...
std::unordered_map<int, std::string> REACTION_NAME_MAP {
  ...
  {SCORE_PROMPT_CHAIN_FLUX, "prompt-chain-flux"},
  {SCORE_DELAYED_CHAIN_FLUX, "delayed-chain-flux"},
  {SCORE_PROMPT_CHAIN_NU_FISSION, "prompt-chain-nu-fission"},
  {SCORE_DELAYED_CHAIN_NU_FISSION, "delayed-chain-nu-fission"},
  {SCORE_PROMPT_CHAIN_GEN_TIME_NUM, "prompt-chain-gen-time-num"},
  {SCORE_PROMPT_CHAIN_GEN_TIME_DENOM, "prompt-chain-gen-time-denom"},
  {SCORE_PROMPT_CHAIN_NU_FISSION_RATE, "prompt-chain-nu-fission-rate"},
  ...
  {SCORE_IFP_GEN_TIME_NUM, "ifp-gen-time-num"},
  {SCORE_IFP_GEN_TIME_DENOM, "ifp-gen-time-denom"},
