      ...
      if (ifp_denom > 0.0 && simulation::keff > 0.0) {
        ...
        if (simulation::lambda_eff_ifp > 0.0) {
          ...
          if (n > 1) {
            ...
            // Error propagation for α = (β - ρ) / Λ
            // ∂α/∂β = 1/Λ, ∂α/∂k = -1/(k²Λ) (via ∂ρ/∂k = 1/k²), ∂α/∂Λ = -(β-ρ)/Λ²
