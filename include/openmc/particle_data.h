...
private:
  ...
  bool is_delayed_ {
    false}; //!< flag indicating if neutron is delayed (for kinetics)
  ...
  // k-prompt tally accumulator for kinetics calculations
  double k_prompt_tally_tracklength_ {0.0};
...
public:
  ...
  double& k_prompt_tally_tracklength() { return k_prompt_tally_tracklength_; }
