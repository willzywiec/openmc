...
// α = −β_eff / [Λ_p · (1 − ρ)]
extern double alpha_ifp;              //!< α at delayed critical from IFP-weighted Λ_p [/s]
extern double alpha_ifp_std;          //!< Standard deviation of α_ifp
extern double alpha_actual_ifp;       //!< α at actual reactivity state [/s]
extern double alpha_actual_ifp_std;   //!< Standard deviation of α_actual_ifp
