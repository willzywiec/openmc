"""
LST019-5: Concrete reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=723 (Run 152)
...
mat1.add_nuclide("U234", 6.539800e-07)
mat1.add_nuclide("U235", 8.115400e-05)
mat1.add_nuclide("U236", 8.105300e-08)
mat1.add_nuclide("U238", 7.228500e-04)
mat1.add_nuclide("H1", 5.868300e-02)
mat1.add_element("N", 2.184600e-03)
mat1.add_nuclide("O16", 3.721700e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=76.68)
# P100         [ dX=C-B; Xo=-(B+C)/2 ]
surf10 = openmc.model.RectangularParallelepiped(-27.61, -17.560000000000002, -35.5, 35.5, 0.0, 150.5)
# Gap          [ dX=C-B; Xo=-(B+C)/2 ]
surf11 = openmc.model.RectangularParallelepiped(-27.61, -17.560000000000002, -35.7, 35.7, 0.0, 150.5)
# Steel Frame  [ dX=C-B; Xo=-(B+C)/2 ]
surf12 = openmc.model.RectangularParallelepiped(-27.61, -17.560000000000002, -38.7, 38.7, -3.0, 153.5)
# Aluminum     [ dX=D-A; Xo=-(D+A)/2 ]
surf13 = openmc.model.RectangularParallelepiped(-28.42, -16.75, -38.7, 38.7, -3.0, 153.5)
# P100         [ dx=C-B; Xo=+(B+C)/2 ]
surf20 = openmc.model.RectangularParallelepiped(17.560000000000002, 27.61, -35.5, 35.5, 0.0, 150.5)
# Gap          [ dX=C-B; Xo=+(B+C)/2 ]
surf21 = openmc.model.RectangularParallelepiped(17.560000000000002, 27.61, -35.7, 35.7, 0.0, 150.5)
# Steel Frame  [ dx=C-B; Xo=+(B+C)/2 ]
surf22 = openmc.model.RectangularParallelepiped(17.560000000000002, 27.61, -38.7, 38.7, -3.0, 153.5)
# Aluminum     [ dx=D-A; Xo=+(D+A)/2 ]
surf23 = openmc.model.RectangularParallelepiped(16.75, 28.42, -38.7, 38.7, -3.0, 153.5)
# BCD
surf99 = openmc.model.RectangularParallelepiped(-26.0, 26.0, -39.0, 39.0, -4.0, 156.0, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 38.34))
