"""
PU-SOL-THERM-041-8: Experiment 268 with 51.65 gPu(3)/L at H/X=465; Hc=28.67
...
surf7 = openmc.ZPlane(surface_id=7, z0=28.67)
...
source.space = openmc.stats.Box((-18.5, -18.5, 14.085), (18.5, 18.5, 16.085))
