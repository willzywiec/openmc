"""
U233-SOL-THERM-013: Case No. 4 (Experment No. 123)
...
mat1.add_nuclide("U232", 2.325800e-09)
mat1.add_nuclide("U233", 3.491100e-04)
mat1.add_nuclide("U234", 3.731400e-06)
mat1.add_nuclide("U235", 9.226500e-08)
mat1.add_nuclide("U236", 3.533700e-09)
mat1.add_nuclide("U238", 4.856400e-06)
mat1.add_element("Th", 4.488900e-06)
mat1.add_nuclide("H1", 6.340200e-02)
mat1.add_element("N", 8.277500e-04)
mat1.add_nuclide("O16", 3.485200e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=26.657)
