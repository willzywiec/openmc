"""
LCT050-7: Exp. No. 2768; 25x25-35=590 array of U(4.738)O2 rods on 1.3cm pitch; boron solution no. 2
...
mat8.add_nuclide("H1", 6.129240e-02)
mat8.add_nuclide("O16", 3.318890e-02)
mat8.add_element("N", 8.489960e-04)
mat8.add_nuclide("B10", 5.575700e-05)
mat8.add_nuclide("B11", 2.244310e-04)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=88.21)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 43.105), (5.55, 5.55, 45.105))
