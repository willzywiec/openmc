"""
LCT034-12: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.65cm Boral, 1.0cm water gap, Hc=57.43cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=57.43)
# Lower grid plate
...
# Basket
surf10 = openmc.model.RectangularParallelepiped(-29.950000000000003, -1.1500000000000004, 1.1500000000000004, 29.950000000000003, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf11 = openmc.model.RectangularParallelepiped(-30.6, -0.5, 0.5, 30.6, -2.200000000000003, 97.8)
# Basket
surf12 = openmc.model.RectangularParallelepiped(1.1500000000000004, 29.950000000000003, 1.1500000000000004, 29.950000000000003, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf13 = openmc.model.RectangularParallelepiped(0.5, 30.6, 0.5, 30.6, -2.200000000000003, 97.8)
# Basket
surf14 = openmc.model.RectangularParallelepiped(-29.950000000000003, -1.1500000000000004, -29.950000000000003, -1.1500000000000004, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf15 = openmc.model.RectangularParallelepiped(-30.6, -0.5, -30.6, -0.5, -2.200000000000003, 97.8)
# Basket
surf16 = openmc.model.RectangularParallelepiped(1.1500000000000004, 29.950000000000003, -29.950000000000003, -1.1500000000000004, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf17 = openmc.model.RectangularParallelepiped(0.5, 30.6, -30.6, -0.5, -2.200000000000003, 97.8)
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-29.0175, y0=29.0175, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-29.0175, y0=29.0175, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-1.95, y0=29.15, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-29.15, y0=1.95, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-1.95, y0=1.95, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=29.0175, y0=29.0175, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=29.0175, y0=29.0175, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=1.95, y0=29.15, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=29.15, y0=1.95, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=1.95, y0=1.95, r=0.5)
# Aluminum cover
...
surf1_zmin = openmc.ZPlane(surface_id=1047, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1048, z0=90.0)
surf2_zmin = openmc.ZPlane(surface_id=1049, z0=0.0)
surf2_zmax = openmc.ZPlane(surface_id=1050, z0=96.9)
surf3_zmin = openmc.ZPlane(surface_id=1051, z0=-1.27)
surf3_zmax = openmc.ZPlane(surface_id=1052, z0=98.2)
surf4_zmin = openmc.ZPlane(surface_id=1053, z0=-1.27)
surf4_zmax = openmc.ZPlane(surface_id=1054, z0=98.2)
...
cell1.translation = (-15.55, 15.55, 0.0)
...
cell12.translation = (15.55, -15.55, 0.0)
...
source.space = openmc.stats.Box((-30.15, -30.15, 27.715), (30.15, 30.15, 29.715))
