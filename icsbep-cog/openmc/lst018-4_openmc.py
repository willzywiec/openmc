"""
LST018-4: Concrete reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=734 (Run 144)
...
mat1.add_nuclide("U234", 6.447200e-07)
mat1.add_nuclide("U235", 8.000500e-05)
mat1.add_nuclide("U236", 7.990500e-08)
mat1.add_nuclide("U238", 7.126100e-04)
mat1.add_nuclide("H1", 5.874600e-02)
mat1.add_element("N", 2.161800e-03)
mat1.add_nuclide("O16", 3.715800e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=67.95)
# C100         [ dX=C-B; Xo=-(B+C)/2 ]
surf11 = openmc.model.RectangularParallelepiped(-27.67, -17.6, -35.7, 35.7, 0.0, 150.6)
# Steel Frame  [ dX=C-B; Xo=-(B+C)/2 ]
surf12 = openmc.model.RectangularParallelepiped(-27.67, -17.6, -38.7, 38.7, -3.0, 153.6)
# Aluminum     [ dX=D-A; Xo=-(D+A)/2 ]
surf13 = openmc.model.RectangularParallelepiped(-28.48, -16.790000000000003, -38.7, 38.7, -3.0, 153.6)
# C100         [ dx=C-B; Xo=+(B+C)/2 ]
surf21 = openmc.model.RectangularParallelepiped(17.6, 27.67, -35.7, 35.7, 0.0, 150.6)
# Steel Frame  [ dx=C-B; Xo=+(B+C)/2 ]
surf22 = openmc.model.RectangularParallelepiped(17.6, 27.67, -38.7, 38.7, -3.0, 153.6)
# Aluminum     [ dx=D-A; Xo=+(D+A)/2 ]
surf23 = openmc.model.RectangularParallelepiped(16.790000000000003, 28.48, -38.7, 38.7, -3.0, 153.6)
# BCD
surf99 = openmc.model.RectangularParallelepiped(-28.5, 28.5, -39.0, 39.0, -4.0, 156.0, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 33.975))
