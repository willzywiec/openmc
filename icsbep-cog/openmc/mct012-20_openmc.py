"""
MCT012-20: MOX/Polystyrene (H/SQRT(LxW)=1.29) with H/X=226, bare
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -26.195, 26.195, boundary_type="vacuum")
