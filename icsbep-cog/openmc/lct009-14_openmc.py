"""
LEU-COMP-THERM-009-14: (15x8)-3.1515cm-(0.357cm Cu-1Cd)-3.1515cm-(15x8)-3.1515cm-(0.357cm Cu-1Cd)-3.1515cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
mat6.add_nuclide("B10", 4.938400e-06)
mat6.add_nuclide("B11", 1.987800e-05)
mat6.add_element("C", 8.934600e-06)
mat6.add_element("Cd", 4.720800e-04)
mat6.add_element("Cu", 8.332800e-02)
mat6.add_element("Fe", 1.921600e-05)
mat6.add_element("Mn", 8.790100e-06)
mat6.add_element("Ni", 9.142400e-06)
mat6.add_nuclide("O16", 6.372000e-05)
mat6.add_element("Si", 7.641900e-06)
mat6.add_element("Sn", 1.130000e-04)
mat6.add_element("Zn", 5.744000e-06)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-63.81, 63.81, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-93.81, 93.81, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-25.71)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=25.71)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-22.5585, -22.2015, -15.3, 15.3, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(22.2015, 22.5585, -15.3, 15.3, 0.0, 91.5)
...
cell1.translation = (-44.76, 0.0, 0.0)
...
cell5.translation = (44.76, 0.0, 0.0)
...
source.space = openmc.stats.Box((-45.76, -2.27, 45.0375), (45.76, 2.27, 47.0375))
