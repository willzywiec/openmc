"""
U233-SOL-THERM-013: Case No. 1 (Experiment No. 120)
...
mat1.add_nuclide("U232", 2.327900e-09)
mat1.add_nuclide("U233", 3.494400e-04)
mat1.add_nuclide("U234", 3.734900e-06)
mat1.add_nuclide("U235", 9.235200e-08)
mat1.add_nuclide("U236", 3.536900e-09)
mat1.add_nuclide("U238", 4.860900e-06)
mat1.add_element("Th", 4.493100e-06)
mat1.add_nuclide("H1", 6.346200e-02)
mat1.add_element("N", 8.285300e-04)
mat1.add_nuclide("O16", 3.488600e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=26.411)
