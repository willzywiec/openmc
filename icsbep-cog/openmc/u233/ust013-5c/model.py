"""
U233-SOL-THERM-013: Case No. 5 (Experment No. 124)
...
mat1.add_nuclide("U232", 2.324900e-09)
mat1.add_nuclide("U233", 3.489700e-04)
mat1.add_nuclide("U234", 3.729900e-06)
mat1.add_nuclide("U235", 9.222900e-08)
mat1.add_nuclide("U236", 3.532100e-09)
mat1.add_nuclide("U238", 4.854400e-06)
mat1.add_element("Th", 4.487000e-06)
mat1.add_nuclide("H1", 6.337600e-02)
mat1.add_element("N", 8.274200e-04)
mat1.add_nuclide("O16", 3.483900e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=26.810)
