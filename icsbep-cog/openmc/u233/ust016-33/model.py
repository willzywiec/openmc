"""
U233-SOL-THERM-016-33: 1.357 kg 233U @ H/X=583.2 and N/U=2.15 (Exp't No. 198)
...
mat1.add_nuclide("U233", 1.126400e-04)
mat1.add_nuclide("U234", 1.203900e-06)
mat1.add_nuclide("U235", 2.976900e-08)
mat1.add_nuclide("U236", 1.140100e-09)
mat1.add_nuclide("U238", 1.566900e-06)
mat1.add_nuclide("H1", 6.569500e-02)
mat1.add_element("N", 2.479000e-04)
mat1.add_nuclide("O16", 3.381600e-02)
mat1.add_element("Th", 1.449800e-06)
...
# Solution/Hc
surf10 = openmc.ZPlane(surface_id=10, z0=26.52375)
...
source.space = openmc.stats.Point((0.0, 0.0, 13.34125))
