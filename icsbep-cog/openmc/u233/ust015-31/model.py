"""
U233-SOL-THERM-015-31; FALSTAFF; Sol'n No. 7; Sphere No. 8; 1.84 cm Be
...
surf1 = openmc.Sphere(surface_id=1, r=12.4564)
surf2 = openmc.Sphere(surface_id=2, r=12.5047)
surf3 = openmc.Sphere(surface_id=3, r=14.3447, boundary_type="vacuum")
