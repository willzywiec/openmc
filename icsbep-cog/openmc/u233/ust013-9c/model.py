"""
U233-SOL-THERM-013: Case No. 9 (Experment No. 128)
...
mat1.add_nuclide("U232", 2.248500e-09)
mat1.add_nuclide("U233", 3.375100e-04)
mat1.add_nuclide("U234", 3.607400e-06)
mat1.add_nuclide("U235", 8.920100e-08)
mat1.add_nuclide("U236", 3.416300e-09)
mat1.add_nuclide("U238", 4.695000e-06)
mat1.add_element("Th", 4.339800e-06)
mat1.add_nuclide("H1", 6.334700e-02)
mat1.add_element("N", 8.002500e-04)
mat1.add_nuclide("O16", 3.472100e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=27.788)
