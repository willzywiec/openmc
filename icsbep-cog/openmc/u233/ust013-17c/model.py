"""
U233-SOL-THERM-013: Case No. 17 (Experment No. 171)
...
mat1.add_nuclide("U232", 1.336000e-09)
mat1.add_nuclide("U233", 2.005500e-04)
mat1.add_nuclide("U234", 2.143500e-06)
mat1.add_nuclide("U235", 5.300300e-08)
mat1.add_nuclide("U236", 2.029900e-09)
mat1.add_nuclide("U238", 2.789800e-06)
mat1.add_element("Th", 2.578700e-06)
mat1.add_nuclide("H1", 6.477800e-02)
mat1.add_element("N", 4.755100e-04)
mat1.add_nuclide("O16", 3.419900e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=28.209)
