"""
U233-SOL-THERM-016-11: 2.700 kg 233U @ H/X=120.8 and N/U=2.15 (Exp't No. 104)
...
mat1.add_nuclide("U233", 5.141600e-04)
mat1.add_nuclide("U234", 5.495400e-06)
mat1.add_nuclide("U235", 1.358800e-07)
mat1.add_nuclide("U236", 5.204000e-09)
mat1.add_nuclide("U238", 7.152200e-06)
mat1.add_nuclide("H1", 6.210200e-02)
mat1.add_element("N", 1.131600e-03)
mat1.add_nuclide("O16", 3.547400e-02)
mat1.add_element("Th", 6.617500e-06)
...
surf5 = openmc.ZCylinder(surface_id=5, x0=9.82975, y0=0.0, r=2.62509)
# Al-2S/Fill-Pipe/Outer
surf6 = openmc.ZCylinder(surface_id=6, x0=9.82975, y0=0.0, r=3.01625)
# Al-2S/Soln-Tank/Inner
surf7 = openmc.ZCylinder(surface_id=7, r=12.719)
# Al-2S/Soln-Tank/Outer
surf8 = openmc.ZCylinder(surface_id=8, r=12.846)
# Al-2S/Soln-Tank/Lid
surf9 = openmc.ZCylinder(surface_id=9, r=15.24)
# Solution/Hc
surf10 = openmc.ZPlane(surface_id=10, z0=24.80975)
...
surf7_zmin = openmc.ZPlane(surface_id=1014, z0=0.15875)
surf7_zmax = openmc.ZPlane(surface_id=1015, z0=181.76875)
surf8_zmin = openmc.ZPlane(surface_id=1016, z0=-1.27)
surf8_zmax = openmc.ZPlane(surface_id=1017, z0=181.76875)
surf9_zmin = openmc.ZPlane(surface_id=1018, z0=181.76875)
surf9_zmax = openmc.ZPlane(surface_id=1019, z0=181.89575)
...
source.space = openmc.stats.Point((0.0, 0.0, 12.404875))
