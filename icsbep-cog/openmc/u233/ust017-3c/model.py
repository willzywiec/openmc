"""
U233-SOL-THERM-017-3: 0.947 kg 233U @ H/X=193.7 and N/U=2.15 (Exp't No. 225b)
...
surf3 = openmc.ZCylinder(surface_id=3, x0=-2.19175, y0=0.0, r=10.161)
# Al-2S/Soln-Tank/Outer
surf4 = openmc.ZCylinder(surface_id=4, x0=-2.19175, y0=0.0, r=10.288)
# Al-2S/Soln-Tank/Lid
surf5 = openmc.ZCylinder(surface_id=5, x0=-2.19175, y0=0.0, r=12.7)
# Al-1100/Tank/Inner
surf6 = openmc.ZCylinder(surface_id=6, r=45.72)
# Al-1100/Tank/Outer
surf7 = openmc.ZCylinder(surface_id=7, r=46.0375)
# Solution/Hc
surf8 = openmc.ZPlane(surface_id=8, z0=21.199)
# Water/Hr
surf9 = openmc.ZPlane(surface_id=9, z0=40.43)

# Z-plane surfaces for bounded cylinders
surf6_zmin = openmc.ZPlane(surface_id=1009, z0=-26.27)
surf6_zmax = openmc.ZPlane(surface_id=1010, z0=100.73)
surf7_zmin = openmc.ZPlane(surface_id=1011, z0=-27.54)
surf7_zmax = openmc.ZPlane(surface_id=1012, z0=100.73)
...
source.space = openmc.stats.Point((0.0, 0.0, 10.5995))
