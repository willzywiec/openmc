"""
U233-SOL-THERM-009: 13.142 kg U-233 @ H/U-233 = 1,824 (Case 17)
...
mat1.add_nuclide("U233", 3.648100e-05)
mat1.add_nuclide("U234", 5.595900e-07)
mat1.add_nuclide("U235", 1.485900e-08)
mat1.add_nuclide("U238", 3.997900e-07)
mat1.add_nuclide("H1", 6.655000e-02)
mat1.add_element("N", 8.224800e-05)
mat1.add_nuclide("O16", 3.359300e-02)
mat1.add_element("Th", 3.707200e-08)
...
surf1 = openmc.ZPlane(surface_id=1, z0=49.5046)
...
source.space = openmc.stats.Point((0.0, 0.0, 24.7523))
