"""
U233-SOL-THERM-009: 18.788 kg U-233 @ H/U-233 = 1,999 (Case 19)
...
mat1.add_nuclide("U233", 3.323900e-05)
mat1.add_nuclide("U234", 5.068300e-07)
mat1.add_nuclide("U235", 1.693500e-08)
mat1.add_nuclide("U238", 3.879300e-07)
mat1.add_nuclide("H1", 6.643900e-02)
mat1.add_element("N", 7.999900e-05)
mat1.add_nuclide("O16", 3.352200e-02)
mat1.add_element("Th", 3.694800e-08)
...
surf1 = openmc.ZPlane(surface_id=1, z0=77.6732)
...
source.space = openmc.stats.Point((0.0, 0.0, 38.8366))
