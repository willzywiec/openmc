"""
U233-SOL-THERM-013: Case No. 16 (Experment No. 170)
...
mat1.add_nuclide("U232", 1.397500e-09)
mat1.add_nuclide("U233", 2.097700e-04)
mat1.add_nuclide("U234", 2.242100e-06)
mat1.add_nuclide("U235", 5.544100e-08)
mat1.add_nuclide("U236", 2.123200e-09)
mat1.add_nuclide("U238", 2.918100e-06)
mat1.add_element("Th", 2.697200e-06)
mat1.add_nuclide("H1", 6.482700e-02)
mat1.add_element("N", 4.973800e-04)
mat1.add_nuclide("O16", 3.430700e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=26.975)
