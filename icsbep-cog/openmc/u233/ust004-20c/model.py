"""
U233-SOL-THERM-004 (Exp't 20 in 6"-Diam. Vessel) 1514 g U-233 @ H/X = 84
...
mat1.add_nuclide("U233", 7.077100e-04)
mat1.add_nuclide("U234", 3.285600e-06)
mat1.add_nuclide("U238", 6.179600e-06)
mat1.add_nuclide("H1", 5.937400e-02)
mat1.add_nuclide("O16", 3.659600e-02)
mat1.add_element("N", 1.903100e-03)
...
# Paraffin/Outer
surf3 = openmc.ZCylinder(surface_id=3, r=22.928)
# Hc
# surf4: Unsupported surface type "analytic" with params ['1.', 'z', '-30.7880', 'constant']

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(z0=0.0)
surf1_zmax = openmc.ZPlane(z0=91.528)
surf2_zmin = openmc.ZPlane(z0=-0.1291)
surf2_zmax = openmc.ZPlane(z0=91.6571)
surf3_zmin = openmc.ZPlane(z0=-15.3691, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(z0=91.6571, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 15.394))
