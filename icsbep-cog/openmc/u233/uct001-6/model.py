...
surf99 = openmc.ZCylinder(surface_id=99, r=60.28, boundary_type="vacuum")

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1099, z0=-19.05)
surf1_zmax = openmc.ZPlane(surface_id=1100, z0=19.05)
surf2_zmin = openmc.ZPlane(surface_id=1101, z0=-25.8191)
surf2_zmax = openmc.ZPlane(surface_id=1102, z0=-19.05)
surf3_zmin = openmc.ZPlane(surface_id=1103, z0=19.05)
surf3_zmax = openmc.ZPlane(surface_id=1104, z0=25.8191)
surf4_zmin = openmc.ZPlane(surface_id=1105, z0=-25.8191)
surf4_zmax = openmc.ZPlane(surface_id=1106, z0=25.8191)
surf5_zmin = openmc.ZPlane(surface_id=1107, z0=-25.8191)
surf5_zmax = openmc.ZPlane(surface_id=1108, z0=25.8191)
surf6_zmin = openmc.ZPlane(surface_id=1109, z0=-0.3175)
surf6_zmax = openmc.ZPlane(surface_id=1110, z0=0.3175)
surf7_zmin = openmc.ZPlane(surface_id=1111, z0=-25.8191)
surf7_zmax = openmc.ZPlane(surface_id=1112, z0=25.8191)
surf21_zmin = openmc.ZPlane(surface_id=1113, z0=-19.05)
surf21_zmax = openmc.ZPlane(surface_id=1114, z0=19.05)
surf22_zmin = openmc.ZPlane(surface_id=1115, z0=-25.8191)
surf22_zmax = openmc.ZPlane(surface_id=1116, z0=-19.05)
surf23_zmin = openmc.ZPlane(surface_id=1117, z0=19.05)
surf23_zmax = openmc.ZPlane(surface_id=1118, z0=25.8191)
surf24_zmin = openmc.ZPlane(surface_id=1119, z0=-25.8191)
surf24_zmax = openmc.ZPlane(surface_id=1120, z0=25.8191)
surf25_zmin = openmc.ZPlane(surface_id=1121, z0=-25.8191)
surf25_zmax = openmc.ZPlane(surface_id=1122, z0=25.8191)
surf99_zmin = openmc.ZPlane(surface_id=1123, z0=-56.2991, boundary_type="vacuum")
surf99_zmax = openmc.ZPlane(surface_id=1124, z0=56.2991, boundary_type="vacuum")
