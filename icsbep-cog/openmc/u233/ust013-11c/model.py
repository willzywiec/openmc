"""
U233-SOL-THERM-013: Case No. 11 (Experment No. 130)
...
mat1.add_nuclide("U232", 2.250600e-09)
mat1.add_nuclide("U233", 3.378400e-04)
mat1.add_nuclide("U234", 3.610900e-06)
mat1.add_nuclide("U235", 8.928700e-08)
mat1.add_nuclide("U236", 3.419500e-09)
mat1.add_nuclide("U238", 4.699600e-06)
mat1.add_element("Th", 4.344000e-06)
mat1.add_nuclide("H1", 6.340900e-02)
mat1.add_element("N", 8.010300e-04)
mat1.add_nuclide("O16", 3.475400e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=27.165)
