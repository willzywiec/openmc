"""
U233-SOL-THERM-013: Case No. 2 (Experiment No. 121)
...
mat1.add_nuclide("U232", 2.327400e-09)
mat1.add_nuclide("U233", 3.493700e-04)
mat1.add_nuclide("U234", 3.734200e-06)
mat1.add_nuclide("U235", 9.233400e-08)
mat1.add_nuclide("U236", 3.536200e-09)
mat1.add_nuclide("U238", 4.860000e-06)
mat1.add_element("Th", 4.492100e-06)
mat1.add_nuclide("H1", 6.344900e-02)
mat1.add_element("N", 8.283600e-04)
mat1.add_nuclide("O16", 3.487800e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=26.467)
