"""
U233-SOL-THERM-017-4: 0.886 kg 233U @ H/X=272.2 and N/U=2.15 (Exp't No. 232b)
...
surf3 = openmc.ZCylinder(surface_id=3, x0=-4.74975, y0=0.0, r=12.719)
# Al-2S/Soln-Tank/Outer
surf4 = openmc.ZCylinder(surface_id=4, x0=-4.74975, y0=0.0, r=12.846)
# Al-2S/Soln-Tank/Lid
surf5 = openmc.ZCylinder(surface_id=5, x0=-4.74975, y0=0.0, r=15.24)
# Al-1100/Tank/Inner
surf6 = openmc.ZCylinder(surface_id=6, r=45.72)
# Al-1100/Tank/Outer
surf7 = openmc.ZCylinder(surface_id=7, r=46.0375)
# Solution/Hc
surf8 = openmc.ZPlane(surface_id=8, z0=17.917)
# Water/Hr
surf9 = openmc.ZPlane(surface_id=9, z0=39.93)

# Z-plane surfaces for bounded cylinders
surf6_zmin = openmc.ZPlane(surface_id=1009, z0=-25.67)
surf6_zmax = openmc.ZPlane(surface_id=1010, z0=101.33)
surf7_zmin = openmc.ZPlane(surface_id=1011, z0=-26.94)
surf7_zmax = openmc.ZPlane(surface_id=1012, z0=101.33)
...
source.space = openmc.stats.Point((0.0, 0.0, 8.9585))
