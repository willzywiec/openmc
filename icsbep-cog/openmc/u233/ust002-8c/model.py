"""
U233-SOL-THERM-002 (Exp't 8 in 8"-Diam. Vessel) 795 g U-233 @ H/X = 192
...
mat1.add_nuclide("U233", 3.282100e-04)
mat1.add_nuclide("U234", 1.523700e-06)
mat1.add_nuclide("U238", 2.865900e-06)
mat1.add_nuclide("H1", 6.307000e-02)
mat1.add_nuclide("O16", 3.495200e-02)
mat1.add_element("N", 9.676800e-04)
...
# Hc
# surf4: Unsupported surface type "analytic" with params ['1.', 'z', '-18.9195', 'constant']
...
source.space = openmc.stats.Point((0.0, 0.0, 9.46))
