"""
U233-SOL-THERM-013: Case No. 10 (Experment No. 129)
...
mat1.add_nuclide("U232", 2.248100e-09)
mat1.add_nuclide("U233", 3.374600e-04)
mat1.add_nuclide("U234", 3.606900e-06)
mat1.add_nuclide("U235", 8.918700e-08)
mat1.add_nuclide("U236", 3.415700e-09)
mat1.add_nuclide("U238", 4.694300e-06)
mat1.add_element("Th", 4.339100e-06)
mat1.add_nuclide("H1", 6.333700e-02)
mat1.add_element("N", 8.001300e-04)
...
surf4 = openmc.ZPlane(surface_id=4, z0=27.927)
