...
mat1.add_nuclide("U233", 5.047400e-04)
mat1.add_nuclide("U234", 5.398200e-06)
mat1.add_nuclide("U235", 1.334000e-07)
mat1.add_nuclide("U236", 5.108800e-09)
mat1.add_nuclide("U238", 7.021200e-06)
mat1.add_nuclide("H1", 6.183300e-02)
mat1.add_element("N", 1.196700e-03)
mat1.add_nuclide("O16", 3.547400e-02)
mat1.add_element("Th", 6.489900e-06)
...
# surf9: Unsupported surface type "analytic" with params ['1.', 'z', '-35.9645', 'constant']
# Water Height; C
# surf10: Unsupported surface type "analytic" with params ['1.', 'z', '-68.0', 'constant']
