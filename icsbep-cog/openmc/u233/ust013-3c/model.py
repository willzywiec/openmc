"""
U233-SOL-THERM-013: Case No. 3 (Experiment No. 122)
...
mat1.add_nuclide("U232", 2.326800e-09)
mat1.add_nuclide("U233", 3.492700e-04)
mat1.add_nuclide("U234", 3.733100e-06)
mat1.add_nuclide("U235", 9.230700e-08)
mat1.add_nuclide("U236", 3.535200e-09)
mat1.add_nuclide("U238", 4.858500e-06)
mat1.add_element("Th", 4.490900e-06)
mat1.add_nuclide("H1", 6.343100e-02)
mat1.add_element("N", 8.281200e-04)
mat1.add_nuclide("O16", 3.486800e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=26.543)
