"""
U233-SOL-THERM-002 (Exp't 4 in 8"-Diam. Vessel) 1081 g U-233 @ H/X = 119
...
# Hc
# surf4: Unsupported surface type "analytic" with params ['1.', 'z', '-16.5195', 'constant']
...
source.space = openmc.stats.Point((0.0, 0.0, 8.26))
