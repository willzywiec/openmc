"""
U233-SOL-THERM-004 (Exp't 33 in 7.5"-Diam. Vessel) 890 g U-233 @ H/X = 144
...
# Paraffin/Outer
surf3 = openmc.ZCylinder(surface_id=3, r=24.8937)
# Hc
# surf4: Unsupported surface type "analytic" with params ['1.', 'z', '-18.7109', 'constant']

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(z0=0.0)
surf1_zmax = openmc.ZPlane(z0=19.1609)
surf2_zmin = openmc.ZPlane(z0=-0.1291)
surf2_zmax = openmc.ZPlane(z0=19.29)
surf3_zmin = openmc.ZPlane(z0=-15.3691, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(z0=34.53, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 9.35))
