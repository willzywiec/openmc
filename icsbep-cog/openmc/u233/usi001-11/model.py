"""
FALSTAFF; Sol'n No. 1; Sphere No. 6; 0.64 cm Be + 1.35 cm CH2
...
surf3 = openmc.Sphere(surface_id=3, r=11.4875)
surf4 = openmc.Sphere(surface_id=4, r=12.8375, boundary_type="vacuum")
