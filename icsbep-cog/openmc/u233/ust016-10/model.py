"""
U233-SOL-THERM-016-10: 2.704 kg 233U @ H/X=120.8 and N/U=2.15 (Exp't No. 103)
...
# Solution/Hc
surf10 = openmc.ZPlane(surface_id=10, z0=24.702)
...
surf7_zmax = openmc.ZPlane(z0=181.61)
surf8_zmin = openmc.ZPlane(z0=-1.27)
surf8_zmax = openmc.ZPlane(z0=181.61)
surf9_zmin = openmc.ZPlane(z0=181.61)
surf9_zmax = openmc.ZPlane(z0=181.737)
...
source.space = openmc.stats.Point((0.0, 0.0, 12.351))
