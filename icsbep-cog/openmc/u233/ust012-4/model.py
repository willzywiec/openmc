...
mat1.add_nuclide("U233", 3.314600e-04)
mat1.add_nuclide("U234", 3.544900e-06)
mat1.add_nuclide("U235", 8.759900e-08)
mat1.add_nuclide("U236", 3.354900e-09)
mat1.add_nuclide("U238", 4.610700e-06)
mat1.add_nuclide("H1", 6.380900e-02)
mat1.add_element("N", 7.858800e-04)
mat1.add_nuclide("O16", 3.489700e-02)
mat1.add_element("Th", 4.261800e-06)
...
mat3.add_nuclide("H1", 6.664800e-02)
mat3.add_nuclide("O16", 3.332400e-02)
...
# surf9: Unsupported surface type "analytic" with params ['1.', 'z', '-39.6163', 'constant']
# Water Height; C
# surf10: Unsupported surface type "analytic" with params ['1.', 'z', '-68.5', 'constant']
