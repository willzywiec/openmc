"""
U233-SOL-THERM-004 (Exp't 30 in 6"-Diam. Vessel) 1751 g U-233 @ H/X = 66
...
# Hc
# surf4: Unsupported surface type "analytic" with params ['1.', 'z', '-29.0880', 'constant']
...
source.space = openmc.stats.Point((0.0, 0.0, 14.544))
