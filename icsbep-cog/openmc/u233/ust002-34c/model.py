"""
U233-SOL-THERM-002 (Exp't 34 in 8"-Diam. Vessel) 929 g U-233 @ H/X = 144
...
mat1.add_nuclide("U233", 4.311200e-04)
mat1.add_nuclide("U234", 2.001500e-06)
mat1.add_nuclide("U238", 3.764400e-06)
mat1.add_nuclide("H1", 6.218000e-02)
mat1.add_nuclide("O16", 3.529800e-02)
mat1.add_element("N", 1.158900e-03)
...
# Hc
# surf4: Unsupported surface type "analytic" with params ['1.', 'z', '-16.8195', 'constant']
...
source.space = openmc.stats.Point((0.0, 0.0, 8.4))
