"""
LST004-5: Water-reflected 60-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=942 (Run 46)
...
mat1.add_nuclide("H1", 5.818900e-02)
mat1.add_element("N", 2.592500e-03)
mat1.add_nuclide("O16", 3.741400e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=78.56)
...
source.space = openmc.stats.Point((0.0, 0.0, 39.28))
