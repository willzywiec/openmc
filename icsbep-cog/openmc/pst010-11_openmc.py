...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=22.3520)
# Cylinder/Inner
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=22.5095)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=52.9895)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=22.352)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=53.147)
