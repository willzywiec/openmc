"""
LCT006-18: Tank-Type Critical Assembly (TCA) 19x19 rods with 2.293 cm pitch; Hc=41.54 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=41.54)
# DX=DY=19*2.293        =  43.567 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-21.7835, 21.7835, -21.7835, 21.7835, -30.0, 144.15)
# DX=DY=19*2.293 + 2*30 = 103.567 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-51.7835, 51.7835, -51.7835, 51.7835, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-21.7835, -21.7835]
...
source.space = openmc.stats.Point((0.0, 0.0, 20.77))
