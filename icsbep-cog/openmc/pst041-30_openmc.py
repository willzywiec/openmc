"""
PU-SOL-THERM-041-30: Experiment 445 with 40.15 gPu(3.11)/L at H/X=650; Hc=30.75
...
surf7 = openmc.ZPlane(surface_id=7, z0=30.75)
...
source.space = openmc.stats.Box((-18.5, -18.5, 15.125), (18.5, 18.5, 17.125))
