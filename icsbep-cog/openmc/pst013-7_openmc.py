"""
PU-SOL-THERM-013 (Case 7) Three cylinders with 0 cm surface-to-surface in a right-angle
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=36.05)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=25.588, y0=0.0, r=12.794)
...
source.space = openmc.stats.Box((-1.0, -26.588, 17.0), (26.588, 1.0, 19.0))
