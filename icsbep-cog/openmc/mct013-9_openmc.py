"""
MCT013-9: MOX/Polystyrene with H/X=226 with 0.70 SST-1.1B absorber and 15.24cm Lucite reflector
...
mat2.add_nuclide("B10", 7.830100e-04)
mat2.add_nuclide("B11", 3.151700e-03)
mat2.add_element("Fe", 5.311600e-02)
mat2.add_element("Cr", 1.387700e-02)
mat2.add_element("Ni", 5.467100e-03)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 0.70 + 18.3686 = 31.2976 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.671400000000002, 19.0686)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=0.70)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.9114, 34.3086, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 10.88))
