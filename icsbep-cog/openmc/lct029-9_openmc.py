"""
LCT029-9: 22x22 array of 484 U(4.738)O2 fuel rods with 1.60 cm square pitch with no Hf plates
...
surf5 = openmc.ZPlane(surface_id=5, z0=32.18)
...
cell11.region = -surf1 & (+surf14 | -surf14_zmin | +surf14_zmax)
...
source.space = openmc.stats.Box((-1.8, -1.8, 15.09), (1.8, 1.8, 17.09))
