"""
MCT012-3: MOX/Polystyrene (H/SQRT(LxW)=0.44) with H/X=343 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-33.085, 33.085, -33.085, 33.085, -14.62, 14.62)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-48.325, 48.325, -48.325, 48.325, -29.86, 29.86, boundary_type="vacuum")
