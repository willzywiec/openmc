"""
U233-SOL-THERM-013: Case No. 18 (Experment No. 177)
...
mat1.add_nuclide("U232", 1.252300e-09)
mat1.add_nuclide("U233", 1.879800e-04)
mat1.add_nuclide("U234", 2.009100e-06)
mat1.add_nuclide("U235", 4.968000e-08)
mat1.add_nuclide("U236", 1.902600e-09)
mat1.add_nuclide("U238", 2.614900e-06)
mat1.add_element("Th", 2.417000e-06)
mat1.add_nuclide("H1", 6.503900e-02)
mat1.add_element("N", 4.456900e-04)
mat1.add_nuclide("O16", 3.421600e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=31.5966)
