"""
MCT013-27: MOX/Polystyrene with H/X=226 with 0.65 Lead absorber and 15.24cm Lucite reflector
...
mat2.add_element("Fe", 3.667500e-05)
mat2.add_element("Pb", 3.272000e-02)
mat2.add_element("Bi", 3.267000e-06)
mat2.add_element("Cu", 1.074400e-05)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 0.65 + 10.0206 = 25.3420 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.671399999999998, 10.6706)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.0)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=0.65)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.9114, 25.910600000000002, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 6.66))
