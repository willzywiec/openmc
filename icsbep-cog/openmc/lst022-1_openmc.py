"""
LST022-1: STACY 28cm thick slab tank with 10% enriched uranyl nitrate solution @ H/X=747 reflected with (B010) borated concrete (Run 136)
...
mat1.add_nuclide("U234", 6.368900e-07)
mat1.add_nuclide("U235", 7.903400e-05)
mat1.add_nuclide("U236", 7.893500e-08)
mat1.add_nuclide("U238", 7.039700e-04)
mat1.add_nuclide("H1", 5.906500e-02)
mat1.add_element("N", 2.049200e-03)
...
mat5.add_nuclide("H1", 1.751600e-02)
mat5.add_nuclide("O16", 8.758100e-03)
mat5.add_nuclide("O16", 3.462900e-02)
mat5.add_nuclide("B10", 1.075200e-04)
mat5.add_nuclide("B11", 4.328000e-04)
mat5.add_element("C", 1.353700e-04)
mat5.add_element("Na", 1.146500e-04)
mat5.add_element("Mg", 1.314900e-04)
mat5.add_element("Al", 7.619100e-04)
mat5.add_element("Si", 1.350000e-02)
mat5.add_element("S", 1.466600e-04)
mat5.add_element("Cl", 7.473900e-07)
mat5.add_element("K", 1.291400e-04)
mat5.add_element("Ca", 5.500500e-03)
mat5.add_element("Fe", 1.953400e-04)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=71.96)
# Borated concrete
surf11 = openmc.model.RectangularParallelepiped(-32.42, -17.54, -35.7, 35.7, 0.0, 150.6)
# Steel frames
surf12 = openmc.model.RectangularParallelepiped(-32.42, -17.54, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover plates
surf13 = openmc.model.RectangularParallelepiped(-33.230000000000004, -16.73, -38.7, 38.7, -3.0, 153.6)
# Borated concrete
surf21 = openmc.model.RectangularParallelepiped(17.54, 32.42, -35.7, 35.7, 0.0, 150.6)
# Steel frames
surf22 = openmc.model.RectangularParallelepiped(17.54, 32.42, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover plates
surf23 = openmc.model.RectangularParallelepiped(16.73, 33.230000000000004, -38.7, 38.7, -3.0, 153.6)
# BCD
surf99 = openmc.model.RectangularParallelepiped(-33.23, 33.23, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 35.98))
