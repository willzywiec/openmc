"""
MCT012-22: MOX/Polystyrene (H/SQRT(LxW)=0.77) with H/X=226, bare
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-25.45, 25.45, -22.93, 22.93, -18.495, 18.495, boundary_type="vacuum")
