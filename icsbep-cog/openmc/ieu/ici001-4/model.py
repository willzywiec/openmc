...
mat10.add_nuclide("U235", 5.389800e-03)
mat10.add_nuclide("U238", 9.534900e-03)
mat10.add_nuclide("O16", 3.000000e-02)
...
# BCD/upper
surf4 = openmc.ZPlane(surface_id=4, z0=1.863, boundary_type="periodic")
# BCD/planar
...
# CH2/lower
surf6 = openmc.ZCylinder(surface_id=6, x0=0.000, y0=0.345, r=2.35)
# CH2/upper
surf7 = openmc.ZCylinder(surface_id=7, x0=1.345, y0=1.690, r=2.35)
# U(36)O2
surf10 = openmc.ZCylinder(surface_id=10, x0=1.710, y0=1.843, r=2.32)
# Can-U(36)O2
surf11 = openmc.ZCylinder(surface_id=11, x0=1.690, y0=1.863, r=2.34)
# Th
surf20 = openmc.ZCylinder(surface_id=20, x0=0.375, y0=1.315, r=2.3)
# Can-Th
surf21 = openmc.ZCylinder(surface_id=21, x0=0.345, y0=1.345, r=2.33)
...
u1_cell0.region = -surf10
u1_cell1 = openmc.Cell(fill=mat11)
u1_cell1.region = +surf10 & -surf11
u1_cell2 = openmc.Cell(fill=mat2)
u1_cell2.region = -surf7 & +surf11 & +surf21
u1_cell3 = openmc.Cell(fill=mat20)
u1_cell3.region = -surf20
u1_cell4 = openmc.Cell(fill=mat21)
u1_cell4.region = +surf20 & -surf21
u1_cell5 = openmc.Cell(fill=mat2)
u1_cell5.region = -surf6 & +surf21
...
source.space = openmc.stats.Point((0.0, 0.0, 1.7765))
