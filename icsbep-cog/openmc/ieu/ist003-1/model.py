"""
IST003-1: 30F1 solution in a water reflected 16-inch diameter cylinder
...
mat1.add_nuclide("U235", 7.462000e-04)
mat1.add_nuclide("U234", 8.656400e-06)
mat1.add_nuclide("U236", 1.716600e-06)
mat1.add_nuclide("U238", 1.684600e-03)
mat1.add_nuclide("H1", 5.626600e-02)
mat1.add_element("F", 4.882400e-03)
mat1.add_nuclide("O16", 3.301500e-02)
...
surf3_zmax = openmc.ZPlane(z0=18.0957)
...
source.space = openmc.stats.Point((0.0, 0.0, 9.04785))
