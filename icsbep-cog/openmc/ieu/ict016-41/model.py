"""
ICT016-41: 17.78 x 17.78 x 22.3012 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 0.0381 cm Cd plus 20.32 cm Beechwood A on top - batch 80
...
mat4.add_nuclide("H1", 2.652600e-02)
mat4.add_element("C", 1.596400e-02)
mat4.add_element("N", 2.266700e-05)
mat4.add_nuclide("O16", 1.235000e-02)
mat4.add_element("Na", 2.725600e-06)
mat4.add_element("Mg", 1.718800e-06)
mat4.add_element("K", 1.282100e-05)
mat4.add_element("Ca", 8.338600e-06)
...
# Bottom of polythene
surf3 = openmc.ZPlane(surface_id=3, z0=-31.4706)
# Top of core
surf4 = openmc.ZPlane(surface_id=4, z0=11.1506)
# Top of cadmium
surf5 = openmc.ZPlane(surface_id=5, z0=11.1887)
# Top of top reflector
surf6 = openmc.ZPlane(surface_id=6, z0=31.5087)
