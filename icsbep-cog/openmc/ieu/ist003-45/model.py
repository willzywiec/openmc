"""
IST003-45: 30F12 solution in unreflected 12-inch diameter cylinder with Cadmium screen
...
# Z2=Hc=b
surf3 = openmc.ZPlane(surface_id=3, z0=29.7948)
# SST/inner
...
# Dummy/bcd
surf8 = openmc.ZCylinder(surface_id=8, x0=-1.9999, y0=99.9999, r=19.9999, boundary_type="vacuum")
...
cell3.region = +surf4 & -surf5 & -surf7
...
source.space = openmc.stats.Point((0.0, 0.0, 14.8974))
