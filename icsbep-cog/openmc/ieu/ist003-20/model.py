"""
IST003-20: 30F18 solution in a water reflected 12-inch diameter cylinder
...
mat1.add_nuclide("U235", 1.063900e-04)
mat1.add_nuclide("U234", 1.234200e-06)
mat1.add_nuclide("U236", 2.447400e-07)
mat1.add_nuclide("U238", 2.401900e-04)
mat1.add_nuclide("H1", 6.551900e-02)
mat1.add_element("F", 6.961100e-04)
mat1.add_nuclide("O16", 3.345600e-02)
...
surf3_zmax = openmc.ZPlane(z0=47.0004)
...
source.space = openmc.stats.Point((0.0, 0.0, 23.5002))
