"""
IST003-43: 30F15 solution in unreflected 12-inch diameter cylinder
...
# Z2=Hc=b
surf3 = openmc.ZPlane(surface_id=3, z0=45.6990)
...
source.space = openmc.stats.Point((0.0, 0.0, 22.8495))
