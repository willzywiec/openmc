"""
IST003-4: 30F4 solution in a water reflected 16-inch diameter cylinder
...
surf3_zmax = openmc.ZPlane(z0=19.2556)
...
source.space = openmc.stats.Point((0.0, 0.0, 9.6278))
