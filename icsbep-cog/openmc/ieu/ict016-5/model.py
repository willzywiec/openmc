"""
ICT016-5: 22.86 x 22.86 x 24.0792 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - bare on top - batch 80C
...
surf1 = openmc.model.RectangularParallelepiped(-11.43, 11.43, -11.43, 11.43, -12.0396, 12.0396)
surf2 = openmc.model.RectangularParallelepiped(-31.75, 31.75, -31.75, 31.75, -32.3596, 32.3596, boundary_type="vacuum")
surf3 = openmc.ZPlane(surface_id=3, z0=12.0396)
