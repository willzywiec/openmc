"""
ICT016-14: 20.32 x 20.32 x 17.6276 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 15.24 cm Polythene on top - batch 40
...
surf1 = openmc.model.RectangularParallelepiped(-10.16, 10.16, -10.16, 10.16, -8.8138, 8.8138)
surf2 = openmc.model.RectangularParallelepiped(-30.48, 30.48, -30.48, 30.48, -29.1338, 29.1338, boundary_type="vacuum")
# Zo=(17.6276/2)+15.24
surf3 = openmc.ZPlane(surface_id=3, z0=24.0538)
