"""
ICT016-1: 20.32 x 20.32 x 21.3614 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - bare on top - batch 40
...
surf1 = openmc.model.RectangularParallelepiped(-10.16, 10.16, -10.16, 10.16, -10.6807, 10.6807)
surf2 = openmc.model.RectangularParallelepiped(-30.48, 30.48, -30.48, 30.48, -31.0007, 31.0007, boundary_type="vacuum")
surf3 = openmc.ZPlane(surface_id=3, z0=10.6807)
