"""
IST003-11: 30F9 solution in a water reflected 12-inch diameter cylinder
...
mat1.add_nuclide("H1", 5.703900e-02)
mat1.add_element("F", 4.602500e-03)
mat1.add_nuclide("O16", 3.312200e-02)
...
surf3_zmax = openmc.ZPlane(z0=22.6029)
...
source.space = openmc.stats.Point((0.0, 0.0, 11.30145))
