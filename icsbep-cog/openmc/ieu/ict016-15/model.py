"""
ICT016-15: 17.78 x 17.78 x 21.6662 (30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 2.54 cm Polythene on top - batch 80
...
surf1 = openmc.model.RectangularParallelepiped(-8.89, 8.89, -8.89, 8.89, -10.8331, 10.8331)
surf2 = openmc.model.RectangularParallelepiped(-29.21, 29.21, -29.21, 29.21, -31.1531, 31.1531, boundary_type="vacuum")
# Zo=(21.6662/2)+2.54
surf3 = openmc.ZPlane(surface_id=3, z0=13.3731)
