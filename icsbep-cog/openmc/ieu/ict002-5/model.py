...
# Al
surf401 = openmc.ZCylinder(surface_id=401, x0=4.3, y0=6.3, r=0.3)
# Al
surf402 = openmc.ZCylinder(surface_id=402, x0=6.3, y0=6.8, r=1.15)
# Al
surf403 = openmc.ZCylinder(surface_id=403, x0=6.8, y0=67.4, r=0.55)
# Al
surf404 = openmc.ZCylinder(surface_id=404, x0=67.4, y0=67.9, r=1.15)
# Al
surf405 = openmc.ZCylinder(surface_id=405, x0=67.9, y0=70.4, r=0.3)
# Absorber
surf406 = openmc.ZCylinder(surface_id=406, x0=11.9, y0=59.9, r=0.52)
# SST
surf407 = openmc.ZCylinder(surface_id=407, x0=10.9, y0=60.9, r=0.55)
# SST
surf408 = openmc.ZCylinder(surface_id=408, x0=9.9, y0=10.9, r=0.3)
# SST
surf409 = openmc.ZCylinder(surface_id=409, x0=60.9, y0=61.9, r=0.3)
# Unit boundary
surf410 = openmc.ZCylinder(surface_id=410, x0=4.3, y0=70.4, r=1.15)
# SST ring/inner
...
u3_cell2.region = +surf124 & -surf210 & -surf212 & -surf999 & +surf410
...
u5_cell0.region = -surf401
u5_cell1 = openmc.Cell(fill=mat3)
u5_cell1.region = +surf401 & -surf402
u5_cell2 = openmc.Cell(fill=mat3)
u5_cell2.region = +surf402 & -surf403 & +surf406 & +surf407 & +surf408 & +surf409
u5_cell3 = openmc.Cell(fill=mat3)
u5_cell3.region = +surf403 & -surf404
u5_cell4 = openmc.Cell(fill=mat3)
u5_cell4.region = +surf404 & -surf405
u5_cell5 = openmc.Cell(fill=mat5)
u5_cell5.region = -surf406
u5_cell6 = openmc.Cell(fill=mat2)
u5_cell6.region = -surf403 & +surf406 & -surf407 & +surf408 & +surf409
u5_cell7 = openmc.Cell(fill=mat2)
u5_cell7.region = -surf408
u5_cell8 = openmc.Cell(fill=mat2)
u5_cell8.region = -surf409
