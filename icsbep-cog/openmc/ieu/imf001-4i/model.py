"""
HEU-MET-FAST-001-4i: Idealized Model of Jemima Configuration #4 with Tu-Oy-Tu Disk Triplets, Fillers Out
...
mat3.add_nuclide("U234", 2.642800e-06)
mat3.add_nuclide("U235", 3.459700e-04)
mat3.add_nuclide("U238", 4.770200e-02)

# Oy
mat4 = openmc.Material(material_id=4)
mat4.set_density("sum")
mat4.add_nuclide("U234", 4.917500e-04)
mat4.add_nuclide("U235", 4.485100e-02)
mat4.add_nuclide("U238", 2.630600e-03)
...
surf54 = openmc.ZPlane(surface_id=54, z0=25.552)
surf55 = openmc.ZPlane(surface_id=55, z0=26.0050)
surf91 = openmc.ZCylinder(surface_id=91, r=1.11125)
...
cell1.region = -surf6 & +surf54 & -surf55 & +surf91

# Oy
cell2 = openmc.Cell(cell_id=2, fill=mat4)
cell2.region = -surf6 & +surf53 & -surf54 & +surf91

# Tu
cell3 = openmc.Cell(cell_id=3, fill=mat3)
cell3.region = -surf6 & +surf52 & -surf53 & +surf91

# Oy
cell4 = openmc.Cell(cell_id=4, fill=mat4)
cell4.region = -surf6 & +surf51 & -surf52 & +surf91

# Tu
cell5 = openmc.Cell(cell_id=5, fill=mat3)
cell5.region = -surf6 & +surf50 & -surf51 & +surf91

# Oy
cell6 = openmc.Cell(cell_id=6, fill=mat4)
cell6.region = -surf6 & +surf49 & -surf50 & +surf91

# Tu
cell7 = openmc.Cell(cell_id=7, fill=mat3)
cell7.region = -surf6 & +surf48 & -surf49 & +surf91

# Oy
cell8 = openmc.Cell(cell_id=8, fill=mat4)
cell8.region = -surf6 & +surf47 & -surf48 & +surf91

# Tu
cell9 = openmc.Cell(cell_id=9, fill=mat3)
cell9.region = -surf6 & +surf46 & -surf47 & +surf91

# Oy
cell10 = openmc.Cell(cell_id=10, fill=mat4)
cell10.region = -surf6 & +surf45 & -surf46 & +surf91

# Tu
cell11 = openmc.Cell(cell_id=11, fill=mat3)
cell11.region = -surf6 & +surf44 & -surf45 & +surf91

# Oy
cell12 = openmc.Cell(cell_id=12, fill=mat4)
cell12.region = -surf6 & +surf43 & -surf44 & +surf91

# Tu
cell13 = openmc.Cell(cell_id=13, fill=mat3)
cell13.region = -surf4 & +surf42 & -surf43 & +surf91

# Tu
cell14 = openmc.Cell(cell_id=14, fill=mat3)
cell14.region = -surf6 & +surf41 & -surf42 & +surf91

# Oy
cell15 = openmc.Cell(cell_id=15, fill=mat4)
cell15.region = -surf6 & +surf40 & -surf41 & +surf91

# Tu
cell16 = openmc.Cell(cell_id=16, fill=mat3)
cell16.region = -surf6 & +surf39 & -surf40 & +surf91

# Oy
cell17 = openmc.Cell(cell_id=17, fill=mat4)
cell17.region = -surf6 & +surf38 & -surf39 & +surf91

# Tu
cell18 = openmc.Cell(cell_id=18, fill=mat3)
cell18.region = -surf6 & +surf37 & -surf38 & +surf91

# Oy
cell19 = openmc.Cell(cell_id=19, fill=mat4)
cell19.region = -surf6 & +surf36 & -surf37 & +surf91

# Tu
cell20 = openmc.Cell(cell_id=20, fill=mat3)
cell20.region = -surf6 & +surf35 & -surf36 & +surf91

# Oy
cell21 = openmc.Cell(cell_id=21, fill=mat4)
cell21.region = -surf6 & +surf34 & -surf35 & +surf91

# Tu
cell22 = openmc.Cell(cell_id=22, fill=mat3)
cell22.region = -surf6 & +surf33 & -surf34 & +surf91

# Oy
cell23 = openmc.Cell(cell_id=23, fill=mat4)
cell23.region = -surf6 & +surf32 & -surf33 & +surf91

# Tu
cell24 = openmc.Cell(cell_id=24, fill=mat3)
cell24.region = -surf6 & +surf31 & -surf32 & +surf91

# Oy
cell25 = openmc.Cell(cell_id=25, fill=mat4)
cell25.region = -surf6 & +surf30 & -surf31 & +surf91

# Tu
cell26 = openmc.Cell(cell_id=26, fill=mat3)
cell26.region = -surf6 & +surf29 & -surf30 & +surf91

# Oy
cell27 = openmc.Cell(cell_id=27, fill=mat4)
cell27.region = -surf6 & +surf28 & -surf29 & +surf91

# Tu
cell28 = openmc.Cell(cell_id=28, fill=mat3)
cell28.region = -surf6 & +surf27 & -surf28 & +surf91

# Al
cell29 = openmc.Cell(cell_id=29, fill=mat1)
cell29.region = +surf4 & -surf8 & +surf42 & -surf43

# Al
cell30 = openmc.Cell(cell_id=30, fill=mat1)
cell30.region = +surf3 & -surf9 & +surf25 & -surf27

# Al
cell31 = openmc.Cell(cell_id=31, fill=mat1)
cell31.region = +surf6 & -surf7 & +surf23 & -surf25

# Al
cell32 = openmc.Cell(cell_id=32, fill=mat1)
cell32.region = +surf5 & -surf10 & +surf22 & -surf23

# Al
cell33 = openmc.Cell(cell_id=33, fill=mat1)
cell33.region = -surf1 & +surf24 & -surf26

# Al
cell34 = openmc.Cell(cell_id=34, fill=mat1)
cell34.region = -surf2 & +surf22 & -surf24

# SS
cell35 = openmc.Cell(cell_id=35, fill=mat2)
cell35.region = -surf11 & +surf21 & -surf22
