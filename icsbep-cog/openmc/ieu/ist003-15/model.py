"""
IST003-15: 30F13 solution in a water reflected 12-inch diameter cylinder
...
mat1.add_nuclide("U235", 3.752800e-04)
mat1.add_nuclide("U234", 4.353500e-06)
mat1.add_nuclide("U236", 8.633000e-07)
mat1.add_nuclide("U238", 8.472300e-04)
mat1.add_nuclide("H1", 6.191800e-02)
mat1.add_element("F", 2.455400e-03)
mat1.add_nuclide("O16", 3.341500e-02)
...
surf3_zmax = openmc.ZPlane(z0=22.4933)
...
source.space = openmc.stats.Point((0.0, 0.0, 11.24665))
