"""
IST003-24: 30F20 solution in a water reflected 12-inch diameter cylinder
...
mat1.add_nuclide("U235", 7.034200e-04)
mat1.add_nuclide("U234", 8.160100e-06)
mat1.add_nuclide("U236", 1.618200e-06)
mat1.add_nuclide("U238", 1.588000e-03)
mat1.add_nuclide("H1", 5.724000e-02)
mat1.add_element("F", 4.602500e-03)
mat1.add_nuclide("O16", 3.322200e-02)
...
surf3_zmax = openmc.ZPlane(z0=51.7592)
...
source.space = openmc.stats.Point((0.0, 0.0, 25.8796))
