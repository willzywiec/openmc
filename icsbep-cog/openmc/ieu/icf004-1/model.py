...
surf3 = openmc.ZCylinder(surface_id=3, r=96.82257)
...
surf3_zmin = openmc.ZPlane(z0=-85.09, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(z0=85.09, boundary_type="vacuum")
