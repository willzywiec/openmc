"""
IEU-MET-FAST-020-4s: Rev. 2: FR0 T3-S; simplified homogeous cylindrical benchmark
...
# (U20)
surf1 = openmc.ZCylinder(surface_id=1, r=16.712)
# Copper (CU)
surf2 = openmc.ZCylinder(surface_id=2, r=29.289)
# Void Region (VR)
surf3 = openmc.ZCylinder(surface_id=3, r=29.289)
# Inside End Blocks (IEB)
surf4 = openmc.ZCylinder(surface_id=4, r=29.289)
# Outside End Blocks (OEB)
surf5 = openmc.ZCylinder(surface_id=5, r=29.289)
# Locking rails
surf6 = openmc.ZCylinder(surface_id=6, r=29.289)
