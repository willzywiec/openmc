"""
IST003-2: 30F2 solution in a water reflected 16-inch diameter cylinder
...
mat1.add_nuclide("U235", 5.473000e-04)
mat1.add_nuclide("U234", 6.349100e-06)
mat1.add_nuclide("U236", 1.259000e-06)
mat1.add_nuclide("U238", 1.235600e-03)
mat1.add_nuclide("H1", 5.950100e-02)
mat1.add_element("F", 3.581000e-03)
...
surf3_zmax = openmc.ZPlane(z0=17.709)
...
source.space = openmc.stats.Point((0.0, 0.0, 8.8545))
