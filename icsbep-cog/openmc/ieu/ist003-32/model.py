"""
IST003-32: 30F2 solution in unreflected 16-inch diameter cylinder
...
# Z2=Hc=b
surf3 = openmc.ZPlane(surface_id=3, z0=19.6423)
...
source.space = openmc.stats.Point((0.0, 0.0, 9.82115))
