"""
IEU-MET-FAST-020-5: FR0 experiment T4a-D (case 5 detailed model)
...
# Array boundaries
surf11 = openmc.model.RectangularParallelepiped(-17.56333, 17.56333, -2.285, 2.285, -999.0, 999.0)
surf12 = openmc.model.RectangularParallelepiped(-15.995, 15.995, -6.855, 6.855, -999.0, 999.0)
surf13 = openmc.model.RectangularParallelepiped(-15.14333, 15.14333, -11.425, 11.425, -999.0, 999.0)
surf14 = openmc.model.RectangularParallelepiped(-11.425, 11.425, -15.14333, 15.14333, -999.0, 999.0)
surf15 = openmc.model.RectangularParallelepiped(-6.855, 6.855, -15.995, 15.995, -999.0, 999.0)
surf16 = openmc.model.RectangularParallelepiped(-2.285, 2.285, -17.56333, 17.56333, -999.0, 999.0)
...
lattice4.lower_left = [-29.705, -29.705]
...
lattice4.universes = [
    ...
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3],
    [universe1, universe1, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe1, universe3, universe3, universe3],
    [universe1, universe1, universe1, universe1, universe1, universe3, universe3, universe3, universe3, universe3, universe1, universe1, universe1],
    [universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe3, universe3, universe3, universe3, universe1, universe1],
    [universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe1, universe1, universe1, universe1, universe1, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe1],
]
universe4 = openmc.Universe(universe_id=4)
universe4.add_cell(openmc.Cell(fill=lattice4))

# Lattice 5: 13x13 array
lattice5 = openmc.RectLattice(lattice_id=5)
lattice5.lower_left = [-29.705, -29.705]
...
lattice5.universes = [
    ...
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3],
    [universe2, universe2, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe2, universe3, universe3, universe3],
    [universe2, universe2, universe2, universe2, universe2, universe3, universe3, universe3, universe3, universe3, universe2, universe2, universe2],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe3, universe3, universe3, universe3, universe2, universe2],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe2, universe2, universe2, universe2, universe2, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe2],
]
...
cell7.region = -surf20 & +surf11 & +surf12 & +surf13 & +surf14 & +surf15 & +surf16

# VrtSt
cell8 = openmc.Cell(cell_id=8, fill=mat6)
cell8.region = +surf20 & -surf21

# Table
cell9 = openmc.Cell(cell_id=9, fill=mat6)
cell9.region = +surf20 & +surf21 & -surf22 & -surf23
...
cell21.region = +surf6 & -surf7

# FeRail
cell26 = openmc.Cell(cell_id=26, fill=mat6)
cell26.region = +surf6 & -surf7

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell15, cell21, cell26])
