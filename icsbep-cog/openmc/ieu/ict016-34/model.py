"""
ICT016-34: 20.32 x 20.32 x 20.2184 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 0.0381 cm Cd plus 20.32 cm Polythene on top - batch 40
...
surf1 = openmc.model.RectangularParallelepiped(-10.16, 10.16, -10.16, 10.16, -10.1092, 10.1092)
surf2 = openmc.model.RectangularParallelepiped(-30.48, 30.48, -30.48, 30.48, -49.99995, 49.99995, boundary_type="vacuum")
# Bottom of polythene
surf3 = openmc.ZPlane(surface_id=3, z0=-30.4292)
# Top of core
surf4 = openmc.ZPlane(surface_id=4, z0=10.1092)
# Top of cadmium
surf5 = openmc.ZPlane(surface_id=5, z0=10.1473)
# Top of top reflector
surf6 = openmc.ZPlane(surface_id=6, z0=30.4673)
