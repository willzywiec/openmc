...
# (U20)
surf1 = openmc.ZCylinder(surface_id=1, r=18.173)
# Copper (CU)
surf2 = openmc.ZCylinder(surface_id=2, r=25.398)
# Void Region (VR)
surf3 = openmc.ZCylinder(surface_id=3, r=25.398)
# Inside End Blocks (IEB)
surf4 = openmc.ZCylinder(surface_id=4, r=25.398)
# Outside End Blocks (OEB)
surf5 = openmc.ZCylinder(surface_id=5, r=25.398)
# Locking rails
surf6 = openmc.ZCylinder(surface_id=6, r=25.398)
