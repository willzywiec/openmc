"""
IST003-30: 30F26 solution in a water reflected 12-inch diameter cylinder
...
mat1.add_nuclide("U235", 3.247500e-04)
mat1.add_nuclide("U234", 3.767300e-06)
mat1.add_nuclide("U236", 7.470700e-07)
mat1.add_nuclide("U238", 7.331500e-04)
mat1.add_nuclide("H1", 6.262300e-02)
mat1.add_element("F", 2.124800e-03)
mat1.add_nuclide("O16", 3.343600e-02)
...
# r=a
surf1 = openmc.ZCylinder(surface_id=1, r=10.1947)
# r=c; Z1=-d; Z2=e+91.44
surf2 = openmc.ZCylinder(surface_id=2, r=10.3573)
# Z2=Hc=b
surf3 = openmc.ZCylinder(surface_id=3, r=38.1)
# Arbitrary bcd
surf4 = openmc.ZCylinder(surface_id=4, r=99.9)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(z0=0.0)
surf1_zmax = openmc.ZPlane(z0=91.44)
surf2_zmin = openmc.ZPlane(z0=-2.0638)
surf2_zmax = openmc.ZPlane(z0=93.98)
surf3_zmin = openmc.ZPlane(z0=0.0)
surf3_zmax = openmc.ZPlane(z0=62.7849)
surf4_zmin = openmc.ZPlane(z0=-99.9, boundary_type="vacuum")
surf4_zmax = openmc.ZPlane(z0=99.9, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 31.39245))
