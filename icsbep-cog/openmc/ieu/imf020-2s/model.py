"""
IEU-MET-FAST-020-2s: Rev. 2: FR0 T1-S; simplified homogeous cylindrical benchmark
...
# (U20)
surf1 = openmc.ZCylinder(surface_id=1, r=15.896)
# Copper (CU)
surf2 = openmc.ZCylinder(surface_id=2, r=34.308)
# Void Region (VR)
surf3 = openmc.ZCylinder(surface_id=3, r=34.308)
# Inside End Blocks (IEB)
surf4 = openmc.ZCylinder(surface_id=4, r=34.308)
# Outside End Blocks (OEB)
surf5 = openmc.ZCylinder(surface_id=5, r=34.308)
# Locking rails
surf6 = openmc.ZCylinder(surface_id=6, r=34.308)
