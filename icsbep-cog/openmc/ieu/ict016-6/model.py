"""
ICT016-6: 22.86 x 22.86 x 19.8626 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 20.32 cm water on top - batch 16
...
surf1 = openmc.model.RectangularParallelepiped(-11.43, 11.43, -11.43, 11.43, -9.9313, 9.9313)
surf2 = openmc.model.RectangularParallelepiped(-31.75, 31.75, -31.75, 31.75, -30.2513, 30.2513, boundary_type="vacuum")
surf3 = openmc.ZPlane(surface_id=3, z0=9.9313)
