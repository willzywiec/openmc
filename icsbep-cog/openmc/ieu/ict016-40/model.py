"""
ICT016-40: 17.78 x 17.78 x 21.5392 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 0.0381 cm Cd plus 20.32 cm Concrete B on top - batch 80
...
mat4.add_nuclide("H1", 1.375000e-02)
mat4.add_element("C", 3.032500e-04)
mat4.add_nuclide("O16", 4.802300e-02)
mat4.add_element("Si", 1.762200e-02)
mat4.add_element("K", 8.089200e-05)
mat4.add_element("Ca", 2.942000e-03)
mat4.add_element("Fe", 4.549500e-04)
