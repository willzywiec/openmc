"""
IEU-SOL-THERM-002-4: Fully reflected 22-inch i.d. U(30.45) solution sphere
...
mat1.add_nuclide("U235", 5.531400e-05)
mat1.add_nuclide("U234", 6.932400e-07)
mat1.add_nuclide("U236", 1.447100e-07)
mat1.add_nuclide("U238", 1.239200e-04)
mat1.add_nuclide("H1", 6.605200e-02)
mat1.add_element("F", 3.601400e-04)
mat1.add_nuclide("O16", 3.338600e-02)
...
surf3_zmin = openmc.ZPlane(surface_id=1003, z0=-46.0428, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(surface_id=1004, z0=46.0428, boundary_type="vacuum")
