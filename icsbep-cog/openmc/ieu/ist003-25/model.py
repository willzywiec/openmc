"""
IST003-25: 30F23 solution in a water reflected 12-inch dimeter cylinder
...
mat1.add_nuclide("U235", 6.275900e-04)
mat1.add_nuclide("U234", 7.280500e-06)
mat1.add_nuclide("U236", 1.443700e-06)
mat1.add_nuclide("U238", 1.416800e-03)
mat1.add_nuclide("H1", 5.843300e-02)
mat1.add_element("F", 4.106300e-03)
mat1.add_nuclide("O16", 3.332300e-02)
...
surf3_zmax = openmc.ZPlane(z0=50.2279)
...
source.space = openmc.stats.Point((0.0, 0.0, 25.11395))
