"""
IST003-10: 30F30 solution in a water reflected 16-inch diameter cylinder
...
mat1.add_nuclide("U235", 8.774800e-05)
mat1.add_nuclide("U234", 1.017900e-06)
mat1.add_nuclide("U236", 2.018600e-07)
mat1.add_nuclide("U238", 1.981000e-04)
mat1.add_nuclide("H1", 6.566500e-02)
mat1.add_element("F", 5.741300e-03)
mat1.add_nuclide("O16", 3.340700e-02)
...
surf2_zmin = openmc.ZPlane(z0=-1.614)
surf2_zmax = openmc.ZPlane(z0=92.71)
surf3_zmin = openmc.ZPlane(z0=0.0)
surf3_zmax = openmc.ZPlane(z0=33.6328)
...
source.space = openmc.stats.Point((0.0, 0.0, 16.8164))
