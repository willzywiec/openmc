"""
IEU-MET-FAST-022-7: FR0 10-S; simplified homogeous cylindrical benchmark; C/X=0.4; H/X=0.8
...
mat1.add_element("C", 1.911500e-03)
mat1.add_element("H", 3.823000e-03)
mat1.add_element("Fe", 1.153500e-02)
mat1.add_nuclide("O16", 1.730500e-02)
...
# (U20)
surf1 = openmc.ZCylinder(surface_id=1, x0=-19.3545, y0=19.3545, r=20.465)
# Copper (CU)
