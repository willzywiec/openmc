"""
IEU-SOL-THERM-002-2: Fully reflected 13.75-inch i.d. U(30.45) solution sphere
...
mat1.add_nuclide("U235", 1.139000e-04)
mat1.add_nuclide("U234", 1.427600e-06)
mat1.add_nuclide("U236", 2.979800e-07)
mat1.add_nuclide("U238", 2.551800e-04)
mat1.add_nuclide("H1", 6.535300e-02)
mat1.add_element("F", 7.416200e-04)
...
surf3_zmin = openmc.ZPlane(surface_id=1003, z0=-35.5584, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(surface_id=1004, z0=35.5584, boundary_type="vacuum")
