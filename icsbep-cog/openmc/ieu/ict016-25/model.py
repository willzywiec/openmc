"""
ICT016-25: 17.78 x 17.78 x 20.1422 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 20.32 cm Paraffin Wax on top - batch 80
...
surf1 = openmc.model.RectangularParallelepiped(-8.89, 8.89, -8.89, 8.89, -10.0711, 10.0711)
surf2 = openmc.model.RectangularParallelepiped(-29.21, 29.21, -29.21, 29.21, -30.3911, 30.3911, boundary_type="vacuum")
surf3 = openmc.ZPlane(surface_id=3, z0=10.0711)
