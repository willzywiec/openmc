"""
ICT016-22: 22.86 x 22.86 x 25.8318 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 20.32 cm Perspex on top - batch 80L
...
surf1 = openmc.model.RectangularParallelepiped(-11.43, 11.43, -11.43, 11.43, -12.9159, 12.9159)
surf2 = openmc.model.RectangularParallelepiped(-31.75, 31.75, -31.75, 31.75, -33.2359, 33.2359, boundary_type="vacuum")
surf3 = openmc.ZPlane(surface_id=3, z0=12.9159)
