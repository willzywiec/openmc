"""
IEU-SOL-THERM-002-11: Partially reflected 22-inch i.d. U(30.45) solution sphere
...
mat1.add_nuclide("U235", 5.609400e-05)
mat1.add_nuclide("U234", 7.030200e-07)
mat1.add_nuclide("U236", 1.467500e-07)
mat1.add_nuclide("U238", 1.256700e-04)
mat1.add_nuclide("H1", 6.609900e-02)
mat1.add_element("F", 3.652200e-04)
...
# Z2=c+e
surf4 = openmc.ZPlane(surface_id=4, z0=27.9377)

# Z-plane surfaces for bounded cylinders
surf3_zmin = openmc.ZPlane(surface_id=1004, z0=-46.0428, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(surface_id=1005, z0=46.0428, boundary_type="vacuum")
