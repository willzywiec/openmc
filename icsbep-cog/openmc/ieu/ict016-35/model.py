"""
ICT016-35: 17.78 x 17.78 x 22.1996 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 0.0381 cm Cd plus 20.32 cm Polythene Wax on top - batch 80
...
surf1 = openmc.model.RectangularParallelepiped(-8.89, 8.89, -8.89, 8.89, -11.0998, 11.0998)
surf2 = openmc.model.RectangularParallelepiped(-29.21, 29.21, -29.21, 29.21, -49.99995, 49.99995, boundary_type="vacuum")
# Bottom of polythene
surf3 = openmc.ZPlane(surface_id=3, z0=-31.4198)
# Top of core
surf4 = openmc.ZPlane(surface_id=4, z0=11.0998)
# Top of cadmium
surf5 = openmc.ZPlane(surface_id=5, z0=11.1379)
# Top of top reflector
surf6 = openmc.ZPlane(surface_id=6, z0=31.4579)
