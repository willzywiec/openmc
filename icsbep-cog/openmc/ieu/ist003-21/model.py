"""
IST003-21: 30F19 solution in a water reflected 12-inch diameter cylinder
...
mat1.add_nuclide("U235", 1.017300e-04)
mat1.add_nuclide("U234", 1.180100e-06)
mat1.add_nuclide("U236", 2.340200e-07)
mat1.add_nuclide("U238", 2.296600e-04)
mat1.add_nuclide("H1", 6.550600e-02)
mat1.add_element("F", 6.656100e-04)
mat1.add_nuclide("O16", 3.341800e-02)
...
surf3_zmax = openmc.ZPlane(z0=51.2607)
...
source.space = openmc.stats.Point((0.0, 0.0, 25.63035))
