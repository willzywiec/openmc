"""
IST003-44: 30F17 solution in unreflected 12-inch diameter cylinder
...
# Z2=Hc=b
surf3 = openmc.ZPlane(surface_id=3, z0=57.1923)
...
source.space = openmc.stats.Point((0.0, 0.0, 28.59615))
