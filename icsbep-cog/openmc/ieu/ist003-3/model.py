"""
IST003-3: 30F3 solution in a water reflected 16-inch diameter cylinder
...
mat1.add_nuclide("U235", 3.651700e-04)
mat1.add_nuclide("U234", 4.236200e-06)
mat1.add_nuclide("U236", 8.400500e-07)
mat1.add_nuclide("U238", 8.244100e-04)
mat1.add_nuclide("H1", 6.264800e-02)
mat1.add_element("F", 2.389300e-03)
mat1.add_nuclide("O16", 3.371300e-02)
...
surf3_zmax = openmc.ZPlane(z0=17.941)
...
source.space = openmc.stats.Point((0.0, 0.0, 8.9705))
