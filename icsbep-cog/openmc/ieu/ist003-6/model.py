"""
IST003-6: 30F6 solution in a water reflected 16-inch diameter cylinder
...
mat1.add_nuclide("U235", 1.009500e-04)
mat1.add_nuclide("U234", 1.171100e-06)
mat1.add_nuclide("U236", 2.322300e-07)
mat1.add_nuclide("U238", 2.279100e-04)
mat1.add_nuclide("H1", 6.552600e-02)
mat1.add_element("F", 6.605300e-04)
mat1.add_nuclide("O16", 3.342300e-02)
...
surf3_zmax = openmc.ZPlane(z0=29.5408)
...
source.space = openmc.stats.Point((0.0, 0.0, 14.7704))
