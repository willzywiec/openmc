"""
IEU-SOL-THERM-002-3: Fully reflected 16-inch i.d. U(30.45) solution sphere
...
mat1.add_nuclide("U235", 8.347800e-05)
mat1.add_nuclide("U234", 1.046200e-06)
mat1.add_nuclide("U236", 2.183900e-07)
mat1.add_nuclide("U238", 1.870200e-04)
mat1.add_nuclide("H1", 6.579500e-02)
mat1.add_element("F", 5.435100e-04)
mat1.add_nuclide("O16", 3.344100e-02)
...
surf3_zmin = openmc.ZPlane(surface_id=1003, z0=-38.3798, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(surface_id=1004, z0=38.3798, boundary_type="vacuum")
