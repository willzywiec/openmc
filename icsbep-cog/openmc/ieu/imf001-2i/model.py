"""
IEU-MET-FAST-001-2i: Idealized Model of Jemima Configuration #2 with Oy-Tu Disk Pairs, Fillers Out
...
mat4.add_nuclide("U234", 4.915700e-04)
mat4.add_nuclide("U235", 4.482500e-02)
...
surf161 = openmc.ZPlane(surface_id=161, z0=15.488)
...
cell1.region = +surf101 & -surf105 & +surf2 & -surf12

# Tu
cell2 = openmc.Cell(cell_id=2, fill=mat3)
cell2.region = +surf105 & -surf106 & +surf2 & -surf12

# Oy
cell3 = openmc.Cell(cell_id=3, fill=mat4)
cell3.region = +surf106 & -surf109 & +surf2 & -surf12

# Tu
cell4 = openmc.Cell(cell_id=4, fill=mat3)
cell4.region = +surf109 & -surf110 & +surf2 & -surf12

# Oy
cell5 = openmc.Cell(cell_id=5, fill=mat4)
cell5.region = +surf110 & -surf113 & +surf2 & -surf12

# Tu
cell6 = openmc.Cell(cell_id=6, fill=mat3)
cell6.region = +surf113 & -surf114 & +surf2 & -surf12

# Oy
cell7 = openmc.Cell(cell_id=7, fill=mat4)
cell7.region = +surf114 & -surf117 & +surf2 & -surf12

# Tu
cell8 = openmc.Cell(cell_id=8, fill=mat3)
cell8.region = +surf117 & -surf118 & +surf2 & -surf12

# Oy
cell9 = openmc.Cell(cell_id=9, fill=mat4)
cell9.region = +surf118 & -surf121 & +surf2 & -surf12

# Tu
cell10 = openmc.Cell(cell_id=10, fill=mat3)
cell10.region = +surf121 & -surf122 & +surf2 & -surf12

# Oy
cell11 = openmc.Cell(cell_id=11, fill=mat4)
cell11.region = +surf122 & -surf125 & +surf2 & -surf12

# Tu
cell12 = openmc.Cell(cell_id=12, fill=mat3)
cell12.region = +surf125 & -surf126 & +surf2 & -surf12

# Oy
cell13 = openmc.Cell(cell_id=13, fill=mat4)
cell13.region = +surf126 & -surf129 & +surf2 & -surf12

# Tu
cell14 = openmc.Cell(cell_id=14, fill=mat3)
cell14.region = +surf129 & -surf131 & -surf10

# Oy
cell15 = openmc.Cell(cell_id=15, fill=mat4)
cell15.region = +surf131 & -surf134 & -surf12

# Tu
cell16 = openmc.Cell(cell_id=16, fill=mat3)
cell16.region = +surf134 & -surf136 & -surf12

# Oy
cell17 = openmc.Cell(cell_id=17, fill=mat4)
cell17.region = +surf136 & -surf138 & -surf12

# Tu
cell18 = openmc.Cell(cell_id=18, fill=mat3)
cell18.region = +surf138 & -surf140 & -surf12

# Oy
cell19 = openmc.Cell(cell_id=19, fill=mat4)
cell19.region = +surf140 & -surf142 & -surf12

# Tu
cell20 = openmc.Cell(cell_id=20, fill=mat3)
cell20.region = +surf142 & -surf144 & -surf12

# Oy
cell21 = openmc.Cell(cell_id=21, fill=mat4)
cell21.region = +surf144 & -surf146 & -surf12

# Tu
cell22 = openmc.Cell(cell_id=22, fill=mat3)
cell22.region = +surf146 & -surf161 & -surf12

# Al
cell23 = openmc.Cell(cell_id=23, fill=mat1)
cell23.region = +surf129 & -surf131 & +surf10 & -surf17

# Al
cell24 = openmc.Cell(cell_id=24, fill=mat1)
cell24.region = +surf202 & -surf101 & +surf8 & -surf18

# Al
cell25 = openmc.Cell(cell_id=25, fill=mat1)
cell25.region = +surf203 & -surf201 & -surf3

# Al
cell26 = openmc.Cell(cell_id=26, fill=mat1)
cell26.region = +surf205 & -surf203 & -surf7

# Al
cell27 = openmc.Cell(cell_id=27, fill=mat1)
cell27.region = +surf204 & -surf202 & +surf12 & -surf14

# Al
cell28 = openmc.Cell(cell_id=28, fill=mat1)
cell28.region = +surf205 & -surf204 & +surf11 & -surf19

# SS
cell29 = openmc.Cell(cell_id=29, fill=mat2)
cell29.region = +surf206 & -surf205 & -surf20
