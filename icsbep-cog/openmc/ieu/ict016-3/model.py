"""
ICT016-3: 20.32 x 20.32 x 19.0500 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - bare on top - batch 80
...
surf1 = openmc.model.RectangularParallelepiped(-10.16, 10.16, -10.16, 10.16, -9.525, 9.525)
surf2 = openmc.model.RectangularParallelepiped(-30.48, 30.48, -30.48, 30.48, -29.845, 29.845, boundary_type="vacuum")
surf3 = openmc.ZPlane(surface_id=3, z0=9.525)
