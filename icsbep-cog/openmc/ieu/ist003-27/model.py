"""
IST003-27: 30F22 solution in a water reflected 12-inch diameter cylinder
...
mat1.add_nuclide("U235", 5.268900e-04)
mat1.add_nuclide("U234", 6.112300e-06)
mat1.add_nuclide("U236", 1.212100e-06)
mat1.add_nuclide("U238", 1.189500e-03)
mat1.add_nuclide("H1", 5.973600e-02)
mat1.add_element("F", 3.447400e-03)
mat1.add_nuclide("O16", 3.331500e-02)
...
surf3_zmax = openmc.ZPlane(z0=49.9216)
