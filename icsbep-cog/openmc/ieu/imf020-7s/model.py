...
# (U20)
surf1 = openmc.ZCylinder(surface_id=1, x0=-15.0535, y0=15.0535, r=19.24)
# Copper (CU)
surf2 = openmc.ZCylinder(surface_id=2, x0=-55.9035, y0=55.9035, r=24.328)
# Void Region (VR)
surf3 = openmc.ZCylinder(surface_id=3, x0=-57.4535, y0=58.2465, r=24.328)
# Inside End Blocks (IEB)
surf4 = openmc.ZCylinder(surface_id=4, x0=-59.7535, y0=60.2465, r=24.328)
# Outside End Blocks (OEB)
surf5 = openmc.ZCylinder(surface_id=5, x0=-61.5535, y0=61.9465, r=24.328)
# Locking rails
surf6 = openmc.ZCylinder(surface_id=6, x0=61.9465, y0=64.7465, r=24.328)
