"""
IEU-MET-FAST-020-7s: Rev. 2: FR0 T6a-S; simplified homogeous cylindrical benchmark
...
# (U20)
surf1 = openmc.ZCylinder(surface_id=1, r=19.24)
# Copper (CU)
surf2 = openmc.ZCylinder(surface_id=2, r=24.328)
# Void Region (VR)
surf3 = openmc.ZCylinder(surface_id=3, r=24.328)
# Inside End Blocks (IEB)
surf4 = openmc.ZCylinder(surface_id=4, r=24.328)
# Outside End Blocks (OEB)
surf5 = openmc.ZCylinder(surface_id=5, r=24.328)
# Locking rails
surf6 = openmc.ZCylinder(surface_id=6, r=24.328)
