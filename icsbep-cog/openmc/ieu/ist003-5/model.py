"""
IST003-5: 30F5 solution in a water reflected 16-inch diameter cylinder
...
mat1.add_nuclide("U235", 1.498900e-04)
mat1.add_nuclide("U234", 1.738900e-06)
mat1.add_nuclide("U236", 3.448200e-07)
mat1.add_nuclide("U238", 3.384000e-04)
mat1.add_nuclide("H1", 6.499900e-02)
mat1.add_element("F", 9.807500e-04)
mat1.add_nuclide("O16", 3.348000e-02)
...
surf3_zmax = openmc.ZPlane(z0=22.6583)
...
source.space = openmc.stats.Point((0.0, 0.0, 11.32915))
