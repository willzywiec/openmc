"""
IST003-29: 30F25 solution in a water reflected 12-inch diameter cylinder
...
mat1.add_nuclide("U235", 3.900500e-04)
mat1.add_nuclide("U234", 4.524800e-06)
mat1.add_nuclide("U236", 8.972800e-07)
mat1.add_nuclide("U238", 8.805700e-04)
mat1.add_nuclide("H1", 6.187100e-02)
mat1.add_element("F", 2.552100e-03)
mat1.add_nuclide("O16", 3.348800e-02)
...
surf3_zmax = openmc.ZPlane(z0=54.5157)
...
source.space = openmc.stats.Point((0.0, 0.0, 27.25785))
