...
surf401_zmin = openmc.ZPlane(z0=4.3)
surf401_zmax = openmc.ZPlane(z0=6.3)
surf402_zmin = openmc.ZPlane(z0=6.3)
surf402_zmax = openmc.ZPlane(z0=6.8)
surf403_zmin = openmc.ZPlane(z0=6.8)
surf403_zmax = openmc.ZPlane(z0=67.4)
surf404_zmin = openmc.ZPlane(z0=67.4)
surf404_zmax = openmc.ZPlane(z0=67.9)
surf405_zmin = openmc.ZPlane(z0=67.9)
surf405_zmax = openmc.ZPlane(z0=70.4)
surf406_zmin = openmc.ZPlane(z0=11.9)
surf406_zmax = openmc.ZPlane(z0=59.9)
surf407_zmin = openmc.ZPlane(z0=10.9)
surf407_zmax = openmc.ZPlane(z0=60.9)
surf408_zmin = openmc.ZPlane(z0=9.9)
surf408_zmax = openmc.ZPlane(z0=10.9)
surf409_zmin = openmc.ZPlane(z0=60.9)
surf409_zmax = openmc.ZPlane(z0=61.9)
surf410_zmin = openmc.ZPlane(z0=4.3)
surf410_zmax = openmc.ZPlane(z0=70.4)
