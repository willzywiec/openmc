"""
IEU-COMP-THERM-002-3: U(17)O2 annular fuel rods with 6.8 cm pitch; Gd absorbers; 16.4 C
...
# Water at 16.4 C, 0.1 MPa
mat4 = openmc.Material(material_id=4)
mat4.set_density("sum")
mat4.add_nuclide("H1", 6.677600e-02)
mat4.add_nuclide("O16", 3.338800e-02)
mat4.add_s_alpha_beta("c_H_in_H2O")

# Gadolinium absorber
mat5 = openmc.Material(material_id=5)
mat5.set_density("sum")
mat5.add_element("Gd", 2.159300e-03)
mat5.add_element("Al", 1.477500e-02)
mat5.add_nuclide("O16", 2.540100e-02)
...
# Hole in the upper lattice plate and unit boundary
surf303 = openmc.ZCylinder(surface_id=303, r=1.6)
# Al
surf401 = openmc.ZCylinder(surface_id=401, r=0.3)
# Al
surf402 = openmc.ZCylinder(surface_id=402, r=1.15)
# Al
surf403 = openmc.ZCylinder(surface_id=403, r=0.55)
# Al
surf404 = openmc.ZCylinder(surface_id=404, r=1.15)
# Al
surf405 = openmc.ZCylinder(surface_id=405, r=0.3)
# Absorber
surf406 = openmc.ZCylinder(surface_id=406, r=0.52)
# SST
surf407 = openmc.ZCylinder(surface_id=407, r=0.55)
# SST
surf408 = openmc.ZCylinder(surface_id=408, r=0.3)
# SST
surf409 = openmc.ZCylinder(surface_id=409, r=0.3)
# Unit boundary
surf410 = openmc.ZCylinder(surface_id=410, r=1.15)
# SST ring/inner
...
surf401_zmin = openmc.ZPlane(surface_id=2003, z0=4.3)
surf401_zmax = openmc.ZPlane(surface_id=2004, z0=6.3)
surf402_zmin = openmc.ZPlane(surface_id=2005, z0=6.3)
surf402_zmax = openmc.ZPlane(surface_id=2006, z0=6.8)
surf403_zmin = openmc.ZPlane(surface_id=2007, z0=6.8)
surf403_zmax = openmc.ZPlane(surface_id=2008, z0=67.4)
surf404_zmin = openmc.ZPlane(surface_id=2009, z0=67.4)
surf404_zmax = openmc.ZPlane(surface_id=2010, z0=67.9)
surf405_zmin = openmc.ZPlane(surface_id=2011, z0=67.9)
surf405_zmax = openmc.ZPlane(surface_id=2012, z0=70.4)
surf406_zmin = openmc.ZPlane(surface_id=2013, z0=11.9)
surf406_zmax = openmc.ZPlane(surface_id=2014, z0=59.9)
surf407_zmin = openmc.ZPlane(surface_id=2015, z0=10.9)
surf407_zmax = openmc.ZPlane(surface_id=2016, z0=60.9)
surf408_zmin = openmc.ZPlane(surface_id=2017, z0=9.9)
surf408_zmax = openmc.ZPlane(surface_id=2018, z0=10.9)
surf409_zmin = openmc.ZPlane(surface_id=2019, z0=60.9)
surf409_zmax = openmc.ZPlane(surface_id=2020, z0=61.9)
surf410_zmin = openmc.ZPlane(surface_id=2021, z0=4.3)
surf410_zmax = openmc.ZPlane(surface_id=2022, z0=70.4)
surf902_zmin = openmc.ZPlane(surface_id=2023, z0=-19.0)
surf902_zmax = openmc.ZPlane(surface_id=2024, z0=0.0)
surf903_zmin = openmc.ZPlane(surface_id=2025, z0=0.0)
surf903_zmax = openmc.ZPlane(surface_id=2026, z0=3.5)
surf904_zmin = openmc.ZPlane(surface_id=2027, z0=66.8)
surf904_zmax = openmc.ZPlane(surface_id=2028, z0=68.8)
surf999_zmin = openmc.ZPlane(surface_id=2029, z0=-19.0, boundary_type="vacuum")
surf999_zmax = openmc.ZPlane(surface_id=2030, z0=106.0, boundary_type="vacuum")
...
u3_cell2.region = +surf124 & -surf210 & -surf212 & (-surf999 & +surf999_zmin & -surf999_zmax) & (+surf410 | -surf410_zmin | +surf410_zmax)
...
u5_cell0.region = (-surf401 & +surf401_zmin & -surf401_zmax)
u5_cell1 = openmc.Cell(fill=mat3)
u5_cell1.region = (+surf401 | -surf401_zmin | +surf401_zmax) & (-surf402 & +surf402_zmin & -surf402_zmax)
u5_cell2 = openmc.Cell(fill=mat3)
u5_cell2.region = (+surf402 | -surf402_zmin | +surf402_zmax) & (-surf403 & +surf403_zmin & -surf403_zmax) & (+surf406 | -surf406_zmin | +surf406_zmax) & (+surf407 | -surf407_zmin | +surf407_zmax) & (+surf408 | -surf408_zmin | +surf408_zmax) & (+surf409 | -surf409_zmin | +surf409_zmax)
u5_cell3 = openmc.Cell(fill=mat3)
u5_cell3.region = (+surf403 | -surf403_zmin | +surf403_zmax) & (-surf404 & +surf404_zmin & -surf404_zmax)
u5_cell4 = openmc.Cell(fill=mat3)
u5_cell4.region = (+surf404 | -surf404_zmin | +surf404_zmax) & (-surf405 & +surf405_zmin & -surf405_zmax)
u5_cell5 = openmc.Cell(fill=mat5)
u5_cell5.region = (-surf406 & +surf406_zmin & -surf406_zmax)
u5_cell6 = openmc.Cell(fill=mat2)
u5_cell6.region = (-surf403 & +surf403_zmin & -surf403_zmax) & (+surf406 | -surf406_zmin | +surf406_zmax) & (-surf407 & +surf407_zmin & -surf407_zmax) & (+surf408 | -surf408_zmin | +surf408_zmax) & (+surf409 | -surf409_zmin | +surf409_zmax)
u5_cell7 = openmc.Cell(fill=mat2)
u5_cell7.region = (-surf408 & +surf408_zmin & -surf408_zmax)
u5_cell8 = openmc.Cell(fill=mat2)
u5_cell8.region = (-surf409 & +surf409_zmin & -surf409_zmax)
