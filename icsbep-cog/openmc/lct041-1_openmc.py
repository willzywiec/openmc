"""
LCT041-1: CRISTO II Configuration A
...
# Reflector
surf6 = openmc.model.RectangularParallelepiped(-110.6, 110.6, -110.6, 110.6, -110.6, 110.6, boundary_type="reflecting")
...
cell6.region = +surf2 & -surf5

# H2O
cell10 = openmc.Cell(cell_id=10, fill=mat4)
cell10.region = +surf4 & -surf5

root_universe = openmc.Universe(cells=[cell1, cell2, cell6, cell10])
