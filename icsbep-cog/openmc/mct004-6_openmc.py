"""
MIX-COMP-THERM-004-6: 21x21 MOX pins with 1.956 cm pitch; Hc=69.40
...
mat1.add_nuclide("Pu241", 2.422800e-05)
mat1.add_nuclide("Pu242", 8.123400e-06)
mat1.add_nuclide("Am241", 5.054300e-06)
...
# Water height
surf11 = openmc.ZPlane(surface_id=11, z0=69.40)
# Al lower grid, top
...
source.space = openmc.stats.Point((0.0, 0.0, 34.7))
