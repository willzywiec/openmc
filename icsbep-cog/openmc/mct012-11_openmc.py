"""
MCT012-11: MOX/Polystyrene (H/SQRT(LxW)=0.40) with H/X=705 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.54, 30.54, -27.94, 27.94, -11.61, 11.61)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.78, 45.78, -43.18, 43.18, -26.85, 26.85, boundary_type="vacuum")
