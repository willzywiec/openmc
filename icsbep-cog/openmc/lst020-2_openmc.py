"""
LST020-2: Water reflected 80-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=1,054 (Run 217)
...
mat1.add_nuclide("U234", 4.641900e-07)
mat1.add_nuclide("U235", 5.760200e-05)
mat1.add_nuclide("U236", 5.753100e-08)
mat1.add_nuclide("U238", 5.130700e-04)
mat1.add_nuclide("H1", 6.070800e-02)
mat1.add_element("N", 1.726500e-03)
mat1.add_nuclide("O16", 3.638400e-02)
...
mat4.add_element("N", 3.901400e-05)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=47.87)
...
source.space = openmc.stats.Point((0.0, 0.0, 23.935))
