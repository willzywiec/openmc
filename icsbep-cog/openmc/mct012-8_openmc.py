"""
MCT012-8: MOX/Polystyrene (H/SQRT(LxW)=0.52) with H/X=705 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-25.45, 25.45, -25.4, 25.4, -13.2, 13.2)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-40.69, 40.69, -40.64, 40.64, -28.44, 28.44, boundary_type="vacuum")
