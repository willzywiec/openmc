"""
LCT037-3: 12x36 array of 432 U(4.738)O2 fuel rods with 1.60 cm square pitch with 10.0 cm concrete screen
...
# Water
surf7 = openmc.ZPlane(surface_id=7, z0=54.23)
# Dummy
...
# Tank wall
surf24 = openmc.model.RectangularParallelepiped(10.1, 10.4, -65.0, 65.0, -24.0, 116.0)
# AG3M pedestal plate
surf31 = openmc.model.RectangularParallelepiped(-175.6, 10.400000000000006, -93.0, 93.0, -4.0, -3.0)
# SST  pedestal plate
surf32 = openmc.model.RectangularParallelepiped(-175.6, 10.400000000000006, -93.0, 93.0, -6.5, -4.0)
# Entire problem
surf99 = openmc.model.RectangularParallelepiped(-49.2, 10.400000000000002, -65.05, 65.05, -24.0, 116.1, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-19.4, -1.8, 26.115), (0.19999999999999996, 1.8, 28.115))
