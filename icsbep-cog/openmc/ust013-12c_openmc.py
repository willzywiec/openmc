"""
U233-SOL-THERM-013: Case No. 12 (Experment No. 131)
...
mat1.add_nuclide("U232", 2.249500e-09)
mat1.add_nuclide("U233", 3.376600e-04)
mat1.add_nuclide("U234", 3.609000e-06)
mat1.add_nuclide("U235", 8.923900e-08)
mat1.add_nuclide("U236", 3.417700e-09)
mat1.add_nuclide("U238", 4.697000e-06)
mat1.add_element("Th", 4.341600e-06)
mat1.add_nuclide("H1", 6.337500e-02)
mat1.add_element("N", 8.006000e-04)
mat1.add_nuclide("O16", 3.473500e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=27.445)
