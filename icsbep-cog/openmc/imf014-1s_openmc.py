...
surf4 = openmc.ZPlane(surface_id=4, z0=0.000)
...
cell2.region = -surf2 & +surf5 & -surf6

# AR2
cell3 = openmc.Cell(cell_id=3, fill=mat3)
cell3.region = -surf2 & +surf6 & -surf7

# RR1
cell4 = openmc.Cell(cell_id=4, fill=mat4)
cell4.region = +surf1 & -surf3 & +surf4 & -surf5

# RR2
cell5 = openmc.Cell(cell_id=5, fill=mat5)
cell5.region = +surf2 & -surf3 & +surf5 & -surf7
