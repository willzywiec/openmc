"""
LCT040-10: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.65cm Boral, 2.0cm water gap, Hc=61.84cm, 2.5cm gap between steel reflector
...
surf5 = openmc.ZPlane(surface_id=5, z0=61.84)
# Lower grid plate
...
# Inner: 2(2.5)+4(0.65)+18(2)(1.6)+2.0 = 67.20
surf51 = openmc.model.RectangularParallelepiped(-33.6, 33.6, -33.6, 33.6, -2.200000000000003, 92.8)
# Outer: 2(15.0) + 67.20 = 97.20
surf52 = openmc.model.RectangularParallelepiped(-48.6, 48.6, -48.6, 48.6, -2.200000000000003, 92.8)
...
source.space = openmc.stats.Box((-30.65, -30.65, 29.92), (30.65, 30.65, 31.92))
