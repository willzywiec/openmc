"""
LST011-4: Water reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=954 (Run 470)
...
mat1.add_nuclide("U234", 5.003400e-07)
mat1.add_nuclide("U235", 5.988400e-05)
mat1.add_nuclide("U236", 9.921800e-08)
mat1.add_nuclide("U238", 9.241000e-04)
mat1.add_nuclide("H1", 5.714100e-02)
mat1.add_element("N", 2.577400e-03)
mat1.add_nuclide("O16", 3.796800e-02)
...
source.space = openmc.stats.Point((0.0, 0.0, 33.335))
