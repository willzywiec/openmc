"""
MCT012-2: MOX/Polystyrene (H/SQRT(LxW)=0.52) with H/X=343 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.54, 30.54, -30.54, 30.54, -15.9, 15.9)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.78, 45.78, -45.78, 45.78, -31.14, 31.14, boundary_type="vacuum")
