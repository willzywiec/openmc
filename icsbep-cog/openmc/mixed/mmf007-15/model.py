"""
MixMF007-15: 3.933 kg alpha-Pu; 1.428 kg HEU; 8.37 cm Be
...
# HEU
surf2 = openmc.Sphere(surface_id=2, r=4.0637)
# Be
surf3 = openmc.Sphere(surface_id=3, r=12.4337, boundary_type="vacuum")
