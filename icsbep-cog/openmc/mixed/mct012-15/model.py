"""
MCT012-15: MOX/Polystyrene (H/SQRT(LxW)=0.59) with H/X=226 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.36, 20.36, -11.92, 11.92)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.6, 35.6, -27.16, 27.16, boundary_type="vacuum")
