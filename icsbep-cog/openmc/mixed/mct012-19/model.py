"""
MCT012-19: MOX/Polystyrene (H/SQRT(LxW)=0.27) with H/X=226 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.54, 30.54, -30.54, 30.54, -8.315, 8.315)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.78, 45.78, -45.78, 45.78, -23.555, 23.555, boundary_type="vacuum")
