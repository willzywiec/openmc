"""
MixMF007-4: 2.472 kg alpha-Pu; 8.340 kg HEU; 5.60 cm Be
...
# HEU
surf2 = openmc.Sphere(surface_id=2, r=5.1639)
# Be
surf3 = openmc.Sphere(surface_id=3, r=10.7639, boundary_type="vacuum")
