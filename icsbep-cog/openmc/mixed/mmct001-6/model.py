"""
MMCT001-6: Experiment 112 with 996 FFTF rods immersed in 103.18 gPu/l, 360.62 gU/l and 0.49 gGd/l solution
...
mat9.add_nuclide("H1", 6.674900e-02)
mat9.add_nuclide("O16", 3.337400e-02)
mat9.add_s_alpha_beta("c_H_in_H2O")

# Plutonium-uranium
mat10 = openmc.Material(material_id=10)
mat10.set_density("sum")
mat10.add_nuclide("Pu238", 1.057100e-07)
mat10.add_nuclide("Pu239", 2.368300e-04)
mat10.add_nuclide("Pu240", 2.156200e-05)
mat10.add_nuclide("Pu241", 1.080000e-06)
mat10.add_nuclide("Pu242", 2.451500e-07)
mat10.add_nuclide("Am241", 1.424300e-06)
mat10.add_nuclide("U238", 9.052800e-04)
mat10.add_nuclide("U236", 4.876200e-07)
mat10.add_nuclide("U235", 6.532300e-06)
mat10.add_nuclide("U234", 6.495400e-08)
mat10.add_nuclide("H1", 5.552500e-02)
mat10.add_element("N", 3.255500e-03)
mat10.add_element("Gd", 1.876500e-06)
mat10.add_nuclide("O16", 3.915800e-02)
mat10.add_element("B", 1.022600e-07)
mat10.add_element("Mn", 1.908700e-07)
mat10.add_element("Cd", 3.158200e-08)
mat10.add_element("Fe", 4.087800e-06)
...
# Solution height (case 112)
surf9 = openmc.ZPlane(surface_id=9, z0=30.28)
# SS316 clad, inner
...
source.space = openmc.stats.Box((-1.7, -1.7, 36.246), (1.7, 1.7, 38.246))
