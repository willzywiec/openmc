"""
MST010-2: Exp. 138 with H/X=284 and 0.04 gGd/L and 0.1 gB/L
...
mat1.add_nuclide("Pu238", 3.437900e-08)
mat1.add_nuclide("Pu239", 1.991600e-04)
mat1.add_nuclide("Pu240", 1.353000e-05)
mat1.add_nuclide("Pu241", 1.069400e-06)
mat1.add_nuclide("Pu242", 1.014300e-07)
mat1.add_nuclide("U234", 2.812100e-08)
mat1.add_nuclide("U235", 3.061400e-06)
mat1.add_nuclide("U236", 5.576400e-08)
mat1.add_nuclide("U238", 4.576800e-04)
mat1.add_nuclide("Am241", 2.613200e-08)
mat1.add_nuclide("H1", 5.782600e-02)
mat1.add_element("N", 2.816600e-03)
mat1.add_nuclide("O16", 3.780800e-02)
...
mat1.add_nuclide("B10", 1.102800e-06)
mat1.add_nuclide("B11", 4.467000e-06)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=18.65)
# Solution tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 9.325))
