"""
MCT012-28: MOX/Polystyrene (H/SQRT(LxW)=0.26) with H/X=172 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.545, 30.545, -27.995, 27.995, -7.58, 7.58)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.785, 45.785, -43.235, 43.235, -22.82, 22.82, boundary_type="vacuum")
