"""
MST006-5: 3-D Model of Exp't No. 2251 with H/X=297 and 0.647 gGd/L
...
mat1.add_nuclide("Pu238", 5.299200e-07)
mat1.add_nuclide("Pu239", 1.753500e-04)
mat1.add_nuclide("Pu240", 4.731200e-05)
mat1.add_nuclide("Pu241", 6.702100e-06)
mat1.add_nuclide("Pu242", 2.486700e-06)
mat1.add_nuclide("Am241", 1.469700e-06)
mat1.add_nuclide("U234", 6.584100e-08)
mat1.add_nuclide("U235", 2.699500e-06)
mat1.add_nuclide("U236", 2.578800e-07)
mat1.add_nuclide("U238", 5.456500e-04)
mat1.add_element("N", 3.849600e-03)
mat1.add_nuclide("O16", 3.919700e-02)
mat1.add_nuclide("H1", 5.482600e-02)
...
mat1.add_element("Gd", 2.472900e-06)
...
mat4.add_nuclide("H1", 6.671300e-02)
mat4.add_nuclide("O16", 3.335600e-02)
...
# Critical height
surf4 = openmc.ZPlane(surface_id=4, z0=77.09)
...
source.space = openmc.stats.Point((0.0, 0.0, 38.545))
