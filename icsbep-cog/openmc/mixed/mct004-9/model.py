"""
MIX-COMP-THERM-004-9: 20x20 MOX pins with 2.225 cm pitch; Hc=65.63
...
mat1.add_nuclide("Pu241", 2.537300e-05)
mat1.add_nuclide("Pu242", 8.123400e-06)
mat1.add_nuclide("Am241", 3.909800e-06)
...
# Water height
surf11 = openmc.ZPlane(surface_id=11, z0=65.63)
# Al lower grid, top
...
source.space = openmc.stats.Box((-2.1, -2.1, 31.814999999999998), (2.1, 2.1, 33.815))
