"""
MIX-MET-FAST-002-2: Composite core of Ni-clad a-Pu(4.73) and HEU reflected by Nat-U
...
mat1.add_nuclide("Pu239", 4.645100e-02)
mat1.add_nuclide("Pu240", 2.313500e-03)
mat1.add_nuclide("Pu241", 1.467300e-04)
...
surf4 = openmc.Sphere(surface_id=4, r=5.2451)
surf5 = openmc.Sphere(surface_id=5, r=24.1173, boundary_type="vacuum")
