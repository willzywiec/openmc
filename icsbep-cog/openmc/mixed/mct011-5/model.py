"""
MCT011-5: 139 Rapsodie pins with 2.5 cm pitch and Hc = 33.06 cm
...
surf9 = openmc.ZPlane(surface_id=9, z0=33.06)
...
surf31 = openmc.model.RectangularParallelepiped(-2.5, 2.5, -16.238, 16.238, -499.9995, 499.9995)
# Inner X-Y prism for fuel
surf32 = openmc.model.RectangularParallelepiped(-2.5, 2.5, -16.238, 16.238, -499.9995, 499.9995)
# Inner X-Y prism for fuel
surf33 = openmc.model.RectangularParallelepiped(-2.5, 2.5, -16.238, 16.238, -499.9995, 499.9995)
