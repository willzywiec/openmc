"""
MCT012-30: MOX/Polystyrene (H/SQRT(LxW)=0.32) with H/X=172 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-25.45, 25.45, -25.45, 25.45, -8.245, 8.245)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-40.69, 40.69, -40.69, 40.69, -23.485, 23.485, boundary_type="vacuum")
