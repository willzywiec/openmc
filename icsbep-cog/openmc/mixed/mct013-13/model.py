"""
MCT013-13: MOX/Polystyrene with H/X=226 with 0.34 SST-1.6B absorber and 15.24cm Lucite reflector
...
mat2.add_nuclide("B10", 1.220100e-03)
mat2.add_nuclide("B11", 4.910900e-03)
mat2.add_element("Fe", 5.333500e-02)
mat2.add_element("Cr", 1.393600e-02)
mat2.add_element("Ni", 5.486400e-03)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 0.34 + 17.2829 = 32.2943 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.6714, 17.6229)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=0.34)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.911399999999997, 32.862899999999996, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 9.98))
