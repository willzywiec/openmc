"""
MIX-SOL-THERM-004-9: Exp. No. 083 with 173.22 gPu/l and 262.88 gU/L with 1.22M
...
mat1.add_nuclide("Pu238", 1.270800e-07)
mat1.add_nuclide("Pu239", 3.976100e-04)
mat1.add_nuclide("Pu240", 3.611100e-05)
mat1.add_nuclide("Pu241", 1.947300e-06)
mat1.add_nuclide("Pu242", 4.007800e-07)
mat1.add_nuclide("U234", 4.734900e-08)
mat1.add_nuclide("U235", 3.798700e-06)
mat1.add_nuclide("U236", 1.542500e-07)
mat1.add_nuclide("U238", 6.610700e-04)
mat1.add_nuclide("Am241", 2.275600e-06)
mat1.add_nuclide("H1", 5.405800e-02)
mat1.add_element("N", 3.862800e-03)
mat1.add_nuclide("O16", 3.958400e-02)
mat1.add_nuclide("B10", 9.408300e-08)
mat1.add_element("Cd", 5.289400e-08)
mat1.add_element("Fe", 5.482200e-06)
mat1.add_element("Gd", 7.296900e-09)
mat1.add_nuclide("Li6", 3.381400e-09)
...
# Sol'n height
surf5 = openmc.ZPlane(surface_id=5, z0=30.60)
# Dump line, inner
surf6 = openmc.ZCylinder(surface_id=6, x0=0.0, y0=80.01, r=2.625)
# Dump line, outer
surf7 = openmc.ZCylinder(surface_id=7, x0=0.0, y0=80.01, r=3.016)
# Empty central tank, inner
surf8 = openmc.ZCylinder(surface_id=8, x0=0.0, y0=80.01, r=12.7)
# Empty central tank, outer
surf9 = openmc.ZCylinder(surface_id=9, x0=0.0, y0=80.01, r=12.774)
...
surf21 = openmc.ZCylinder(surface_id=21, x0=0.0, y0=0.1, r=18.415)
# Concrete, outer, upper
surf22 = openmc.ZCylinder(surface_id=22, x0=0.0, y0=0.1, r=43.615)
# Concrete, larger
...
surf31 = openmc.ZCylinder(surface_id=31, x0=-0.3, y0=-1.3, r=18.415)
# Concrete, outer, lower
surf32 = openmc.ZCylinder(surface_id=32, x0=-0.3, y0=-1.3, r=43.615)
# Concrete, smaller
...
# Empty annular tank, inner
surf91 = openmc.ZCylinder(surface_id=91, x0=0.0, y0=80.01, r=26.596)
# Empty annular tank, outer
surf92 = openmc.ZCylinder(surface_id=92, x0=0.0, y0=80.01, r=26.67)

# Z-plane surfaces for bounded cylinders
surf2_zmin = openmc.ZPlane(surface_id=1092, z0=-16.953)
surf2_zmax = openmc.ZPlane(surface_id=1093, z0=-0.953)
surf3_zmin = openmc.ZPlane(surface_id=1094, z0=0.0)
surf3_zmax = openmc.ZPlane(surface_id=1095, z0=90.6)
surf4_zmin = openmc.ZPlane(surface_id=1096, z0=-0.953)
surf4_zmax = openmc.ZPlane(surface_id=1097, z0=91.553)
...
source.space = openmc.stats.Point((0.0, 0.0, 15.3))
