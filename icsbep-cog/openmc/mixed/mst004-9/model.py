...
surf21_cyl = openmc.ZCylinder(surface_id=21, x0=tr, y0=0, r=18.415)
surf21_zmin = openmc.ZPlane(z0=0.1)
...
surf31_cyl = openmc.ZCylinder(surface_id=31, x0=tr, y0=-0.3, r=18.415)
surf31_zmin = openmc.ZPlane(z0=-1.3)
