"""
MIX-SOL-THERM-008-7: Raschig rings in 80.8 gPu/l with 185 gU/l and 3.5M solution (Model 3)
...
mat1.add_nuclide("Am241", 4.701100e-08)
mat1.add_nuclide("Pu238", 3.270500e-08)
mat1.add_nuclide("Pu239", 1.910100e-04)
mat1.add_nuclide("Pu240", 1.157400e-05)
mat1.add_nuclide("Pu241", 7.589800e-07)
mat1.add_nuclide("Pu242", 1.165900e-07)
mat1.add_nuclide("U234", 2.856100e-08)
mat1.add_nuclide("U235", 3.152000e-06)
mat1.add_nuclide("U236", 5.663800e-08)
mat1.add_nuclide("U238", 4.648100e-04)
mat1.add_element("Gd", 7.426400e-08)
mat1.add_element("Fe", 1.446300e-05)
mat1.add_element("N", 3.901500e-03)
mat1.add_nuclide("H1", 5.451700e-02)
mat1.add_nuclide("O16", 3.884500e-02)
...
# Critical height (case 7)
surf6 = openmc.ZPlane(surface_id=6, z0=81.51)
...
source.space = openmc.stats.Point((0.0, 0.0, 40.755))
