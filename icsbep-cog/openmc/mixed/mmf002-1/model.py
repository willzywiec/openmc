"""
MIX-MET-FAST-002-1: Composite core of Ni-clad a-Pu(2.34) and HEU reflected by Nat-U
...
mat1.add_nuclide("Pu239", 4.787100e-02)
mat1.add_nuclide("Pu240", 1.148200e-03)
mat1.add_nuclide("Pu241", 4.906800e-05)
...
surf4 = openmc.Sphere(surface_id=4, r=5.2096)
surf5 = openmc.Sphere(surface_id=5, r=24.1326, boundary_type="vacuum")
