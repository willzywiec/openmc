"""
MST010-1: Exp. 137R with H/X=284 and 0.047 gGd/L
...
mat1.add_nuclide("Pu238", 3.440300e-08)
mat1.add_nuclide("Pu239", 1.993000e-04)
mat1.add_nuclide("Pu240", 1.354000e-05)
mat1.add_nuclide("Pu241", 1.070200e-06)
mat1.add_nuclide("Pu242", 1.015000e-07)
mat1.add_nuclide("U234", 1.817700e-08)
mat1.add_nuclide("U235", 3.067500e-06)
mat1.add_nuclide("U236", 5.587500e-08)
mat1.add_nuclide("U238", 4.585900e-04)
mat1.add_nuclide("Am241", 2.615000e-08)
mat1.add_nuclide("H1", 5.771600e-02)
mat1.add_element("N", 2.816600e-03)
mat1.add_nuclide("O16", 3.776500e-02)
mat1.add_nuclide("Gd152", 3.599800e-10)
mat1.add_nuclide("Gd154", 3.923800e-09)
mat1.add_nuclide("Gd155", 2.663900e-08)
mat1.add_nuclide("Gd156", 3.684400e-08)
mat1.add_nuclide("Gd157", 2.816800e-08)
mat1.add_nuclide("Gd158", 4.471000e-08)
mat1.add_nuclide("Gd160", 3.934600e-08)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=18.13)
# Solution tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 9.065))
