"""
MIX-COMP-THERM-004-2: 23x23 MOX pins with 1.825 cm pitch; Hc=61.90
...
mat1.add_nuclide("Pu241", 2.670100e-05)
mat1.add_nuclide("Pu242", 8.123400e-06)
mat1.add_nuclide("Am241", 2.581200e-06)
...
# Water height
surf11 = openmc.ZPlane(surface_id=11, z0=61.90)
# Al lower grid, top
...
source.space = openmc.stats.Point((0.0, 0.0, 30.95))
