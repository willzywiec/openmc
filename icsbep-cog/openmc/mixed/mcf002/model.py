...
surf3 = openmc.ZCylinder(surface_id=3, x0=-110.5357, y0=110.5357, r=111.5583)
surf4 = openmc.ZCylinder(surface_id=4, x0=-121.9200, y0=121.9200, r=140.2589, boundary_type="vacuum")
...
cell6.region = -surf1 & -surf3 & +surf9

# IR2
cell7 = openmc.Cell(cell_id=7, fill=mat4)
cell7.region = -surf1 & -surf3 & -surf6
...
cell10.region = +surf1 & -surf2 & -surf3 & -surf6

# OR2
cell11 = openmc.Cell(cell_id=11, fill=mat6)
cell11.region = +surf1 & -surf2 & -surf3 & +surf9

# RR1
cell12 = openmc.Cell(cell_id=12, fill=mat7)
cell12.region = +surf2 & -surf3 & +surf5 & -surf10

# RR2
cell13 = openmc.Cell(cell_id=13, fill=mat8)
cell13.region = +surf2 & -surf3 & -surf5

# RR2
cell14 = openmc.Cell(cell_id=14, fill=mat8)
cell14.region = +surf2 & -surf3 & +surf10
