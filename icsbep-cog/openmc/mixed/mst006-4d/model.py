"""
MST006-4: 3-D Model of Exp't No. 2249 with H/X=301 and 0.549 gGd/L
...
mat1.add_nuclide("Pu238", 5.232600e-07)
mat1.add_nuclide("Pu239", 1.731500e-04)
mat1.add_nuclide("Pu240", 4.671800e-05)
mat1.add_nuclide("Pu241", 6.619700e-06)
mat1.add_nuclide("Pu242", 2.455400e-06)
mat1.add_nuclide("Am241", 1.449500e-06)
mat1.add_nuclide("U234", 6.510100e-08)
mat1.add_nuclide("U235", 2.669100e-06)
mat1.add_nuclide("U236", 2.549800e-07)
mat1.add_nuclide("U238", 5.395200e-04)
mat1.add_element("N", 3.812100e-03)
mat1.add_nuclide("O16", 3.912300e-02)
mat1.add_nuclide("H1", 5.491600e-02)
...
mat1.add_element("Gd", 2.097900e-06)
...
mat4.add_nuclide("H1", 6.671900e-02)
mat4.add_nuclide("O16", 3.335900e-02)
...
# Critical height
surf4 = openmc.ZPlane(surface_id=4, z0=60.06)
...
source.space = openmc.stats.Point((0.0, 0.0, 30.03))
