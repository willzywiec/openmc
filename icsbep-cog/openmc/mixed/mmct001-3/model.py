"""
MMCT001-3: Experiment 109 with 996 FFTF rods immersed in 47.50 gPu/l and 163.06 gU/l solution
...
mat10.add_nuclide("Pu238", 4.866600e-08)
mat10.add_nuclide("Pu239", 1.090300e-04)
mat10.add_nuclide("Pu240", 9.926100e-06)
mat10.add_nuclide("Pu241", 4.972100e-07)
mat10.add_nuclide("Pu242", 1.128600e-07)
mat10.add_nuclide("Am241", 6.679300e-07)
mat10.add_nuclide("U238", 4.093400e-04)
mat10.add_nuclide("U236", 2.204800e-07)
mat10.add_nuclide("U235", 2.953700e-06)
mat10.add_nuclide("U234", 2.937000e-08)
mat10.add_nuclide("H1", 6.158600e-02)
mat10.add_element("N", 1.616700e-03)
mat10.add_nuclide("O16", 3.631100e-02)
mat10.add_element("B", 2.146800e-08)
mat10.add_element("Mn", 8.026700e-08)
mat10.add_element("Cd", 1.479700e-08)
mat10.add_element("Fe", 1.708700e-07)
...
# Solution height (case 109)
surf9 = openmc.ZPlane(surface_id=9, z0=20.01)
# SS316 clad, inner
...
source.space = openmc.stats.Box((-1.7, -1.7, 31.110999999999997), (1.7, 1.7, 33.111))
