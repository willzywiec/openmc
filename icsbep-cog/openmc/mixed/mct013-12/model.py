"""
MCT013-12: MOX/Polystyrene with H/X=226 with 3.51 SST-1.1B absorber and 15.24cm Lucite reflector
...
mat2.add_nuclide("B10", 8.588600e-04)
mat2.add_nuclide("B11", 3.457000e-03)
mat2.add_element("Fe", 5.826100e-02)
mat2.add_element("Cr", 1.522100e-02)
mat2.add_element("Ni", 5.996600e-03)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 3.51 + 23.1026 = 41.2840 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.671399999999998, 26.6126)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=3.51)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.911399999999997, 41.852599999999995, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 16.060000000000002))
