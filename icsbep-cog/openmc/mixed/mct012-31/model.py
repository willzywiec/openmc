"""
MCT012-31: MOX/Polystyrene (H/SQRT(LxW)=0.88) with H/X=172, bare
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-22.905, 22.905, -20.36, 20.36, -18.99, 18.99, boundary_type="vacuum")
