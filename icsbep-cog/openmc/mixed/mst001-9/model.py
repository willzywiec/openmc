"""
MIX-SOL-THERM-001-9: Exp. No. 097
...
mat1.add_nuclide("H1", 6.419700e-02)
mat1.add_element("N", 1.300900e-03)
mat1.add_nuclide("O16", 3.567100e-02)
mat1.add_nuclide("Pu238", 3.982100e-08)
mat1.add_nuclide("Pu239", 1.344900e-04)
mat1.add_nuclide("Pu240", 1.161300e-05)
mat1.add_nuclide("Pu241", 5.723900e-07)
mat1.add_nuclide("Pu242", 9.862900e-08)
mat1.add_nuclide("U234", 8.167000e-09)
mat1.add_nuclide("U235", 1.350600e-07)
mat1.add_nuclide("U236", 2.740300e-08)
mat1.add_nuclide("U238", 5.649900e-06)
mat1.add_nuclide("Am241", 7.136600e-07)
mat1.add_nuclide("B10", 1.430300e-08)
mat1.add_element("Cd", 1.124400e-08)
mat1.add_element("Fe", 1.625100e-06)
mat1.add_element("Gd", 2.009400e-09)
mat1.add_nuclide("Li6", 1.138100e-09)
...
mat3.add_nuclide("H1", 6.665200e-02)
mat3.add_nuclide("O16", 3.332600e-02)
...
# Critical solution height (case 097)
surf6 = openmc.ZPlane(surface_id=6, z0=28.94)
...
source.space = openmc.stats.Box((-20.7, -1.0, 35.475), (20.7, 1.0, 41.235))
