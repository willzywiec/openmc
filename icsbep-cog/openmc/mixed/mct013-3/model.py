"""
MCT013-3: MOX/Polystyrene with H/X=226 with 0.69 SST absorber and 15.24cm Lucite reflector
...
mat2.add_element("Cr", 1.420600e-02)
mat2.add_element("Ni", 5.593700e-03)
mat2.add_element("Fe", 5.437600e-02)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 0.69 + 11.8643 = 27.2257 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.6714, 12.5543)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=0.69)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.9114, 27.7943, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 7.62))
