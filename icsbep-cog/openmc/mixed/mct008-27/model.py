...
# Cd, inner
surf71 = openmc.ZCylinder(surface_id=71, r=0.53594)
# Cd, outer
surf72 = openmc.ZCylinder(surface_id=72, r=0.63754)
# Hole
...
surf71_zmin = openmc.ZPlane(z0=1.905)
surf71_zmax = openmc.ZPlane(z0=94.869)
...
u7_cell0.region = (-surf71 & +surf71_zmin & -surf71_zmax) & (-surf72 & +surf72_zmin & -surf72_zmax) & (-surf73 & +surf73_zmin & -surf73_zmax)
...
u7_cell2.region = (+surf71 | -surf71_zmin | +surf71_zmax) & (+surf72 | -surf72_zmin | +surf72_zmax) & (-surf73 & +surf73_zmin & -surf73_zmax)
...
cell7.region = -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf125
