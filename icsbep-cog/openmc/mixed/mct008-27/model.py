"""
MIX-COMP-THERM-008-27: Central Cd sleeve containing air and 232 + 12 MOX pins with 2.6670 cm pitch
...
mat7.add_element("N", 3.775300e-05)
mat7.add_nuclide("O16", 1.064800e-05)
...
# Cd, inner
surf71 = openmc.ZCylinder(surface_id=71, x0=1.9050, y0=94.8690, r=0.53594)
# Cd, outer
surf72 = openmc.ZCylinder(surface_id=72, x0=1.9050, y0=94.8690, r=0.63754)
# Hole
...
u7_cell0.region = -surf71 & -surf72 & -surf73
u7_cell1 = openmc.Cell(fill=mat8)
u7_cell1.region = +surf71 & -surf72 & -surf73
u7_cell2 = openmc.Cell(fill=mat6)
u7_cell2.region = +surf71 & +surf72 & -surf73
