"""
MIX-SOL-THERM-007-7: Exp. No. 135
...
mat1.add_nuclide("Pu238", 2.343600e-08)
mat1.add_nuclide("Pu239", 1.824000e-04)
mat1.add_nuclide("Pu240", 1.116700e-05)
mat1.add_nuclide("Pu241", 7.155200e-07)
mat1.add_nuclide("Pu242", 1.190800e-07)
mat1.add_nuclide("U234", 2.721800e-08)
mat1.add_nuclide("U235", 3.003800e-06)
mat1.add_nuclide("U236", 5.397400e-08)
mat1.add_nuclide("U238", 4.429500e-04)
mat1.add_nuclide("Am241", 4.432900e-08)
mat1.add_nuclide("H1", 5.493100e-02)
mat1.add_element("N", 3.703300e-03)
mat1.add_nuclide("O16", 3.847800e-02)
mat1.add_nuclide("Gd152", 7.735800e-09)
mat1.add_nuclide("Gd154", 8.432000e-08)
mat1.add_nuclide("Gd155", 5.724500e-07)
mat1.add_nuclide("Gd156", 7.917500e-07)
mat1.add_nuclide("Gd157", 6.053200e-07)
mat1.add_nuclide("Gd158", 9.607800e-07)
mat1.add_nuclide("Gd160", 8.455200e-07)
...
surf1 = openmc.ZPlane(surface_id=1, z0=62.11570)
# Solution tank, inner
...
# Reflector tank, inner
surf5 = openmc.ZCylinder(surface_id=5, r=50.8)

# Z-plane surfaces for bounded cylinders
surf2_zmin = openmc.ZPlane(z0=0.0)
surf2_zmax = openmc.ZPlane(z0=107.0)
surf3_zmin = openmc.ZPlane(z0=-0.635)
surf3_zmax = openmc.ZPlane(z0=107.953)
surf4_zmin = openmc.ZPlane(z0=-20.635)
surf4_zmax = openmc.ZPlane(z0=107.953)
surf5_zmin = openmc.ZPlane(z0=-21.905, boundary_type="vacuum")
surf5_zmax = openmc.ZPlane(z0=107.953, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 31.05785))
