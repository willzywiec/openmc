"""
MixMF007-21: 4.664 kg alpha-Pu; 11.702 kg HEU; 0.657 cm Be
...
# alpha-Pu
surf1 = openmc.Sphere(surface_id=1, r=3.8673)
# HEU
surf2 = openmc.Sphere(surface_id=2, r=5.9253)
# Be
surf3 = openmc.Sphere(surface_id=3, r=6.5823, boundary_type="vacuum")
