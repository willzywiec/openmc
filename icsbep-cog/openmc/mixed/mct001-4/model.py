"""
MIX-COMP-THERM-001-4: 162 MOX pins with 2 x 0.9525 cm = 1.9050 cm pitch
...
surf1 = openmc.ZCylinder(surface_id=1, x0=4.06, y0=18.538, r=0.240665)
# Natural UO2 isolator
surf2 = openmc.ZCylinder(surface_id=2, x0=18.538, y0=20.570, r=0.2413)
# MOX fuel
surf3 = openmc.ZCylinder(surface_id=3, x0=20.570, y0=112.010, r=0.2407)
# Natural UO2 isolator
surf4 = openmc.ZCylinder(surface_id=4, x0=112.010, y0=114.042, r=0.2413)
# Inconel 600 reflector
surf5 = openmc.ZCylinder(surface_id=5, x0=114.042, y0=128.520, r=0.240665)
# SS302 spring
surf6 = openmc.ZCylinder(surface_id=6, x0=128.520, y0=141.070, r=0.254)
# SS316 plenum, inner
surf7 = openmc.ZCylinder(surface_id=7, r=0.23114)
# SS316 plenum, outer
surf8 = openmc.ZCylinder(surface_id=8, x0=141.070, y0=227.284, r=0.24511)
# SS316 clad, inner
surf9 = openmc.ZCylinder(surface_id=9, x0=4.06, y0=227.284, r=0.254)
# SS316 clad, outer (or hole)
surf10 = openmc.ZCylinder(surface_id=10, x0=0.0, y0=237.744, r=0.2921)
# Upper  SS304L plate
surf11 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -13.335, 13.335, 182.89999999999998, 185.745)
# Minimum water level
surf12 = openmc.ZPlane(surface_id=12, z0=127.0)
# Middle SS304L plate
surf13 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -13.335, 13.335, 121.76, 124.605)
# Polypropolyne spacer plate
surf14 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -13.335, 13.335, 56.330000000000005, 57.698)
# Bottom SS304L plate
surf15 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -13.335, 13.335, 9.850000000000001, 12.695)
# Plexiglas base plate
surf16 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -13.335, 13.335, -2.54, 0.0)
# Al-6061 channel, outer
surf17 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -13.335, 13.335, -17.84, -2.539999999999999)
# Al-6061 channel, inner
surf18 = openmc.model.RectangularParallelepiped(-8.255, 8.255, -499.95, 499.95, -499.95, 499.95)
# Al-6061 channel, lhs
surf19 = openmc.model.RectangularParallelepiped(-17.78, -8.89, -499.95, 499.95, -17.205, -3.175)
# Al-6061 channel, rhs
surf20 = openmc.model.RectangularParallelepiped(8.89, 17.78, -499.95, 499.95, -17.205, -3.175)
# Carbon steel tank floor
surf21 = openmc.ZPlane(surface_id=21, z0=-17.84)
# Top of concrete
surf22 = openmc.ZPlane(surface_id=22, z0=-18.792)
# BCD
surf23 = openmc.ZCylinder(surface_id=23, x0=-48.792, y0=237.744, r=60.0, boundary_type="vacuum")
# Bottom of fuel
surf98 = openmc.ZPlane(surface_id=98, z0=0.0)
# Lattice external boundary
surf99 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -13.335, 13.335, -499.95, 499.95)
...
u1_cell5.region = +surf5 & -surf6 & -surf9
u1_cell6 = openmc.Cell(fill=mat5)
u1_cell6.region = +surf6 & +surf7 & -surf8 & -surf9
u1_cell7 = openmc.Cell(fill=mat5)
u1_cell7.region = +surf1 & +surf6 & +surf8 & +surf9 & -surf10
...
u2_cell0.region = -surf10 & -surf12 & -surf23
u2_cell1 = openmc.Cell(fill=mat7)
u2_cell1.region = +surf10 & -surf11
u2_cell2 = openmc.Cell(fill=mat7)
u2_cell2.region = +surf10 & -surf13
u2_cell3 = openmc.Cell(fill=mat8)
u2_cell3.region = +surf10 & -surf14
u2_cell4 = openmc.Cell(fill=mat7)
u2_cell4.region = +surf10 & -surf15
u2_cell5 = openmc.Cell(fill=mat6)
u2_cell5.region = +surf10 & -surf16
u2_cell6 = openmc.Cell(fill=mat11)
u2_cell6.region = +surf16 & -surf17 & +surf18 & +surf19 & +surf20
u2_cell7 = openmc.Cell(fill=mat12)
u2_cell7.region = +surf16 & -surf17 & -surf18 & +surf19 & +surf20
u2_cell8 = openmc.Cell(fill=mat12)
u2_cell8.region = +surf16 & -surf17 & +surf18 & -surf19 & +surf20
u2_cell9 = openmc.Cell(fill=mat12)
u2_cell9.region = +surf16 & -surf17 & +surf18 & +surf19 & -surf20
u2_cell10 = openmc.Cell(fill=mat9)
u2_cell10.region = +surf17 & -surf21 & +surf22 & -surf23
u2_cell11 = openmc.Cell(fill=mat10)
u2_cell11.region = -surf22 & -surf23
u2_cell12 = openmc.Cell(fill=mat12)
u2_cell12.region = +surf10 & +surf11 & -surf12 & +surf13 & +surf14
...
# Lattice 4: 28x28 array
lattice4 = openmc.RectLattice(lattice_id=4)
lattice4.lower_left = [-13.335, -13.335]
lattice4.pitch = [0.952500, 0.952500]
lattice4.universes = [
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
    [universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
    [universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
    [universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
    [universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3, universe2, universe3],
...
source.space = openmc.stats.Box((-1.5, 2.3, 72.785), (2.4, 4.3, 74.785))
