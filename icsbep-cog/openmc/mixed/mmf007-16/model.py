"""
MixMF007-16: 3.933 kg alpha-Pu; 4.157 kg HEU; 4.62 cm Be
...
# HEU
surf2 = openmc.Sphere(surface_id=2, r=4.6743)
# Be
surf3 = openmc.Sphere(surface_id=3, r=9.2943, boundary_type="vacuum")
