...
cell1.region = -surf11 & (-surf30_0 & -surf30_1 & -surf30_2 & -surf30_3 & -surf30_4 & -surf30_5)

# Harray
cell2 = openmc.Cell(cell_id=2, fill=universe7)
cell2.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & +surf41 & +surf42 & +surf43 & +surf44 & +surf45 & +surf46 & +surf47 & +surf48 & +surf49 & +surf50 & +surf51 & +surf52

# NoHole
cell3 = openmc.Cell(cell_id=3, fill=universe3)
cell3.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf41

# NoHole
cell4 = openmc.Cell(cell_id=4, fill=universe3)
cell4.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf42

# NoHole
cell5 = openmc.Cell(cell_id=5, fill=universe3)
cell5.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf43

# NoHole
cell6 = openmc.Cell(cell_id=6, fill=universe3)
cell6.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf44

# NoHole
cell7 = openmc.Cell(cell_id=7, fill=universe3)
cell7.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf45

# NoHole
cell8 = openmc.Cell(cell_id=8, fill=universe3)
cell8.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf46

# NoHole
cell9 = openmc.Cell(cell_id=9, fill=universe3)
cell9.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf47

# NoHole
cell10 = openmc.Cell(cell_id=10, fill=universe3)
cell10.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf48

# NoHole
cell11 = openmc.Cell(cell_id=11, fill=universe3)
cell11.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf49

# NoHole
cell12 = openmc.Cell(cell_id=12, fill=universe3)
cell12.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf50

# NoHole
cell13 = openmc.Cell(cell_id=13, fill=universe3)
cell13.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf51

# NoHole
cell14 = openmc.Cell(cell_id=14, fill=universe3)
cell14.region = -surf11 & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & (-surf31_0 & -surf31_1 & -surf31_2 & -surf31_3 & -surf31_4 & -surf31_5) & -surf52

# Alles
cell15 = openmc.Cell(cell_id=15, fill=universe3)
cell15.region = -surf11 & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5) & +surf61 & +surf62 & +surf63 & +surf64 & +surf65 & +surf66 & +surf67 & +surf68

# Hole
cell16 = openmc.Cell(cell_id=16, fill=universe7)
cell16.region = -surf11 & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5) & -surf61

# Hole
cell17 = openmc.Cell(cell_id=17, fill=universe7)
cell17.region = -surf11 & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5) & -surf62

# Hole
cell18 = openmc.Cell(cell_id=18, fill=universe7)
cell18.region = -surf11 & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5) & -surf63

# Hole
cell19 = openmc.Cell(cell_id=19, fill=universe7)
cell19.region = -surf11 & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5) & -surf64

# Hole
cell20 = openmc.Cell(cell_id=20, fill=universe7)
cell20.region = -surf11 & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5) & -surf65

# Hole
cell21 = openmc.Cell(cell_id=21, fill=universe7)
cell21.region = -surf11 & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5) & -surf66

# Hole
cell22 = openmc.Cell(cell_id=22, fill=universe7)
cell22.region = -surf11 & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5) & -surf67

# Hole
cell23 = openmc.Cell(cell_id=23, fill=universe7)
cell23.region = -surf11 & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5) & -surf68
