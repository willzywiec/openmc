"""
MIX-MET-FAST-004-2: Pu sphere surrounded by HEU reflected by BeO
...
mat3.add_nuclide("Be9", 6.750800e-02)
mat3.add_nuclide("O16", 6.750800e-02)
mat3.add_s_alpha_beta("c_Be_in_BeO")
mat3.add_s_alpha_beta("c_O_in_BeO")
...
# top
surf10 = openmc.ZPlane(surface_id=10, z0=-0.75)
# Cavity
# surf11: Unsupported surface type "s" with params ['1.40', 'tr', '0', '0', '-0.75']
# Pu
# surf12: Unsupported surface type "s" with params ['3.15', 'tr', '0', '0', '-0.75']
# HEU, full shell
# surf13: Unsupported surface type "s" with params ['6.75', 'tr', '0', '0', '-0.75']
# HEU, half shell
# surf14: Unsupported surface type "s" with params ['8.35', 'tr', '0', '0', '-0.75']
# BeO
# surf15: Unsupported surface type "s" with params ['9.15', 'tr', '0', '0', '-0.75']
# Cu
# surf16: Unsupported surface type "s" with params ['9.30', 'tr', '0', '0', '-0.75']
# Steel (Fe)
surf17 = openmc.ZCylinder(surface_id=17, x0=-15.05, y0=-1.0, r=2.5)
# Hole in HEU
surf20_cyl = openmc.XCylinder(surface_id=20, x0=tr, y0=0, r=0.6)
surf20_zmin = openmc.ZPlane(z0=0.0)
surf20_zmax = openmc.ZPlane(z0=-0.75)
...
surf21_zmax = openmc.ZPlane(z0=-0.75)
...
source.space = openmc.stats.Box((-3.0, -3.0, -3.0), (3.0, 3.0, 3.8))
