...
# Steel plate
surf2 = openmc.ZCylinder(surface_id=2, x0=56.31, y0=56.627, r=12.5125)
# Polyethylene
surf3 = openmc.ZCylinder(surface_id=3, x0=56.627, y0=71.627, r=12.5125)
# Vessel, inner
surf4 = openmc.ZCylinder(surface_id=4, x0=0.0, y0=107.0, r=12.7125)
# Vessel, outer
surf5 = openmc.ZCylinder(surface_id=5, x0=-1.0, y0=107.0, r=12.9125)
# Vessel, flange
surf6 = openmc.ZCylinder(surface_id=6, x0=-1.0, y0=0.0, r=17.9125)
# Water reflector
