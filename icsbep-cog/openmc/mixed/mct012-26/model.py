"""
MCT012-26: MOX/Polystyrene (H/SQRT(LxW)=0.35) with H/X=172 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-25.45, 25.45, -22.905, 22.905, -8.57, 8.57)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-40.69, 40.69, -38.145, 38.145, -23.81, 23.81, boundary_type="vacuum")
