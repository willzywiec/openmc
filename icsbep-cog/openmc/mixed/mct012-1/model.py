"""
MCT012-1: MOX/Polystyrene (H/SQRT(LxW)=0.48) with H/X=343 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.54, 30.54, -33.085, 33.085, -15.245, 15.245)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.78, 45.78, -48.325, 48.325, -30.485, 30.485, boundary_type="vacuum")
