"""
MixMF007-6: 2.472 kg alpha-Pu; 19.355 kg HEU; 1.36 cm Be
...
# HEU
surf2 = openmc.Sphere(surface_id=2, r=6.5350)
# Be
surf3 = openmc.Sphere(surface_id=3, r=7.8950, boundary_type="vacuum")
