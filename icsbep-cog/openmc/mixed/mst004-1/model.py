"""
MIX-SOL-THERM-004-1: Exp. No. 065 with 41.69 gPu/l and 63.38 gU/L with 0.61M
...
mat1.add_nuclide("Pu238", 3.058500e-08)
mat1.add_nuclide("Pu239", 9.569500e-05)
mat1.add_nuclide("Pu240", 8.691100e-06)
mat1.add_nuclide("Pu241", 4.686800e-07)
mat1.add_nuclide("Pu242", 9.645900e-08)
mat1.add_nuclide("U234", 1.141600e-08)
mat1.add_nuclide("U235", 9.158600e-07)
mat1.add_nuclide("U236", 3.719100e-08)
mat1.add_nuclide("U238", 1.593800e-04)
mat1.add_nuclide("Am241", 5.410700e-07)
mat1.add_nuclide("H1", 6.352700e-02)
mat1.add_element("N", 1.120700e-03)
mat1.add_nuclide("O16", 3.526400e-02)
mat1.add_nuclide("B10", 2.264300e-08)
mat1.add_element("Cd", 1.273000e-08)
mat1.add_element("Fe", 1.319400e-06)
mat1.add_element("Gd", 1.756200e-09)
mat1.add_nuclide("Li6", 8.138200e-10)
...
# Sol'n height
surf5 = openmc.ZPlane(surface_id=5, z0=44.46)
# Dump line, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 22.23))
