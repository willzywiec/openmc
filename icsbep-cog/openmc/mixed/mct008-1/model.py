...
surf4 = openmc.ZCylinder(surface_id=4, x0=-1.016, y0=-1.7597636, r=0.71775)
surf5 = openmc.ZCylinder(surface_id=5, x0=-1.016, y0=1.7597636, r=0.71775)
surf6 = openmc.ZCylinder(surface_id=6, x0=1.016, y0=-1.7597636, r=0.71775)
surf7 = openmc.ZCylinder(surface_id=7, x0=1.016, y0=1.7597636, r=0.71775)
# Upper  Lucite plate
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-13.208, y0=22.8769268, r=0.71775)
surf102 = openmc.ZCylinder(surface_id=102, x0=-11.176, y0=22.8769268, r=0.71775)
surf103 = openmc.ZCylinder(surface_id=103, x0=9.144, y0=22.8769268, r=0.71775)
surf104 = openmc.ZCylinder(surface_id=104, x0=11.176, y0=22.8769268, r=0.71775)
surf105 = openmc.ZCylinder(surface_id=105, x0=13.208, y0=22.8769268, r=0.71775)
surf106 = openmc.ZCylinder(surface_id=106, x0=-14.224, y0=21.1171632, r=0.71775)
surf107 = openmc.ZCylinder(surface_id=107, x0=14.224, y0=21.1171632, r=0.71775)
surf108 = openmc.ZCylinder(surface_id=108, x0=-15.244, y0=19.3573996, r=0.71775)
surf109 = openmc.ZCylinder(surface_id=109, x0=-24.384, y0=3.5195272, r=0.71775)
surf110 = openmc.ZCylinder(surface_id=110, x0=24.384, y0=3.5195272, r=0.71775)
surf111 = openmc.ZCylinder(surface_id=111, x0=-25.4, y0=1.7597636, r=0.71775)
surf112 = openmc.ZCylinder(surface_id=112, x0=25.4, y0=1.7597636, r=0.71775)
surf113 = openmc.ZCylinder(surface_id=113, x0=-26.416, y0=0.0, r=0.71775)
surf114 = openmc.ZCylinder(surface_id=114, x0=26.416, y0=0.0, r=0.71775)
surf115 = openmc.ZCylinder(surface_id=115, x0=-25.4, y0=-1.7597636, r=0.71775)
surf116 = openmc.ZCylinder(surface_id=116, x0=25.4, y0=-1.7597636, r=0.71775)
surf117 = openmc.ZCylinder(surface_id=117, x0=-24.384, y0=-3.5195272, r=0.71775)
surf118 = openmc.ZCylinder(surface_id=118, x0=15.244, y0=-19.3573996, r=0.71775)
surf119 = openmc.ZCylinder(surface_id=119, x0=-14.224, y0=-21.1171632, r=0.71775)
surf120 = openmc.ZCylinder(surface_id=120, x0=14.224, y0=-21.1171632, r=0.71775)
surf121 = openmc.ZCylinder(surface_id=121, x0=-13.208, y0=-22.8769268, r=0.71775)
surf122 = openmc.ZCylinder(surface_id=122, x0=-11.176, y0=-22.8769268, r=0.71775)
surf123 = openmc.ZCylinder(surface_id=123, x0=-9.144, y0=-22.8769268, r=0.71775)
surf124 = openmc.ZCylinder(surface_id=124, x0=9.144, y0=-22.8769268, r=0.71775)
surf125 = openmc.ZCylinder(surface_id=125, x0=11.176, y0=-22.8769268, r=0.71775)
surf126 = openmc.ZCylinder(surface_id=126, x0=13.208, y0=-22.8769268, r=0.71775)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1126, z0=3.1035)
surf1_zmax = openmc.ZPlane(surface_id=1127, z0=94.0435)
surf2_zmin = openmc.ZPlane(surface_id=1128, z0=2.6035)
surf2_zmax = openmc.ZPlane(surface_id=1129, z0=3.1035)
surf3_zmin = openmc.ZPlane(surface_id=1130, z0=1.905)
surf3_zmax = openmc.ZPlane(surface_id=1131, z0=94.869)
