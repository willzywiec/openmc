"""
MIX-COMP-THERM-008-22: Central H1Cd absorber rod and 232 + 15 MOX pins with 2.6670 cm pitch
...
mat7.add_element("Hf", 1.460900e-02)
mat7.add_nuclide("O16", 3.054200e-02)
mat7.add_element("Zr", 6.620500e-04)
mat7.add_element("Al", 1.045800e-02)
...
cell9.region = -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & (-surf21_0

# water
cell10 = openmc.Cell(cell_id=10, fill=mat6)
cell10.region = -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22
