...
# Peripheral rod #7
surf47_cyl = openmc.ZCylinder(surface_id=47, x0=tr, y0=12.0015, r=0.72)
surf47_zmin = openmc.ZPlane(z0=16.16783)
...
cell8.region = -surf10 & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5) & +surf21 & +surf22 & +surf23 & -surf24 & +surf46 & +surf47
...
cell10.region = -surf10 & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5) & +surf21 & +surf22 & +surf23 & -surf24 & -surf47

# Alles
cell11 = openmc.Cell(cell_id=11, fill=universe2)
cell11.region = -surf10 & +surf24
