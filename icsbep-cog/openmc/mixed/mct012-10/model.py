"""
MCT012-10: MOX/Polystyrene (H/SQRT(LxW)=0.35) with H/X=705 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.54, 30.54, -33.02, 33.02, -11.045, 11.045)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.78, 45.78, -48.26, 48.26, -26.285, 26.285, boundary_type="vacuum")
