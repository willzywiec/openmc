"""
MIX-SOL-THERM-001-8: Exp. No. 096
...
mat1.add_nuclide("H1", 6.147100e-02)
mat1.add_element("N", 2.332100e-03)
mat1.add_nuclide("O16", 3.716700e-02)
mat1.add_nuclide("Pu238", 7.522300e-08)
mat1.add_nuclide("Pu239", 2.540500e-04)
mat1.add_nuclide("Pu240", 2.193600e-05)
mat1.add_nuclide("Pu241", 1.081300e-06)
mat1.add_nuclide("Pu242", 1.863100e-07)
mat1.add_nuclide("U234", 1.349300e-08)
mat1.add_nuclide("U235", 2.231500e-07)
mat1.add_nuclide("U236", 4.527400e-08)
mat1.add_nuclide("U238", 9.334600e-06)
mat1.add_nuclide("Am241", 1.348100e-06)
mat1.add_nuclide("B10", 2.701800e-08)
mat1.add_element("Cd", 2.123900e-08)
mat1.add_element("Fe", 3.069800e-06)
mat1.add_element("Gd", 3.795700e-09)
mat1.add_nuclide("Li6", 2.149800e-09)
...
# Critical solution height (case 096)
surf6 = openmc.ZPlane(surface_id=6, z0=25.69)
...
source.space = openmc.stats.Box((-20.7, -1.0, 33.85), (20.7, 1.0, 41.235))
