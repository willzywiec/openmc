...
# Cadmium, lower
surf10 = openmc.ZCylinder(surface_id=10, x0=1.27, y0=1.344, r=12.615)
# Cadmium/SS304L, inner
surf11 = openmc.ZCylinder(surface_id=11, r=7.409)
# Polyethylene, inner
surf12 = openmc.ZCylinder(surface_id=12, x0=1.344, y0=128.114, r=7.483)
# Polyethylene, outer
surf13 = openmc.ZCylinder(surface_id=13, x0=1.344, y0=128.114, r=12.541)
# Cadmium, outer
surf14 = openmc.ZCylinder(surface_id=14, x0=1.344, y0=128.114, r=12.615)
# SS304L, upper
surf15 = openmc.ZCylinder(surface_id=15, x0=128.114, y0=128.59, r=12.615)
# Bottle, inner
...
cell1.region = +surf1 & -surf2 & -surf5 & +surf10
...
cell6.region = +surf10 & +surf11 & -surf12

# Poly
cell7 = openmc.Cell(cell_id=7, fill=mat4)
cell7.region = +surf10 & +surf12 & -surf13

# Cd
cell8 = openmc.Cell(cell_id=8, fill=mat7)
cell8.region = +surf10 & +surf13 & -surf14

# SS304L
cell9 = openmc.Cell(cell_id=9, fill=mat2)
cell9.region = +surf11 & +surf14 & -surf15

# Soln
cell10 = openmc.Cell(cell_id=10, fill=mat6)
cell10.region = -surf5 & -surf21 & -surf22 & -surf23

# SS304L
cell11 = openmc.Cell(cell_id=11, fill=mat2)
cell11.region = -surf5 & +surf21 & -surf22
