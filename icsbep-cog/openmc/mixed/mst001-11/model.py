...
surf10_zmax = openmc.ZPlane(z0=1.344)
surf12_zmin = openmc.ZPlane(z0=1.344)
surf12_zmax = openmc.ZPlane(z0=128.114)
surf13_zmin = openmc.ZPlane(z0=1.344)
surf13_zmax = openmc.ZPlane(z0=128.114)
surf14_zmin = openmc.ZPlane(z0=1.344)
surf14_zmax = openmc.ZPlane(z0=128.114)
surf15_zmin = openmc.ZPlane(z0=128.114)
surf15_zmax = openmc.ZPlane(z0=128.59)
