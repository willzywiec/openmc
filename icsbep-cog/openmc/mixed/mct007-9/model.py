...
surf45_cyl = openmc.ZCylinder(surface_id=45, x0=tr, y0=18.669, r=0.72)
surf45_zmin = openmc.ZPlane(z0=4.61938)
...
cell7.region = -surf10 & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5) & +surf21 & +surf22 & -surf23 & +surf45

# Hole
cell8 = openmc.Cell(cell_id=8, fill=universe6)
cell8.region = -surf10 & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5) & +surf21 & +surf22 & -surf23 & -surf45

# Harray
cell9 = openmc.Cell(cell_id=9, fill=universe6)
cell9.region = -surf10 & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5) & +surf21 & +surf22 & +surf23 & -surf24
