"""
MCT007-9: Central B3 absorber rod and 193+4=197 MOX pins with 2.6670 cm pitch
...
mat7.add_nuclide("B10", 1.862000e-04)
mat7.add_nuclide("B11", 7.494900e-04)
mat7.add_element("Al", 5.805100e-02)
mat7.add_nuclide("O16", 5.398800e-05)
mat7.add_element("Mg", 7.897600e-06)
...
surf45 = openmc.ZCylinder(surface_id=45, x0=18.669, y0=4.61938, r=0.72)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1045, z0=3.1035)
surf1_zmax = openmc.ZPlane(surface_id=1046, z0=94.0435)
surf2_zmin = openmc.ZPlane(surface_id=1047, z0=2.6035)
surf2_zmax = openmc.ZPlane(surface_id=1048, z0=3.1035)
surf3_zmin = openmc.ZPlane(surface_id=1049, z0=1.905)
surf3_zmax = openmc.ZPlane(surface_id=1050, z0=94.869)
surf4_zmin = openmc.ZPlane(surface_id=1051, z0=2.6035)
surf4_zmax = openmc.ZPlane(surface_id=1052, z0=94.0435)
surf5_zmin = openmc.ZPlane(surface_id=1053, z0=1.905)
surf5_zmax = openmc.ZPlane(surface_id=1054, z0=94.869)
surf6_zmin = openmc.ZPlane(surface_id=1055, z0=1.905)
surf6_zmax = openmc.ZPlane(surface_id=1056, z0=94.869)
surf10_zmin = openmc.ZPlane(surface_id=1057, z0=-16.1925, boundary_type="vacuum")
surf10_zmax = openmc.ZPlane(surface_id=1058, z0=115.3795, boundary_type="vacuum")
surf12_zmin = openmc.ZPlane(surface_id=1059, z0=0.0)
surf12_zmax = openmc.ZPlane(surface_id=1060, z0=1.905)
surf13_zmin = openmc.ZPlane(surface_id=1061, z0=24.4475)
surf13_zmax = openmc.ZPlane(surface_id=1062, z0=26.3525)
surf14_zmin = openmc.ZPlane(surface_id=1063, z0=70.1675)
surf14_zmax = openmc.ZPlane(surface_id=1064, z0=72.0725)
...
cell7.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5) & +surf21 & +surf22 & -surf23 & +surf45

# Hole
cell8 = openmc.Cell(cell_id=8, fill=universe6)
cell8.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5) & +surf21 & +surf22 & -surf23 & -surf45

# Harray
cell9 = openmc.Cell(cell_id=9, fill=universe6)
cell9.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5) & +surf21 & +surf22 & +surf23 & -surf24
