"""
MCT012-32: MOX/Polystyrene (H/SQRT(LxW)=1.04) with H/X=172, bare
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.36, 20.36, -21.12, 21.12, boundary_type="vacuum")
