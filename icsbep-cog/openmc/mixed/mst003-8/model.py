"""
MIX-SOL-THERM-003-8: AWRE SCAMP
...
mat1.add_nuclide("Pu239", 4.400000e-05)
mat1.add_nuclide("Pu240", 2.600000e-06)
mat1.add_nuclide("Pu241", 2.000000e-07)
mat1.add_nuclide("U235", 7.600000e-07)
mat1.add_nuclide("U238", 1.060000e-04)
mat1.add_nuclide("H1", 6.430000e-02)
mat1.add_element("N", 9.500000e-04)
mat1.add_nuclide("O16", 3.490000e-02)
mat1.add_element("Fe", 4.000000e-09)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=72.86)
# Steel plate
surf2 = openmc.ZCylinder(surface_id=2, r=18.795)
# Polyethylene
surf3 = openmc.ZCylinder(surface_id=3, r=18.795)
# Vessel, inner
surf4 = openmc.ZCylinder(surface_id=4, r=18.995)
# Vessel, outer
surf5 = openmc.ZCylinder(surface_id=5, r=19.245)
# Vessel, flange
surf6 = openmc.ZCylinder(surface_id=6, r=24.245)
# Water reflector
surf7 = openmc.ZCylinder(surface_id=7, r=42.0, boundary_type="vacuum")

# Z-plane surfaces for bounded cylinders
surf2_zmin = openmc.ZPlane(surface_id=1007, z0=72.86)
surf2_zmax = openmc.ZPlane(surface_id=1008, z0=73.177)
surf3_zmin = openmc.ZPlane(surface_id=1009, z0=73.177)
surf3_zmax = openmc.ZPlane(surface_id=1010, z0=88.177)
surf4_zmin = openmc.ZPlane(surface_id=1011, z0=0.0)
surf4_zmax = openmc.ZPlane(surface_id=1012, z0=107.0)
surf5_zmin = openmc.ZPlane(surface_id=1013, z0=-1.0)
surf5_zmax = openmc.ZPlane(surface_id=1014, z0=107.0)
...
surf7_zmax = openmc.ZPlane(surface_id=1018, z0=107.0, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 36.43))
