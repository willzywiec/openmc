"""
MMCT001-2: Experiment 107 with 996 FFTF rods immersed in 73.95 gPu/l and 254.09 gU/l solution
...
mat10.add_nuclide("Pu238", 7.576600e-08)
mat10.add_nuclide("Pu239", 1.697400e-04)
mat10.add_nuclide("Pu240", 1.545300e-05)
mat10.add_nuclide("Pu241", 7.740700e-07)
mat10.add_nuclide("Pu242", 1.757000e-07)
mat10.add_nuclide("Am241", 1.039900e-06)
mat10.add_nuclide("U238", 6.378600e-04)
mat10.add_nuclide("U236", 3.435700e-07)
mat10.add_nuclide("U235", 4.602600e-06)
mat10.add_nuclide("U234", 4.576600e-08)
mat10.add_nuclide("H1", 5.882800e-02)
mat10.add_element("N", 2.373800e-03)
mat10.add_nuclide("O16", 3.764900e-02)
mat10.add_element("B", 3.342200e-08)
mat10.add_element("Mn", 1.249600e-07)
mat10.add_element("Cd", 2.303600e-08)
mat10.add_element("Fe", 2.660200e-06)
...
# Solution height (case 107)
surf9 = openmc.ZPlane(surface_id=9, z0=21.34)
# SS316 clad, inner
...
source.space = openmc.stats.Box((-1.7, -1.7, 31.776000000000003), (1.7, 1.7, 33.776))
