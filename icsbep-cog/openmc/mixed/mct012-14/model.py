"""
MCT012-14: MOX/Polystyrene (H/SQRT(LxW)=0.85) with H/X=226 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-15.27, 15.27, -20.36, 20.36, -14.905, 14.905)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-30.51, 30.51, -35.6, 35.6, -30.145, 30.145, boundary_type="vacuum")
