"""
MIX-COMP-THERM-004-3: 23x23 MOX pins with 1.825 cm pitch; Hc=64.06
...
mat1.add_nuclide("Pu241", 2.544700e-05)
mat1.add_nuclide("Pu242", 8.123400e-06)
mat1.add_nuclide("Am241", 3.836100e-06)
...
# Water height
surf11 = openmc.ZPlane(surface_id=11, z0=64.06)
# Al lower grid, top
...
source.space = openmc.stats.Point((0.0, 0.0, 32.03))
