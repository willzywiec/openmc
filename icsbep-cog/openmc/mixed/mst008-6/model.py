"""
MIX-SOL-THERM-008-6: Raschig rings in 81.7 gPu/l with 186 gU/l and 3.5M solution (Model 3)
...
mat1.add_nuclide("Am241", 4.753500e-08)
mat1.add_nuclide("Pu238", 3.306900e-08)
mat1.add_nuclide("Pu239", 1.931400e-04)
mat1.add_nuclide("Pu240", 1.170300e-05)
mat1.add_nuclide("Pu241", 7.674300e-07)
mat1.add_nuclide("Pu242", 1.178900e-07)
mat1.add_nuclide("U234", 2.871600e-08)
mat1.add_nuclide("U235", 3.169100e-06)
mat1.add_nuclide("U236", 5.694400e-08)
mat1.add_nuclide("U238", 4.673200e-04)
mat1.add_element("Gd", 7.509100e-08)
mat1.add_element("Fe", 1.462400e-05)
mat1.add_element("N", 3.916100e-03)
mat1.add_nuclide("H1", 5.457300e-02)
mat1.add_nuclide("O16", 3.892200e-02)
...
# Critical height (case 6)
surf6 = openmc.ZPlane(surface_id=6, z0=79.93)
...
source.space = openmc.stats.Point((0.0, 0.0, 39.965))
