"""
MIX-SOL-THERM-001-13: Exp. No. 108
...
mat1.add_nuclide("H1", 6.147500e-02)
mat1.add_element("N", 1.620200e-03)
mat1.add_nuclide("O16", 3.626100e-02)
mat1.add_nuclide("Pu238", 3.453900e-08)
mat1.add_nuclide("Pu239", 1.080700e-04)
mat1.add_nuclide("Pu240", 9.847800e-06)
mat1.add_nuclide("Pu241", 4.963400e-07)
mat1.add_nuclide("Pu242", 1.101000e-07)
mat1.add_nuclide("U234", 2.912800e-08)
mat1.add_nuclide("U235", 2.917000e-06)
mat1.add_nuclide("U236", 2.186700e-07)
mat1.add_nuclide("U238", 4.059900e-04)
mat1.add_nuclide("Am241", 6.549700e-07)
mat1.add_nuclide("B10", 2.572500e-08)
mat1.add_element("Cd", 1.437600e-08)
mat1.add_element("Fe", 1.490000e-06)
mat1.add_element("Gd", 1.983300e-09)
mat1.add_nuclide("Li6", 9.190400e-10)
...
mat3.add_nuclide("H1", 6.669900e-02)
mat3.add_nuclide("O16", 3.334900e-02)
...
mat6.add_nuclide("H1", 5.478000e-02)
mat6.add_element("N", 3.375000e-03)
...
mat6.add_nuclide("Am241", 1.437900e-06)
...
# Critical solution height (case 108)
surf6 = openmc.ZPlane(surface_id=6, z0=45.09)
...
source.space = openmc.stats.Box((-20.7, -1.0, 43.55), (20.7, 1.0, 52.535))
