"""
MST006-2: 3-D Model of Exp't No. 2237 with H/X=298 and 0.230 gGd/L
...
mat1.add_nuclide("Pu238", 5.294000e-07)
mat1.add_nuclide("Pu239", 1.751800e-04)
mat1.add_nuclide("Pu240", 4.726600e-05)
mat1.add_nuclide("Pu241", 6.721200e-06)
mat1.add_nuclide("Pu242", 2.484200e-06)
mat1.add_nuclide("Am241", 1.442700e-06)
mat1.add_nuclide("U234", 6.584700e-08)
mat1.add_nuclide("U235", 2.699700e-06)
mat1.add_nuclide("U236", 2.579000e-07)
mat1.add_nuclide("U238", 5.457100e-04)
mat1.add_element("N", 3.808100e-03)
mat1.add_nuclide("O16", 3.916200e-02)
mat1.add_nuclide("H1", 5.496900e-02)
...
mat1.add_element("Gd", 8.791700e-07)
...
source.space = openmc.stats.Point((0.0, 0.0, 16.855))
