"""
MIX-MET-FAST-011; ZPPR-21 Phase B; Benchmark Model
...
mat1.add_nuclide("Pu238", 4.906910e-07)
mat1.add_nuclide("Pu239", 4.030450e-03)
mat1.add_nuclide("Pu240", 2.654940e-04)
mat1.add_nuclide("Pu241", 9.526050e-06)
mat1.add_nuclide("Pu242", 2.031070e-06)
mat1.add_nuclide("Am241", 2.200520e-05)
mat1.add_nuclide("U234", 1.092610e-05)
mat1.add_nuclide("U235", 1.124700e-03)
mat1.add_nuclide("U236", 5.237840e-06)
mat1.add_nuclide("U238", 4.961200e-03)
mat1.add_element("Cr", 3.648130e-03)
mat1.add_element("Ni", 1.625610e-03)
mat1.add_element("Fe", 1.281970e-02)
mat1.add_element("Al", 3.307700e-04)
mat1.add_element("C", 3.908830e-05)
mat1.add_element("Mo", 2.412170e-04)
mat1.add_element("Mn", 3.018420e-04)
mat1.add_element("Cu", 3.225480e-05)
mat1.add_element("Si", 1.774060e-04)
mat1.add_element("N", 1.086730e-06)
mat1.add_element("Co", 9.219440e-07)
...
mat3.add_element("Cr", 1.433100e-03)
mat3.add_element("Ni", 5.813750e-04)
mat3.add_element("Fe", 5.157970e-03)
mat3.add_element("Al", 2.376520e-08)
mat3.add_element("C", 6.634590e-02)
mat3.add_element("Mo", 8.955440e-06)
mat3.add_element("Mn", 1.202530e-04)
mat3.add_element("Cu", 1.784320e-05)
mat3.add_element("Si", 7.749340e-05)

mat4 = openmc.Material(material_id=4)
mat4.set_density("sum")
mat4.add_element("Cr", 3.140470e-03)
mat4.add_element("Ni", 1.394520e-03)
mat4.add_element("Fe", 1.116090e-02)
mat4.add_element("Al", 5.776680e-06)
mat4.add_element("C", 3.746370e-05)
mat4.add_element("Mo", 1.321440e-05)
mat4.add_element("Mn", 2.530370e-04)
mat4.add_element("Cu", 3.107160e-05)
mat4.add_element("Si", 1.792490e-04)
mat4.add_element("Co", 1.661760e-06)
...
mat7.add_element("Na", 1.754040e-06)
...
surf2 = openmc.ZCylinder(surface_id=2, r=31.55778)
...
surf12 = openmc.ZPlane(surface_id=12, z0=-20.68936)
surf13 = openmc.ZPlane(surface_id=13, z0=-30.84936)
surf14 = openmc.ZPlane(surface_id=14, z0=-48.62936)
surf15 = openmc.ZPlane(surface_id=15, z0=-59.28505)
surf16 = openmc.ZPlane(surface_id=16, z0=-126.40113)
