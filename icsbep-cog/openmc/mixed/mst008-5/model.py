"""
MIX-SOL-THERM-008-5: Raschig rings in 82.4 gPu/l with 191 gU/l and 3.6M solution (Model 3)
...
mat1.add_nuclide("Am241", 4.615700e-08)
mat1.add_nuclide("Pu238", 3.126800e-08)
mat1.add_nuclide("Pu239", 1.949200e-04)
mat1.add_nuclide("Pu240", 1.170600e-05)
mat1.add_nuclide("Pu241", 7.451900e-07)
mat1.add_nuclide("Pu242", 1.209500e-07)
mat1.add_nuclide("U234", 2.948800e-08)
mat1.add_nuclide("U235", 3.254300e-06)
mat1.add_nuclide("U236", 5.847500e-08)
mat1.add_nuclide("U238", 4.798800e-04)
mat1.add_element("Gd", 7.573500e-08)
mat1.add_element("Fe", 1.475000e-05)
mat1.add_element("N", 4.009100e-03)
mat1.add_nuclide("H1", 5.449000e-02)
...
# Critical height (case 5)
surf6 = openmc.ZPlane(surface_id=6, z0=79.78)
...
source.space = openmc.stats.Point((0.0, 0.0, 39.89))
