...
# Borated water for PNL-30
mat4 = openmc.Material(material_id=4)
mat4.set_density("sum")
mat4.add_nuclide("H1", 6.670600e-02)
mat4.add_nuclide("O16", 3.335300e-02)
mat4.add_nuclide("B10", 1.870600e-08)
mat4.add_nuclide("B11", 7.577000e-08)
...
surf90 = openmc.ZCylinder(surface_id=90, r=50.0, boundary_type="vacuum")
...
surf151 = openmc.YPlane(surface_id=151, y0=-50.673)
surf152 = openmc.YPlane(surface_id=152, y0=-48.895)
surf153 = openmc.YPlane(surface_id=153, y0=-47.117)
surf154 = openmc.YPlane(surface_id=154, y0=-45.339)
surf155 = openmc.YPlane(surface_id=155, y0=-43.561)
surf156 = openmc.YPlane(surface_id=156, y0=-41.783)
surf157 = openmc.YPlane(surface_id=157, y0=-40.005)
surf158 = openmc.YPlane(surface_id=158, y0=-38.227)
surf159 = openmc.YPlane(surface_id=159, y0=-36.449)
surf160 = openmc.YPlane(surface_id=160, y0=-34.671)
surf161 = openmc.YPlane(surface_id=161, y0=-32.893)
surf162 = openmc.YPlane(surface_id=162, y0=-31.115)
surf163 = openmc.YPlane(surface_id=163, y0=-29.337)
surf164 = openmc.YPlane(surface_id=164, y0=-27.559)
surf165 = openmc.YPlane(surface_id=165, y0=-25.781)
surf166 = openmc.YPlane(surface_id=166, y0=-24.003)
surf167 = openmc.YPlane(surface_id=167, y0=-22.225)
surf168 = openmc.YPlane(surface_id=168, y0=-20.447)
surf169 = openmc.YPlane(surface_id=169, y0=-18.669)
surf170 = openmc.YPlane(surface_id=170, y0=-16.891)
surf171 = openmc.YPlane(surface_id=171, y0=-15.113)
surf172 = openmc.YPlane(surface_id=172, y0=-13.335)
surf173 = openmc.YPlane(surface_id=173, y0=-11.557)
surf174 = openmc.YPlane(surface_id=174, y0=-9.779)
surf175 = openmc.YPlane(surface_id=175, y0=-8.001)
surf176 = openmc.YPlane(surface_id=176, y0=-6.223)
surf177 = openmc.YPlane(surface_id=177, y0=-4.445)
surf178 = openmc.YPlane(surface_id=178, y0=-2.667)
surf179 = openmc.YPlane(surface_id=179, y0=-0.889)
surf180 = openmc.YPlane(surface_id=180, y0=0.889)
...
cell15.translation = (49.784, -49.784, 0.0)
cell15.region = +surf129 & -surf130 & +surf151 & -surf152 & +surf191 & -surf192
