"""
MCT013-5: MOX/Polystyrene with H/X=226 with 2.52 SST absorber and 15.24cm Lucite reflector
...
mat2.add_element("Cr", 1.555900e-02)
mat2.add_element("Ni", 6.126400e-03)
mat2.add_element("Fe", 5.955500e-02)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 2.52 + 16.3293 = 33.5207 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.671399999999998, 18.8493)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=2.52)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.911399999999997, 34.089299999999994, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 11.68))
