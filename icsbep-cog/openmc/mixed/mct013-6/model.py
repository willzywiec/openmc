"""
MCT013-6: MOX/Polystyrene with H/X=226 with 3.80 SST absorber and 15.24cm Lucite reflector
...
mat2.add_element("Cr", 1.547700e-02)
mat2.add_element("Ni", 6.094200e-03)
mat2.add_element("Fe", 5.924100e-02)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 3.80 + 18.1583 = 36.6297 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.6714, 21.9583)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=3.80)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.9114, 37.1983, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 13.88))
