"""
MCT012-29: MOX/Polystyrene (H/SQRT(LxW)=0.48) with H/X=172 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-33.085, 33.085, -30.54, 30.54, -7.215, 7.215)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-48.325, 48.325, -45.78, 45.78, -22.455, 22.455, boundary_type="vacuum")
