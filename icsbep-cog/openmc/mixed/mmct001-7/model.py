"""
MMCT001-7: Experiment 113 with 996 FFTF rods immersed in 102.23 gPu/l, 359.69 gU/l and 0.98 gGd/l solution
...
mat9.add_nuclide("H1", 6.670900e-02)
mat9.add_nuclide("O16", 3.335400e-02)
mat9.add_s_alpha_beta("c_H_in_H2O")

# Plutonium-uranium
mat10 = openmc.Material(material_id=10)
mat10.set_density("sum")
mat10.add_nuclide("Pu238", 1.047400e-07)
mat10.add_nuclide("Pu239", 2.346500e-04)
mat10.add_nuclide("Pu240", 2.136300e-05)
mat10.add_nuclide("Pu241", 1.070100e-06)
mat10.add_nuclide("Pu242", 2.428900e-07)
mat10.add_nuclide("Am241", 1.411200e-06)
mat10.add_nuclide("U238", 9.029500e-04)
mat10.add_nuclide("U236", 4.863600e-07)
mat10.add_nuclide("U235", 6.515500e-06)
mat10.add_nuclide("U234", 6.478600e-08)
mat10.add_nuclide("H1", 5.560600e-02)
mat10.add_element("N", 3.241200e-03)
mat10.add_element("Gd", 3.753000e-06)
mat10.add_nuclide("O16", 3.915100e-02)
mat10.add_element("B", 1.013200e-07)
mat10.add_element("Mn", 1.891100e-07)
mat10.add_element("Cd", 3.129200e-08)
mat10.add_element("Fe", 4.050200e-06)
...
# Solution height (case 113)
surf9 = openmc.ZPlane(surface_id=9, z0=38.78)
# SS316 clad, inner
...
source.space = openmc.stats.Box((-1.7, -1.7, 40.496), (1.7, 1.7, 42.496))
