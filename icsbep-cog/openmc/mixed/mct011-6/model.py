"""
MCT011-6: 151 Rapsodie pins with 2.5 cm pitch and Hc = 30.54 cm
...
surf9 = openmc.ZPlane(surface_id=9, z0=30.54)
...
# Unit
surf21 = openmc.ZCylinder(surface_id=21, x0=-1.25, y0=2.1650635, r=0.425)
# triangular
surf22 = openmc.ZCylinder(surface_id=22, x0=1.25, y0=2.1650635, r=0.425)
# cell
surf23 = openmc.ZCylinder(surface_id=23, x0=-2.5, y0=0.0, r=0.425)
# of seven
surf24 = openmc.ZCylinder(surface_id=24, x0=2.5, y0=0.0, r=0.425)
# fuel
surf25 = openmc.ZCylinder(surface_id=25, x0=-1.25, y0=-2.1650635, r=0.425)
# pins
surf26 = openmc.ZCylinder(surface_id=26, x0=1.25, y0=-2.1650635, r=0.425)
# Hexagonal prism
...
# Inner X-Y prism for fuel
surf31 = openmc.model.RectangularParallelepiped(-5.0, 5.0, -16.238, 16.238, -499.9995, 499.9995)
# Inner X-Y prism for fuel
surf32 = openmc.model.RectangularParallelepiped(-5.0, 5.0, -16.238, 16.238, -499.9995, 499.9995)
# Inner X-Y prism for fuel
surf33 = openmc.model.RectangularParallelepiped(-5.0, 5.0, -16.238, 16.238, -499.9995, 499.9995)
# Inner X-Y prism for holes
surf34 = openmc.model.RectangularParallelepiped(-7.5, 7.5, -16.238, 16.238, -499.9995, 499.9995)
# Inner X-Y prism for holes
surf35 = openmc.model.RectangularParallelepiped(-7.5, 7.5, -16.238, 16.238, -499.9995, 499.9995)
# Inner X-Y prism for holes
surf36 = openmc.model.RectangularParallelepiped(-7.5, 7.5, -16.238, 16.238, -499.9995, 499.9995)
...
u1_cell5.region = (+surf5 | -surf5_zmin | +surf5_zmax) & +surf6 & -surf91
...
u1_cell10.region = (+surf5 | -surf5_zmin | +surf5_zmax) & +surf6 & (-surf7 & +surf7_zmin & -surf7_zmax) & +surf9 & -surf10 & +surf91
u1_cell11 = openmc.Cell(fill=mat4)
u1_cell11.region = (+surf5 | -surf5_zmin | +surf5_zmax) & +surf6 & (-surf7 & +surf7_zmin & -surf7_zmax) & +surf8 & -surf9 & +surf91
...
cell1.region = (-surf11 & +surf11_zmin & -surf11_zmax) & (-surf30_0 & -surf30_1 & -surf30_2 & -surf30_3 & -surf30_4 & -surf30_5) & -surf99

# Farray
cell2 = openmc.Cell(cell_id=2, fill=universe6)
cell2.region = (-surf11 & +surf11_zmin & -surf11_zmax) & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & -surf31 & -surf99

# Farray
cell3 = openmc.Cell(cell_id=3, fill=universe6)
cell3.region = (-surf11 & +surf11_zmin & -surf11_zmax) & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & +surf31 & -surf32 & -surf99

# Farray
cell4 = openmc.Cell(cell_id=4, fill=universe6)
cell4.region = (-surf11 & +surf11_zmin & -surf11_zmax) & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & +surf31 & +surf32 & -surf33 & -surf99

# Harray
cell5 = openmc.Cell(cell_id=5, fill=universe7)
cell5.region = (-surf11 & +surf11_zmin & -surf11_zmax) & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & +surf31 & +surf32 & +surf33 & -surf34 & -surf99

# Harray
cell6 = openmc.Cell(cell_id=6, fill=universe7)
cell6.region = (-surf11 & +surf11_zmin & -surf11_zmax) & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & +surf31 & +surf32 & +surf33 & +surf34 & -surf35 & -surf99

# Harray
cell7 = openmc.Cell(cell_id=7, fill=universe7)
cell7.region = (-surf11 & +surf11_zmin & -surf11_zmax) & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & +surf31 & +surf32 & +surf33 & +surf34 & +surf35 & -surf36 & -surf99

# Alles
cell8 = openmc.Cell(cell_id=8, fill=universe3)
cell8.region = (-surf11 & +surf11_zmin & -surf11_zmax) & (+surf30_0 | +surf30_1 | +surf30_2 | +surf30_3 | +surf30_4 | +surf30_5) & +surf31 & +surf32 & +surf33 & +surf34 & +surf35 & +surf36 & -surf99

# Alles
cell9 = openmc.Cell(cell_id=9, fill=universe3)
cell9.region = (-surf11 & +surf11_zmin & -surf11_zmax) & +surf99
...
source.space = openmc.stats.Point((0.0, 0.0, 16.53))
