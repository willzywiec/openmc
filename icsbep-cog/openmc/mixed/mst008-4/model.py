"""
MIX-SOL-THERM-008-4: Raschig rings in 83.7 gPu/l with 181 gU/l and 3.8M solution (Model 3)
...
mat1.add_nuclide("Am241", 4.507200e-08)
mat1.add_nuclide("Pu238", 4.023100e-08)
mat1.add_nuclide("Pu239", 1.981000e-04)
mat1.add_nuclide("Pu240", 1.180300e-05)
mat1.add_nuclide("Pu241", 7.276700e-07)
mat1.add_nuclide("Pu242", 1.270200e-07)
mat1.add_nuclide("U234", 2.794400e-08)
mat1.add_nuclide("U235", 3.083900e-06)
mat1.add_nuclide("U236", 5.541300e-08)
mat1.add_nuclide("U238", 4.547600e-04)
mat1.add_element("Gd", 7.693000e-08)
mat1.add_element("Fe", 1.498200e-05)
mat1.add_element("N", 4.092700e-03)
mat1.add_nuclide("H1", 5.372100e-02)
mat1.add_nuclide("O16", 3.891100e-02)
...
# Critical height (case 4)
surf6 = openmc.ZPlane(surface_id=6, z0=76.07)
...
source.space = openmc.stats.Point((0.0, 0.0, 38.035))
