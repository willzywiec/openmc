"""
MCT013-11: MOX/Polystyrene with H/X=226 with 1.89 SST-1.1B absorber and 15.24cm Lucite reflector
...
mat2.add_nuclide("B10", 8.700100e-04)
mat2.add_nuclide("B11", 3.501900e-03)
mat2.add_element("Fe", 5.901700e-02)
mat2.add_element("Cr", 1.541900e-02)
mat2.add_element("Ni", 6.074500e-03)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 1.89 + 21.6550 = 38.2164 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.6714, 23.545)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=1.89)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.6714, 38.544999999999995, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 13.72))
