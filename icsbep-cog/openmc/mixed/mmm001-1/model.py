...
surf1_zmin = openmc.ZPlane(surface_id=1053, z0=7.913)
surf1_zmax = openmc.ZPlane(surface_id=1054, z0=8.9)
surf2_zmin = openmc.ZPlane(surface_id=1055, z0=6.918)
surf2_zmax = openmc.ZPlane(surface_id=1056, z0=7.913)
surf3_zmin = openmc.ZPlane(surface_id=1057, z0=5.931)
surf3_zmax = openmc.ZPlane(surface_id=1058, z0=6.918)
surf4_zmin = openmc.ZPlane(surface_id=1059, z0=5.461)
surf4_zmax = openmc.ZPlane(surface_id=1060, z0=5.911)
surf5_zmin = openmc.ZPlane(surface_id=1061, z0=5.441)
surf5_zmax = openmc.ZPlane(surface_id=1062, z0=5.931)
surf6_zmin = openmc.ZPlane(surface_id=1063, z0=5.666)
surf6_zmax = openmc.ZPlane(surface_id=1064, z0=5.706)
surf7_zmin = openmc.ZPlane(surface_id=1065, z0=5.706)
surf7_zmax = openmc.ZPlane(surface_id=1066, z0=5.931)
surf8_zmin = openmc.ZPlane(surface_id=1067, z0=5.441)
surf8_zmax = openmc.ZPlane(surface_id=1068, z0=5.931)
surf9_zmin = openmc.ZPlane(surface_id=1069, z0=4.454)
surf9_zmax = openmc.ZPlane(surface_id=1070, z0=5.441)
surf10_zmin = openmc.ZPlane(surface_id=1071, z0=3.459)
surf10_zmax = openmc.ZPlane(surface_id=1072, z0=4.454)
surf11_zmin = openmc.ZPlane(surface_id=1073, z0=2.472)
surf11_zmax = openmc.ZPlane(surface_id=1074, z0=3.459)
surf12_zmin = openmc.ZPlane(surface_id=1075, z0=2.002)
surf12_zmax = openmc.ZPlane(surface_id=1076, z0=2.452)
surf13_zmin = openmc.ZPlane(surface_id=1077, z0=1.982)
surf13_zmax = openmc.ZPlane(surface_id=1078, z0=2.472)
surf14_zmin = openmc.ZPlane(surface_id=1079, z0=2.207)
surf14_zmax = openmc.ZPlane(surface_id=1080, z0=2.247)
surf15_zmin = openmc.ZPlane(surface_id=1081, z0=2.247)
surf15_zmax = openmc.ZPlane(surface_id=1082, z0=2.472)
surf16_zmin = openmc.ZPlane(surface_id=1083, z0=1.982)
surf16_zmax = openmc.ZPlane(surface_id=1084, z0=2.472)
surf17_zmin = openmc.ZPlane(surface_id=1085, z0=0.995)
surf17_zmax = openmc.ZPlane(surface_id=1086, z0=1.982)
surf19_zmin = openmc.ZPlane(surface_id=1087, z0=0.0)
surf19_zmax = openmc.ZPlane(surface_id=1088, z0=0.995)
surf21_zmin = openmc.ZPlane(surface_id=1089, z0=0.0)
surf21_zmax = openmc.ZPlane(surface_id=1090, z0=0.2)
surf22_zmin = openmc.ZPlane(surface_id=1091, z0=0.2)
surf22_zmax = openmc.ZPlane(surface_id=1092, z0=0.8)
surf23_zmin = openmc.ZPlane(surface_id=1093, z0=-2.107)
surf23_zmax = openmc.ZPlane(surface_id=1094, z0=-1.12)
surf24_zmin = openmc.ZPlane(surface_id=1095, z0=-2.577)
surf24_zmax = openmc.ZPlane(surface_id=1096, z0=-2.127)
surf25_zmin = openmc.ZPlane(surface_id=1097, z0=-2.597)
surf25_zmax = openmc.ZPlane(surface_id=1098, z0=-2.107)
surf26_zmin = openmc.ZPlane(surface_id=1099, z0=-2.372)
surf26_zmax = openmc.ZPlane(surface_id=1100, z0=-2.332)
surf27_zmin = openmc.ZPlane(surface_id=1101, z0=-2.332)
surf27_zmax = openmc.ZPlane(surface_id=1102, z0=-2.107)
surf28_zmin = openmc.ZPlane(surface_id=1103, z0=-2.597)
surf28_zmax = openmc.ZPlane(surface_id=1104, z0=-2.107)
surf29_zmin = openmc.ZPlane(surface_id=1105, z0=-3.584)
surf29_zmax = openmc.ZPlane(surface_id=1106, z0=-2.597)
surf30_zmin = openmc.ZPlane(surface_id=1107, z0=-4.579)
surf30_zmax = openmc.ZPlane(surface_id=1108, z0=-3.584)
surf31_zmin = openmc.ZPlane(surface_id=1109, z0=-5.566)
surf31_zmax = openmc.ZPlane(surface_id=1110, z0=-4.579)
surf32_zmin = openmc.ZPlane(surface_id=1111, z0=-6.036)
surf32_zmax = openmc.ZPlane(surface_id=1112, z0=-5.586)
surf33_zmin = openmc.ZPlane(surface_id=1113, z0=-6.056)
surf33_zmax = openmc.ZPlane(surface_id=1114, z0=-5.566)
surf34_zmin = openmc.ZPlane(surface_id=1115, z0=-5.831)
surf34_zmax = openmc.ZPlane(surface_id=1116, z0=-5.791)
surf35_zmin = openmc.ZPlane(surface_id=1117, z0=-5.791)
surf35_zmax = openmc.ZPlane(surface_id=1118, z0=-5.566)
surf36_zmin = openmc.ZPlane(surface_id=1119, z0=-6.056)
surf36_zmax = openmc.ZPlane(surface_id=1120, z0=-5.566)
surf37_zmin = openmc.ZPlane(surface_id=1121, z0=-7.043)
surf37_zmax = openmc.ZPlane(surface_id=1122, z0=-6.056)
surf38_zmin = openmc.ZPlane(surface_id=1123, z0=-8.038)
surf38_zmax = openmc.ZPlane(surface_id=1124, z0=-7.043)
surf39_zmin = openmc.ZPlane(surface_id=1125, z0=-9.025)
surf39_zmax = openmc.ZPlane(surface_id=1126, z0=-8.038)
surf40_zmin = openmc.ZPlane(surface_id=1127, z0=-9.495)
surf40_zmax = openmc.ZPlane(surface_id=1128, z0=-9.045)
surf41_zmin = openmc.ZPlane(surface_id=1129, z0=-9.515)
surf41_zmax = openmc.ZPlane(surface_id=1130, z0=-9.025)
surf42_zmin = openmc.ZPlane(surface_id=1131, z0=-9.29)
surf42_zmax = openmc.ZPlane(surface_id=1132, z0=-9.25)
surf43_zmin = openmc.ZPlane(surface_id=1133, z0=-9.25)
surf43_zmax = openmc.ZPlane(surface_id=1134, z0=-9.025)
surf44_zmin = openmc.ZPlane(surface_id=1135, z0=-9.515)
surf44_zmax = openmc.ZPlane(surface_id=1136, z0=-9.025)
surf45_zmin = openmc.ZPlane(surface_id=1137, z0=-10.502)
surf45_zmax = openmc.ZPlane(surface_id=1138, z0=-9.515)
surf46_zmin = openmc.ZPlane(surface_id=1139, z0=-11.497)
surf46_zmax = openmc.ZPlane(surface_id=1140, z0=-10.502)
surf47_zmin = openmc.ZPlane(surface_id=1141, z0=-12.484)
surf47_zmax = openmc.ZPlane(surface_id=1142, z0=-11.497)
surf48_zmin = openmc.ZPlane(surface_id=1143, z0=-12.954)
surf48_zmax = openmc.ZPlane(surface_id=1144, z0=-12.504)
surf49_zmin = openmc.ZPlane(surface_id=1145, z0=-12.974)
surf49_zmax = openmc.ZPlane(surface_id=1146, z0=-12.484)
surf50_zmin = openmc.ZPlane(surface_id=1147, z0=-12.749)
surf50_zmax = openmc.ZPlane(surface_id=1148, z0=-12.709)
surf51_zmin = openmc.ZPlane(surface_id=1149, z0=-12.709)
surf51_zmax = openmc.ZPlane(surface_id=1150, z0=-12.484)
surf52_zmin = openmc.ZPlane(surface_id=1151, z0=-12.974)
surf52_zmax = openmc.ZPlane(surface_id=1152, z0=-12.484)
surf53_zmin = openmc.ZPlane(surface_id=1153, z0=-13.961)
surf53_zmax = openmc.ZPlane(surface_id=1154, z0=-12.974)
