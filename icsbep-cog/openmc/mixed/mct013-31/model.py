"""
MCT013-31: MOX/Polystyrene with H/X=226 with 5.80 Lead absorber and 15.24cm Lucite reflector
...
mat2.add_element("Fe", 3.726600e-05)
mat2.add_element("Cu", 1.091700e-05)
mat2.add_element("Pb", 3.324700e-02)
mat2.add_element("Bi", 3.319600e-06)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 5.80 + 14.7497 = 35.2211 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.6714, 20.5497)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.0)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=5.80)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.911399999999997, 35.789699999999996, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 14.17))
