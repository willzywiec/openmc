"""
MIX-SOL-THERM-008-8: Raschig rings in 79.4 gPu/l with 182 gU/l and 3.4 solution (Model 3)
...
mat1.add_nuclide("Am241", 4.619600e-08)
mat1.add_nuclide("Pu238", 3.213800e-08)
mat1.add_nuclide("Pu239", 1.877000e-04)
mat1.add_nuclide("Pu240", 1.137400e-05)
mat1.add_nuclide("Pu241", 7.458200e-07)
mat1.add_nuclide("Pu242", 1.145700e-07)
mat1.add_nuclide("U234", 2.809800e-08)
mat1.add_nuclide("U235", 3.100900e-06)
mat1.add_nuclide("U236", 5.571900e-08)
mat1.add_nuclide("U238", 4.572700e-04)
mat1.add_element("Gd", 7.297800e-08)
mat1.add_element("Fe", 1.421300e-05)
mat1.add_element("N", 3.811200e-03)
mat1.add_nuclide("H1", 5.486600e-02)
mat1.add_nuclide("O16", 3.876400e-02)
...
# Critical height (case 8)
surf6 = openmc.ZPlane(surface_id=6, z0=85.70)
...
source.space = openmc.stats.Point((0.0, 0.0, 42.85))
