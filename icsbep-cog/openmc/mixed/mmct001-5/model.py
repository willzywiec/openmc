"""
MMCT001-5: Experiment 111 with 996 FFTF rods immersed in 103.70 gPu/l and 363.98 gU/l solution
...
mat9.add_nuclide("H1", 6.672900e-02)
mat9.add_nuclide("O16", 3.336400e-02)
mat9.add_s_alpha_beta("c_H_in_H2O")

# Plutonium-uranium
mat10 = openmc.Material(material_id=10)
mat10.set_density("sum")
mat10.add_nuclide("Pu238", 1.062500e-07)
mat10.add_nuclide("Pu239", 2.380300e-04)
mat10.add_nuclide("Pu240", 2.167000e-05)
mat10.add_nuclide("Pu241", 1.085500e-06)
mat10.add_nuclide("Pu242", 2.463800e-07)
mat10.add_nuclide("Am241", 1.431500e-06)
mat10.add_nuclide("U238", 9.137200e-04)
mat10.add_nuclide("U236", 4.921600e-07)
mat10.add_nuclide("U235", 6.593200e-06)
mat10.add_nuclide("U234", 6.555900e-08)
mat10.add_nuclide("H1", 5.529100e-02)
mat10.add_element("N", 3.283700e-03)
mat10.add_nuclide("O16", 3.913900e-02)
mat10.add_element("B", 1.027700e-07)
mat10.add_element("Mn", 1.918300e-07)
mat10.add_element("Cd", 3.174200e-08)
mat10.add_element("Fe", 4.108400e-06)
...
# Solution height (case 111)
surf9 = openmc.ZPlane(surface_id=9, z0=23.87)
# SS316 clad, inner
...
source.space = openmc.stats.Box((-1.7, -1.7, 33.041), (1.7, 1.7, 35.041))
