"""
MMCT001-10: Experiment 116 with 996 FFTF rods immersed in 103.61 gPu/l, 362.45 gU/l and 2.16 gGd/l solution
...
mat9.add_nuclide("H1", 6.676200e-02)
mat9.add_nuclide("O16", 3.338100e-02)
mat9.add_s_alpha_beta("c_H_in_H2O")

# Plutonium-uranium
mat10 = openmc.Material(material_id=10)
mat10.set_density("sum")
mat10.add_nuclide("Pu238", 1.061500e-07)
mat10.add_nuclide("Pu239", 2.378200e-04)
mat10.add_nuclide("Pu240", 2.165100e-05)
mat10.add_nuclide("Pu241", 1.084500e-06)
mat10.add_nuclide("Pu242", 2.461700e-07)
mat10.add_nuclide("Am241", 1.430200e-06)
mat10.add_nuclide("U238", 9.098800e-04)
mat10.add_nuclide("U236", 4.900900e-07)
mat10.add_nuclide("U235", 6.565500e-06)
mat10.add_nuclide("U234", 6.528300e-08)
mat10.add_nuclide("H1", 5.523300e-02)
mat10.add_element("N", 3.269100e-03)
mat10.add_element("Gd", 8.272000e-06)
mat10.add_nuclide("O16", 3.906200e-02)
mat10.add_element("B", 1.026800e-07)
mat10.add_element("Mn", 1.916600e-07)
mat10.add_element("Cd", 3.171400e-08)
mat10.add_element("Fe", 4.014800e-06)
...
# Solution height (case 116)
surf9 = openmc.ZPlane(surface_id=9, z0=90.27)
# SS316 clad, inner
...
source.space = openmc.stats.Box((-1.7, -1.7, 66.241), (1.7, 1.7, 68.241))
