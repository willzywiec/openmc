"""
MCT013-29: MOX/Polystyrene with H/X=226 with 3.28 Lead absorber and 15.24cm Lucite reflector
...
mat2.add_element("Fe", 3.647700e-05)
mat2.add_element("Pb", 3.254300e-02)
mat2.add_element("Bi", 3.249300e-06)
mat2.add_element("Cu", 1.068600e-05)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 3.28 + 12.2849 = 30.2363 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.6714, 15.5649)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.0)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=3.28)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.911399999999997, 30.8049, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 10.42))
