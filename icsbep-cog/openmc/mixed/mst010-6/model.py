"""
MST010-6: Exp. 146 with H/X=289 and 0.388 gGd/L and 1.2 gB/L
...
mat1.add_nuclide("Pu238", 2.702000e-08)
mat1.add_nuclide("Pu239", 1.932600e-04)
mat1.add_nuclide("Pu240", 1.259500e-05)
mat1.add_nuclide("Pu241", 9.195300e-07)
mat1.add_nuclide("Pu242", 1.062900e-07)
mat1.add_nuclide("U234", 3.694800e-08)
mat1.add_nuclide("U235", 3.026000e-06)
mat1.add_nuclide("U236", 5.953000e-08)
mat1.add_nuclide("U238", 4.509800e-04)
mat1.add_nuclide("Am241", 5.373700e-08)
mat1.add_nuclide("H1", 5.708800e-02)
mat1.add_element("N", 3.098200e-03)
mat1.add_nuclide("O16", 3.820900e-02)
mat1.add_nuclide("Gd152", 2.971800e-09)
mat1.add_nuclide("Gd154", 3.239300e-08)
mat1.add_nuclide("Gd155", 2.199100e-07)
mat1.add_nuclide("Gd156", 3.041600e-07)
mat1.add_nuclide("Gd157", 2.325400e-07)
mat1.add_nuclide("Gd158", 3.691000e-07)
mat1.add_nuclide("Gd160", 3.248200e-07)
mat1.add_nuclide("B10", 1.323400e-05)
mat1.add_nuclide("B11", 5.360400e-05)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=43.03)
# Solution tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 21.515))
