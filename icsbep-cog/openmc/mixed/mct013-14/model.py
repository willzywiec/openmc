"""
MCT013-14: MOX/Polystyrene with H/X=226 with 1.28 SST-1.6B absorber and 15.24cm Lucite reflector
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 1.28 + 21.2442 = 37.1956 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.671399999999998, 22.5242)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=1.28)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.9114, 37.7642, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 12.9))
