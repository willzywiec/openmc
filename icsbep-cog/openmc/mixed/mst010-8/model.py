"""
MST010-8: Exp. 150 with H/X=296 and 0.519 gGd/L and 1.5 gB/L
...
mat1.add_nuclide("Pu238", 2.662400e-08)
mat1.add_nuclide("Pu239", 1.904300e-04)
mat1.add_nuclide("Pu240", 1.241100e-05)
mat1.add_nuclide("Pu241", 9.060500e-07)
mat1.add_nuclide("Pu242", 1.047300e-07)
mat1.add_nuclide("U234", 3.713500e-08)
mat1.add_nuclide("U235", 3.041300e-06)
mat1.add_nuclide("U236", 5.983200e-08)
mat1.add_nuclide("U238", 4.532700e-04)
mat1.add_nuclide("Am241", 6.066000e-08)
mat1.add_nuclide("H1", 5.754500e-02)
mat1.add_element("N", 3.069100e-03)
mat1.add_nuclide("O16", 3.838900e-02)
mat1.add_nuclide("Gd152", 3.975200e-09)
mat1.add_nuclide("Gd154", 4.332900e-08)
mat1.add_nuclide("Gd155", 2.941600e-07)
mat1.add_nuclide("Gd156", 4.068600e-07)
mat1.add_nuclide("Gd157", 3.110600e-07)
mat1.add_nuclide("Gd158", 4.937100e-07)
mat1.add_nuclide("Gd160", 4.344900e-07)
mat1.add_nuclide("B10", 1.654200e-05)
mat1.add_nuclide("B11", 6.700500e-05)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=67.83)
# Solution tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 33.915))
