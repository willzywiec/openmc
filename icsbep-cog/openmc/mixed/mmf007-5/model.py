"""
MixMF007-5: 2.472 kg alpha-Pu; 13.842 kg HEU; 2.74 cm Be
...
# HEU
surf2 = openmc.Sphere(surface_id=2, r=5.9280)
# Be
surf3 = openmc.Sphere(surface_id=3, r=8.6680, boundary_type="vacuum")
