"""
MCT012-13: MOX/Polystyrene (H/SQRT(LxW)=0.90) with H/X=705 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.32, 20.32, -18.21, 18.21)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.56, 35.56, -33.45, 33.45, boundary_type="vacuum")
