"""
MixMF007-17: 3.933 kg alpha-Pu; 6.912 kg HEU; 2.90 cm Be
...
# HEU
surf2 = openmc.Sphere(surface_id=2, r=5.1613)
# Be
surf3 = openmc.Sphere(surface_id=3, r=8.0613, boundary_type="vacuum")
