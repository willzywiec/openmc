"""
MIX-COMP-THERM-004-8: 20x20 MOX pins with 2.225 cm pitch; Hc=62.99
...
mat1.add_nuclide("Pu241", 2.664900e-05)
mat1.add_nuclide("Pu242", 8.123400e-06)
mat1.add_nuclide("Am241", 2.634000e-06)
...
surf5 = openmc.model.RectangularParallelepiped(-22.25, 22.25, -22.25, 22.25, -499.995, 499.995)
# BCD
surf6 = openmc.model.RectangularParallelepiped(-52.25, 52.25, -52.25, 52.25, -71.60000000000001, 81.17, boundary_type="vacuum")
# Middle grid, bottom
surf10 = openmc.ZPlane(surface_id=10, z0=80.57)
# Water height
surf11 = openmc.ZPlane(surface_id=11, z0=62.99)
# Al lower grid, top
...
surf1_zmin = openmc.ZPlane(surface_id=1018, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1019, z0=70.6)
surf2_zmin = openmc.ZPlane(surface_id=1020, z0=-16.83)
surf2_zmax = openmc.ZPlane(surface_id=1021, z0=0.0)
surf3_zmin = openmc.ZPlane(surface_id=1022, z0=70.6)
surf3_zmax = openmc.ZPlane(surface_id=1023, z0=81.17)
surf4_zmin = openmc.ZPlane(surface_id=1024, z0=-16.83)
surf4_zmax = openmc.ZPlane(surface_id=1025, z0=81.17)
...
u1_cell2.region = (+surf1 | -surf1_zmin | +surf1_zmax) & (+surf2 | -surf2_zmin | +surf2_zmax) & (+surf3 | -surf3_zmin | +surf3_zmax) & (-surf4 & +surf4_zmin & -surf4_zmax)
...
lattice4.universes = [
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3],
    [universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3, universe3],
...
cell6.region = (+surf1 | -surf1_zmin | +surf1_zmax) & (+surf2 | -surf2_zmin | +surf2_zmax) & (+surf3 | -surf3_zmin | +surf3_zmax) & (-surf4 & +surf4_zmin & -surf4_zmax)
...
cell17.region = (+surf4 | -surf4_zmin | +surf4_zmax) & -surf6
...
source.space = openmc.stats.Box((-2.1, -2.1, 30.495), (2.1, 2.1, 32.495000000000005))
