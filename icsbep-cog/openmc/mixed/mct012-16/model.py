"""
MCT012-16: MOX/Polystyrene (H/SQRT(LxW)=0.41) with H/X=226 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-22.905, 22.905, -25.45, 25.45, -9.91, 9.91)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-38.145, 38.145, -40.69, 40.69, -25.15, 25.15, boundary_type="vacuum")
