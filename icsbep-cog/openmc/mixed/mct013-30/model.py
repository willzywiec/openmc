"""
MCT013-30: MOX/Polystyrene with H/X=226 with 4.57 Lead absorber and 15.24cm Lucite reflector
...
mat2.add_element("Fe", 3.673600e-05)
mat2.add_element("Pb", 3.277400e-02)
mat2.add_element("Bi", 3.272400e-06)
mat2.add_element("Cu", 1.076200e-05)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 4.57 + 13.5368 = 32.7782 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.671399999999998, 18.1068)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.0)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=4.57)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.9114, 33.3468, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 12.34))
