"""
MIX-SOL-THERM-001-10: Exp. No. 098
...
mat1.add_nuclide("H1", 5.912100e-02)
mat1.add_element("N", 2.325700e-03)
mat1.add_nuclide("O16", 3.763200e-02)
mat1.add_nuclide("Pu238", 5.336400e-08)
mat1.add_nuclide("Pu239", 1.669700e-04)
mat1.add_nuclide("Pu240", 1.521500e-05)
mat1.add_nuclide("Pu241", 7.668600e-07)
mat1.add_nuclide("Pu242", 1.701100e-07)
mat1.add_nuclide("U234", 4.454800e-08)
mat1.add_nuclide("U235", 4.461200e-06)
mat1.add_nuclide("U236", 3.344300e-07)
mat1.add_nuclide("U238", 6.209000e-04)
mat1.add_nuclide("Am241", 1.000400e-06)
mat1.add_nuclide("B10", 3.974600e-08)
mat1.add_element("Cd", 2.221200e-08)
mat1.add_element("Fe", 2.302100e-06)
mat1.add_element("Gd", 3.064200e-09)
mat1.add_nuclide("Li6", 1.419900e-09)
...
mat3.add_nuclide("H1", 6.665100e-02)
mat3.add_nuclide("O16", 3.332500e-02)
...
mat6.add_nuclide("Am241", 1.421600e-06)
...
# Critical solution height (case 098)
surf6 = openmc.ZPlane(surface_id=6, z0=39.58)
...
source.space = openmc.stats.Box((-20.7, -1.0, 40.795), (20.7, 1.0, 52.535))
