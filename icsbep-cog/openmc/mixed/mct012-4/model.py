"""
MCT012-4: MOX/Polystyrene (H/SQRT(LxW)=0.64) with H/X=343 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.54, 30.54, -25.45, 25.45, -17.805, 17.805)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.78, 45.78, -40.69, 40.69, -33.045, 33.045, boundary_type="vacuum")
