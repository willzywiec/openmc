"""
MST010-7: Exp. 147 with H/X=293 and 0.424 gGd/L and 1.35 gB/L
...
mat1.add_nuclide("Pu238", 2.669900e-08)
mat1.add_nuclide("Pu239", 1.909700e-04)
mat1.add_nuclide("Pu240", 1.244600e-05)
mat1.add_nuclide("Pu241", 9.086200e-07)
mat1.add_nuclide("Pu242", 1.050300e-07)
mat1.add_nuclide("U234", 3.704100e-08)
mat1.add_nuclide("U235", 3.033600e-06)
mat1.add_nuclide("U236", 5.968100e-08)
mat1.add_nuclide("U238", 4.521300e-04)
mat1.add_nuclide("Am241", 5.696600e-08)
mat1.add_nuclide("H1", 5.704900e-02)
mat1.add_element("N", 3.117600e-03)
mat1.add_nuclide("O16", 3.824500e-02)
mat1.add_nuclide("Gd152", 3.247500e-09)
mat1.add_nuclide("Gd154", 3.539800e-08)
mat1.add_nuclide("Gd155", 2.403200e-07)
mat1.add_nuclide("Gd156", 3.323800e-07)
mat1.add_nuclide("Gd157", 2.541200e-07)
mat1.add_nuclide("Gd158", 4.033400e-07)
mat1.add_nuclide("Gd160", 3.549600e-07)
mat1.add_nuclide("B10", 1.488800e-05)
mat1.add_nuclide("B11", 6.030400e-05)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=52.12)
# Solution tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 26.06))
