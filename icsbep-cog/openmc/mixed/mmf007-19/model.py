"""
MixMF007-19: 4.664 kg alpha-Pu; 3.445 kg HEU; 3.57 cm Be
...
# HEU
surf2 = openmc.Sphere(surface_id=2, r=4.6732)
# Be
surf3 = openmc.Sphere(surface_id=3, r=8.2432, boundary_type="vacuum")
