"""
MIX-SOL-THERM-001-3: Exp. No. 091
...
mat1.add_nuclide("H1", 5.469900e-02)
mat1.add_element("N", 3.382800e-03)
mat1.add_nuclide("O16", 3.910600e-02)
mat1.add_nuclide("Pu238", 7.583600e-08)
mat1.add_nuclide("Pu239", 2.372800e-04)
mat1.add_nuclide("Pu240", 2.154900e-05)
mat1.add_nuclide("Pu241", 1.162100e-06)
mat1.add_nuclide("Pu242", 2.391700e-07)
mat1.add_nuclide("U234", 6.550100e-08)
mat1.add_nuclide("U235", 6.559400e-06)
mat1.add_nuclide("U236", 4.917300e-07)
mat1.add_nuclide("U238", 9.129400e-04)
mat1.add_nuclide("Am241", 1.365000e-06)
mat1.add_nuclide("B10", 5.648300e-08)
mat1.add_element("Cd", 3.156500e-08)
mat1.add_element("Fe", 3.271500e-06)
mat1.add_element("Gd", 4.354500e-09)
mat1.add_nuclide("Li6", 2.017900e-09)
...
mat3.add_nuclide("H1", 6.667900e-02)
mat3.add_nuclide("O16", 3.333900e-02)
mat3.add_s_alpha_beta("c_H_in_H2O")

# Concrete (091)
mat4 = openmc.Material(material_id=4)
mat4.set_density("sum")
mat4.add_nuclide("H1", 1.236500e-02)
mat4.add_nuclide("O16", 3.977700e-02)
mat4.add_element("Al", 2.356000e-03)
mat4.add_nuclide("B10", 4.884300e-06)
mat4.add_nuclide("B11", 1.951300e-05)
mat4.add_element("Ba", 6.722500e-06)
mat4.add_element("Ca", 5.067600e-03)
mat4.add_element("Cu", 2.075400e-06)
mat4.add_element("Fe", 1.036700e-03)
mat4.add_element("K", 1.821500e-04)
mat4.add_element("Li", 3.800000e-05)
mat4.add_element("Mg", 6.077300e-04)
mat4.add_element("Mn", 1.680400e-05)
mat4.add_element("Na", 1.084200e-03)
mat4.add_element("Si", 1.023700e-02)
mat4.add_element("Sr", 6.020700e-06)
mat4.add_element("Ti", 1.570000e-04)
mat4.add_element("Zr", 5.782900e-05)
...
mat6.add_nuclide("H1", 5.478300e-02)
mat6.add_element("N", 3.374800e-03)
mat6.add_nuclide("O16", 3.912500e-02)
mat6.add_nuclide("Pu238", 7.582800e-08)
mat6.add_nuclide("Pu239", 2.372500e-04)
mat6.add_nuclide("Pu240", 2.154700e-05)
mat6.add_nuclide("Pu241", 1.162000e-06)
mat6.add_nuclide("Pu242", 2.391500e-07)
...
mat6.add_nuclide("Am241", 1.364900e-06)
...
# Critical solution height (case 091)
surf6 = openmc.ZPlane(surface_id=6, z0=27.67)
...
surf11_zmax = openmc.ZPlane(z0=2.54)
surf13_zmin = openmc.ZPlane(z0=2.54)
surf13_zmax = openmc.ZPlane(z0=128.27)
...
source.space = openmc.stats.Box((-20.7, -1.0, 34.84), (20.7, 1.0, 52.535))
