"""
MCT012-23: MOX/Polystyrene (H/SQRT(LxW)=1.01) with H/X=172 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-15.27, 15.27, -15.27, 15.27, -15.445, 15.445)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-30.51, 30.51, -30.51, 30.51, -30.685, 30.685, boundary_type="vacuum")
