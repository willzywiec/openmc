"""
MMCT001-8: Experiment 114 with 996 FFTF rods immersed in 102.65 gPu/l, 359.59 gU/l and 1.47 gGd/l solution
...
mat10.add_nuclide("Pu238", 1.051700e-07)
mat10.add_nuclide("Pu239", 2.356200e-04)
mat10.add_nuclide("Pu240", 2.145100e-05)
mat10.add_nuclide("Pu241", 1.074500e-06)
mat10.add_nuclide("Pu242", 2.438900e-07)
mat10.add_nuclide("Am241", 1.417000e-06)
mat10.add_nuclide("U238", 9.027000e-04)
mat10.add_nuclide("U236", 4.862200e-07)
mat10.add_nuclide("U235", 6.513700e-06)
mat10.add_nuclide("U234", 6.476800e-08)
mat10.add_nuclide("H1", 5.544500e-02)
mat10.add_element("N", 3.250900e-03)
mat10.add_element("Gd", 5.629600e-06)
mat10.add_nuclide("O16", 3.909600e-02)
mat10.add_element("B", 1.017300e-07)
mat10.add_element("Mn", 1.898900e-07)
mat10.add_element("Cd", 3.142000e-08)
mat10.add_element("Fe", 4.066800e-06)
...
# Solution height (case 114)
surf9 = openmc.ZPlane(surface_id=9, z0=51.06)
# SS316 clad, inner
...
source.space = openmc.stats.Box((-1.7, -1.7, 46.636), (1.7, 1.7, 48.636))
