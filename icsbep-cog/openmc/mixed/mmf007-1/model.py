"""
MixMF007-1: 2.472 kg alpha-Pu; 2.140 kg HEU; 20 cm Be
...
# HEU
surf2 = openmc.Sphere(surface_id=2, r=3.8736)
# Be
surf3 = openmc.Sphere(surface_id=3, r=23.8736, boundary_type="vacuum")
