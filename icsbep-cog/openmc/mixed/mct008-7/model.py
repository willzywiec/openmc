"""
MIX-COMP-THERM-008-7: Central Al absorber rod and 232 MOX pins with 2.6670 cm pitch
...
mat7.add_element("Al", 5.882000e-02)
mat7.add_element("Ni", 4.499100e-04)
mat7.add_element("Fe", 8.702100e-05)
mat7.add_element("Si", 5.767900e-05)
...
# Hole
surf73 = openmc.ZCylinder(surface_id=73, r=0.71775)
...
surf71_zmin = openmc.ZPlane(z0=2.6035)
surf71_zmax = openmc.ZPlane(z0=94.0435)
surf72_zmin = openmc.ZPlane(z0=1.905)
surf72_zmax = openmc.ZPlane(z0=94.869)
surf73_zmin = openmc.ZPlane(z0=1.905)
surf73_zmax = openmc.ZPlane(z0=94.869)
...
u7_cell1.region = (+surf71 | -surf71_zmin | +surf71_zmax) & (-surf72 & +surf72_zmin & -surf72_zmax) & (-surf73 & +surf73_zmin & -surf73_zmax)
u7_cell2 = openmc.Cell(fill=mat6)
u7_cell2.region = (+surf72 | -surf72_zmin | +surf72_zmax) & (-surf73 & +surf73_zmin & -surf73_zmax)
...
cell2.region = -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & (-surf73 & +surf73_zmin & -surf73_zmax)
...
cell10.region = -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf108 & +surf6 & -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf118 & +surf6 & -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf128 & +surf6 & -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf138

# water
cell11 = openmc.Cell(cell_id=11, fill=mat6)
cell11.region = -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf109 & +surf6 & -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf119 & +surf6 & -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf129

# water
cell12 = openmc.Cell(cell_id=12, fill=mat6)
cell12.region = -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf110 & +surf6 & -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf120 & +surf6 & -surf14 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5) & -surf22 & -surf130
