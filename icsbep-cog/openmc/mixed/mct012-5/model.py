"""
MCT012-5: MOX/Polystyrene (H/SQRT(LxW)=0.57) with H/X=343 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.54, 30.54, -27.995, 27.995, -16.62, 16.62)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.78, 45.78, -43.235, 43.235, -31.86, 31.86, boundary_type="vacuum")
