"""
MixMF007-14: 3.933 kg alpha-Pu; 0.712 kg HEU; 10.20 cm Be
...
# alpha-Pu
surf1 = openmc.Sphere(surface_id=1, r=3.6537)
# HEU
surf2 = openmc.Sphere(surface_id=2, r=3.8690)
# Be
surf3 = openmc.Sphere(surface_id=3, r=14.0690, boundary_type="vacuum")
