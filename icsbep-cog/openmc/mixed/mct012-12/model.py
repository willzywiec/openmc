"""
MCT012-12: MOX/Polystyrene (H/SQRT(LxW)=0.44) with H/X=705 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.54, 30.54, -25.4, 25.4, -12.185, 12.185)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.78, 45.78, -40.64, 40.64, -27.425, 27.425, boundary_type="vacuum")
