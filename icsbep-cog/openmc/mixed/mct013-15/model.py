"""
MCT013-15: MOX/Polystyrene with H/X=226 with 2.56 SST-1.6B absorber and 15.24cm Lucite reflector
...
mat2.add_nuclide("B10", 1.296300e-03)
mat2.add_nuclide("B11", 5.217800e-03)
mat2.add_element("Fe", 5.666800e-02)
mat2.add_element("Cr", 1.480700e-02)
mat2.add_element("Ni", 5.829300e-03)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 2.56 + 22.9119 = 40.1433 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.671400000000002, 25.4719)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=2.56)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.9114, 40.7119, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 15.02))
