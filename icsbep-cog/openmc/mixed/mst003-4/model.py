"""
MIX-SOL-THERM-003-4: AWRE SCAMP
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=16.05)
# Steel plate
surf2 = openmc.ZCylinder(surface_id=2, x0=16.05, y0=16.367, r=25.16)
# Polyethylene
surf3 = openmc.ZCylinder(surface_id=3, x0=16.367, y0=31.367, r=25.16)
# Vessel, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 8.025))
