"""
MIX-COMP-THERM-004-5: 21x21 MOX pins with 1.956 cm pitch; Hc=64.40
...
mat1.add_nuclide("Pu241", 2.667000e-05)
mat1.add_nuclide("Pu242", 8.123400e-06)
mat1.add_nuclide("Am241", 2.612900e-06)
...
# Water height
surf11 = openmc.ZPlane(surface_id=11, z0=64.40)
# Al lower grid, top
...
source.space = openmc.stats.Point((0.0, 0.0, 32.2))
