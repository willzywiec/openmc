"""
MixMF007-3: 2.472 kg alpha-Pu; 5.586 kg HEU; 8.67 cm Be
...
# HEU
surf2 = openmc.Sphere(surface_id=2, r=4.6777)
# Be
surf3 = openmc.Sphere(surface_id=3, r=13.3477, boundary_type="vacuum")
