"""
MCT012-27: MOX/Polystyrene (H/SQRT(LxW)=0.28) with H/X=172 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-30.54, 30.54, -25.45, 25.45, -7.765, 7.765)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-45.78, 45.78, -40.69, 40.69, -23.005, 23.005, boundary_type="vacuum")
