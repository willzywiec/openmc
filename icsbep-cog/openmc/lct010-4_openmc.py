"""
LEU-COMP-THERM-010-4: (13x8)-9.175cm-(13x8)-9.175cm-(13x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; Pb walls; 5.405 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-82.0, 82.0, -25.765, -15.565, -20.0625, 103.3375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-82.0, 82.0, 15.565, 25.765, -20.0625, 103.3375)
...
cell1.translation = (-42.195, 0.0, 0.0)
...
cell5.translation = (42.195, 0.0, 0.0)
...
source.space = openmc.stats.Box((-43.195, -2.27, 45.0375), (43.195, 2.27, 47.0375))
