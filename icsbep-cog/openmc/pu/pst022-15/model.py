"""
PU-SOL-THERM-022 (Case 15) Hc = 70.46 @ H/X=505; 18.88 wt-% Pu-240; Paraffin + Cd
...
mat1.add_nuclide("Pu239", 1.140600e-04)
mat1.add_nuclide("Pu240", 2.890100e-05)
mat1.add_nuclide("Pu241", 8.758300e-06)
mat1.add_nuclide("Pu242", 1.730700e-06)
mat1.add_nuclide("Am241", 7.314700e-07)
mat1.add_element("N", 2.002000e-03)
mat1.add_nuclide("O16", 3.636500e-02)
mat1.add_nuclide("H1", 6.203700e-02)
mat1.add_element("Fe", 1.520400e-05)
mat1.add_element("Cr", 4.889300e-06)
mat1.add_element("Ni", 3.465300e-06)
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=70.46)
...
# Reflector/Outer
surf9 = openmc.ZCylinder(surface_id=9, r=50.3)
# Hole
...
surf8_zmin = openmc.ZPlane(z0=-1.42)
surf8_zmax = openmc.ZPlane(z0=118.68)
surf9_zmin = openmc.ZPlane(z0=-26.42, boundary_type="vacuum")
surf9_zmax = openmc.ZPlane(z0=118.68, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-18.0, -18.0, 34.0), (18.0, 18.0, 36.0))
