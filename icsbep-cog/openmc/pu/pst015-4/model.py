"""
PU-SOL-THERM-015 (Case 4) Two cylinders with 30 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=39.72)
...
source.space = openmc.stats.Box((-1.0, -31.0, 18.9), (1.0, 31.0, 20.9))
