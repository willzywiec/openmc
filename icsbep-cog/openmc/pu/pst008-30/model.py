"""
PU-SOL-THERM-008 (case 30) 1.085 kg Pu(95.43) @ H/X = 557 in 14" SS304L sphere with 10" concrete hemi
...
mat1.add_nuclide("Pu238", 7.133900e-09)
mat1.add_nuclide("Pu239", 1.124900e-04)
mat1.add_nuclide("Pu240", 5.503900e-06)
mat1.add_nuclide("Pu241", 3.604700e-07)
mat1.add_nuclide("Pu242", 1.052400e-08)
mat1.add_element("N", 1.708000e-03)
mat1.add_nuclide("H1", 6.288000e-02)
mat1.add_nuclide("O16", 3.594700e-02)
...
# = Hc ------------ Table 5b
surf1 = openmc.ZPlane(surface_id=1, z0=16.1434)
...
# Mid-plane cf Concrete Hemishell
surf9 = openmc.ZPlane(surface_id=9, z0=0.0000)

# Z-plane surfaces for bounded cylinders
surf7_zmin = openmc.ZPlane(surface_id=1009, z0=-99.0)
surf7_zmax = openmc.ZPlane(surface_id=1010, z0=0.0)
surf8_zmin = openmc.ZPlane(surface_id=1011, z0=-99.0)
surf8_zmax = openmc.ZPlane(surface_id=1012, z0=0.0)
