"""
PU-SOL-THERM-022 (Case 16) Hc = 83.61 @ H/X=554; 18.88 wt-% Pu-240; Paraffin + Cd
...
mat1.add_nuclide("Pu239", 1.043400e-04)
mat1.add_nuclide("Pu240", 2.643800e-05)
mat1.add_nuclide("Pu241", 8.011700e-06)
mat1.add_nuclide("Pu242", 1.583100e-06)
mat1.add_nuclide("Am241", 6.691200e-07)
mat1.add_element("N", 1.903600e-03)
mat1.add_nuclide("O16", 3.618900e-02)
mat1.add_nuclide("H1", 6.223300e-02)
mat1.add_element("Fe", 1.434200e-05)
mat1.add_element("Cr", 4.611900e-06)
mat1.add_element("Ni", 3.268700e-06)
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=83.61)
...
source.space = openmc.stats.Box((-18.0, -18.0, 41.0), (18.0, 18.0, 43.0))
