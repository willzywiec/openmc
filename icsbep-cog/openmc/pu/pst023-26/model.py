...
mat1.add_nuclide("Pu238", 1.844900e-08)
mat1.add_nuclide("Pu239", 2.402400e-04)
mat1.add_nuclide("Pu240", 1.060000e-05)
mat1.add_nuclide("Pu241", 7.172300e-07)
mat1.add_nuclide("Pu242", 3.976700e-08)
mat1.add_nuclide("Am241", 1.604200e-07)
mat1.add_element("N", 3.271600e-03)
mat1.add_nuclide("H1", 5.856000e-02)
mat1.add_nuclide("O16", 3.796900e-02)
mat1.add_element("Fe", 3.040900e-06)
mat1.add_element("Cr", 8.165200e-07)
mat1.add_element("Ni", 4.018800e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=19.94)
