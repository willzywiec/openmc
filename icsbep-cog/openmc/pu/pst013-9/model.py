"""
PU-SOL-THERM-013 (Case 9) Three cylinders with 10 cm surface-to-surface in a right-angle
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=60.99)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=35.588, y0=0.0, r=12.794)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=-35.588, r=12.794)
...
source.space = openmc.stats.Box((-1.0, -36.588, 29.5), (36.558, 1.0, 31.5))
