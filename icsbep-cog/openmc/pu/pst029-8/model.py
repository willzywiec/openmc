"""
PU-SOL-THERM-029 (Case 11; No. 183) Hc=57.53cm; D=1.0cm; 40.6 gPu/l; H/X=632; 2.98 wt-% Pu-240; Air/Cd; Air/Cd; Water
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=57.53)
...
# dY = 111.0 (fixed)
surf12 = openmc.model.RectangularParallelepiped(-80.8, 80.8, -55.5, 55.5, -32.800000000000004, 119.0)
...
source.space = openmc.stats.Box((-6.5, -1.0, 27.8), (6.5, 1.0, 29.8))
