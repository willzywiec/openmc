"""
PU-SOL-THERM-030-12: Exp. No. 501 with H/X=865 with AIR in the central cavity
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=34.85)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 17.425))
