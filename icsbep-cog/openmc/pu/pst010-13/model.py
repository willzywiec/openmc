"""
PU-SOL-THERM-010 (Case 12-3) 0.759 kg Pu(97.15) @ H/X = 728 in a water reflected 12" diameter SS-347 cylinder
...
mat1.add_nuclide("Pu239", 8.933200e-05)
mat1.add_nuclide("Pu240", 2.656900e-06)
mat1.add_element("N", 1.040200e-03)
mat1.add_nuclide("H1", 6.504000e-02)
mat1.add_nuclide("O16", 3.530500e-02)
mat1.add_element("Fe", 1.736100e-06)
...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=28.4734)
# Cylinder/Inner
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=28.6309)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=59.1109)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=28.4734)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=59.2684)
...
source.space = openmc.stats.Point((0.0, 0.0, 14.2))
