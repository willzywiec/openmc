"""
PU-SOL-THERM-031-16: H/X=1128 with no Hafnium
...
mat1.add_nuclide("U238", 6.906200e-08)
mat1.add_nuclide("Pu239", 5.153900e-05)
mat1.add_nuclide("Pu240", 1.292000e-05)
mat1.add_nuclide("Pu241", 3.452800e-06)
mat1.add_nuclide("Pu242", 7.677000e-07)
mat1.add_nuclide("Am241", 7.744200e-07)
mat1.add_nuclide("H1", 6.203200e-02)
mat1.add_nuclide("O16", 3.632500e-02)
mat1.add_element("N", 2.059700e-03)
mat1.add_element("Fe", 9.489200e-06)
mat1.add_element("Cr", 2.877300e-06)
mat1.add_element("Ni", 2.128900e-06)
mat1.add_element("Mn", 2.543600e-07)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=36.72)
# SST tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 18.36))
