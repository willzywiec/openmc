"""
PU-SOL-THERM-041-22: Experiment 356 with 91.05 gPu(3.11)/L at H/X=281; Hc=Hw=23.50
...
mat1.add_nuclide("Pu239", 2.219610e-04)
mat1.add_nuclide("Pu240", 7.103620e-06)
mat1.add_nuclide("Pu241", 2.729540e-07)
mat1.add_element("N", 1.892880e-03)
mat1.add_nuclide("O16", 3.640620e-02)
mat1.add_nuclide("H1", 6.240660e-02)
mat1.add_element("Fe", 8.011930e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=23.50)
...
source.space = openmc.stats.Box((-18.5, -18.5, 11.5), (18.5, 18.5, 13.5))
