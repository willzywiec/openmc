"""
PU-SOL-THERM-029 (Case 16; No. 161) Hc=50.06cm; D=1.0cm; 40.6 gPu/l; H/X=632; 2.98 wt-% Pu-240; Air/Water; Water
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=50.06)
...
# dY = 111.0 (fixed)
surf9 = openmc.model.RectangularParallelepiped(-80.8, 80.8, -55.5, 55.5, -32.800000000000004, 119.0)
...
source.space = openmc.stats.Box((-6.5, -1.0, 24.0), (6.5, 1.0, 26.0))
