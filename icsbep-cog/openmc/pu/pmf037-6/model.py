"""
PMF037-6: Flooded 2x2x2 array of double-canned 3kg Pu parts in water; Hw=30.88; dx=dy=8.996; dz=13.335
...
# Water height
surf6 = openmc.ZPlane(surface_id=6, z0=30.88)
# Inner tank
...
# Upper bottom tray
surf41 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 23.415000000000003, 24.05)
# Upper middle tray
surf42 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 27.11, 27.744999999999997)
# Upper upper  tray
...
cell39.region = -surf6 & (-surf7 & +surf7_zmin & -surf7_zmax) & (-surf8 & +surf8_zmin & -surf8_zmax) & +surf11 & +surf12 & +surf13 & +surf14 & +surf21 & +surf22 & +surf23 & +surf24 & +surf31 & +surf32 & +surf33 & +surf41 & +surf42 & +surf43

# Tank
cell40 = openmc.Cell(cell_id=40, fill=mat5)
cell40.region = (+surf7 | -surf7_zmin | +surf7_zmax) & (-surf8 & +surf8_zmin & -surf8_zmax)

# SS304L
cell46 = openmc.Cell(cell_id=46, fill=mat4)
cell46.region = (+surf2 | -surf2_zmin | +surf2_zmax) & (+surf4 | -surf4_zmin | +surf4_zmax) & (-surf5 & +surf5_zmin & -surf5_zmax)
...
source.space = openmc.stats.Box((-5.498, -5.498, 13.0285), (5.498, 5.498, 28.3635))
