"""
PU-SOL-THERM-012 (Case 13) Hc = 67.46 @ H/X=2394; 18.91 wt-% Pu-240; 5 sides water reflection
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=67.46)
# Lucoflex/Inner
...
source.space = openmc.stats.Point((0.0, 0.0, 33.7))
