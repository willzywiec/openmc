"""
PU-SOL-THERM-032-7: H/X=838 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 4.212100e-08)
mat1.add_nuclide("Pu239", 7.434200e-05)
mat1.add_nuclide("Pu240", 8.320400e-06)
mat1.add_nuclide("Pu241", 1.064800e-06)
mat1.add_nuclide("Pu242", 7.456100e-08)
mat1.add_nuclide("H1", 6.322800e-02)
mat1.add_nuclide("O16", 3.554700e-02)
mat1.add_element("N", 1.505600e-03)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=42.54)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 21.27))
