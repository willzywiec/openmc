"""
PU-SOL-THERM-031-3: H/X=305 and 5 groups of two Hafnium Plates with 10.0092 cm Pitch
...
mat1.add_nuclide("U238", 2.466500e-07)
mat1.add_nuclide("Pu239", 1.840500e-04)
mat1.add_nuclide("Pu240", 4.613700e-05)
mat1.add_nuclide("Pu241", 1.236200e-05)
mat1.add_nuclide("Pu242", 2.741400e-06)
mat1.add_nuclide("Am241", 2.732900e-06)
mat1.add_nuclide("H1", 5.924100e-02)
mat1.add_nuclide("O16", 3.811400e-02)
mat1.add_element("N", 3.169300e-03)
mat1.add_element("Fe", 3.375200e-05)
mat1.add_element("Cr", 1.027600e-05)
mat1.add_element("Ni", 7.603300e-06)
mat1.add_element("Mn", 9.084600e-07)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=52.21)
# SST tank, inner
...
# Hafnium plate
surf51 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -19.950000000000003, -19.7408, 2.4179999999999993, 52.418)
# Hafnium plate
surf52 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -9.9408, -9.7316, 2.4179999999999993, 52.418)
# Hafnium plate
surf53 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 0.06839999999999999, 0.27759999999999996, 2.4179999999999993, 52.418)
# Hafnium plate
surf54 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 10.0776, 10.2868, 2.4179999999999993, 52.418)
# Hafnium plate
surf55 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 20.0868, 20.296000000000003, 2.4179999999999993, 52.418)
...
u3_cell0.region = +surf1 & -surf2 & -surf5 & +surf51 & +surf52 & +surf53 & +surf54 & +surf55
u3_cell1 = openmc.Cell(fill=mat1)
u3_cell1.region = -surf1 & -surf2 & +surf4 & -surf5 & +surf11 & +surf12 & +surf13 & +surf14 & +surf51 & +surf52 & +surf53 & +surf54 & +surf55
u3_cell2 = openmc.Cell(fill=mat5)
u3_cell2.region = -surf51 & -surf52 & -surf53 & -surf54 & -surf55
...
source.space = openmc.stats.Box((-1.0, -5.8316, 25.105), (1.0, 6.1776, 27.105))
