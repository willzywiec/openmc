"""
PU-SOL-THERM-025 (Case 20) 10.821 kg Pu(80.45) at H/X = 179 with H/SQRT(A) = 0.276; 18.40 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=36.703)
...
source.space = openmc.stats.Point((0.0, 2.71, 18.4))
