"""
PU-SOL-THERM-041-9: Experiment 269 with 51.65 gPu(3)/L at H/X=465; Hc=Hw=30.13
...
surf7 = openmc.ZPlane(surface_id=7, z0=30.13)
...
source.space = openmc.stats.Box((-18.5, -18.5, 14.815), (18.5, 18.5, 16.814999999999998))
