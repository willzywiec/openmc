"""
PU-SOL-THERM-041-5: Experiment 254 with 55.8 gPu(3)/L at H/X=273; Hc=27.88
...
surf7 = openmc.ZPlane(surface_id=7, z0=27.88)
...
source.space = openmc.stats.Box((-18.5, -18.5, 13.69), (18.5, 18.5, 15.69))
