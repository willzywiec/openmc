"""
PU-SOL-THERM-025 (Case 25) 15.625 kg Pu(75.779) at H/X = 153 with H/SQRT(A) = 0.241; 23.185 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=39.726)
# Sol'n Tank/Inner: Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-53.34, 53.34, -6.434, 11.854, 0.0, 106.68)
# Sol'n Tank/Outer: Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -6.593000000000001, 12.013000000000002, -0.3159999999999954, 106.99600000000001)
# Egg Crate /Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -18.023, 23.443, -0.3159999999999954, 106.99600000000001)
