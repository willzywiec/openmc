"""
PMF017-3: LLNL Pu Array Phase II - MHE - 4x4x4 - 6kg - case 203
...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -41.1235, -32.4365, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-49.04, 49.04, -41.86, -31.700000000000003, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -16.6035, -7.9165, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-49.04, 49.04, -17.34, -7.18, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 7.9165, 16.6035, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-49.04, 49.04, 7.18, 17.34, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 32.4365, 41.1235, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-49.04, 49.04, 31.700000000000003, 41.86, 216.35500000000002, 221.435)
# Hole
...
# MHE, ring 1
surf81 = openmc.ZCylinder(surface_id=81, r=7.6304)
# MHE, ring 2
surf82 = openmc.ZCylinder(surface_id=82, r=7.6304)
# MHE, ring 3
surf83 = openmc.ZCylinder(surface_id=83, r=7.6304)
# MHE, ring 4
surf84 = openmc.ZCylinder(surface_id=84, r=7.6304)
surf101 = openmc.ZCylinder(surface_id=101, x0=-36.78, y0=-36.78, r=7.6304)
surf102 = openmc.ZCylinder(surface_id=102, x0=-36.78, y0=-12.26, r=7.6304)
surf103 = openmc.ZCylinder(surface_id=103, x0=-36.78, y0=12.26, r=7.6304)
surf104 = openmc.ZCylinder(surface_id=104, x0=-36.78, y0=36.78, r=7.6304)
surf105 = openmc.ZCylinder(surface_id=105, x0=-12.26, y0=-36.78, r=7.6304)
surf106 = openmc.ZCylinder(surface_id=106, x0=-12.26, y0=-12.26, r=7.6304)
surf107 = openmc.ZCylinder(surface_id=107, x0=-12.26, y0=12.26, r=7.6304)
surf108 = openmc.ZCylinder(surface_id=108, x0=-12.26, y0=36.78, r=7.6304)
surf109 = openmc.ZCylinder(surface_id=109, x0=12.26, y0=-36.78, r=7.6304)
surf110 = openmc.ZCylinder(surface_id=110, x0=12.26, y0=-12.26, r=7.6304)
surf111 = openmc.ZCylinder(surface_id=111, x0=12.26, y0=12.26, r=7.6304)
surf112 = openmc.ZCylinder(surface_id=112, x0=12.26, y0=36.78, r=7.6304)
surf113 = openmc.ZCylinder(surface_id=113, x0=36.78, y0=-36.78, r=7.6304)
surf114 = openmc.ZCylinder(surface_id=114, x0=36.78, y0=-12.26, r=7.6304)
surf115 = openmc.ZCylinder(surface_id=115, x0=36.78, y0=12.26, r=7.6304)
surf116 = openmc.ZCylinder(surface_id=116, x0=36.78, y0=36.78, r=7.6304)
...
surf36_zmax = openmc.ZPlane(z0=5.7316)
surf37_zmin = openmc.ZPlane(z0=5.7316)
surf37_zmax = openmc.ZPlane(z0=5.7526)
surf38_zmin = openmc.ZPlane(z0=5.7526)
surf38_zmax = openmc.ZPlane(z0=10.3856)
surf39_zmin = openmc.ZPlane(z0=5.7526)
surf39_zmax = openmc.ZPlane(z0=10.3856)
surf40_zmin = openmc.ZPlane(z0=10.3856)
surf40_zmax = openmc.ZPlane(z0=10.4726)
surf41_zmin = openmc.ZPlane(z0=10.4726)
surf41_zmax = openmc.ZPlane(z0=10.9516)
surf50_zmin = openmc.ZPlane(z0=0.0)
surf50_zmax = openmc.ZPlane(z0=208.417)
surf61_zmin = openmc.ZPlane(z0=25.083)
surf61_zmax = openmc.ZPlane(z0=69.9779)
surf62_zmin = openmc.ZPlane(z0=69.9779)
surf62_zmax = openmc.ZPlane(z0=73.7942)
surf63_zmin = openmc.ZPlane(z0=73.7942)
surf63_zmax = openmc.ZPlane(z0=84.7458)
surf64_zmin = openmc.ZPlane(z0=84.7458)
surf64_zmax = openmc.ZPlane(z0=88.5621)
surf65_zmin = openmc.ZPlane(z0=88.5621)
surf65_zmax = openmc.ZPlane(z0=95.7979)
surf66_zmin = openmc.ZPlane(z0=95.7979)
surf66_zmax = openmc.ZPlane(z0=99.6142)
surf67_zmin = openmc.ZPlane(z0=99.6142)
surf67_zmax = openmc.ZPlane(z0=110.5658)
surf68_zmin = openmc.ZPlane(z0=110.5658)
surf68_zmax = openmc.ZPlane(z0=114.3821)
surf69_zmin = openmc.ZPlane(z0=114.3821)
surf69_zmax = openmc.ZPlane(z0=121.6179)
surf70_zmin = openmc.ZPlane(z0=121.6179)
surf70_zmax = openmc.ZPlane(z0=125.4342)
surf71_zmin = openmc.ZPlane(z0=125.4342)
surf71_zmax = openmc.ZPlane(z0=136.3858)
surf72_zmin = openmc.ZPlane(z0=136.3858)
surf72_zmax = openmc.ZPlane(z0=140.2021)
surf73_zmin = openmc.ZPlane(z0=140.2021)
surf73_zmax = openmc.ZPlane(z0=147.4379)
surf74_zmin = openmc.ZPlane(z0=147.4379)
surf74_zmax = openmc.ZPlane(z0=151.2542)
surf75_zmin = openmc.ZPlane(z0=151.2542)
surf75_zmax = openmc.ZPlane(z0=162.2058)
surf76_zmin = openmc.ZPlane(z0=162.2058)
surf76_zmax = openmc.ZPlane(z0=166.0221)
surf81_zmin = openmc.ZPlane(z0=69.9779)
surf81_zmax = openmc.ZPlane(z0=88.5621)
surf82_zmin = openmc.ZPlane(z0=95.7979)
surf82_zmax = openmc.ZPlane(z0=114.3821)
surf83_zmin = openmc.ZPlane(z0=121.6179)
surf83_zmax = openmc.ZPlane(z0=140.2021)
surf84_zmin = openmc.ZPlane(z0=147.4379)
surf84_zmax = openmc.ZPlane(z0=166.0221)
...
source.space = openmc.stats.Box((-37.78, -37.78, 75.7667), (37.78, 37.78, 160.3233))
