...
surf61_zmax = openmc.ZPlane(surface_id=1141, z0=69.9779)
surf62_zmin = openmc.ZPlane(surface_id=1142, z0=69.9779)
...
surf64_zmax = openmc.ZPlane(surface_id=1147, z0=88.5621)
surf65_zmin = openmc.ZPlane(surface_id=1148, z0=88.5621)
surf65_zmax = openmc.ZPlane(surface_id=1149, z0=95.7979)
surf66_zmin = openmc.ZPlane(surface_id=1150, z0=95.7979)
...
surf68_zmax = openmc.ZPlane(surface_id=1155, z0=114.3821)
surf69_zmin = openmc.ZPlane(surface_id=1156, z0=114.3821)
surf69_zmax = openmc.ZPlane(surface_id=1157, z0=121.6179)
surf70_zmin = openmc.ZPlane(surface_id=1158, z0=121.6179)
...
surf72_zmax = openmc.ZPlane(surface_id=1163, z0=140.2021)
surf73_zmin = openmc.ZPlane(surface_id=1164, z0=140.2021)
surf73_zmax = openmc.ZPlane(surface_id=1165, z0=147.4379)
surf74_zmin = openmc.ZPlane(surface_id=1166, z0=147.4379)
...
surf76_zmax = openmc.ZPlane(surface_id=1171, z0=166.0221)
surf81_zmin = openmc.ZPlane(surface_id=1172, z0=69.9779)
surf81_zmax = openmc.ZPlane(surface_id=1173, z0=88.5621)
surf82_zmin = openmc.ZPlane(surface_id=1174, z0=95.7979)
surf82_zmax = openmc.ZPlane(surface_id=1175, z0=114.3821)
surf83_zmin = openmc.ZPlane(surface_id=1176, z0=121.6179)
surf83_zmax = openmc.ZPlane(surface_id=1177, z0=140.2021)
surf84_zmin = openmc.ZPlane(surface_id=1178, z0=147.4379)
surf84_zmax = openmc.ZPlane(surface_id=1179, z0=166.0221)
