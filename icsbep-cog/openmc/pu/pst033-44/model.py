"""
PU-SOL-THERM-033-44: 202.67 gPu(3.13)/L at H/X=116.4 with 19 (4x60) pyrex tubes at 4.31cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=39.94)
...
source.space = openmc.stats.Box((-3.155, -3.488, 18.97), (3.155, 3.488, 20.97))
