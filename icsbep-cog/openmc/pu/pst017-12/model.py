"""
PU-SOL-THERM-017 (Case 12) Two 300 mm cylinders with 115.1 gPu/L at 15 cm s-to-s
...
# 300-mm Tank/Hc-0.326 from Table 1
surf4 = openmc.ZPlane(surface_id=4, z0=40.374)
# 300-mm Tank/Inner per Figure 5
...
source.space = openmc.stats.Box((-1.0, -1.0, 3.8), (46.0, 1.0, 21.2))
