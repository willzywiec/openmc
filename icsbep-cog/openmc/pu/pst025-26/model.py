"""
PU-SOL-THERM-025 (Case 26) 14.502 kg Pu(75.779) at H/X = 153 with H/SQRT(A) = 0.335; 23.185 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=33.604)
...
source.space = openmc.stats.Point((0.0, 2.71, 16.8))
