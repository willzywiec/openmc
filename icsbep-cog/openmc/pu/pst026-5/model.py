"""
PU-SOL-THERM-026 (Case 5) 11.431 kg Pu(81.6) at H/X = 457 with H/SQRT(A) = 0.205; 18.4 wt-% Pu-240
...
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 127.629, 170.111, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -151.2))
