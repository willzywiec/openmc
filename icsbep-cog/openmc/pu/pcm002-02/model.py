"""
PU-COMP-MIXED-002 (Case 2) 40.848 kg Pu @ H/X = 0.047 with 18.35 wt-% Pu-240 and H/SQRT(A) = 0.320
...
surf1 = openmc.model.RectangularParallelepiped(-12.825, 12.825, -15.39, 15.39, -4.49, 4.49)
# 6" (15.24 cm) Plexiglas Reflector
surf2 = openmc.model.RectangularParallelepiped(-28.065, 28.065, -30.63, 30.63, -19.73, 19.73, boundary_type="vacuum")
