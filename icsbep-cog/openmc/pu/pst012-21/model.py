"""
PU-SOL-THERM-012 (Case 21) Hc = 49.09 @ H/X=2150; 18.91 wt-% Pu-240; no close water reflection
...
mat1.add_nuclide("Pu239", 2.752150e-05)
mat1.add_nuclide("Pu240", 6.973530e-06)
mat1.add_nuclide("Pu241", 2.067170e-06)
mat1.add_nuclide("Pu242", 4.175750e-07)
mat1.add_nuclide("Am241", 2.240140e-07)
mat1.add_element("N", 1.370170e-03)
mat1.add_nuclide("O16", 3.531760e-02)
mat1.add_nuclide("H1", 6.361860e-02)
mat1.add_element("Fe", 3.881960e-06)
mat1.add_element("Cr", 1.248340e-06)
mat1.add_element("Ni", 8.847690e-07)
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=49.09)
# Lucoflex/Inner
...
source.space = openmc.stats.Point((0.0, 0.0, 24.5))
