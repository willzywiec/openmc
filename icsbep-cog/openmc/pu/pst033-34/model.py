"""
PU-SOL-THERM-033-34: 140.8 gPu(4.23)/L at H/X=176.9 with 91 (3x40) pyrex tubes at 3.23cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=58.85)
...
source.space = openmc.stats.Point((0.0, 0.0, 29.425))
