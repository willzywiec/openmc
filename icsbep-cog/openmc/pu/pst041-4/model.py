"""
PU-SOL-THERM-041-4: Experiment 233 with 61.35 gPu(3)/L at H/X=384; Hc=Hw=28.07
...
mat1.add_nuclide("Pu239", 1.497440e-04)
mat1.add_nuclide("Pu240", 4.617160e-06)
mat1.add_nuclide("Pu241", 1.685920e-07)
mat1.add_element("N", 3.225510e-03)
mat1.add_nuclide("O16", 3.715950e-02)
mat1.add_nuclide("H1", 5.755550e-02)
mat1.add_element("Fe", 5.963120e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=28.07)
...
source.space = openmc.stats.Box((-18.5, -18.5, 13.785), (18.5, 18.5, 15.785))
