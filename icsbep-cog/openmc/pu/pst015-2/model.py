"""
PU-SOL-THERM-015 (Case 2) Two cylinders with 5 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=34.70)
...
source.space = openmc.stats.Box((-1.0, -18.5, 16.35), (1.0, 18.5, 18.35))
