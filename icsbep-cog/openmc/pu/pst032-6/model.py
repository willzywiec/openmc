"""
PU-SOL-THERM-032-6: H/X=789 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 4.465000e-08)
mat1.add_nuclide("Pu239", 7.880600e-05)
mat1.add_nuclide("Pu240", 8.820100e-06)
mat1.add_nuclide("Pu241", 1.128800e-06)
mat1.add_nuclide("Pu242", 7.904000e-08)
mat1.add_nuclide("H1", 6.308300e-02)
mat1.add_nuclide("O16", 3.557900e-02)
mat1.add_element("N", 1.543600e-03)
mat1.add_element("Fe", 5.822900e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=40.16)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 20.08))
