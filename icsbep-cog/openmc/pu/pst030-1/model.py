"""
PU-SOL-THERM-030-1: Exp. No. 506 with H/X=1044 with AIR in the central cavity
...
mat1.add_nuclide("Pu239", 6.139500e-05)
mat1.add_nuclide("Pu240", 9.313400e-07)
mat1.add_nuclide("Pu241", 1.854900e-08)
mat1.add_nuclide("H1", 6.410000e-02)
mat1.add_nuclide("O16", 3.205000e-02)
mat1.add_nuclide("O16", 3.158300e-03)
mat1.add_element("N", 1.212400e-03)
mat1.add_element("Fe", 1.822400e-06)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=43.24)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 21.62))
