"""
PU-SOL-THERM-032-12: H/X=1170 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 3.029400e-08)
mat1.add_nuclide("Pu239", 5.346800e-05)
mat1.add_nuclide("Pu240", 5.984200e-06)
mat1.add_nuclide("Pu241", 7.658500e-07)
mat1.add_nuclide("Pu242", 5.362600e-08)
mat1.add_nuclide("H1", 6.343300e-02)
mat1.add_nuclide("O16", 3.538000e-02)
mat1.add_element("N", 1.417100e-03)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=72.4)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 36.2))
