"""
PU-SOL-THERM-041-6: Experiment 255 with 55.8 gPu(3)/L at H/X=273; Hc=Hw=29.05
...
mat1.add_nuclide("Pu239", 1.361970e-04)
mat1.add_nuclide("Pu240", 4.199470e-06)
mat1.add_nuclide("Pu241", 1.533400e-07)
mat1.add_element("N", 3.126530e-03)
mat1.add_nuclide("O16", 3.720820e-02)
mat1.add_nuclide("H1", 5.820460e-02)
...
surf7 = openmc.ZPlane(surface_id=7, z0=29.05)
...
source.space = openmc.stats.Box((-18.5, -18.5, 14.275), (18.5, 18.5, 16.275))
