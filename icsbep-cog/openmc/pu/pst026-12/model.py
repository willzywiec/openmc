"""
PU-SOL-THERM-026 (Case 12) 21.925 kg Pu(81.6) at H/X = 179 with H/SQRT(A) = 0.252
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=62.433)
# Tank/Inner:  Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 138.583, 159.157, -192.929, -86.249)
# Tank/Outer:  Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 138.424, 159.316, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 126.994, 170.746, -193.379, -85.799)
# U-Frame/Inner
