"""
PU-SOL-THERM-025 (Case 21) 25.455 kg Pu(75.779) at H/X = 153 with H/SQRT(A) = 0.159; 23.185 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=80.340)
# Sol'n Tank/Inner: Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-53.34, 53.34, -4.656, 10.076, 0.0, 106.68)
# Sol'n Tank/Outer: Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -4.815, 10.235, -0.3159999999999954, 106.99600000000001)
# Egg Crate /Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -16.244999999999997, 21.665, -0.3159999999999954, 106.99600000000001)
...
source.space = openmc.stats.Point((0.0, 2.71, 40.1))
