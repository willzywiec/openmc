"""
PU-SOL-THERM-008 (Case 29) 1.156 kg Pu(95.43) @ H/X = 499 in 14" SS304L sphere with 10" concrete hemi
...
mat1.add_nuclide("Pu238", 7.953600e-09)
mat1.add_nuclide("Pu239", 1.254200e-04)
mat1.add_nuclide("Pu240", 6.136200e-06)
mat1.add_nuclide("Pu241", 4.018800e-07)
mat1.add_nuclide("Pu242", 1.173300e-08)
mat1.add_element("N", 1.774400e-03)
mat1.add_nuclide("H1", 6.274100e-02)
mat1.add_nuclide("O16", 3.607100e-02)
