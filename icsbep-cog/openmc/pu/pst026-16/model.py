"""
PU-SOL-THERM-026 (Case 16) 27.056 kg Pu(76.8) at H/X = 153 with H/SQRT(A) = 0.293
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=55.651)
# Tank/Inner:  Width = Tc
...
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 125.97800000000001, 171.762, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -165.1))
