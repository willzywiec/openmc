"""
PU-MET-FAST-040; 13.564 kg d-Pu(98) in 1.6 Cu
...
mat1.add_nuclide("Pu239", 3.684900e-02)
mat1.add_nuclide("Pu240", 6.736200e-04)
mat1.add_element("Ga", 2.319300e-03)
mat1.add_element("C", 3.042500e-04)
mat1.add_element("Ni", 1.490800e-03)
...
mat2.add_element("C", 2.020500e-04)
...
mat6.add_element("Cu", 8.416800e-02)
mat6.add_element("Fe", 5.050400e-06)
...
surf1 = openmc.Sphere(surface_id=1, r=1.531)
...
surf7 = openmc.Sphere(surface_id=7, r=7.600, boundary_type="vacuum")
