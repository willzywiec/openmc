"""
PU-SOL-THERM-033-56: 355.6 gPu(3.13)/L at H/X=60.5 with 19 (4x14.78) pyrex tubes at 7.46cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=26.44)
...
# Pyrex tube #1
surf101 = openmc.ZCylinder(surface_id=101, x0=0.0, y0=14.930278, r=2.0058)
# Pyrex tube #2
surf102 = openmc.ZCylinder(surface_id=102, x0=-6.465, y0=11.197708, r=2.0058)
# Pyrex tube #3
surf103 = openmc.ZCylinder(surface_id=103, x0=6.465, y0=11.197708, r=2.0058)
# Pyrex tube #4
surf104 = openmc.ZCylinder(surface_id=104, x0=-12.93, y0=7.465139, r=2.0058)
# Pyrex tube #5
surf105 = openmc.ZCylinder(surface_id=105, x0=0.0, y0=7.465139, r=2.0058)
# Pyrex tube #6
surf106 = openmc.ZCylinder(surface_id=106, x0=12.93, y0=7.465139, r=2.0058)
# Pyrex tube #7
surf107 = openmc.ZCylinder(surface_id=107, x0=-6.465, y0=3.73257, r=2.0058)
# Pyrex tube #8
surf108 = openmc.ZCylinder(surface_id=108, x0=6.465, y0=3.73257, r=2.0058)
# Pyrex tube #9
surf109 = openmc.ZCylinder(surface_id=109, x0=-12.93, y0=0.0, r=2.0058)
# Pyrex tube #10
surf110 = openmc.ZCylinder(surface_id=110, x0=0.0, y0=0.0, r=2.0058)
# Pyrex tube #11
surf111 = openmc.ZCylinder(surface_id=111, x0=12.93, y0=0.0, r=2.0058)
# Pyrex tube #12
surf112 = openmc.ZCylinder(surface_id=112, x0=-6.465, y0=-3.73257, r=2.0058)
# Pyrex tube #13
surf113 = openmc.ZCylinder(surface_id=113, x0=6.465, y0=-3.73257, r=2.0058)
# Pyrex tube #14
surf114 = openmc.ZCylinder(surface_id=114, x0=-12.93, y0=-7.465139, r=2.0058)
# Pyrex tube #15
surf115 = openmc.ZCylinder(surface_id=115, x0=0.0, y0=-7.465139, r=2.0058)
# Pyrex tube #16
surf116 = openmc.ZCylinder(surface_id=116, x0=12.93, y0=-7.465139, r=2.0058)
# Pyrex tube #17
surf117 = openmc.ZCylinder(surface_id=117, x0=-6.465, y0=-11.197708, r=2.0058)
# Pyrex tube #18
surf118 = openmc.ZCylinder(surface_id=118, x0=6.465, y0=-11.197708, r=2.0058)
# Pyrex tube #19
surf119 = openmc.ZCylinder(surface_id=119, x0=0.0, y0=-14.930278, r=2.0058)
...
surf20_zmin = openmc.ZPlane(surface_id=1135, z0=14.175)
surf20_zmax = openmc.ZPlane(surface_id=1136, z0=14.28)
surf24_zmin = openmc.ZPlane(surface_id=1137, z0=1.5)
surf24_zmax = openmc.ZPlane(surface_id=1138, z0=16.28)
...
u4_cell1.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf19 & +surf19_zmin & -surf19_zmax) & +surf16 & +surf17 & +surf18 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107 & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf113 & +surf114 & +surf115 & +surf116 & +surf117 & +surf118 & +surf119
u4_cell2 = openmc.Cell(fill=mat5)
u4_cell2.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf20 & +surf20_zmin & -surf20_zmax) & +surf16 & +surf17 & +surf18 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107 & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf113 & +surf114 & +surf115 & +surf116 & +surf117 & +surf118 & +surf119
...
source.space = openmc.stats.Point((0.0, 0.0, 13.22))
