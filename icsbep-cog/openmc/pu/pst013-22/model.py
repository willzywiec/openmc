"""
PU-SOL-THERM-013 (Case 22) Nine cylinders with 5 cm surface-to-surface
...
surf11 = openmc.ZCylinder(surface_id=11, x0=-30.588, y0=30.588, r=12.794)
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=30.588, r=12.794)
surf13 = openmc.ZCylinder(surface_id=13, x0=30.588, y0=30.588, r=12.794)
surf14 = openmc.ZCylinder(surface_id=14, x0=-30.588, y0=0.0, r=12.794)
surf15 = openmc.ZCylinder(surface_id=15, x0=30.588, y0=0.0, r=12.794)
surf16 = openmc.ZCylinder(surface_id=16, x0=-30.588, y0=-30.588, r=12.794)
surf17 = openmc.ZCylinder(surface_id=17, x0=0.0, y0=-30.588, r=12.794)
