"""
PU-SOL-THERM-015 (Case 10) Three cylinders with 60 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=39.90)
...
source.space = openmc.stats.Box((-26.0, -46.0, 19.0), (53.0, 46.0, 21.0))
