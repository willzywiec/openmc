"""
PU-SOL-THERM-030-11: Exp. No. 497 with H/X=739 with AIR in the central cavity
...
mat1.add_nuclide("Pu239", 8.612700e-05)
mat1.add_nuclide("Pu240", 1.306500e-06)
mat1.add_nuclide("Pu241", 2.602100e-08)
mat1.add_nuclide("H1", 6.370200e-02)
mat1.add_nuclide("O16", 3.185100e-02)
mat1.add_nuclide("O16", 3.586300e-03)
mat1.add_element("N", 1.363000e-03)
mat1.add_element("Fe", 2.501700e-06)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=30.58)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 15.29))
