"""
PU-SOL-THERM-025 (Case 32) 23.818 kg Pu(80.45) at H/X = 109 with H/SQRT(A) = 0.199; 18.4 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=58.877)
...
source.space = openmc.stats.Point((0.0, 2.71, 29.4))
