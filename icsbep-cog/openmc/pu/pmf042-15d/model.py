"""
PMF042-15D: Pu hemisphere reflected by 14x0.3228cm steel shells and infinite oil; detailed model
...
# Hc
surf2 = openmc.ZPlane(surface_id=2, z0=0.67)
# BCD
...
# S2
surf66 = openmc.Sphere(surface_id=66, x0=6.6720, y0=tr, z0=-2.37375, r=0)
# S2
surf67 = openmc.Sphere(surface_id=67, x0=6.9947, y0=tr, z0=-2.37375, r=0)
# S3
surf68 = openmc.Sphere(surface_id=68, x0=7.0053, y0=tr, z0=-2.37375, r=0)
# S3
surf69 = openmc.Sphere(surface_id=69, x0=7.3280, y0=tr, z0=-2.37375, r=0)
# S4
surf70 = openmc.Sphere(surface_id=70, x0=7.3386, y0=tr, z0=-2.37375, r=0)
# S4
surf71 = openmc.Sphere(surface_id=71, x0=7.6614, y0=tr, z0=-2.37375, r=0)
# S5
surf72 = openmc.Sphere(surface_id=72, x0=7.6720, y0=tr, z0=-2.37375, r=0)
# S5
surf73 = openmc.Sphere(surface_id=73, x0=7.9947, y0=tr, z0=-2.37375, r=0)
# S6
surf74 = openmc.Sphere(surface_id=74, x0=8.0053, y0=tr, z0=-2.37375, r=0)
# S6
surf75 = openmc.Sphere(surface_id=75, x0=8.3280, y0=tr, z0=-2.37375, r=0)
# S7
surf76 = openmc.Sphere(surface_id=76, x0=8.3386, y0=tr, z0=-2.37375, r=0)
# S7
surf77 = openmc.Sphere(surface_id=77, x0=8.6614, y0=tr, z0=-2.37375, r=0)
# S8
surf78 = openmc.Sphere(surface_id=78, x0=8.6720, y0=tr, z0=-2.37375, r=0)
# S8
surf79 = openmc.Sphere(surface_id=79, x0=8.9947, y0=tr, z0=-2.37375, r=0)
# S9
surf80 = openmc.Sphere(surface_id=80, x0=9.0053, y0=tr, z0=-2.37375, r=0)
# S9
surf81 = openmc.Sphere(surface_id=81, x0=9.3280, y0=tr, z0=-2.37375, r=0)
# S10
surf82 = openmc.Sphere(surface_id=82, x0=9.3386, y0=tr, z0=-2.37375, r=0)
# S10
surf83 = openmc.Sphere(surface_id=83, x0=9.6614, y0=tr, z0=-2.37375, r=0)
# S11
surf84 = openmc.Sphere(surface_id=84, x0=9.6720, y0=tr, z0=-2.37375, r=0)
# S11
surf85 = openmc.Sphere(surface_id=85, x0=9.9947, y0=tr, z0=-2.37375, r=0)
# S12
surf86 = openmc.Sphere(surface_id=86, x0=10.0053, y0=tr, z0=-2.37375, r=0)
# S12
surf87 = openmc.Sphere(surface_id=87, x0=10.3280, y0=tr, z0=-2.37375, r=0)
# S13
surf88 = openmc.Sphere(surface_id=88, x0=10.3386, y0=tr, z0=-2.37375, r=0)
# S13
surf89 = openmc.Sphere(surface_id=89, x0=10.6614, y0=tr, z0=-2.37375, r=0)
# S14
surf90 = openmc.Sphere(surface_id=90, x0=10.6720, y0=tr, z0=-2.37375, r=0)
# S14
surf91 = openmc.Sphere(surface_id=91, x0=10.9947, y0=tr, z0=-2.37375, r=0)

# Z-plane surfaces for bounded cylinders
surf3_zmin = openmc.ZPlane(surface_id=1091, z0=-31.333, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(surface_id=1092, z0=18.667, boundary_type="vacuum")
...
u2_cell6.region = +surf1 & +surf76 & -surf77
u2_cell7 = openmc.Cell(fill=mat3)
u2_cell7.region = +surf1 & +surf78 & -surf79
u2_cell8 = openmc.Cell(fill=mat3)
u2_cell8.region = +surf1 & +surf80 & -surf81
u2_cell9 = openmc.Cell(fill=mat3)
u2_cell9.region = +surf1 & +surf82 & -surf83
u2_cell10 = openmc.Cell(fill=mat3)
u2_cell10.region = +surf1 & +surf84 & -surf85
u2_cell11 = openmc.Cell(fill=mat3)
u2_cell11.region = +surf1 & +surf86 & -surf87
u2_cell12 = openmc.Cell(fill=mat3)
u2_cell12.region = +surf1 & +surf88 & -surf89
u2_cell13 = openmc.Cell(fill=mat3)
u2_cell13.region = +surf1 & +surf90 & -surf91
universe2 = openmc.Universe(universe_id=2, cells=[u2_cell0, u2_cell1, u2_cell2, u2_cell3, u2_cell4, u2_cell5, u2_cell6, u2_cell7, u2_cell8, u2_cell9, u2_cell10, u2_cell11, u2_cell12, u2_cell13])
...
cell2.region = +surf1 & +surf64 & -surf91

# Oil
cell3 = openmc.Cell(cell_id=3, fill=mat5)
cell3.region = +surf1 & -surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & +surf91
...
cell6.region = +surf1 & +surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & +surf91
