"""
PMF017-5: LLNL Pu Array Phase II - MHE - 4x4x4 - 3kg - case 205
...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -26.168499999999998, -17.4815, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-29.1, 29.1, -26.905, -16.744999999999997, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -11.618500000000001, -2.9315000000000007, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-29.1, 29.1, -12.355, -2.1950000000000003, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 2.9315000000000007, 11.618500000000001, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-29.1, 29.1, 2.1950000000000003, 12.355, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 17.4815, 26.168499999999998, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-29.1, 29.1, 16.744999999999997, 26.905, 216.35500000000002, 221.435)
# Hole
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-21.825, y0=-21.825, r=6.3628)
surf102 = openmc.ZCylinder(surface_id=102, x0=-21.825, y0=-7.275, r=6.3628)
surf103 = openmc.ZCylinder(surface_id=103, x0=-21.825, y0=7.275, r=6.3628)
surf104 = openmc.ZCylinder(surface_id=104, x0=-21.825, y0=21.825, r=6.3628)
surf105 = openmc.ZCylinder(surface_id=105, x0=-7.275, y0=-21.825, r=6.3628)
surf106 = openmc.ZCylinder(surface_id=106, x0=-7.275, y0=-7.275, r=6.3628)
surf107 = openmc.ZCylinder(surface_id=107, x0=-7.275, y0=7.275, r=6.3628)
surf108 = openmc.ZCylinder(surface_id=108, x0=-7.275, y0=21.825, r=6.3628)
surf109 = openmc.ZCylinder(surface_id=109, x0=7.275, y0=-21.825, r=6.3628)
surf110 = openmc.ZCylinder(surface_id=110, x0=7.275, y0=-7.275, r=6.3628)
surf111 = openmc.ZCylinder(surface_id=111, x0=7.275, y0=7.275, r=6.3628)
surf112 = openmc.ZCylinder(surface_id=112, x0=7.275, y0=21.825, r=6.3628)
surf113 = openmc.ZCylinder(surface_id=113, x0=21.825, y0=-21.825, r=6.3628)
surf114 = openmc.ZCylinder(surface_id=114, x0=21.825, y0=-7.275, r=6.3628)
surf115 = openmc.ZCylinder(surface_id=115, x0=21.825, y0=7.275, r=6.3628)
surf116 = openmc.ZCylinder(surface_id=116, x0=21.825, y0=21.825, r=6.3628)
...
surf61_zmax = openmc.ZPlane(surface_id=1131, z0=92.0638)
surf62_zmin = openmc.ZPlane(surface_id=1132, z0=92.0638)
surf62_zmax = openmc.ZPlane(surface_id=1133, z0=94.6125)
surf63_zmin = openmc.ZPlane(surface_id=1134, z0=94.6125)
surf63_zmax = openmc.ZPlane(surface_id=1135, z0=100.4675)
surf64_zmin = openmc.ZPlane(surface_id=1136, z0=100.4675)
surf64_zmax = openmc.ZPlane(surface_id=1137, z0=103.0162)
surf65_zmin = openmc.ZPlane(surface_id=1138, z0=103.0162)
surf65_zmax = openmc.ZPlane(surface_id=1139, z0=105.7038)
surf66_zmin = openmc.ZPlane(surface_id=1140, z0=105.7038)
surf66_zmax = openmc.ZPlane(surface_id=1141, z0=108.2525)
surf67_zmin = openmc.ZPlane(surface_id=1142, z0=108.2525)
surf67_zmax = openmc.ZPlane(surface_id=1143, z0=114.1075)
surf68_zmin = openmc.ZPlane(surface_id=1144, z0=114.1075)
surf68_zmax = openmc.ZPlane(surface_id=1145, z0=116.6562)
surf69_zmin = openmc.ZPlane(surface_id=1146, z0=116.6562)
surf69_zmax = openmc.ZPlane(surface_id=1147, z0=119.3438)
surf70_zmin = openmc.ZPlane(surface_id=1148, z0=119.3438)
surf70_zmax = openmc.ZPlane(surface_id=1149, z0=121.8925)
surf71_zmin = openmc.ZPlane(surface_id=1150, z0=121.8925)
surf71_zmax = openmc.ZPlane(surface_id=1151, z0=127.7475)
surf72_zmin = openmc.ZPlane(surface_id=1152, z0=127.7475)
surf72_zmax = openmc.ZPlane(surface_id=1153, z0=130.2962)
surf73_zmin = openmc.ZPlane(surface_id=1154, z0=130.2962)
surf73_zmax = openmc.ZPlane(surface_id=1155, z0=132.9838)
surf74_zmin = openmc.ZPlane(surface_id=1156, z0=132.9838)
surf74_zmax = openmc.ZPlane(surface_id=1157, z0=135.5325)
surf75_zmin = openmc.ZPlane(surface_id=1158, z0=135.5325)
surf75_zmax = openmc.ZPlane(surface_id=1159, z0=141.3875)
surf76_zmin = openmc.ZPlane(surface_id=1160, z0=141.3875)
surf76_zmax = openmc.ZPlane(surface_id=1161, z0=143.9362)
surf81_zmin = openmc.ZPlane(surface_id=1162, z0=92.0638)
surf81_zmax = openmc.ZPlane(surface_id=1163, z0=103.0162)
surf82_zmin = openmc.ZPlane(surface_id=1164, z0=105.7038)
surf82_zmax = openmc.ZPlane(surface_id=1165, z0=116.6562)
surf83_zmin = openmc.ZPlane(surface_id=1166, z0=119.3438)
surf83_zmax = openmc.ZPlane(surface_id=1167, z0=130.2962)
surf84_zmin = openmc.ZPlane(surface_id=1168, z0=132.9838)
surf84_zmax = openmc.ZPlane(surface_id=1169, z0=143.9362)
...
source.space = openmc.stats.Box((-22.825, -22.825, 96.585), (22.825, 22.825, 139.505))
