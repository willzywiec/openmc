...
surf61_zmax = openmc.ZPlane(z0=92.0638)
surf62_zmin = openmc.ZPlane(z0=92.0638)
surf62_zmax = openmc.ZPlane(z0=94.6125)
surf63_zmin = openmc.ZPlane(z0=94.6125)
surf63_zmax = openmc.ZPlane(z0=100.4675)
surf64_zmin = openmc.ZPlane(z0=100.4675)
surf64_zmax = openmc.ZPlane(z0=103.0162)
surf65_zmin = openmc.ZPlane(z0=103.0162)
surf65_zmax = openmc.ZPlane(z0=105.7038)
surf66_zmin = openmc.ZPlane(z0=105.7038)
surf66_zmax = openmc.ZPlane(z0=108.2525)
surf67_zmin = openmc.ZPlane(z0=108.2525)
surf67_zmax = openmc.ZPlane(z0=114.1075)
surf68_zmin = openmc.ZPlane(z0=114.1075)
surf68_zmax = openmc.ZPlane(z0=116.6562)
surf69_zmin = openmc.ZPlane(z0=116.6562)
surf69_zmax = openmc.ZPlane(z0=119.3438)
surf70_zmin = openmc.ZPlane(z0=119.3438)
surf70_zmax = openmc.ZPlane(z0=121.8925)
surf71_zmin = openmc.ZPlane(z0=121.8925)
surf71_zmax = openmc.ZPlane(z0=127.7475)
surf72_zmin = openmc.ZPlane(z0=127.7475)
surf72_zmax = openmc.ZPlane(z0=130.2962)
surf73_zmin = openmc.ZPlane(z0=130.2962)
surf73_zmax = openmc.ZPlane(z0=132.9838)
surf74_zmin = openmc.ZPlane(z0=132.9838)
surf74_zmax = openmc.ZPlane(z0=135.5325)
surf75_zmin = openmc.ZPlane(z0=135.5325)
surf75_zmax = openmc.ZPlane(z0=141.3875)
surf76_zmin = openmc.ZPlane(z0=141.3875)
surf76_zmax = openmc.ZPlane(z0=143.9362)
surf81_zmin = openmc.ZPlane(z0=92.0638)
surf81_zmax = openmc.ZPlane(z0=103.0162)
surf82_zmin = openmc.ZPlane(z0=105.7038)
surf82_zmax = openmc.ZPlane(z0=116.6562)
surf83_zmin = openmc.ZPlane(z0=119.3438)
surf83_zmax = openmc.ZPlane(z0=130.2962)
surf84_zmin = openmc.ZPlane(z0=132.9838)
surf84_zmax = openmc.ZPlane(z0=143.9362)
