"""
PU-SOL-THERM-012 (Case 1) Hc = 28.17 @ H/X=1601; 18.91 wt-% Pu-240; 6 sides water reflection
...
mat1.add_nuclide("Pu239", 3.688250e-05)
mat1.add_nuclide("Pu240", 9.345480e-06)
mat1.add_nuclide("Pu241", 2.770300e-06)
mat1.add_nuclide("Pu242", 5.596080e-07)
mat1.add_nuclide("Am241", 3.002100e-07)
mat1.add_element("N", 1.413440e-03)
mat1.add_nuclide("O16", 3.539330e-02)
mat1.add_nuclide("H1", 6.349830e-02)
mat1.add_element("Fe", 4.960280e-06)
mat1.add_element("Cr", 1.595110e-06)
mat1.add_element("Ni", 1.130540e-06)
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=28.17)
# Lucoflex/Inner; Zo = Hc + 10
surf2 = openmc.model.RectangularParallelepiped(-64.0, 64.0, -64.0, 64.0, 29.17, 47.17)
# Lucoflex/Outer; Zo = Hc + 10
surf3 = openmc.model.RectangularParallelepiped(-65.0, 65.0, -65.0, 65.0, 28.17, 48.17)
# Tank/Inner
...
surf10 = openmc.ZPlane(surface_id=10, z0=48.17)
...
source.space = openmc.stats.Point((0.0, 0.0, 14.1))
