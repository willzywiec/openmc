"""
PU-SOL-THERM-030-14: Exp. No. 498 with H/X=739 with AIR+CADMIUM in the central cavity
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=32.62)
# Cavity, bottom
...
cell1.region = +surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & -surf30

# Cd
cell2 = openmc.Cell(cell_id=2, fill=mat5)
cell2.region = +surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & +surf30
...
source.space = openmc.stats.Point((0.0, 0.0, 16.31))
