...
surf3_zmax = openmc.ZPlane(z0=8.7796)
surf4_zmin = openmc.ZPlane(z0=-0.2032)
surf4_zmax = openmc.ZPlane(z0=8.9828)
surf5_zmin = openmc.ZPlane(z0=-1.9558)
surf5_zmax = openmc.ZPlane(z0=10.7354)
surf6_zmin = openmc.ZPlane(z0=-1.9558)
surf6_zmax = openmc.ZPlane(z0=10.7354)
surf7_zmin = openmc.ZPlane(z0=-9.5758)
surf7_zmax = openmc.ZPlane(z0=31.0554)
