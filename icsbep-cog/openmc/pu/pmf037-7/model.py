"""
PMF037-7: Flooded 2x2x2 array of double-canned 3kg Pu parts in water; Hw=26.3; dx=dy=10.029; dz=10.058
...
# Water height
surf6 = openmc.ZPlane(surface_id=6, z0=26.3)
# Inner tank
...
# Upper bottom tray
surf41 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 20.138, 20.773)
# Upper middle tray
surf42 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 23.833000000000002, 24.468)
# Upper upper  tray
surf43 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 27.758000000000003, 28.393)
...
source.space = openmc.stats.Box((-6.0145, -6.0145, 13.0285), (6.0145, 6.0145, 25.0865))
