"""
PU-SOL-THERM-025 (Case 13) 4.450 kg Pu(80.45) at H/X = 457 with H/SQRT(A) = 0.347; 18.40 wt-% Pu-240
...
mat1.add_nuclide("O16", 3.637200e-02)
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=31.257)
