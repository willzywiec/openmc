"""
PU-SOL-THERM-030-5: Exp. No. 495 with H/X=640 with WATER in the central cavity
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=29.95)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 14.975))
