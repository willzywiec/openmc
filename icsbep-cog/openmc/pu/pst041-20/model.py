"""
PU-SOL-THERM-041-20: Experiment 330 with 100.46 gPu(3.11)/L at H/X=253; Hc=Hw=23.08
...
mat1.add_nuclide("Pu239", 2.449000e-04)
mat1.add_nuclide("Pu240", 7.837780e-06)
mat1.add_nuclide("Pu241", 3.011640e-07)
mat1.add_element("N", 2.013710e-03)
mat1.add_nuclide("O16", 3.657640e-02)
mat1.add_nuclide("H1", 6.204620e-02)
mat1.add_element("Fe", 8.658920e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=23.08)
...
source.space = openmc.stats.Box((-18.5, -18.5, 11.29), (18.5, 18.5, 13.29))
