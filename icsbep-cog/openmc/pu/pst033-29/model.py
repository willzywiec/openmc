"""
PU-SOL-THERM-033-29: 355.6 gPu(3.13)/L at H/X=60.5 with 13 (3x40) pyrex tubes at 8.55cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=23.44)
...
# Pyrex tube #1
surf101 = openmc.ZCylinder(surface_id=101, x0=-4.845, y0=13.98631, r=1.5)
# Pyrex tube #2
surf102 = openmc.ZCylinder(surface_id=102, x0=9.69, y0=11.18904, r=1.5)
# Pyrex tube #3
surf103 = openmc.ZCylinder(surface_id=103, x0=1.615, y0=8.39179, r=1.5)
# Pyrex tube #4
surf104 = openmc.ZCylinder(surface_id=104, x0=-6.46, y0=5.59452, r=1.5)
# Pyrex tube #5
surf105 = openmc.ZCylinder(surface_id=105, x0=-14.535, y0=2.79726, r=1.5)
# Pyrex tube #6
surf106 = openmc.ZCylinder(surface_id=106, x0=8.075, y0=2.79726, r=1.5)
# Pyrex tube #7
surf107 = openmc.ZCylinder(surface_id=107, x0=0.0, y0=0.0, r=1.5)
# Pyrex tube #8
surf108 = openmc.ZCylinder(surface_id=108, x0=-8.075, y0=-2.79726, r=1.5)
# Pyrex tube #9
surf109 = openmc.ZCylinder(surface_id=109, x0=14.535, y0=-2.79726, r=1.5)
# Pyrex tube #10
surf110 = openmc.ZCylinder(surface_id=110, x0=6.46, y0=-5.59452, r=1.5)
# Pyrex tube #11
surf111 = openmc.ZCylinder(surface_id=111, x0=-1.615, y0=-8.39179, r=1.5)
# Pyrex tube #12
surf112 = openmc.ZCylinder(surface_id=112, x0=-9.69, y0=-11.18904, r=1.5)
# Pyrex tube #13
surf113 = openmc.ZCylinder(surface_id=113, x0=4.845, y0=-13.98631, r=1.5)
...
surf19_zmax = openmc.ZPlane(surface_id=1128, z0=2.585)
surf20_zmin = openmc.ZPlane(surface_id=1129, z0=39.415)
...
u4_cell1.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf19 & +surf19_zmin & -surf19_zmax) & +surf16 & +surf17 & +surf18 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107 & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf113
u4_cell2 = openmc.Cell(fill=mat5)
u4_cell2.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf20 & +surf20_zmin & -surf20_zmax) & +surf16 & +surf17 & +surf18 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107 & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf113
...
source.space = openmc.stats.Box((-4.0, -4.0, 10.72), (4.0, 4.0, 12.72))
