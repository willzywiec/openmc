"""
PU-SOL-THERM-029 (Case 19; No. 173) Hc=71.98cm; D=15.0cm; 40.6 gPu/l; H/X=632; 2.98 wt-% Pu-240; Air/Water; Water
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=71.98)
...
# Tank/Outermost
surf7 = openmc.ZCylinder(surface_id=7, x0=-1.5, y0=119.0, r=25.3)
# dX = L = 160.6 + D
surf8 = openmc.XPlane(surface_id=8, x0=0.0)
# dY = 111.0 (fixed)
surf9 = openmc.model.RectangularParallelepiped(-87.8, 87.8, -55.5, 55.5, -32.800000000000004, 119.0)
...
cell11.region = -surf2 & +surf7 & -surf9

# WATER
cell21 = openmc.Cell(cell_id=21, fill=mat4)
cell21.region = -surf2 & +surf7 & -surf9
...
source.space = openmc.stats.Box((-13.5, -1.0, 34.99), (13.5, 1.0, 36.99))
