"""
PU-COMP-MIXED-002 (case 8) 40.902 kg Pu @ H/X = 5.7 with 11.46 wt-% Pu-240 and H/SQRT(A) = 0.259
...
surf1 = openmc.model.RectangularParallelepiped(-20.48, 20.48, -20.48, 20.48, -5.295, 5.295)
# 6" (15.24 cm) Plexiglas Reflector
surf2 = openmc.model.RectangularParallelepiped(-35.72, 35.72, -35.72, 35.72, -20.535, 20.535, boundary_type="vacuum")
