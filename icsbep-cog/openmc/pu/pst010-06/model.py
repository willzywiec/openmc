"""
PU-SOL-THERM-010 (Case 11-3) 0.784 kg Pu(97.15) @ H/X = 558 in a water reflected 11" diameter SS-347 cylinder
...
mat1.add_nuclide("Pu239", 1.155400e-04)
mat1.add_nuclide("Pu240", 3.375300e-06)
mat1.add_element("N", 1.136300e-03)
mat1.add_nuclide("H1", 6.448200e-02)
mat1.add_nuclide("O16", 3.532000e-02)
mat1.add_element("Fe", 2.965400e-06)
...
surf3 = openmc.ZCylinder(surface_id=3, r=13.6839)
# Piston/Outer; Z1 = Hc; Z2 = Z1 + 30.7950
surf4 = openmc.ZCylinder(surface_id=4, r=13.8414)
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=27.0764)
# Cylinder/Inner
surf6 = openmc.ZCylinder(surface_id=6, r=13.9684)
# Cylinder/Outer
surf7 = openmc.ZCylinder(surface_id=7, r=14.1259)
# Reflector/Inner
surf8 = openmc.ZCylinder(surface_id=8, r=45.72, boundary_type="vacuum")

# Z-plane surfaces for bounded cylinders
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=27.2339)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=57.7139)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=27.0764)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=57.8714)
...
source.space = openmc.stats.Point((0.0, 0.0, 13.5))
