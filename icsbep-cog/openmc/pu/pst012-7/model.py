"""
PU-SOL-THERM-012 (Case 7) Hc = 16.32 @ H/X=366; 18.91 wt-% Pu-240; 5 sides water reflection
...
mat1.add_nuclide("Pu239", 1.572660e-04)
mat1.add_nuclide("Pu240", 3.984880e-05)
mat1.add_nuclide("Pu241", 1.181240e-05)
mat1.add_nuclide("Pu242", 2.386140e-06)
mat1.add_nuclide("Am241", 1.280080e-06)
mat1.add_element("N", 2.070860e-03)
mat1.add_nuclide("O16", 3.661450e-02)
mat1.add_nuclide("H1", 6.193610e-02)
mat1.add_element("Fe", 2.027240e-05)
mat1.add_element("Cr", 6.519130e-06)
mat1.add_element("Ni", 4.620460e-06)
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=16.32)
# Lucoflex/Inner
