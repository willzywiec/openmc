"""
PU-SOL-THERM-020 (Case 3) 0.763 kg Pu(95.43) @ H/X = 784 in a water reflected 14" SS304L sphere
...
mat1.add_nuclide("Pu238", 5.084800e-09)
mat1.add_nuclide("Pu239", 8.017800e-05)
mat1.add_nuclide("Pu240", 3.922100e-06)
mat1.add_nuclide("Pu241", 2.602800e-07)
mat1.add_nuclide("Pu242", 7.500900e-09)
mat1.add_element("N", 1.584100e-03)
mat1.add_nuclide("H1", 6.304200e-02)
mat1.add_nuclide("O16", 3.565000e-02)
...
# = Hc per Table 4
surf1 = openmc.ZPlane(surface_id=1, z0=14.8363)
# SST/Inner/Table 5
