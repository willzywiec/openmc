"""
PU-SOL-THERM-033-25: 355.6 gPu(3.13)/L at H/X=60.5 with 7 (3x40) pyrex tubes at 13.53cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=21.40)
...
# Pyrex tube #1
surf101 = openmc.ZCylinder(surface_id=101, x0=-6.765, y0=11.7173237, r=1.5)
# Pyrex tube #2
surf102 = openmc.ZCylinder(surface_id=102, x0=6.765, y0=11.7173237, r=1.5)
# Pyrex tube #3
surf103 = openmc.ZCylinder(surface_id=103, x0=-13.53, y0=0.0, r=1.5)
# Pyrex tube #4
surf104 = openmc.ZCylinder(surface_id=104, r=1.5)
# Pyrex tube #5
surf105 = openmc.ZCylinder(surface_id=105, x0=13.53, y0=0.0, r=1.5)
# Pyrex tube #6
surf106 = openmc.ZCylinder(surface_id=106, x0=-6.765, y0=-11.7173237, r=1.5)
# Unit cell #7
surf107 = openmc.ZCylinder(surface_id=107, x0=6.765, y0=-11.7173237, r=1.5)
...
surf19_zmax = openmc.ZPlane(surface_id=1122, z0=2.629)
surf20_zmin = openmc.ZPlane(surface_id=1123, z0=39.371)
...
source.space = openmc.stats.Box((-4.0, -4.0, 9.7), (4.0, 4.0, 11.7))
