...
surf19 = openmc.ZCylinder(surface_id=19, x0=2.5, y0=2.629, r=17.5)
# Upper polyethylene grid plate, entire grid
surf20 = openmc.ZCylinder(surface_id=20, x0=39.371, y0=39.5, r=17.5)
...
# Pyrex tube #4
surf104 = openmc.ZCylinder(surface_id=104, x0=1.5, y0=41.5, r=1.5)
# Pyrex tube #5
