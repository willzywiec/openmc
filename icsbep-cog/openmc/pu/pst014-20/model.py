"""
PU-SOL-THERM-014 (Case 20) Three cylinders with 30 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=36.90)
...
source.space = openmc.stats.Box((-1.0, -61.0, 17.0), (61.0, 1.0, 19.0))
