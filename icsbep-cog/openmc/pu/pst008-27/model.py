"""
PU-SOL-THERM-008 (Case 27) 2.361 kg Pu(95.43) @ H/X = 243 in 14" SS304L sphere in 4" air + 6" concrete hemi
...
mat1.add_nuclide("Pu238", 1.608900e-08)
mat1.add_nuclide("Pu239", 2.537100e-04)
mat1.add_nuclide("Pu240", 1.241300e-05)
mat1.add_nuclide("Pu241", 8.129700e-07)
mat1.add_nuclide("Pu242", 2.373400e-08)
mat1.add_element("N", 2.278300e-03)
mat1.add_nuclide("H1", 6.194200e-02)
mat1.add_nuclide("O16", 3.720100e-02)
...
# = Hc ------------ Table 5b
surf1 = openmc.ZPlane(surface_id=1, z0=13.4066)
...
surf10 = openmc.ZPlane(surface_id=10, z0=0.0000)

# Z-plane surfaces for bounded cylinders
surf8_zmin = openmc.ZPlane(surface_id=1010, z0=-99.0)
surf8_zmax = openmc.ZPlane(surface_id=1011, z0=0.0)
surf9_zmin = openmc.ZPlane(surface_id=1012, z0=-99.0)
surf9_zmax = openmc.ZPlane(surface_id=1013, z0=0.0)
...
cell6.region = +surf4 & -surf5 & +surf7 & (+surf9 | -surf9_zmin | +surf9_zmax) & -surf10
