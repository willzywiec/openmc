"""
PMF042-5D: Pu hemisphere reflected by 4x0.3228cm steel shells and infinite oil; detailed model
...
# Hc
surf2 = openmc.ZPlane(surface_id=2, z0=0.09)
# BCD
...
surf3_zmin = openmc.ZPlane(surface_id=1071, z0=-31.333, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(surface_id=1072, z0=18.667, boundary_type="vacuum")
...
cell2.region = +surf1 & +surf64 & -surf71

# Oil
cell3 = openmc.Cell(cell_id=3, fill=mat5)
cell3.region = +surf1 & -surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & +surf71
...
cell6.region = +surf1 & +surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & +surf71
