"""
PU-SOL-THERM-016 (Case 7) 300 and 256 mm cylinders with 115.1 gPu/L at 30 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=40.334)
...
source.space = openmc.stats.Box((-1.0, -1.0, 19.2), (58.79, 1.0, 21.2))
