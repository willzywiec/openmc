"""
PU-SOL-THERM-025 (Case 40) 46.995 kg Pu(80.45) at H/X = 56 with H/SQRT(A) = 0.222; 18.40 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=60.122)
# Sol'n Tank/Inner: Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-53.34, 53.34, -6.180000000000001, 11.600000000000001, 0.0, 106.68)
# Sol'n Tank/Outer: Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -6.3389999999999995, 11.759, -0.3159999999999954, 106.99600000000001)
# Egg Crate /Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -17.769, 23.189, -0.3159999999999954, 106.99600000000001)
...
source.space = openmc.stats.Point((0.0, 2.71, 30.0))
