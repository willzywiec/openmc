...
surf61_zmax = openmc.ZPlane(z0=71.2455)
surf62_zmin = openmc.ZPlane(z0=71.2455)
...
surf64_zmax = openmc.ZPlane(z0=87.2945)
surf65_zmin = openmc.ZPlane(z0=87.2945)
surf65_zmax = openmc.ZPlane(z0=97.0655)
surf66_zmin = openmc.ZPlane(z0=97.0655)
...
surf68_zmax = openmc.ZPlane(z0=113.1145)
surf69_zmin = openmc.ZPlane(z0=113.1145)
surf69_zmax = openmc.ZPlane(z0=122.8855)
surf70_zmin = openmc.ZPlane(z0=122.8855)
...
surf72_zmax = openmc.ZPlane(z0=138.9345)
surf73_zmin = openmc.ZPlane(z0=138.9345)
surf73_zmax = openmc.ZPlane(z0=148.7055)
surf74_zmin = openmc.ZPlane(z0=148.7055)
...
surf76_zmax = openmc.ZPlane(z0=164.7545)
surf81_zmin = openmc.ZPlane(z0=71.2455)
surf81_zmax = openmc.ZPlane(z0=87.2945)
surf82_zmin = openmc.ZPlane(z0=97.0655)
surf82_zmax = openmc.ZPlane(z0=113.1145)
surf83_zmin = openmc.ZPlane(z0=122.8855)
surf83_zmax = openmc.ZPlane(z0=138.9345)
surf84_zmin = openmc.ZPlane(z0=148.7055)
surf84_zmax = openmc.ZPlane(z0=164.7545)
