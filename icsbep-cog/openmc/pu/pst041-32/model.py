"""
PU-SOL-THERM-041-32: Experiment 461 with 30.25 gPu(3.11)/L at H/X=866; Hc=44.39; Hw=101.40 (cavity)
...
mat1.add_nuclide("Pu239", 7.374310e-05)
mat1.add_nuclide("Pu240", 2.360070e-06)
mat1.add_nuclide("Pu241", 9.068490e-08)
mat1.add_element("N", 1.277300e-03)
mat1.add_nuclide("O16", 3.532920e-02)
mat1.add_nuclide("H1", 6.395810e-02)
mat1.add_element("Fe", 2.997730e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=44.39)
...
source.space = openmc.stats.Box((-18.5, -18.5, 21.945), (18.5, 18.5, 23.945))
