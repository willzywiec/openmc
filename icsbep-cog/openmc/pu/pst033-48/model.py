...
# Pyrex tube #1
surf101 = openmc.ZCylinder(surface_id=101, x0=0.0, y0=14.93028, r=2.00695)
# Pyrex tube #2
surf102 = openmc.ZCylinder(surface_id=102, x0=-12.93, y0=7.46514, r=2.00695)
# Pyrex tube #3
surf103 = openmc.ZCylinder(surface_id=103, x0=-4.31, y0=7.46514, r=2.00695)
# Pyrex tube #4
surf104 = openmc.ZCylinder(surface_id=104, x0=4.31, y0=7.46514, r=2.00695)
# Pyrex tube #5
surf105 = openmc.ZCylinder(surface_id=105, x0=12.93, y0=7.46514, r=2.00695)
# Pyrex tube #6
surf106 = openmc.ZCylinder(surface_id=106, x0=-8.62, y0=0.0, r=2.00695)
# Pyrex tube #7
surf107 = openmc.ZCylinder(surface_id=107, r=2.00695)
# Pyrex tube #8
surf108 = openmc.ZCylinder(surface_id=108, x0=8.62, y0=0.0, r=2.00695)
# Pyrex tube #9
surf109 = openmc.ZCylinder(surface_id=109, x0=-12.93, y0=-7.46514, r=2.00695)
# Pyrex tube #10
surf110 = openmc.ZCylinder(surface_id=110, x0=-4.31, y0=-7.46514, r=2.00695)
# Pyrex tube #11
surf111 = openmc.ZCylinder(surface_id=111, x0=4.31, y0=-7.46514, r=2.00695)
# Pyrex tube #12
surf112 = openmc.ZCylinder(surface_id=112, x0=12.93, y0=-7.46514, r=2.00695)
# Pyrex tube #13
surf113 = openmc.ZCylinder(surface_id=113, x0=0.0, y0=-14.93028, r=2.00695)

# Z-plane surfaces for bounded cylinders
surf3_zmin = openmc.ZPlane(surface_id=1113, z0=-0.3)
surf3_zmax = openmc.ZPlane(surface_id=1114, z0=80.7)
surf4_zmin = openmc.ZPlane(surface_id=1115, z0=-25.9)
surf4_zmax = openmc.ZPlane(surface_id=1116, z0=62.8)
surf6_zmin = openmc.ZPlane(surface_id=1117, z0=-26.3, boundary_type="vacuum")
surf6_zmax = openmc.ZPlane(surface_id=1118, z0=85.7, boundary_type="vacuum")
surf10_zmin = openmc.ZPlane(surface_id=1119, z0=1.2)
surf10_zmax = openmc.ZPlane(surface_id=1120, z0=82.2)
surf11_zmin = openmc.ZPlane(surface_id=1121, z0=1.2)
surf11_zmax = openmc.ZPlane(surface_id=1122, z0=1.38)
surf13_zmin = openmc.ZPlane(surface_id=1123, z0=81.8)
surf13_zmax = openmc.ZPlane(surface_id=1124, z0=82.2)
surf15_zmin = openmc.ZPlane(surface_id=1125, z0=1.38)
surf15_zmax = openmc.ZPlane(surface_id=1126, z0=81.8)
surf19_zmin = openmc.ZPlane(surface_id=1127, z0=2.5)
surf19_zmax = openmc.ZPlane(surface_id=1128, z0=2.59)
surf20_zmin = openmc.ZPlane(surface_id=1129, z0=39.41)
surf20_zmax = openmc.ZPlane(surface_id=1130, z0=39.5)
surf24_zmin = openmc.ZPlane(surface_id=1131, z0=1.5)
surf24_zmax = openmc.ZPlane(surface_id=1132, z0=41.5)
surf107_zmin = openmc.ZPlane(surface_id=1133, z0=1.5)
surf107_zmax = openmc.ZPlane(surface_id=1134, z0=41.5)
...
u4_cell1.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf19 & +surf19_zmin & -surf19_zmax) & +surf16 & +surf17 & +surf18 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & (+surf107 | -surf107_zmin | +surf107_zmax) & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf113
u4_cell2 = openmc.Cell(fill=mat5)
u4_cell2.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf20 & +surf20_zmin & -surf20_zmax) & +surf16 & +surf17 & +surf18 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & (+surf107 | -surf107_zmin | +surf107_zmax) & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf113
...
u4_cell4.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (+surf11 | -surf11_zmin | +surf11_zmax) & +surf16 & +surf17 & +surf18 & (+surf19 | -surf19_zmin | +surf19_zmax) & (+surf20 | -surf20_zmin | +surf20_zmax) & -surf1 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & (+surf107 | -surf107_zmin | +surf107_zmax) & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf113
