"""
PU-SOL-THERM-015 (Case 8) Three cylinders with 10 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=31.90)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=23.094, y0=0.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=-11.547, y0=20.0, r=15.0)
# Table 1 and Figure 7
surf13 = openmc.ZCylinder(surface_id=13, x0=-11.547, y0=-20.0, r=15.0)
...
source.space = openmc.stats.Box((-12.0, -21.0, 15.0), (24.0, 21.0, 17.0))
