"""
PMF016-1: Flooded 3x3x3 arrays of 3kg Pu metal cylinders; Hw=48.30; dx=dy=12.00; dz=12.75
...
# Water height
surf9 = openmc.ZPlane(surface_id=9, z0=48.300)
# Sleeve inner
surf10 = openmc.ZCylinder(surface_id=10, r=3.81)
# Sleeve outer
surf11 = openmc.ZCylinder(surface_id=11, r=3.97)
surf12 = openmc.ZCylinder(surface_id=12, x0=-12.0, y0=-12.0, r=3.97)
surf13 = openmc.ZCylinder(surface_id=13, x0=0.0, y0=-12.0, r=3.97)
surf14 = openmc.ZCylinder(surface_id=14, x0=12.0, y0=-12.0, r=3.97)
surf15 = openmc.ZCylinder(surface_id=15, x0=-12.0, y0=0.0, r=3.97)
surf16 = openmc.ZCylinder(surface_id=16, x0=12.0, y0=0.0, r=3.97)
surf17 = openmc.ZCylinder(surface_id=17, x0=-12.0, y0=12.0, r=3.97)
surf18 = openmc.ZCylinder(surface_id=18, x0=0.0, y0=12.0, r=3.97)
surf19 = openmc.ZCylinder(surface_id=19, x0=12.0, y0=12.0, r=3.97)
...
source.space = openmc.stats.Box((-13.0, -13.0, 40.2), (13.0, 13.0, 42.2))
