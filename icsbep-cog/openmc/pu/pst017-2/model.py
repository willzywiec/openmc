"""
PU-SOL-THERM-017 (Case 2) 300 and 256 mm cylinders with 115.1 gPu/L at 30 cm s-to-s
...
surf4 = openmc.ZPlane(surface_id=4, z0=40.214)
...
source.space = openmc.stats.Box((-1.0, -1.0, 9.0), (58.79, 1.0, 21.1))
