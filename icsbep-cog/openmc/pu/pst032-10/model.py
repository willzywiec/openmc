"""
PU-SOL-THERM-032-10: H/X=1075 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 3.293800e-08)
mat1.add_nuclide("Pu239", 5.813400e-05)
mat1.add_nuclide("Pu240", 6.506400e-06)
mat1.add_nuclide("Pu241", 8.326800e-07)
mat1.add_nuclide("Pu242", 5.830600e-08)
mat1.add_nuclide("H1", 6.339400e-02)
mat1.add_nuclide("O16", 3.542400e-02)
mat1.add_element("N", 1.438300e-03)
mat1.add_element("Fe", 5.769000e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=60.60)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 30.3))
