"""
PU-SOL-THERM-026 (Case 10) 28.456 kg Pu(81.6) at H/X = 179 with H/SQRT(A) = 0.205
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=85.242)
# Tank/Inner:  Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 139.091, 158.649, -192.929, -86.249)
# Tank/Outer:  Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 138.93200000000002, 158.808, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 127.50200000000001, 170.238, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -150.3))
