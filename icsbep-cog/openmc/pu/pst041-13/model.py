"""
PU-SOL-THERM-041-13: Experiment 296 with 41.3 gPu(3)/L at H/X=583; Hc=Hw=35.21
...
surf7 = openmc.ZPlane(surface_id=7, z0=35.21)
...
source.space = openmc.stats.Box((-18.5, -18.5, 17.355), (18.5, 18.5, 19.355))
