"""
PU-SOL-THERM-024 (Case 5) 43.066 kg Pu(80.45) at H/X = 109 with H/SQRT(A) = 0.173; 18.40 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=95.6564)
# Tank/Inner:  Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -145.0))
