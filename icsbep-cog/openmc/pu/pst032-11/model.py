"""
PU-SOL-THERM-032-11: H/X=1120 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 3.162200e-08)
mat1.add_nuclide("Pu239", 5.581200e-05)
mat1.add_nuclide("Pu240", 6.246500e-06)
mat1.add_nuclide("Pu241", 7.994300e-07)
mat1.add_nuclide("Pu242", 5.597700e-08)
mat1.add_nuclide("H1", 6.343300e-02)
mat1.add_nuclide("O16", 3.539700e-02)
mat1.add_element("N", 1.421600e-03)
mat1.add_element("Fe", 5.122000e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=65.71)
# Cavity, bottom
...
cell2.region = +surf2 & (+surf3 | -surf3_zmin | +surf3_zmax) & (-surf4 & +surf4_zmin & -surf4_zmax)

# Soln
cell3 = openmc.Cell(cell_id=3, fill=mat1)
cell3.region = -surf1 & +surf2 & (+surf4 | -surf4_zmin | +surf4_zmax) & (-surf5 & +surf5_zmin & -surf5_zmax)
...
cell5.region = +surf2 & (+surf4 | -surf4_zmin | +surf4_zmax) & (+surf5 | -surf5_zmin | +surf5_zmax) & (-surf6 & +surf6_zmin & -surf6_zmax)

# SST
cell6 = openmc.Cell(cell_id=6, fill=mat2)
cell6.region = -surf2 & (-surf6 & +surf6_zmin & -surf6_zmax)

# H2O
cell7 = openmc.Cell(cell_id=7, fill=mat3)
cell7.region = -surf1 & (+surf6 | -surf6_zmin | +surf6_zmax) & (-surf7 & +surf7_zmin & -surf7_zmax)
...
source.space = openmc.stats.Point((0.0, 0.0, 32.855))
