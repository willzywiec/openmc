"""
PU-SOL-THERM-014 (Case 19) Three cylinders with 10 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=32.71)
...
source.space = openmc.stats.Box((-1.0, -41.0, 15.0), (41.0, 1.0, 17.0))
