"""
PMF042-10S: Pu hemisphere reflected by 3.0 cm steel and infinite oil; simplified model
...
# Steel
# surf3: Unsupported surface type "s" with params ['9.333', 'tr', '-2.37375', '0', '-6.333']
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=1.84)
# BCD
