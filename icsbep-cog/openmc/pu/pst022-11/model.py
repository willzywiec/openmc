"""
PU-SOL-THERM-022 (Case 11) Hc = 54.33 @ H/X=215; 18.88 wt-% Pu-240; Paraffin + Cd
...
mat1.add_nuclide("Pu239", 2.543000e-04)
mat1.add_nuclide("Pu240", 6.443600e-05)
mat1.add_nuclide("Pu241", 1.952700e-05)
mat1.add_nuclide("Pu242", 3.858500e-06)
mat1.add_nuclide("Am241", 1.630800e-06)
mat1.add_element("N", 3.188000e-03)
mat1.add_nuclide("O16", 3.819100e-02)
mat1.add_nuclide("H1", 5.891700e-02)
mat1.add_element("Fe", 3.450600e-05)
mat1.add_element("Cr", 1.109600e-05)
mat1.add_element("Ni", 7.864600e-06)
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=54.33)
...
source.space = openmc.stats.Box((-18.0, -18.0, 26.0), (18.0, 18.0, 28.0))
