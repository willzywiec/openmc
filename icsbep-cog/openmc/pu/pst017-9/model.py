"""
PU-SOL-THERM-017 (Case 9) 300 and 256 mm cylinders with 115.1 gPu/L at 5 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=10.00)
...
surf4 = openmc.ZPlane(surface_id=4, z0=39.844)
...
source.space = openmc.stats.Box((-1.0, -1.0, 4.0), (33.79, 1.0, 20.9))
