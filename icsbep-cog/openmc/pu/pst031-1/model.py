"""
PU-SOL-THERM-031-1: H/X=287 and 7 Hafnium Plates with 7.1446 cm Pitch
...
mat1.add_nuclide("U238", 2.593000e-07)
mat1.add_nuclide("Pu239", 1.934600e-04)
mat1.add_nuclide("Pu240", 4.849800e-05)
mat1.add_nuclide("Pu241", 1.302200e-05)
mat1.add_nuclide("Pu242", 2.881700e-06)
mat1.add_nuclide("Am241", 2.844500e-06)
mat1.add_nuclide("H1", 5.917300e-02)
mat1.add_nuclide("O16", 3.797500e-02)
mat1.add_element("N", 3.114000e-03)
mat1.add_element("Fe", 3.774100e-05)
mat1.add_element("Cr", 1.080300e-05)
mat1.add_element("Ni", 7.993200e-06)
mat1.add_element("Mn", 9.550300e-07)
...
mat3.add_nuclide("H1", 6.673600e-02)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=41.61)
# SST tank, inner
...
# Holes
surf31_cyl = openmc.ZCylinder(surface_id=31, x0=tr, y0=0.5, r=0.3)
surf31_zmin = openmc.ZPlane(z0=0.8660254)
surf31_zmax = openmc.ZPlane(z0=0.0)
surf31 = (surf31_cyl, surf31_zmin, surf31_zmax)
# in the
surf32_cyl = openmc.ZCylinder(surface_id=32, x0=tr, y0=-0.5, r=0.3)
surf32_zmin = openmc.ZPlane(z0=0.8660254)
surf32_zmax = openmc.ZPlane(z0=0.0)
surf32 = (surf32_cyl, surf32_zmin, surf32_zmax)
# grid plate
surf33_cyl = openmc.ZCylinder(surface_id=33, x0=tr, y0=0.5, r=0.3)
surf33_zmin = openmc.ZPlane(z0=-0.8660254)
surf33_zmax = openmc.ZPlane(z0=0.0)
surf33 = (surf33_cyl, surf33_zmin, surf33_zmax)
# unit cell
surf34_cyl = openmc.ZCylinder(surface_id=34, x0=tr, y0=-0.5, r=0.3)
surf34_zmin = openmc.ZPlane(z0=-0.8660254)
...
surf41_cyl = openmc.ZCylinder(surface_id=41, x0=tr, y0=-24.5, r=0.3)
surf41_zmin = openmc.ZPlane(z0=0.0)
surf41_zmax = openmc.ZPlane(z0=0.0)
surf41 = (surf41_cyl, surf41_zmin, surf41_zmax)
surf42_cyl = openmc.ZCylinder(surface_id=42, x0=tr, y0=24.5, r=0.3)
surf42_zmin = openmc.ZPlane(z0=0.0)
surf42_zmax = openmc.ZPlane(z0=0.0)
surf42 = (surf42_cyl, surf42_zmin, surf42_zmax)
# Hafnium plate
surf51 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -21.369999999999997, -21.2654, 2.4179999999999993, 52.418)
# Hafnium plate
surf52 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -14.2254, -14.1208, 2.4179999999999993, 52.418)
# Hafnium plate
surf53 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -7.0808, -6.9762, 2.4179999999999993, 52.418)
# Hafnium plate
surf54 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 0.0638, 0.1684, 2.4179999999999993, 52.418)
# Hafnium plate
surf55 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 7.2084, 7.313, 2.4179999999999993, 52.418)
# Hafnium plate
surf56 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 14.353, 14.457600000000001, 2.4179999999999993, 52.418)
# Hafnium plate
surf57 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 21.497600000000002, 21.6022, 2.4179999999999993, 52.418)
...
u3_cell0.region = +surf1 & -surf2 & -surf5 & +surf51 & +surf52 & +surf53 & +surf54 & +surf55 & +surf56 & +surf57
u3_cell1 = openmc.Cell(fill=mat1)
u3_cell1.region = -surf1 & -surf2 & +surf4 & -surf5 & +surf11 & +surf12 & +surf13 & +surf14 & +surf51 & +surf52 & +surf53 & +surf54 & +surf55 & +surf56 & +surf57
u3_cell2 = openmc.Cell(fill=mat5)
u3_cell2.region = -surf51 & -surf52 & -surf53 & -surf54 & -surf55 & -surf56 & -surf57
...
source.space = openmc.stats.Box((-1.0, -4.4562, 19.805), (1.0, 4.6884, 21.805))
