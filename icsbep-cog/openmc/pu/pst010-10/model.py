"""
PU-SOL-THERM-010 (Case 11-7) 0.779 kg Pu(97.15) @ H/X = 535 in a water reflected 11" diameter SS-347 cylinder
...
mat1.add_nuclide("Pu239", 1.198100e-04)
mat1.add_nuclide("Pu240", 3.563300e-06)
mat1.add_element("N", 1.350000e-03)
mat1.add_nuclide("H1", 6.412600e-02)
mat1.add_nuclide("O16", 3.568500e-02)
mat1.add_element("Fe", 2.566400e-06)
...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=25.9588)
# Cylinder/Inner
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=26.1163)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=56.5963)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=25.9588)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=56.7538)
