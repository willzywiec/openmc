"""
PU-SOL-THERM-026 (Case 4) 12.670 kg Pu(81.6) at H/X = 457 with H/SQRT(A) = 0.190
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=93.754)
# Tank/Inner: Width = Tc
...
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 127.756, 169.984, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -99.0))
