"""
PU-SOL-THERM-021 (Case 5) 0.736 kg Pu(95.4) @ H/X = 1121 in a water reflected 15.2" SS304L sphere
...
mat1.add_nuclide("Pu238", 3.703600e-09)
mat1.add_nuclide("Pu239", 5.841400e-05)
mat1.add_nuclide("Pu240", 2.857900e-06)
mat1.add_nuclide("Pu241", 1.725100e-07)
mat1.add_nuclide("Pu242", 5.463400e-09)
mat1.add_element("N", 5.589400e-04)
mat1.add_nuclide("H1", 6.566700e-02)
mat1.add_nuclide("O16", 3.435400e-02)
...
# = Hc per Table 5a
surf1 = openmc.ZPlane(surface_id=1, z0=18.4390)
# SST/Inner
surf2 = openmc.Sphere(surface_id=2, r=19.3163)
# SST/Outer
surf3 = openmc.Sphere(surface_id=3, r=19.4382)
# H2O/Outer
surf4 = openmc.Sphere(surface_id=4, r=49.4382)
# Support Tube/Inner
