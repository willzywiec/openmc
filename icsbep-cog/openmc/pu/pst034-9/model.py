"""
PU-SOL-THERM-034-9: 31.451 kg Pu(8.3) @ H/X=58.5 with 6.28 gGd/L
...
mat1.add_element("Gd", 2.405000e-05)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=29.62)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 14.81))
