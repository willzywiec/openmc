...
surf1 = openmc.Sphere(surface_id=1, r=1.20)
surf2 = openmc.Sphere(surface_id=2, r=3.15)
surf3 = openmc.Sphere(surface_id=3, r=4.02)
surf4 = openmc.Sphere(surface_id=4, r=4.66)
surf5 = openmc.Sphere(surface_id=5, r=5.35)
surf6 = openmc.Sphere(surface_id=6, r=6.00)
surf7 = openmc.Sphere(surface_id=7, r=9.15, boundary_type="vacuum")
