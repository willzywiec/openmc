"""
PU-SOL-THERM-016 (Case 2) 300 and 256 mm cylinders with 152.5 gPu/L at 10 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=39.824)
...
surf4 = openmc.ZPlane(surface_id=4, z0=39.824)
...
source.space = openmc.stats.Box((-1.0, -1.0, 18.9), (38.79, 1.0, 20.9))
