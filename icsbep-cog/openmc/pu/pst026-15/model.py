"""
PU-SOL-THERM-026 (Case 15) 30.840 kg Pu(76.8) at H/X = 153 with H/SQRT(A) = 0.252
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=67.208)
# Tank/Inner:  Width = Tc
...
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 126.613, 171.127, -193.379, -85.799)
# U-Frame/Inner
