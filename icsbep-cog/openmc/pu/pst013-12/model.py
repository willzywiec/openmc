"""
PU-SOL-THERM-013 (Case 12) Four cylinders with 5 cm surface-to-surface
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=36.32)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=-15.294, y0=15.294, r=12.794)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=15.294, y0=15.294, r=12.794)
surf13 = openmc.ZCylinder(surface_id=13, x0=-15.294, y0=-15.294, r=12.794)
surf14 = openmc.ZCylinder(surface_id=14, x0=15.294, y0=-15.294, r=12.794)
...
source.space = openmc.stats.Box((-16.294, -16.294, 17.16), (16.294, 16.294, 19.16))
