...
mat1.add_nuclide("Pu238", 1.292800e-08)
mat1.add_nuclide("Pu239", 1.683400e-04)
mat1.add_nuclide("Pu240", 7.427400e-06)
mat1.add_nuclide("Pu241", 5.006500e-07)
mat1.add_nuclide("Pu242", 2.786500e-08)
mat1.add_nuclide("Am241", 1.143200e-07)
mat1.add_element("N", 2.956600e-03)
mat1.add_nuclide("H1", 5.938500e-02)
mat1.add_nuclide("O16", 3.744200e-02)
mat1.add_element("Fe", 2.663500e-06)
mat1.add_element("Cr", 7.151800e-07)
mat1.add_element("Ni", 3.520000e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=20.14)
