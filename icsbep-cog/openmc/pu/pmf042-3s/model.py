"""
PMF042-3S: Pu hemisphere reflected by 0.667 cm steel and infinite oil; simplified model
...
# Steel
# surf3: Unsupported surface type "s" with params ['7.000', 'tr', '-2.37375', '0', '-6.333']
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=-0.63)
# BCD
