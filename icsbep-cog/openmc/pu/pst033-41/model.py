"""
PU-SOL-THERM-033-41: 151.8 gPu(3.13)/L at H/X=159.2 with 7 (4x60) pyrex tubes at 4.31cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=24.34)
...
source.space = openmc.stats.Box((-3.155, -3.488, 11.17), (3.155, 3.488, 13.17))
