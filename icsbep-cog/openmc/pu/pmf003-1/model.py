...
# 1st
surf41 = openmc.ZCylinder(surface_id=41, x0=3.65, y0=3.65, r=3.609)
# 2nd
surf42 = openmc.ZCylinder(surface_id=42, x0=-3.65, y0=3.65, r=3.609)
# 3rd
surf43 = openmc.ZCylinder(surface_id=43, x0=-3.65, y0=-3.65, r=3.609)
# 4th
surf44 = openmc.ZCylinder(surface_id=44, x0=3.65, y0=-3.65, r=3.609)
