"""
PU-SOL-THERM-033-47: 355.6 gPu(3.13)/L at H/X=60.5 with 1 (4x40) pyrex tubes at 7.81cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=20.94)
...
# Pyrex tube #1
surf101 = openmc.ZCylinder(surface_id=101, r=2.00695)

# Z-plane surfaces for bounded cylinders
surf3_zmin = openmc.ZPlane(surface_id=1101, z0=-0.3)
surf3_zmax = openmc.ZPlane(surface_id=1102, z0=80.7)
surf4_zmin = openmc.ZPlane(surface_id=1103, z0=-25.9)
surf4_zmax = openmc.ZPlane(surface_id=1104, z0=62.8)
surf6_zmin = openmc.ZPlane(surface_id=1105, z0=-26.3, boundary_type="vacuum")
surf6_zmax = openmc.ZPlane(surface_id=1106, z0=85.7, boundary_type="vacuum")
surf10_zmin = openmc.ZPlane(surface_id=1107, z0=1.2)
surf10_zmax = openmc.ZPlane(surface_id=1108, z0=82.2)
surf11_zmin = openmc.ZPlane(surface_id=1109, z0=1.2)
surf11_zmax = openmc.ZPlane(surface_id=1110, z0=1.38)
surf13_zmin = openmc.ZPlane(surface_id=1111, z0=81.8)
surf13_zmax = openmc.ZPlane(surface_id=1112, z0=82.2)
surf15_zmin = openmc.ZPlane(surface_id=1113, z0=1.38)
surf15_zmax = openmc.ZPlane(surface_id=1114, z0=81.8)
surf19_zmin = openmc.ZPlane(surface_id=1115, z0=2.5)
surf19_zmax = openmc.ZPlane(surface_id=1116, z0=2.558)
surf20_zmin = openmc.ZPlane(surface_id=1117, z0=39.442)
surf20_zmax = openmc.ZPlane(surface_id=1118, z0=39.5)
surf24_zmin = openmc.ZPlane(surface_id=1119, z0=1.5)
surf24_zmax = openmc.ZPlane(surface_id=1120, z0=41.5)
surf101_zmin = openmc.ZPlane(surface_id=1121, z0=1.5)
surf101_zmax = openmc.ZPlane(surface_id=1122, z0=41.5)
...
u4_cell1.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf19 & +surf19_zmin & -surf19_zmax) & +surf16 & +surf17 & +surf18 & (+surf101 | -surf101_zmin | +surf101_zmax)
u4_cell2 = openmc.Cell(fill=mat5)
u4_cell2.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf20 & +surf20_zmin & -surf20_zmax) & +surf16 & +surf17 & +surf18 & (+surf101 | -surf101_zmin | +surf101_zmax)
...
u4_cell4.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (+surf11 | -surf11_zmin | +surf11_zmax) & +surf16 & +surf17 & +surf18 & (+surf19 | -surf19_zmin | +surf19_zmax) & (+surf20 | -surf20_zmin | +surf20_zmax) & -surf1 & (+surf101 | -surf101_zmin | +surf101_zmax)
...
source.space = openmc.stats.Box((-4.0, -4.0, 9.47), (4.0, 4.0, 11.47))
