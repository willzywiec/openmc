"""
PU-SOL-THERM-031-17: H/X=1240 with no Hafnium
...
mat1.add_nuclide("U238", 6.248500e-08)
mat1.add_nuclide("Pu239", 4.663100e-05)
mat1.add_nuclide("Pu240", 1.169000e-05)
mat1.add_nuclide("Pu241", 3.124000e-06)
mat1.add_nuclide("Pu242", 6.945900e-07)
mat1.add_nuclide("Am241", 7.006600e-07)
mat1.add_nuclide("H1", 6.169500e-02)
mat1.add_nuclide("O16", 3.626100e-02)
mat1.add_element("N", 2.107700e-03)
mat1.add_element("Fe", 8.626600e-06)
mat1.add_element("Cr", 2.603200e-06)
mat1.add_element("Ni", 1.926200e-06)
mat1.add_element("Mn", 2.301400e-07)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=40.66)
# SST tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 20.33))
