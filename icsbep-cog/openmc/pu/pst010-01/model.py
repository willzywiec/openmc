"""
PU-SOL-THERM-010 (Case 9-1) 1.248 kg Pu(97.15) @ H/X = 267 in a water reflected 9" diameter SS-347 cylinder
...
mat1.add_nuclide("Pu239", 2.425100e-04)
mat1.add_nuclide("Pu240", 7.084600e-06)
mat1.add_element("N", 1.325700e-03)
mat1.add_nuclide("H1", 6.472200e-02)
mat1.add_nuclide("O16", 3.617400e-02)
mat1.add_element("Fe", 4.076000e-06)
...
mat3.add_nuclide("H1", 6.662800e-02)
mat3.add_nuclide("O16", 3.331400e-02)
...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=30.7086)
# Cylinder/Inner
