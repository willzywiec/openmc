"""
PU-SOL-THERM-032-1: H/X=443 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 7.854900e-08)
mat1.add_nuclide("Pu239", 1.386400e-04)
mat1.add_nuclide("Pu240", 1.551600e-05)
mat1.add_nuclide("Pu241", 1.985800e-06)
mat1.add_nuclide("Pu242", 1.390500e-07)
mat1.add_nuclide("H1", 6.232100e-02)
mat1.add_nuclide("O16", 3.611600e-02)
mat1.add_element("N", 1.856600e-03)
mat1.add_element("Fe", 8.950100e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=28.2)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 15.5))
