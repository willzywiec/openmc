"""
PU-SOL-THERM-026 (Case 3) 7.176 kg Pu(95.4) at H/X = 446 with H/SQRT(A) = 0.190
...
mat1.add_nuclide("H1", 6.180100e-02)
mat1.add_element("N", 2.032600e-03)
mat1.add_nuclide("O16", 3.627300e-02)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=70.612)
# Tank/Inner: Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 140.615, 157.125, -192.929, -86.249)
# Tank/Outer: Width = Tc + 0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 140.45600000000002, 157.284, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 129.026, 168.714, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -122.0))
