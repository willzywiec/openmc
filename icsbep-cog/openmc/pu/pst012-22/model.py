"""
PU-SOL-THERM-012 (Case 22) Hc = 69.57 @ H/X=2394; 18.91 wt-% Pu-240; no close water reflection
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=69.57)
# Lucoflex/Inner
...
source.space = openmc.stats.Point((0.0, 0.0, 34.8))
