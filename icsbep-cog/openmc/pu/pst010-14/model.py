...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=33.4264)
# Cylinder/Inner
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=33.5839)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=64.0639)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=33.4264)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=64.2214)
