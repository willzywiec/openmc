"""
PU-SOL-THERM-041-19: Experiment 329 with 100.46 gPu(3.11)/L at H/X=253; Hc=22.76
...
surf7 = openmc.ZPlane(surface_id=7, z0=22.76)
...
source.space = openmc.stats.Box((-18.5, -18.5, 11.13), (18.5, 18.5, 13.13))
