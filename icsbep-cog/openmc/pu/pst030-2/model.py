"""
PU-SOL-THERM-030-2: Exp. No. 507 with H/X=1182 with AIR in the central cavity
...
mat1.add_nuclide("Pu239", 5.425100e-05)
mat1.add_nuclide("Pu240", 8.229600e-07)
mat1.add_nuclide("Pu241", 1.639100e-08)
mat1.add_nuclide("H1", 6.416400e-02)
mat1.add_nuclide("O16", 3.208200e-02)
mat1.add_nuclide("O16", 3.069100e-03)
mat1.add_element("N", 1.182600e-03)
mat1.add_element("Fe", 1.585100e-06)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=53.07)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 26.535))
