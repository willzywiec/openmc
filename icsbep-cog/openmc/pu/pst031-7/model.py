"""
PU-SOL-THERM-031-7: H/X=829 and 2 Groups of 2 Hafnium Plates with 16.6092 cm Pitch
...
mat1.add_nuclide("U238", 9.334800e-08)
mat1.add_nuclide("Pu239", 6.966300e-05)
mat1.add_nuclide("Pu240", 1.746300e-05)
mat1.add_nuclide("Pu241", 4.667600e-06)
mat1.add_nuclide("Pu242", 1.037700e-06)
mat1.add_nuclide("Am241", 1.046100e-06)
mat1.add_nuclide("H1", 6.159600e-02)
mat1.add_nuclide("O16", 3.654500e-02)
mat1.add_element("N", 2.211700e-03)
mat1.add_element("Fe", 1.401800e-05)
mat1.add_element("Cr", 3.889100e-06)
mat1.add_element("Ni", 2.877600e-06)
mat1.add_element("Mn", 3.438100e-07)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=52.58)
# SST tank, inner
...
# Hafnium plate
surf51 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -8.25, -8.0408, 2.4179999999999993, 52.418)
# Hafnium plate
surf52 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 8.359200000000001, 8.5684, 2.4179999999999993, 52.418)
...
source.space = openmc.stats.Point((0.0, 0.1592, 26.29))
