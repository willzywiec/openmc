"""
PU-SOL-THERM-032-8: H/X=936 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 3.782000e-08)
mat1.add_nuclide("Pu239", 6.675100e-05)
mat1.add_nuclide("Pu240", 7.470900e-06)
mat1.add_nuclide("Pu241", 9.561100e-07)
mat1.add_nuclide("Pu242", 6.694900e-08)
mat1.add_nuclide("H1", 6.338600e-02)
mat1.add_nuclide("O16", 3.550800e-02)
mat1.add_element("N", 1.465300e-03)
mat1.add_element("Fe", 6.469900e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=48.08)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 24.04))
