"""
PU-SOL-THERM-015 (Case 9) Three cylinders with 30 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=37.30)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=34.641, y0=0.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=-17.3205, y0=30.0, r=15.0)
# Table 1 and Figure 7
surf13 = openmc.ZCylinder(surface_id=13, x0=-17.3205, y0=-30.0, r=15.0)
...
source.space = openmc.stats.Box((-18.0, -31.0, 17.65), (35.0, 31.0, 19.65))
