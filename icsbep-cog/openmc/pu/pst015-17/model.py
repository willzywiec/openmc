"""
PU-SOL-THERM-015 (Case 17) Four cylinders with 30 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=36.25)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=-30.0, y0=30.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=30.0, y0=30.0, r=15.0)
# Array dimensions per
surf13 = openmc.ZCylinder(surface_id=13, x0=-30.0, y0=-30.0, r=15.0)
# Table 1 and Figure 7
surf14 = openmc.ZCylinder(surface_id=14, x0=30.0, y0=-30.0, r=15.0)

# Z-plane surfaces for bounded cylinders
surf2_zmin = openmc.ZPlane(surface_id=1014, z0=0.0)
surf2_zmax = openmc.ZPlane(surface_id=1015, z0=101.171)
surf3_zmin = openmc.ZPlane(surface_id=1016, z0=-1.329)
surf3_zmax = openmc.ZPlane(surface_id=1017, z0=102.371)
...
source.space = openmc.stats.Box((-31.0, -31.0, 17.1), (31.0, 31.0, 19.1))
