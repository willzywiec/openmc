"""
PU-SOL-THERM-015 (Case 1) Two cylinders with 0 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=31.07)
...
source.space = openmc.stats.Box((-1.0, -16.0, 14.5), (1.0, 16.0, 16.5))
