"""
PU-SOL-THERM-031-15: H/X=1018 with no Hafnium
...
mat1.add_nuclide("U238", 7.589300e-08)
mat1.add_nuclide("Pu239", 5.663700e-05)
mat1.add_nuclide("Pu240", 1.419800e-05)
mat1.add_nuclide("Pu241", 3.794300e-06)
mat1.add_nuclide("Pu242", 8.436700e-07)
mat1.add_nuclide("Am241", 8.505100e-07)
mat1.add_nuclide("H1", 6.152200e-02)
mat1.add_nuclide("O16", 3.634600e-02)
mat1.add_element("N", 2.163600e-03)
mat1.add_element("Fe", 1.046000e-05)
mat1.add_element("Cr", 3.161800e-06)
mat1.add_element("Ni", 2.339500e-06)
mat1.add_element("Mn", 2.795200e-07)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=33.46)
# SST tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 16.73))
