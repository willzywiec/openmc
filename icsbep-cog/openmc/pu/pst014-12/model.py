"""
PU-SOL-THERM-014 (Case 12) Three cylinders with 120 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=40.03)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-150.0, r=15.0)
...
source.space = openmc.stats.Point((0.0, 0.0, 20.0))
