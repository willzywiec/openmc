"""
PMF037-8: Flooded 2x2x2 array of double-canned 3kg Pu parts in water; Hw=34.3; dx=dy=10.029; dz=12.595
...
# Water height
surf6 = openmc.ZPlane(surface_id=6, z0=34.3)
# Inner tank
...
# Upper bottom tray
surf41 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 22.675, 23.31)
# Upper middle tray
surf42 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 26.37, 27.005)
# Upper upper  tray
surf43 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 30.295, 30.93)
...
source.space = openmc.stats.Box((-6.0145, -6.0145, 13.0285), (6.0145, 6.0145, 27.6235))
