"""
PU-SOL-THERM-010 (Case 9-2) 1.074 kg Pu(97.15) @ H/X = 357 in a water reflected 9" diameter SS-347 cylinder
...
mat1.add_nuclide("Pu239", 1.809100e-04)
mat1.add_nuclide("Pu240", 5.285000e-06)
mat1.add_element("N", 1.219900e-03)
mat1.add_nuclide("H1", 6.456600e-02)
mat1.add_nuclide("O16", 3.570500e-02)
mat1.add_element("Fe", 2.490900e-06)
...
mat3.add_nuclide("H1", 6.661800e-02)
mat3.add_nuclide("O16", 3.330900e-02)
...
surf3 = openmc.ZCylinder(surface_id=3, r=11.1419)
# Piston/Outer; Z1 = Hc; Z2 = Z1 + 30.7950
surf4 = openmc.ZCylinder(surface_id=4, r=11.2994)
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=35.4076)
# Cylinder/Inner
surf6 = openmc.ZCylinder(surface_id=6, r=11.4264)
# Cylinder/Outer
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=35.5651)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=66.0451)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=35.4076)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=66.2026)
...
source.space = openmc.stats.Point((0.0, 0.0, 17.7))
