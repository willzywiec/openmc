"""
PU-SOL-THERM-033-39: 275.43 gPu(3.13)/L at H/X=82.3 with 7 (4x40) pyrex tubes at 4.31cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=23.88)
...
surf20_zmin = openmc.ZPlane(surface_id=1053, z0=39.3)
surf20_zmax = openmc.ZPlane(surface_id=1054, z0=39.5)
surf21_zmin = openmc.ZPlane(surface_id=1055, z0=2.5)
surf21_zmax = openmc.ZPlane(surface_id=1056, z0=2.556)
surf22_zmin = openmc.ZPlane(surface_id=1057, z0=39.444)
surf22_zmax = openmc.ZPlane(surface_id=1058, z0=39.5)
surf24_zmin = openmc.ZPlane(surface_id=1059, z0=1.5)
surf24_zmax = openmc.ZPlane(surface_id=1060, z0=41.5)
...
source.space = openmc.stats.Box((-3.155, -3.488, 10.94), (3.155, 3.488, 12.94))
