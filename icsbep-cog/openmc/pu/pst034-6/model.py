"""
PU-SOL-THERM-034-6: 27.271 kg Pu(8.3) @ H/X=228 with 2.38 gGd/L
...
mat1.add_element("Gd", 9.114400e-06)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=80.37)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 40.185))
