"""
PU-SOL-THERM-033-22: 275.43 gPu(3.13)/L at H/X=82.3 with 37 (3x40) pyrex tubes at 3.23cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=43.01)
...
surf22 = openmc.ZCylinder(surface_id=22, x0=39.435, y0=39.5, r=17.5)
# 3x40 pyrex tube, inner
surf23 = openmc.ZCylinder(surface_id=23, r=1.3)
# 3x40 pyrex tube, outer
surf24 = openmc.ZCylinder(surface_id=24, x0=1.5, y0=41.5, r=1.5)
# Unit cell #1
...
u3_cell0.region = -surf1 & -surf23 & -surf24 & (-surf119_0 & -surf119_1 & -surf119_2 & -surf119_3 & -surf119_4 & -surf119_5)
u3_cell1 = openmc.Cell(fill=mat6)
u3_cell1.region = +surf23 & -surf24 & (-surf119_0 & -surf119_1 & -surf119_2 & -surf119_3 & -surf119_4 & -surf119_5)
u3_cell2 = openmc.Cell(fill=mat1)
u3_cell2.region = -surf1 & +surf24 & +surf19 & +surf20 & (-surf119_0 & -surf119_1 & -surf119_2 & -surf119_3 & -surf119_4 & -surf119_5)
u3_cell3 = openmc.Cell(fill=mat5)
u3_cell3.region = +surf24 & -surf19 & (-surf119_0 & -surf119_1 & -surf119_2 & -surf119_3 & -surf119_4 & -surf119_5)
u3_cell4 = openmc.Cell(fill=mat5)
u3_cell4.region = +surf24 & -surf20 & (-surf119_0 & -surf119_1 & -surf119_2 & -surf119_3 & -surf119_4 & -surf119_5)
...
source.space = openmc.stats.Box((-2.6100000000000003, -2.8600000000000003, 20.505), (2.6100000000000003, 2.8600000000000003, 22.505))
