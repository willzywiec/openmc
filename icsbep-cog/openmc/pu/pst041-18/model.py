"""
PU-SOL-THERM-041-18: Experiment 324 with 23.5 gPu(3)/L at H/X=1048; Hc=59.78
...
mat1.add_nuclide("Pu239", 5.735910e-05)
mat1.add_nuclide("Pu240", 1.768600e-06)
mat1.add_nuclide("Pu241", 6.457870e-08)
mat1.add_element("N", 2.724640e-03)
mat1.add_nuclide("O16", 3.702560e-02)
mat1.add_nuclide("H1", 6.018460e-02)
mat1.add_element("Fe", 2.253690e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=59.78)
...
source.space = openmc.stats.Box((-18.5, -18.5, 29.64), (18.5, 18.5, 31.64))
