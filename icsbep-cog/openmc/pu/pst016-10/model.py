"""
PU-SOL-THERM-016 (Case 10) 300 cylinders with 115.1 gPu/L and 256 mm cylinder with 2N acid at 10 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=41.)
...
surf4 = openmc.ZPlane(surface_id=4, z0=40.044)
# 300-mm Tank/Inner per Figure 5
surf5 = openmc.ZCylinder(surface_id=5, x0=37.79, y0=0.0, r=14.7)
# 300-mm Tank/Outer per Figure 5
surf6 = openmc.ZCylinder(surface_id=6, x0=37.79, y0=0.0, r=15.0)
...
source.space = openmc.stats.Point((37.79, 0.0, 20.0))
