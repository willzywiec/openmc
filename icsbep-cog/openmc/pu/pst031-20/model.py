"""
PU-SOL-THERM-031-20: H/X=1547 with no Hafnium
...
mat1.add_nuclide("U238", 5.337800e-08)
mat1.add_nuclide("Pu239", 3.983600e-05)
mat1.add_nuclide("Pu240", 9.986300e-06)
mat1.add_nuclide("Pu241", 2.667000e-06)
mat1.add_nuclide("Pu242", 5.933700e-07)
mat1.add_nuclide("Am241", 6.003200e-07)
mat1.add_nuclide("H1", 6.164200e-02)
mat1.add_nuclide("O16", 3.613800e-02)
mat1.add_element("N", 2.077500e-03)
mat1.add_element("Fe", 7.332600e-06)
mat1.add_element("Cr", 2.223800e-06)
mat1.add_element("Ni", 1.645400e-06)
mat1.add_element("Mn", 1.966000e-07)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=55.03)
# SST tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 27.515))
