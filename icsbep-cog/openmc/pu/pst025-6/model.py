"""
PU-SOL-THERM-025 (Case 6) 2.852 kg Pu(95.3) at H/X = 445 with H/SQRT(A) = 0.247; 4.67 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=28.804)
# Sol'n Tank/Inner: Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-53.34, 53.34, -5.2909999999999995, 10.710999999999999, 0.0, 106.68)
# Sol'n Tank/Outer: Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -5.45, 10.870000000000001, -0.3159999999999954, 106.99600000000001)
# Egg Crate /Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -16.88, 22.3, -0.3159999999999954, 106.99600000000001)
...
source.space = openmc.stats.Point((0.0, 2.71, 14.4))
