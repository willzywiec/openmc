"""
PU-SOL-THERM-022 (Case 12) Hc = 51.46 @ H/X=289; 18.88 wt-% Pu-240; Paraffin + Cd
...
mat1.add_nuclide("Pu239", 1.963300e-04)
mat1.add_nuclide("Pu240", 4.974800e-05)
mat1.add_nuclide("Pu241", 1.507600e-05)
mat1.add_nuclide("Pu242", 2.979000e-06)
mat1.add_nuclide("Am241", 1.259100e-06)
mat1.add_element("N", 2.486300e-03)
mat1.add_nuclide("O16", 3.732600e-02)
mat1.add_nuclide("H1", 6.104000e-02)
mat1.add_element("Fe", 2.698500e-05)
mat1.add_element("Cr", 8.669000e-06)
mat1.add_element("Ni", 6.144200e-06)
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=51.46)
