"""
PU-SOL-THERM-034-10: 34.870 kg Pu(8.3) @ H/X=58.5 with 8.21 gGd/L
...
mat1.add_element("Gd", 3.144100e-05)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=32.84)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 16.42))
