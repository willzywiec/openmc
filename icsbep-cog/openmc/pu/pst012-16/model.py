"""
PU-SOL-THERM-012 (Case 16) Hc = 24.76 @ H/X=1164; 18.91 wt-% Pu-240; no close water reflection
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=24.76)
# Lucoflex/Inner
...
source.space = openmc.stats.Point((0.0, 0.0, 12.4))
