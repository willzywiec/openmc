...
surf19 = openmc.ZCylinder(surface_id=19, x0=2.5, y0=2.574, r=17.5)
# Upper polyethylene grid plate, entire grid
surf20 = openmc.ZCylinder(surface_id=20, x0=39.426, y0=39.5, r=17.5)
...
# Pyrex tube #4
surf104 = openmc.ZCylinder(surface_id=104, x0=1.5, y0=41.5, r=2.00695)
# Pyrex tube #5
...
u4_cell1.region = -surf10 & -surf19 & +surf16 & +surf17 & +surf18 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107
u4_cell2 = openmc.Cell(fill=mat5)
u4_cell2.region = -surf10 & -surf20 & +surf16 & +surf17 & +surf18 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107
u4_cell3 = openmc.Cell(fill=mat2)
u4_cell3.region = -surf10 & +surf12 & -surf13 & +surf16 & +surf17 & +surf18
u4_cell4 = openmc.Cell(fill=mat1)
u4_cell4.region = -surf10 & +surf11 & +surf16 & +surf17 & +surf18 & +surf19 & +surf20 & -surf1 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107
