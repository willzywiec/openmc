...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=32.6390)
# Cylinder/Inner
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=32.7965)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=63.2765)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=32.639)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=63.434)
