"""
PU-SOL-THERM-026 (Case 8) 6.873 kg Pu(81.6) at H/X = 457 with H/SQRT(A) = 0.334; 18.4 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=42.857)
# Tank/Inner: Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -171.5))
