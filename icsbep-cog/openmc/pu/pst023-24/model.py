...
mat1.add_nuclide("Pu238", 2.031100e-08)
mat1.add_nuclide("Pu239", 2.996300e-04)
mat1.add_nuclide("Pu240", 1.322000e-05)
mat1.add_nuclide("Pu241", 8.968000e-07)
mat1.add_nuclide("Pu242", 4.959900e-08)
mat1.add_nuclide("Am241", 1.978400e-07)
mat1.add_element("N", 3.505900e-03)
mat1.add_nuclide("H1", 5.775800e-02)
mat1.add_nuclide("O16", 3.828000e-02)
mat1.add_element("Fe", 3.882000e-06)
mat1.add_element("Cr", 1.042400e-06)
mat1.add_element("Ni", 5.130400e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=19.99)
