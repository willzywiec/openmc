"""
PU-SOL-THERM-021 (Case 2) 1.036 kg Pu(95.4) @ H/X = 795 in a bare 15.2" SS304L sphere
...
mat1.add_nuclide("Pu238", 5.206300e-09)
mat1.add_nuclide("Pu239", 8.211400e-05)
mat1.add_nuclide("Pu240", 4.017500e-06)
mat1.add_nuclide("Pu241", 2.425000e-07)
mat1.add_nuclide("Pu242", 7.680000e-09)
mat1.add_element("N", 6.406200e-04)
mat1.add_nuclide("H1", 6.549600e-02)
mat1.add_nuclide("O16", 3.452200e-02)
...
# = Hc per Table 5a
surf1 = openmc.ZPlane(surface_id=1, z0=19.3163)
# SST/Inner
surf2 = openmc.Sphere(surface_id=2, r=19.3163)
# SST/Outer
surf3 = openmc.Sphere(surface_id=3, r=20.0986)
# Model/Outer
surf4 = openmc.Sphere(surface_id=4, r=50.0986)
# Support Tube/Inner
