"""
PU-MET-FAST-045: LAMPRE Assembly VI (Simplified Model)
...
surf3_zmax = openmc.ZPlane(z0=9.526)
surf4_zmin = openmc.ZPlane(z0=-0.2032)
surf4_zmax = openmc.ZPlane(z0=9.7292)
surf5_zmin = openmc.ZPlane(z0=-1.9558)
surf5_zmax = openmc.ZPlane(z0=11.4818)
surf6_zmin = openmc.ZPlane(z0=-1.9558)
surf6_zmax = openmc.ZPlane(z0=11.4818)
surf7_zmin = openmc.ZPlane(z0=-9.5758)
surf7_zmax = openmc.ZPlane(z0=31.8018)
...
source.space = openmc.stats.Point((0.0, 0.0, 4.86))
