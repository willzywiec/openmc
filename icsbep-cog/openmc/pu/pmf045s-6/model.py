...
surf3_zmax = openmc.ZPlane(surface_id=1013, z0=9.526)
surf4_zmin = openmc.ZPlane(surface_id=1014, z0=-0.2032)
surf4_zmax = openmc.ZPlane(surface_id=1015, z0=9.7292)
surf5_zmin = openmc.ZPlane(surface_id=1016, z0=-1.9558)
surf5_zmax = openmc.ZPlane(surface_id=1017, z0=11.4818)
surf6_zmin = openmc.ZPlane(surface_id=1018, z0=-1.9558)
surf6_zmax = openmc.ZPlane(surface_id=1019, z0=11.4818)
surf7_zmin = openmc.ZPlane(surface_id=1020, z0=-9.5758)
surf7_zmax = openmc.ZPlane(surface_id=1021, z0=31.8018)
