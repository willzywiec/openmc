"""
PU-SOL-THERM-026 (Case 6) 9.232 kg Pu(81.6) at H/X = 457 with H/SQRT(A) = 0.241; 18.4 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=64.851)
# Tank/Inner: Width = Tc
...
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 127.248, 170.49200000000002, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -160.5))
