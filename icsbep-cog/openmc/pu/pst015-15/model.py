"""
PU-SOL-THERM-015 (Case 15) Four cylinders with 0 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=22.96)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=-15.0, y0=15.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=15.0, y0=15.0, r=15.0)
# Array dimensions per
surf13 = openmc.ZCylinder(surface_id=13, x0=-15.0, y0=-15.0, r=15.0)
# Table 1 and Figure 7
surf14 = openmc.ZCylinder(surface_id=14, x0=15.0, y0=-15.0, r=15.0)
...
source.space = openmc.stats.Box((-16.0, -16.0, 10.5), (16.0, 16.0, 12.5))
