...
surf31_zmin = openmc.ZPlane(z0=0.33092)
surf31_zmax = openmc.ZPlane(z0=0.635)
surf32_zmin = openmc.ZPlane(z0=0.635)
surf32_zmax = openmc.ZPlane(z0=0.656)
surf33_zmin = openmc.ZPlane(z0=0.656)
surf33_zmax = openmc.ZPlane(z0=5.289)
surf34_zmin = openmc.ZPlane(z0=0.656)
surf34_zmax = openmc.ZPlane(z0=5.289)
surf35_zmin = openmc.ZPlane(z0=5.289)
surf35_zmax = openmc.ZPlane(z0=5.376)
surf36_zmin = openmc.ZPlane(z0=5.376)
surf36_zmax = openmc.ZPlane(z0=5.855)
surf50_zmin = openmc.ZPlane(z0=0.0)
surf50_zmax = openmc.ZPlane(z0=208.417)
surf61_zmin = openmc.ZPlane(z0=25.083)
surf61_zmax = openmc.ZPlane(z0=99.3568)
surf62_zmin = openmc.ZPlane(z0=99.3568)
surf62_zmax = openmc.ZPlane(z0=100.6275)
surf63_zmin = openmc.ZPlane(z0=100.6275)
surf63_zmax = openmc.ZPlane(z0=106.4825)
surf64_zmin = openmc.ZPlane(z0=106.4825)
surf64_zmax = openmc.ZPlane(z0=107.7532)
surf65_zmin = openmc.ZPlane(z0=107.7532)
surf65_zmax = openmc.ZPlane(z0=108.9868)
surf66_zmin = openmc.ZPlane(z0=108.9868)
surf66_zmax = openmc.ZPlane(z0=110.2575)
surf67_zmin = openmc.ZPlane(z0=110.2575)
surf67_zmax = openmc.ZPlane(z0=116.1125)
surf68_zmin = openmc.ZPlane(z0=116.1125)
surf68_zmax = openmc.ZPlane(z0=117.3832)
surf69_zmin = openmc.ZPlane(z0=117.3832)
surf69_zmax = openmc.ZPlane(z0=118.6168)
surf70_zmin = openmc.ZPlane(z0=118.6168)
surf70_zmax = openmc.ZPlane(z0=119.8875)
surf71_zmin = openmc.ZPlane(z0=119.8875)
surf71_zmax = openmc.ZPlane(z0=125.7425)
surf72_zmin = openmc.ZPlane(z0=125.7425)
surf72_zmax = openmc.ZPlane(z0=127.0132)
surf73_zmin = openmc.ZPlane(z0=127.0132)
surf73_zmax = openmc.ZPlane(z0=128.2468)
surf74_zmin = openmc.ZPlane(z0=128.2468)
surf74_zmax = openmc.ZPlane(z0=129.5175)
surf75_zmin = openmc.ZPlane(z0=129.5175)
surf75_zmax = openmc.ZPlane(z0=135.3725)
surf76_zmin = openmc.ZPlane(z0=135.3725)
surf76_zmax = openmc.ZPlane(z0=136.6432)
surf81_zmin = openmc.ZPlane(z0=99.3568)
surf81_zmax = openmc.ZPlane(z0=107.7532)
surf82_zmin = openmc.ZPlane(z0=108.9868)
surf82_zmax = openmc.ZPlane(z0=117.3832)
surf83_zmin = openmc.ZPlane(z0=118.6168)
surf83_zmax = openmc.ZPlane(z0=127.0132)
surf84_zmin = openmc.ZPlane(z0=128.2468)
surf84_zmax = openmc.ZPlane(z0=136.6432)
