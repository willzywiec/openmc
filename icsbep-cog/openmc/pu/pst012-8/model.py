"""
PU-SOL-THERM-012 (Case 8) Hc = 17.63 @ H/X=588; 18.91 wt-% Pu-240; 5 sides water reflection
...
mat1.add_nuclide("Pu239", 9.866550e-05)
mat1.add_nuclide("Pu240", 2.500040e-05)
mat1.add_nuclide("Pu241", 7.410890e-06)
mat1.add_nuclide("Pu242", 1.497020e-06)
mat1.add_nuclide("Am241", 8.030990e-07)
mat1.add_element("N", 1.784970e-03)
mat1.add_nuclide("O16", 3.595460e-02)
mat1.add_nuclide("H1", 6.240150e-02)
mat1.add_element("Fe", 1.218500e-05)
mat1.add_element("Cr", 3.918410e-06)
mat1.add_element("Ni", 2.777190e-06)
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=17.63)
# Lucoflex/Inner
...
source.space = openmc.stats.Point((0.0, 0.0, 8.8))
