"""
PU-SOL-THERM-030-7: Exp. No. 502 with H/X=865 with WATER in the central cavity
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=39.99)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 19.995))
