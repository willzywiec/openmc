"""
PU-SOL-THERM-008 (Case 20) 0.687 kg Pu(95.43) @ H/X = 899 in l4" SS304L sphere with l0" concrete
...
mat1.add_nuclide("Pu238", 4.553600e-09)
mat1.add_nuclide("Pu239", 7.179500e-05)
mat1.add_nuclide("Pu240", 3.512400e-06)
mat1.add_nuclide("Pu241", 2.390800e-07)
mat1.add_nuclide("Pu242", 6.717200e-09)
mat1.add_element("N", 9.465600e-04)
mat1.add_nuclide("H1", 6.472300e-02)
mat1.add_nuclide("O16", 3.487900e-02)
