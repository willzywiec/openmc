"""
PU-SOL-THERM-034-2: 6.841 kg Pu(8.3) @ H/X=228 with 0.48 gGd/L
...
mat1.add_element("Gd", 1.838200e-06)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=20.16)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 10.08))
