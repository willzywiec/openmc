"""
PU-COMP-MIXED-002 (Case 26) 16.817 kg Pu @ H/X = 61.9 with 18.50 wt-% Pu-240 and H/SQRT(A) = 0.408
...
surf1 = openmc.model.RectangularParallelepiped(-25.45, 25.45, -22.905, 22.905, -9.845, 9.845)
# 6" (15.24 cm) Plexiglas Reflector
surf2 = openmc.model.RectangularParallelepiped(-40.69, 40.69, -38.145, 38.145, -25.085, 25.085, boundary_type="vacuum")
