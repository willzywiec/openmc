"""
PU-SOL-THERM-014 (Case 17) Three cylinders with 120 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=39.77)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=86.6025, y0=0.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=-43.30125, y0=75.0, r=15.0)
# Table 1 and Figure 7
surf13 = openmc.ZCylinder(surface_id=13, x0=-43.30125, y0=-75.0, r=15.0)

# Z-plane surfaces for bounded cylinders
surf2_zmin = openmc.ZPlane(surface_id=1013, z0=0.0)
surf2_zmax = openmc.ZPlane(surface_id=1014, z0=101.171)
surf3_zmin = openmc.ZPlane(surface_id=1015, z0=-1.329)
surf3_zmax = openmc.ZPlane(surface_id=1016, z0=102.371)
...
source.space = openmc.stats.Box((-44.0, -76.0, 19.0), (87.0, 76.0, 21.0))
