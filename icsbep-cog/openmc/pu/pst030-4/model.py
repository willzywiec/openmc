"""
PU-SOL-THERM-030-4: Exp. No. 489 with H/X=491 with WATER in the central cavity
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=27.60)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 13.8))
