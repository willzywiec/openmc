"""
PU-SOL-THERM-012 (Case 23) Hc = 70.00 @ H/X=2394; 18.91 wt-% Pu-240; no close water reflection
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=70.00)
# Lucoflex/Inner
...
source.space = openmc.stats.Point((0.0, 0.0, 35.0))
