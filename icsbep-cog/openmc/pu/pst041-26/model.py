"""
PU-SOL-THERM-041-26: Experiment 380 with 66.22 gPu(3.11)/L at H/X=340; Hc=24.75
...
surf7 = openmc.ZPlane(surface_id=7, z0=24.75)
...
source.space = openmc.stats.Box((-18.5, -18.5, 12.125), (18.5, 18.5, 14.125))
