"""
PU-SOL-THERM-013 (Case 8) Three cylinders with 5 cm surface-to-surface in a right-angle
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=48.75)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=30.588, y0=0.0, r=12.794)
...
surf2_zmax = openmc.ZPlane(surface_id=1013, z0=101.145)
surf3_zmin = openmc.ZPlane(surface_id=1014, z0=-1.355)
surf3_zmax = openmc.ZPlane(surface_id=1015, z0=102.345)
...
source.space = openmc.stats.Box((-1.0, -31.588, 23.375), (31.558, 1.0, 25.375))
