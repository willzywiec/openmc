"""
PU-SOL-THERM-025 (Case 5) 3.052 kg Pu(95.3) at H/X = 445 with H/SQRT(A) = 0.247; 4.67 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=33.477)
...
source.space = openmc.stats.Point((0.0, 2.71, 16.7))
