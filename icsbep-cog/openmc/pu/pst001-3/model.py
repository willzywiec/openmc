"""
PU-SOL-THERM-001 (Case 3) 1.524 kg Pu(95.3) @ H/X = 215 in a water reflected 1l.5" SS304L sphere
...
mat1.add_nuclide("Pu238", 1.806300e-08)
mat1.add_nuclide("Pu239", 2.848200e-04)
mat1.add_nuclide("Pu240", 1.393500e-05)
mat1.add_nuclide("Pu241", 9.067200e-07)
mat1.add_nuclide("Pu242", 2.664500e-08)
mat1.add_element("N", 2.402800e-03)
mat1.add_nuclide("H1", 6.148100e-02)
mat1.add_nuclide("O16", 3.734700e-02)
...
# = Hc per Table 5
surf1 = openmc.ZPlane(surface_id=1, z0=12.9091)
