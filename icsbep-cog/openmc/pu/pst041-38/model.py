"""
PU-SOL-THERM-041-38: Experiment 508 with 189.05 gPu(3.11)/L at H/X=127; Hc=22.80
...
surf7 = openmc.ZPlane(surface_id=7, z0=22.80)
...
source.space = openmc.stats.Box((-18.5, -18.5, 11.15), (18.5, 18.5, 13.15))
