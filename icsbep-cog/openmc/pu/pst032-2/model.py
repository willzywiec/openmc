"""
PU-SOL-THERM-032-2: H/X=481 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 7.254100e-08)
mat1.add_nuclide("Pu239", 1.280300e-04)
mat1.add_nuclide("Pu240", 1.443000e-05)
mat1.add_nuclide("Pu241", 1.833900e-06)
mat1.add_nuclide("Pu242", 1.284100e-07)
mat1.add_nuclide("H1", 6.249800e-02)
mat1.add_nuclide("O16", 3.600100e-02)
mat1.add_element("N", 1.784700e-03)
mat1.add_element("Fe", 8.906900e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=29.5)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 16.15))
