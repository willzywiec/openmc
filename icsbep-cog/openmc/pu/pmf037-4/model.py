"""
PMF037-4: Flooded 2x2x2 array of double-canned 3kg Pu parts in water; Hw=46.3; dx=dy=7.62; dz=23.495
...
# Water height
surf6 = openmc.ZPlane(surface_id=6, z0=46.3)
# Inner tank
...
# Square hole
surf30 = openmc.model.RectangularParallelepiped(-7.62, 7.62, -7.62, 7.62, -4999.995, 4999.995)
# Lower bottom tray
...
# Upper bottom tray
surf41 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 33.574999999999996, 34.21)
# Upper middle tray
surf42 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 37.269999999999996, 37.905)
# Upper upper  tray
surf43 = openmc.model.RectangularParallelepiped(-22.85, 22.85, -22.85, 22.85, 41.195, 41.830000000000005)
...
cell16.region = -surf6 & +surf21 & +surf22 & +surf23 & +surf24 & -surf30 & -surf42

# Water
cell17 = openmc.Cell(cell_id=17, fill=mat6)
cell17.region = -surf6 & (-surf7 & +surf7_zmin & -surf7_zmax) & (-surf8 & +surf8_zmin & -surf8_zmax) & +surf11 & +surf12 & +surf13 & +surf14 & +surf31 & +surf32 & +surf33

# Tank
cell18 = openmc.Cell(cell_id=18, fill=mat5)
cell18.region = (+surf7 | -surf7_zmin | +surf7_zmax) & (-surf8 & +surf8_zmin & -surf8_zmax)

# SS304L
cell24 = openmc.Cell(cell_id=24, fill=mat4)
cell24.region = (+surf2 | -surf2_zmin | +surf2_zmax) & (+surf4 | -surf4_zmin | +surf4_zmax) & (-surf5 & +surf5_zmin & -surf5_zmax)

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell15, cell16, cell17, cell18, cell24])
...
source.space = openmc.stats.Box((-4.8100000000000005, -4.8100000000000005, 13.0285), (4.8100000000000005, 4.8100000000000005, 38.5235))
