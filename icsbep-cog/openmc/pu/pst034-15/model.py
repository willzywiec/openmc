"""
PU-SOL-THERM-034-15: 63.030 kg Pu(8.3) @ H/X=58.5 with 20.25 gGd/L
...
mat1.add_element("Gd", 7.754900e-05)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=59.36)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 29.68))
