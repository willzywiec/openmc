"""
PU-SOL-THERM-034-13: 49.651 kg Pu(8.3) @ H/X=58.5 with 15.55 gGd/L
...
mat1.add_element("Gd", 5.955000e-05)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=46.76)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 23.38))
