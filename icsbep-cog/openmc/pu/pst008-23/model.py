"""
PU-SOL-THERM-008 (Case 23) 1.023 kg Pu(95.43) @ H/X = 521 in 14" SS304L sphere with l0" concrete
...
mat1.add_nuclide("Pu238", 6.800000e-09)
mat1.add_nuclide("Pu239", 1.072300e-04)
mat1.add_nuclide("Pu240", 5.246200e-06)
mat1.add_nuclide("Pu241", 3.435900e-07)
mat1.add_nuclide("Pu242", 1.003100e-08)
mat1.add_element("N", 4.341600e-03)
mat1.add_nuclide("H1", 5.608300e-02)
mat1.add_nuclide("O16", 3.912100e-02)
