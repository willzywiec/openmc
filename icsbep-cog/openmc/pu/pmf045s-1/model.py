...
cell5.region = +surf5 & +surf6 & -surf7 & +surf13 & -surf14

# Al
cell6 = openmc.Cell(cell_id=6, fill=mat4)
cell6.region = +surf5 & +surf6 & -surf7 & +surf12 & -surf13

# CH2
cell7 = openmc.Cell(cell_id=7, fill=mat7)
cell7.region = +surf5 & +surf6 & -surf7 & +surf11 & -surf12
...
cell9.region = -surf8 & -surf10 & +surf14

# Fe
cell10 = openmc.Cell(cell_id=10, fill=mat5)
cell10.region = +surf8 & -surf9 & -surf10

# H2O
cell11 = openmc.Cell(cell_id=11, fill=mat6)
cell11.region = +surf9 & -surf10
