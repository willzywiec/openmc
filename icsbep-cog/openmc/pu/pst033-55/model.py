"""
PU-SOL-THERM-033-55: 355.6 gPu(3.13)/L at H/X=60.5 with 55 (4x14.78) pyrex tubes at 4.31cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=32.95)
...
source.space = openmc.stats.Point((0.0, 0.0, 16.475))
