"""
PU-SOL-THERM-021 (Case 6) 1.171 kg Pu(95.4) @ H/X = 579 in a water reflected 15.2" SS304L sphere
...
mat1.add_nuclide("Pu238", 5.874100e-09)
mat1.add_nuclide("Pu239", 9.264800e-05)
mat1.add_nuclide("Pu240", 4.532900e-06)
mat1.add_nuclide("Pu241", 2.736100e-07)
mat1.add_nuclide("Pu242", 8.665200e-09)
mat1.add_element("N", 5.026900e-03)
mat1.add_nuclide("H1", 5.384000e-02)
mat1.add_nuclide("O16", 3.968200e-02)
...
# = Hc per Table 5a
surf1 = openmc.ZPlane(surface_id=1, z0=19.3208)
# SST/Inner
surf2 = openmc.Sphere(surface_id=2, r=19.3208)
# SST/Outer
surf3 = openmc.Sphere(surface_id=3, r=19.4427)
# H2O/Outer
surf4 = openmc.Sphere(surface_id=4, r=49.4427)
# Support Tube/Inner
