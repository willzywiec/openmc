"""
PU-SOL-THERM-033-13: 178.5 gPu(4.23)/L at H/X=136.3 with no poisons
...
surf1 = openmc.ZPlane(surface_id=1, z0=19.13)
...
source.space = openmc.stats.Point((0.0, 0.0, 9.565))
