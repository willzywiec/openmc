"""
PU-SOL-THERM-016 (Case 4) 300 and 256 mm cylinders with 152.5 gPu/L at 60 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=42.104)
...
surf4 = openmc.ZPlane(surface_id=4, z0=42.104)
...
source.space = openmc.stats.Box((-1.0, -1.0, 20.0), (88.79, 1.0, 22.0))
