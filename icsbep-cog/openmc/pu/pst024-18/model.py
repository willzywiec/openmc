"""
PU-SOL-THERM-024 (Case 18) 5.495 kg Pu(80.45) at H/X = 457 with H/SQRT(A) = 0.343; 18.4 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=36.3017)
# Tank/Inner:  Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -175.0))
