"""
PU-SOL-THERM-041-30: Experiment 445 with 40.15 gPu(3.11)/L at H/X=650; Hc=Hw=33.05
...
mat1.add_nuclide("Pu239", 9.787720e-05)
mat1.add_nuclide("Pu240", 3.132460e-06)
mat1.add_nuclide("Pu241", 1.203640e-07)
mat1.add_element("N", 1.379380e-03)
mat1.add_nuclide("O16", 3.551570e-02)
mat1.add_nuclide("H1", 6.371860e-02)
mat1.add_element("Fe", 3.774120e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=33.05)
...
source.space = openmc.stats.Box((-18.5, -18.5, 16.275), (18.5, 18.5, 18.275))
