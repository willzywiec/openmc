"""
PU-SOL-THERM-014 (Case 5) Two cylinders with 50 cm s-to-s
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-40.0, r=15.0)
...
source.space = openmc.stats.Box((-1.0, -41.0, 18.7), (1.0, 41.0, 20.7))
