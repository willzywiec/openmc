"""
PU-SOL-THERM-014 (Case 10) Three cylinders with 30 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=37.47)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-60.0, r=15.0)
...
source.space = openmc.stats.Point((0.0, 0.0, 18.7))
