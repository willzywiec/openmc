"""
PMF003-5: LLNL Pu Array - bare - 2x2x1 - 6kg - case 105
...
# Aluminum "middle" heat sinks
mat9 = openmc.Material(material_id=9)
mat9.set_density("sum")
mat9.add_element("Al", 2.951100e-02)
...
# 1st
surf41 = openmc.ZCylinder(surface_id=41, x0=3.795, y0=3.795, r=3.609)
# 2nd
surf42 = openmc.ZCylinder(surface_id=42, x0=-3.795, y0=3.795, r=3.609)
# 3rd
surf43 = openmc.ZCylinder(surface_id=43, x0=-3.795, y0=-3.795, r=3.609)
# 4th
surf44 = openmc.ZCylinder(surface_id=44, x0=3.795, y0=-3.795, r=3.609)

# Z-plane surfaces for bounded cylinders
surf4_zmin = openmc.ZPlane(z0=0.0)
surf4_zmax = openmc.ZPlane(z0=8.3)
surf6_zmin = openmc.ZPlane(z0=0.0)
surf6_zmax = openmc.ZPlane(z0=45.734)
...
u1_cell8 = openmc.Cell(fill=mat9)
u1_cell8.region = +surf16 & -surf17
u1_cell9 = openmc.Cell(fill=mat6)
u1_cell9.region = +surf17 & -surf22
u1_cell10 = openmc.Cell(fill=mat1)
u1_cell10.region = -surf14 & +surf22 & -surf23
u1_cell11 = openmc.Cell(fill=mat2)
u1_cell11.region = +surf14 & +surf22 & -surf23
u1_cell12 = openmc.Cell(fill=mat2)
u1_cell12.region = +surf23 & -surf24
u1_cell13 = openmc.Cell(fill=mat4)
u1_cell13.region = +surf24 & -surf25
universe1 = openmc.Universe(universe_id=1, cells=[u1_cell0, u1_cell1, u1_cell2, u1_cell3, u1_cell4, u1_cell5, u1_cell6, u1_cell7, u1_cell8, u1_cell9, u1_cell10, u1_cell11, u1_cell12, u1_cell13])
...
source.space = openmc.stats.Box((-4.795, -4.795, 16.5), (4.795, 4.795, 23.6))
