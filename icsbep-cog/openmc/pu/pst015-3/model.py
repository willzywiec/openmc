"""
PU-SOL-THERM-015 (Case 3) Two cylinders with 15 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=37.73)
...
source.space = openmc.stats.Box((-1.0, -23.5, 17.9), (1.0, 23.5, 19.9))
