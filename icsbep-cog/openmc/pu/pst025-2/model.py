"""
PU-SOL-THERM-025 (Case 2) 5.777 kg Pu(95.3) at H/X = 445 with H/SQRT(A) = 0.127; 4.67 wt-% Pu-240
...
mat1.add_nuclide("Pu238", 8.803600e-09)
mat1.add_nuclide("Pu239", 1.388900e-04)
mat1.add_nuclide("Pu240", 6.796400e-06)
mat1.add_nuclide("Pu241", 3.694800e-07)
mat1.add_nuclide("Pu242", 1.298700e-08)
mat1.add_nuclide("H1", 6.198600e-02)
mat1.add_element("N", 1.993500e-03)
mat1.add_nuclide("O16", 3.626900e-02)
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=79.908)
# Sol'n Tank/Inner: Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-53.34, 53.34, -3.1319999999999997, 8.552, 0.0, 106.68)
# Sol'n Tank/Outer: Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -3.2910000000000004, 8.711, -0.3159999999999954, 106.99600000000001)
# Egg Crate /Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -14.721, 20.141000000000002, -0.3159999999999954, 106.99600000000001)
...
source.space = openmc.stats.Point((0.0, 2.71, 40.0))
