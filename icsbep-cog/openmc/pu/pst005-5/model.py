"""
PU-SOL-THERM-005 (Case 5) 0.849 kg Pu(95.95) @ H/X = 694 in a water reflected 14" SS-347 sphere
...
mat1.add_nuclide("Pu239", 8.711300e-05)
mat1.add_nuclide("Pu240", 3.661700e-06)
mat1.add_element("N", 2.645600e-03)
mat1.add_nuclide("H1", 6.046300e-02)
mat1.add_nuclide("O16", 3.702700e-02)
mat1.add_element("Fe", 1.121500e-06)
