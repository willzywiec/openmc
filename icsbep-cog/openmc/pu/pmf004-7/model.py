"""
PMF004-7: LLNL Pu Array Phase II - bare - 4x4x1 - 6kg - case 213
...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -20.708499999999997, -12.0215, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-21.82, 21.82, -21.445, -11.284999999999998, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -9.7985, -1.1115000000000004, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-21.82, 21.82, -10.535, -0.375, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 1.1115000000000004, 9.7985, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-21.82, 21.82, 0.375, 10.535, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 12.0215, 20.708499999999997, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-21.82, 21.82, 11.284999999999998, 21.445, 216.35500000000002, 221.435)
# Hole
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-16.365, y0=-16.365, r=3.607)
surf102 = openmc.ZCylinder(surface_id=102, x0=-16.365, y0=-5.455, r=3.607)
surf103 = openmc.ZCylinder(surface_id=103, x0=-16.365, y0=5.455, r=3.607)
surf104 = openmc.ZCylinder(surface_id=104, x0=-16.365, y0=16.365, r=3.607)
surf105 = openmc.ZCylinder(surface_id=105, x0=-5.455, y0=-16.365, r=3.607)
surf106 = openmc.ZCylinder(surface_id=106, x0=-5.455, y0=-5.455, r=3.607)
surf107 = openmc.ZCylinder(surface_id=107, x0=-5.455, y0=5.455, r=3.607)
surf108 = openmc.ZCylinder(surface_id=108, x0=-5.455, y0=16.365, r=3.607)
surf109 = openmc.ZCylinder(surface_id=109, x0=5.455, y0=-16.365, r=3.607)
surf110 = openmc.ZCylinder(surface_id=110, x0=5.455, y0=-5.455, r=3.607)
surf111 = openmc.ZCylinder(surface_id=111, x0=5.455, y0=5.455, r=3.607)
surf112 = openmc.ZCylinder(surface_id=112, x0=5.455, y0=16.365, r=3.607)
surf113 = openmc.ZCylinder(surface_id=113, x0=16.365, y0=-16.365, r=3.607)
surf114 = openmc.ZCylinder(surface_id=114, x0=16.365, y0=-5.455, r=3.607)
surf115 = openmc.ZCylinder(surface_id=115, x0=16.365, y0=5.455, r=3.607)
surf116 = openmc.ZCylinder(surface_id=116, x0=16.365, y0=16.365, r=3.607)
...
surf61_zmax = openmc.ZPlane(z0=112.5242)
surf62_zmin = openmc.ZPlane(z0=112.5242)
surf62_zmax = openmc.ZPlane(z0=123.4758)
...
cell44.translation = (0.0, 0.0, 112.5242)
cell44.region = (+surf61 | -surf61_zmin | +surf61_zmax) & (-surf62 & +surf62_zmin & -surf62_zmax)

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell15, cell16, cell17, cell18, cell19, cell20, cell21, cell22, cell23, cell24, cell25, cell26, cell27, cell39, cell44])
...
source.space = openmc.stats.Box((-17.365, -17.365, 114.4967), (17.365, 17.365, 121.5933))
