"""
PU-SOL-THERM-041-16: Experiment 317 with 28.1 gPu(3)/L at H/X=876; Hc=45.70
...
mat1.add_nuclide("Pu239", 6.858680e-05)
mat1.add_nuclide("Pu240", 2.114790e-06)
mat1.add_nuclide("Pu241", 7.721960e-08)
mat1.add_element("N", 2.742490e-03)
mat1.add_nuclide("O16", 3.706460e-02)
mat1.add_nuclide("H1", 6.012520e-02)
mat1.add_element("Fe", 2.792850e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=45.70)
...
source.space = openmc.stats.Box((-18.5, -18.5, 22.6), (18.5, 18.5, 24.6))
