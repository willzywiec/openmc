"""
PU-SOL-THERM-013 (Case 11) Four cylinders with 0 cm surface-to-surface
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=26.71)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=-12.794, y0=12.794, r=12.794)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=12.794, y0=12.794, r=12.794)
surf13 = openmc.ZCylinder(surface_id=13, x0=-12.794, y0=-12.794, r=12.794)
surf14 = openmc.ZCylinder(surface_id=14, x0=12.794, y0=-12.794, r=12.794)

# Z-plane surfaces for bounded cylinders
surf2_zmin = openmc.ZPlane(surface_id=1014, z0=0.0)
surf2_zmax = openmc.ZPlane(surface_id=1015, z0=101.145)
surf3_zmin = openmc.ZPlane(surface_id=1016, z0=-1.355)
surf3_zmax = openmc.ZPlane(surface_id=1017, z0=102.345)
...
cell1.region = -surf4 & +surf11 & +surf12 & +surf13 & +surf14
...
source.space = openmc.stats.Box((-13.794, -13.794, 12.355), (13.794, 13.794, 14.355))
