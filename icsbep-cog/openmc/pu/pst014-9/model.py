"""
PU-SOL-THERM-014 (Case 9) Three cylinders with 15 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=35.19)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-45.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=45.0, r=15.0)
...
source.space = openmc.stats.Point((0.0, 0.0, 17.6))
