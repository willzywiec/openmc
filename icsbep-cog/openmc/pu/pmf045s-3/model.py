"""
PU-MET-FAST-045: LAMPRE Assembly III (Simplified Model)
...
mat1.add_nuclide("Pu239", 3.280000e-02)
mat1.add_element("Ni", 7.760000e-03)
...
# Fe
surf11 = openmc.ZCylinder(surface_id=11, r=12.3444)
# H2O
surf12 = openmc.ZCylinder(surface_id=12, r=48.26)

# Z-plane surfaces for bounded cylinders
surf3_zmin = openmc.ZPlane(z0=0.0)
surf3_zmax = openmc.ZPlane(z0=8.4948)
surf4_zmin = openmc.ZPlane(z0=-0.2032)
surf4_zmax = openmc.ZPlane(z0=8.698)
surf5_zmin = openmc.ZPlane(z0=-1.9558)
surf5_zmax = openmc.ZPlane(z0=10.4506)
surf6_zmin = openmc.ZPlane(z0=-1.9558)
surf6_zmax = openmc.ZPlane(z0=10.4506)
surf7_zmin = openmc.ZPlane(z0=-9.5758)
surf7_zmax = openmc.ZPlane(z0=30.7706)
surf8_zmin = openmc.ZPlane(z0=-11.557)
surf8_zmax = openmc.ZPlane(z0=-9.5758)
surf9_zmin = openmc.ZPlane(z0=-42.037)
surf9_zmax = openmc.ZPlane(z0=-11.557)
surf12_zmin = openmc.ZPlane(z0=-42.037, boundary_type="vacuum")
surf12_zmax = openmc.ZPlane(z0=43.7478, boundary_type="vacuum")
...
cell6.region = (+surf5 | -surf5_zmin | +surf5_zmax) & (+surf6 | -surf6_zmin | +surf6_zmax) & (+surf7 | -surf7_zmin | +surf7_zmax) & (-surf8 & +surf8_zmin & -surf8_zmax)

# CH2
cell7 = openmc.Cell(cell_id=7, fill=mat7)
cell7.region = (+surf5 | -surf5_zmin | +surf5_zmax) & (+surf6 | -surf6_zmin | +surf6_zmax) & (+surf8 | -surf8_zmin | +surf8_zmax) & (-surf9 & +surf9_zmin & -surf9_zmax)
...
source.space = openmc.stats.Point((0.0, 0.0, 4.25))
