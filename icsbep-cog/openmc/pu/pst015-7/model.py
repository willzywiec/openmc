"""
PU-SOL-THERM-015 (Case 7) Three cylinders with 0 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=23.33)
...
source.space = openmc.stats.Box((-9.0, -16.0, 10.7), (18.0, 16.0, 12.7))
