"""
PU-SOL-THERM-026 (Case 19) 39.363 kg Pu(81.6) at H/X = 109 with H/SQRT(A) = 0.257
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=69.342)
# Tank/Inner:  Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 137.821, 159.919, -192.929, -86.249)
# Tank/Outer:  Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 137.662, 160.078, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 126.232, 171.508, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -158.3))
