"""
PU-SOL-THERM-014 (Case 21) Three cylinders with 60 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=38.88)
...
source.space = openmc.stats.Box((-1.0, -91.0, 18.0), (91.0, 1.0, 20.0))
