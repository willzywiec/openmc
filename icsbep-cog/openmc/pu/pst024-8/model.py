"""
PU-SOL-THERM-024 (Case 8) 14.128 kg Pu(80.45) at H/X = 179 with H/SQRT(A) = 0.302; 18.40 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=41.2496)
# Tank/Inner:  Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -172.0))
