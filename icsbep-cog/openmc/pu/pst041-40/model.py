"""
PU-SOL-THERM-041-40: Experiment 514 with 189.05 gPu(3.11)/L at H/X=127; Hc=Hw=22.95
...
mat1.add_nuclide("Pu239", 4.608640e-04)
mat1.add_nuclide("Pu240", 1.474950e-05)
mat1.add_nuclide("Pu241", 5.667430e-07)
mat1.add_element("N", 3.241940e-03)
mat1.add_nuclide("O16", 3.844440e-02)
mat1.add_nuclide("H1", 5.871990e-02)
mat1.add_element("Fe", 1.816970e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=22.95)
...
source.space = openmc.stats.Box((-18.5, -18.5, 11.225), (18.5, 18.5, 13.225))
