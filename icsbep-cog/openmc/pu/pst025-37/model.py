"""
PU-SOL-THERM-025 (Case 37) 23.020 kg Pu(75.779) at H/X = 103 with H/SQRT(A) = 0.346; 23.185 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=35.636)
...
source.space = openmc.stats.Point((0.0, 2.71, 17.8))
