"""
PU-SOL-THERM-029 (Case 7; No. 172) Hc=70.10cm; D=15.0cm; 40.6 gPu/l; H/X=632; 2.98 wt-% Pu-240; Air/Air; Water
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=70.10)
...
u1_cell5.region = +surf1 & -surf4 & -surf7
...
u1_cell8.region = -surf2 & +surf7 & -surf9
...
cell10.region = -surf2 & +surf7 & -surf9

root_universe = openmc.Universe(cells=[cell10])
...
source.space = openmc.stats.Box((-13.5, -1.0, 34.1), (13.5, 1.0, 36.1))
