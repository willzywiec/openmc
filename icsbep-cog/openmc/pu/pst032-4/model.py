"""
PU-SOL-THERM-032-4: H/X=559 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 5.704600e-08)
mat1.add_nuclide("Pu239", 1.006900e-04)
mat1.add_nuclide("Pu240", 1.126900e-05)
mat1.add_nuclide("Pu241", 1.442200e-06)
mat1.add_nuclide("Pu242", 1.009800e-07)
mat1.add_nuclide("H1", 6.268000e-02)
mat1.add_nuclide("O16", 3.575100e-02)
mat1.add_element("N", 1.672900e-03)
mat1.add_element("Fe", 7.548300e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=33.31)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 16.655))
