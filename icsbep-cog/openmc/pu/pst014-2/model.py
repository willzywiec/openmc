"""
PU-SOL-THERM-014 (Case 2) Two cylinders with 5 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=33.80)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-17.5, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=17.5, r=15.0)
...
source.space = openmc.stats.Box((-1.0, -18.5, 15.899999999999999), (1.0, 18.5, 17.9))
