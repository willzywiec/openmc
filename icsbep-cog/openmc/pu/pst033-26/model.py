"""
PU-SOL-THERM-033-26: 355.6 gPu(3.13)/L at H/X=60.5 with 13 (3x40) pyrex tubes at 9.02cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=23.18)
...
# Pyrex tube #1
surf101 = openmc.ZCylinder(surface_id=101, x0=0.0, y0=15.623098, r=1.5)
# Pyrex tube #2
surf102 = openmc.ZCylinder(surface_id=102, x0=-13.53, y0=7.811549, r=1.5)
# Pyrex tube #3
surf103 = openmc.ZCylinder(surface_id=103, x0=-4.51, y0=7.811549, r=1.5)
# Pyrex tube #4
surf104 = openmc.ZCylinder(surface_id=104, x0=4.51, y0=7.811549, r=1.5)
# Pyrex tube #5
surf105 = openmc.ZCylinder(surface_id=105, x0=13.53, y0=7.811549, r=1.5)
# Pyrex tube #6
surf106 = openmc.ZCylinder(surface_id=106, x0=-9.02, y0=0.0, r=1.5)
# Pyrex tube #7
surf107 = openmc.ZCylinder(surface_id=107, x0=0.0, y0=0.0, r=1.5)
# Pyrex tube #8
surf108 = openmc.ZCylinder(surface_id=108, x0=9.02, y0=0.0, r=1.5)
# Pyrex tube #9
surf109 = openmc.ZCylinder(surface_id=109, x0=-13.53, y0=-7.811549, r=1.5)
# Pyrex tube #10
surf110 = openmc.ZCylinder(surface_id=110, x0=-4.51, y0=-7.811549, r=1.5)
# Pyrex tube #11
surf111 = openmc.ZCylinder(surface_id=111, x0=4.51, y0=-7.811549, r=1.5)
# Pyrex tube #12
surf112 = openmc.ZCylinder(surface_id=112, x0=13.53, y0=-7.811549, r=1.5)
# Pyrex tube #13
surf113 = openmc.ZCylinder(surface_id=113, x0=0.0, y0=-15.623098, r=1.5)
...
surf19_zmax = openmc.ZPlane(surface_id=1128, z0=2.638)
surf20_zmin = openmc.ZPlane(surface_id=1129, z0=39.362)
...
source.space = openmc.stats.Box((-4.0, -4.0, 10.59), (4.0, 4.0, 12.59))
