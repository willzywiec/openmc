"""
PU-SOL-THERM-017 (Case 7) 300 and 256 mm cylinders with 115.1 gPu/L at 15 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=80.00)
...
surf4 = openmc.ZPlane(surface_id=4, z0=38.414)
# 300-mm Tank/Inner per Figure 5
surf5 = openmc.ZCylinder(surface_id=5, x0=42.79, y0=0.0, r=14.7)
# 300-mm Tank/Outer per Figure 5
surf6 = openmc.ZCylinder(surface_id=6, x0=42.79, y0=0.0, r=15.0)
...
source.space = openmc.stats.Box((-1.0, -1.0, 18.2), (43.79, 1.0, 41.0))
