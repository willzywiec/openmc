"""
PU-SOL-THERM-034-11: 38.268 kg Pu(8.3) @ H/X=58.5 with 9.88 gGd/L
...
mat1.add_element("Gd", 3.783600e-05)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=36.04)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 18.02))
