"""
PU-SOL-THERM-041-10: Experiment 287 with 48 gPu(3)/L at H/X=499; Hc=Hw=31.51
...
mat1.add_nuclide("Pu239", 1.171590e-04)
mat1.add_nuclide("Pu240", 3.612450e-06)
mat1.add_nuclide("Pu241", 1.319050e-07)
mat1.add_element("N", 3.047140e-03)
mat1.add_nuclide("O16", 3.715390e-02)
mat1.add_nuclide("H1", 5.857230e-02)
...
surf7 = openmc.ZPlane(surface_id=7, z0=31.51)
...
source.space = openmc.stats.Box((-18.5, -18.5, 15.504999999999999), (18.5, 18.5, 17.505))
