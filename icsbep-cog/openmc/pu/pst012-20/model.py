"""
PU-SOL-THERM-012 (Case 20) Hc = 38.60 @ H/X=1893; 18.91 wt-% Pu-240; no close water reflection
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=38.60)
# Lucoflex/Inner
...
source.space = openmc.stats.Point((0.0, 0.0, 19.3))
