"""
PU-SOL-THERM-012 (Case 2) Hc = 32.25 @ H/X=1786; 18.91 wt-% Pu-240; 6 sides water reflection
...
mat1.add_nuclide("Pu239", 3.313810e-05)
mat1.add_nuclide("Pu240", 8.396700e-06)
mat1.add_nuclide("Pu241", 2.489050e-06)
mat1.add_nuclide("Pu242", 5.027950e-07)
mat1.add_nuclide("Am241", 2.697320e-07)
mat1.add_element("N", 1.384810e-03)
mat1.add_nuclide("O16", 3.537580e-02)
mat1.add_nuclide("H1", 6.362910e-02)
mat1.add_element("Fe", 4.421120e-06)
mat1.add_element("Cr", 1.421720e-06)
mat1.add_element("Ni", 1.007650e-06)
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=32.25)
# Lucoflex/Inner; Zo = Hc + 10
surf2 = openmc.model.RectangularParallelepiped(-64.0, 64.0, -64.0, 64.0, 33.25, 51.25)
# Lucoflex/Outer; Zo = Hc + 10
surf3 = openmc.model.RectangularParallelepiped(-65.0, 65.0, -65.0, 65.0, 32.25, 52.25)
# Tank/Inner
...
surf10 = openmc.ZPlane(surface_id=10, z0=52.25)
...
source.space = openmc.stats.Point((0.0, 0.0, 16.1))
