"""
PU-SOL-THERM-013 (Case 1) Two cylinders with 0 cm s-to-s
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-12.794, r=12.794)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=12.794, r=12.794)
...
source.space = openmc.stats.Box((-1.0, -13.794, 25.48), (1.0, 13.794, 27.48))
