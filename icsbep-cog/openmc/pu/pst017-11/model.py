"""
PU-SOL-THERM-017 (Case 11) Two 300 mm cylinders with 115.1 gPu/L at 15 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=0.00)
...
# 300-mm Tank/Hc-0.326 from Table 1
surf4 = openmc.ZPlane(surface_id=4, z0=40.314)
# 300-mm Tank/Inner per Figure 5
surf5 = openmc.ZCylinder(surface_id=5, x0=45.0, y0=0.0, r=14.7)
# 300-mm Tank/Outer per Figure 5
surf6 = openmc.ZCylinder(surface_id=6, x0=45.0, y0=0.0, r=15.0)

# Z-plane surfaces for bounded cylinders
surf2_zmin = openmc.ZPlane(surface_id=1006, z0=-0.326)
surf2_zmax = openmc.ZPlane(surface_id=1007, z0=100.845)
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=-1.655)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=102.045)
...
cell1.region = (-surf2 & +surf2_zmin & -surf2_zmax)
...
source.space = openmc.stats.Point((45.0, 0.0, 20.1))
