"""
PU-SOL-THERM-014 (Case 22) Three cylinders with 120 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=39.83)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=150.0, y0=0.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=-150.0, r=15.0)
...
source.space = openmc.stats.Box((-1.0, -151.0, 19.0), (151.0, 1.0, 21.0))
