"""
PU-SOL-THERM-016 (Case 5) 300 and 256 mm cylinders with 115.1 gPu/L at 0 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=33.764)
...
surf4 = openmc.ZPlane(surface_id=4, z0=33.764)
...
cell6.region = +surf3 & +surf5 & -surf6
...
source.space = openmc.stats.Box((-1.0, -1.0, 15.899999999999999), (28.79, 1.0, 17.9))
