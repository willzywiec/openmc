"""
PU-SOL-THERM-017 (Case 15) Two 300 mm cylinders with 115.1 gPu/L at 30 cm s-to-s
...
# 300-mm Tank/Hc-0.326 from Table 1
surf4 = openmc.ZPlane(surface_id=4, z0=40.561)
# 300-mm Tank/Inner per Figure 5
surf5 = openmc.ZCylinder(surface_id=5, x0=60.0, y0=0.0, r=14.7)
# 300-mm Tank/Outer per Figure 5
surf6 = openmc.ZCylinder(surface_id=6, x0=60.0, y0=0.0, r=15.0)
...
source.space = openmc.stats.Point((60.0, 0.0, 20.3))
