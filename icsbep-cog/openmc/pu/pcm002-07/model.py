"""
PU-COMP-MIXED-002 (Case 7) 30.807 kg Pu @ H/X = 5.7 with 11.46 wt-% Pu-240 and H/SQRT(A) = 0.462
...
surf1 = openmc.model.RectangularParallelepiped(-15.36, 15.36, -15.36, 15.36, -7.09, 7.09)
# 6" (15.24 cm) Plexiglas Reflector
surf2 = openmc.model.RectangularParallelepiped(-30.6, 30.6, -30.6, 30.6, -22.33, 22.33, boundary_type="vacuum")
