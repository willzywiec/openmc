"""
PU-SOL-THERM-041-1: Experiment 210 with 65.9 gPu(2.99)/L at H/X=357; Hc=Hw=27.62
...
mat1.add_nuclide("Pu239", 1.608660e-04)
mat1.add_nuclide("Pu240", 4.943060e-06)
mat1.add_nuclide("Pu241", 1.810950e-07)
mat1.add_element("N", 3.328370e-03)
mat1.add_nuclide("O16", 3.739060e-02)
mat1.add_nuclide("H1", 5.745470e-02)
mat1.add_element("Fe", 6.901260e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=27.62)
...
source.space = openmc.stats.Box((-18.5, -18.5, 13.56), (18.5, 18.5, 15.56))
