"""
PMF037-1: Flooded 2x2x2 array of double-canned 3kg Pu parts in water; Hw=20.2; dx=dy=7.62; dz=13.335
...
# Water height
surf6 = openmc.ZPlane(surface_id=6, z0=20.2)
# Inner tank
...
source.space = openmc.stats.Box((-4.8100000000000005, -4.8100000000000005, 13.0285), (4.8100000000000005, 4.8100000000000005, 28.3635))
