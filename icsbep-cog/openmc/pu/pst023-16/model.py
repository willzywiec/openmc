...
mat1.add_nuclide("Pu238", 1.103300e-11)
mat1.add_nuclide("Pu239", 1.187300e-08)
mat1.add_nuclide("Pu240", 7.310900e-09)
mat1.add_nuclide("Pu241", 1.703200e-09)
mat1.add_nuclide("Pu242", 7.124200e-10)
mat1.add_nuclide("Am241", 9.286000e-11)
mat1.add_element("N", 2.113800e-03)
mat1.add_nuclide("H1", 6.168900e-02)
mat1.add_nuclide("O16", 3.612000e-02)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=25.78)
...
source.space = openmc.stats.Point((0.0, 0.0, 12.9))
