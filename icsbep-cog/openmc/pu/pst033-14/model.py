"""
PU-SOL-THERM-033-14: 160.7 gPu(4.23)/L at H/X=153.2 with no poisons
...
surf1 = openmc.ZPlane(surface_id=1, z0=19.03)
...
source.space = openmc.stats.Point((0.0, 0.0, 9.515))
