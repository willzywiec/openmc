"""
PU-SOL-THERM-014 (Case 1) Two cylinders with 0 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=30.54)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-15.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=15.0, r=15.0)
...
source.space = openmc.stats.Box((-1.0, -16.0, 14.27), (1.0, 16.0, 16.27))
