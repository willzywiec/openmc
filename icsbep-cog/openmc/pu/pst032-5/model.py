"""
PU-SOL-THERM-032-5: H/X=691 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 5.091200e-08)
mat1.add_nuclide("Pu239", 8.985700e-05)
mat1.add_nuclide("Pu240", 1.005700e-05)
mat1.add_nuclide("Pu241", 1.287100e-06)
mat1.add_nuclide("Pu242", 9.012300e-08)
mat1.add_nuclide("H1", 6.296500e-02)
mat1.add_nuclide("O16", 3.568600e-02)
mat1.add_element("N", 1.599800e-03)
mat1.add_element("Fe", 6.793400e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=36.01)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 18.005))
