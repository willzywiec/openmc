...
mat1.add_nuclide("Pu238", 1.676400e-07)
mat1.add_nuclide("Pu239", 1.804100e-04)
mat1.add_nuclide("Pu240", 1.110800e-04)
mat1.add_nuclide("Pu241", 2.645400e-05)
mat1.add_nuclide("Pu242", 1.082500e-05)
mat1.add_nuclide("Am241", 8.350700e-07)
mat1.add_element("N", 3.576400e-03)
mat1.add_nuclide("H1", 5.758000e-02)
mat1.add_nuclide("O16", 3.839300e-02)
mat1.add_element("Fe", 1.455700e-06)
mat1.add_element("Cr", 3.908900e-07)
mat1.add_element("Ni", 1.923900e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=22.69)
