"""
PU-SOL-THERM-014 (Case 18) Three cylinders with 0 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=26.70)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=30.0, y0=0.0, r=15.0)
...
source.space = openmc.stats.Box((-1.0, -31.0, 12.35), (31.0, 1.0, 14.35))
