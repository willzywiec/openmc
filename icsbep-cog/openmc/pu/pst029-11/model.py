"""
PU-SOL-THERM-029 (Case 14; No. 187) Hc=100.00cm; D=15.0cm; 40.6 gPu/l; H/X=632; 2.98 wt-% Pu-240; Air/Cd; Air/Cd; Water
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=100.00)
...
# dY = 111.0 (fixed)
surf12 = openmc.model.RectangularParallelepiped(-87.8, 87.8, -55.5, 55.5, -32.800000000000004, 119.0)
...
source.space = openmc.stats.Box((-13.5, -1.0, 49.0), (13.5, 1.0, 51.0))
