"""
PU-SOL-THERM-024 (Case 11) 20.212 kg Pu(80.45) at H/X = 179 with H/SQRT(A) = 0.193; 18.40 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=70.6374)
# Tank/Inner:  Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 140.488, 157.252, -192.929, -86.249)
# Tank/Outer:  Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 140.329, 157.411, -193.379, -85.799)
# Plex/Outer:  Width = Tc +  5.398
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 137.78900000000002, 159.951, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf5 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 128.899, 168.841, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -158.0))
