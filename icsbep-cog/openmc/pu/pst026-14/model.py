"""
PU-SOL-THERM-026 (Case 14) 17.504 kg Pu(81.6) at H/X = 179 with H/SQRT(A) = 0.325
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=45.364)
# Tank/Inner:  Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -170.2))
