"""
PU-SOL-THERM-022 (Case 14) Hc = 59.33 @ H/X=413; 18.88 wt-% Pu-240; Paraffin + Cd
...
mat1.add_nuclide("Pu239", 1.383700e-04)
mat1.add_nuclide("Pu240", 3.506100e-05)
mat1.add_nuclide("Pu241", 1.062500e-05)
mat1.add_nuclide("Pu242", 2.099500e-06)
mat1.add_nuclide("Am241", 8.873600e-07)
mat1.add_element("N", 2.158500e-03)
mat1.add_nuclide("O16", 3.658600e-02)
mat1.add_nuclide("H1", 6.155800e-02)
mat1.add_element("Fe", 1.682200e-05)
mat1.add_element("Cr", 5.409500e-06)
mat1.add_element("Ni", 3.834000e-06)
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=59.33)
