"""
PU-SOL-THERM-033-4: 275.43 gPu(3.13)/L at H/X=82.3 with no poisons
...
surf1 = openmc.ZPlane(surface_id=1, z0=19.17)
...
source.space = openmc.stats.Point((0.0, 0.0, 9.585))
