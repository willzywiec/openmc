"""
PMF016-6: Flooded 3x3x3 arrays of 3kg Pu metal cylinders; Hw=65.60; dx=dy=12.80; dz=13.10
...
# Water height
surf9 = openmc.ZPlane(surface_id=9, z0=65.600)
# Sleeve inner
surf10 = openmc.ZCylinder(surface_id=10, r=3.81)
# Sleeve outer
surf11 = openmc.ZCylinder(surface_id=11, r=3.97)
surf12 = openmc.ZCylinder(surface_id=12, x0=-12.8, y0=-12.8, r=3.97)
surf13 = openmc.ZCylinder(surface_id=13, x0=0.0, y0=-12.8, r=3.97)
surf14 = openmc.ZCylinder(surface_id=14, x0=12.8, y0=-12.8, r=3.97)
surf15 = openmc.ZCylinder(surface_id=15, x0=-12.8, y0=0.0, r=3.97)
surf16 = openmc.ZCylinder(surface_id=16, x0=12.8, y0=0.0, r=3.97)
surf17 = openmc.ZCylinder(surface_id=17, x0=-12.8, y0=12.8, r=3.97)
surf18 = openmc.ZCylinder(surface_id=18, x0=0.0, y0=12.8, r=3.97)
surf19 = openmc.ZCylinder(surface_id=19, x0=12.8, y0=12.8, r=3.97)
...
source.space = openmc.stats.Box((-13.8, -13.8, 40.5), (13.8, 13.8, 42.5))
