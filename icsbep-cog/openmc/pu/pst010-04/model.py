...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=25.6032)
# Cylinder/Inner
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=25.7607)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=56.2407)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=25.6032)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=56.3982)
