"""
PU-SOL-THERM-041-25: Experiment 379 with 66.22 gPu(3.11)/L at H/X=340; Hc=Hw=25.41
...
mat1.add_nuclide("Pu239", 1.614300e-04)
mat1.add_nuclide("Pu240", 5.166410e-06)
mat1.add_nuclide("Pu241", 1.985180e-07)
mat1.add_element("N", 1.653720e-03)
mat1.add_nuclide("O16", 3.596420e-02)
mat1.add_nuclide("H1", 6.297570e-02)
mat1.add_element("Fe", 5.661190e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=25.41)
...
source.space = openmc.stats.Box((-18.5, -18.5, 12.455), (18.5, 18.5, 14.455))
