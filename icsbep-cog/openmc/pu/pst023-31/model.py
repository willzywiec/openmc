...
mat1.add_nuclide("Pu238", 2.618800e-09)
mat1.add_nuclide("Pu239", 3.410000e-05)
mat1.add_nuclide("Pu240", 1.504600e-06)
mat1.add_nuclide("Pu241", 1.011500e-07)
mat1.add_nuclide("Pu242", 5.644800e-09)
mat1.add_nuclide("Am241", 2.342600e-08)
mat1.add_element("N", 2.362200e-03)
mat1.add_nuclide("H1", 6.111500e-02)
mat1.add_nuclide("O16", 3.653600e-02)
mat1.add_element("Fe", 7.763900e-07)
mat1.add_element("Cr", 2.084700e-07)
mat1.add_element("Ni", 1.026100e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=22.64)
