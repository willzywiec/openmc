"""
PU-SOL-THERM-014 (Case 23) Three cylinders with 145 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=39.86)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=175.0, y0=0.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=-175.0, r=15.0)
...
source.space = openmc.stats.Box((-1.0, -176.0, 19.0), (176.0, 1.0, 21.0))
