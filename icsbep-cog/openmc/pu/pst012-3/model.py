"""
PU-SOL-THERM-012 (Case 3) Hc = 35.44 @ H/X=1893; 18.91 wt-% Pu-240; 6 sides water reflection
...
mat1.add_nuclide("Pu239", 3.126590e-05)
mat1.add_nuclide("Pu240", 7.922310e-06)
mat1.add_nuclide("Pu241", 2.348420e-06)
mat1.add_nuclide("Pu242", 4.743880e-07)
mat1.add_nuclide("Am241", 2.544920e-07)
mat1.add_element("N", 1.385320e-03)
mat1.add_nuclide("O16", 3.537670e-02)
mat1.add_nuclide("H1", 6.363980e-02)
mat1.add_element("Fe", 4.097620e-06)
mat1.add_element("Cr", 1.317700e-06)
mat1.add_element("Ni", 9.339230e-07)
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=35.44)
# Lucoflex/Inner; Zo = Hc + 10
surf2 = openmc.model.RectangularParallelepiped(-64.0, 64.0, -64.0, 64.0, 36.44, 54.44)
# Lucoflex/Outer; Zo = Hc + 10
surf3 = openmc.model.RectangularParallelepiped(-65.0, 65.0, -65.0, 65.0, 35.44, 55.44)
# Tank/Inner
...
surf10 = openmc.ZPlane(surface_id=10, z0=55.44)
