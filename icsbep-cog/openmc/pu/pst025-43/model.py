"""
PU-SOL-THERM-025 (Case 43) 37.238 kg Pu(80.45) at H/X = 56 with H/SQRT(A) = 0.328; 18.40 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=39.700)
...
source.space = openmc.stats.Point((0.0, 2.71, 19.9))
