"""
PU-SOL-THERM-031-2: H/X=408 and 7 Hafnium Plates with 7.1446 cm Pitch
...
mat1.add_nuclide("U238", 1.854300e-07)
mat1.add_nuclide("Pu239", 1.383500e-04)
mat1.add_nuclide("Pu240", 3.468300e-05)
mat1.add_nuclide("Pu241", 9.309100e-06)
mat1.add_nuclide("Pu242", 2.060800e-06)
mat1.add_nuclide("Am241", 2.038400e-06)
mat1.add_nuclide("H1", 6.017500e-02)
mat1.add_nuclide("O16", 3.742500e-02)
mat1.add_element("N", 2.763000e-03)
mat1.add_element("Fe", 2.641900e-05)
mat1.add_element("Cr", 7.725400e-06)
mat1.add_element("Ni", 5.716200e-06)
mat1.add_element("Mn", 6.829100e-07)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=52.13)
# SST tank, inner
...
source.space = openmc.stats.Box((-1.0, -4.4562, 25.015), (1.0, 4.6884, 27.015))
