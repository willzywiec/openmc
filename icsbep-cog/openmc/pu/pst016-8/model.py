"""
PU-SOL-THERM-016 (Case 8) 300 and 256 mm cylinders with 115.1 gPu/L at 60 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=40.574)
...
surf4 = openmc.ZPlane(surface_id=4, z0=40.574)
# 300-mm Tank/Inner per Figure 5
surf5 = openmc.ZCylinder(surface_id=5, x0=87.79, y0=0.0, r=14.7)
# 300-mm Tank/Outer per Figure 5
surf6 = openmc.ZCylinder(surface_id=6, x0=87.79, y0=0.0, r=15.0)
...
source.space = openmc.stats.Box((-1.0, -1.0, 19.3), (88.79, 1.0, 21.3))
