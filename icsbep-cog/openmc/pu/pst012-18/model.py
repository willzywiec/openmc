"""
PU-SOL-THERM-012 (Case 18) Hc = 31.52 @ H/X=1601; 18.91 wt-% Pu-240; no close water reflection
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=31.52)
# Lucoflex/Inner
...
source.space = openmc.stats.Point((0.0, 0.0, 15.8))
