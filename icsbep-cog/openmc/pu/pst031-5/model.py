"""
PU-SOL-THERM-031-5: H/X=577 and 5 Hafnium Plates with 10.0046 cm Pitch
...
mat1.add_nuclide("U238", 1.325600e-07)
mat1.add_nuclide("Pu239", 9.892100e-05)
mat1.add_nuclide("Pu240", 2.479800e-05)
mat1.add_nuclide("Pu241", 6.633200e-06)
mat1.add_nuclide("Pu242", 1.473500e-06)
mat1.add_nuclide("Am241", 1.480200e-06)
mat1.add_nuclide("H1", 6.090300e-02)
mat1.add_nuclide("O16", 3.681100e-02)
mat1.add_element("N", 2.422000e-03)
mat1.add_element("Fe", 1.703700e-05)
mat1.add_element("Cr", 5.522700e-06)
mat1.add_element("Ni", 4.086300e-06)
mat1.add_element("Mn", 4.882300e-07)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=52.85)
# SST tank, inner
...
# Hafnium plate
surf51 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -19.95, -19.8454, 2.4179999999999993, 52.418)
# Hafnium plate
surf52 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -9.945400000000001, -9.8408, 2.4179999999999993, 52.418)
# Hafnium plate
surf53 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 0.0592, 0.1638, 2.4179999999999993, 52.418)
# Hafnium plate
surf54 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 10.063799999999999, 10.1684, 2.4179999999999993, 52.418)
# Hafnium plate
surf55 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 20.0684, 20.173, 2.4179999999999993, 52.418)
...
source.space = openmc.stats.Box((-1.0, -5.8908, 25.425), (1.0, 6.1138, 27.425))
