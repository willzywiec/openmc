"""
PU-SOL-THERM-011 (Case 18-4) 1.167 kg Pu(95.80) @ H/X = 1100 in a bare 18" SS347 + 0.020" Cd sphere
...
mat1.add_nuclide("Pu239", 5.748600e-05)
mat1.add_nuclide("Pu240", 2.509700e-06)
mat1.add_element("N", 1.441400e-03)
mat1.add_nuclide("H1", 6.322000e-02)
mat1.add_nuclide("O16", 3.533300e-02)
mat1.add_element("Fe", 1.326300e-06)
