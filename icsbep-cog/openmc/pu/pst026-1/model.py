"""
PU-SOL-THERM-026 (Case 1) 9.523 kg Pu(95.4) at H/X = 451 with H/SQRT(A) = 0.157
...
mat1.add_nuclide("Pu238", 8.697300e-09)
mat1.add_nuclide("Pu239", 1.372200e-04)
mat1.add_nuclide("Pu240", 6.714300e-06)
mat1.add_nuclide("Pu241", 3.650300e-07)
mat1.add_nuclide("Pu242", 1.283000e-08)
mat1.add_nuclide("H1", 6.209500e-02)
mat1.add_element("N", 1.956300e-03)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=97.358)
# Tank/Inner
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 140.869, 156.871, -192.929, -86.249)
# Tank/Outer
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 140.71, 157.03, -193.379, -85.799)
# Frame/Outer
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 129.439, 168.30100000000002, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -144.0))
