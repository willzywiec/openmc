"""
PMF042-9S: Pu hemisphere reflected by 2.667 cm steel and infinite oil; simplified model
...
# Steel
# surf3: Unsupported surface type "s" with params ['9.000', 'tr', '-2.37375', '0', '-6.333']
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=1.18)
# BCD
