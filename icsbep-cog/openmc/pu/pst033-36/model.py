"""
PU-SOL-THERM-033-36: 178.5 gPu(4.23)/L at H/X=136.3 with 73 (3x40) pyrex tubes at 3.23cm pitch
...
mat1.add_nuclide("U235", 1.696700e-10)
mat1.add_nuclide("U238", 2.376500e-08)
mat1.add_nuclide("Pu238", 3.296400e-08)
mat1.add_nuclide("Pu239", 4.292400e-04)
mat1.add_nuclide("Pu240", 1.893900e-05)
mat1.add_nuclide("Pu241", 1.293000e-06)
mat1.add_nuclide("Pu242", 7.105300e-08)
mat1.add_nuclide("Am241", 1.551800e-07)
mat1.add_nuclide("H1", 5.869300e-02)
mat1.add_nuclide("O16", 3.824700e-02)
mat1.add_element("N", 3.196800e-03)
mat1.add_element("Fe", 3.558500e-06)
mat1.add_element("Cr", 1.447100e-07)
mat1.add_element("Ni", 3.809600e-07)
mat1.add_element("Mn", 1.565300e-07)
mat1.add_element("Ca", 2.145700e-06)
mat1.add_element("Cu", 1.353300e-07)
mat1.add_element("Mg", 2.653600e-07)
mat1.add_element("Zn", 4.931700e-07)
mat1.add_element("Na", 4.675700e-07)
...
surf1 = openmc.ZPlane(surface_id=1, z0=57.83)
...
surf3_zmin = openmc.ZPlane(surface_id=1191, z0=-0.3)
surf3_zmax = openmc.ZPlane(surface_id=1192, z0=80.7)
surf4_zmin = openmc.ZPlane(surface_id=1193, z0=-25.9)
surf4_zmax = openmc.ZPlane(surface_id=1194, z0=62.8)
surf6_zmin = openmc.ZPlane(surface_id=1195, z0=-26.3, boundary_type="vacuum")
surf6_zmax = openmc.ZPlane(surface_id=1196, z0=85.7, boundary_type="vacuum")
surf10_zmin = openmc.ZPlane(surface_id=1197, z0=1.2)
surf10_zmax = openmc.ZPlane(surface_id=1198, z0=82.2)
surf11_zmin = openmc.ZPlane(surface_id=1199, z0=1.2)
surf11_zmax = openmc.ZPlane(surface_id=1200, z0=1.38)
surf13_zmin = openmc.ZPlane(surface_id=1201, z0=81.8)
surf13_zmax = openmc.ZPlane(surface_id=1202, z0=82.2)
surf15_zmin = openmc.ZPlane(surface_id=1203, z0=1.38)
surf15_zmax = openmc.ZPlane(surface_id=1204, z0=81.8)
surf19_zmin = openmc.ZPlane(surface_id=1205, z0=2.5)
surf19_zmax = openmc.ZPlane(surface_id=1206, z0=2.7)
surf20_zmin = openmc.ZPlane(surface_id=1207, z0=39.3)
surf20_zmax = openmc.ZPlane(surface_id=1208, z0=39.5)
surf24_zmin = openmc.ZPlane(surface_id=1209, z0=1.5)
surf24_zmax = openmc.ZPlane(surface_id=1210, z0=41.5)
...
u4_cell1.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf19 & +surf19_zmin & -surf19_zmax) & +surf16 & +surf17 & +surf18 & +surf103 & +surf104 & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf114 & +surf115 & +surf116 & +surf117 & +surf118 & +surf119 & +surf120
u4_cell2 = openmc.Cell(fill=mat5)
u4_cell2.region = (-surf10 & +surf10_zmin & -surf10_zmax) & (-surf20 & +surf20_zmin & -surf20_zmax) & +surf16 & +surf17 & +surf18 & +surf103 & +surf104 & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf114 & +surf115 & +surf116 & +surf117 & +surf118 & +surf119 & +surf120
...
source.space = openmc.stats.Point((0.0, 0.0, 28.915))
