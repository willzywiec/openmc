...
surf61_zmax = openmc.ZPlane(z0=106.5342)
surf62_zmin = openmc.ZPlane(z0=106.5342)
surf62_zmax = openmc.ZPlane(z0=117.4858)
surf63_zmin = openmc.ZPlane(z0=117.4858)
surf63_zmax = openmc.ZPlane(z0=118.5142)
surf64_zmin = openmc.ZPlane(z0=118.5142)
surf64_zmax = openmc.ZPlane(z0=129.4658)
