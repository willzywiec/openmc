...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -9.2235, -0.5365000000000002, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-9.76, 9.76, -9.96, 0.20000000000000018, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 0.5365000000000002, 9.2235, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-9.76, 9.76, -0.20000000000000018, 9.96, 216.35500000000002, 221.435)
# Hole
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-4.88, y0=-4.88, r=3.607)
surf102 = openmc.ZCylinder(surface_id=102, x0=-4.88, y0=4.88, r=3.607)
surf103 = openmc.ZCylinder(surface_id=103, x0=4.88, y0=-4.88, r=3.607)
surf104 = openmc.ZCylinder(surface_id=104, x0=4.88, y0=4.88, r=3.607)

# Z-plane surfaces for bounded cylinders
surf31_zmin = openmc.ZPlane(surface_id=1104, z0=0.33092)
surf31_zmax = openmc.ZPlane(surface_id=1105, z0=0.635)
surf32_zmin = openmc.ZPlane(surface_id=1106, z0=0.635)
surf32_zmax = openmc.ZPlane(surface_id=1107, z0=0.656)
surf33_zmin = openmc.ZPlane(surface_id=1108, z0=0.656)
surf33_zmax = openmc.ZPlane(surface_id=1109, z0=5.289)
surf34_zmin = openmc.ZPlane(surface_id=1110, z0=0.656)
surf34_zmax = openmc.ZPlane(surface_id=1111, z0=5.289)
surf35_zmin = openmc.ZPlane(surface_id=1112, z0=5.289)
surf35_zmax = openmc.ZPlane(surface_id=1113, z0=5.376)
surf36_zmin = openmc.ZPlane(surface_id=1114, z0=5.376)
surf36_zmax = openmc.ZPlane(surface_id=1115, z0=5.7316)
surf37_zmin = openmc.ZPlane(surface_id=1116, z0=5.7316)
surf37_zmax = openmc.ZPlane(surface_id=1117, z0=5.7526)
surf38_zmin = openmc.ZPlane(surface_id=1118, z0=5.7526)
surf38_zmax = openmc.ZPlane(surface_id=1119, z0=10.3856)
surf39_zmin = openmc.ZPlane(surface_id=1120, z0=5.7526)
surf39_zmax = openmc.ZPlane(surface_id=1121, z0=10.3856)
surf40_zmin = openmc.ZPlane(surface_id=1122, z0=10.3856)
surf40_zmax = openmc.ZPlane(surface_id=1123, z0=10.4726)
surf41_zmin = openmc.ZPlane(surface_id=1124, z0=10.4726)
surf41_zmax = openmc.ZPlane(surface_id=1125, z0=10.9516)
surf50_zmin = openmc.ZPlane(surface_id=1126, z0=0.0)
surf50_zmax = openmc.ZPlane(surface_id=1127, z0=208.417)
surf61_zmin = openmc.ZPlane(surface_id=1128, z0=25.083)
surf61_zmax = openmc.ZPlane(surface_id=1129, z0=106.5342)
surf62_zmin = openmc.ZPlane(surface_id=1130, z0=106.5342)
surf62_zmax = openmc.ZPlane(surface_id=1131, z0=117.4858)
surf63_zmin = openmc.ZPlane(surface_id=1132, z0=117.4858)
surf63_zmax = openmc.ZPlane(surface_id=1133, z0=118.5142)
surf64_zmin = openmc.ZPlane(surface_id=1134, z0=118.5142)
surf64_zmax = openmc.ZPlane(surface_id=1135, z0=129.4658)
...
cell5.region = -surf10 & +surf11

# I-beam
cell6 = openmc.Cell(cell_id=6, fill=mat8)
cell6.region = -surf10 & -surf11 & +surf12 & -surf13

# I-beam
cell7 = openmc.Cell(cell_id=7, fill=mat8)
cell7.region = -surf15 & +surf16

# I-beam
cell8 = openmc.Cell(cell_id=8, fill=mat8)
cell8.region = -surf15 & -surf16 & +surf17 & -surf18
...
cell25.region = +surf30 & (+surf40 | -surf40_zmin | +surf40_zmax) & (-surf41 & +surf41_zmin & -surf41_zmax)

# Part
cell31 = openmc.Cell(cell_id=31, fill=universe1)
cell31.translation = (0.0, 0.0, 118.5142)
cell31.region = (+surf63 | -surf63_zmin | +surf63_zmax) & (-surf64 & +surf64_zmin & -surf64_zmax)
