"""
PU-SOL-THERM-016 (Case 6) 300 and 256 mm cylinders with 115.1 gPu/L at 10 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=38.674)
...
surf4 = openmc.ZPlane(surface_id=4, z0=38.674)
...
source.space = openmc.stats.Box((-1.0, -1.0, 18.3), (38.79, 1.0, 20.3))
