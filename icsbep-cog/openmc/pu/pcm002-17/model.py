"""
PU-COMP-MIXED-002 (Case 17) 37.970 kg Pu @ H/X = 16.3 with 8.06 wt-% Pu-240 and H/SQRT(A) = 0.175
...
surf1 = openmc.model.RectangularParallelepiped(-25.655, 25.655, -34.125, 34.125, -5.18, 5.18)
# 6" (15.24 cm) Plexiglas Reflector
surf2 = openmc.model.RectangularParallelepiped(-40.895, 40.895, -49.365, 49.365, -20.42, 20.42, boundary_type="vacuum")
