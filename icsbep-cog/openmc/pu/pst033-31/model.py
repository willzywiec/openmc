"""
PU-SOL-THERM-033-31: 151.8 gPu(3.13)/L at H/X=159.2 with 91 (3x40) pyrex tubes at 3.23cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=58.28)
...
source.space = openmc.stats.Point((0.0, 0.0, 29.14))
