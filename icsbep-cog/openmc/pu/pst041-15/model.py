"""
PU-SOL-THERM-041-15: Experiment 312 with 33.74 gPu(3)/L at H/X=726; Hc=Hw=42.77
...
surf7 = openmc.ZPlane(surface_id=7, z0=42.77)
...
source.space = openmc.stats.Box((-18.5, -18.5, 21.135), (18.5, 18.5, 23.135))
