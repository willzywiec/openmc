"""
PU-SOL-THERM-033-27: 355.6 gPu(3.13)/L at H/X=60.5 with 19 (3x40) pyrex tubes at 7.81cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=24.87)
...
# Pyrex tube #2
surf102 = openmc.ZCylinder(surface_id=102, x0=-6.765, y0=11.717324, r=1.5)
# Pyrex tube #3
surf103 = openmc.ZCylinder(surface_id=103, x0=6.765, y0=11.717324, r=1.5)
# Pyrex tube #4
surf104 = openmc.ZCylinder(surface_id=104, x0=-13.53, y0=7.811549, r=1.5)
# Pyrex tube #5
surf105 = openmc.ZCylinder(surface_id=105, x0=0.0, y0=7.811549, r=1.5)
# Pyrex tube #6
surf106 = openmc.ZCylinder(surface_id=106, x0=13.53, y0=7.811549, r=1.5)
# Pyrex tube #7
surf107 = openmc.ZCylinder(surface_id=107, x0=-6.765, y0=3.905775, r=1.5)
# Pyrex tube #8
surf108 = openmc.ZCylinder(surface_id=108, x0=6.765, y0=3.905775, r=1.5)
# Pyrex tube #9
surf109 = openmc.ZCylinder(surface_id=109, x0=-13.53, y0=0.0, r=1.5)
# Pyrex tube #10
surf110 = openmc.ZCylinder(surface_id=110, x0=0.0, y0=0.0, r=1.5)
# Pyrex tube #11
surf111 = openmc.ZCylinder(surface_id=111, x0=13.53, y0=0.0, r=1.5)
# Pyrex tube #12
surf112 = openmc.ZCylinder(surface_id=112, x0=-6.765, y0=-3.905775, r=1.5)
# Pyrex tube #13
surf113 = openmc.ZCylinder(surface_id=113, x0=6.765, y0=-3.905775, r=1.5)
# Pyrex tube #14
surf114 = openmc.ZCylinder(surface_id=114, x0=-13.53, y0=-7.811549, r=1.5)
# Pyrex tube #15
surf115 = openmc.ZCylinder(surface_id=115, x0=0.0, y0=-7.811549, r=1.5)
# Pyrex tube #16
surf116 = openmc.ZCylinder(surface_id=116, x0=13.53, y0=-7.811549, r=1.5)
# Pyrex tube #17
surf117 = openmc.ZCylinder(surface_id=117, x0=-6.765, y0=-11.717324, r=1.5)
# Pyrex tube #18
surf118 = openmc.ZCylinder(surface_id=118, x0=6.765, y0=-11.717324, r=1.5)
# Pyrex tube #19
surf119 = openmc.ZCylinder(surface_id=119, x0=0.0, y0=-15.623098, r=1.5)
...
surf19_zmax = openmc.ZPlane(surface_id=1134, z0=2.638)
surf20_zmin = openmc.ZPlane(surface_id=1135, z0=39.362)
...
source.space = openmc.stats.Box((-4.0, -4.0, 11.435), (4.0, 4.0, 13.435))
