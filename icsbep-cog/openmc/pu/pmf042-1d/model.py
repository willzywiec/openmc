...
surf3_zmin = openmc.ZPlane(surface_id=1064, z0=-31.333, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(surface_id=1065, z0=18.667, boundary_type="vacuum")
...
cell2.region = +surf1 & -surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & +surf64

# Oil
cell3 = openmc.Cell(cell_id=3, fill=mat5)
cell3.region = -surf1 & -surf2 & (-surf3 & +surf3_zmin & -surf3_zmax)
...
cell5.region = +surf1 & +surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & +surf64
