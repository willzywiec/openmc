"""
PU-SOL-THERM-015 (Case 13) Three cylinders with 30 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=37.92)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=60.0, y0=0.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=-60.0, r=15.0)
...
source.space = openmc.stats.Box((-1.0, -61.0, 18.0), (61.0, 1.0, 20.0))
