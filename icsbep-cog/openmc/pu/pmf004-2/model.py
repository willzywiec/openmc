"""
PMF004-2: LLNL Pu Array Phase II - bare - 4x4x4 - 6kg - case 208
...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -30.2635, -21.576500000000003, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-34.56, 34.56, -31.0, -20.840000000000003, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -12.9835, -4.296500000000001, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-34.56, 34.56, -13.72, -3.5600000000000005, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 4.296500000000001, 12.9835, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-34.56, 34.56, 3.5600000000000005, 13.72, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 21.576500000000003, 30.2635, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-34.56, 34.56, 20.840000000000003, 31.0, 216.35500000000002, 221.435)
# Hole
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-25.92, y0=-25.92, r=3.607)
surf102 = openmc.ZCylinder(surface_id=102, x0=-25.92, y0=-8.64, r=3.607)
surf103 = openmc.ZCylinder(surface_id=103, x0=-25.92, y0=8.64, r=3.607)
surf104 = openmc.ZCylinder(surface_id=104, x0=-25.92, y0=25.92, r=3.607)
surf105 = openmc.ZCylinder(surface_id=105, x0=-8.64, y0=-25.92, r=3.607)
surf106 = openmc.ZCylinder(surface_id=106, x0=-8.64, y0=-8.64, r=3.607)
surf107 = openmc.ZCylinder(surface_id=107, x0=-8.64, y0=8.64, r=3.607)
surf108 = openmc.ZCylinder(surface_id=108, x0=-8.64, y0=25.92, r=3.607)
surf109 = openmc.ZCylinder(surface_id=109, x0=8.64, y0=-25.92, r=3.607)
surf110 = openmc.ZCylinder(surface_id=110, x0=8.64, y0=-8.64, r=3.607)
surf111 = openmc.ZCylinder(surface_id=111, x0=8.64, y0=8.64, r=3.607)
surf112 = openmc.ZCylinder(surface_id=112, x0=8.64, y0=25.92, r=3.607)
surf113 = openmc.ZCylinder(surface_id=113, x0=25.92, y0=-25.92, r=3.607)
surf114 = openmc.ZCylinder(surface_id=114, x0=25.92, y0=-8.64, r=3.607)
surf115 = openmc.ZCylinder(surface_id=115, x0=25.92, y0=8.64, r=3.607)
surf116 = openmc.ZCylinder(surface_id=116, x0=25.92, y0=25.92, r=3.607)
...
surf61_zmax = openmc.ZPlane(z0=86.8442)
surf62_zmin = openmc.ZPlane(z0=86.8442)
surf62_zmax = openmc.ZPlane(z0=97.7958)
surf63_zmin = openmc.ZPlane(z0=97.7958)
surf63_zmax = openmc.ZPlane(z0=103.9642)
surf64_zmin = openmc.ZPlane(z0=103.9642)
surf64_zmax = openmc.ZPlane(z0=114.9158)
surf65_zmin = openmc.ZPlane(z0=114.9158)
surf65_zmax = openmc.ZPlane(z0=121.0842)
surf66_zmin = openmc.ZPlane(z0=121.0842)
surf66_zmax = openmc.ZPlane(z0=132.0358)
surf67_zmin = openmc.ZPlane(z0=132.0358)
surf67_zmax = openmc.ZPlane(z0=138.2042)
surf68_zmin = openmc.ZPlane(z0=138.2042)
surf68_zmax = openmc.ZPlane(z0=149.1558)
...
cell47.translation = (0.0, 0.0, 138.2042)
...
source.space = openmc.stats.Box((-26.92, -26.92, 88.8167), (26.92, 26.92, 147.2733))
