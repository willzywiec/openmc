"""
PU-SOL-THERM-013 (Case 2) Two cylinders with 5 cm surface-to-surface
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=78.72)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-15.294, r=12.794)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=15.294, r=12.794)
...
source.space = openmc.stats.Box((-1.0, -16.294, 38.36), (1.0, 16.294, 40.36))
