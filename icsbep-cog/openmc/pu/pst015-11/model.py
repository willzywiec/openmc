"""
PU-SOL-THERM-015 (Case 11) Three cylinders with 0 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=26.58)
...
source.space = openmc.stats.Box((-1.0, -31.0, 12.3), (31.0, 1.0, 14.3))
