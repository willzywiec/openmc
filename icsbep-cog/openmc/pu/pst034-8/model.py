"""
PU-SOL-THERM-034-8: 29.806 kg Pu(8.3) @ H/X=58.5 with 5.28 gGd/L
...
mat1.add_element("Gd", 2.022000e-05)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=28.07)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 14.035))
