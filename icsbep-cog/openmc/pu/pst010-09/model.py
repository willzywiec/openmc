...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=22.8092)
# Cylinder/Inner
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=22.9667)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=53.4467)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=22.8092)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=53.6042)
