...
surf40_zmin = openmc.ZPlane(z0=0.0)
surf40_zmax = openmc.ZPlane(z0=208.417)
surf51_zmin = openmc.ZPlane(z0=25.083)
surf51_zmax = openmc.ZPlane(z0=103.2825)
surf52_zmin = openmc.ZPlane(z0=103.2825)
surf52_zmax = openmc.ZPlane(z0=109.1375)
surf53_zmin = openmc.ZPlane(z0=109.1375)
surf53_zmax = openmc.ZPlane(z0=111.1425)
surf54_zmin = openmc.ZPlane(z0=111.1425)
surf54_zmax = openmc.ZPlane(z0=116.9975)
surf55_zmin = openmc.ZPlane(z0=116.9975)
surf55_zmax = openmc.ZPlane(z0=119.0025)
surf56_zmin = openmc.ZPlane(z0=119.0025)
surf56_zmax = openmc.ZPlane(z0=124.8575)
surf57_zmin = openmc.ZPlane(z0=124.8575)
surf57_zmax = openmc.ZPlane(z0=126.8625)
surf58_zmin = openmc.ZPlane(z0=126.8625)
surf58_zmax = openmc.ZPlane(z0=132.7175)
