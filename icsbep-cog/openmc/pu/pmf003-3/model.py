"""
PMF003-3: LLNL Pu Array - Bare - 3x3x3 - case 103
...
# 1st
surf41 = openmc.ZCylinder(surface_id=41, x0=-9.6, y0=9.6, r=3.609)
# 2nd
surf42 = openmc.ZCylinder(surface_id=42, x0=-9.6, y0=0.0, r=3.609)
# 3rd
surf43 = openmc.ZCylinder(surface_id=43, x0=-9.6, y0=-9.6, r=3.609)
# 4th
surf44 = openmc.ZCylinder(surface_id=44, x0=0.0, y0=9.6, r=3.609)
# 5th
surf45 = openmc.ZCylinder(surface_id=45, x0=0.0, y0=0.0, r=3.609)
# 6th
surf46 = openmc.ZCylinder(surface_id=46, x0=0.0, y0=-9.6, r=3.609)
# 7th
surf47 = openmc.ZCylinder(surface_id=47, x0=9.6, y0=9.6, r=3.609)
# 8th
surf48 = openmc.ZCylinder(surface_id=48, x0=9.6, y0=0.0, r=3.609)
# 9th
surf49 = openmc.ZCylinder(surface_id=49, x0=9.6, y0=-9.6, r=3.609)

# Z-plane surfaces for bounded cylinders
surf4_zmin = openmc.ZPlane(surface_id=1049, z0=0.0)
surf4_zmax = openmc.ZPlane(surface_id=1050, z0=8.3)
surf6_zmin = openmc.ZPlane(surface_id=1051, z0=0.0)
surf6_zmax = openmc.ZPlane(surface_id=1052, z0=45.734)
...
source.space = openmc.stats.Box((-10.6, -10.6, 16.5), (10.6, 10.6, 33.9))
