"""
PU-SOL-THERM-041-28: Experiment 438 with 50.5 gPu(3.11)/L at H/X=513; Hc=Hw=28.78
...
mat1.add_nuclide("Pu239", 1.231080e-04)
mat1.add_nuclide("Pu240", 3.939950e-06)
mat1.add_nuclide("Pu241", 1.513910e-07)
mat1.add_element("N", 1.546720e-03)
mat1.add_nuclide("O16", 3.575470e-02)
mat1.add_nuclide("H1", 6.325270e-02)
mat1.add_element("Fe", 4.723050e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=28.78)
...
source.space = openmc.stats.Box((-18.5, -18.5, 14.14), (18.5, 18.5, 16.14))
