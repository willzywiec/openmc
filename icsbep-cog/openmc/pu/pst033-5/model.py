"""
PU-SOL-THERM-033-5: 251.9 gPu(3.13)/L at H/X=91.0 with no poisons
...
mat1.add_nuclide("U235", 1.852300e-10)
mat1.add_nuclide("U238", 2.594400e-08)
mat1.add_nuclide("Pu239", 6.138400e-04)
mat1.add_nuclide("Pu240", 1.981100e-05)
mat1.add_nuclide("Pu241", 7.551600e-07)
mat1.add_nuclide("Pu242", 7.520300e-08)
mat1.add_nuclide("Am241", 8.810200e-08)
mat1.add_nuclide("H1", 5.587400e-02)
mat1.add_nuclide("O16", 3.934200e-02)
mat1.add_element("N", 4.049700e-03)
mat1.add_element("Fe", 3.709400e-06)
mat1.add_element("Cr", 4.376200e-07)
mat1.add_element("Ni", 5.169400e-07)
mat1.add_element("Mn", 1.656700e-07)
mat1.add_element("Ca", 2.271000e-06)
mat1.add_element("Cu", 3.103300e-07)
mat1.add_element("Mg", 1.248300e-06)
mat1.add_element("Zn", 3.479800e-07)
mat1.add_element("Na", 1.649600e-06)
