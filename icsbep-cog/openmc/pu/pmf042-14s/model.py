"""
PMF042-14S: Pu hemisphere reflected by 4.333 cm steel and infinite oil; simplified model
...
# Steel
# surf3: Unsupported surface type "s" with params ['10.666', 'tr', '-2.37375', '0', '-6.333']
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=0.96)
# BCD
...
cell3.region = +surf1 & +surf3 & -surf4 & -surf5
...
cell6.region = +surf1 & +surf3 & +surf4 & -surf5
