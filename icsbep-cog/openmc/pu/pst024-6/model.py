"""
PU-SOL-THERM-024 (Case 6) 55.863 kg Pu(80.45) at H/X = 55.9 with H/SQRT(A) = 0.292; 18.40 wt-% Pu-240
...
mat1.add_nuclide("Pu238", 1.980800e-06)
mat1.add_nuclide("Pu239", 7.881600e-04)
mat1.add_nuclide("Pu240", 1.902200e-04)
mat1.add_nuclide("Pu241", 4.663700e-05)
mat1.add_nuclide("Pu242", 9.842400e-06)
mat1.add_nuclide("Am241", 2.882600e-06)
mat1.add_element("N", 6.661200e-03)
mat1.add_nuclide("O16", 4.207900e-02)
mat1.add_nuclide("H1", 4.669700e-02)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=56.2102)
# Tank/Inner:  Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 137.567, 160.173, -192.929, -86.249)
# Tank/Outer:  Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 137.40800000000002, 160.332, -193.379, -85.799)
# Plex/Outer:  Width = Tc +  5.398
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 134.868, 162.872, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf5 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 125.97800000000001, 171.762, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -165.0))
