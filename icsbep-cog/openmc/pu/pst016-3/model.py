"""
PU-SOL-THERM-016 (Case 3) 300 and 256 mm cylinders with 152.5 gPu/L at 30 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=41.764)
...
surf4 = openmc.ZPlane(surface_id=4, z0=41.764)
...
source.space = openmc.stats.Box((-1.0, -1.0, 19.882), (58.79, 1.0, 21.882))
