...
mat1.add_nuclide("Pu238", 1.154400e-07)
mat1.add_nuclide("Pu239", 1.242300e-04)
mat1.add_nuclide("Pu240", 7.649300e-05)
mat1.add_nuclide("Pu241", 1.811800e-05)
mat1.add_nuclide("Pu242", 7.453900e-06)
mat1.add_nuclide("Am241", 6.732000e-07)
mat1.add_element("N", 3.171700e-03)
mat1.add_nuclide("H1", 5.879200e-02)
mat1.add_nuclide("O16", 3.778200e-02)
mat1.add_element("Fe", 1.401800e-06)
mat1.add_element("Cr", 3.764100e-07)
mat1.add_element("Ni", 1.852700e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=22.61)
