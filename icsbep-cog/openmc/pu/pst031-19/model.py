"""
PU-SOL-THERM-031-19: H/X=1413 with no Hafnium
...
mat1.add_nuclide("U238", 5.464300e-08)
mat1.add_nuclide("Pu239", 4.078000e-05)
mat1.add_nuclide("Pu240", 1.022300e-05)
mat1.add_nuclide("Pu241", 2.730200e-06)
mat1.add_nuclide("Pu242", 6.074300e-07)
mat1.add_nuclide("Am241", 6.145400e-07)
mat1.add_nuclide("H1", 6.150100e-02)
mat1.add_nuclide("O16", 3.614600e-02)
mat1.add_element("N", 2.107600e-03)
mat1.add_element("Fe", 7.548200e-06)
mat1.add_element("Cr", 2.276500e-06)
mat1.add_element("Ni", 1.684600e-06)
mat1.add_element("Mn", 2.012600e-07)
...
mat3.add_nuclide("H1", 6.670700e-02)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=52.19)
# SST tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 26.095))
