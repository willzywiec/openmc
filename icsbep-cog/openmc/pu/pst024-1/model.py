"""
PU-SOL-THERM-024 (Case 1) 25.269 kg Pu(80.45) at H/X = 109 with H/SQRT(A) = 0.3015; 18.40 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=46.3804)
# Tank/Inner:  Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 138.2655, 159.4745, -192.929, -86.249)
# Tank/Outer:  Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 138.1065, 159.6335, -193.379, -85.799)
# Plex/Outer:  Width = Tc +  5.398
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 135.56650000000002, 162.1735, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf5 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 126.6765, 171.0635, -193.379, -85.799)
# U-Frame/Inner
