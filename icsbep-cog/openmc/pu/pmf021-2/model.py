...
surf1_zmin = openmc.ZPlane(surface_id=1020, z0=-2.55)
surf1_zmax = openmc.ZPlane(surface_id=1021, z0=-2.1)
surf2_zmin = openmc.ZPlane(surface_id=1022, z0=-2.06)
surf2_zmax = openmc.ZPlane(surface_id=1023, z0=-1.61)
surf3_zmin = openmc.ZPlane(surface_id=1024, z0=-1.57)
surf3_zmax = openmc.ZPlane(surface_id=1025, z0=-1.12)
surf4_zmin = openmc.ZPlane(surface_id=1026, z0=-1.08)
surf4_zmax = openmc.ZPlane(surface_id=1027, z0=-0.63)
surf5_zmin = openmc.ZPlane(surface_id=1028, z0=-0.59)
surf5_zmax = openmc.ZPlane(surface_id=1029, z0=-0.14)
surf6_zmin = openmc.ZPlane(surface_id=1030, z0=-2.57)
surf6_zmax = openmc.ZPlane(surface_id=1031, z0=-0.12)
surf7_zmin = openmc.ZPlane(surface_id=1032, z0=-17.51)
surf7_zmax = openmc.ZPlane(surface_id=1033, z0=-2.57)
surf8_zmin = openmc.ZPlane(surface_id=1034, z0=-2.57)
surf8_zmax = openmc.ZPlane(surface_id=1035, z0=-0.12)
surf9_zmin = openmc.ZPlane(surface_id=1036, z0=-2.57)
surf9_zmax = openmc.ZPlane(surface_id=1037, z0=-2.37)
surf11_zmin = openmc.ZPlane(surface_id=1038, z0=2.1)
surf11_zmax = openmc.ZPlane(surface_id=1039, z0=2.55)
surf12_zmin = openmc.ZPlane(surface_id=1040, z0=1.61)
surf12_zmax = openmc.ZPlane(surface_id=1041, z0=2.06)
surf13_zmin = openmc.ZPlane(surface_id=1042, z0=1.12)
surf13_zmax = openmc.ZPlane(surface_id=1043, z0=1.57)
surf14_zmin = openmc.ZPlane(surface_id=1044, z0=0.63)
surf14_zmax = openmc.ZPlane(surface_id=1045, z0=1.08)
surf15_zmin = openmc.ZPlane(surface_id=1046, z0=0.14)
surf15_zmax = openmc.ZPlane(surface_id=1047, z0=0.59)
surf16_zmin = openmc.ZPlane(surface_id=1048, z0=0.12)
surf16_zmax = openmc.ZPlane(surface_id=1049, z0=2.57)
surf17_zmin = openmc.ZPlane(surface_id=1050, z0=2.59)
surf17_zmax = openmc.ZPlane(surface_id=1051, z0=17.53)
surf18_zmin = openmc.ZPlane(surface_id=1052, z0=0.12)
surf18_zmax = openmc.ZPlane(surface_id=1053, z0=2.59)
surf19_zmin = openmc.ZPlane(surface_id=1054, z0=2.39)
surf19_zmax = openmc.ZPlane(surface_id=1055, z0=2.59)
