"""
PMF004-4: LLNL Pu Array Phase II - bare - 4x4x4 - 6kg - case 210
...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -22.2385, -13.5515, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-23.86, 23.86, -22.975, -12.815, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -10.308499999999999, -1.6215000000000002, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-23.86, 23.86, -11.045, -0.8849999999999998, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 1.6215000000000002, 10.308499999999999, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-23.86, 23.86, 0.8849999999999998, 11.045, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 13.5515, 22.2385, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-23.86, 23.86, 12.815, 22.975, 216.35500000000002, 221.435)
# Hole
...
# 6 kg part
surf62 = openmc.ZCylinder(surface_id=62, r=3.2995)
# Inner spacer
surf63 = openmc.ZCylinder(surface_id=63, r=3.3338)
# 6 kg part
surf64 = openmc.ZCylinder(surface_id=64, r=3.2995)
# Inner spacer
surf65 = openmc.ZCylinder(surface_id=65, r=3.3338)
# 6 kg part
surf66 = openmc.ZCylinder(surface_id=66, r=3.2995)
# Inner spacer
surf67 = openmc.ZCylinder(surface_id=67, r=3.3338)
# 6 kg part
surf68 = openmc.ZCylinder(surface_id=68, r=3.2995)
surf101 = openmc.ZCylinder(surface_id=101, x0=-17.895, y0=-17.895, r=3.607)
surf102 = openmc.ZCylinder(surface_id=102, x0=-17.895, y0=-5.965, r=3.607)
surf103 = openmc.ZCylinder(surface_id=103, x0=-17.895, y0=5.965, r=3.607)
surf104 = openmc.ZCylinder(surface_id=104, x0=-17.895, y0=17.895, r=3.607)
surf105 = openmc.ZCylinder(surface_id=105, x0=-5.965, y0=-17.895, r=3.607)
surf106 = openmc.ZCylinder(surface_id=106, x0=-5.965, y0=-5.965, r=3.607)
surf107 = openmc.ZCylinder(surface_id=107, x0=-5.965, y0=5.965, r=3.607)
surf108 = openmc.ZCylinder(surface_id=108, x0=-5.965, y0=17.895, r=3.607)
surf109 = openmc.ZCylinder(surface_id=109, x0=5.965, y0=-17.895, r=3.607)
surf110 = openmc.ZCylinder(surface_id=110, x0=5.965, y0=-5.965, r=3.607)
surf111 = openmc.ZCylinder(surface_id=111, x0=5.965, y0=5.965, r=3.607)
surf112 = openmc.ZCylinder(surface_id=112, x0=5.965, y0=17.895, r=3.607)
surf113 = openmc.ZCylinder(surface_id=113, x0=17.895, y0=-17.895, r=3.607)
surf114 = openmc.ZCylinder(surface_id=114, x0=17.895, y0=-5.965, r=3.607)
surf115 = openmc.ZCylinder(surface_id=115, x0=17.895, y0=5.965, r=3.607)
surf116 = openmc.ZCylinder(surface_id=116, x0=17.895, y0=17.895, r=3.607)
...
surf61_zmax = openmc.ZPlane(z0=41.8442)
surf62_zmin = openmc.ZPlane(z0=41.8442)
surf62_zmax = openmc.ZPlane(z0=52.7958)
surf63_zmin = openmc.ZPlane(z0=52.7958)
surf63_zmax = openmc.ZPlane(z0=88.9642)
surf64_zmin = openmc.ZPlane(z0=88.9642)
surf64_zmax = openmc.ZPlane(z0=99.9158)
surf65_zmin = openmc.ZPlane(z0=99.9158)
surf65_zmax = openmc.ZPlane(z0=136.0842)
surf66_zmin = openmc.ZPlane(z0=136.0842)
surf66_zmax = openmc.ZPlane(z0=147.0358)
surf67_zmin = openmc.ZPlane(z0=147.0358)
surf67_zmax = openmc.ZPlane(z0=183.2042)
surf68_zmin = openmc.ZPlane(z0=183.2042)
surf68_zmax = openmc.ZPlane(z0=194.1558)
...
u2_cell4.region = +surf60 & (+surf62 | -surf62_zmin | +surf62_zmax) & (-surf63 & +surf63_zmin & -surf63_zmax)
u2_cell5 = openmc.Cell(fill=mat5)
u2_cell5.region = +surf60 & (+surf64 | -surf64_zmin | +surf64_zmax) & (-surf65 & +surf65_zmin & -surf65_zmax)
u2_cell6 = openmc.Cell(fill=mat5)
u2_cell6.region = +surf60 & (+surf66 | -surf66_zmin | +surf66_zmax) & (-surf67 & +surf67_zmin & -surf67_zmax)
...
cell47.translation = (0.0, 0.0, 183.2042)
cell47.region = (+surf67 | -surf67_zmin | +surf67_zmax) & (-surf68 & +surf68_zmin & -surf68_zmax)
...
source.space = openmc.stats.Box((-18.895, -18.895, 43.8167), (18.895, 18.895, 192.2733))
