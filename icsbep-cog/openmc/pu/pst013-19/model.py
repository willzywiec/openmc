"""
PU-SOL-THERM-013 (Case 19) Seven cylinders with 5 cm surface-to-surface
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=27.10)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=-15.294, y0=26.49, r=12.794)
surf12 = openmc.ZCylinder(surface_id=12, x0=15.294, y0=26.49, r=12.794)
surf13 = openmc.ZCylinder(surface_id=13, x0=-30.588, y0=0.0, r=12.794)
surf14 = openmc.ZCylinder(surface_id=14, x0=30.588, y0=0.0, r=12.794)
surf15 = openmc.ZCylinder(surface_id=15, x0=-15.294, y0=-26.49, r=12.794)
surf16 = openmc.ZCylinder(surface_id=16, x0=15.294, y0=-26.49, r=12.794)
...
source.space = openmc.stats.Point((0.0, 0.0, 13.55))
