"""
PU-SOL-THERM-041-33: Experiment 464 with 25.1 gPu(3.11)/L at H/X=1049; Hc=Hw=65.69
...
mat1.add_nuclide("Pu239", 6.118850e-05)
mat1.add_nuclide("Pu240", 1.958270e-06)
mat1.add_nuclide("Pu241", 7.524600e-08)
mat1.add_element("N", 1.199290e-03)
mat1.add_nuclide("O16", 3.526180e-02)
mat1.add_nuclide("H1", 6.426730e-02)
mat1.add_element("Fe", 2.318390e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=65.69)
...
source.space = openmc.stats.Box((-18.5, -18.5, 32.595), (18.5, 18.5, 34.595))
