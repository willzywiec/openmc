"""
PU-SOL-THERM-013 (Case 13) Four cylinders with 10 cm surface-to-surface
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=45.04)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=-17.794, y0=17.794, r=12.794)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=17.794, y0=17.794, r=12.794)
surf13 = openmc.ZCylinder(surface_id=13, x0=-17.794, y0=-17.794, r=12.794)
surf14 = openmc.ZCylinder(surface_id=14, x0=17.794, y0=-17.794, r=12.794)
...
source.space = openmc.stats.Box((-18.794, -18.794, 21.52), (18.794, 18.794, 23.52))
