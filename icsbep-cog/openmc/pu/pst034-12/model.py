"""
PU-SOL-THERM-034-12: 43.556 kg Pu(8.3) @ H/X=58.5 with 12.58 gGd/L
...
# 363.0 gPu(8.3)/L Sol'n
mat1 = openmc.Material(material_id=1)
mat1.set_density("sum")
mat1.add_nuclide("Pu238", 4.040500e-07)
mat1.add_nuclide("Pu239", 8.292000e-04)
mat1.add_nuclide("Pu240", 7.630200e-05)
mat1.add_nuclide("Pu241", 7.717300e-06)
mat1.add_nuclide("Pu242", 4.425200e-07)
mat1.add_nuclide("H1", 4.897300e-02)
mat1.add_element("N", 6.158600e-03)
mat1.add_nuclide("O16", 4.172800e-02)
mat1.add_element("Gd", 4.816700e-05)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=41.02)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 20.51))
