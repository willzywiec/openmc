"""
PU-SOL-THERM-013 (Case 17) Six cylinders with 10 cm surface-to-surface
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=39.25)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=-17.794, y0=35.588, r=12.794)
surf12 = openmc.ZCylinder(surface_id=12, x0=17.794, y0=35.588, r=12.794)
surf13 = openmc.ZCylinder(surface_id=13, x0=-17.794, y0=0.0, r=12.794)
surf14 = openmc.ZCylinder(surface_id=14, x0=17.794, y0=0.0, r=12.794)
surf15 = openmc.ZCylinder(surface_id=15, x0=-17.794, y0=-35.588, r=12.794)
surf16 = openmc.ZCylinder(surface_id=16, x0=17.794, y0=-35.588, r=12.794)
...
cell1.region = -surf4 & +surf11 & +surf12 & +surf13 & +surf14 & +surf15 & +surf16
...
source.space = openmc.stats.Box((-18.794, -36.588, 18.6), (18.794, 36.588, 20.6))
