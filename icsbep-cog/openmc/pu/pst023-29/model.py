...
mat1.add_nuclide("Pu238", 5.651300e-09)
mat1.add_nuclide("Pu239", 7.358700e-05)
mat1.add_nuclide("Pu240", 3.246800e-06)
mat1.add_nuclide("Pu241", 2.186500e-07)
mat1.add_nuclide("Pu242", 1.218100e-08)
mat1.add_nuclide("Am241", 5.017800e-08)
mat1.add_element("N", 2.517700e-03)
mat1.add_nuclide("H1", 6.066300e-02)
mat1.add_nuclide("O16", 3.678200e-02)
mat1.add_element("Fe", 1.272400e-06)
mat1.add_element("Cr", 3.416600e-07)
mat1.add_element("Ni", 1.681600e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=21.19)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(z0=3.45)
surf1_zmax = openmc.ZPlane(z0=17.45)
surf2_zmin = openmc.ZPlane(z0=3.3)
surf2_zmax = openmc.ZPlane(z0=17.6)
