...
mat1.add_nuclide("Pu238", 2.186600e-08)
mat1.add_nuclide("Pu239", 2.847300e-04)
mat1.add_nuclide("Pu240", 1.256300e-05)
mat1.add_nuclide("Pu241", 8.507200e-07)
mat1.add_nuclide("Pu242", 4.713200e-08)
mat1.add_nuclide("Am241", 1.894500e-07)
mat1.add_element("N", 3.450700e-03)
mat1.add_nuclide("H1", 5.807400e-02)
mat1.add_nuclide("O16", 3.826900e-02)
mat1.add_element("Fe", 4.205500e-06)
mat1.add_element("Cr", 1.129200e-06)
mat1.add_element("Ni", 5.558000e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=20.01)
