"""
PU-MET-FAST-045: LAMPRE Assembly V (Simplified Model)
...
mat1.add_nuclide("Pu239", 3.580000e-02)
mat1.add_element("Ni", 8.460000e-03)
...
surf3_zmax = openmc.ZPlane(z0=7.3819)
surf4_zmin = openmc.ZPlane(z0=-0.2032)
surf4_zmax = openmc.ZPlane(z0=7.5851)
surf5_zmin = openmc.ZPlane(z0=-1.9558)
surf5_zmax = openmc.ZPlane(z0=9.3377)
surf6_zmin = openmc.ZPlane(z0=-1.9558)
surf6_zmax = openmc.ZPlane(z0=9.3377)
surf7_zmin = openmc.ZPlane(z0=-9.5758)
surf7_zmax = openmc.ZPlane(z0=29.6577)
...
source.space = openmc.stats.Point((0.0, 0.0, 3.72))
