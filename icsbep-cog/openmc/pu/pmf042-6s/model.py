"""
PMF042-6S: Pu hemisphere reflected by 1.667 cm steel and infinite oil; simplified model
...
# Steel
# surf3: Unsupported surface type "s" with params ['8.000', 'tr', '-2.37375', '0', '-6.333']
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=0.31)
# BCD
