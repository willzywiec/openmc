"""
PU-SOL-THERM-015 (Case 6) One cylinder
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=42.53)
...
surf2_zmax = openmc.ZPlane(surface_id=1006, z0=101.171)
surf3_zmin = openmc.ZPlane(surface_id=1007, z0=-1.329)
surf3_zmax = openmc.ZPlane(surface_id=1008, z0=102.371)
...
cell1.region = (+surf3 | -surf3_zmin | +surf3_zmax) & -surf4
...
source.space = openmc.stats.Point((0.0, 0.0, 21.3))
