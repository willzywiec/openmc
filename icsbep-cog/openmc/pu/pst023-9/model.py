...
mat1.add_nuclide("Pu238", 1.421800e-07)
mat1.add_nuclide("Pu239", 1.530100e-04)
mat1.add_nuclide("Pu240", 9.421600e-05)
mat1.add_nuclide("Pu241", 2.237800e-05)
mat1.add_nuclide("Pu242", 9.180900e-06)
mat1.add_nuclide("Am241", 7.673300e-07)
mat1.add_element("N", 3.394100e-03)
mat1.add_nuclide("H1", 5.803100e-02)
mat1.add_nuclide("O16", 3.806300e-02)
mat1.add_element("Fe", 1.423400e-06)
mat1.add_element("Cr", 3.822000e-07)
mat1.add_element("Ni", 1.881200e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=22.63)
