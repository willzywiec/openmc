"""
PU-SOL-THERM-025 (Case 36) 24.072 kg Pu(75.779) at H/X = 103 with H/SQRT(A) = 0.309; 23.185 wt-% Pu-240
...
mat1.add_nuclide("Pu238", 5.025600e-07)
mat1.add_nuclide("Pu239", 5.134700e-04)
mat1.add_nuclide("Pu240", 1.650700e-04)
mat1.add_nuclide("Pu241", 2.806200e-05)
mat1.add_nuclide("Pu242", 6.820500e-06)
mat1.add_nuclide("Am241", 1.488900e-06)
mat1.add_nuclide("H1", 5.557600e-02)
mat1.add_element("N", 4.203100e-03)
mat1.add_nuclide("O16", 3.972600e-02)
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=39.624)
# Sol'n Tank/Inner: Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-53.34, 53.34, -7.3229999999999995, 12.742999999999999, 0.0, 106.68)
# Sol'n Tank/Outer: Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -7.482, 12.902000000000001, -0.3159999999999954, 106.99600000000001)
# Egg Crate /Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-53.656, 53.656, -18.912, 24.332, -0.3159999999999954, 106.99600000000001)
...
source.space = openmc.stats.Point((0.0, 2.71, 19.8))
