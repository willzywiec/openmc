"""
PU-SOL-THERM-010 (Case 11-2) 0.815 kg Pu(97.15) @ H/X = 558 in a water reflected 11" diameter SS-347 cylinder
...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=28.1686)
# Cylinder/Inner
surf6 = openmc.ZCylinder(surface_id=6, r=13.9684)
# Cylinder/Outer
surf7 = openmc.ZCylinder(surface_id=7, r=14.291)
# Reflector/Inner
surf8 = openmc.ZCylinder(surface_id=8, r=45.72, boundary_type="vacuum")

# Z-plane surfaces for bounded cylinders
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=28.3261)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=58.8061)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=28.1686)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=58.9636)
...
source.space = openmc.stats.Point((0.0, 0.0, 14.0))
