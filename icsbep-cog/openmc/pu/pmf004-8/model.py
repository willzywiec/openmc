...
surf61_zmax = openmc.ZPlane(z0=98.8442)
surf62_zmin = openmc.ZPlane(z0=98.8442)
surf62_zmax = openmc.ZPlane(z0=109.7958)
surf63_zmin = openmc.ZPlane(z0=109.7958)
surf63_zmax = openmc.ZPlane(z0=112.5242)
surf64_zmin = openmc.ZPlane(z0=112.5242)
surf64_zmax = openmc.ZPlane(z0=123.4758)
surf65_zmin = openmc.ZPlane(z0=123.4758)
surf65_zmax = openmc.ZPlane(z0=126.2042)
surf66_zmin = openmc.ZPlane(z0=126.2042)
surf66_zmax = openmc.ZPlane(z0=137.1558)
