"""
PU-SOL-THERM-026 (Case 11) 24.411 kg Pu(81.6) at H/X = 179 with H/SQRT(A) = 0.230
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=71.272)
# Tank/Inner:  Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -157.3))
