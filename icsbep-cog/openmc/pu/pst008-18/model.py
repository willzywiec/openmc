"""
PU-SOL-THERM-008 (Case 18) 1.088 kg Pu(95.43) @ H/X = 510 in 14" SS304L sphere with 4" concrete
...
mat1.add_nuclide("Pu239", 1.122400e-04)
mat1.add_nuclide("Pu240", 5.491000e-06)
mat1.add_nuclide("Pu241", 3.737600e-07)
mat1.add_nuclide("Pu242", 1.050100e-08)
mat1.add_element("N", 3.856900e-03)
mat1.add_nuclide("H1", 5.742500e-02)
mat1.add_nuclide("O16", 3.859100e-02)
...
surf4 = openmc.Sphere(surface_id=4, r=28.1501)
