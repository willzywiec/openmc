"""
PU-SOL-THERM-021 (Case 1) 1.180 kg Pu(95.4) @ H/X = 700 in a bare 15.2" SS304L sphere
...
# = Hc per Table 5a
surf1 = openmc.ZPlane(surface_id=1, z0=19.3304)
# SST/Inner
surf2 = openmc.Sphere(surface_id=2, r=19.3304)
# SST/Outer
surf3 = openmc.Sphere(surface_id=3, r=19.4523)
# Model/Outer
surf4 = openmc.Sphere(surface_id=4, r=49.4523)
# Support Tube/Inner
