"""
PU-SOL-THERM-026 (Case 17) 48.768 kg Pu(81.6) at H/X = 109 with H/SQRT(A) = 0.217
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=89.510)
# Tank/Inner:  Width = Tc
...
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 126.6765, 171.0635, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -148.0))
