"""
PU-SOL-THERM-022 (Case 17) Hc = 92.09 @ H/X=576; 18.88 wt-% Pu-240; Paraffin + Cd
...
mat1.add_nuclide("Pu239", 1.004100e-04)
mat1.add_nuclide("Pu240", 2.544300e-05)
mat1.add_nuclide("Pu241", 7.710200e-06)
mat1.add_nuclide("Pu242", 1.523600e-06)
mat1.add_nuclide("Am241", 6.439400e-07)
mat1.add_element("N", 1.872500e-03)
mat1.add_nuclide("O16", 3.614400e-02)
mat1.add_nuclide("H1", 6.232300e-02)
mat1.add_element("Fe", 1.347900e-05)
mat1.add_element("Cr", 4.334500e-06)
mat1.add_element("Ni", 3.072100e-06)
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=92.09)
...
source.space = openmc.stats.Box((-18.0, -18.0, 45.0), (18.0, 18.0, 47.0))
