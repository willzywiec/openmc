"""
PU-SOL-THERM-041-3: Experiment 232 with 61.35 gPu(3)/L at H/X=384; Hc=28.07
...
surf7 = openmc.ZPlane(surface_id=7, z0=27.05)
...
source.space = openmc.stats.Box((-18.5, -18.5, 13.275), (18.5, 18.5, 15.275))
