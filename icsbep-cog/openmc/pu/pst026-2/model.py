"""
PU-SOL-THERM-026 (Case 2) 8.156 kg Pu(95.4) at H/X = 446 with H/SQRT(A) = 0.174
...
mat1.add_nuclide("Pu238", 8.758100e-09)
mat1.add_nuclide("Pu239", 1.381700e-04)
mat1.add_nuclide("Pu240", 6.761200e-06)
mat1.add_nuclide("Pu241", 3.675700e-07)
mat1.add_nuclide("Pu242", 1.291900e-08)
mat1.add_nuclide("H1", 6.184300e-02)
mat1.add_element("N", 2.014600e-03)
mat1.add_nuclide("O16", 3.624800e-02)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=81.509)
# Tank/Inner: Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 140.74200000000002, 156.998, -192.929, -86.249)
# Tank/Outer: Width = Tc + 0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 140.583, 157.157, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 129.15300000000002, 168.587, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -152.0))
