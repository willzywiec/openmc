"""
PU-SOL-THERM-025 (Case 11) 5.564 kg Pu(80.45) at H/X = 457 with H/SQRT(A) = 0.184; 18.40 wt-% Pu-240
...
# Hc (Solution)
surf1 = openmc.ZPlane(surface_id=1, z0=49.017)
...
source.space = openmc.stats.Point((0.0, 2.71, 24.5))
