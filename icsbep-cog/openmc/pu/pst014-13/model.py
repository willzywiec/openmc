"""
PU-SOL-THERM-014 (Case 13) Three cylinders with 0 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=23.12)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=17.3205, y0=0.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=-8.66025, y0=15.0, r=15.0)
# Table 1 and Figure 7
surf13 = openmc.ZCylinder(surface_id=13, x0=-8.66025, y0=-15.0, r=15.0)
...
source.space = openmc.stats.Box((-9.7, -16.0, -1.0), (18.3, 16.0, 12.56))
