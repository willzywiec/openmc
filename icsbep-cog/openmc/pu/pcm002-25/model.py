"""
PU-COMP-MIXED-002 (Case 25) 17.728 kg Pu @ H/X = 61.9 with 18.50 wt-% Pu-240 and H/SQRT(A) = 0.367
...
surf1 = openmc.model.RectangularParallelepiped(-25.45, 25.45, -25.45, 25.45, -9.34, 9.34)
# 6" (15.24 cm) Plexiglas Reflector
surf2 = openmc.model.RectangularParallelepiped(-40.69, 40.69, -40.69, 40.69, -24.58, 24.58, boundary_type="vacuum")
