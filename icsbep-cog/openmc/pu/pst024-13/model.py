"""
PU-SOL-THERM-024 (Case 13) 26.134 kg Pu(80.45) at H/X = 179 with H/SQRT(A) = 0.158; 18.40 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=95.6818)
# Tank/Inner:  Width = Tc
...
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 138.17000000000002, 159.57, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf5 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 129.28, 168.46, -193.379, -85.799)
# U-Frame/Inner
