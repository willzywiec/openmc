...
mat1.add_nuclide("Pu238", 5.026100e-08)
mat1.add_nuclide("Pu239", 5.408900e-05)
mat1.add_nuclide("Pu240", 3.330500e-05)
mat1.add_nuclide("Pu241", 7.816200e-06)
mat1.add_nuclide("Pu242", 3.245400e-06)
mat1.add_nuclide("Am241", 3.655500e-07)
mat1.add_element("N", 2.650600e-03)
mat1.add_nuclide("H1", 6.025400e-02)
mat1.add_nuclide("O16", 3.695300e-02)
mat1.add_element("Fe", 7.871700e-07)
mat1.add_element("Cr", 2.113700e-07)
mat1.add_element("Ni", 1.040300e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=22.95)
