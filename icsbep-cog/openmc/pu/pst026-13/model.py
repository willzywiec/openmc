"""
PU-SOL-THERM-026 (Case 13) 19.666 kg Pu(81.6) at H/X = 179 with H/SQRT(A) = 0.281
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=54.000)
# Tank/Inner:  Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -165.9))
