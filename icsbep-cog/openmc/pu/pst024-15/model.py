"""
PU-SOL-THERM-024 (Case 15) 19.919 kg Pu(75.78) at H/X = 153 with H/SQRT(A) = 0.314; 23.2 wt-% Pu-240
...
mat1.add_nuclide("Pu238", 3.570000e-07)
mat1.add_nuclide("Pu239", 3.647500e-04)
mat1.add_nuclide("Pu240", 1.172600e-04)
mat1.add_nuclide("Pu241", 1.993400e-05)
mat1.add_nuclide("Pu242", 4.845000e-06)
mat1.add_nuclide("Am241", 1.057600e-06)
mat1.add_element("N", 2.995300e-03)
mat1.add_nuclide("O16", 3.791600e-02)
mat1.add_nuclide("H1", 5.882500e-02)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=43.4086)
# Tank/Inner:  Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 138.202, 159.538, -192.929, -86.249)
# Tank/Outer:  Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 138.043, 159.697, -193.379, -85.799)
# Plex/Outer:  Width = Tc +  5.398
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 135.50300000000001, 162.237, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf5 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 126.613, 171.127, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -171.0))
