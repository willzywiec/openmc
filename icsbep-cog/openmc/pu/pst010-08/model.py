"""
PU-SOL-THERM-010 (Case 11-5) 0.973 kg Pu(97.15) @ H/X = 665 in a water reflected 11" diameter SS-347 cylinder
...
mat1.add_nuclide("Pu239", 9.030800e-05)
mat1.add_nuclide("Pu240", 2.638200e-06)
mat1.add_element("N", 2.913700e-03)
mat1.add_nuclide("H1", 6.009000e-02)
mat1.add_nuclide("O16", 3.751500e-02)
mat1.add_element("Fe", 2.836000e-06)
...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=43.0022)
# Cylinder/Inner
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=43.1597)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=73.6397)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=43.0022)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=73.7972)
...
source.space = openmc.stats.Point((0.0, 0.0, 21.5))
