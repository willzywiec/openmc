...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -34.6285, -25.9415, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-40.38, 40.38, -35.365, -25.205, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -14.438500000000001, -5.751500000000001, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-40.38, 40.38, -15.175, -5.015000000000001, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 5.751500000000001, 14.438500000000001, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-40.38, 40.38, 5.015000000000001, 15.175, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 25.9415, 34.6285, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-40.38, 40.38, 25.205, 35.365, 216.35500000000002, 221.435)
# Hole
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-30.285, y0=-30.285, r=3.607)
surf102 = openmc.ZCylinder(surface_id=102, x0=-30.285, y0=-10.095, r=3.607)
surf103 = openmc.ZCylinder(surface_id=103, x0=-30.285, y0=10.095, r=3.607)
surf104 = openmc.ZCylinder(surface_id=104, x0=-30.285, y0=30.285, r=3.607)
surf105 = openmc.ZCylinder(surface_id=105, x0=-10.095, y0=-30.285, r=3.607)
surf106 = openmc.ZCylinder(surface_id=106, x0=-10.095, y0=-10.095, r=3.607)
surf107 = openmc.ZCylinder(surface_id=107, x0=-10.095, y0=10.095, r=3.607)
surf108 = openmc.ZCylinder(surface_id=108, x0=-10.095, y0=30.285, r=3.607)
surf109 = openmc.ZCylinder(surface_id=109, x0=10.095, y0=-30.285, r=3.607)
surf110 = openmc.ZCylinder(surface_id=110, x0=10.095, y0=-10.095, r=3.607)
surf111 = openmc.ZCylinder(surface_id=111, x0=10.095, y0=10.095, r=3.607)
surf112 = openmc.ZCylinder(surface_id=112, x0=10.095, y0=30.285, r=3.607)
surf113 = openmc.ZCylinder(surface_id=113, x0=30.285, y0=-30.285, r=3.607)
surf114 = openmc.ZCylinder(surface_id=114, x0=30.285, y0=-10.095, r=3.607)
surf115 = openmc.ZCylinder(surface_id=115, x0=30.285, y0=10.095, r=3.607)
surf116 = openmc.ZCylinder(surface_id=116, x0=30.285, y0=30.285, r=3.607)
...
surf61_zmax = openmc.ZPlane(z0=92.8442)
surf62_zmin = openmc.ZPlane(z0=92.8442)
surf62_zmax = openmc.ZPlane(z0=103.7958)
surf63_zmin = openmc.ZPlane(z0=103.7958)
surf63_zmax = openmc.ZPlane(z0=105.9642)
surf64_zmin = openmc.ZPlane(z0=105.9642)
surf64_zmax = openmc.ZPlane(z0=116.9158)
surf65_zmin = openmc.ZPlane(z0=116.9158)
surf65_zmax = openmc.ZPlane(z0=119.0842)
surf66_zmin = openmc.ZPlane(z0=119.0842)
surf66_zmax = openmc.ZPlane(z0=130.0358)
surf67_zmin = openmc.ZPlane(z0=130.0358)
surf67_zmax = openmc.ZPlane(z0=132.2042)
surf68_zmin = openmc.ZPlane(z0=132.2042)
surf68_zmax = openmc.ZPlane(z0=143.1458)
