"""
PU-SOL-THERM-033-60: 99.05 gPu(3.13)/L at H/X=250.4 with 55 (4x40) pyrex tubes at 4.31cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=59.18)
...
# Pyrex tube #1
surf101 = openmc.ZCylinder(surface_id=101, x0=-4.31, y0=14.930278, r=2.00695)
# Pyrex tube #2
surf102 = openmc.ZCylinder(surface_id=102, x0=0.0, y0=14.930278, r=2.00695)
# Pyrex tube #3
surf103 = openmc.ZCylinder(surface_id=103, x0=4.31, y0=14.930278, r=2.00695)
# Pyrex tube #4
surf104 = openmc.ZCylinder(surface_id=104, x0=-10.775, y0=11.1977085, r=2.00695)
# Pyrex tube #5
surf105 = openmc.ZCylinder(surface_id=105, x0=-6.465, y0=11.1977085, r=2.00695)
# Pyrex tube #6
surf106 = openmc.ZCylinder(surface_id=106, x0=-2.115, y0=11.1977085, r=2.00695)
# Pyrex tube #7
surf107 = openmc.ZCylinder(surface_id=107, x0=2.115, y0=11.1977085, r=2.00695)
# Pyrex tube #8
surf108 = openmc.ZCylinder(surface_id=108, x0=6.465, y0=11.1977085, r=2.00695)
# Pyrex tube #9
surf109 = openmc.ZCylinder(surface_id=109, x0=10.775, y0=11.1977085, r=2.00695)
# Pyrex tube #10
surf110 = openmc.ZCylinder(surface_id=110, x0=-12.93, y0=7.465139, r=2.00695)
# Pyrex tube #11
surf111 = openmc.ZCylinder(surface_id=111, x0=-8.62, y0=7.465139, r=2.00695)
# Pyrex tube #12
surf112 = openmc.ZCylinder(surface_id=112, x0=-4.31, y0=7.465139, r=2.00695)
# Pyrex tube #13
surf113 = openmc.ZCylinder(surface_id=113, x0=0.0, y0=7.465139, r=2.00695)
# Pyrex tube #14
surf114 = openmc.ZCylinder(surface_id=114, x0=4.31, y0=7.465139, r=2.00695)
# Pyrex tube #15
surf115 = openmc.ZCylinder(surface_id=115, x0=8.62, y0=7.465139, r=2.00695)
# Pyrex tube #16
surf116 = openmc.ZCylinder(surface_id=116, x0=12.93, y0=7.465139, r=2.00695)
# Pyrex tube #17
surf117 = openmc.ZCylinder(surface_id=117, x0=-15.085, y0=3.7325695, r=2.00695)
# Pyrex tube #18
surf118 = openmc.ZCylinder(surface_id=118, x0=-10.775, y0=3.7325695, r=2.00695)
# Pyrex tube #19
surf119 = openmc.ZCylinder(surface_id=119, x0=-6.465, y0=3.7325695, r=2.00695)
# Pyrex tube #20
surf120 = openmc.ZCylinder(surface_id=120, x0=-2.155, y0=3.7325695, r=2.00695)
# Pyrex tube #21
surf121 = openmc.ZCylinder(surface_id=121, x0=2.155, y0=3.7325695, r=2.00695)
# Pyrex tube #22
surf122 = openmc.ZCylinder(surface_id=122, x0=6.465, y0=3.7325695, r=2.00695)
# Pyrex tube #23
surf123 = openmc.ZCylinder(surface_id=123, x0=10.775, y0=3.7325695, r=2.00695)
# Pyrex tube #24
surf124 = openmc.ZCylinder(surface_id=124, x0=15.085, y0=3.7325695, r=2.00695)
# Pyrex tube #25
surf125 = openmc.ZCylinder(surface_id=125, x0=-12.93, y0=0.0, r=2.00695)
# Pyrex tube #26
surf126 = openmc.ZCylinder(surface_id=126, x0=-8.62, y0=0.0, r=2.00695)
# Pyrex tube #27
surf127 = openmc.ZCylinder(surface_id=127, x0=-4.31, y0=0.0, r=2.00695)
# Pyrex tube #28
surf128 = openmc.ZCylinder(surface_id=128, x0=0.0, y0=0.0, r=2.00695)
# Pyrex tube #29
surf129 = openmc.ZCylinder(surface_id=129, x0=4.31, y0=0.0, r=2.00695)
# Pyrex tube #30
surf130 = openmc.ZCylinder(surface_id=130, x0=8.62, y0=0.0, r=2.00695)
# Pyrex tube #31
surf131 = openmc.ZCylinder(surface_id=131, x0=12.93, y0=0.0, r=2.00695)
# Pyrex tube #32
surf132 = openmc.ZCylinder(surface_id=132, x0=-15.085, y0=-3.7325695, r=2.00695)
# Pyrex tube #33
surf133 = openmc.ZCylinder(surface_id=133, x0=-10.775, y0=-3.7325695, r=2.00695)
# Pyrex tube #34
surf134 = openmc.ZCylinder(surface_id=134, x0=-6.465, y0=-3.7325695, r=2.00695)
# Pyrex tube #35
surf135 = openmc.ZCylinder(surface_id=135, x0=-2.155, y0=-3.7325695, r=2.00695)
# Pyrex tube #36
surf136 = openmc.ZCylinder(surface_id=136, x0=2.155, y0=-3.7325695, r=2.00695)
# Pyrex tube #37
surf137 = openmc.ZCylinder(surface_id=137, x0=6.465, y0=-3.7325695, r=2.00695)
# Pyrex tube #38
surf138 = openmc.ZCylinder(surface_id=138, x0=10.775, y0=-3.7325695, r=2.00695)
# Pyrex tube #39
surf139 = openmc.ZCylinder(surface_id=139, x0=15.085, y0=-3.7325695, r=2.00695)
# Pyrex tube #40
surf140 = openmc.ZCylinder(surface_id=140, x0=-12.93, y0=-7.465139, r=2.00695)
# Pyrex tube #41
surf141 = openmc.ZCylinder(surface_id=141, x0=-8.62, y0=-7.465139, r=2.00695)
# Pyrex tube #42
surf142 = openmc.ZCylinder(surface_id=142, x0=-4.31, y0=-7.465139, r=2.00695)
# Pyrex tube #43
surf143 = openmc.ZCylinder(surface_id=143, x0=0.0, y0=-7.465139, r=2.00695)
# Pyrex tube #44
surf144 = openmc.ZCylinder(surface_id=144, x0=4.31, y0=-7.465139, r=2.00695)
# Pyrex tube #45
surf145 = openmc.ZCylinder(surface_id=145, x0=8.62, y0=-7.465139, r=2.00695)
# Pyrex tube #46
surf146 = openmc.ZCylinder(surface_id=146, x0=12.93, y0=-7.465139, r=2.00695)
# Pyrex tube #47
surf147 = openmc.ZCylinder(surface_id=147, x0=-10.775, y0=-11.1977085, r=2.00695)
# Pyrex tube #48
surf148 = openmc.ZCylinder(surface_id=148, x0=-6.465, y0=-11.1977085, r=2.00695)
# Pyrex tube #49
surf149 = openmc.ZCylinder(surface_id=149, x0=-2.115, y0=-11.1977085, r=2.00695)
# Pyrex tube #50
surf150 = openmc.ZCylinder(surface_id=150, x0=2.115, y0=-11.1977085, r=2.00695)
# Pyrex tube #51
surf151 = openmc.ZCylinder(surface_id=151, x0=6.465, y0=-11.1977085, r=2.00695)
# Pyrex tube #52
surf152 = openmc.ZCylinder(surface_id=152, x0=10.775, y0=-11.1977085, r=2.00695)
# Pyrex tube #53
surf153 = openmc.ZCylinder(surface_id=153, x0=-4.31, y0=-14.930278, r=2.00695)
# Pyrex tube #54
surf154 = openmc.ZCylinder(surface_id=154, x0=0.0, y0=-14.930278, r=2.00695)
# Pyrex tube #55
surf155 = openmc.ZCylinder(surface_id=155, x0=4.31, y0=-14.930278, r=2.00695)

# Z-plane surfaces for bounded cylinders
surf3_zmin = openmc.ZPlane(surface_id=1155, z0=-0.3)
surf3_zmax = openmc.ZPlane(surface_id=1156, z0=80.7)
surf4_zmin = openmc.ZPlane(surface_id=1157, z0=-25.9)
surf4_zmax = openmc.ZPlane(surface_id=1158, z0=62.8)
surf6_zmin = openmc.ZPlane(surface_id=1159, z0=-26.3, boundary_type="vacuum")
surf6_zmax = openmc.ZPlane(surface_id=1160, z0=85.7, boundary_type="vacuum")
surf10_zmin = openmc.ZPlane(surface_id=1161, z0=1.2)
surf10_zmax = openmc.ZPlane(surface_id=1162, z0=82.2)
surf11_zmin = openmc.ZPlane(surface_id=1163, z0=1.2)
surf11_zmax = openmc.ZPlane(surface_id=1164, z0=1.38)
surf13_zmin = openmc.ZPlane(surface_id=1165, z0=81.8)
surf13_zmax = openmc.ZPlane(surface_id=1166, z0=82.2)
surf15_zmin = openmc.ZPlane(surface_id=1167, z0=1.38)
surf15_zmax = openmc.ZPlane(surface_id=1168, z0=81.8)
surf19_zmin = openmc.ZPlane(surface_id=1169, z0=2.5)
surf19_zmax = openmc.ZPlane(surface_id=1170, z0=2.7)
surf20_zmin = openmc.ZPlane(surface_id=1171, z0=39.3)
surf20_zmax = openmc.ZPlane(surface_id=1172, z0=39.5)
surf24_zmin = openmc.ZPlane(surface_id=1173, z0=1.5)
surf24_zmax = openmc.ZPlane(surface_id=1174, z0=41.5)
...
source.space = openmc.stats.Point((0.0, 0.0, 29.59))
