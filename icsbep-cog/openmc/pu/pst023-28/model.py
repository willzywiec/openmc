...
mat1.add_nuclide("Pu238", 7.978200e-09)
mat1.add_nuclide("Pu239", 1.038900e-04)
mat1.add_nuclide("Pu240", 4.583800e-06)
mat1.add_nuclide("Pu241", 3.088500e-07)
mat1.add_nuclide("Pu242", 1.719700e-08)
mat1.add_nuclide("Am241", 7.067600e-08)
mat1.add_element("N", 2.646500e-03)
mat1.add_nuclide("H1", 6.033400e-02)
mat1.add_nuclide("O16", 3.700400e-02)
mat1.add_element("Fe", 1.703700e-06)
mat1.add_element("Cr", 4.574800e-07)
mat1.add_element("Ni", 2.251700e-07)
...
# = Hc (Table 1)
surf7 = openmc.XPlane(surface_id=7, x0=20.81)
...
source.space = openmc.stats.Point((0.0, 0.0, 10.4))
