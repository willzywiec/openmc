"""
PU-SOL-THERM-041-37: Experiment 477 with 19.98 gPu(3.11)/L at H/X=1320; Hc=77.05
...
mat1.add_nuclide("Pu239", 4.870700e-05)
mat1.add_nuclide("Pu240", 1.558820e-06)
mat1.add_nuclide("Pu241", 5.598970e-08)
mat1.add_element("N", 1.158390e-03)
mat1.add_nuclide("O16", 3.517100e-02)
mat1.add_nuclide("H1", 6.436310e-02)
mat1.add_element("Fe", 1.865500e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=77.05)
...
source.space = openmc.stats.Box((-18.5, -18.5, 37.825), (18.5, 18.5, 39.825))
