"""
PMF023-1D: 2.35cm graphite reflected spherical assembly of 13.484 kg delta-239Pu(98%): detailed model
...
mat1.add_nuclide("Pu239", 3.682500e-02)
mat1.add_nuclide("Pu240", 6.731800e-04)
mat1.add_element("Ga", 2.199900e-03)
mat1.add_element("Fe", 1.471300e-04)
mat1.add_element("C", 3.040500e-04)
...
mat6.add_element("C", 9.184200e-02)
...
surf1 = openmc.Sphere(surface_id=1, r=1.715)
...
surf7 = openmc.Sphere(surface_id=7, r=8.350, boundary_type="vacuum")
