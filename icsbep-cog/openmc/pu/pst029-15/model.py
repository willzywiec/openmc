"""
PU-SOL-THERM-029 (Case 18; No. 171) Hc=69.00cm; D=7.5cm; 40.6 gPu/l; H/X=632; 2.98 wt-% Pu-240; Air/Water; Water
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=69.00)
...
# dY = 111.0 (fixed)
surf9 = openmc.model.RectangularParallelepiped(-84.05, 84.05, -55.5, 55.5, -32.800000000000004, 119.0)
...
source.space = openmc.stats.Box((-9.75, -1.0, 33.5), (9.75, 1.0, 35.5))
