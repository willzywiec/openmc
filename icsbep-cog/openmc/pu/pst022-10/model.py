"""
PU-SOL-THERM-022 (Case 10) Hc = 60.72 @ H/X=174; 18.88 wt-% Pu-240; Paraffin + Cd
...
mat1.add_nuclide("Pu239", 3.085300e-04)
mat1.add_nuclide("Pu240", 7.817600e-05)
mat1.add_nuclide("Pu241", 2.369100e-05)
mat1.add_nuclide("Pu242", 4.681300e-06)
mat1.add_nuclide("Am241", 1.978600e-06)
mat1.add_element("N", 3.720200e-03)
mat1.add_nuclide("O16", 3.907900e-02)
mat1.add_nuclide("H1", 5.770900e-02)
mat1.add_element("Fe", 4.097600e-05)
mat1.add_element("Cr", 1.317700e-05)
mat1.add_element("Ni", 9.339200e-06)
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=60.72)
...
source.space = openmc.stats.Box((-18.0, -18.0, 29.0), (18.0, 18.0, 31.0))
