...
surf61_zmax = openmc.ZPlane(surface_id=1141, z0=72.5685)
surf62_zmin = openmc.ZPlane(surface_id=1142, z0=72.5685)
surf62_zmax = openmc.ZPlane(surface_id=1143, z0=73.8392)
surf63_zmin = openmc.ZPlane(surface_id=1144, z0=73.8392)
surf63_zmax = openmc.ZPlane(surface_id=1145, z0=84.7908)
surf64_zmin = openmc.ZPlane(surface_id=1146, z0=84.7908)
surf64_zmax = openmc.ZPlane(surface_id=1147, z0=86.0615)
surf65_zmin = openmc.ZPlane(surface_id=1148, z0=86.0615)
surf65_zmax = openmc.ZPlane(surface_id=1149, z0=98.3585)
surf66_zmin = openmc.ZPlane(surface_id=1150, z0=98.3585)
surf66_zmax = openmc.ZPlane(surface_id=1151, z0=99.6292)
surf67_zmin = openmc.ZPlane(surface_id=1152, z0=99.6292)
surf67_zmax = openmc.ZPlane(surface_id=1153, z0=110.5808)
surf68_zmin = openmc.ZPlane(surface_id=1154, z0=110.5808)
surf68_zmax = openmc.ZPlane(surface_id=1155, z0=111.8515)
surf69_zmin = openmc.ZPlane(surface_id=1156, z0=111.8515)
surf69_zmax = openmc.ZPlane(surface_id=1157, z0=124.1485)
surf70_zmin = openmc.ZPlane(surface_id=1158, z0=124.1485)
surf70_zmax = openmc.ZPlane(surface_id=1159, z0=125.4192)
surf71_zmin = openmc.ZPlane(surface_id=1160, z0=125.4192)
surf71_zmax = openmc.ZPlane(surface_id=1161, z0=136.3708)
surf72_zmin = openmc.ZPlane(surface_id=1162, z0=136.3708)
surf72_zmax = openmc.ZPlane(surface_id=1163, z0=137.6415)
surf73_zmin = openmc.ZPlane(surface_id=1164, z0=137.6415)
surf73_zmax = openmc.ZPlane(surface_id=1165, z0=149.9385)
surf74_zmin = openmc.ZPlane(surface_id=1166, z0=149.9385)
surf74_zmax = openmc.ZPlane(surface_id=1167, z0=151.2092)
surf75_zmin = openmc.ZPlane(surface_id=1168, z0=151.2092)
surf75_zmax = openmc.ZPlane(surface_id=1169, z0=162.1608)
surf76_zmin = openmc.ZPlane(surface_id=1170, z0=162.1608)
surf76_zmax = openmc.ZPlane(surface_id=1171, z0=163.4315)
surf81_zmin = openmc.ZPlane(surface_id=1172, z0=72.5685)
surf81_zmax = openmc.ZPlane(surface_id=1173, z0=86.0615)
surf82_zmin = openmc.ZPlane(surface_id=1174, z0=98.3585)
surf82_zmax = openmc.ZPlane(surface_id=1175, z0=111.8515)
surf83_zmin = openmc.ZPlane(surface_id=1176, z0=124.1485)
surf83_zmax = openmc.ZPlane(surface_id=1177, z0=137.6415)
surf84_zmin = openmc.ZPlane(surface_id=1178, z0=149.9385)
surf84_zmax = openmc.ZPlane(surface_id=1179, z0=163.4315)
