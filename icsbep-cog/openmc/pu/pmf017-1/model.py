"""
PMF017-1: LLNL Pu Array Phase II - MHE - 4x4x4 - 6kg - case 201
...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -30.5935, -21.9065, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-35.0, 35.0, -31.33, -21.17, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -13.093499999999999, -4.4065, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-35.0, 35.0, -13.83, -3.67, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 4.4065, 13.093499999999999, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-35.0, 35.0, 3.67, 13.83, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 21.9065, 30.5935, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-35.0, 35.0, 21.17, 31.33, 216.35500000000002, 221.435)
# Hole
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-26.25, y0=-26.25, r=5.0848)
surf102 = openmc.ZCylinder(surface_id=102, x0=-26.25, y0=-8.75, r=5.0848)
surf103 = openmc.ZCylinder(surface_id=103, x0=-26.25, y0=8.75, r=5.0848)
surf104 = openmc.ZCylinder(surface_id=104, x0=-26.25, y0=26.25, r=5.0848)
surf105 = openmc.ZCylinder(surface_id=105, x0=-8.75, y0=-26.25, r=5.0848)
surf106 = openmc.ZCylinder(surface_id=106, x0=-8.75, y0=-8.75, r=5.0848)
surf107 = openmc.ZCylinder(surface_id=107, x0=-8.75, y0=8.75, r=5.0848)
surf108 = openmc.ZCylinder(surface_id=108, x0=-8.75, y0=26.25, r=5.0848)
surf109 = openmc.ZCylinder(surface_id=109, x0=8.75, y0=-26.25, r=5.0848)
surf110 = openmc.ZCylinder(surface_id=110, x0=8.75, y0=-8.75, r=5.0848)
surf111 = openmc.ZCylinder(surface_id=111, x0=8.75, y0=8.75, r=5.0848)
surf112 = openmc.ZCylinder(surface_id=112, x0=8.75, y0=26.25, r=5.0848)
surf113 = openmc.ZCylinder(surface_id=113, x0=26.25, y0=-26.25, r=5.0848)
surf114 = openmc.ZCylinder(surface_id=114, x0=26.25, y0=-8.75, r=5.0848)
surf115 = openmc.ZCylinder(surface_id=115, x0=26.25, y0=8.75, r=5.0848)
surf116 = openmc.ZCylinder(surface_id=116, x0=26.25, y0=26.25, r=5.0848)
...
surf61_zmax = openmc.ZPlane(z0=72.5685)
surf62_zmin = openmc.ZPlane(z0=72.5685)
surf62_zmax = openmc.ZPlane(z0=73.8392)
surf63_zmin = openmc.ZPlane(z0=73.8392)
surf63_zmax = openmc.ZPlane(z0=84.7908)
surf64_zmin = openmc.ZPlane(z0=84.7908)
surf64_zmax = openmc.ZPlane(z0=86.0615)
surf65_zmin = openmc.ZPlane(z0=86.0615)
surf65_zmax = openmc.ZPlane(z0=98.3585)
surf66_zmin = openmc.ZPlane(z0=98.3585)
surf66_zmax = openmc.ZPlane(z0=99.6292)
surf67_zmin = openmc.ZPlane(z0=99.6292)
surf67_zmax = openmc.ZPlane(z0=110.5808)
surf68_zmin = openmc.ZPlane(z0=110.5808)
surf68_zmax = openmc.ZPlane(z0=111.8515)
surf69_zmin = openmc.ZPlane(z0=111.8515)
surf69_zmax = openmc.ZPlane(z0=124.1485)
surf70_zmin = openmc.ZPlane(z0=124.1485)
surf70_zmax = openmc.ZPlane(z0=125.4192)
surf71_zmin = openmc.ZPlane(z0=125.4192)
surf71_zmax = openmc.ZPlane(z0=136.3708)
surf72_zmin = openmc.ZPlane(z0=136.3708)
surf72_zmax = openmc.ZPlane(z0=137.6415)
surf73_zmin = openmc.ZPlane(z0=137.6415)
surf73_zmax = openmc.ZPlane(z0=149.9385)
surf74_zmin = openmc.ZPlane(z0=149.9385)
surf74_zmax = openmc.ZPlane(z0=151.2092)
surf75_zmin = openmc.ZPlane(z0=151.2092)
surf75_zmax = openmc.ZPlane(z0=162.1608)
surf76_zmin = openmc.ZPlane(z0=162.1608)
surf76_zmax = openmc.ZPlane(z0=163.4315)
surf81_zmin = openmc.ZPlane(z0=72.5685)
surf81_zmax = openmc.ZPlane(z0=86.0615)
surf82_zmin = openmc.ZPlane(z0=98.3585)
surf82_zmax = openmc.ZPlane(z0=111.8515)
surf83_zmin = openmc.ZPlane(z0=124.1485)
surf83_zmax = openmc.ZPlane(z0=137.6415)
surf84_zmin = openmc.ZPlane(z0=149.9385)
surf84_zmax = openmc.ZPlane(z0=163.4315)
...
source.space = openmc.stats.Box((-27.25, -27.25, 75.8117), (27.25, 27.25, 160.2783))
