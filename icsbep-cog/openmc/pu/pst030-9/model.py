"""
PU-SOL-THERM-030-9: Exp. No. 488 with H/X=562 with AIR in the central cavity
...
mat1.add_nuclide("Pu239", 1.118800e-04)
mat1.add_nuclide("Pu240", 1.697100e-06)
mat1.add_nuclide("Pu241", 3.380100e-08)
mat1.add_nuclide("H1", 6.284400e-02)
mat1.add_nuclide("O16", 3.142200e-02)
mat1.add_nuclide("O16", 4.404200e-03)
mat1.add_element("N", 1.668800e-03)
mat1.add_element("Fe", 3.321200e-06)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=26.34)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 13.17))
