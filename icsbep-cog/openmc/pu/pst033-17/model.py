...
surf20_zmin = openmc.ZPlane(surface_id=1135, z0=39.3)
...
surf22_zmin = openmc.ZPlane(surface_id=1139, z0=39.435)
surf22_zmax = openmc.ZPlane(surface_id=1140, z0=39.5)
surf24_zmin = openmc.ZPlane(surface_id=1141, z0=1.5)
surf24_zmax = openmc.ZPlane(surface_id=1142, z0=41.5)
