"""
PU-SOL-THERM-014 (Case 15) Three cylinders with 30 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=36.28)
...
source.space = openmc.stats.Box((-18.3, -31.0, 17.1), (35.6, 31.0, 19.1))
