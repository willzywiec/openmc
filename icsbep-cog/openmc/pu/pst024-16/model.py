"""
PU-SOL-THERM-024 (Case 16) 21.430 kg Pu(75.78) at H/X = 153 with H/SQRT(A) = 0.276; 23.2 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=49.6570)
# Tank/Inner:  Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -168.0))
