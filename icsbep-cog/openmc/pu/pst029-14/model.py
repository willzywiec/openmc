"""
PU-SOL-THERM-029 (Case 17; No. 167) Hc=59.54cm; D=3.5cm; 40.6 gPu/l; H/X=632; 2.98 wt-% Pu-240; Air/Water; Water
...
# = Hc per Table 1
surf2 = openmc.ZPlane(surface_id=2, z0=59.54)
...
# dY = 111.0 (fixed)
surf9 = openmc.model.RectangularParallelepiped(-82.05, 82.05, -55.5, 55.5, -32.800000000000004, 119.0)
...
source.space = openmc.stats.Box((-7.75, -1.0, 28.8), (7.75, 1.0, 30.8))
