"""
PU-SOL-THERM-041-27: Experiment 417 with 55.08 gPu(3.11)/L at H/X=469; Hc=26.63
...
mat1.add_nuclide("Pu239", 1.342730e-04)
mat1.add_nuclide("Pu240", 4.297280e-06)
mat1.add_nuclide("Pu241", 1.651220e-07)
mat1.add_element("N", 1.654870e-03)
mat1.add_nuclide("O16", 3.591960e-02)
mat1.add_nuclide("H1", 6.299400e-02)
mat1.add_element("Fe", 5.316120e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=26.63)
...
source.space = openmc.stats.Box((-18.5, -18.5, 13.065), (18.5, 18.5, 15.065))
