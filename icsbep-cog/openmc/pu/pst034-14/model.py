"""
PU-SOL-THERM-034-14: 57.020 kg Pu(8.3) @ H/X=58.5 with 18.40 gGd/L
...
mat1.add_element("Gd", 7.046400e-05)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=53.70)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 26.85))
