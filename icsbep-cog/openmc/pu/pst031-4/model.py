"""
PU-SOL-THERM-031-4: H/X=476 and 6 Hafnium Plates with 8.3346 cm Pitch
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=52.96)
# SST tank, inner
...
u3_cell0.region = +surf1 & -surf2 & -surf5 & +surf51 & +surf52 & +surf53 & +surf54 & +surf55 & +surf56
u3_cell1 = openmc.Cell(fill=mat1)
u3_cell1.region = -surf1 & -surf2 & +surf4 & -surf5 & +surf11 & +surf12 & +surf13 & +surf14 & +surf51 & +surf52 & +surf53 & +surf54 & +surf55 & +surf56
u3_cell2 = openmc.Cell(fill=mat5)
u3_cell2.region = -surf51 & -surf52 & -surf53 & -surf54 & -surf55 & -surf56
...
source.space = openmc.stats.Box((-1.0, -9.2208, 25.48), (1.0, 9.4484, 27.48))
