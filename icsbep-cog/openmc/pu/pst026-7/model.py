"""
PU-SOL-THERM-026 (Case 7) 7.604 kg Pu(81.6) at H/X = 457 with H/SQRT(A) = 0.291; 18.4 wt-8 Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=50.239)
# Tank/Inner: Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -167.8))
