"""
PU-MET-FAST-045: LAMPRE Assembly II (Simplified Model)
...
surf3_zmax = openmc.ZPlane(z0=12.8726)
surf4_zmin = openmc.ZPlane(z0=-0.2032)
surf4_zmax = openmc.ZPlane(z0=13.0758)
surf5_zmin = openmc.ZPlane(z0=-1.9558)
surf5_zmax = openmc.ZPlane(z0=14.8284)
surf6_zmin = openmc.ZPlane(z0=-1.9558)
surf6_zmax = openmc.ZPlane(z0=14.8284)
surf7_zmin = openmc.ZPlane(z0=-9.5758)
surf7_zmax = openmc.ZPlane(z0=35.1484)
...
source.space = openmc.stats.Point((0.0, 0.0, 6.4))
