"""
PU-SOL-THERM-031-18: H/X=1330 with no Hafnium
...
mat1.add_nuclide("U238", 5.818400e-08)
mat1.add_nuclide("Pu239", 4.342200e-05)
mat1.add_nuclide("Pu240", 1.088500e-05)
mat1.add_nuclide("Pu241", 2.908200e-06)
mat1.add_nuclide("Pu242", 6.467900e-07)
mat1.add_nuclide("Am241", 6.532100e-07)
mat1.add_nuclide("H1", 6.161500e-02)
mat1.add_nuclide("O16", 3.619100e-02)
mat1.add_element("N", 2.099700e-03)
mat1.add_element("Fe", 7.979600e-06)
mat1.add_element("Cr", 2.424100e-06)
mat1.add_element("Ni", 1.793600e-06)
mat1.add_element("Mn", 2.143000e-07)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=46.03)
# SST tank, inner
...
source.space = openmc.stats.Point((0.0, 0.0, 23.015))
