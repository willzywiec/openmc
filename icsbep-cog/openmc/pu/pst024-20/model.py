"""
PU-SOL-THERM-024 (Case 20) 6.190 kg Pu(80.45) at H/X = 457 with H/SQRT(A) = 0.267; 18.4 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=46.4185)
# Tank/Inner:  Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 139.472, 158.268, -192.929, -86.249)
# Tank/Outer:  Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 139.31300000000002, 158.427, -193.379, -85.799)
# Plex/Outer:  Width = Tc +  5.398
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 136.773, 160.967, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf5 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 127.88300000000001, 169.857, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -169.0))
