"""
PU-SOL-THERM-010 (Case 9-3) 0.997 kg Pu(97.15) @ H/X = 484 in a water reflected 9" diameter SS-347 cylinder
...
mat1.add_nuclide("Pu239", 1.334500e-04)
mat1.add_nuclide("Pu240", 3.898700e-06)
mat1.add_element("N", 1.163500e-03)
mat1.add_nuclide("H1", 6.461400e-02)
mat1.add_nuclide("O16", 3.549000e-02)
...
mat3.add_nuclide("H1", 6.663400e-02)
mat3.add_nuclide("O16", 3.331700e-02)
...
# = Hc
surf5 = openmc.ZPlane(surface_id=5, z0=44.5770)
# Cylinder/Inner
...
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=44.7345)
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=75.2145)
surf4_zmin = openmc.ZPlane(surface_id=1010, z0=44.577)
surf4_zmax = openmc.ZPlane(surface_id=1011, z0=75.372)
...
source.space = openmc.stats.Point((0.0, 0.0, 22.3))
