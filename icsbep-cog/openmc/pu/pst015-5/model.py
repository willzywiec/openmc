"""
PU-SOL-THERM-015 (Case 5) Two cylinders with 50 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=40.86)
...
source.space = openmc.stats.Box((-1.0, -41.0, 19.4), (1.0, 41.0, 21.4))
