"""
PU-SOL-THERM-041-35: Experiment 472 with 23.2 gPu(3.11)/L at H/X=1135; Hc=53.99
...
surf7 = openmc.ZPlane(surface_id=7, z0=53.99)
...
source.space = openmc.stats.Box((-18.5, -18.5, 26.745), (18.5, 18.5, 28.745))
