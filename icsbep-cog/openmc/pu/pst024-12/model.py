"""
PU-SOL-THERM-024 (Case 12) 23.448 kg Pu(80.45) at H/X = 179 with H/SQRT(A) = 0.171; 18.40 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=84.5058)
# Tank/Inner:  Width = Tc
...
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 138.043, 159.697, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf5 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 129.15300000000002, 168.587, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -151.0))
