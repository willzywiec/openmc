"""
PMF042-8S: Pu hemisphere reflected by 2.333 cm steel and infinite oil; simplified model
...
# Steel
# surf3: Unsupported surface type "s" with params ['8.666', 'tr', '-2.37375', '0', '-6.333']
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=1.17)
# BCD
