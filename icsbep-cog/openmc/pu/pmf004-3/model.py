...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -23.9785, -15.291500000000003, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-26.18, 26.18, -24.715000000000003, -14.555000000000001, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -10.8885, -2.2015000000000002, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-26.18, 26.18, -11.625, -1.4649999999999999, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 2.2015000000000002, 10.8885, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-26.18, 26.18, 1.4649999999999999, 11.625, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 15.291500000000003, 23.9785, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-26.18, 26.18, 14.555000000000001, 24.715000000000003, 216.35500000000002, 221.435)
# Hole
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-19.635, y0=-19.635, r=3.607)
surf102 = openmc.ZCylinder(surface_id=102, x0=-19.635, y0=-6.545, r=3.607)
surf103 = openmc.ZCylinder(surface_id=103, x0=-19.635, y0=6.545, r=3.607)
surf104 = openmc.ZCylinder(surface_id=104, x0=-19.635, y0=19.635, r=3.607)
surf105 = openmc.ZCylinder(surface_id=105, x0=-6.545, y0=-19.635, r=3.607)
surf106 = openmc.ZCylinder(surface_id=106, x0=-6.545, y0=-6.545, r=3.607)
surf107 = openmc.ZCylinder(surface_id=107, x0=-6.545, y0=6.545, r=3.607)
surf108 = openmc.ZCylinder(surface_id=108, x0=-6.545, y0=19.635, r=3.607)
surf109 = openmc.ZCylinder(surface_id=109, x0=6.545, y0=-19.635, r=3.607)
surf110 = openmc.ZCylinder(surface_id=110, x0=6.545, y0=-6.545, r=3.607)
surf111 = openmc.ZCylinder(surface_id=111, x0=6.545, y0=6.545, r=3.607)
surf112 = openmc.ZCylinder(surface_id=112, x0=6.545, y0=19.635, r=3.607)
surf113 = openmc.ZCylinder(surface_id=113, x0=19.635, y0=-19.635, r=3.607)
surf114 = openmc.ZCylinder(surface_id=114, x0=19.635, y0=-6.545, r=3.607)
surf115 = openmc.ZCylinder(surface_id=115, x0=19.635, y0=6.545, r=3.607)
surf116 = openmc.ZCylinder(surface_id=116, x0=19.635, y0=19.635, r=3.607)
...
surf61_zmax = openmc.ZPlane(z0=64.3442)
surf62_zmin = openmc.ZPlane(z0=64.3442)
surf62_zmax = openmc.ZPlane(z0=75.2958)
surf63_zmin = openmc.ZPlane(z0=75.2958)
surf63_zmax = openmc.ZPlane(z0=96.4642)
surf64_zmin = openmc.ZPlane(z0=96.4642)
surf64_zmax = openmc.ZPlane(z0=107.4158)
surf65_zmin = openmc.ZPlane(z0=107.4158)
surf65_zmax = openmc.ZPlane(z0=128.5842)
surf66_zmin = openmc.ZPlane(z0=128.5842)
surf66_zmax = openmc.ZPlane(z0=139.5358)
surf67_zmin = openmc.ZPlane(z0=139.5358)
surf67_zmax = openmc.ZPlane(z0=160.7042)
surf68_zmin = openmc.ZPlane(z0=160.7042)
surf68_zmax = openmc.ZPlane(z0=171.6558)
