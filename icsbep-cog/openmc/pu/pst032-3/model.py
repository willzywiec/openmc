"""
PU-SOL-THERM-032-3: H/X=544 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 6.394000e-08)
mat1.add_nuclide("Pu239", 1.128500e-04)
mat1.add_nuclide("Pu240", 1.263100e-05)
mat1.add_nuclide("Pu241", 1.616400e-06)
mat1.add_nuclide("Pu242", 1.131900e-07)
mat1.add_nuclide("H1", 6.266900e-02)
mat1.add_nuclide("O16", 3.588100e-02)
mat1.add_element("N", 1.716100e-03)
mat1.add_element("Fe", 8.464800e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=31.28)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 15.64))
