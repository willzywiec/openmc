"""
PU-SOL-THERM-014 (Case 7) Three cylinders with 0 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=28.30)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-30.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=30.0, r=15.0)
...
cell6.region = (+surf2 | -surf2_zmin | +surf2_zmax) & (-surf3 & +surf3_zmin & -surf3_zmax)
