"""
PU-SOL-THERM-041-24: Experiment 378 with 76.81 gPu(3.11)/L at H/X=335; Hc=24.41; Hw=101.40 (cavity)
...
mat1.add_nuclide("Pu239", 1.872470e-04)
mat1.add_nuclide("Pu240", 5.992630e-06)
mat1.add_nuclide("Pu241", 2.302650e-07)
mat1.add_element("N", 1.751420e-03)
mat1.add_nuclide("O16", 3.618300e-02)
mat1.add_nuclide("H1", 6.281510e-02)
mat1.add_element("Fe", 6.674810e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=24.41)
...
source.space = openmc.stats.Box((-18.5, -18.5, 11.955), (18.5, 18.5, 13.955))
