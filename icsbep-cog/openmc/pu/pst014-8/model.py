"""
PU-SOL-THERM-014 (Case 8) Three cylinders with 5 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=31.84)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=0.0, y0=-35.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=35.0, r=15.0)
...
source.space = openmc.stats.Point((0.0, 0.0, 15.9))
