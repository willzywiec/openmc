"""
PU-SOL-THERM-012 (Case 11) Hc = 27.15 @ H/X=1457; 18.91 wt-% Pu-240; 5 sides water reflection
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=27.15)
# Lucoflex/Inner
...
source.space = openmc.stats.Point((0.0, 0.0, 13.6))
