"""
PU-SOL-THERM-041-12: Experiment 294 with 41.3 gPu(3)/L at H/X=583; Hc=32.37
...
mat1.add_nuclide("Pu239", 1.008050e-04)
mat1.add_nuclide("Pu240", 3.108210e-06)
mat1.add_nuclide("Pu241", 1.134940e-07)
mat1.add_element("N", 2.957520e-03)
mat1.add_nuclide("O16", 3.700480e-02)
mat1.add_nuclide("H1", 5.879370e-02)
mat1.add_element("Fe", 4.043700e-06)
...
surf7 = openmc.ZPlane(surface_id=7, z0=32.37)
...
source.space = openmc.stats.Box((-18.5, -18.5, 15.934999999999999), (18.5, 18.5, 17.935))
