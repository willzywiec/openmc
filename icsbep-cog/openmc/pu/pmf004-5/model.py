"""
PMF004-5: LLNL Pu Array Phase II - bare - 4x4x4 - 6kg - case 211
...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -27.188499999999998, -18.5015, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-30.46, 30.46, -27.924999999999997, -17.765, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -11.9585, -3.2715000000000005, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-30.46, 30.46, -12.695, -2.535, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 3.2715000000000005, 11.9585, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-30.46, 30.46, 2.535, 12.695, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 18.5015, 27.188499999999998, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-30.46, 30.46, 17.765, 27.924999999999997, 216.35500000000002, 221.435)
# Hole
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-22.845, y0=-22.845, r=3.607)
surf102 = openmc.ZCylinder(surface_id=102, x0=-22.845, y0=-7.615, r=3.607)
surf103 = openmc.ZCylinder(surface_id=103, x0=-22.845, y0=7.615, r=3.607)
surf104 = openmc.ZCylinder(surface_id=104, x0=-22.845, y0=22.845, r=3.607)
surf105 = openmc.ZCylinder(surface_id=105, x0=-7.615, y0=-22.845, r=3.607)
surf106 = openmc.ZCylinder(surface_id=106, x0=-7.615, y0=-7.615, r=3.607)
surf107 = openmc.ZCylinder(surface_id=107, x0=-7.615, y0=7.615, r=3.607)
surf108 = openmc.ZCylinder(surface_id=108, x0=-7.615, y0=22.845, r=3.607)
surf109 = openmc.ZCylinder(surface_id=109, x0=7.615, y0=-22.845, r=3.607)
surf110 = openmc.ZCylinder(surface_id=110, x0=7.615, y0=-7.615, r=3.607)
surf111 = openmc.ZCylinder(surface_id=111, x0=7.615, y0=7.615, r=3.607)
surf112 = openmc.ZCylinder(surface_id=112, x0=7.615, y0=22.845, r=3.607)
surf113 = openmc.ZCylinder(surface_id=113, x0=22.845, y0=-22.845, r=3.607)
surf114 = openmc.ZCylinder(surface_id=114, x0=22.845, y0=-7.615, r=3.607)
surf115 = openmc.ZCylinder(surface_id=115, x0=22.845, y0=7.615, r=3.607)
surf116 = openmc.ZCylinder(surface_id=116, x0=22.845, y0=22.845, r=3.607)
...
surf61_zmax = openmc.ZPlane(z0=79.3442)
surf62_zmin = openmc.ZPlane(z0=79.3442)
surf62_zmax = openmc.ZPlane(z0=90.2958)
surf63_zmin = openmc.ZPlane(z0=90.2958)
surf63_zmax = openmc.ZPlane(z0=101.4642)
surf64_zmin = openmc.ZPlane(z0=101.4642)
surf64_zmax = openmc.ZPlane(z0=112.4158)
surf65_zmin = openmc.ZPlane(z0=112.4158)
surf65_zmax = openmc.ZPlane(z0=123.5842)
surf66_zmin = openmc.ZPlane(z0=123.5842)
surf66_zmax = openmc.ZPlane(z0=134.5358)
surf67_zmin = openmc.ZPlane(z0=134.5358)
surf67_zmax = openmc.ZPlane(z0=145.7042)
surf68_zmin = openmc.ZPlane(z0=145.7042)
surf68_zmax = openmc.ZPlane(z0=156.6558)
...
source.space = openmc.stats.Box((-23.845, -23.845, 81.3167), (23.845, 23.845, 154.7733))
