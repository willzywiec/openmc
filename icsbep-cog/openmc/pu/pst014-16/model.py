"""
PU-SOL-THERM-014 (Case 16) Three cylinders with 60 cm s-to-s
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=38.53)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=51.9615, y0=0.0, r=15.0)
# Table 1 and Figure 7
surf12 = openmc.ZCylinder(surface_id=12, x0=-25.98075, y0=45.0, r=15.0)
# Table 1 and Figure 7
surf13 = openmc.ZCylinder(surface_id=13, x0=-25.98075, y0=-45.0, r=15.0)
...
source.space = openmc.stats.Box((-27.0, -46.0, 18.0), (53.0, 46.0, 20.0))
