"""
PU-SOL-THERM-041-31: Experiment 458 with 30.25 gPu(3.11)/L at H/X=866; Hc=38.08
...
surf7 = openmc.ZPlane(surface_id=7, z0=38.08)
...
source.space = openmc.stats.Box((-18.5, -18.5, 18.79), (18.5, 18.5, 20.79))
