"""
PU-SOL-THERM-034-5: 16.382 kg Pu(8.3) @ H/X=228 with 1.92 gGd/L
...
mat1.add_element("Gd", 7.352800e-06)
...
# Hc per Table 33
surf1 = openmc.ZPlane(surface_id=1, z0=48.28)
# Soln tank/inner
...
source.space = openmc.stats.Point((0.0, 0.0, 24.14))
