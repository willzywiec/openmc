"""
PU-SOL-THERM-033-45: 151.8 gPu(3.13)/L at H/X=159.2 with 19 (4x60) pyrex tubes at 4.31cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=46.32)
...
source.space = openmc.stats.Box((-3.155, -3.488, 22.16), (3.155, 3.488, 24.16))
