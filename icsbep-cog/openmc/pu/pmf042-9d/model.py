"""
PMF042-9D: Pu hemisphere reflected by 8x0.3228cm steel shells and infinite oil; detailed model
...
# Hc
surf2 = openmc.ZPlane(surface_id=2, z0=1.18)
# BCD
...
surf3_zmin = openmc.ZPlane(surface_id=1079, z0=-31.333, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(surface_id=1080, z0=18.667, boundary_type="vacuum")
...
cell2.region = +surf1 & +surf64 & -surf79

# Oil
cell3 = openmc.Cell(cell_id=3, fill=mat5)
cell3.region = +surf1 & -surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & +surf79
...
cell6.region = +surf1 & +surf2 & (-surf3 & +surf3_zmin & -surf3_zmax) & +surf79
