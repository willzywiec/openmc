"""
PU-SOL-THERM-012 (Case 9) Hc = 21.31 @ H/X=980; 18.91 wt-% Pu-240; 5 sides water reflection
...
mat1.add_nuclide("Pu239", 5.972350e-05)
mat1.add_nuclide("Pu240", 1.513300e-05)
mat1.add_nuclide("Pu241", 4.485910e-06)
mat1.add_nuclide("Pu242", 9.061670e-07)
mat1.add_nuclide("Am241", 4.861260e-07)
mat1.add_element("N", 1.566260e-03)
mat1.add_nuclide("O16", 3.557070e-02)
mat1.add_nuclide("H1", 6.295420e-02)
mat1.add_element("Fe", 7.548250e-06)
mat1.add_element("Cr", 2.427330e-06)
mat1.add_element("Ni", 1.720380e-06)
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=21.31)
# Lucoflex/Inner
