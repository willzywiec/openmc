"""
PU-SOL-THERM-017 (Case 3) 300 and 256 mm cylinders with 115.1 gPu/L at 30 cm s-to-s
...
surf1 = openmc.ZPlane(surface_id=1, z0=40.00)
...
surf4 = openmc.ZPlane(surface_id=4, z0=39.944)
...
source.space = openmc.stats.Box((-1.0, -1.0, 19.0), (58.79, 1.0, 21.0))
