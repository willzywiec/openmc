"""
LCT052-2: Hexagonal array of 1261 U(4.738)O2 fuel rods with 1.72 cm triangular pitch in gadolinium nitrate solution
...
mat4.add_element("Gd", 1.646740e-06)
mat4.add_element("N", 8.854590e-06)
mat4.add_nuclide("H1", 6.669400e-02)
mat4.add_nuclide("O16", 3.337160e-02)
...
surf5 = openmc.ZPlane(surface_id=5, z0=88.5)
# UO2
...
surf99_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=30.5360500000)
surf99_2 = openmc.Plane(a=-0.8660253631, b=0.5000000705, c=0, d=30.5360543031)
surf99_3 = openmc.Plane(a=-0.8660253631, b=-0.5000000705, c=0, d=30.5360543031)
surf99_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=30.5360500000)
surf99_5 = openmc.Plane(a=0.8660253631, b=-0.5000000705, c=0, d=30.5360543031)
...
lattice3.lower_left = [-36.12, -31.280838]
...
source.space = openmc.stats.Point((0.0, 0.0, 44.25))
