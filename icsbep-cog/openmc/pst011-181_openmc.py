"""
PU-SOL-THERM-011 (Case 18-1) 1.095 kg Pu(95.80) @ H/X = 1208 in a bare 18" SS347 + 0.020" Cd sphere
...
mat1.add_nuclide("Pu239", 5.393800e-05)
mat1.add_nuclide("Pu240", 2.354900e-06)
mat1.add_element("N", 7.393000e-04)
mat1.add_nuclide("H1", 6.514700e-02)
mat1.add_nuclide("O16", 3.453400e-02)
mat1.add_element("Fe", 1.294000e-06)
