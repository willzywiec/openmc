"""
PU-SOL-THERM-013 (Case 18) Seven cylinders with 1.2 cm surface-to-surface
...
# Hc per Table 1
surf1 = openmc.ZPlane(surface_id=1, z0=21.43)
...
surf11 = openmc.ZCylinder(surface_id=11, x0=-13.394, y0=23.1991, r=12.794)
surf12 = openmc.ZCylinder(surface_id=12, x0=13.394, y0=23.1991, r=12.794)
surf13 = openmc.ZCylinder(surface_id=13, x0=-26.788, y0=0.0, r=12.794)
surf14 = openmc.ZCylinder(surface_id=14, x0=26.788, y0=0.0, r=12.794)
surf15 = openmc.ZCylinder(surface_id=15, x0=-13.394, y0=-23.1991, r=12.794)
surf16 = openmc.ZCylinder(surface_id=16, x0=13.394, y0=-23.1991, r=12.794)
