"""
FALSTAFF; Sol'n No. 1; Sphere No. 4; 0.51 cm Be + 3.31 cm CH2
...
surf3 = openmc.Sphere(surface_id=3, r=10.2216)
surf4 = openmc.Sphere(surface_id=4, r=13.5316, boundary_type="vacuum")
