"""
U233-SOL-THERM-013: Case No. 13 (Experment No. 132)
...
mat1.add_nuclide("U232", 2.250500e-09)
mat1.add_nuclide("U233", 3.378100e-04)
mat1.add_nuclide("U234", 3.610700e-06)
mat1.add_nuclide("U235", 8.927900e-08)
mat1.add_nuclide("U236", 3.419200e-09)
mat1.add_nuclide("U238", 4.699200e-06)
mat1.add_element("Th", 4.343600e-06)
mat1.add_nuclide("H1", 6.340400e-02)
mat1.add_element("N", 8.009700e-04)
mat1.add_nuclide("O16", 3.475100e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=26.954)
