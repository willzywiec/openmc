...
surf4_zmin = openmc.ZPlane(surface_id=1025, z0=-41.3, boundary_type="vacuum")
surf4_zmax = openmc.ZPlane(surface_id=1026, z0=71.2, boundary_type="vacuum")
surf11_zmin = openmc.ZPlane(surface_id=1027, z0=-9.1)
surf11_zmax = openmc.ZPlane(surface_id=1028, z0=0.0)
surf12_zmin = openmc.ZPlane(surface_id=1029, z0=0.0)
surf12_zmax = openmc.ZPlane(surface_id=1030, z0=58.84)
surf13_zmin = openmc.ZPlane(surface_id=1031, z0=54.84)
surf13_zmax = openmc.ZPlane(surface_id=1032, z0=60.24)
surf15_zmin = openmc.ZPlane(surface_id=1033, z0=60.24)
surf15_zmax = openmc.ZPlane(surface_id=1034, z0=71.2)
surf17_zmin = openmc.ZPlane(surface_id=1035, z0=-9.1)
surf17_zmax = openmc.ZPlane(surface_id=1036, z0=71.2)
surf21_zmin = openmc.ZPlane(surface_id=1037, z0=54.84)
surf21_zmax = openmc.ZPlane(surface_id=1038, z0=71.2)
surf22_zmin = openmc.ZPlane(surface_id=1039, z0=54.84)
surf22_zmax = openmc.ZPlane(surface_id=1040, z0=71.2)
surf23_zmin = openmc.ZPlane(surface_id=1041, z0=53.17)
surf23_zmax = openmc.ZPlane(surface_id=1042, z0=71.2)
surf25_zmin = openmc.ZPlane(surface_id=1043, z0=-9.1)
surf25_zmax = openmc.ZPlane(surface_id=1044, z0=71.2)
