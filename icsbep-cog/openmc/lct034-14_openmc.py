"""
LCT034-14: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.65cm Boral, 2.0cm water gap, Hc=72.96cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=72.96)
# Lower grid plate
...
source.space = openmc.stats.Box((-30.65, -30.65, 35.48), (30.65, 30.65, 37.48))
