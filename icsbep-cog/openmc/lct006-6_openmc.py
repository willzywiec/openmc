"""
LCT006-6: Tank-Type Critical Assembly (TCA) 19x19 rods with 1.956 cm pitch; Hc=60.38 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=60.38)
# DX=DY=19*1.956        = 37.164 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-18.582, 18.582, -18.582, 18.582, -30.0, 144.15)
# DX=DY=19*1.956 + 2*30 = 97.164 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-48.582, 48.582, -48.582, 48.582, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-18.582, -18.582]
...
source.space = openmc.stats.Point((0.0, 0.0, 30.19))
