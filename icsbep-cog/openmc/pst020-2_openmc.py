"""
PU-SOL-THERM-020 (Case 2) 0.887 kg Pu(95.43) @ H/X = 651 in a water reflected 14" SS304L sphere
...
mat1.add_nuclide("Pu238", 5.828600e-09)
mat1.add_nuclide("Pu239", 9.190600e-05)
mat1.add_nuclide("Pu240", 4.495800e-06)
mat1.add_nuclide("Pu241", 2.983500e-07)
mat1.add_nuclide("Pu242", 8.598100e-09)
mat1.add_element("N", 2.831800e-03)
mat1.add_nuclide("H1", 6.007100e-02)
mat1.add_nuclide("O16", 3.730800e-02)
...
# = Hc per Table 4
surf1 = openmc.ZPlane(surface_id=1, z0=16.2696)
# SST/Inner/Table 5
