"""
MCT012-17: MOX/Polystyrene (H/SQRT(LxW)=0.37) with H/X=226 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-25.45, 25.45, -25.45, 25.45, -9.46, 9.46)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-40.69, 40.69, -40.69, 40.69, -24.7, 24.7, boundary_type="vacuum")
