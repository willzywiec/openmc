"""
PU-SOL-THERM-007 (Case 7) 1.240 kg Pu(95.43) @ H/X = 265 in a water reflected 11.5" SS-304L sphere
...
mat1.add_nuclide("Pu238", 1.519400e-08)
mat1.add_nuclide("Pu239", 2.395900e-04)
mat1.add_nuclide("Pu240", 1.172200e-05)
mat1.add_nuclide("Pu241", 7.627200e-07)
mat1.add_nuclide("Pu242", 2.241300e-08)
mat1.add_element("N", 1.261600e-03)
mat1.add_nuclide("H1", 6.367100e-02)
mat1.add_nuclide("O16", 3.549400e-02)
...
surf1 = openmc.ZPlane(surface_id=1, z0=10.9741)
