...
# Water/outer/bcd
surf199 = openmc.ZCylinder(surface_id=199, r=98.4, boundary_type="vacuum")
# Graphite/lower
...
surf1_zmin = openmc.ZPlane(surface_id=1405, z0=-36.83)
surf1_zmax = openmc.ZPlane(surface_id=1406, z0=74.295)
surf100_zmin = openmc.ZPlane(surface_id=1407, z0=-36.2)
surf100_zmax = openmc.ZPlane(surface_id=1408, z0=-34.295)
surf101_zmin = openmc.ZPlane(surface_id=1409, z0=28.88)
surf101_zmax = openmc.ZPlane(surface_id=1410, z0=30.785)
surf115_zmin = openmc.ZPlane(surface_id=1411, z0=-26.975)
surf115_zmax = openmc.ZPlane(surface_id=1412, z0=26.975)
surf116_zmin = openmc.ZPlane(surface_id=1413, z0=-28.245)
surf116_zmax = openmc.ZPlane(surface_id=1414, z0=28.245)
surf199_zmin = openmc.ZPlane(surface_id=1415, z0=-100.0, boundary_type="vacuum")
surf199_zmax = openmc.ZPlane(surface_id=1416, z0=100.0, boundary_type="vacuum")
surf201_zmin = openmc.ZPlane(surface_id=1417, z0=-28.527375)
surf201_zmax = openmc.ZPlane(surface_id=1418, z0=-19.129375)
surf202_zmin = openmc.ZPlane(surface_id=1419, z0=-19.129375)
surf202_zmax = openmc.ZPlane(surface_id=1420, z0=-19.05)
surf204_zmin = openmc.ZPlane(surface_id=1421, z0=-19.05)
surf204_zmax = openmc.ZPlane(surface_id=1422, z0=19.05)
surf205_zmin = openmc.ZPlane(surface_id=1423, z0=19.05)
surf205_zmax = openmc.ZPlane(surface_id=1424, z0=25.654)
surf206_zmin = openmc.ZPlane(surface_id=1425, z0=-28.527375)
surf206_zmax = openmc.ZPlane(surface_id=1426, z0=25.654)
surf207_zmin = openmc.ZPlane(surface_id=1427, z0=-36.03)
surf207_zmax = openmc.ZPlane(surface_id=1428, z0=36.03)
surf301_zmin = openmc.ZPlane(surface_id=1429, z0=-35.56)
surf301_zmax = openmc.ZPlane(surface_id=1430, z0=-21.59)
surf302_zmin = openmc.ZPlane(surface_id=1431, z0=-21.59)
surf302_zmax = openmc.ZPlane(surface_id=1432, z0=-19.05)
surf304_zmin = openmc.ZPlane(surface_id=1433, z0=-19.05)
surf304_zmax = openmc.ZPlane(surface_id=1434, z0=19.05)
surf305_zmin = openmc.ZPlane(surface_id=1435, z0=19.05)
surf305_zmax = openmc.ZPlane(surface_id=1436, z0=19.84375)
surf306_zmin = openmc.ZPlane(surface_id=1437, z0=19.84375)
surf306_zmax = openmc.ZPlane(surface_id=1438, z0=21.11375)
surf307_zmin = openmc.ZPlane(surface_id=1439, z0=21.11375)
surf307_zmax = openmc.ZPlane(surface_id=1440, z0=59.69)
surf308_zmin = openmc.ZPlane(surface_id=1441, z0=59.69)
surf308_zmax = openmc.ZPlane(surface_id=1442, z0=60.96)
surf309_zmin = openmc.ZPlane(surface_id=1443, z0=60.96)
surf309_zmax = openmc.ZPlane(surface_id=1444, z0=70.485)
surf310_zmin = openmc.ZPlane(surface_id=1445, z0=-35.56)
surf310_zmax = openmc.ZPlane(surface_id=1446, z0=70.485)
surf311_zmin = openmc.ZPlane(surface_id=1447, z0=-36.83)
surf311_zmax = openmc.ZPlane(surface_id=1448, z0=74.295)
surf401_zmin = openmc.ZPlane(surface_id=1449, z0=-35.56)
surf401_zmax = openmc.ZPlane(surface_id=1450, z0=19.84375)
surf402_zmin = openmc.ZPlane(surface_id=1451, z0=21.11375)
surf402_zmax = openmc.ZPlane(surface_id=1452, z0=59.21375)
surf403_zmin = openmc.ZPlane(surface_id=1453, z0=59.21375)
surf403_zmax = openmc.ZPlane(surface_id=1454, z0=59.69)
surf404_zmin = openmc.ZPlane(surface_id=1455, z0=60.96)
surf404_zmax = openmc.ZPlane(surface_id=1456, z0=70.485)
surf405_zmin = openmc.ZPlane(surface_id=1457, z0=-36.83)
surf405_zmax = openmc.ZPlane(surface_id=1458, z0=74.295)
...
u4_cell0.region = -surf38 & +surf9 & -surf39 & +surf9 & -surf40 & +surf9 & -surf41
u4_cell1 = openmc.Cell(fill=mat9)
u4_cell1.region = -surf42 & +surf9 & -surf43 & +surf9 & -surf44 & +surf9 & -surf45
u4_cell2 = openmc.Cell(fill=mat9)
u4_cell2.region = -surf46 & +surf9 & -surf47 & +surf9 & -surf48 & +surf9 & -surf49
u4_cell3 = openmc.Cell(fill=mat9)
u4_cell3.region = -surf50 & +surf9 & -surf51 & +surf9 & -surf52
u4_cell4 = openmc.Cell(fill=mat9)
u4_cell4.region = -surf60 & +surf9 & -surf61
u4_cell5 = openmc.Cell(fill=mat9)
u4_cell5.region = -surf62 & +surf9 & -surf63 & +surf9 & -surf64 & +surf9 & -surf65
u4_cell6 = openmc.Cell(fill=mat9)
u4_cell6.region = -surf66 & +surf9 & -surf67 & +surf9 & -surf68 & +surf9 & -surf69
u4_cell7 = openmc.Cell(fill=mat9)
u4_cell7.region = -surf70 & +surf9 & -surf71 & +surf9 & -surf72 & +surf9 & -surf73
u4_cell8 = openmc.Cell(fill=mat9)
u4_cell8.region = -surf74 & +surf9 & -surf75 & +surf9 & -surf76 & +surf9 & -surf77
u4_cell9 = openmc.Cell(fill=mat9)
u4_cell9.region = -surf78 & +surf9 & -surf79 & +surf9 & -surf80 & +surf9 & -surf81
u4_cell10 = openmc.Cell(fill=mat9)
u4_cell10.region = -surf82 & +surf9 & -surf83 & +surf9 & -surf84 & +surf9 & -surf85
u4_cell11 = openmc.Cell(fill=mat9)
u4_cell11.region = -surf86 & +surf9 & -surf87 & +surf9 & -surf88 & +surf9 & -surf89
u4_cell12 = openmc.Cell(fill=mat9)
u4_cell12.region = -surf90 & +surf9 & -surf91
u4_cell13 = openmc.Cell(fill=mat6)
u4_cell13.region = (-surf100 & +surf100_zmin & -surf100_zmax) & (+surf1 | -surf1_zmin | +surf1_zmax) & +surf2 & +surf3 & +surf4 & +surf5 & +surf6 & +surf7 & +surf8 & +surf9 & +surf10 & +surf11 & +surf12 & +surf13 & +surf14 & +surf15 & +surf16 & +surf17 & +surf18 & +surf19 & +surf20
u4_cell14 = openmc.Cell(fill=mat6)
u4_cell14.region = (-surf101 & +surf101_zmin & -surf101_zmax) & (+surf1 | -surf1_zmin | +surf1_zmax) & +surf2 & +surf3 & +surf4 & +surf5 & +surf6 & +surf7 & +surf8 & +surf9 & +surf10 & +surf11 & +surf12 & +surf13 & +surf14 & +surf15 & +surf16 & +surf17 & +surf18 & +surf19 & +surf20
u4_cell15 = openmc.Cell(fill=mat6)
u4_cell15.region = +surf110 & -surf111 & (-surf116 & +surf116_zmin & -surf116_zmax)
u4_cell16 = openmc.Cell(fill=mat6)
u4_cell16.region = +surf111 & (+surf115 | -surf115_zmin | +surf115_zmax) & (-surf116 & +surf116_zmin & -surf116_zmax)
u4_cell17 = openmc.Cell(fill=mat8)
u4_cell17.region = +surf111 & -surf112 & (-surf115 & +surf115_zmin & -surf115_zmax)
u4_cell18 = openmc.Cell(fill=mat10)
u4_cell18.region = +surf112 & -surf113 & +surf114 & (-surf115 & +surf115_zmin & -surf115_zmax)
...
u4_cell20.region = +surf113 & (-surf115 & +surf115_zmin & -surf115_zmax)
...
cell31.region = (+surf207 | -surf207_zmin | +surf207_zmax) & (-surf199 & +surf199_zmin & -surf199_zmax)

# Water
cell44 = openmc.Cell(cell_id=44, fill=mat9)
cell44.region = (+surf311 | -surf311_zmin | +surf311_zmax) & (-surf199 & +surf199_zmin & -surf199_zmax)

# Water
cell51 = openmc.Cell(cell_id=51, fill=mat9)
cell51.region = (+surf405 | -surf405_zmin | +surf405_zmax) & (-surf199 & +surf199_zmin & -surf199_zmax)
