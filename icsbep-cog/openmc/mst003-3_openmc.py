"""
MIX-SOL-THERM-003-3: AWRE SCAMP
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=21.17)
# Steel plate
...
surf2_zmin = openmc.ZPlane(surface_id=1007, z0=21.17)
surf2_zmax = openmc.ZPlane(surface_id=1008, z0=21.487)
surf3_zmin = openmc.ZPlane(surface_id=1009, z0=21.487)
surf3_zmax = openmc.ZPlane(surface_id=1010, z0=36.487)
...
source.space = openmc.stats.Point((0.0, 0.0, 10.585))
