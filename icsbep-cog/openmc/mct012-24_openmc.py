"""
MCT012-24: MOX/Polystyrene (H/SQRT(LxW)=0.67) with H/X=172 reflected by 15.24cm Lucite
...
# Core
surf1 = openmc.model.RectangularParallelepiped(-17.815, 17.815, -17.815, 17.815, -11.975, 11.975)
# Refl
surf2 = openmc.model.RectangularParallelepiped(-33.055, 33.055, -33.055, 33.055, -27.215, 27.215, boundary_type="vacuum")
