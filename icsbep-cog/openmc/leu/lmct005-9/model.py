"""
LMCT005-9: STACY run 517 with U(5)O2 rods immersed in 58.61cm of U(6) uranyl nitrate, Sm, Cs, and Rh solution with water reflection
...
mat1.add_nuclide("U234", 4.093800e-07)
mat1.add_nuclide("U235", 4.891600e-05)
mat1.add_nuclide("U236", 8.118100e-08)
mat1.add_nuclide("U238", 7.561900e-04)
mat1.add_nuclide("O16", 3.801700e-02)
mat1.add_nuclide("H1", 5.704400e-02)
mat1.add_element("N", 2.823600e-03)
mat1.add_element("Sm", 5.046500e-07)
mat1.add_element("Cs", 1.359300e-05)
mat1.add_element("Rh", 7.666200e-06)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=58.61)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 29.305))
