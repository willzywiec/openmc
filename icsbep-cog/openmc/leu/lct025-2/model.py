...
surf14 = openmc.ZCylinder(surface_id=14, r=47.0, boundary_type="vacuum")
...
surf1_zmin = openmc.ZPlane(surface_id=1216, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1217, z0=85.6)
surf2_zmin = openmc.ZPlane(surface_id=1218, z0=-0.8)
surf2_zmax = openmc.ZPlane(surface_id=1219, z0=0.0)
surf3_zmin = openmc.ZPlane(surface_id=1220, z0=0.0)
surf3_zmax = openmc.ZPlane(surface_id=1221, z0=85.9)
surf4_zmin = openmc.ZPlane(surface_id=1222, z0=85.9)
surf4_zmax = openmc.ZPlane(surface_id=1223, z0=86.7)
surf5_zmin = openmc.ZPlane(surface_id=1224, z0=-1.0)
surf5_zmax = openmc.ZPlane(surface_id=1225, z0=-0.1)
surf6_zmin = openmc.ZPlane(surface_id=1226, z0=-0.1)
surf6_zmax = openmc.ZPlane(surface_id=1227, z0=87.4)
surf7_zmin = openmc.ZPlane(surface_id=1228, z0=87.4)
surf7_zmax = openmc.ZPlane(surface_id=1229, z0=92.6)
surf8_zmin = openmc.ZPlane(surface_id=1230, z0=-1.0)
surf8_zmax = openmc.ZPlane(surface_id=1231, z0=999.9)
surf11_zmin = openmc.ZPlane(surface_id=1232, z0=-2.2)
surf11_zmax = openmc.ZPlane(surface_id=1233, z0=-1.0)
surf12_zmin = openmc.ZPlane(surface_id=1234, z0=0.5)
surf12_zmax = openmc.ZPlane(surface_id=1235, z0=0.8)
surf13_zmin = openmc.ZPlane(surface_id=1236, z0=81.9)
surf13_zmax = openmc.ZPlane(surface_id=1237, z0=82.2)
surf14_zmin = openmc.ZPlane(surface_id=1238, z0=-19.9, boundary_type="vacuum")
surf14_zmax = openmc.ZPlane(surface_id=1239, z0=105.6, boundary_type="vacuum")
