"""
LCT062-15: 18x18 array of U(2.6)O2 rods on 1.9558cm pitch with 0.6194cm SST-0.98B plate, 1.9558cm gap (TCA)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=95.55)
# Array boundary
...
surf31 = openmc.model.RectangularParallelepiped(19.558, 20.1774, -22.5, 22.5, 0.37000000000000455, 150.37)
...
source.space = openmc.stats.Box((-1.98, -1.98, 46.775), (1.98, 1.98, 48.775))
