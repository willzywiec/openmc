"""
LMCT003-8: STACY run 442 with U(5)O2 rods immersed in 56.65cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 6.471300e-08)
mat1.add_nuclide("U235", 7.719600e-06)
mat1.add_nuclide("U236", 1.283300e-08)
mat1.add_nuclide("U238", 1.195500e-04)
mat1.add_nuclide("O16", 3.546700e-02)
mat1.add_nuclide("H1", 6.275300e-02)
mat1.add_element("N", 1.483200e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=56.65)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 28.325))
