"""
LCT003-9: 17x17 (two lower) + 17x11 (two upper) arrays of U(2.35)O2 fuel rods with 1.684 cm square pitch in water and 2.59 cm separation (SSC-2.35-000-069)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-29.923, 29.923, -16.451, 16.451, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-59.923, 59.923, -46.451, 46.451, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-1.295)
surf4 = openmc.XPlane(surface_id=4, x0=1.295)
surf5 = openmc.YPlane(surface_id=5, y0=12.177)
surf6 = openmc.YPlane(surface_id=6, y0=14.767)
surf7 = openmc.XPlane(surface_id=7, x0=-11.399)
surf8 = openmc.XPlane(surface_id=8, x0=11.399)
# Al-5052 lower plug
...
cell1.translation = (-15.609, -2.137, 0.0)
...
cell3.translation = (15.609, -2.137, 0.0)
...
cell5.translation = (-15.609, 15.609, 0.0)
cell5.region = -surf1 & -surf2 & -surf3 & +surf6 & -surf7

# EMPTY
cell6 = openmc.Cell(cell_id=6, fill=universe2)
cell6.region = -surf1 & -surf2 & -surf3 & +surf6 & +surf7

# EMPTY
cell7 = openmc.Cell(cell_id=7, fill=universe2)
cell7.region = -surf1 & -surf2 & +surf3 & -surf4 & +surf6

# EMPTY
cell8 = openmc.Cell(cell_id=8, fill=universe2)
cell8.region = -surf1 & -surf2 & +surf4 & +surf6 & -surf8

# CORE
cell9 = openmc.Cell(cell_id=9, fill=universe3)
cell9.translation = (15.609, 15.609, 0.0)
cell9.region = -surf1 & -surf2 & +surf4 & +surf6 & +surf8

# H2O
cell10 = openmc.Cell(cell_id=10, fill=mat5)
cell10.region = +surf1 & -surf2
...
source.space = openmc.stats.Box((-16.6, -3.1, 44.72), (16.6, -1.1, 46.72))
