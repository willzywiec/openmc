"""
LMCT001-5: STACY run 401 with U(5)O2 rods immersed in 64.69cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 6.651500e-08)
mat1.add_nuclide("U235", 7.974200e-06)
mat1.add_nuclide("U236", 1.319000e-08)
mat1.add_nuclide("U238", 1.228400e-04)
mat1.add_nuclide("O16", 3.588300e-02)
mat1.add_nuclide("H1", 6.202300e-02)
mat1.add_element("N", 1.791400e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=64.69)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 32.345))
