"""
LCT003-11: 17x17 (two) + 17x3-3 + 17x4-2 arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water and 4.27 cm separation (SSC-2.35-000-070)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-30.763, 30.763, -19.817, 19.817, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-60.763, 60.763, -49.817, 49.817, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-2.135)
surf4 = openmc.XPlane(surface_id=4, x0=2.135)
surf5 = openmc.YPlane(surface_id=5, y0=8.811)
surf6 = openmc.YPlane(surface_id=6, y0=13.081)
surf7 = openmc.XPlane(surface_id=7, x0=-7.187)
surf8 = openmc.XPlane(surface_id=8, x0=5.503)
# Al-5052 lower plug
...
cell1.translation = (-16.449, -5.503, 0.0)
...
cell3.translation = (16.449, -5.503, 0.0)
...
cell5.translation = (-16.449, 17.291, 0.0)
...
cell9.translation = (16.449, 17.291, 0.0)
...
source.space = openmc.stats.Box((-17.449, -6.503, 44.72), (17.449, 16.607, 46.72))
