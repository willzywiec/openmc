"""
LST025-1: STACY two slabs of 10% 235U uranyl nitrate with concrete (C25) isolators
...
mat1.add_nuclide("U234", 5.979900e-07)
mat1.add_nuclide("U235", 7.420600e-05)
mat1.add_nuclide("U236", 7.411400e-08)
mat1.add_nuclide("U238", 6.609600e-04)
mat1.add_nuclide("H1", 5.947500e-02)
mat1.add_element("N", 1.977500e-03)
mat1.add_nuclide("O16", 3.688900e-02)
...
# Critical height
surf5 = openmc.ZPlane(surface_id=5, z0=53.11)
# Concrete
surf6 = openmc.model.RectangularParallelepiped(-1.265, 1.265, -35.7, 35.7, 0.0, 150.6)
# SST frame
surf7 = openmc.model.RectangularParallelepiped(-1.265, 1.265, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover
surf8 = openmc.model.RectangularParallelepiped(-2.075, 2.075, -38.7, 38.7, -3.0, 153.6)
# BCD
surf10 = openmc.model.RectangularParallelepiped(-40.792, 40.792, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
# LHS SST tank
surf11 = openmc.model.RectangularParallelepiped(-40.792, -2.1709999999999994, -36.6005, 36.6005, -2.060999999999993, 152.183)
# RHS SST tank
surf12 = openmc.model.RectangularParallelepiped(2.1709999999999994, 40.792, -36.6005, 36.6005, -2.060999999999993, 152.183)
...
cell1.translation = (-21.4815, 0.0, 0.0)
...
cell3.translation = (21.4815, 0.0, 0.0)
...
source.space = openmc.stats.Box((-22.4815, -1.0, 25.555), (22.4815, 1.0, 27.555))
