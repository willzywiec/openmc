"""
LCT049-15S: Simplified model of R2-4R(4,4) with H/U=2 & 3 (concentric) and d=5.43cm
...
cell1.region = +surf11 & -surf20 & +surf21 & -surf27 & +surf31 & -surf37

# Air
cell20 = openmc.Cell(cell_id=20, fill=mat5)
cell20.region = -surf9

root_universe = openmc.Universe(cells=[cell1, cell20])
...
source.space = openmc.stats.Box((-34.495, -11.26, -11.0), (13.975, 11.26, 11.0))
