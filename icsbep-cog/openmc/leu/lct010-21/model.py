"""
LEU-COMP-THERM-010-21: (12x16)-17.703cm-(12x16)-17.703cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; Lead walls; 0.660 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-82.0, 82.0, -25.996000000000002, -15.796000000000001, -20.0625, 103.3375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-82.0, 82.0, 15.796000000000001, 25.996000000000002, -20.0625, 103.3375)
...
cell1.translation = (-40.407, 0.0, 0.0)
...
cell5.translation = (40.407, 0.0, 0.0)
...
source.space = openmc.stats.Box((-40.461, -2.27, 45.0375), (40.461, 2.27, 47.0375))
