"""
LMCT005-7: STACY run 513 with U(5)O2 rods immersed in 55.71cm of U(6) uranyl nitrate, Sm, Cs, and Rh solution with water reflection
...
mat1.add_nuclide("U234", 4.087400e-07)
mat1.add_nuclide("U235", 4.883900e-05)
mat1.add_nuclide("U236", 8.105300e-08)
mat1.add_nuclide("U238", 7.550000e-04)
mat1.add_nuclide("O16", 3.796200e-02)
mat1.add_nuclide("H1", 5.709500e-02)
mat1.add_element("N", 2.795800e-03)
mat1.add_element("Sm", 5.406900e-07)
mat1.add_element("Cs", 1.513400e-05)
mat1.add_element("Rh", 2.697800e-06)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=55.71)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 27.855))
