"""
LST004-4: Water-reflected 60-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=896 (Run 34)
...
mat1.add_nuclide("U234", 5.220300e-07)
mat1.add_nuclide("U235", 6.478000e-05)
mat1.add_nuclide("U236", 6.470000e-08)
mat1.add_nuclide("U238", 5.770100e-04)
mat1.add_nuclide("H1", 5.803200e-02)
mat1.add_element("N", 2.633700e-03)
mat1.add_nuclide("O16", 3.752700e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=64.85)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1004, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1005, z0=150.0)
surf2_zmin = openmc.ZPlane(surface_id=1006, z0=-2.0)
surf2_zmax = openmc.ZPlane(surface_id=1007, z0=152.5)
surf3_zmin = openmc.ZPlane(surface_id=1008, z0=-32.0, boundary_type="vacuum")
surf3_zmax = openmc.ZPlane(surface_id=1009, z0=172.5, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 32.425))
