"""
LST020-1: Water reflected 80-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=971 (Run 216)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=41.46)
...
source.space = openmc.stats.Point((0.0, 0.0, 20.73))
