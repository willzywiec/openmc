"""
LCT062-11: 18x18 array of U(2.6)O2 rods on 1.9558cm pitch with 0.6228cm SST-0.67B plate, 1.9558cm gap (TCA)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=92.31)
# Array boundary
...
surf31 = openmc.model.RectangularParallelepiped(19.558, 20.180799999999998, -22.5, 22.5, 0.37000000000000455, 150.37)
...
source.space = openmc.stats.Box((-1.98, -1.98, 45.155), (1.98, 1.98, 47.155))
