"""
LCT001-6: (24x15)-8.01cm-(20x15)-8.01cm-(24x15) array of U(2.35)O2 fuel rods with 2.032 cm pitch (SSC-2.35-000-045)
...
surf1 = openmc.model.RectangularParallelepiped(-77.098, 77.098, -15.24, 15.24, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-107.098, 107.098, -45.24, 45.24, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-28.33)
surf4 = openmc.XPlane(surface_id=4, x0=-20.32)
surf5 = openmc.XPlane(surface_id=5, x0=20.32)
surf6 = openmc.XPlane(surface_id=6, x0=28.33)
# Al-5052 lower plug
...
# Lattice 3: 24x15 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-24.384, -15.24]
...
cell1.translation = (-52.714, 0.0, 0.0)
...
cell5.translation = (52.714, 0.0, 0.0)
