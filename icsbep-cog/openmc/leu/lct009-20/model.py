"""
LEU-COMP-THERM-009-20: (15x8)-2.8895cm-(0.0901cm Cd)-2.8895cm-(15x8)-2.8895cm-(0.0901cm Cd)-2.8895cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-63.02, 63.02, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-93.02, 93.02, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-24.92)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=24.92)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-22.03005, -21.93995, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(21.93995, 22.03005, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-43.97, 0.0, 0.0)
...
cell5.translation = (43.97, 0.0, 0.0)
...
source.space = openmc.stats.Box((-44.97, -2.27, 45.0375), (44.97, 2.27, 47.0375))
