"""
LCT028-19: 253 U(4.31)O2 rods with 3.302 cm triangular pitch in water with 0.0257 gGd/l
...
# Water with Gd (Case 19)
mat5 = openmc.Material(material_id=5)
mat5.set_density("sum")
mat5.add_nuclide("H1", 6.673000e-02)
mat5.add_element("N", 1.523800e-06)
mat5.add_nuclide("O16", 3.336900e-02)
mat5.add_element("Gd", 9.842200e-08)
...
surf21_0 = openmc.Plane(a=0.8660242012, b=0.5000020829, c=0, d=28.5961191245)
surf21_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=28.5960000000)
surf21_2 = openmc.Plane(a=-0.8660242012, b=0.5000020829, c=0, d=28.5961191245)
surf21_3 = openmc.Plane(a=-0.8660242012, b=-0.5000020829, c=0, d=28.5961191245)
surf21_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=28.5960000000)
surf21_5 = openmc.Plane(a=0.8660242012, b=-0.5000020829, c=0, d=28.5961191245)
