...
surf13 = openmc.ZCylinder(surface_id=13, x0=-1.5, y0=0.0, r=51.41)
# Steel reflector top plate
surf14 = openmc.ZCylinder(surface_id=14, x0=142.0, y0=142.6, r=51.41)
# = 29.82 +  0.49 (Inner Gap)
surf15 = openmc.ZCylinder(surface_id=15, r=30.31)
# = 30.31 +  0.31 (Inner Wall)
surf16 = openmc.ZCylinder(surface_id=16, x0=0.0, y0=142.0, r=30.62)
# = 30.62 + 19.98 (Concrete)
surf17 = openmc.ZCylinder(surface_id=17, x0=0.0, y0=142.0, r=50.6)
# = 50.60 +  0.81 (Outer Wall)
surf18 = openmc.ZCylinder(surface_id=18, x0=0.0, y0=142.0, r=51.41)
# BCD
