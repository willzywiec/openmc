"""
LMCT005-10: STACY run 522 with U(5)O2 rods immersed in 58.40cm of U(6) uranyl nitrate, Sm, Cs, Rh, and Eu solution with water reflection
...
mat1.add_nuclide("U234", 4.154300e-07)
mat1.add_nuclide("U235", 4.963800e-05)
mat1.add_nuclide("U236", 8.238000e-08)
mat1.add_nuclide("U238", 7.673600e-04)
mat1.add_nuclide("O16", 3.804700e-02)
mat1.add_nuclide("H1", 5.677000e-02)
mat1.add_element("N", 2.876400e-03)
mat1.add_element("Sm", 4.966400e-07)
mat1.add_element("Cs", 1.350300e-05)
mat1.add_element("Rh", 7.315100e-06)
mat1.add_element("Eu", 2.928600e-08)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=58.40)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 29.2))
