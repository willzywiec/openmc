"""
LMCT001-4: STACY run 398 with U(5)O2 rods immersed in 55.73cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 1.312300e-07)
mat1.add_nuclide("U235", 1.573200e-05)
mat1.add_nuclide("U236", 2.602300e-08)
mat1.add_nuclide("U238", 2.423500e-04)
mat1.add_nuclide("O16", 3.636400e-02)
mat1.add_nuclide("H1", 6.094800e-02)
mat1.add_element("N", 2.046100e-03)
...
# Water reflector
surf7 = openmc.ZCylinder(surface_id=7, r=59.825)
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=55.73)
# UO2
...
surf1_zmin = openmc.ZPlane(z0=145.4)
surf1_zmax = openmc.ZPlane(z0=146.0)
surf2_zmin = openmc.ZPlane(z0=105.0)
surf2_zmax = openmc.ZPlane(z0=105.6)
surf3_zmin = openmc.ZPlane(z0=5.0)
surf3_zmax = openmc.ZPlane(z0=5.6)
surf4_zmin = openmc.ZPlane(z0=0.0)
surf4_zmax = openmc.ZPlane(z0=150.25)
surf5_zmin = openmc.ZPlane(z0=150.25)
surf5_zmax = openmc.ZPlane(z0=152.25)
surf6_zmin = openmc.ZPlane(z0=-2.01)
surf6_zmax = openmc.ZPlane(z0=159.17)
surf7_zmin = openmc.ZPlane(z0=-32.01, boundary_type="vacuum")
surf7_zmax = openmc.ZPlane(z0=174.17, boundary_type="vacuum")
surf11_zmin = openmc.ZPlane(z0=1.48)
surf11_zmax = openmc.ZPlane(z0=143.54)
surf12_zmin = openmc.ZPlane(z0=1.48)
surf12_zmax = openmc.ZPlane(z0=148.05)
surf13_zmin = openmc.ZPlane(z0=0.55)
surf13_zmax = openmc.ZPlane(z0=148.97)
surf14_zmin = openmc.ZPlane(z0=0.0)
surf14_zmax = openmc.ZPlane(z0=149.52)
surf15_zmin = openmc.ZPlane(z0=0.0)
surf15_zmax = openmc.ZPlane(z0=149.52)
surf31_zmin = openmc.ZPlane(z0=0.0)
surf31_zmax = openmc.ZPlane(z0=149.52)
surf32_zmin = openmc.ZPlane(z0=0.0)
surf32_zmax = openmc.ZPlane(z0=149.52)
...
cell3.region = (-surf7 & +surf7_zmin & -surf7_zmax) & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7) & +surf21 & +surf22

# Alles
cell4 = openmc.Cell(cell_id=4, fill=universe1)
cell4.region = (-surf7 & +surf7_zmin & -surf7_zmax) & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5 | +surf20_6 | +surf20_7) & +surf51 & +surf52 & +surf53 & +surf54

# H2O
cell13 = openmc.Cell(cell_id=13, fill=mat6)
cell13.region = (+surf6 | -surf6_zmin | +surf6_zmax) & (-surf7 & +surf7_zmin & -surf7_zmax)

# Alles
cell20 = openmc.Cell(cell_id=20, fill=universe1)
cell20.region = (+surf15 | -surf15_zmin | +surf15_zmax) & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7)
...
cell27.region = (+surf32 | -surf32_zmin | +surf32_zmax) & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7)

# Soln
cell34 = openmc.Cell(cell_id=34, fill=mat1)
cell34.region = -surf10 & (+surf13 | -surf13_zmin | +surf13_zmax) & (+surf14 | -surf14_zmin | +surf14_zmax) & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7)
...
cell41.region = -surf10 & (+surf31 | -surf31_zmin | +surf31_zmax) & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7)
...
source.space = openmc.stats.Point((0.0, 0.0, 27.865))
