"""
LCT006-3: Tank-Type Critical Assembly (TCA) 21x21 rods with 1.849 cm pitch; Hc=60.81 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=60.81)
# DX=DY=21*1.849        = 38.829 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-19.4145, 19.4145, -19.4145, 19.4145, -30.0, 144.15)
# DX=DY=21*1.849 + 2*30 = 98.829 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-49.4145, 49.4145, -49.4145, 49.4145, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-19.4145, -19.4145]
...
source.space = openmc.stats.Point((0.0, 0.0, 30.405))
