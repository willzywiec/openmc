"""
LST008-4: STACY 60cm diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=956 reflected with (C300) concrete (Run 72)
...
mat1.add_nuclide("U234", 4.936200e-07)
mat1.add_nuclide("U235", 6.125500e-05)
mat1.add_nuclide("U236", 6.117900e-08)
mat1.add_nuclide("U238", 5.456100e-04)
mat1.add_nuclide("H1", 5.858200e-02)
mat1.add_element("N", 2.461400e-03)
mat1.add_nuclide("O16", 3.726700e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=71.71)
# Steel support/inner
surf11 = openmc.ZCylinder(surface_id=11, r=31.7)
# Steel support/outer
surf12 = openmc.ZCylinder(surface_id=12, r=68.5)
# Aluminum reflector bottom plate
surf13 = openmc.ZCylinder(surface_id=13, r=61.45)
# Steel reflector top plate
surf14 = openmc.ZCylinder(surface_id=14, r=61.45)
# = 29.82 +  0.37 (Inner Gap)
surf15 = openmc.ZCylinder(surface_id=15, r=30.19)
# = 30.19 +  0.31 (Inner Wall)
surf16 = openmc.ZCylinder(surface_id=16, r=30.5)
# = 30.50 + 30.14 (Concrete)
surf17 = openmc.ZCylinder(surface_id=17, r=60.64)
# = 60.64 +  0.81 (Outer Wall)
surf18 = openmc.ZCylinder(surface_id=18, r=61.45)
# BCD
...
source.space = openmc.stats.Point((0.0, 0.0, 35.855))
