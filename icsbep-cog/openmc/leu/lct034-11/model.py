"""
LCT034-11: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.65cm Boral, 0.5cm water gap, Hc=53.01cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=53.01)
# Lower grid plate
...
# Basket
surf10 = openmc.model.RectangularParallelepiped(-29.700000000000003, -0.9000000000000004, 0.9000000000000004, 29.700000000000003, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf11 = openmc.model.RectangularParallelepiped(-30.35, -0.25, 0.25, 30.35, -2.200000000000003, 97.8)
# Basket
surf12 = openmc.model.RectangularParallelepiped(0.9000000000000004, 29.700000000000003, 0.9000000000000004, 29.700000000000003, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf13 = openmc.model.RectangularParallelepiped(0.25, 30.35, 0.25, 30.35, -2.200000000000003, 97.8)
# Basket
surf14 = openmc.model.RectangularParallelepiped(-29.700000000000003, -0.9000000000000004, -29.700000000000003, -0.9000000000000004, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf15 = openmc.model.RectangularParallelepiped(-30.35, -0.25, -30.35, -0.25, -2.200000000000003, 97.8)
# Basket
surf16 = openmc.model.RectangularParallelepiped(0.9000000000000004, 29.700000000000003, -29.700000000000003, -0.9000000000000004, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf17 = openmc.model.RectangularParallelepiped(0.25, 30.35, -30.35, -0.25, -2.200000000000003, 97.8)
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-28.7675, y0=28.7675, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-28.7675, y0=28.7675, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-1.7, y0=28.9, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-28.9, y0=1.7, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-1.7, y0=1.7, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=28.7675, y0=28.7675, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=28.7675, y0=28.7675, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=1.7, y0=28.9, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=28.9, y0=1.7, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=1.7, y0=1.7, r=0.5)
# Aluminum cover
...
cell3.translation = (-15.3, 15.3, 0.0)
...
cell6.translation = (15.3, 15.3, 0.0)
...
cell9.translation = (-15.3, -15.3, 0.0)
...
cell12.translation = (15.3, -15.3, 0.0)
...
source.space = openmc.stats.Box((-29.9, -29.9, 25.505), (29.9, 29.9, 27.505))
