"""
LCT027-1: 14x14 array reflected by lead with no water gap
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=75.13)
# Array boundary
...
# Lead #1
surf25 = openmc.model.RectangularParallelepiped(-48.8, 11.2, -41.2, -11.2, -3.200000000000003, 91.8)
# Lead #2
surf26 = openmc.model.RectangularParallelepiped(-11.2, 48.8, 11.2, 41.2, -3.200000000000003, 91.8)
# Lead #3
surf27 = openmc.model.RectangularParallelepiped(-41.2, -11.2, -11.2, 48.8, -3.200000000000003, 91.8)
# Lead #4
surf28 = openmc.model.RectangularParallelepiped(11.2, 41.2, -48.8, 11.2, -3.200000000000003, 91.8)
# BCD
...
source.space = openmc.stats.Box((-1.8, -1.8, 36.565), (1.8, 1.8, 38.565))
