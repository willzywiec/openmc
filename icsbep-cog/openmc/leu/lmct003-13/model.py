"""
LMCT003-13: STACY run 428 with U(5)O2 rods immersed in 47.80cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 1.951700e-07)
mat1.add_nuclide("U235", 2.328200e-05)
mat1.add_nuclide("U236", 3.870200e-08)
mat1.add_nuclide("U238", 3.605500e-04)
mat1.add_nuclide("O16", 3.641700e-02)
mat1.add_nuclide("H1", 6.057600e-02)
mat1.add_element("N", 1.990600e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=47.80)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 23.9))
