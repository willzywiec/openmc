"""
LCT049-1S: Simplified model of R2-2R(6,6) with H/U=2 with d=2.60cm
...
mat1.add_nuclide("O16", 2.280100e-02)
mat1.add_nuclide("H1", 1.472500e-02)
...
cell1.region = +surf11 & -surf18 & +surf21 & -surf29 & +surf31 & -surf39
...
source.space = openmc.stats.Box((-11.26, -11.26, -11.0), (11.26, 11.26, 11.0))
