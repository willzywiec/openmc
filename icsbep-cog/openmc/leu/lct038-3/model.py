"""
LCT038-3: Two (18x13-2) arrays of U(4.738)O2 rods, 1.60 cm pitch, 5.0cm concrete reflector, Hc=65.4cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=65.4)
# Lower grid plate
...
surf12 = openmc.model.RectangularParallelepiped(-89.9, 5.100000000000001, -47.5, 47.5, -3.4, -2.6)
# Water & tank & BCD
surf13 = openmc.model.RectangularParallelepiped(-114.9, 5.399999999999999, -60.0, 60.0, -22.599999999999994, 117.5, boundary_type="vacuum")
surf14 = openmc.XPlane(surface_id=14, x0=0.0)
surf15 = openmc.XPlane(surface_id=15, x0=5.1)
...
# Concrete
surf40 = openmc.model.RectangularParallelepiped(0.34999999999999964, 4.75, -34.7, 34.7, -2.25, 97.15)
# Concrete
surf41 = openmc.model.RectangularParallelepiped(0.04999999999999982, 5.05, -34.7, 34.7, -0.04999999999999716, 94.95)
# Frame
surf42 = openmc.model.RectangularParallelepiped(0.04999999999999982, 5.05, -35.0, 35.0, -2.549999999999997, 97.45)
# PVC & paint
surf43 = openmc.model.RectangularParallelepiped(0.0, 5.1, -35.05, 35.05, -2.5999999999999943, 97.5)
...
source.space = openmc.stats.Box((-21.0, -1.8, 31.700000000000003), (0.19999999999999996, 1.8, 33.7))
