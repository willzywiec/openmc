"""
LCT050-10: Exp. No. 2771; 23x23-35=494 array of U(4.738)O2 rods on 1.3cm pitch; samarium solution no. C2
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=88.83)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 43.415), (5.55, 5.55, 45.415))
