"""
LCT042-4: (20x18)-2.566cm-BoroflexPlex(25x18)PlexBoroflex-2.566cm-(20x18) array of U(2.35)O2 fuel rods with 1.684 cm pitch
...
mat7.add_nuclide("B10", 6.282200e-03)
mat7.add_nuclide("B11", 2.528700e-02)
mat7.add_element("C", 1.833900e-02)
mat7.add_element("Cr", 6.014500e-06)
mat7.add_element("Fe", 9.332900e-06)
mat7.add_nuclide("H1", 2.740800e-02)
mat7.add_nuclide("O16", 1.368900e-02)
mat7.add_element("Si", 8.310300e-03)
...
surf3 = openmc.XPlane(surface_id=3, x0=-23.616)
surf4 = openmc.XPlane(surface_id=4, x0=-21.05)
surf5 = openmc.XPlane(surface_id=5, x0=21.05)
surf6 = openmc.XPlane(surface_id=6, x0=23.616)
# Al-5052 lower plug
...
surf20 = openmc.XPlane(surface_id=20, x0=-21.21)
surf21 = openmc.model.RectangularParallelepiped(-21.436, -21.049999999999997, -15.1, 15.1, 0.0, 91.5)
surf22 = openmc.XPlane(surface_id=22, x0=21.21)
surf23 = openmc.model.RectangularParallelepiped(21.049999999999997, 21.436, -15.1, 15.1, 0.0, 91.5)
...
cell1.translation = (-39.614, 0.0, 0.0)
...
cell5.translation = (39.614, 0.0, 0.0)
...
source.space = openmc.stats.Box((-40.614, -1.842, 44.72), (40.614, 1.842, 46.72))
