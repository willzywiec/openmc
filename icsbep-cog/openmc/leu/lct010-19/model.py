"""
LEU-COMP-THERM-010-19: (12x16)-13.343cm-(12x16)-13.343cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; Steel walls; 5.405 gap
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-47.399, 47.399, -15.136, 15.136, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-104.15, 104.15, -45.636, 45.636, -20.0625, 109.4975, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-24.695)
surf4 = openmc.XPlane(surface_id=4, x0=-11.352)
surf5 = openmc.XPlane(surface_id=5, x0=11.352)
surf6 = openmc.XPlane(surface_id=6, x0=24.695)
# Rubber
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -38.391000000000005, -20.541, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 20.541, 38.391000000000005, -20.0625, 101.8375)
...
cell1.translation = (-36.047, 0.0, 0.0)
...
cell5.translation = (36.047, 0.0, 0.0)
...
source.space = openmc.stats.Box((-36.101, -2.27, 45.0375), (36.101, 2.27, 47.0375))
