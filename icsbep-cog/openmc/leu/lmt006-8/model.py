"""
LMT006-8: Case 8; Bugey 6; detailed; 33 type 1 tubes; 11.2cm pitch; Hw=59.41cm; no additional plate
...
# Critical water height, Hw=59.41-0.4=59.01
surf904 = openmc.ZPlane(surface_id=904, z0=59.01)
...
cell2.region = -surf101 & +surf902 & -surf905 & -surf999

# Ftube
cell3 = openmc.Cell(cell_id=3, fill=universe3)
cell3.translation = (-40.0, -28.8, -0.4)
cell3.region = -surf102 & +surf902 & -surf905 & -surf999

# Ftube
cell4 = openmc.Cell(cell_id=4, fill=universe3)
cell4.translation = (-40.0, -17.6, -0.4)
cell4.region = -surf103 & +surf902 & -surf905 & -surf999

# Ftube
cell5 = openmc.Cell(cell_id=5, fill=universe3)
cell5.translation = (-40.0, -6.4, -0.4)
cell5.region = -surf104 & +surf902 & -surf905 & -surf999

# Ftube
cell6 = openmc.Cell(cell_id=6, fill=universe3)
cell6.translation = (-40.0, 4.8, -0.4)
cell6.region = -surf105 & +surf902 & -surf905 & -surf999

# Ftube
cell7 = openmc.Cell(cell_id=7, fill=universe3)
cell7.translation = (-40.0, 16.0, -0.4)
cell7.region = -surf106 & +surf902 & -surf905 & -surf999

# Ftube
cell8 = openmc.Cell(cell_id=8, fill=universe3)
cell8.translation = (-30.30052, -34.4, -0.4)
cell8.region = -surf111 & +surf902 & -surf905 & -surf999

# Ftube
cell9 = openmc.Cell(cell_id=9, fill=universe3)
cell9.translation = (-30.30052, -23.2, -0.4)
cell9.region = -surf112 & +surf902 & -surf905 & -surf999

# Ftube
cell10 = openmc.Cell(cell_id=10, fill=universe3)
cell10.translation = (-30.30052, -12.0, -0.4)
cell10.region = -surf113 & +surf902 & -surf905 & -surf999

# Ftube
cell11 = openmc.Cell(cell_id=11, fill=universe3)
cell11.translation = (-30.30052, -0.8, -0.4)
cell11.region = -surf114 & +surf902 & -surf905 & -surf999

# Ftube
cell12 = openmc.Cell(cell_id=12, fill=universe3)
cell12.translation = (-30.30052, 10.4, -0.4)
cell12.region = -surf115 & +surf902 & -surf905 & -surf999

# Ftube
cell13 = openmc.Cell(cell_id=13, fill=universe3)
cell13.translation = (-20.60103, -40.0, -0.4)
cell13.region = -surf121 & +surf902 & -surf905 & -surf999

# Ftube
cell14 = openmc.Cell(cell_id=14, fill=universe3)
cell14.translation = (-20.60103, -28.8, -0.4)
cell14.region = -surf122 & +surf902 & -surf905 & -surf999

# Ftube
cell15 = openmc.Cell(cell_id=15, fill=universe3)
cell15.translation = (-20.60103, -17.6, -0.4)
cell15.region = -surf123 & +surf902 & -surf905 & -surf999

# Ftube
cell16 = openmc.Cell(cell_id=16, fill=universe3)
cell16.translation = (-20.60103, -6.4, -0.4)
cell16.region = -surf124 & +surf902 & -surf905 & -surf999

# Ftube
cell17 = openmc.Cell(cell_id=17, fill=universe3)
cell17.translation = (-20.60103, 4.8, -0.4)
cell17.region = -surf125 & +surf902 & -surf905 & -surf999

# Ftube
cell18 = openmc.Cell(cell_id=18, fill=universe3)
cell18.translation = (-20.60103, 16.0, -0.4)
cell18.region = -surf126 & +surf902 & -surf905 & -surf999

# Ftube
cell19 = openmc.Cell(cell_id=19, fill=universe3)
cell19.translation = (-10.90155, -34.4, -0.4)
cell19.region = -surf131 & +surf902 & -surf905 & -surf999

# Ftube
cell20 = openmc.Cell(cell_id=20, fill=universe3)
cell20.translation = (-10.90155, -23.2, -0.4)
cell20.region = -surf132 & +surf902 & -surf905 & -surf999

# Ftube
cell21 = openmc.Cell(cell_id=21, fill=universe3)
cell21.translation = (-10.90155, -12.0, -0.4)
cell21.region = -surf133 & +surf902 & -surf905 & -surf999

# Ftube
cell22 = openmc.Cell(cell_id=22, fill=universe3)
cell22.translation = (-10.90155, -0.8, -0.4)
cell22.region = -surf134 & +surf902 & -surf905 & -surf999

# Ftube
cell23 = openmc.Cell(cell_id=23, fill=universe3)
cell23.translation = (-10.90155, 10.4, -0.4)
cell23.region = -surf135 & +surf902 & -surf905 & -surf999

# Ftube
cell24 = openmc.Cell(cell_id=24, fill=universe3)
cell24.translation = (-1.20206, -40.0, -0.4)
cell24.region = -surf141 & +surf902 & -surf905 & -surf999

# Ftube
cell25 = openmc.Cell(cell_id=25, fill=universe3)
cell25.translation = (-1.20206, -28.8, -0.4)
cell25.region = -surf142 & +surf902 & -surf905 & -surf999

# Ftube
cell26 = openmc.Cell(cell_id=26, fill=universe3)
cell26.translation = (-1.20206, -17.6, -0.4)
cell26.region = -surf143 & +surf902 & -surf905 & -surf999

# Ftube
cell27 = openmc.Cell(cell_id=27, fill=universe3)
cell27.translation = (-1.20206, -6.4, -0.4)
cell27.region = -surf144 & +surf902 & -surf905 & -surf999

# Ftube
cell28 = openmc.Cell(cell_id=28, fill=universe3)
cell28.translation = (-1.20206, 4.8, -0.4)
cell28.region = -surf145 & +surf902 & -surf905 & -surf999

# Ftube
cell29 = openmc.Cell(cell_id=29, fill=universe3)
cell29.translation = (-1.20206, 16.0, -0.4)
cell29.region = -surf146 & +surf902 & -surf905 & -surf999

# Ftube
cell30 = openmc.Cell(cell_id=30, fill=universe3)
cell30.translation = (8.49742, -34.4, -0.4)
cell30.region = -surf151 & +surf902 & -surf905 & -surf999

# Ftube
cell31 = openmc.Cell(cell_id=31, fill=universe3)
cell31.translation = (8.49742, -23.2, -0.4)
cell31.region = -surf152 & +surf902 & -surf905 & -surf999

# Ftube
cell32 = openmc.Cell(cell_id=32, fill=universe3)
cell32.translation = (8.49742, -12.0, -0.4)
cell32.region = -surf153 & +surf902 & -surf905 & -surf999

# Ftube
cell33 = openmc.Cell(cell_id=33, fill=universe3)
cell33.translation = (8.49742, -0.8, -0.4)
cell33.region = -surf154 & +surf902 & -surf905 & -surf999

# Ftube
cell34 = openmc.Cell(cell_id=34, fill=universe3)
cell34.translation = (8.49742, 10.4, -0.4)
cell34.region = -surf155 & +surf902 & -surf905 & -surf999

# Water
cell35 = openmc.Cell(cell_id=35, fill=mat2)
cell35.region = +surf902 & -surf904 & -surf999 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106

# Air
cell36 = openmc.Cell(cell_id=36, fill=mat5)
cell36.region = +surf904 & -surf905 & -surf999 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105
