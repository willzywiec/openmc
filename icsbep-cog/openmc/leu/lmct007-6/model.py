"""
LMCT007-6: STACY run 625 with U(5)O2 rods immersed in 88.81cm of U(6) uranyl nitrate with water reflection
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=88.81)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 44.405))
