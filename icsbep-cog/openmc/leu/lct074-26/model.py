"""
LEU-COMP-THERM-074-26: MIRTE-1 Experiment R4A-Water-003; 9x8; Hc=60.450cm
...
lattice4.lower_left = [-24.15, 0.15]
...
lattice5.lower_left = [-24.15, -24.15]
...
lattice6.lower_left = [0.15, -24.15]
...
cell6.region = +surf4 & -surf8 & +surf11 & +surf12 & +surf13 & +surf14 & -surf9

# Air
cell7 = openmc.Cell(cell_id=7, fill=mat7)
cell7.region = +surf4 & -surf8 & +surf11 & +surf12 & +surf13 & +surf14 & +surf9
...
source.space = openmc.stats.Box((-8.35, -8.35, 29.225), (8.35, 8.35, 31.225))
