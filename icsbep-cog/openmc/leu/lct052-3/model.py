"""
LCT052-3: Hexagonal array of 1261 U(4.738)O2 fuel rods with 2.26 cm triangular pitch in gadolinium nitrate solution
...
mat4.add_element("Gd", 6.548670e-07)
mat4.add_element("N", 6.180070e-06)
mat4.add_nuclide("H1", 6.669670e-02)
mat4.add_nuclide("O16", 3.336480e-02)
...
surf5 = openmc.ZPlane(surface_id=5, z0=89.0)
# UO2
...
surf99_0 = openmc.Plane(a=0.8660254202, b=0.4999999716, c=0, d=40.1229577180)
surf99_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=40.1229600000)
surf99_2 = openmc.Plane(a=-0.8660254202, b=0.4999999716, c=0, d=40.1229577180)
surf99_3 = openmc.Plane(a=-0.8660254202, b=-0.4999999716, c=0, d=40.1229577180)
surf99_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=40.1229600000)
...
lattice3.lower_left = [-47.46, -41.10162]
...
source.space = openmc.stats.Point((0.0, 0.0, 44.5))
