"""
LEU-COMP-THERM-002-5: (13x8)-7.11cm-(13x8)-7.11cm-(13x8) array of U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-56.64, 56.64, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-86.64, 86.64, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-23.62)
surf4 = openmc.XPlane(surface_id=4, x0=-16.51)
surf5 = openmc.XPlane(surface_id=5, x0=16.51)
surf6 = openmc.XPlane(surface_id=6, x0=23.62)
# Rubber
...
cell1.translation = (-40.13, 0.0, 0.0)
...
cell5.translation = (40.13, 0.0, 0.0)
