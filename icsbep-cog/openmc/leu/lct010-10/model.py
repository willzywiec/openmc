"""
LEU-COMP-THERM-010-10: (13x8)-13.125cm-(13x8)-13.125cm-(13x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; Steel walls; 0.660 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -28.67, -10.82, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 10.82, 28.67, -20.0625, 101.8375)
...
cell1.translation = (-46.145, 0.0, 0.0)
...
cell5.translation = (46.145, 0.0, 0.0)
...
source.space = openmc.stats.Box((-47.145, -2.27, 45.0375), (47.145, 2.27, 47.0375))
