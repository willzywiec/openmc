"""
LST011-12: Air reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=996 (Run 472)
...
mat1.add_nuclide("U234", 4.818100e-07)
mat1.add_nuclide("U235", 5.766700e-05)
mat1.add_nuclide("U236", 9.554400e-08)
mat1.add_nuclide("U238", 8.898900e-04)
mat1.add_nuclide("H1", 5.742300e-02)
mat1.add_element("N", 2.522600e-03)
mat1.add_nuclide("O16", 3.786200e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=87.91)
...
source.space = openmc.stats.Point((0.0, 0.0, 43.955))
