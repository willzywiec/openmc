"""
LCT030-11: 709 U(3.5)O2 rods, 1.27 cm trianglur pitch, Hc=104.60cm
...
surf1 = openmc.ZPlane(surface_id=1, z0=104.60)
...
surf321 = openmc.model.RectangularParallelepiped(-6.35, 6.35, -499.5, 499.5, -499.5, 499.5)
# (10 on each short side)
surf322 = openmc.model.RectangularParallelepiped(-6.35, 6.35, -499.5, 499.5, -499.5, 499.5)
surf323 = openmc.model.RectangularParallelepiped(-6.35, 6.35, -499.5, 499.5, -499.5, 499.5)
surf331 = openmc.model.RectangularParallelepiped(-1.905, 1.905, -499.5, 499.5, -499.5, 499.5)
# (3 on each short side)
surf332 = openmc.model.RectangularParallelepiped(-1.905, 1.905, -499.5, 499.5, -499.5, 499.5)
surf333 = openmc.model.RectangularParallelepiped(-1.905, 1.905, -499.5, 499.5, -499.5, 499.5)
...
source.space = openmc.stats.Point((0.0, 0.0, 52.3))
