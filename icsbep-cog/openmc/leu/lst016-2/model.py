"""
LST016-2: Water reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=514 (Run 113)
...
mat1.add_nuclide("U234", 8.849400e-07)
mat1.add_nuclide("U235", 1.098100e-04)
mat1.add_nuclide("U236", 1.096800e-07)
mat1.add_nuclide("U238", 9.781300e-04)
mat1.add_nuclide("H1", 5.645900e-02)
mat1.add_element("N", 2.659700e-03)
mat1.add_nuclide("O16", 3.814600e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=42.77)
...
source.space = openmc.stats.Point((0.0, 0.0, 21.385))
