...
# Hole in grid plates
surf21_cyl = openmc.ZCylinder(surface_id=21, x0=tr, y0=-1.957217, r=0.5)
surf21_zmin = openmc.ZPlane(z0=1.13)
surf21_zmax = openmc.ZPlane(z0=0.0)
surf21 = (surf21_cyl, surf21_zmin, surf21_zmax)
# Hole in grid plates
surf22_cyl = openmc.ZCylinder(surface_id=22, x0=tr, y0=-1.957217, r=0.5)
surf22_zmin = openmc.ZPlane(z0=-1.13)
surf22_zmax = openmc.ZPlane(z0=0.0)
surf22 = (surf22_cyl, surf22_zmin, surf22_zmax)
# Hole in grid plates
surf23_cyl = openmc.ZCylinder(surface_id=23, x0=tr, y0=1.957217, r=0.5)
surf23_zmin = openmc.ZPlane(z0=1.13)
surf23_zmax = openmc.ZPlane(z0=0.0)
surf23 = (surf23_cyl, surf23_zmin, surf23_zmax)
# Hole in grid plates
surf24_cyl = openmc.ZCylinder(surface_id=24, x0=tr, y0=1.957217, r=0.5)
surf24_zmin = openmc.ZPlane(z0=-1.13)
