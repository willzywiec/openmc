"""
LCT007-1: 22x22 array of 484 U(4.738)O2 fuel rods with 1.26 cm square pitch in water
...
# Lattice boundary
surf2 = openmc.model.RectangularParallelepiped(-13.86, 13.86, -13.86, 13.86, -499.95, 499.95)
# Hc
surf10 = openmc.ZPlane(surface_id=10, z0=90.69)
# UO2
...
# Lattice 2: 22x22 array
lattice2 = openmc.RectLattice(lattice_id=2)
lattice2.lower_left = [-13.86, -13.86]
lattice2.pitch = [1.260000, 1.260000]
lattice2.universes = [
...
source.space = openmc.stats.Box((-1.63, -1.63, 44.345), (1.63, 1.63, 46.345))
