"""
LCT049-17S: Simplified model of R2-2R(5,5) with H/U=2 & 3 (checkerboard) and d=8.90cm
...
cell1.region = +surf11 & -surf18 & +surf21 & -surf28 & +surf31 & -surf38
...
source.space = openmc.stats.Box((-36.23, -1.0, -1.0), (36.23, 1.0, 1.0))
