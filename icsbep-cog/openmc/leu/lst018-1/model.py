"""
LST018-1: Concrete reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=751 (Run 133)
...
mat1.add_nuclide("U234", 6.342200e-07)
mat1.add_nuclide("U235", 7.870200e-05)
mat1.add_nuclide("U236", 7.860400e-08)
mat1.add_nuclide("U238", 7.010100e-04)
mat1.add_nuclide("H1", 5.913500e-02)
mat1.add_element("N", 2.042600e-03)
mat1.add_nuclide("O16", 3.701500e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=67.91)
# C150
surf11 = openmc.model.RectangularParallelepiped(-32.61, -17.61, -35.7, 35.7, 0.0, 150.6)
# Steel Frame
surf12 = openmc.model.RectangularParallelepiped(-32.61, -17.61, -38.7, 38.7, -3.0, 153.6)
# Aluminum
surf13 = openmc.model.RectangularParallelepiped(-33.42, -16.799999999999997, -38.7, 38.7, -3.0, 153.6)
# C150
surf21 = openmc.model.RectangularParallelepiped(17.61, 32.61, -35.7, 35.7, 0.0, 150.6)
# Steel Frame
surf22 = openmc.model.RectangularParallelepiped(17.61, 32.61, -38.7, 38.7, -3.0, 153.6)
# Aluminum
surf23 = openmc.model.RectangularParallelepiped(16.799999999999997, 33.42, -38.7, 38.7, -3.0, 153.6)
# BCD
surf99 = openmc.model.RectangularParallelepiped(-33.5, 33.5, -39.0, 39.0, -4.0, 156.0, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 33.955))
