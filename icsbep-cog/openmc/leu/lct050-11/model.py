"""
LCT050-11: Exp. No. 2772; 25x25-25=600 array of U(4.738)O2 rods on 1.3cm pitch; samarium solution no. C2
...
mat8.add_nuclide("H1", 6.671100e-02)
mat8.add_nuclide("O16", 3.338700e-02)
mat8.add_element("N", 1.191000e-05)
mat8.add_nuclide("Sm144", 8.988500e-10)
mat8.add_nuclide("Sm147", 1.760950e-09)
mat8.add_nuclide("Sm148", 6.996170e-09)
mat8.add_nuclide("Sm149", 8.417080e-07)
mat8.add_nuclide("Sm150", 1.207980e-08)
mat8.add_nuclide("Sm152", 3.405870e-09)
mat8.add_nuclide("Sm154", 1.680780e-04)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=59.11)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 28.555), (5.55, 5.55, 30.555))
