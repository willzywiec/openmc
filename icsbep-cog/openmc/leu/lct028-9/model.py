"""
LCT028-9: 422 U(4.31)O2 rods with 2.286 cm triangular pitch in water with 0.213 gGd/l
...
# Water with Gd (Case 9)
mat5 = openmc.Material(material_id=5)
mat5.set_density("sum")
mat5.add_nuclide("H1", 6.671100e-02)
mat5.add_element("N", 5.096900e-06)
mat5.add_nuclide("O16", 3.337100e-02)
mat5.add_element("Gd", 8.167100e-07)
...
surf21_0 = openmc.Plane(a=0.8660292486, b=0.4999933405, c=0, d=25.7366572100)
surf21_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=25.7370000000)
surf21_2 = openmc.Plane(a=-0.8660292486, b=0.4999933405, c=0, d=25.7366572100)
surf21_3 = openmc.Plane(a=-0.8660292486, b=-0.4999933405, c=0, d=25.7366572100)
surf21_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=25.7370000000)
surf21_5 = openmc.Plane(a=0.8660292486, b=-0.4999933405, c=0, d=25.7366572100)
