...
# Lexan  lattice plate
surf1 = openmc.ZCylinder(surface_id=1, x0=83.165, y0=83.800, r=30.0)
# SS304L lattice plate
surf2 = openmc.ZCylinder(surface_id=2, x0=-2.225, y0=-0.635, r=30.0)
# Al6061 lattice plate
surf3 = openmc.ZCylinder(surface_id=3, x0=-2.860, y0=-2.225, r=30.0)
