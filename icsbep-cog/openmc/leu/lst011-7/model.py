"""
LST011-7: Water reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=1,065 (Run 486)
...
mat1.add_nuclide("U234", 4.533800e-07)
mat1.add_nuclide("U235", 5.426400e-05)
mat1.add_nuclide("U236", 8.990600e-08)
mat1.add_nuclide("U238", 8.373700e-04)
mat1.add_nuclide("H1", 5.778800e-02)
mat1.add_element("N", 2.416700e-03)
mat1.add_nuclide("O16", 3.761200e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=109.72)
...
source.space = openmc.stats.Point((0.0, 0.0, 54.86))
