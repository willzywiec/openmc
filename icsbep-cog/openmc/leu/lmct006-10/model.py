"""
LMCT006-10: STACY run 560 with U(5)O2 rods immersed in 84.21cm of U(6) uranyl nitrate and Gd solution, unreflected
...
mat1.add_nuclide("U234", 4.204400e-07)
mat1.add_nuclide("U235", 5.023800e-05)
mat1.add_nuclide("U236", 8.337500e-08)
mat1.add_nuclide("U238", 7.766200e-04)
mat1.add_nuclide("O16", 3.803100e-02)
mat1.add_nuclide("H1", 5.688500e-02)
mat1.add_element("N", 2.842200e-03)
mat1.add_element("Gd", 3.665000e-07)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=84.21)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 42.105))
