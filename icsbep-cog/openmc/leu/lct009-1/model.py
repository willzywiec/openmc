"""
LEU-COMP-THERM-009-1: (15x8)-4.0475cm-(0.485cm STL)-4.0475cm-(15x8)-4.0475cm-(0.485cm STL)-4.0475cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
mat6.add_element("Cr", 1.704600e-02)
mat6.add_element("Cu", 2.029100e-04)
mat6.add_element("Fe", 5.835300e-02)
mat6.add_element("Mn", 1.373400e-03)
mat6.add_element("Mo", 1.294200e-04)
mat6.add_element("Ni", 9.023800e-03)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-65.73, 65.73, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-95.73, 95.73, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-27.63)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=27.63)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-23.5825, -23.0975, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(23.0975, 23.5825, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-46.68, 0.0, 0.0)
...
cell5.translation = (46.68, 0.0, 0.0)
...
source.space = openmc.stats.Box((-47.68, -2.27, 45.0375), (47.68, 2.27, 47.0375))
