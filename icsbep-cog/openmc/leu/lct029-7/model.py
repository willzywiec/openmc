"""
LCT029-7: 21x20 array of 420 U(4.738)O2 fuel rods with 1.60 cm square pitch with four, 0.0978cm thick, Hf plates
...
surf5 = openmc.ZPlane(surface_id=5, z0=52.10)
...
source.space = openmc.stats.Box((-1.0, -1.0, 25.05), (2.6, 1.0, 27.05))
