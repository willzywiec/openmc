"""
LCT003-19: 17x17 (two) + 17x17 (two) arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water and 2.59 (x) and 13.87(y) cm separation (SSC-2.35-000-072)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-29.923, 29.923, -35.563, 35.563, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-59.923, 59.923, -65.563, 65.563, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-1.295)
surf4 = openmc.XPlane(surface_id=4, x0=1.295)
surf5 = openmc.YPlane(surface_id=5, y0=-6.935)
surf6 = openmc.YPlane(surface_id=6, y0=6.935)
# Al-5052 lower plug
...
cell1.translation = (-15.609, -21.249, 0.0)
...
cell3.translation = (15.609, -21.249, 0.0)
...
cell5.translation = (-15.609, 21.249, 0.0)
cell5.region = -surf1 & -surf2 & -surf3 & +surf6

# EMPTY
cell6 = openmc.Cell(cell_id=6, fill=universe2)
cell6.region = -surf1 & -surf2 & +surf3 & -surf4 & +surf6

# CORE
cell7 = openmc.Cell(cell_id=7, fill=universe3)
cell7.translation = (15.609, 21.249, 0.0)
cell7.region = -surf1 & -surf2 & +surf4 & +surf6

# H2O
cell8 = openmc.Cell(cell_id=8, fill=mat5)
cell8.region = +surf1 & -surf2

# Water
cell17 = openmc.Cell(cell_id=17, fill=mat5)
cell17.region = -surf2 & +surf17 & (+surf14 | -surf14_zmin | +surf14_zmax) & (+surf15 | -surf15_zmin | +surf15_zmax)

# Water
cell21 = openmc.Cell(cell_id=21, fill=mat5)
cell21.region = -surf2 & -surf16

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell17, cell21])
...
source.space = openmc.stats.Box((-16.609, -22.249, 44.72), (16.609, 22.249, 46.72))
