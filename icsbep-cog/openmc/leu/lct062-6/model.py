"""
LCT062-6: 18x18 array of U(2.6)O2 rods on 1.9558cm pitch with 0.3114cm SST-0.67B plate, no gap (TCA)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=111.50)
# Array boundary
...
surf31 = openmc.model.RectangularParallelepiped(17.6022, 17.9136, -22.5, 22.5, 0.37000000000000455, 150.37)
...
source.space = openmc.stats.Box((-1.98, -1.98, 54.75), (1.98, 1.98, 56.75))
