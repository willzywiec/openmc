"""
LCT050-5: Exp. No. 2766; 27x25-25=650 array of U(4.738)O2 rods on 1.3cm pitch; boron solution no. 2
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=63.67)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 30.835), (5.55, 5.55, 32.835))
