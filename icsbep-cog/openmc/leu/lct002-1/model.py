"""
LEU-COMP-THERM-002-1: 10x11.51 = 10x11 + 5 array of U(4.31)O2 rods in water; 2.54 cm pitch
...
# Boundary of 10x12 Array
surf1 = openmc.model.RectangularParallelepiped(-12.7, 12.7, -15.24, 15.24, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-42.7, 42.7, -45.24, 45.24, -20.0625, 107.075, boundary_type="vacuum")
# Rubber
...
surf11_zmin = openmc.ZPlane(surface_id=1016, z0=-2.2225)
surf11_zmax = openmc.ZPlane(surface_id=1017, z0=0.0)
surf12_zmin = openmc.ZPlane(surface_id=1018, z0=0.0)
surf12_zmax = openmc.ZPlane(surface_id=1019, z0=92.075)
surf13_zmin = openmc.ZPlane(surface_id=1020, z0=92.075)
surf13_zmax = openmc.ZPlane(surface_id=1021, z0=94.2975)
surf15_zmin = openmc.ZPlane(surface_id=1022, z0=-2.2225)
surf15_zmax = openmc.ZPlane(surface_id=1023, z0=94.2975)
...
# Lattice 3: 10x12 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-12.7, -15.24]
...
source.space = openmc.stats.Box((-2.27, -2.27, 45.0375), (2.27, 2.27, 47.0375))
