"""
LCT003-13: 17x17 (two) + 17x1 (two) arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water and 2.59 (x) and 5.11 (y) cm separation (SSC-2.35-000-078)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-29.923, 29.923, -17.711, 17.711, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-59.923, 59.923, -47.711, 47.711, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-1.295)
surf4 = openmc.XPlane(surface_id=4, x0=1.295)
surf5 = openmc.YPlane(surface_id=5, y0=10.917)
surf6 = openmc.YPlane(surface_id=6, y0=16.027)
# Al-5052 lower plug
...
cell1.translation = (-15.609, -3.397, 0.0)
...
cell3.translation = (15.609, -3.397, 0.0)
...
cell5.translation = (-15.609, 16.869, 0.0)
...
cell7.translation = (15.609, 16.869, 0.0)
...
source.space = openmc.stats.Box((-16.609, -4.397, 44.72), (16.609, 17.869, 46.72))
