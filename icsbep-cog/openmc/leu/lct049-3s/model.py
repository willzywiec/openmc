"""
LCT049-3S: Simplified model of R2-3R(6,6) with H/U=2 and d=9.83cm
...
cell1.region = +surf11 & -surf19 & +surf21 & -surf29 & +surf31 & -surf39
...
source.space = openmc.stats.Box((-26.435, -11.26, -11.0), (5.915, 11.26, 11.0))
