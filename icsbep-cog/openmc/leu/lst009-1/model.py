"""
LST009-1: STACY 60cm diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=936 reflected with (B010) borated concrete (Run 92)
...
mat1.add_nuclide("U234", 5.037100e-07)
mat1.add_nuclide("U235", 6.250700e-05)
mat1.add_nuclide("U236", 6.242900e-08)
mat1.add_nuclide("U238", 5.567600e-04)
mat1.add_nuclide("H1", 5.849300e-02)
mat1.add_element("N", 2.504300e-03)
mat1.add_nuclide("O16", 3.736700e-02)
...
# Borated Concrete (B010)
mat6 = openmc.Material(material_id=6)
mat6.set_density("sum")
mat6.add_nuclide("H1", 1.924100e-02)
mat6.add_nuclide("O16", 9.620500e-03)
mat6.add_nuclide("O16", 3.444900e-02)
mat6.add_nuclide("B10", 1.108500e-04)
mat6.add_nuclide("B11", 4.461800e-04)
mat6.add_element("C", 1.403900e-04)
mat6.add_element("Na", 2.429100e-04)
mat6.add_element("Mg", 3.272200e-04)
mat6.add_element("Al", 6.733100e-04)
mat6.add_element("Si", 1.359400e-02)
mat6.add_element("S", 1.910400e-04)
mat6.add_element("Cl", 1.206000e-06)
mat6.add_element("K", 1.777300e-04)
mat6.add_element("Ca", 4.829300e-03)
mat6.add_element("Fe", 2.074100e-04)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=74.38)
# Steel support/inner
surf11 = openmc.ZCylinder(surface_id=11, r=31.7)
# Steel support/outer
surf12 = openmc.ZCylinder(surface_id=12, r=68.5)
# Aluminum reflector bottom plate
surf13 = openmc.ZCylinder(surface_id=13, r=51.44)
# Steel reflector top plate
surf14 = openmc.ZCylinder(surface_id=14, r=51.44)
# = 29.82 +  0.47 (Inner Gap)
surf15 = openmc.ZCylinder(surface_id=15, r=30.29)
# = 30.29 +  0.31 (Inner Wall)
surf16 = openmc.ZCylinder(surface_id=16, r=30.6)
# = 30.60 + 20.04 (Concrete)
surf17 = openmc.ZCylinder(surface_id=17, r=50.64)
# = 50.64 +  0.80 (Outer Wall)
surf18 = openmc.ZCylinder(surface_id=18, r=51.44)
# BCD
surf19 = openmc.ZCylinder(surface_id=19, r=68.5, boundary_type="vacuum")

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1019, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1020, z0=149.86)
surf2_zmin = openmc.ZPlane(surface_id=1021, z0=-2.02)
surf2_zmax = openmc.ZPlane(surface_id=1022, z0=152.8)
surf12_zmin = openmc.ZPlane(surface_id=1023, z0=-4.0)
surf12_zmax = openmc.ZPlane(surface_id=1024, z0=-1.5)
surf13_zmin = openmc.ZPlane(surface_id=1025, z0=-1.5)
surf13_zmax = openmc.ZPlane(surface_id=1026, z0=0.0)
surf14_zmin = openmc.ZPlane(surface_id=1027, z0=142.0)
surf14_zmax = openmc.ZPlane(surface_id=1028, z0=142.6)
surf16_zmin = openmc.ZPlane(surface_id=1029, z0=0.0)
surf16_zmax = openmc.ZPlane(surface_id=1030, z0=142.0)
surf17_zmin = openmc.ZPlane(surface_id=1031, z0=0.0)
surf17_zmax = openmc.ZPlane(surface_id=1032, z0=142.0)
surf18_zmin = openmc.ZPlane(surface_id=1033, z0=0.0)
surf18_zmax = openmc.ZPlane(surface_id=1034, z0=142.0)
surf19_zmin = openmc.ZPlane(surface_id=1035, z0=-4.0, boundary_type="vacuum")
surf19_zmax = openmc.ZPlane(surface_id=1036, z0=152.8, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 37.19))
