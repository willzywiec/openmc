"""
LEU-COMP-THERM-101-1: MIRTE-2.2 Experiment 4A-PVC-010; 11x12; Hc=63.085cm
...
mat7.add_nuclide("H1", 4.209400e-02)
mat7.add_element("C", 2.792300e-02)
mat7.add_nuclide("O16", 2.031000e-03)
mat7.add_element("Cl", 1.162100e-02)
mat7.add_element("Ca", 4.137900e-04)
mat7.add_element("Cr", 2.104700e-07)
mat7.add_element("Cu", 1.457200e-07)
mat7.add_element("Sn", 3.262100e-06)
mat7.add_element("Mg", 4.849100e-06)
mat7.add_element("Al", 4.056000e-06)
mat7.add_element("K", 4.736800e-07)
mat7.add_element("Na", 2.160400e-05)
mat7.add_element("S", 1.837800e-05)
mat7.add_element("Ti", 2.286300e-05)
mat7.add_element("Si", 3.297100e-06)
mat7.add_element("Sr", 9.607700e-08)
mat7.add_element("Fe", 4.220800e-07)
...
lattice3.lower_left = [0.49665, 0.49665]
...
lattice4.lower_left = [-24.49665, 0.49665]
lattice4.pitch = [1.600000, 1.600000]
lattice4.universes = [
    [universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
...
lattice5.lower_left = [-24.49665, -24.49665]
...
lattice6.lower_left = [0.49665, -24.49665]
...
cell3.region = -surf8 & -surf13

# core
cell4 = openmc.Cell(cell_id=4, fill=universe6)
cell4.region = -surf8 & -surf14

# SST
cell5 = openmc.Cell(cell_id=5, fill=mat4)
cell5.region = -surf4 & -surf8 & +surf11 & +surf12 & +surf13 & +surf14

# PVC
cell6 = openmc.Cell(cell_id=6, fill=mat7)
cell6.region = +surf4 & -surf8 & +surf11 & +surf12 & +surf13 & +surf14 & -surf21

# PVC
cell7 = openmc.Cell(cell_id=7, fill=mat7)
cell7.region = +surf4 & -surf8 & +surf11 & +surf12 & +surf13 & +surf14 & +surf21 & -surf22

# H2O
cell8 = openmc.Cell(cell_id=8, fill=mat5)
cell8.region = +surf4 & -surf8 & +surf11 & +surf12 & +surf13 & +surf14 & +surf21 & +surf22 & -surf9

# Air
cell9 = openmc.Cell(cell_id=9, fill=mat6)
cell9.region = +surf4 & -surf8 & +surf11 & +surf12 & +surf13 & +surf14 & +surf21 & +surf22 & +surf9
...
source.space = openmc.stats.Box((-8.7, -8.7, 30.5425), (8.7, 8.7, 32.542500000000004))
