"""
LST017-4: Unreflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=650 (Run 126)
...
mat1.add_nuclide("U234", 7.217000e-07)
mat1.add_nuclide("U235", 8.955800e-05)
mat1.add_nuclide("U236", 8.944700e-08)
mat1.add_nuclide("U238", 7.977100e-04)
mat1.add_nuclide("H1", 5.822000e-02)
mat1.add_element("N", 2.257900e-03)
mat1.add_nuclide("O16", 3.741900e-02)
...
# Hc
surf10 = openmc.ZPlane(surface_id=10, z0=68.57)
...
source.space = openmc.stats.Point((0.0, 0.0, 34.285))
