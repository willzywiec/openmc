"""
LMT006-9: Case 9; Bugey 5; detailed; 36 type 1 tubes; 11.2cm pitch; Hw=54.65cm; no additional plate
...
# Critical water height, Hw=54.65-0.4=54.25 (absolute)
surf904 = openmc.ZPlane(surface_id=904, z0=54.25)
# Critical water height (relative to tube)
surf905 = openmc.ZPlane(surface_id=905, z0=54.65)
# Arbitrary
surf906 = openmc.ZPlane(surface_id=906, z0=60.0)
# Boundary condition
...
u3_cell0.region = -surf4 & (-surf5 & +surf5_zmin & -surf5_zmax) & (+surf6 | -surf6_zmin | +surf6_zmax) & -surf905
...
u3_cell2.region = +surf4 & (+surf5 | -surf5_zmin | +surf5_zmax) & (+surf6 | -surf6_zmin | +surf6_zmax) & -surf905
u3_cell3 = openmc.Cell(fill=mat3)
u3_cell3.region = (-surf6 & +surf6_zmin & -surf6_zmax)
u3_cell4 = openmc.Cell(fill=mat5)
u3_cell4.region = -surf4 & (-surf5 & +surf5_zmin & -surf5_zmax) & (+surf6 | -surf6_zmin | +surf6_zmax) & +surf905
u3_cell5 = openmc.Cell(fill=mat5)
u3_cell5.region = +surf4 & (+surf5 | -surf5_zmin | +surf5_zmax) & (+surf6 | -surf6_zmin | +surf6_zmax) & +surf905
...
cell38.region = +surf902 & -surf904 & -surf999 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106

# Air
cell39 = openmc.Cell(cell_id=39, fill=mat5)
cell39.region = +surf904 & -surf906 & -surf999 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106

# Water
cell40 = openmc.Cell(cell_id=40, fill=mat2)
cell40.region = +surf901 & -surf902 & -surf999
