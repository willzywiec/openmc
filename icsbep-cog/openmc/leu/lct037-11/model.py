"""
LCT037-11: 12x36 array of 432 U(4.738)O2 fuel rods with 1.60 cm square pitch with 20.0/20.0 cm concrete screens
...
mat6.add_nuclide("H1", 6.670200e-02)
mat6.add_nuclide("O16", 3.335100e-02)
...
# Water
surf7 = openmc.ZPlane(surface_id=7, z0=48.17)
# Dummy
...
# Concrete
surf30 = openmc.model.RectangularParallelepiped(20.95, 39.349999999999994, -34.2, 34.2, -2.1500000000000057, 96.25)
# Concrete
surf31 = openmc.model.RectangularParallelepiped(20.15, 40.15, -34.2, 34.2, 2.049999999999997, 92.05)
# Frame
surf32 = openmc.model.RectangularParallelepiped(20.15, 40.15, -35.0, 35.0, -2.950000000000003, 97.05)
# PVC & paint
surf33 = openmc.model.RectangularParallelepiped(20.099999999999998, 40.2, -35.05, 35.05, -3.0, 97.1)
# Tank wall
surf34 = openmc.model.RectangularParallelepiped(40.2, 40.5, -65.0, 65.0, -24.0, 116.0)
# AG3M pedestal plate
surf41 = openmc.model.RectangularParallelepiped(-145.5, 40.5, -93.0, 93.0, -4.0, -3.0)
# SST  pedestal plate
surf42 = openmc.model.RectangularParallelepiped(-145.5, 40.5, -93.0, 93.0, -6.5, -4.0)
# Entire problem
surf99 = openmc.model.RectangularParallelepiped(-49.2, 40.5, -65.05, 65.05, -24.0, 116.1, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-19.4, -1.8, 23.085), (0.19999999999999996, 1.8, 25.085))
