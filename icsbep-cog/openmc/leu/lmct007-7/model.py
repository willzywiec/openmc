"""
LMCT007-7: STACY run 600 with U(5)O2 rods immersed in 46.49cm of U(6) uranyl nitrate, unreflected
...
mat1.add_nuclide("U234", 3.800500e-07)
mat1.add_nuclide("U235", 4.541100e-05)
mat1.add_nuclide("U236", 7.536400e-08)
mat1.add_nuclide("U238", 7.020000e-04)
mat1.add_nuclide("O16", 3.749300e-02)
mat1.add_nuclide("H1", 5.844300e-02)
mat1.add_element("N", 2.411100e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=46.49)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 23.245))
