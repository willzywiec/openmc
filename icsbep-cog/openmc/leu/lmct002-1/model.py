"""
LMCT002-1: STACY run 368 with U(5)O2 rods immersed in 42.55cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 4.665000e-07)
mat1.add_nuclide("U235", 5.592700e-05)
mat1.add_nuclide("U236", 9.250800e-08)
mat1.add_nuclide("U238", 8.615200e-04)
mat1.add_nuclide("O16", 3.869100e-02)
mat1.add_nuclide("H1", 5.519700e-02)
mat1.add_element("N", 3.335500e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=42.55)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 21.275))
