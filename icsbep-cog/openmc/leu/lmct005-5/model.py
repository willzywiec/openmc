"""
LMCT005-5: STACY run 509 with U(5)O2 rods immersed in 53.24cm of U(6) uranyl nitrate, Sm and Cs solution with water reflection
...
mat1.add_nuclide("U234", 4.124700e-07)
mat1.add_nuclide("U235", 4.928500e-05)
mat1.add_nuclide("U236", 8.179300e-08)
mat1.add_nuclide("U238", 7.618900e-04)
mat1.add_nuclide("O16", 3.799300e-02)
mat1.add_nuclide("H1", 5.699500e-02)
mat1.add_element("N", 2.821600e-03)
mat1.add_element("Sm", 5.607200e-07)
mat1.add_element("Cs", 1.024000e-05)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=53.24)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 26.62))
