"""
LEU-COMP-THERM-010-14: (12x16)-14.393cm-(12x16)-14.393cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; Steel walls; 0.0 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -32.986000000000004, -15.136, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 15.136, 32.986000000000004, -20.0625, 101.8375)
...
cell1.translation = (-37.097, 0.0, 0.0)
...
cell5.translation = (37.097, 0.0, 0.0)
...
source.space = openmc.stats.Box((-37.151, -2.27, 45.0375), (37.151, 2.27, 47.0375))
