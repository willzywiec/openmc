...
# Al-5052 lower plug
surf11 = openmc.ZCylinder(surface_id=11, x0=-1.27, y0=0.0, r=0.558)
# U(2.35)O2 fuel
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=91.44, r=0.558)
# Al-1100 upper plug
surf13 = openmc.ZCylinder(surface_id=13, x0=91.44, y0=91.92, r=0.558)
# Al-6061 clad/outer
...
cell15.region = -surf2 & +surf17 & +surf14 & +surf15
