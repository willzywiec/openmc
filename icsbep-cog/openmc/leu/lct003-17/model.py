"""
LCT003-17: 17x17 (two) + 17x12 (two) arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water and 2.59 (x) and 9.97 (y) cm separation (SSC-2.35-000-074)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-29.923, 29.923, -29.403, 29.403, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-59.923, 59.923, -59.403, 59.403, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-1.295)
surf4 = openmc.XPlane(surface_id=4, x0=1.295)
surf5 = openmc.YPlane(surface_id=5, y0=-0.775)
surf6 = openmc.YPlane(surface_id=6, y0=9.195)
# Al-5052 lower plug
...
cell1.translation = (-15.609, -15.089, 0.0)
...
cell3.translation = (15.609, -15.089, 0.0)
...
cell5.translation = (-15.609, 20.141, 0.0)
...
cell7.translation = (15.609, 20.141, 0.0)
...
source.space = openmc.stats.Box((-16.609, -16.089, 44.72), (16.609, 21.141, 46.72))
