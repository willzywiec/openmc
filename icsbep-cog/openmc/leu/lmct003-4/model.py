"""
LMCT003-4: STACY run 419 with U(5)O2 rods immersed in 45.82cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 3.242100e-07)
mat1.add_nuclide("U235", 3.867500e-05)
mat1.add_nuclide("U236", 6.429100e-08)
mat1.add_nuclide("U238", 5.989300e-04)
mat1.add_nuclide("O16", 3.739900e-02)
mat1.add_nuclide("H1", 5.853700e-02)
mat1.add_element("N", 2.486400e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=45.82)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 22.91))
