"""
LST016-6: Water reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=739 (Run 140)
...
mat1.add_nuclide("U234", 6.410100e-07)
mat1.add_nuclide("U235", 7.954500e-05)
mat1.add_nuclide("U236", 7.944600e-08)
mat1.add_nuclide("U238", 7.085200e-04)
mat1.add_nuclide("H1", 5.877800e-02)
mat1.add_element("N", 2.152700e-03)
mat1.add_nuclide("O16", 3.713700e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=81.47)
...
source.space = openmc.stats.Point((0.0, 0.0, 40.735))
