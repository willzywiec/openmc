"""
LCT049-13S: Simplified model of R2-3R(4,4) with H/U=2 & 3 (concentric) and d=0.73cm
...
cell1.region = +surf11 & -surf19 & +surf21 & -surf27 & +surf31 & -surf37
...
source.space = openmc.stats.Box((-21.885, -11.26, -11.0), (1.365, 11.26, 11.0))
