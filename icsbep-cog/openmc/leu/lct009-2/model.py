"""
LEU-COMP-THERM-009-2: (15x8)-4.5825cm-(0.485cm STL)-4.5825cm-(15x8)-4.5825cm-(0.485cm STL)-4.5825cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-66.8, 66.8, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-96.8, 96.8, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-28.70)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=28.70)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-24.1175, -23.6325, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(23.6325, 24.1175, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-47.75, 0.0, 0.0)
...
cell5.translation = (47.75, 0.0, 0.0)
...
source.space = openmc.stats.Box((-48.75, -2.27, 45.0375), (48.75, 2.27, 47.0375))
