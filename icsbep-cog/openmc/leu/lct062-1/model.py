...
surf11_zmax = openmc.ZPlane(surface_id=1023, z0=144.15)
surf12_zmin = openmc.ZPlane(surface_id=1024, z0=0.0)
surf12_zmax = openmc.ZPlane(surface_id=1025, z0=146.69)
surf13_zmin = openmc.ZPlane(surface_id=1026, z0=-16.83)
surf13_zmax = openmc.ZPlane(surface_id=1027, z0=170.73)
surf14_zmin = openmc.ZPlane(surface_id=1028, z0=-16.84)
surf14_zmax = openmc.ZPlane(surface_id=1029, z0=170.73)
surf21_zmin = openmc.ZPlane(surface_id=1030, z0=0.0)
surf21_zmax = openmc.ZPlane(surface_id=1031, z0=145.415)
surf22_zmin = openmc.ZPlane(surface_id=1032, z0=-16.83)
surf22_zmax = openmc.ZPlane(surface_id=1033, z0=170.73)
...
cell13.region = (+surf14 | -surf14_zmin | +surf14_zmax) & -surf8

# Alles
cell17 = openmc.Cell(cell_id=17, fill=universe1)
cell17.region = (+surf14 | -surf14_zmin | +surf14_zmax) & -surf8
