"""
LCT003-23: (20x18)-6.176cm-(23x18)-6.176cm-(20x18) arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water (SSC-2.35-000-(149-157))
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-59.222, 59.222, -15.156, 15.156, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-89.222, 89.222, -45.156, 45.156, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-25.542)
surf4 = openmc.XPlane(surface_id=4, x0=-19.366)
surf5 = openmc.XPlane(surface_id=5, x0=19.366)
surf6 = openmc.XPlane(surface_id=6, x0=25.542)
# Al-5052 lower plug
...
# Lattice 3: 23x18 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-19.366, -15.156]
...
cell1.translation = (-41.54, 0.0, 0.0)
...
cell5.translation = (41.54, 0.0, 0.0)
...
source.space = openmc.stats.Box((-42.54, -1.842, 44.72), (42.54, 1.842, 46.72))
