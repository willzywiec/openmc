"""
LEU-COMP-THERM-010-12: (13x8)-11.315cm-(13x8)-11.315cm-(13x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; Steel walls; 2.616 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -30.626, -12.776, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 12.776, 30.626, -20.0625, 101.8375)
...
cell1.translation = (-44.335, 0.0, 0.0)
...
cell5.translation = (44.335, 0.0, 0.0)
...
source.space = openmc.stats.Box((-45.335, -2.27, 45.0375), (45.335, 2.27, 47.0375))
