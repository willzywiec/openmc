"""
LCT035-2: 21x21 array of U(2.6)O2 rods on 1.956cm pitch in soluble boron (TCA Core B2)
...
# Water with soluble boron (B2)
mat4 = openmc.Material(material_id=4)
mat4.set_density("sum")
mat4.add_nuclide("H1", 6.661000e-02)
mat4.add_nuclide("O16", 3.331700e-02)
mat4.add_nuclide("B10", 1.632000e-06)
mat4.add_nuclide("B11", 6.569100e-06)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=60.29)
# Array boundary
surf2 = openmc.model.RectangularParallelepiped(-20.538, 20.538, -20.538, 20.538, -499.995, 499.995)
# Al lower grid
...
surf12 = openmc.ZCylinder(surface_id=12, x0=0.0, y0=144.15, r=0.7085)
# Al end plug
surf13 = openmc.ZCylinder(surface_id=13, x0=-16.83, y0=0.0, r=0.7085)
...
lattice3.lower_left = [-20.538, -20.538]
...
cell12.region = +surf11 & +surf12 & +surf13 & -surf8
...
source.space = openmc.stats.Point((0.0, 0.0, 30.145))
