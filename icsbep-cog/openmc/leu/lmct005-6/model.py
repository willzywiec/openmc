"""
LMCT005-6: STACY run 511 with U(5)O2 rods immersed in 54.46cm of U(6) uranyl nitrate, Sm and Cs solution with water reflection
...
mat1.add_nuclide("U234", 4.077100e-07)
mat1.add_nuclide("U235", 4.871600e-05)
mat1.add_nuclide("U236", 8.084900e-08)
mat1.add_nuclide("U238", 7.531000e-04)
mat1.add_nuclide("O16", 3.795100e-02)
mat1.add_nuclide("H1", 5.715300e-02)
mat1.add_element("N", 2.783800e-03)
mat1.add_element("Sm", 5.647200e-07)
mat1.add_element("Cs", 1.527000e-05)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=54.46)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 27.23))
