"""
LCT022-6: 483 U(10)O2 rods with 1.83 cm hexagonal pitch
...
surf81_2 = openmc.Plane(a=1.0000000000, b=0.0000000000, c=0, d=20.5875000000)
surf81_3 = openmc.Plane(a=0.8660253916, b=0.5000000210, c=0, d=21.3951575004)
surf81_4 = openmc.Plane(a=0.5142158001, b=0.8576608367, c=0, d=20.7023263982)
surf81_5 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=21.3951580000)
surf81_6 = openmc.Plane(a=-0.5142158001, b=0.8576608367, c=0, d=20.7023263982)
surf81_7 = openmc.Plane(a=-0.8660253916, b=0.5000000210, c=0, d=21.3951575004)
surf81_8 = openmc.Plane(a=-1.0000000000, b=0.0000000000, c=0, d=20.5875000000)
surf81_9 = openmc.Plane(a=-0.8660253916, b=-0.5000000210, c=0, d=21.3951575004)
surf81_10 = openmc.Plane(a=-0.5142158001, b=-0.8576608367, c=0, d=20.7023263982)
surf81_11 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=21.3951580000)
# Boundary condition
surf99 = openmc.ZCylinder(surface_id=99, r=52.0, boundary_type="vacuum")
...
# Lattice 3: 23x17 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-21.045, -26.9420505]
lattice3.pitch = [1.830000, 3.169653]
lattice3.universes = [
...
cell1.region = (-surf81_0 & -surf81_1 & -surf81_2 & -surf81_3 & -surf81_4 & -surf81_5 & -surf81_6 & -surf81_7 & -surf81_8 & -surf81_9 & -surf81_10 & -surf81_11) & (-surf99 & +surf99_zmin & -surf99_zmax) & +surf21 & +surf22 & +surf23 & +surf24
...
cell5.region = (-surf81_0 & -surf81_1 & -surf81_2 & -surf81_3 & -surf81_4 & -surf81_5 & -surf81_6 & -surf81_7 & -surf81_8 & -surf81_9 & -surf81_10 & -surf81_11) & (-surf99 & +surf99_zmin & -surf99_zmax) & -surf24

# water
cell6 = openmc.Cell(cell_id=6, fill=mat4)
cell6.region = (+surf81_0 | +surf81_1 | +surf81_2 | +surf81_3 | +surf81_4 | +surf81_5 | +surf81_6 | +surf81_7 | +surf81_8 | +surf81_9 | +surf81_10 | +surf81_11) & (-surf99 & +surf99_zmin & -surf99_zmax)
