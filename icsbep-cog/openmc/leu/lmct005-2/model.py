"""
LMCT005-2: STACY run 503 with U(5)O2 rods immersed in 47.12cm of U(6) uranyl nitrate and Sm solution with water reflection
...
mat1.add_nuclide("U234", 4.263600e-07)
mat1.add_nuclide("U235", 5.094500e-05)
mat1.add_nuclide("U236", 8.454800e-08)
mat1.add_nuclide("U238", 7.875600e-04)
mat1.add_nuclide("O16", 3.810500e-02)
mat1.add_nuclide("H1", 5.672600e-02)
mat1.add_element("N", 2.889600e-03)
mat1.add_element("Sm", 3.740800e-07)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=47.12)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 23.56))
