"""
LST024-7: STACY two slabs of 10% 235U uranyl nitrate with polyethylene (P150,P50,P100) isolators
...
mat1.add_nuclide("U234", 6.128100e-07)
mat1.add_nuclide("U235", 7.604500e-05)
mat1.add_nuclide("U236", 7.595100e-08)
mat1.add_nuclide("U238", 6.773500e-04)
mat1.add_nuclide("H1", 5.929700e-02)
mat1.add_element("N", 2.020000e-03)
mat1.add_nuclide("O16", 3.696100e-02)
...
# Critical height
surf5 = openmc.ZPlane(surface_id=5, z0=68.96)
# Polyethylene
...
# Polyethylene
surf26 = openmc.model.RectangularParallelepiped(-5.025, 5.025, -35.7, 35.7, 0.0, 150.6)
# SST frame
surf27 = openmc.model.RectangularParallelepiped(-5.025, 5.025, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover
surf28 = openmc.model.RectangularParallelepiped(-5.835, 5.835, -38.7, 38.7, -3.0, 153.6)
# BCD
surf30 = openmc.model.RectangularParallelepiped(-56.391, 56.391, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
# LHS SST tank
surf31 = openmc.model.RectangularParallelepiped(-56.391000000000005, -17.77, -36.6005, 36.6005, -2.060999999999993, 152.183)
# P150 isolator
surf32 = openmc.model.RectangularParallelepiped(-17.64, -0.9399999999999995, -38.7, 38.7, -3.0, 153.6)
# P50 isolator
surf33 = openmc.model.RectangularParallelepiped(-0.81, 5.84, -38.7, 38.7, -3.0, 153.6)
# P100 isolator
surf34 = openmc.model.RectangularParallelepiped(5.97, 17.64, -38.7, 38.7, -3.0, 153.6)
# RHS SST tank
surf35 = openmc.model.RectangularParallelepiped(17.77, 56.391000000000005, -36.6005, 36.6005, -2.060999999999993, 152.183)
...
source.space = openmc.stats.Box((-38.0805, -1.0, 33.48), (38.0805, 1.0, 35.48))
