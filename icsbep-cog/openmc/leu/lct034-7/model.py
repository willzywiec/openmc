"""
LCT034-7: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.155cm borated steel, 6.0cm water gap, Hc=70.73cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=70.73)
# Lower grid plate
...
# Basket
surf10 = openmc.model.RectangularParallelepiped(-31.955, -3.1549999999999994, 3.1549999999999994, 31.955, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf11 = openmc.model.RectangularParallelepiped(-32.11, -3.0, 3.0, 32.11, -2.200000000000003, 97.8)
# Basket
surf12 = openmc.model.RectangularParallelepiped(3.1549999999999994, 31.955, 3.1549999999999994, 31.955, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf13 = openmc.model.RectangularParallelepiped(3.0, 32.11, 3.0, 32.11, -2.200000000000003, 97.8)
# Basket
surf14 = openmc.model.RectangularParallelepiped(-31.955, -3.1549999999999994, -31.955, -3.1549999999999994, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf15 = openmc.model.RectangularParallelepiped(-32.11, -3.0, -32.11, -3.0, -2.200000000000003, 97.8)
# Basket
surf16 = openmc.model.RectangularParallelepiped(3.1549999999999994, 31.955, -31.955, -3.1549999999999994, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf17 = openmc.model.RectangularParallelepiped(3.0, 32.11, -32.11, -3.0, -2.200000000000003, 97.8)
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-31.0225, y0=31.0225, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-31.0225, y0=31.0225, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-3.955, y0=31.155, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-31.155, y0=3.955, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-3.955, y0=3.955, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=31.0225, y0=31.0225, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=31.0225, y0=31.0225, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=3.955, y0=31.155, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=31.155, y0=3.955, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=3.955, y0=3.955, r=0.5)
...
cell1.translation = (-17.555, 17.555, 0.0)
...
cell4.translation = (17.555, 17.555, 0.0)
...
cell7.translation = (-17.555, -17.555, 0.0)
...
cell10.translation = (17.555, -17.555, 0.0)
...
source.space = openmc.stats.Box((-32.155, -32.155, 34.365), (32.155, 32.155, 36.365))
