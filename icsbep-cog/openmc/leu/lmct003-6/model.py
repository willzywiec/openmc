"""
LMCT003-6: STACY run 429 with U(5)O2 rods immersed in 49.87cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U235", 2.329700e-05)
mat1.add_nuclide("U236", 3.872800e-08)
mat1.add_nuclide("U238", 3.607800e-04)
mat1.add_nuclide("O16", 3.642000e-02)
mat1.add_nuclide("H1", 6.057900e-02)
mat1.add_element("N", 1.991100e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=49.87)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 24.935))
