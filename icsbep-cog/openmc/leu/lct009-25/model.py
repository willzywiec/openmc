"""
LEU-COMP-THERM-009-25: (15x8)-5.0725cm-(0.625cm Al)-5.0725cm-(15x8)-5.0725cm-(0.625cm Al)-5.0725cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
mat6.add_element("Al", 5.837100e-02)
mat6.add_element("Cr", 6.547500e-05)
mat6.add_element("Cu", 3.061400e-05)
mat6.add_element("Fe", 2.380300e-04)
mat6.add_element("Mn", 6.196800e-05)
mat6.add_element("Si", 4.733200e-04)
mat6.add_element("S", 3.033000e-05)
mat6.add_element("Ti", 2.065400e-04)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-67.92, 67.92, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-97.92, 97.92, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-29.82)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=29.82)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-24.7475, -24.1225, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(24.1225, 24.7475, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-48.87, 0.0, 0.0)
...
cell5.translation = (48.87, 0.0, 0.0)
...
source.space = openmc.stats.Box((-49.87, -2.27, 45.0375), (49.87, 2.27, 47.0375))
