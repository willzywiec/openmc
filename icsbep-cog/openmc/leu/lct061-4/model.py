...
# Boundary condition
surf4 = openmc.ZCylinder(surface_id=4, x0=-32.3, y0=133.3, r=65.0, boundary_type="vacuum")
# UO2
...
# Hf rod, lower
surf91 = openmc.ZCylinder(surface_id=91, x0=-3.8, y0=-2.3, r=0.3)
# Hf rod, upper
surf92 = openmc.ZCylinder(surface_id=92, x0=-2.3, y0=133.27, r=0.41)
...
# surf102: Unsupported surface type "rev" with params ['4', '-3.8', '0.31', '-2.3', '0.31', '-2.29999', '0.47', '133.27', '0.47', 'tr', '0.0', '6.59910', '0', '0.0', '6.59910', '9', '0.0', '9', '0']
# surf103: Unsupported surface type "rev" with params ['4', '-3.8', '0.31', '-2.3', '0.31', '-2.29999', '0.47', '133.27', '0.47', 'tr', '0.0', '-6.59910', '0', '0.0', '-6.59910', '9', '0.0', '9', '0']
# surf104: Unsupported surface type "rev" with params ['4', '-3.8', '0.31', '-2.3', '0.31', '-2.29999', '0.47', '133.27', '0.47', 'tr', '5.715', '3.29955', '0', '5.715', '3.29955', '9', '5.715', '9', '0']
# surf105: Unsupported surface type "rev" with params ['4', '-3.8', '0.31', '-2.3', '0.31', '-2.29999', '0.47', '133.27', '0.47', 'tr', '-5.715', '3.29955', '0', '-5.715', '3.29955', '9', '-5.715', '9', '0']
# surf106: Unsupported surface type "rev" with params ['4', '-3.8', '0.31', '-2.3', '0.31', '-2.29999', '0.47', '133.27', '0.47', 'tr', '5.715', '-3.29955', '0', '5.715', '-3.29955', '9', '5.715', '9', '0']
# surf107: Unsupported surface type "rev" with params ['4', '-3.8', '0.31', '-2.3', '0.31', '-2.29999', '0.47', '133.27', '0.47', 'tr', '-5.715', '-3.29955', '0', '-5.715', '-3.29955', '9', '-5.715', '9', '0']
...
cell41.region = -surf1 & -surf4 & +surf91 & +surf92
