"""
LCT006-7: Tank-Type Critical Assembly (TCA) 20x20 rods with 1.956 cm pitch; Hc=51.65 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=51.65)
# DX=DY=20*1.956        = 39.12 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-19.56, 19.56, -19.56, 19.56, -30.0, 144.15)
# DX=DY=20*1.956 + 2*30 = 99.12 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-49.56, 49.56, -49.56, 49.56, -30.0, 144.15, boundary_type="vacuum")
...
# Lattice 2: 20x20 array
lattice2 = openmc.RectLattice(lattice_id=2)
lattice2.lower_left = [-19.56, -19.56]
...
source.space = openmc.stats.Box((-2.0, -2.0, 24.825), (2.0, 2.0, 26.825))
