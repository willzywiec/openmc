"""
LMT006-15: Case 15; Bugey 19; detailed; 39 type 1 tubes; 12.2cm pitch; Hw=61.21cm
...
surf904 = openmc.ZPlane(surface_id=904, z0=61.21)
...
cell7.translation = (-40.0, 21.0, 0.0)
cell7.region = -surf106 & +surf903 & -surf905 & -surf999

# Ftube
cell8 = openmc.Cell(cell_id=8, fill=universe3)
cell8.translation = (-29.43449, -33.9, 0.0)
cell8.region = -surf111 & +surf903 & -surf905 & -surf999

# Ftube
cell9 = openmc.Cell(cell_id=9, fill=universe3)
cell9.translation = (-29.43449, -21.7, 0.0)
cell9.region = -surf112 & +surf903 & -surf905 & -surf999

# Ftube
cell10 = openmc.Cell(cell_id=10, fill=universe3)
cell10.translation = (-29.43449, -9.5, 0.0)
cell10.region = -surf113 & +surf903 & -surf905 & -surf999

# Ftube
cell11 = openmc.Cell(cell_id=11, fill=universe3)
cell11.translation = (-29.43449, 2.7, 0.0)
cell11.region = -surf114 & +surf903 & -surf905 & -surf999

# Ftube
cell12 = openmc.Cell(cell_id=12, fill=universe3)
cell12.translation = (-29.43449, 14.9, 0.0)
cell12.region = -surf115 & +surf903 & -surf905 & -surf999

# Ftube
cell13 = openmc.Cell(cell_id=13, fill=universe3)
cell13.translation = (-18.86898, -40.0, 0.0)
cell13.region = -surf121 & +surf903 & -surf905 & -surf999

# Ftube
cell14 = openmc.Cell(cell_id=14, fill=universe3)
cell14.translation = (-18.86898, -27.8, 0.0)
cell14.region = -surf122 & +surf903 & -surf905 & -surf999

# Ftube
cell15 = openmc.Cell(cell_id=15, fill=universe3)
cell15.translation = (-18.86898, -15.6, 0.0)
cell15.region = -surf123 & +surf903 & -surf905 & -surf999

# Ftube
cell16 = openmc.Cell(cell_id=16, fill=universe3)
cell16.translation = (-18.86898, -3.4, 0.0)
cell16.region = -surf124 & +surf903 & -surf905 & -surf999

# Ftube
cell17 = openmc.Cell(cell_id=17, fill=universe3)
cell17.translation = (-18.86898, 8.8, 0.0)
cell17.region = -surf125 & +surf903 & -surf905 & -surf999

# Ftube
cell18 = openmc.Cell(cell_id=18, fill=universe3)
cell18.translation = (-18.86898, 21.0, 0.0)
cell18.region = -surf126 & +surf903 & -surf905 & -surf999

# Ftube
cell19 = openmc.Cell(cell_id=19, fill=universe3)
cell19.translation = (-8.30347, -33.9, 0.0)
cell19.region = -surf131 & +surf903 & -surf905 & -surf999

# Ftube
cell20 = openmc.Cell(cell_id=20, fill=universe3)
cell20.translation = (-8.30347, -21.7, 0.0)
cell20.region = -surf132 & +surf903 & -surf905 & -surf999

# Ftube
cell21 = openmc.Cell(cell_id=21, fill=universe3)
cell21.translation = (-8.30347, -9.5, 0.0)
cell21.region = -surf133 & +surf903 & -surf905 & -surf999

# Ftube
cell22 = openmc.Cell(cell_id=22, fill=universe3)
cell22.translation = (-8.30347, 2.7, 0.0)
cell22.region = -surf134 & +surf903 & -surf905 & -surf999

# Ftube
cell23 = openmc.Cell(cell_id=23, fill=universe3)
cell23.translation = (-8.30347, 14.9, 0.0)
cell23.region = -surf135 & +surf903 & -surf905 & -surf999

# Ftube
cell24 = openmc.Cell(cell_id=24, fill=universe3)
cell24.translation = (2.26204, -40.0, 0.0)
cell24.region = -surf141 & +surf903 & -surf905 & -surf999

# Ftube
cell25 = openmc.Cell(cell_id=25, fill=universe3)
cell25.translation = (2.26204, -27.8, 0.0)
cell25.region = -surf142 & +surf903 & -surf905 & -surf999

# Ftube
cell26 = openmc.Cell(cell_id=26, fill=universe3)
cell26.translation = (2.26204, -15.6, 0.0)
cell26.region = -surf143 & +surf903 & -surf905 & -surf999

# Ftube
cell27 = openmc.Cell(cell_id=27, fill=universe3)
cell27.translation = (2.26204, -3.4, 0.0)
cell27.region = -surf144 & +surf903 & -surf905 & -surf999

# Ftube
cell28 = openmc.Cell(cell_id=28, fill=universe3)
cell28.translation = (2.26204, 8.8, 0.0)
cell28.region = -surf145 & +surf903 & -surf905 & -surf999

# Ftube
cell29 = openmc.Cell(cell_id=29, fill=universe3)
cell29.translation = (2.26204, 21.0, 0.0)
cell29.region = -surf146 & +surf903 & -surf905 & -surf999

# Ftube
cell30 = openmc.Cell(cell_id=30, fill=universe3)
cell30.translation = (12.82755, -33.9, 0.0)
cell30.region = -surf151 & +surf903 & -surf905 & -surf999

# Ftube
cell31 = openmc.Cell(cell_id=31, fill=universe3)
cell31.translation = (12.82755, -21.7, 0.0)
cell31.region = -surf152 & +surf903 & -surf905 & -surf999

# Ftube
cell32 = openmc.Cell(cell_id=32, fill=universe3)
cell32.translation = (12.82755, -9.5, 0.0)
cell32.region = -surf153 & +surf903 & -surf905 & -surf999

# Ftube
cell33 = openmc.Cell(cell_id=33, fill=universe3)
cell33.translation = (12.82755, 2.7, 0.0)
cell33.region = -surf154 & +surf903 & -surf905 & -surf999

# Ftube
cell34 = openmc.Cell(cell_id=34, fill=universe3)
cell34.translation = (12.82755, 14.9, 0.0)
cell34.region = -surf155 & +surf903 & -surf905 & -surf999

# Ftube
cell35 = openmc.Cell(cell_id=35, fill=universe3)
cell35.translation = (23.39306, -40.0, 0.0)
cell35.region = -surf161 & +surf903 & -surf905 & -surf999

# Ftube
cell36 = openmc.Cell(cell_id=36, fill=universe3)
cell36.translation = (23.39306, -27.8, 0.0)
cell36.region = -surf162 & +surf903 & -surf905 & -surf999

# Ftube
cell37 = openmc.Cell(cell_id=37, fill=universe3)
cell37.translation = (23.39306, -15.6, 0.0)
cell37.region = -surf163 & +surf903 & -surf905 & -surf999

# Ftube
cell38 = openmc.Cell(cell_id=38, fill=universe3)
cell38.translation = (23.39306, -3.4, 0.0)
cell38.region = -surf164 & +surf903 & -surf905 & -surf999

# Ftube
cell39 = openmc.Cell(cell_id=39, fill=universe3)
cell39.translation = (23.39306, 8.8, 0.0)
cell39.region = -surf165 & +surf903 & -surf905 & -surf999

# Ftube
cell40 = openmc.Cell(cell_id=40, fill=universe3)
cell40.translation = (23.39306, 21.0, 0.0)
cell40.region = -surf166 & +surf903 & -surf905 & -surf999

# Water
cell41 = openmc.Cell(cell_id=41, fill=mat2)
cell41.region = +surf903 & -surf905 & -surf999 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106
