"""
LCT064-6: Lattice of 1,039 U(2.4)O2 rods with 1.27 cm (triangular) pitch
...
surf10 = openmc.ZPlane(surface_id=10, z0=99.53)
...
surf32_0 = openmc.Plane(a=0.5000003650, b=-0.8660251931, c=0, d=21.5900013270)
surf32_1 = openmc.Plane(a=0.8660254505, b=-0.4999999191, c=0, d=21.9970439421)
surf32_2 = openmc.Plane(a=1.0000000000, b=0.0000000000, c=0, d=21.5900000000)
surf32_3 = openmc.Plane(a=0.8660254505, b=0.4999999191, c=0, d=21.9970439421)
surf32_4 = openmc.Plane(a=0.5000003650, b=0.8660251931, c=0, d=21.5900013270)
surf32_5 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=21.9970500000)
surf32_6 = openmc.Plane(a=-0.5000003650, b=0.8660251931, c=0, d=21.5900013270)
surf32_7 = openmc.Plane(a=-0.8660254505, b=0.4999999191, c=0, d=21.9970439421)
surf32_8 = openmc.Plane(a=-1.0000000000, b=0.0000000000, c=0, d=21.5900000000)
surf32_9 = openmc.Plane(a=-0.8660254505, b=-0.4999999191, c=0, d=21.9970439421)
surf32_10 = openmc.Plane(a=-0.5000003650, b=-0.8660251931, c=0, d=21.5900013270)
...
surf201 = openmc.ZCylinder(surface_id=201, x0=-5.08, y0=21.99705, r=0.47)
surf202 = openmc.ZCylinder(surface_id=202, x0=-3.81, y0=21.99705, r=0.47)
surf203 = openmc.ZCylinder(surface_id=203, x0=-2.54, y0=21.99705, r=0.47)
surf204 = openmc.ZCylinder(surface_id=204, x0=-1.27, y0=21.99705, r=0.47)
surf205 = openmc.ZCylinder(surface_id=205, x0=0.0, y0=21.99705, r=0.47)
surf206 = openmc.ZCylinder(surface_id=206, x0=1.27, y0=21.99705, r=0.47)
surf207 = openmc.ZCylinder(surface_id=207, x0=2.54, y0=21.99705, r=0.47)
surf208 = openmc.ZCylinder(surface_id=208, x0=3.81, y0=21.99705, r=0.47)
surf209 = openmc.ZCylinder(surface_id=209, x0=5.08, y0=21.99705, r=0.47)
surf210 = openmc.ZCylinder(surface_id=210, x0=-6.985, y0=20.89719, r=0.47)
surf211 = openmc.ZCylinder(surface_id=211, x0=-5.715, y0=20.89719, r=0.47)
surf212 = openmc.ZCylinder(surface_id=212, x0=5.715, y0=20.89719, r=0.47)
surf213 = openmc.ZCylinder(surface_id=213, x0=6.985, y0=20.89719, r=0.47)
surf214 = openmc.ZCylinder(surface_id=214, x0=-8.89, y0=19.79734, r=0.47)
surf215 = openmc.ZCylinder(surface_id=215, x0=8.89, y0=19.79734, r=0.47)
surf216 = openmc.ZCylinder(surface_id=216, x0=-10.795, y0=18.69749, r=0.47)
surf217 = openmc.ZCylinder(surface_id=217, x0=10.795, y0=18.69749, r=0.47)
...
surf309 = openmc.ZCylinder(surface_id=309, x0=-7.62, y0=19.79734, r=0.47)
surf310 = openmc.ZCylinder(surface_id=310, x0=-6.35, y0=19.79734, r=0.47)
surf311 = openmc.ZCylinder(surface_id=311, x0=6.35, y0=19.79734, r=0.47)
surf312 = openmc.ZCylinder(surface_id=312, x0=7.62, y0=19.79734, r=0.47)
surf313 = openmc.ZCylinder(surface_id=313, x0=-9.525, y0=18.69749, r=0.47)
surf314 = openmc.ZCylinder(surface_id=314, x0=-8.255, y0=18.69749, r=0.47)
surf315 = openmc.ZCylinder(surface_id=315, x0=8.255, y0=18.69749, r=0.47)
surf316 = openmc.ZCylinder(surface_id=316, x0=9.525, y0=18.69749, r=0.47)
surf317 = openmc.ZCylinder(surface_id=317, x0=-10.16, y0=17.59764, r=0.47)
surf318 = openmc.ZCylinder(surface_id=318, x0=10.16, y0=17.59764, r=0.47)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1318, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1319, z0=125.0)
surf3_zmin = openmc.ZPlane(surface_id=1320, z0=125.0)
surf3_zmax = openmc.ZPlane(surface_id=1321, z0=125.7)
surf5_zmin = openmc.ZPlane(surface_id=1322, z0=125.7)
surf5_zmax = openmc.ZPlane(surface_id=1323, z0=128.0)
surf6_zmin = openmc.ZPlane(surface_id=1324, z0=0.0)
surf6_zmax = openmc.ZPlane(surface_id=1325, z0=128.0)
surf7_zmin = openmc.ZPlane(surface_id=1326, z0=-2.07)
surf7_zmax = openmc.ZPlane(surface_id=1327, z0=130.53)
surf8_zmin = openmc.ZPlane(surface_id=1328, z0=-3.57)
surf8_zmax = openmc.ZPlane(surface_id=1329, z0=132.03)
surf12_zmin = openmc.ZPlane(surface_id=1330, z0=-3.57)
surf12_zmax = openmc.ZPlane(surface_id=1331, z0=-2.07)
surf13_zmin = openmc.ZPlane(surface_id=1332, z0=-999.9)
surf13_zmax = openmc.ZPlane(surface_id=1333, z0=999.9)
surf14_zmin = openmc.ZPlane(surface_id=1334, z0=127.13)
surf14_zmax = openmc.ZPlane(surface_id=1335, z0=128.13)
surf15_zmin = openmc.ZPlane(surface_id=1336, z0=-33.57, boundary_type="vacuum")
surf15_zmax = openmc.ZPlane(surface_id=1337, z0=132.03, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 49.765))
