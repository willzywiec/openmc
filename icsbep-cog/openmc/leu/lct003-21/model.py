"""
LCT003-21: (20x18)-6.78cm-(25x18)-6.78cm-(20x18) arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water (SSC-2.35-000-120)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-61.51, 61.51, -15.156, 15.156, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-91.51, 91.51, -45.156, 45.156, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-27.830)
surf4 = openmc.XPlane(surface_id=4, x0=-21.050)
surf5 = openmc.XPlane(surface_id=5, x0=21.050)
surf6 = openmc.XPlane(surface_id=6, x0=27.830)
# Al-5052 lower plug
...
cell1.translation = (-43.828, 0.0, 0.0)
...
cell5.translation = (43.828, 0.0, 0.0)
...
source.space = openmc.stats.Box((-44.828, -1.842, 44.72), (44.828, 1.842, 46.72))
