"""
LCT049-12S: Simplified model of R2-2R(4,4) with H/U=3 and d=10.21cm
...
cell1.region = +surf11 & -surf18 & +surf21 & -surf27 & +surf31 & -surf37
...
source.space = openmc.stats.Box((-16.365000000000002, -11.26, -11.0), (16.365000000000002, 11.26, 11.0))
