"""
LCT034-3: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.155cm borated steel, 2.0cm water gap, Hc=41.40cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=41.40)
# Lower grid plate
...
source.space = openmc.stats.Box((-30.155, -30.155, 19.7), (30.155, 30.155, 21.7))
