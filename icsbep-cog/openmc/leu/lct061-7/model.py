"""
LCT061-7: 762 U(4.5)O2 rods, 7 Dy rods, 1.27 cm trianglur pitch, Hc=77.32cm, water
...
surf1 = openmc.ZPlane(surface_id=1, z0=77.32)
...
source.space = openmc.stats.Box((-2.27, -2.09985, 37.66), (2.27, 2.09985, 39.66))
