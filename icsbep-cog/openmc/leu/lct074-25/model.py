"""
LEU-COMP-THERM-074-25: MIRTE-1 Experiment R4A-Water-005; 9x8; Hc=59.996cm
...
lattice4.lower_left = [-24.25, 0.25]
...
lattice5.lower_left = [-24.25, -24.25]
...
lattice6.lower_left = [0.25, -24.25]
...
source.space = openmc.stats.Box((-8.45, -8.45, 28.998), (8.45, 8.45, 30.998))
