"""
LMT006-19: Bugey case 51; 42 type 1 tubes; 9.7cm pitch; Hw=63.94cm
...
# fuel tube and disk
surf102 = openmc.ZCylinder(surface_id=102, x0=-40.0, y0=-30.3, r=4.85)
# fuel tube and disk
surf103 = openmc.ZCylinder(surface_id=103, x0=-40.0, y0=-20.6, r=4.85)
# fuel tube and disk
surf104 = openmc.ZCylinder(surface_id=104, x0=-40.0, y0=-10.9, r=4.85)
# fuel tube and disk
surf105 = openmc.ZCylinder(surface_id=105, x0=-40.0, y0=-1.2, r=4.85)
# fuel tube and disk
surf106 = openmc.ZCylinder(surface_id=106, x0=-40.0, y0=8.5, r=4.85)
# fuel tube and disk
surf107 = openmc.ZCylinder(surface_id=107, x0=-40.0, y0=18.2, r=4.85)
# Second row
surf111 = openmc.ZCylinder(surface_id=111, x0=-30.3, y0=-40.0, r=4.85)
# ditto
surf112 = openmc.ZCylinder(surface_id=112, x0=-30.3, y0=-30.3, r=4.85)
# ditto
surf113 = openmc.ZCylinder(surface_id=113, x0=-30.3, y0=-20.6, r=4.85)
# ditto
surf114 = openmc.ZCylinder(surface_id=114, x0=-30.3, y0=-10.9, r=4.85)
# ditto
surf115 = openmc.ZCylinder(surface_id=115, x0=-30.3, y0=-1.2, r=4.85)
# ditto
surf116 = openmc.ZCylinder(surface_id=116, x0=-30.3, y0=8.5, r=4.85)
# ditto
surf117 = openmc.ZCylinder(surface_id=117, x0=-30.3, y0=18.2, r=4.85)
# Third row
surf121 = openmc.ZCylinder(surface_id=121, x0=-20.6, y0=-40.0, r=4.85)
# ditto
surf122 = openmc.ZCylinder(surface_id=122, x0=-20.6, y0=-30.3, r=4.85)
# ditto
surf123 = openmc.ZCylinder(surface_id=123, x0=-20.6, y0=-20.6, r=4.85)
# ditto
surf124 = openmc.ZCylinder(surface_id=124, x0=-20.6, y0=-10.9, r=4.85)
# ditto
surf125 = openmc.ZCylinder(surface_id=125, x0=-20.6, y0=-1.2, r=4.85)
# ditto
surf126 = openmc.ZCylinder(surface_id=126, x0=-20.6, y0=8.5, r=4.85)
# ditto
surf127 = openmc.ZCylinder(surface_id=127, x0=-20.6, y0=18.2, r=4.85)
# Fourth row
surf131 = openmc.ZCylinder(surface_id=131, x0=-10.9, y0=-40.0, r=4.85)
# ditto
surf132 = openmc.ZCylinder(surface_id=132, x0=-10.9, y0=-30.3, r=4.85)
# ditto
surf133 = openmc.ZCylinder(surface_id=133, x0=-10.9, y0=-20.6, r=4.85)
# ditto
surf134 = openmc.ZCylinder(surface_id=134, x0=-10.9, y0=-10.9, r=4.85)
# ditto
surf135 = openmc.ZCylinder(surface_id=135, x0=-10.9, y0=-1.2, r=4.85)
# ditto
surf136 = openmc.ZCylinder(surface_id=136, x0=-10.9, y0=8.5, r=4.85)
# ditto
surf137 = openmc.ZCylinder(surface_id=137, x0=-10.9, y0=18.2, r=4.85)
# Fifth row
surf141 = openmc.ZCylinder(surface_id=141, x0=-1.2, y0=-40.0, r=4.85)
# ditto
surf142 = openmc.ZCylinder(surface_id=142, x0=-1.2, y0=-30.3, r=4.85)
# ditto
surf143 = openmc.ZCylinder(surface_id=143, x0=-1.2, y0=-20.6, r=4.85)
# ditto
surf144 = openmc.ZCylinder(surface_id=144, x0=-1.2, y0=-10.9, r=4.85)
# ditto
surf145 = openmc.ZCylinder(surface_id=145, x0=-1.2, y0=-1.2, r=4.85)
# ditto
surf146 = openmc.ZCylinder(surface_id=146, x0=-1.2, y0=8.5, r=4.85)
# ditto
surf147 = openmc.ZCylinder(surface_id=147, x0=-1.2, y0=18.2, r=4.85)
# Sixth row
surf151 = openmc.ZCylinder(surface_id=151, x0=8.5, y0=-40.0, r=4.85)
# ditto
surf152 = openmc.ZCylinder(surface_id=152, x0=8.5, y0=-30.3, r=4.85)
# ditto
surf153 = openmc.ZCylinder(surface_id=153, x0=8.5, y0=-20.6, r=4.85)
# ditto
surf154 = openmc.ZCylinder(surface_id=154, x0=8.5, y0=-10.9, r=4.85)
# ditto
surf155 = openmc.ZCylinder(surface_id=155, x0=8.5, y0=-1.2, r=4.85)
# ditto
surf156 = openmc.ZCylinder(surface_id=156, x0=8.5, y0=8.5, r=4.85)
# ditto
surf157 = openmc.ZCylinder(surface_id=157, x0=8.5, y0=18.2, r=4.85)
# Arbitrary
...
surf904 = openmc.ZPlane(surface_id=904, z0=63.94)
# Boundary condition
...
cell44.region = +surf903 & -surf900 & -surf999 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107

# Plate
cell45 = openmc.Cell(cell_id=45, fill=mat4)
cell45.region = -surf3 & +surf902 & -surf903 & -surf999
...
cell47.region = +surf901 & -surf902 & -surf999
