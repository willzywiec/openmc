"""
LST010-3: Polyethylene (P100) reflected 60-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=944 (Run 86)
...
mat1.add_nuclide("U234", 4.998000e-07)
mat1.add_nuclide("U235", 6.202200e-05)
mat1.add_nuclide("U236", 6.194400e-08)
mat1.add_nuclide("U238", 5.524300e-04)
mat1.add_nuclide("H1", 5.852600e-02)
mat1.add_element("N", 2.488700e-03)
mat1.add_nuclide("O16", 3.733000e-02)
...
mat6.add_nuclide("H1", 8.237100e-02)
mat6.add_element("C", 4.132800e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=76.92)
# Steel support/inner
surf11 = openmc.ZCylinder(surface_id=11, r=31.7)
# Steel support/outer
surf12 = openmc.ZCylinder(surface_id=12, r=68.5)
# =A
surf13 = openmc.ZCylinder(surface_id=13, r=31.98)
# =B
surf14 = openmc.ZCylinder(surface_id=14, r=32.29)
# =C
surf15 = openmc.ZCylinder(surface_id=15, r=42.34)
# =D
surf16 = openmc.ZCylinder(surface_id=16, r=43.15)
...
source.space = openmc.stats.Point((0.0, 0.0, 38.46))
