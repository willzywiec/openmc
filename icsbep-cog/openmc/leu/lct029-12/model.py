"""
LCT029-12: 20x20 array of 400 U(4.738)O2 fuel rods with 1.60 cm square pitch with no Hf plates
...
surf5 = openmc.ZPlane(surface_id=5, z0=37.86)
...
cell12.region = -surf1 & (+surf14 | -surf14_zmin | +surf14_zmax)

root_universe = openmc.Universe(cells=[cell1, cell2, cell12])
...
source.space = openmc.stats.Point((1.6, -1.6, 18.93))
