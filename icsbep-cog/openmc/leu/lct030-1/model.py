"""
LCT030-1: 1897 U(3.5)O2 rods, 1.27 cm trianglur pitch, Hc=30.68cm
...
surf1 = openmc.ZPlane(surface_id=1, z0=30.68)
...
surf31_0 = openmc.Plane(a=0.8660250002, b=0.5000006990, c=0, d=25.8465161319)
surf31_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=25.8464800000)
surf31_2 = openmc.Plane(a=-0.8660250002, b=0.5000006990, c=0, d=25.8465161319)
surf31_3 = openmc.Plane(a=-0.8660250002, b=-0.5000006990, c=0, d=25.8465161319)
surf31_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=25.8464800000)
surf31_5 = openmc.Plane(a=0.8660250002, b=-0.5000006990, c=0, d=25.8465161319)
# 2nd prism with fuel rods and holes
# Prism 32: 6-sided polygon
surf32_0 = openmc.Plane(a=0.8660249985, b=0.5000007019, c=0, d=26.9463678290)
surf32_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=26.9463300000)
surf32_2 = openmc.Plane(a=-0.8660249985, b=0.5000007019, c=0, d=26.9463678290)
surf32_3 = openmc.Plane(a=-0.8660249985, b=-0.5000007019, c=0, d=26.9463678290)
surf32_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=26.9463300000)
surf32_5 = openmc.Plane(a=0.8660249985, b=-0.5000007019, c=0, d=26.9463678290)
# 3rd prism with fuel rods and holes
# Prism 33: 6-sided polygon
surf33_0 = openmc.Plane(a=0.8660249969, b=0.5000007047, c=0, d=28.0462195261)
surf33_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=28.0461800000)
surf33_2 = openmc.Plane(a=-0.8660249969, b=0.5000007047, c=0, d=28.0462195261)
surf33_3 = openmc.Plane(a=-0.8660249969, b=-0.5000007047, c=0, d=28.0462195261)
surf33_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=28.0461800000)
surf33_5 = openmc.Plane(a=0.8660249969, b=-0.5000007047, c=0, d=28.0462195261)
# 4th prism with fuel rods and holes
# Prism 34: 6-sided polygon
surf34_0 = openmc.Plane(a=0.8660249955, b=0.5000007072, c=0, d=29.1460712232)
surf34_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=29.1460300000)
surf34_2 = openmc.Plane(a=-0.8660249955, b=0.5000007072, c=0, d=29.1460712232)
surf34_3 = openmc.Plane(a=-0.8660249955, b=-0.5000007072, c=0, d=29.1460712232)
surf34_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=29.1460300000)
surf34_5 = openmc.Plane(a=0.8660249955, b=-0.5000007072, c=0, d=29.1460712232)
# 5th prism with 3 more rows of holes
# Prism 35: 6-sided polygon
surf35_0 = openmc.Plane(a=0.8660249917, b=0.5000007137, c=0, d=32.4456263146)
surf35_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=32.4455800000)
surf35_2 = openmc.Plane(a=-0.8660249917, b=0.5000007137, c=0, d=32.4456263146)
surf35_3 = openmc.Plane(a=-0.8660249917, b=-0.5000007137, c=0, d=32.4456263146)
surf35_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=32.4455800000)
surf35_5 = openmc.Plane(a=0.8660249917, b=-0.5000007137, c=0, d=32.4456263146)
surf321 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -499.5, 499.5, -499.5, 499.5)
# (21 on each short side)
surf322 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -499.5, 499.5, -499.5, 499.5)
surf323 = openmc.model.RectangularParallelepiped(-13.335, 13.335, -499.5, 499.5, -499.5, 499.5)
surf331 = openmc.model.RectangularParallelepiped(-8.89, 8.89, -499.5, 499.5, -499.5, 499.5)
# (14 on each short side)
surf332 = openmc.model.RectangularParallelepiped(-8.89, 8.89, -499.5, 499.5, -499.5, 499.5)
surf333 = openmc.model.RectangularParallelepiped(-8.89, 8.89, -499.5, 499.5, -499.5, 499.5)
surf341 = openmc.model.RectangularParallelepiped(-3.175, 3.175, -499.5, 499.5, -499.5, 499.5)
# (5 on each short side)
surf342 = openmc.model.RectangularParallelepiped(-3.175, 3.175, -499.5, 499.5, -499.5, 499.5)
surf343 = openmc.model.RectangularParallelepiped(-3.175, 3.175, -499.5, 499.5, -499.5, 499.5)

# Z-plane surfaces for bounded cylinders
surf2_zmin = openmc.ZPlane(surface_id=1343, z0=-3.8)
surf2_zmax = openmc.ZPlane(surface_id=1344, z0=-2.3)
surf3_zmin = openmc.ZPlane(surface_id=1345, z0=126.9)
surf3_zmax = openmc.ZPlane(surface_id=1346, z0=127.9)
surf4_zmin = openmc.ZPlane(surface_id=1347, z0=-33.8, boundary_type="vacuum")
surf4_zmax = openmc.ZPlane(surface_id=1348, z0=131.8, boundary_type="vacuum")
surf10_zmin = openmc.ZPlane(surface_id=1349, z0=0.0)
surf10_zmax = openmc.ZPlane(surface_id=1350, z0=125.0)
surf12_zmin = openmc.ZPlane(surface_id=1351, z0=125.0)
surf12_zmax = openmc.ZPlane(surface_id=1352, z0=125.7)
surf14_zmin = openmc.ZPlane(surface_id=1353, z0=125.7)
surf14_zmax = openmc.ZPlane(surface_id=1354, z0=128.0)
surf15_zmin = openmc.ZPlane(surface_id=1355, z0=0.0)
surf15_zmax = openmc.ZPlane(surface_id=1356, z0=128.0)
surf16_zmin = openmc.ZPlane(surface_id=1357, z0=-2.3)
surf16_zmax = openmc.ZPlane(surface_id=1358, z0=130.3)
surf17_zmin = openmc.ZPlane(surface_id=1359, z0=-3.8)
surf17_zmax = openmc.ZPlane(surface_id=1360, z0=131.8)
...
cell10.region = (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf33_0 | +surf33_1 | +surf33_2 | +surf33_3 | +surf33_4 | +surf33_5) & (-surf34_0 & -surf34_1 & -surf34_2 & -surf34_3 & -surf34_4 & -surf34_5) & -surf341

# Frods
cell11 = openmc.Cell(cell_id=11, fill=universe5)
cell11.region = (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf33_0 | +surf33_1 | +surf33_2 | +surf33_3 | +surf33_4 | +surf33_5) & (-surf34_0 & -surf34_1 & -surf34_2 & -surf34_3 & -surf34_4 & -surf34_5) & -surf342

# Frods
cell12 = openmc.Cell(cell_id=12, fill=universe5)
cell12.region = (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf33_0 | +surf33_1 | +surf33_2 | +surf33_3 | +surf33_4 | +surf33_5) & (-surf34_0 & -surf34_1 & -surf34_2 & -surf34_3 & -surf34_4 & -surf34_5) & -surf343

# Holes
cell13 = openmc.Cell(cell_id=13, fill=universe6)
cell13.region = (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf33_0 | +surf33_1 | +surf33_2 | +surf33_3 | +surf33_4 | +surf33_5) & (-surf34_0 & -surf34_1 & -surf34_2 & -surf34_3 & -surf34_4 & -surf34_5) & +surf341 & +surf342 & +surf343

# Holes
cell14 = openmc.Cell(cell_id=14, fill=universe6)
cell14.region = (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf34_0 | +surf34_1 | +surf34_2 | +surf34_3 | +surf34_4 | +surf34_5) & (-surf35_0 & -surf35_1 & -surf35_2 & -surf35_3 & -surf35_4 & -surf35_5)

# Alles
cell15 = openmc.Cell(cell_id=15, fill=universe1)
cell15.region = (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf35_0 | +surf35_1 | +surf35_2 | +surf35_3 | +surf35_4 | +surf35_5)

# Mod
cell19 = openmc.Cell(cell_id=19, fill=mat4)
cell19.region = -surf1 & (+surf2 | -surf2_zmin | +surf2_zmax) & (+surf3 | -surf3_zmin | +surf3_zmax) & (-surf4 & +surf4_zmin & -surf4_zmax)

# Mod
cell26 = openmc.Cell(cell_id=26, fill=mat4)
cell26.region = -surf1 & (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf16 | -surf16_zmin | +surf16_zmax) & (+surf17 | -surf17_zmin | +surf17_zmax)

# Alles
cell27 = openmc.Cell(cell_id=27, fill=universe1)
cell27.region = (-surf4 & +surf4_zmin & -surf4_zmax) & +surf20 & +surf21 & +surf22 & +surf23 & +surf24 & +surf25 & +surf26

# Alles
cell35 = openmc.Cell(cell_id=35, fill=universe1)
cell35.region = (-surf4 & +surf4_zmin & -surf4_zmax) & +surf20 & +surf21 & +surf22 & +surf23 & +surf24 & +surf25 & +surf26
...
source.space = openmc.stats.Point((0.0, 0.0, 15.34))
