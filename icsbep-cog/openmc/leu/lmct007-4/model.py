"""
LMCT007-4: STACY run 611 with U(5)O2 rods immersed in 62.90cm of U(6) uranyl nitrate with water reflection
...
mat1.add_nuclide("U234", 1.953000e-07)
mat1.add_nuclide("U235", 2.333600e-05)
mat1.add_nuclide("U236", 3.872800e-08)
mat1.add_nuclide("U238", 3.607500e-04)
mat1.add_nuclide("O16", 3.608900e-02)
mat1.add_nuclide("H1", 6.142100e-02)
mat1.add_element("N", 1.690000e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=62.90)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 31.45))
