"""
LST002-2: Full 174-liter sphere of U(4.9)O2F2 solution; unreflected
...
surf1 = openmc.Sphere(surface_id=1, r=34.4995)
surf2 = openmc.Sphere(surface_id=2, r=34.6583, boundary_type="vacuum")
