"""
LCT038-12: Two pairs of (18x13-2) arrays of U(4.738)O2 rods, 1.60 cm pitch, between 20.0cm concrete isolator, Hc=58.1cm
...
mat5.add_nuclide("H1", 6.670200e-02)
mat5.add_nuclide("O16", 3.335100e-02)
...
surf5 = openmc.ZPlane(surface_id=5, z0=58.1)
# Lower grid plate
...
# Basket  Note: Xo = (20.1/2) + 14.4 = 24.45
surf10 = openmc.model.RectangularParallelepiped(-38.85, -10.049999999999999, 0.0, 28.8, -2.6000000000000014, 104.19999999999999)
# Basket
surf11 = openmc.model.RectangularParallelepiped(-38.85, -10.049999999999999, -28.8, 0.0, -2.6000000000000014, 104.19999999999999)
# Basket
surf12 = openmc.model.RectangularParallelepiped(10.049999999999999, 38.85, 0.0, 28.8, -2.6000000000000014, 104.19999999999999)
# Basket
surf13 = openmc.model.RectangularParallelepiped(10.049999999999999, 38.85, -28.8, 0.0, -2.6000000000000014, 104.19999999999999)
...
# Xo = (20.1/2) + 0.8 = 10.85
surf21 = openmc.ZCylinder(surface_id=21, x0=-10.85, y0=28.0, r=0.5)
# Xo = 17.5(1.6) + (20.1/2) = 38.05
surf22 = openmc.ZCylinder(surface_id=22, x0=-38.05, y0=0.8, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-38.05, y0=-0.8, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-10.85, y0=-28.0, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=10.85, y0=28.0, r=0.5)
surf26 = openmc.ZCylinder(surface_id=26, x0=38.05, y0=0.8, r=0.5)
surf27 = openmc.ZCylinder(surface_id=27, x0=38.05, y0=-0.8, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=10.85, y0=-28.0, r=0.5)
# Inner
surf31 = openmc.ZCylinder(surface_id=31, x0=-37.9175, y0=27.8675, r=0.7975)
# Outer
surf32 = openmc.ZCylinder(surface_id=32, x0=-37.9175, y0=27.8675, r=0.9325)
# Inner
surf33 = openmc.ZCylinder(surface_id=33, x0=-37.9175, y0=-27.8675, r=0.7975)
# Outer
surf34 = openmc.ZCylinder(surface_id=34, x0=-37.9175, y0=-27.8675, r=0.9325)
# Inner
surf35 = openmc.ZCylinder(surface_id=35, x0=37.9175, y0=27.8675, r=0.7975)
# Outer
surf36 = openmc.ZCylinder(surface_id=36, x0=37.9175, y0=27.8675, r=0.9325)
# Inner
surf37 = openmc.ZCylinder(surface_id=37, x0=37.9175, y0=-27.8675, r=0.7975)
# Outer
surf38 = openmc.ZCylinder(surface_id=38, x0=37.9175, y0=-27.8675, r=0.9325)
# Concrete
surf40 = openmc.model.RectangularParallelepiped(-10.0, 10.0, -35.0, 35.0, -2.549999999999997, 97.45)
# PVC & paint
surf41 = openmc.model.RectangularParallelepiped(-10.05, 10.05, -35.05, 35.05, -2.5999999999999943, 97.5)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1041, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1042, z0=90.0)
surf2_zmin = openmc.ZPlane(surface_id=1043, z0=0.0)
surf2_zmax = openmc.ZPlane(surface_id=1044, z0=96.9)
surf4_zmin = openmc.ZPlane(surface_id=1045, z0=-1.8)
surf4_zmax = openmc.ZPlane(surface_id=1046, z0=98.2)
...
cell22.region = +surf40 & -surf41 & +surf10 & +surf11 & +surf12 & +surf13 & +surf14

# SST
cell23 = openmc.Cell(cell_id=23, fill=mat3)
cell23.region = +surf10 & +surf11 & +surf12 & +surf13 & -surf14 & -surf15 & +surf41

# Air
cell24 = openmc.Cell(cell_id=24, fill=mat4)
cell24.region = +surf5 & +surf10 & +surf11 & +surf12 & +surf13 & +surf14 & -surf15 & +surf41

# Water
cell25 = openmc.Cell(cell_id=25, fill=mat5)
cell25.region = -surf5 & +surf10 & +surf11 & +surf12 & +surf13 & +surf14 & -surf15 & +surf41

# Water
cell36 = openmc.Cell(cell_id=36, fill=mat5)
cell36.region = (+surf4 | -surf4_zmin | +surf4_zmax) & -surf5 & +surf6 & +surf7 & -surf8 & -surf9

# Water
cell44 = openmc.Cell(cell_id=44, fill=mat5)
cell44.region = (+surf4 | -surf4_zmin | +surf4_zmax) & -surf5 & +surf6 & +surf7 & -surf8 & -surf9

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell15, cell16, cell17, cell18, cell19, cell20, cell21, cell22, cell23, cell24, cell25, cell36, cell44])
...
source.space = openmc.stats.Box((-31.05, -1.8, 28.05), (31.05, 1.8, 30.05))
