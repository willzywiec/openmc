"""
LEU-COMP-THERM-074-23: MIRTE-1 Experiment 4A-Cu-005; 10x10; Hc=64.527cm
...
mat8.add_element("Al", 1.338900e-05)
mat8.add_element("Be", 5.726600e-06)
mat8.add_element("Fe", 2.772400e-06)
mat8.add_element("Sb", 4.239000e-07)
mat8.add_element("Si", 9.187900e-06)
mat8.add_element("Ti", 3.233700e-06)
mat8.add_element("Zn", 1.499600e-05)
mat8.add_element("C", 1.289100e-05)
mat8.add_nuclide("O16", 1.612900e-05)
mat8.add_element("Cu", 8.117800e-02)
...
lattice3.lower_left = [0.2499, 0.2499]
...
lattice4.lower_left = [-24.2499, 0.2499]
...
lattice5.lower_left = [-24.2499, -24.2499]
...
lattice6.lower_left = [0.2499, -24.2499]
...
source.space = openmc.stats.Box((-8.45, -8.45, 31.2635), (8.45, 8.45, 33.2635))
