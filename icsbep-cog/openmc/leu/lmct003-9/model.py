"""
LMCT003-9: STACY run 413 with U(5)O2 rods immersed in 40.74cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 4.272600e-07)
mat1.add_nuclide("U235", 5.096800e-05)
mat1.add_nuclide("U236", 8.472700e-08)
mat1.add_nuclide("U238", 7.893000e-04)
mat1.add_nuclide("O16", 3.810600e-02)
mat1.add_nuclide("H1", 5.679800e-02)
mat1.add_element("N", 2.873900e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=40.74)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 20.37))
