"""
LCT030-10: 727 U(3.5)O2 rods, 1.27 cm trianglur pitch, Hc=94.00cm
...
surf1 = openmc.ZPlane(surface_id=1, z0=94.00)
...
surf31_0 = openmc.Plane(a=0.8660248854, b=0.5000008978, c=0, d=14.8479966609)
surf31_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=14.8479700000)
surf31_2 = openmc.Plane(a=-0.8660248854, b=0.5000008978, c=0, d=14.8479966609)
surf31_3 = openmc.Plane(a=-0.8660248854, b=-0.5000008978, c=0, d=14.8479966609)
surf31_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=14.8479700000)
surf31_5 = openmc.Plane(a=0.8660248854, b=-0.5000008978, c=0, d=14.8479966609)
# 2nd prism with all fuel rods
# Prism 32: 6-sided polygon
surf32_0 = openmc.Plane(a=0.8660248905, b=0.5000008891, c=0, d=15.9478483580)
surf32_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=15.9478200000)
surf32_2 = openmc.Plane(a=-0.8660248905, b=0.5000008891, c=0, d=15.9478483580)
surf32_3 = openmc.Plane(a=-0.8660248905, b=-0.5000008891, c=0, d=15.9478483580)
surf32_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=15.9478200000)
surf32_5 = openmc.Plane(a=0.8660248905, b=-0.5000008891, c=0, d=15.9478483580)
# 3rd prism with all fuel rods
# Prism 33: 6-sided polygon
surf33_0 = openmc.Plane(a=0.8660248948, b=0.5000008815, c=0, d=17.0477000551)
surf33_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=17.0476700000)
surf33_2 = openmc.Plane(a=-0.8660248948, b=0.5000008815, c=0, d=17.0477000551)
surf33_3 = openmc.Plane(a=-0.8660248948, b=-0.5000008815, c=0, d=17.0477000551)
surf33_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=17.0476700000)
surf33_5 = openmc.Plane(a=0.8660248948, b=-0.5000008815, c=0, d=17.0477000551)
# 4th prism with all fuel rods
# Prism 34: 6-sided polygon
surf34_0 = openmc.Plane(a=0.8660248987, b=0.5000008748, c=0, d=18.1475517522)
surf34_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=18.1475200000)
surf34_2 = openmc.Plane(a=-0.8660248987, b=0.5000008748, c=0, d=18.1475517522)
surf34_3 = openmc.Plane(a=-0.8660248987, b=-0.5000008748, c=0, d=18.1475517522)
surf34_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=18.1475200000)
surf34_5 = openmc.Plane(a=0.8660248987, b=-0.5000008748, c=0, d=18.1475517522)
# 5th prism with 3 more rows of holes
# Prism 35: 6-sided polygon
surf35_0 = openmc.Plane(a=0.8660249079, b=0.5000008589, c=0, d=21.4471068435)
surf35_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=21.4470700000)
surf35_2 = openmc.Plane(a=-0.8660249079, b=0.5000008589, c=0, d=21.4471068435)
surf35_3 = openmc.Plane(a=-0.8660249079, b=-0.5000008589, c=0, d=21.4471068435)
surf35_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=21.4470700000)
surf35_5 = openmc.Plane(a=0.8660249079, b=-0.5000008589, c=0, d=21.4471068435)
surf321 = openmc.model.RectangularParallelepiped(-8.255, 8.255, -499.5, 499.5, -499.5, 499.5)
# (13 on each short side)
surf322 = openmc.model.RectangularParallelepiped(-8.255, 8.255, -499.5, 499.5, -499.5, 499.5)
surf323 = openmc.model.RectangularParallelepiped(-8.255, 8.255, -499.5, 499.5, -499.5, 499.5)
surf331 = openmc.model.RectangularParallelepiped(-6.35, 6.35, -499.5, 499.5, -499.5, 499.5)
# (10 on each short side)
surf332 = openmc.model.RectangularParallelepiped(-6.35, 6.35, -499.5, 499.5, -499.5, 499.5)
surf333 = openmc.model.RectangularParallelepiped(-6.35, 6.35, -499.5, 499.5, -499.5, 499.5)
surf341 = openmc.model.RectangularParallelepiped(-4.445, 4.445, -499.5, 499.5, -499.5, 499.5)
# (7 on each short side)
surf342 = openmc.model.RectangularParallelepiped(-4.445, 4.445, -499.5, 499.5, -499.5, 499.5)
surf343 = openmc.model.RectangularParallelepiped(-4.445, 4.445, -499.5, 499.5, -499.5, 499.5)
...
source.space = openmc.stats.Point((0.0, 0.0, 47.0))
