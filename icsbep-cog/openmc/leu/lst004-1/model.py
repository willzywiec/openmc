"""
LST004-1: Water-reflected 60-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=719 (Run 1)
...
mat1.add_nuclide("U234", 6.383300e-07)
mat1.add_nuclide("U235", 7.921300e-05)
mat1.add_nuclide("U236", 7.911400e-08)
mat1.add_nuclide("U238", 7.055600e-04)
mat1.add_nuclide("H1", 5.695600e-02)
mat1.add_element("N", 2.877800e-03)
mat1.add_nuclide("O16", 3.802900e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=41.53)
...
source.space = openmc.stats.Point((0.0, 0.0, 20.765))
