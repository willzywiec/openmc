"""
LCT050-1: Exp. No. 2762; 23x23-25=504 array of U(4.738)O2 rods on 1.3cm pitch; water
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=61.38)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 29.69), (5.55, 5.55, 31.69))
