...
# Inner
surf31_cyl = openmc.ZCylinder(surface_id=31, x0=tr, y0=-40.4675, r=0.7975)
...
# Inner
surf33_cyl = openmc.ZCylinder(surface_id=33, x0=tr, y0=-40.4675, r=0.7975)
...
# Inner
surf35_cyl = openmc.ZCylinder(surface_id=35, x0=tr, y0=40.4675, r=0.7975)
...
# Inner
surf37_cyl = openmc.ZCylinder(surface_id=37, x0=tr, y0=40.4675, r=0.7975)
