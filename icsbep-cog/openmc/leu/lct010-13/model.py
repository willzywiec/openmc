"""
LEU-COMP-THERM-010-13: (13x8)-8.675cm-(13x8)-8.675cm-(13x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; Steel walls; 5.405 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -33.415, -15.564999999999998, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 15.564999999999998, 33.415, -20.0625, 101.8375)
...
cell1.translation = (-41.695, 0.0, 0.0)
...
cell5.translation = (41.695, 0.0, 0.0)
...
source.space = openmc.stats.Box((-42.695, -2.27, 45.0375), (42.695, 2.27, 47.0375))
