"""
LEU-COMP-THERM-010-30: (12x16)-15.923cm-(12x16)-15.923cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; U walls; 5.405 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-76.15, 76.15, -28.191, -20.541, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-76.15, 76.15, 20.541, 28.191, -20.0625, 101.8375)
...
cell1.translation = (-38.627, 0.0, 0.0)
...
cell5.translation = (38.627, 0.0, 0.0)
...
source.space = openmc.stats.Box((-38.681, -2.27, 45.0375), (38.681, 2.27, 47.0375))
