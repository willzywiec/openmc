"""
LST016-7: Water reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=772 (Run 196)
...
mat1.add_nuclide("U234", 6.167200e-07)
mat1.add_nuclide("U235", 7.653100e-05)
mat1.add_nuclide("U236", 7.643500e-08)
mat1.add_nuclide("U238", 6.816700e-04)
mat1.add_nuclide("H1", 5.906600e-02)
mat1.add_element("N", 2.098900e-03)
mat1.add_nuclide("O16", 3.705700e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=102.34)
...
source.space = openmc.stats.Point((0.0, 0.0, 51.17))
