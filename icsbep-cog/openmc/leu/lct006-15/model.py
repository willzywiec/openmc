"""
LCT006-15: Tank-Type Critical Assembly (TCA) 16x16 rods with 2.293 cm pitch; Hc=64.42 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=64.42)
# DX=DY=16*2.293        = 36.688 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-18.344, 18.344, -18.344, 18.344, -30.0, 144.15)
# DX=DY=16*2.293 + 2*30 = 96.688 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-48.344, 48.344, -48.344, 48.344, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-18.344, -18.344]
...
source.space = openmc.stats.Box((-2.1, -2.1, 31.21), (2.1, 2.1, 33.21))
