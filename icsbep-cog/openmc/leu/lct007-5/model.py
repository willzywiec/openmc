"""
LCT007-5: 547 U(4.738)O2 fuel rods with 1.35 cm triangular pitch in water
...
surf2_0 = openmc.Plane(a=0.5000000947, b=0.8660253491, c=0, d=15.1987448773)
surf2_1 = openmc.Plane(a=-0.5000000947, b=0.8660253491, c=0, d=15.1987448773)
surf2_2 = openmc.Plane(a=-1.0000000000, b=0.0000000000, c=0, d=15.1987420000)
surf2_3 = openmc.Plane(a=-0.5000000947, b=-0.8660253491, c=0, d=15.1987448773)
surf2_4 = openmc.Plane(a=0.5000000947, b=-0.8660253491, c=0, d=15.1987448773)
surf2_5 = openmc.Plane(a=1.0000000000, b=0.0000000000, c=0, d=15.1987420000)
# Hexagonal
# Prism 3: 6-sided polygon
surf3_0 = openmc.Plane(a=0.4998807993, b=0.8660942134, c=0, d=15.7845670394)
surf3_1 = openmc.Plane(a=-0.4998807993, b=0.8660942134, c=0, d=15.7845670394)
surf3_2 = openmc.Plane(a=-1.0000000000, b=0.0000000000, c=0, d=15.7883310000)
surf3_3 = openmc.Plane(a=-0.4998807993, b=-0.8660942134, c=0, d=15.7845670394)
surf3_4 = openmc.Plane(a=0.4998807993, b=-0.8660942134, c=0, d=15.7845670394)
surf3_5 = openmc.Plane(a=1.0000000000, b=0.0000000000, c=0, d=15.7883310000)
# Hc
surf10 = openmc.ZPlane(surface_id=10, z0=60.93)
# UO2
...
# Hole in grid plates
surf21 = openmc.ZCylinder(surface_id=21, x0=-1.169134, y0=0.675, r=0.5)
# Hole in grid plates
surf22 = openmc.ZCylinder(surface_id=22, x0=-1.169134, y0=-0.675, r=0.5)
# Hole in grid plates
surf23 = openmc.ZCylinder(surface_id=23, x0=1.169134, y0=0.675, r=0.5)
# Hole in grid plates
surf24 = openmc.ZCylinder(surface_id=24, x0=1.169134, y0=-0.675, r=0.5)

# Z-plane surfaces for bounded cylinders
surf11_zmin = openmc.ZPlane(surface_id=1024, z0=0.0)
surf11_zmax = openmc.ZPlane(surface_id=1025, z0=89.7)
surf12_zmin = openmc.ZPlane(surface_id=1026, z0=0.0)
surf12_zmax = openmc.ZPlane(surface_id=1027, z0=96.9)
surf16_zmin = openmc.ZPlane(surface_id=1028, z0=-0.3)
surf16_zmax = openmc.ZPlane(surface_id=1029, z0=-0.05)
surf17_zmin = openmc.ZPlane(surface_id=1030, z0=96.45)
surf17_zmax = openmc.ZPlane(surface_id=1031, z0=96.7)
...
# Lattice 3: 15x33 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-17.53701, -22.275]
lattice3.pitch = [2.338268, 1.350000]
lattice3.universes = [
...
cell14.region = -surf1 & +surf10 & +surf14 & +surf15 & (+surf16 | -surf16_zmin | +surf16_zmax) & (+surf17 | -surf17_zmin | +surf17_zmax) & +surf21 & +surf22 & +surf23 & +surf24
...
source.space = openmc.stats.Point((0.0, 0.0, 30.465))
