"""
LST011-13: Air reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=1,039 (Run 484)
...
mat1.add_nuclide("U235", 5.555700e-05)
mat1.add_nuclide("U236", 9.204900e-08)
mat1.add_nuclide("U238", 8.573300e-04)
mat1.add_nuclide("H1", 5.769900e-02)
mat1.add_element("N", 2.447200e-03)
mat1.add_nuclide("O16", 3.770800e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=113.30)
...
source.space = openmc.stats.Point((0.0, 0.0, 56.65))
