"""
LEU-COMP-THERM-010-26: (12x16)-17.793cm-(12x16)-17.793cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; U walls; 1.321 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-76.15, 76.15, -24.107, -16.457, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-76.15, 76.15, 16.457, 24.107, -20.0625, 101.8375)
...
cell1.translation = (-40.497, 0.0, 0.0)
...
cell5.translation = (40.497, 0.0, 0.0)
...
source.space = openmc.stats.Box((-40.551, -2.27, 45.0375), (40.551, 2.27, 47.0375))
