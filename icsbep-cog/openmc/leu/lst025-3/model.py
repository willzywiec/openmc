"""
LST025-3: STACY two slabs of 10% 235U uranyl nitrate with concrete (C100) isolator
...
mat1.add_nuclide("U234", 6.000500e-07)
mat1.add_nuclide("U235", 7.446200e-05)
mat1.add_nuclide("U236", 7.436900e-08)
mat1.add_nuclide("U238", 6.632400e-04)
mat1.add_nuclide("H1", 5.946500e-02)
mat1.add_element("N", 1.982600e-03)
mat1.add_nuclide("O16", 3.690400e-02)
...
# Critical height
surf5 = openmc.ZPlane(surface_id=5, z0=59.45)
# Concrete
surf6 = openmc.model.RectangularParallelepiped(-5.035, 5.035, -35.7, 35.7, 0.0, 150.6)
# SST frame
surf7 = openmc.model.RectangularParallelepiped(-5.035, 5.035, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover
surf8 = openmc.model.RectangularParallelepiped(-5.845, 5.845, -38.7, 38.7, -3.0, 153.6)
# BCD
surf10 = openmc.model.RectangularParallelepiped(-44.692, 44.692, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
# LHS SST tank
surf11 = openmc.model.RectangularParallelepiped(-44.692, -6.070999999999998, -36.6005, 36.6005, -2.060999999999993, 152.183)
# RHS SST tank
surf12 = openmc.model.RectangularParallelepiped(6.070999999999998, 44.692, -36.6005, 36.6005, -2.060999999999993, 152.183)
...
cell1.translation = (-25.3815, 0.0, 0.0)
...
cell3.translation = (25.3815, 0.0, 0.0)
...
source.space = openmc.stats.Box((-26.3815, -1.0, 28.725), (26.3815, 1.0, 30.725))
