"""
LCT029-1: 22x22 array of 484 U(4.738)O2 fuel rods with 1.60 cm square pitch with two, 0.0978cm thick, Hf plates
...
mat6.add_nuclide("O16", 3.338100e-02)
...
# Hafnium plate
surf7 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 17.6, 17.6978, 0.0, 50.0)
# Hafnium plate
surf8 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -17.6978, -17.6, 0.0, 50.0)
# UO2
...
source.space = openmc.stats.Box((-1.8, -1.8, 17.15), (1.8, 1.8, 19.15))
