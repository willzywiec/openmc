"""
LCT003-15: 17x17 (two) + 17x4 (two) arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water and 2.59 (x) and 7.53 (y) cm separation (SSC-2.35-000-076)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-29.923, 29.923, -21.447, 21.447, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-59.923, 59.923, -51.447, 51.447, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-1.295)
surf4 = openmc.XPlane(surface_id=4, x0=1.295)
surf5 = openmc.YPlane(surface_id=5, y0=7.181)
surf6 = openmc.YPlane(surface_id=6, y0=14.711)
# Al-5052 lower plug
...
cell1.translation = (-15.609, -7.133, 0.0)
...
cell3.translation = (15.609, -7.133, 0.0)
...
cell5.translation = (-15.609, 17.237, 0.0)
...
cell7.translation = (15.609, 17.237, 0.0)
...
source.space = openmc.stats.Box((-16.609, -8.133, 44.72), (16.609, 18.237, 46.72))
