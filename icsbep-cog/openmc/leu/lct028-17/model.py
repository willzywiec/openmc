"""
LCT028-17: 434 U(4.31)O2 rods with 3.302 cm triangular pitch in water with 0.2154 gB/l
...
# Water with B (Case 17)
mat5 = openmc.Material(material_id=5)
mat5.set_density("sum")
mat5.add_nuclide("H1", 6.669500e-02)
mat5.add_element("B", 1.199900e-05)
mat5.add_nuclide("O16", 3.338300e-02)
...
# Lexan  lattice plate
surf1 = openmc.ZCylinder(surface_id=1, r=42.0)
# SS304L lattice plate
surf2 = openmc.ZCylinder(surface_id=2, r=42.0)
# Al6061 lattice plate
surf3 = openmc.ZCylinder(surface_id=3, r=42.0)
# Water and boundary condition
surf4 = openmc.ZCylinder(surface_id=4, r=50.8, boundary_type="vacuum")
# Al6061 tie rod
...
surf20 = openmc.ZCylinder(surface_id=20, r=42.0)
# Prism 21: 6-sided polygon
surf21_0 = openmc.Plane(a=0.8660253660, b=0.5000000654, c=0, d=37.1750048621)
surf21_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=37.1750000000)
surf21_2 = openmc.Plane(a=-0.8660253660, b=0.5000000654, c=0, d=37.1750048621)
surf21_3 = openmc.Plane(a=-0.8660253660, b=-0.5000000654, c=0, d=37.1750048621)
surf21_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=37.1750000000)
surf21_5 = openmc.Plane(a=0.8660253660, b=-0.5000000654, c=0, d=37.1750048621)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1021, z0=83.165)
surf1_zmax = openmc.ZPlane(surface_id=1022, z0=83.8)
surf2_zmin = openmc.ZPlane(surface_id=1023, z0=-2.225)
surf2_zmax = openmc.ZPlane(surface_id=1024, z0=-0.635)
surf3_zmin = openmc.ZPlane(surface_id=1025, z0=-2.86)
surf3_zmax = openmc.ZPlane(surface_id=1026, z0=-2.225)
surf4_zmin = openmc.ZPlane(surface_id=1027, z0=-33.34, boundary_type="vacuum")
surf4_zmax = openmc.ZPlane(surface_id=1028, z0=146.66, boundary_type="vacuum")
surf11_zmin = openmc.ZPlane(surface_id=1029, z0=0.0)
surf11_zmax = openmc.ZPlane(surface_id=1030, z0=82.72)
surf12_zmin = openmc.ZPlane(surface_id=1031, z0=0.0)
surf12_zmax = openmc.ZPlane(surface_id=1032, z0=85.831)
surf13_zmin = openmc.ZPlane(surface_id=1033, z0=-0.635)
surf13_zmax = openmc.ZPlane(surface_id=1034, z0=86.141)
surf14_zmin = openmc.ZPlane(surface_id=1035, z0=86.141)
surf14_zmax = openmc.ZPlane(surface_id=1036, z0=90.461)
...
cell1.region = (-surf4 & +surf4_zmin & -surf4_zmax) & -surf20 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5)

# Else
cell2 = openmc.Cell(cell_id=2, fill=universe1)
cell2.region = (-surf4 & +surf4_zmin & -surf4_zmax) & -surf20 & (+surf21_0 | +surf21_1 | +surf21_2 | +surf21_3 | +surf21_4 | +surf21_5)

# Else
cell3 = openmc.Cell(cell_id=3, fill=universe1)
cell3.region = (-surf4 & +surf4_zmin & -surf4_zmax) & +surf20

# Else
cell15 = openmc.Cell(cell_id=15, fill=universe1)
cell15.region = (+surf13 | -surf13_zmin | +surf13_zmax) & (+surf14 | -surf14_zmin | +surf14_zmax) & (-surf4 & +surf4_zmin & -surf4_zmax)

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell15])
