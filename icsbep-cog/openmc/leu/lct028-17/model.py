...
cell1.region = -surf4 & -surf20 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5)

# Else
cell2 = openmc.Cell(cell_id=2, fill=universe1)
cell2.region = -surf4 & -surf20 & (+surf21_0 | +surf21_1 | +surf21_2 | +surf21_3 | +surf21_4 | +surf21_5)

# Else
cell3 = openmc.Cell(cell_id=3, fill=universe1)
cell3.region = -surf4 & +surf20

# Else
cell15 = openmc.Cell(cell_id=15, fill=universe1)
cell15.region = +surf13 & +surf14 & -surf4
