"""
LMCT003-12: STACY run 424 with U(5)O2 rods immersed in 45.16cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 2.583400e-07)
mat1.add_nuclide("U235", 3.081700e-05)
mat1.add_nuclide("U236", 5.122900e-08)
mat1.add_nuclide("U238", 4.772400e-04)
mat1.add_nuclide("O16", 3.692500e-02)
mat1.add_nuclide("H1", 5.972400e-02)
mat1.add_element("N", 2.215100e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=45.16)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 22.58))
