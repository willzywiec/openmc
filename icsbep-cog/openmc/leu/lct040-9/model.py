"""
LCT040-9: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.65cm Boral, 2.0cm water gap, Hc=51.55cm, 0.1cm gap between steel reflector
...
mat7.add_element("Fe", 8.373900e-02)
mat7.add_element("C", 5.475100e-04)
mat7.add_element("Si", 3.345000e-04)
mat7.add_element("P", 1.516500e-04)
...
surf5 = openmc.ZPlane(surface_id=5, z0=51.55)
# Lower grid plate
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-29.5175, y0=29.5175, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-29.5175, y0=29.5175, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-2.45, y0=29.65, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-29.65, y0=2.45, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-2.45, y0=2.45, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=29.5175, y0=29.5175, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=29.5175, y0=29.5175, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=2.45, y0=29.65, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=29.65, y0=2.45, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=2.45, y0=2.45, r=0.5)
# Aluminum cover
...
# Inner: 2(0.1)+4(0.65)+18(2)(1.6)+2.0 = 62.40
surf51 = openmc.model.RectangularParallelepiped(-31.2, 31.2, -31.2, 31.2, -2.200000000000003, 92.8)
# Outer: 2(15.0) + 62.40 = 92.40
surf52 = openmc.model.RectangularParallelepiped(-46.2, 46.2, -46.2, 46.2, -2.200000000000003, 92.8)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1052, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1053, z0=90.0)
surf2_zmin = openmc.ZPlane(surface_id=1054, z0=0.0)
surf2_zmax = openmc.ZPlane(surface_id=1055, z0=96.9)
surf3_zmin = openmc.ZPlane(surface_id=1056, z0=-1.27)
surf3_zmax = openmc.ZPlane(surface_id=1057, z0=98.2)
surf4_zmin = openmc.ZPlane(surface_id=1058, z0=-1.27)
surf4_zmax = openmc.ZPlane(surface_id=1059, z0=98.2)
...
source.space = openmc.stats.Box((-30.65, -30.65, 24.775), (30.65, 30.65, 26.775))
