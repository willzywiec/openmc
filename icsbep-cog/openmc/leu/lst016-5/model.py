"""
LST016-5: Water reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=699 (Run 131)
...
mat1.add_nuclide("H1", 5.873800e-02)
mat1.add_element("N", 2.148000e-03)
mat1.add_nuclide("O16", 3.723800e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=66.39)
