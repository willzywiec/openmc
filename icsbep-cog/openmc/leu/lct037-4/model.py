"""
LCT037-4: 12x36 array of 432 U(4.738)O2 fuel rods with 1.60 cm square pitch with 10.0/5.0 cm concrete screens
...
mat6.add_nuclide("H1", 6.674700e-02)
mat6.add_nuclide("O16", 3.337300e-02)
...
# Water
surf7 = openmc.ZPlane(surface_id=7, z0=50.36)
# Dummy
...
# Concrete
surf20 = openmc.model.RectangularParallelepiped(0.5499999999999998, 9.55, -34.5, 34.5, -2.450000000000003, 96.55)
# Concrete
surf21 = openmc.model.RectangularParallelepiped(0.04999999999999982, 10.05, -34.5, 34.5, 2.049999999999997, 92.05)
# Frame
surf22 = openmc.model.RectangularParallelepiped(0.04999999999999982, 10.05, -35.0, 35.0, -2.950000000000003, 97.05)
# PVC & paint
surf23 = openmc.model.RectangularParallelepiped(0.0, 10.1, -35.05, 35.05, -3.0, 97.1)
# Concrete
surf30 = openmc.model.RectangularParallelepiped(10.45, 14.850000000000001, -34.7, 34.7, -2.6500000000000057, 96.75)
# Concrete
surf31 = openmc.model.RectangularParallelepiped(10.15, 15.15, -34.7, 34.7, -0.45000000000000284, 94.55)
# Frame
surf32 = openmc.model.RectangularParallelepiped(10.15, 15.15, -35.0, 35.0, -2.950000000000003, 97.05)
# PVC & paint
surf33 = openmc.model.RectangularParallelepiped(10.100000000000001, 15.2, -35.05, 35.05, -3.0, 97.1)
# Tank wall
surf34 = openmc.model.RectangularParallelepiped(15.2, 15.5, -65.0, 65.0, -24.0, 116.0)
# AG3M pedestal plate
surf41 = openmc.model.RectangularParallelepiped(-170.5, 15.5, -93.0, 93.0, -4.0, -3.0)
# SST  pedestal plate
surf42 = openmc.model.RectangularParallelepiped(-170.5, 15.5, -93.0, 93.0, -6.5, -4.0)
# Entire problem
surf99 = openmc.model.RectangularParallelepiped(-49.2, 15.5, -65.05, 65.05, -24.0, 116.1, boundary_type="vacuum")
...
cell19.region = +surf23 & -surf34 & -surf99
...
source.space = openmc.stats.Box((-19.4, -1.8, 24.18), (0.19999999999999996, 1.8, 26.18))
