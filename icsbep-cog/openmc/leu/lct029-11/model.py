"""
LCT029-11: 21x20 array of 420 U(4.738)O2 fuel rods with 1.60 cm square pitch with no Hf plates
...
surf5 = openmc.ZPlane(surface_id=5, z0=36.30)
...
source.space = openmc.stats.Box((-1.0, -1.0, 17.15), (2.6, 1.0, 19.15))
