"""
LEU-COMP-THERM-009-22: (15x8)-2.7397cm-(0.2006cm Cd)-2.7397cm-(15x8)-2.7397cm-(0.2006cm Cd)-2.7397cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-62.83, 62.83, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-92.83, 92.83, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-24.73)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=24.73)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-21.9903, -21.7897, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(21.7897, 21.9903, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-43.78, 0.0, 0.0)
...
cell5.translation = (43.78, 0.0, 0.0)
...
source.space = openmc.stats.Box((-44.78, -2.27, 45.0375), (44.78, 2.27, 47.0375))
