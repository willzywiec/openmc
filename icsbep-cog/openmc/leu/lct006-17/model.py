"""
LCT006-17: Tank-Type Critical Assembly (TCA) 18x18 rods with 2.293 cm pitch; Hc=46.06 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=46.06)
# DX=DY=18*2.293        =  41.274 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-20.637, 20.637, -20.637, 20.637, -30.0, 144.15)
# DX=DY=18*2.293 + 2*30 = 101.274 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-50.637, 50.637, -50.637, 50.637, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-20.637, -20.637]
...
source.space = openmc.stats.Box((-2.1, -2.1, 22.03), (2.1, 2.1, 24.03))
