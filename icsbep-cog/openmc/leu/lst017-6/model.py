"""
LST017-6: Unreflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=729 (Run 147)
...
mat1.add_nuclide("U234", 6.490400e-07)
mat1.add_nuclide("U235", 8.054100e-05)
mat1.add_nuclide("U236", 8.044100e-08)
mat1.add_nuclide("U238", 7.173900e-04)
mat1.add_nuclide("H1", 5.871400e-02)
mat1.add_element("N", 2.172400e-03)
mat1.add_nuclide("O16", 3.718400e-02)
...
# Hc
surf10 = openmc.ZPlane(surface_id=10, z0=111.91)
...
source.space = openmc.stats.Point((0.0, 0.0, 55.955))
