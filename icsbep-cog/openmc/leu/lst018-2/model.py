"""
LST018-2: Concrete reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=737 (Run 142)
...
mat1.add_nuclide("U234", 6.426600e-07)
mat1.add_nuclide("U235", 7.974900e-05)
mat1.add_nuclide("U236", 7.965000e-08)
mat1.add_nuclide("U238", 7.103400e-04)
mat1.add_nuclide("H1", 5.876300e-02)
mat1.add_element("N", 2.156700e-03)
mat1.add_nuclide("O16", 3.714600e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=80.57)
# C25          [ dX=C-B; Xo=-(B+C)/2 ]
surf11 = openmc.model.RectangularParallelepiped(-20.18, -17.65, -35.7, 35.7, 0.0, 150.6)
# Steel Frame  [ dX=C-B; Xo=-(B+C)/2 ]
surf12 = openmc.model.RectangularParallelepiped(-20.18, -17.65, -38.7, 38.7, -3.0, 153.6)
# Aluminum     [ dX=D-A; Xo=-(D+A)/2 ]
surf13 = openmc.model.RectangularParallelepiped(-20.99, -16.84, -38.7, 38.7, -3.0, 153.6)
# C25          [ dx=C-B; Xo=+(B+C)/2 ]
surf21 = openmc.model.RectangularParallelepiped(17.65, 20.18, -35.7, 35.7, 0.0, 150.6)
# Steel Frame  [ dx=C-B; Xo=+(B+C)/2 ]
surf22 = openmc.model.RectangularParallelepiped(17.65, 20.18, -38.7, 38.7, -3.0, 153.6)
# Aluminum     [ dx=D-A; Xo=+(D+A)/2 ]
surf23 = openmc.model.RectangularParallelepiped(16.84, 20.99, -38.7, 38.7, -3.0, 153.6)
# BCD
...
source.space = openmc.stats.Point((0.0, 0.0, 40.285))
