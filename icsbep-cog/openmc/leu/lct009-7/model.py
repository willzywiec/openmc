"""
LEU-COMP-THERM-009-7: (15x8)-2.731cm-(0.298cm STL1.6B)-2.731cm-(15x8)-2.731cm-(0.298cm STL-1.6B)-2.731cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
mat6.add_nuclide("B10", 1.395300e-03)
mat6.add_nuclide("B11", 5.616300e-03)
mat6.add_element("Cr", 1.763800e-02)
mat6.add_element("Cu", 1.914500e-04)
mat6.add_element("Fe", 5.563400e-02)
mat6.add_element("Mn", 1.439400e-03)
mat6.add_element("Mo", 1.511900e-04)
mat6.add_element("Ni", 8.068400e-03)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-62.91, 62.91, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-92.91, 92.91, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-24.81)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=24.81)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-22.079, -21.781, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(21.781, 22.079, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-43.86, 0.0, 0.0)
...
cell5.translation = (43.86, 0.0, 0.0)
...
source.space = openmc.stats.Box((-44.86, -2.27, 45.0375), (44.86, 2.27, 47.0375))
