"""
LMCT005-1: STACY run 500 with U(5)O2 rods immersed in 43.73cm of U(6) uranyl nitrate and Sm solution with water reflection
...
mat1.add_nuclide("U234", 4.253300e-07)
mat1.add_nuclide("U235", 5.082200e-05)
mat1.add_nuclide("U236", 8.434400e-08)
mat1.add_nuclide("U238", 7.856500e-04)
mat1.add_nuclide("O16", 3.809400e-02)
mat1.add_nuclide("H1", 5.674200e-02)
mat1.add_element("N", 2.885000e-03)
mat1.add_element("Sm", 1.866400e-07)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=43.73)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 21.865))
