"""
LST024-1: STACY two slabs of 10% 235U uranyl nitrate with polyethylene (P10) isolator
...
mat1.add_nuclide("U234", 6.070500e-07)
mat1.add_nuclide("U235", 7.533000e-05)
mat1.add_nuclide("U236", 7.523600e-08)
mat1.add_nuclide("U238", 6.709700e-04)
mat1.add_nuclide("H1", 5.935600e-02)
mat1.add_element("N", 1.999800e-03)
mat1.add_nuclide("O16", 3.691900e-02)
...
# Critical height
surf5 = openmc.ZPlane(surface_id=5, z0=53.60)
# Polyethylene
surf6 = openmc.model.RectangularParallelepiped(-0.515, 0.515, -35.7, 35.7, 0.0, 150.6)
# SST frame
surf7 = openmc.model.RectangularParallelepiped(-0.515, 0.515, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover
surf8 = openmc.model.RectangularParallelepiped(-1.325, 1.325, -38.7, 38.7, -3.0, 153.6)
# BCD
surf10 = openmc.model.RectangularParallelepiped(-39.967, 39.967, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
# LHS SST tank
surf11 = openmc.model.RectangularParallelepiped(-39.967, -1.346, -36.6005, 36.6005, -2.060999999999993, 152.183)
# RHS SST tank
surf12 = openmc.model.RectangularParallelepiped(1.346, 39.967, -36.6005, 36.6005, -2.060999999999993, 152.183)
...
cell1.translation = (-20.6565, 0.0, 0.0)
...
cell3.translation = (20.6565, 0.0, 0.0)
...
source.space = openmc.stats.Box((-21.6565, -1.0, 25.8), (21.6565, 1.0, 27.8))
