...
surf215 = openmc.ZCylinder(surface_id=215, x0=-4.445, y0=20.89719, r=0.47)
surf216 = openmc.ZCylinder(surface_id=216, x0=4.445, y0=20.89719, r=0.47)
surf217 = openmc.ZCylinder(surface_id=217, x0=5.715, y0=20.89719, r=0.47)
surf218 = openmc.ZCylinder(surface_id=218, x0=6.985, y0=20.89719, r=0.47)
surf219 = openmc.ZCylinder(surface_id=219, x0=8.255, y0=20.89719, r=0.47)
surf220 = openmc.ZCylinder(surface_id=220, x0=-10.16, y0=19.79734, r=0.47)
surf221 = openmc.ZCylinder(surface_id=221, x0=-8.89, y0=19.79734, r=0.47)
surf222 = openmc.ZCylinder(surface_id=222, x0=-7.62, y0=19.79734, r=0.47)
surf223 = openmc.ZCylinder(surface_id=223, x0=7.62, y0=19.79734, r=0.47)
surf224 = openmc.ZCylinder(surface_id=224, x0=8.89, y0=19.79734, r=0.47)
surf225 = openmc.ZCylinder(surface_id=225, x0=10.16, y0=19.79734, r=0.47)
surf301 = openmc.ZCylinder(surface_id=301, x0=-3.175, y0=20.89719, r=0.47)
surf302 = openmc.ZCylinder(surface_id=302, x0=-1.905, y0=20.89719, r=0.47)
surf303 = openmc.ZCylinder(surface_id=303, x0=-0.635, y0=20.89719, r=0.47)
surf304 = openmc.ZCylinder(surface_id=304, x0=0.635, y0=20.89719, r=0.47)
surf305 = openmc.ZCylinder(surface_id=305, x0=1.905, y0=20.89719, r=0.47)
surf306 = openmc.ZCylinder(surface_id=306, x0=3.175, y0=20.89719, r=0.47)
surf307 = openmc.ZCylinder(surface_id=307, x0=-6.35, y0=19.79734, r=0.47)
surf308 = openmc.ZCylinder(surface_id=308, x0=-5.08, y0=19.79734, r=0.47)
surf309 = openmc.ZCylinder(surface_id=309, x0=5.08, y0=19.79734, r=0.47)
surf310 = openmc.ZCylinder(surface_id=310, x0=6.35, y0=19.79734, r=0.47)
surf311 = openmc.ZCylinder(surface_id=311, x0=-10.795, y0=18.69749, r=0.47)
surf312 = openmc.ZCylinder(surface_id=312, x0=-9.525, y0=18.69749, r=0.47)
surf313 = openmc.ZCylinder(surface_id=313, x0=-8.255, y0=18.69749, r=0.47)
surf314 = openmc.ZCylinder(surface_id=314, x0=-6.985, y0=18.69749, r=0.47)
surf315 = openmc.ZCylinder(surface_id=315, x0=6.985, y0=18.69749, r=0.47)
surf316 = openmc.ZCylinder(surface_id=316, x0=8.255, y0=18.69749, r=0.47)
surf317 = openmc.ZCylinder(surface_id=317, x0=9.525, y0=18.69749, r=0.47)
surf318 = openmc.ZCylinder(surface_id=318, x0=10.795, y0=18.69749, r=0.47)
...
cell2.region = (-surf15 & +surf15_zmin & -surf15_zmax) & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5 | +surf31_6 | +surf31_7 | +surf31_8 | +surf31_9 | +surf31_10 | +surf31_11) & (-surf32_0 & -surf32_1 & -surf32_2 & -surf32_3 & -surf32_4 & -surf32_5)

# Misc
cell3 = openmc.Cell(cell_id=3, fill=universe9)
cell3.region = (-surf15 & +surf15_zmin & -surf15_zmax) & (+surf31_0 | +surf31_1 | +surf31_2 | +surf31_3 | +surf31_4 | +surf31_5 | +surf31_6 | +surf31_7 | +surf31_8 | +surf31_9 | +surf31_10 | +surf31_11) & (+surf32_0 | +surf32_1 | +surf32_2 | +surf32_3 | +surf32_4 | +surf32_5) & (-surf33_0 & -surf33_1 & -surf33_2 & -surf33_3 & -surf33_4 & -surf33_5 & -surf33_6 & -surf33_7 & -surf33_8 & -surf33_9 & -surf33_10 & -surf33_11)
