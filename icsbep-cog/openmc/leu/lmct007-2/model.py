"""
LMCT007-2: STACY run 604 with U(5)O2 rods immersed in 46.41cm of U(6) uranyl nitrate with water reflection
...
mat1.add_nuclide("U234", 3.243400e-07)
mat1.add_nuclide("U235", 3.875500e-05)
mat1.add_nuclide("U236", 6.431700e-08)
mat1.add_nuclide("U238", 5.991000e-04)
mat1.add_nuclide("O16", 3.705100e-02)
mat1.add_nuclide("H1", 5.928300e-02)
mat1.add_element("N", 2.197900e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=46.41)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 23.205))
