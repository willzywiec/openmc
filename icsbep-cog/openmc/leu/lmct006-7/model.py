"""
LMCT006-7: STACY run 551 with U(5)O2 rods immersed in 53.80cm of U(6) uranyl nitrate and Gd solution, unreflected
...
mat1.add_nuclide("U234", 4.250800e-07)
mat1.add_nuclide("U235", 5.079100e-05)
mat1.add_nuclide("U236", 8.429300e-08)
mat1.add_nuclide("U238", 7.851800e-04)
mat1.add_nuclide("O16", 3.809400e-02)
mat1.add_nuclide("H1", 5.684000e-02)
mat1.add_element("N", 2.865800e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=53.80)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 26.9))
