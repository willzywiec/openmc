"""
LST024-3: STACY two slabs of 10% 235U uranyl nitrate with polyethylene (P50) isolator
...
mat1.add_nuclide("U234", 6.089000e-07)
mat1.add_nuclide("U235", 7.556000e-05)
mat1.add_nuclide("U236", 7.546600e-08)
mat1.add_nuclide("U238", 6.730200e-04)
mat1.add_nuclide("H1", 5.935000e-02)
mat1.add_element("N", 2.004400e-03)
mat1.add_nuclide("O16", 3.693400e-02)
...
# Critical height
surf5 = openmc.ZPlane(surface_id=5, z0=63.69)
# Polyethylene
surf6 = openmc.model.RectangularParallelepiped(-2.515, 2.515, -35.7, 35.7, 0.0, 150.6)
# SST frame
surf7 = openmc.model.RectangularParallelepiped(-2.515, 2.515, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover
surf8 = openmc.model.RectangularParallelepiped(-3.325, 3.325, -38.7, 38.7, -3.0, 153.6)
# BCD
surf10 = openmc.model.RectangularParallelepiped(-41.992, 41.992, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
# LHS SST tank
surf11 = openmc.model.RectangularParallelepiped(-41.992000000000004, -3.3709999999999987, -36.6005, 36.6005, -2.060999999999993, 152.183)
# RHS SST tank
surf12 = openmc.model.RectangularParallelepiped(3.3709999999999987, 41.992000000000004, -36.6005, 36.6005, -2.060999999999993, 152.183)
...
cell1.translation = (-22.6815, 0.0, 0.0)
...
cell3.translation = (22.6815, 0.0, 0.0)
...
source.space = openmc.stats.Box((-23.6815, -1.0, 30.845), (23.6815, 1.0, 32.845))
