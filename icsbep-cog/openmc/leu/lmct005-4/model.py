"""
LMCT005-4: STACY run 507 with U(5)O2 rods immersed in 52.14cm of U(6) uranyl nitrate, Sm and Cs solution with water reflection
...
mat1.add_nuclide("U234", 4.187700e-07)
mat1.add_nuclide("U235", 5.003800e-05)
mat1.add_nuclide("U236", 8.304300e-08)
mat1.add_nuclide("U238", 7.735300e-04)
mat1.add_nuclide("O16", 3.805600e-02)
mat1.add_nuclide("H1", 5.686500e-02)
mat1.add_element("N", 2.859300e-03)
mat1.add_element("Sm", 5.607200e-07)
mat1.add_element("Cs", 5.029500e-06)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=52.14)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 26.07))
