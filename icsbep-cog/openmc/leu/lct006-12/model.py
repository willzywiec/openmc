"""
LCT006-12: Tank-Type Critical Assembly (TCA) 19x19 rods with 2.15 cm pitch; Hc=44.55 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=44.55)
# DX=DY=19*2.15        =  40.85 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-20.425, 20.425, -20.425, 20.425, -30.0, 144.15)
# DX=DY=19*2.15 + 2*30 = 100.85 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-50.425, 50.425, -50.425, 50.425, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-20.425, -20.425]
...
source.space = openmc.stats.Point((0.0, 0.0, 22.275))
