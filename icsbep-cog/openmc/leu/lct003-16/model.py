"""
LCT003-16: 17x17 (two) + 17x9 (two) arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water and 2.59 (x) and 9.00 (y) cm separation (SSC-2.35-000-075)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-29.923, 29.923, -26.392, 26.392, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-59.923, 59.923, -56.392, 56.392, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-1.295)
surf4 = openmc.XPlane(surface_id=4, x0=1.295)
surf5 = openmc.YPlane(surface_id=5, y0=2.236)
surf6 = openmc.YPlane(surface_id=6, y0=11.236)
# Al-5052 lower plug
...
cell1.translation = (-15.609, -12.078, 0.0)
...
cell3.translation = (15.609, -12.078, 0.0)
...
cell5.translation = (-15.609, 18.814, 0.0)
...
cell7.translation = (15.609, 18.814, 0.0)
...
source.space = openmc.stats.Box((-16.609, -13.078, 44.72), (16.609, 19.814, 46.72))
