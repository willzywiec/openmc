"""
LEU-COMP-THERM-096-1: 45 x 45 array of 2025 fuel rods with 0.8001 cm square pitch; Hc = 36.55 cm
...
surf13 = openmc.ZPlane(surface_id=13, z0=36.55)
...
root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell15, cell20, cell24])
...
source.space = openmc.stats.Point((0.0, 0.0, 18.275))
