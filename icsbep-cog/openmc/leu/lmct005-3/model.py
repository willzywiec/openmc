"""
LMCT005-3: STACY run 505 with U(5)O2 rods immersed in 51.06cm of U(6) uranyl nitrate and Sm solution with water reflection
...
mat1.add_nuclide("U234", 4.252000e-07)
mat1.add_nuclide("U235", 5.080700e-05)
mat1.add_nuclide("U236", 8.431900e-08)
mat1.add_nuclide("U238", 7.854200e-04)
mat1.add_nuclide("O16", 3.812200e-02)
mat1.add_nuclide("H1", 5.673300e-02)
mat1.add_element("N", 2.897600e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=51.06)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 25.53))
