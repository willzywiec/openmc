"""
LMCT003-15: STACY run 443 with U(5)O2 rods immersed in 55.23cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 6.484200e-08)
mat1.add_nuclide("U235", 7.734900e-06)
mat1.add_nuclide("U236", 1.285800e-08)
mat1.add_nuclide("U238", 1.197900e-04)
mat1.add_nuclide("O16", 3.547000e-02)
mat1.add_nuclide("H1", 6.275600e-02)
mat1.add_element("N", 1.483700e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=55.23)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 27.615))
