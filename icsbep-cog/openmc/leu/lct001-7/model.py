"""
LCT001-7: (20x14)-4.46cm-(20x14)-4.46cm-(20x14) array of U(2.35)O2 fuel rods with 2.032 cm pitch (SSC-2.35-000-021)
...
surf1 = openmc.model.RectangularParallelepiped(-65.42, 65.42, -14.224, 14.224, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-95.42, 95.42, -44.224, 44.224, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-24.78)
surf4 = openmc.XPlane(surface_id=4, x0=-20.32)
surf5 = openmc.XPlane(surface_id=5, x0=20.32)
surf6 = openmc.XPlane(surface_id=6, x0=24.78)
# Al-5052 lower plug
...
# Lattice 3: 20x14 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-20.32, -14.224]
...
cell1.translation = (-45.1, 0.0, 0.0)
...
cell5.translation = (45.1, 0.0, 0.0)
