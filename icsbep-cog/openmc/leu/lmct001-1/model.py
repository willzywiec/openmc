"""
LMCT001-1: STACY run 375 with U(5)O2 rods immersed in 41.38cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 3.657700e-07)
mat1.add_nuclide("U235", 4.385000e-05)
mat1.add_nuclide("U236", 7.253200e-08)
mat1.add_nuclide("U238", 6.754800e-04)
mat1.add_nuclide("O16", 3.803400e-02)
mat1.add_nuclide("H1", 5.699300e-02)
mat1.add_element("N", 2.913300e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=41.38)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 20.69))
