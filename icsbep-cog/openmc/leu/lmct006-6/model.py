"""
LMCT006-6: STACY run 548 with U(5)O2 rods immersed in 48.45cm of U(6) uranyl nitrate and Gd solution, unreflected
...
mat1.add_nuclide("O16", 3.801400e-02)
mat1.add_nuclide("H1", 5.669900e-02)
mat1.add_element("N", 2.861100e-03)
mat1.add_element("Gd", 7.276300e-08)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=48.45)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 24.225))
