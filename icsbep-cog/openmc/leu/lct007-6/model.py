"""
LCT007-6: 271 U(4.738)O2 fuel rods with 1.72 cm triangular pitch in water
...
surf2_0 = openmc.Plane(a=0.4999999231, b=0.8660254482, c=0, d=13.4060739379)
surf2_1 = openmc.Plane(a=-0.4999999231, b=0.8660254482, c=0, d=13.4060739379)
surf2_2 = openmc.Plane(a=-1.0000000000, b=0.0000000000, c=0, d=13.4060760000)
surf2_3 = openmc.Plane(a=-0.4999999231, b=-0.8660254482, c=0, d=13.4060739379)
surf2_4 = openmc.Plane(a=0.4999999231, b=-0.8660254482, c=0, d=13.4060739379)
surf2_5 = openmc.Plane(a=1.0000000000, b=0.0000000000, c=0, d=13.4060760000)
# Hexagonal
# Prism 3: 6-sided polygon
surf3_0 = openmc.Plane(a=0.5012153441, b=0.8653225866, c=0, d=14.1393710650)
surf3_1 = openmc.Plane(a=-0.5012153441, b=0.8653225866, c=0, d=14.1393710650)
surf3_2 = openmc.Plane(a=-1.0000000000, b=0.0000000000, c=0, d=14.1050860000)
surf3_3 = openmc.Plane(a=-0.5012153441, b=-0.8653225866, c=0, d=14.1393710650)
surf3_4 = openmc.Plane(a=0.5012153441, b=-0.8653225866, c=0, d=14.1393710650)
surf3_5 = openmc.Plane(a=1.0000000000, b=0.0000000000, c=0, d=14.1050860000)
# Hc
surf10 = openmc.ZPlane(surface_id=10, z0=68.06)
# UO2
...
# Lattice 3: 11x19 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-16.385204, -16.34]
lattice3.pitch = [2.979128, 1.720000]
lattice3.universes = [
...
source.space = openmc.stats.Point((0.0, 0.0, 34.03))
