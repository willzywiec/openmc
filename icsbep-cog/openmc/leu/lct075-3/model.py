"""
LCT075-3: 1,195 VVER U(6.5)O2 rods, 1.10 cm trianglur pitch, 4 B4C rods 8.8 from core center, Hc=125.0cm
...
surf1 = openmc.ZPlane(surface_id=1, z0=125.0)
...
cell2.translation = (-4.4, 7.621024, 0.0)
...
cell3.translation = (4.4, 7.621024, 0.0)
...
cell6.translation = (-4.4, -7.621024, 0.0)
...
cell7.translation = (4.4, -7.621024, 0.0)
...
source.space = openmc.stats.Point((0.0, 0.0, 62.5))
