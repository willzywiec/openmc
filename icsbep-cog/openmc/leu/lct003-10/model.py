"""
LCT003-10: 4+17x17 and 17x17+5 arrays of U(2.35)O2 fuel rods with 1.684 cm square pitch in water and 1.68 cm separation (SSC-2.35-000-108)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-29.468, 29.468, -15.156, 15.156, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-59.468, 59.468, -45.156, 45.156, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-0.84)
surf4 = openmc.XPlane(surface_id=4, x0=0.84)
# Al-5052 lower plug
...
# Lattice 3: 17x18 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-14.314, -15.156]
...
lattice3.universes = [
    ...
    [universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe1, universe1, universe1, universe1, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2],
]
universe3 = openmc.Universe(universe_id=3)
universe3.add_cell(openmc.Cell(fill=lattice3))

# Lattice 4: 17x18 array
lattice4 = openmc.RectLattice(lattice_id=4)
lattice4.lower_left = [-14.314, -15.156]
...
lattice4.universes = [
    ...
    [universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1],
]
...
cell1.translation = (-15.154, 0.0, 0.0)
...
cell3.translation = (15.154, 0.0, 0.0)
cell3.region = -surf1 & -surf2 & +surf4

# H2O
cell4 = openmc.Cell(cell_id=4, fill=mat5)
cell4.region = +surf1 & -surf2

# Water
cell13 = openmc.Cell(cell_id=13, fill=mat5)
cell13.region = -surf2 & +surf17 & (+surf14 | -surf14_zmin | +surf14_zmax) & (+surf15 | -surf15_zmin | +surf15_zmax)

# Water
cell17 = openmc.Cell(cell_id=17, fill=mat5)
cell17.region = -surf2 & -surf16

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell13, cell17])
...
source.space = openmc.stats.Box((-16.154, -1.842, 44.72), (16.154, 1.842, 46.72))
