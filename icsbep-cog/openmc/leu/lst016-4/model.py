"""
LST016-4: Water reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=650 (Run 129)
...
mat1.add_nuclide("U234", 7.221100e-07)
mat1.add_nuclide("U235", 8.960900e-05)
mat1.add_nuclide("U236", 8.949800e-08)
mat1.add_nuclide("U238", 7.981600e-04)
mat1.add_nuclide("H1", 5.826500e-02)
mat1.add_element("N", 2.258900e-03)
mat1.add_nuclide("O16", 3.744500e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=56.96)
...
source.space = openmc.stats.Point((0.0, 0.0, 28.48))
