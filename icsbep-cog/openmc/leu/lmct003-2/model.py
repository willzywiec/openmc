"""
LMCT003-2: STACY run 414 with U(5)O2 rods immersed in 44.03cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 4.275200e-07)
mat1.add_nuclide("U235", 5.099800e-05)
mat1.add_nuclide("U236", 8.477800e-08)
mat1.add_nuclide("U238", 7.897800e-04)
mat1.add_nuclide("O16", 3.810900e-02)
mat1.add_nuclide("H1", 5.679500e-02)
mat1.add_element("N", 2.875000e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=44.03)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 22.015))
