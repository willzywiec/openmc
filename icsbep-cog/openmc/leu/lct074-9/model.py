"""
LEU-COMP-THERM-074-9: MIRTE-1 Experiment 2A-Pb-200; 7x45; Hc=75.366cm
...
mat8.add_element("Ca", 1.674000e-06)
mat8.add_element("Cu", 3.695300e-05)
mat8.add_element("Fe", 1.201400e-06)
mat8.add_element("Na", 2.918300e-06)
mat8.add_element("Si", 2.388900e-06)
mat8.add_element("C", 1.117200e-05)
mat8.add_nuclide("O16", 5.451400e-05)
mat8.add_element("Pb", 3.236300e-02)
mat8.add_element("Cd", 1.492100e-08)
...
lattice4.lower_left = [-49.6, -25.9942]
...
cell8.region = -surf8 & +surf10 & +surf11 & +surf4 & +surf12 & +surf13 & -surf14 & -surf15
...
cell10.region = -surf8 & +surf10 & +surf11 & +surf4 & +surf12 & +surf13 & -surf14 & +surf15 & +surf16

# Air
cell11 = openmc.Cell(cell_id=11, fill=mat7)
cell11.region = -surf8 & +surf10 & +surf11 & +surf4 & +surf12 & +surf13 & +surf14 & +surf9

# H2O
cell12 = openmc.Cell(cell_id=12, fill=mat6)
cell12.region = -surf8 & +surf10 & +surf11 & +surf4 & +surf12 & +surf13 & +surf14 & -surf9
...
source.space = openmc.stats.Box((-0.19999999999999996, 10.6, 36.683), (1.8, 22.2, 38.683))
