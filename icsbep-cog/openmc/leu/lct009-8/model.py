"""
LEU-COMP-THERM-009-8: (15x8)-3.801cm-(0.298cm STL1.6B)-3.801cm-(15x8)-3.801cm-(0.298cm STL-1.68)-3.801cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-65.05, 65.05, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-95.05, 95.05, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-26.95)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=26.95)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-23.149, -22.851, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(22.851, 23.149, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-46.0, 0.0, 0.0)
...
cell5.translation = (46.0, 0.0, 0.0)
...
source.space = openmc.stats.Box((-47.0, -2.27, 45.0375), (47.0, 2.27, 47.0375))
