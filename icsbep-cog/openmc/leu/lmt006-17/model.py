"""
LMT006-17: Case 17; Bugey 24; detailed; 46 type 1 and 5 type 2 tubes; 12.7cm pitch; Hw=66.54cm
...
surf904 = openmc.ZPlane(surface_id=904, z0=66.54)
...
u3_cell2.region = (+surf5 | -surf5_zmin | +surf5_zmax) & (-surf6 & +surf6_zmin & -surf6_zmax)
u3_cell3 = openmc.Cell(fill=mat2)
u3_cell3.region = +surf4 & (+surf5 | -surf5_zmin | +surf5_zmax) & (+surf6 | -surf6_zmin | +surf6_zmax) & -surf904
...
root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell17, cell22, cell28])
