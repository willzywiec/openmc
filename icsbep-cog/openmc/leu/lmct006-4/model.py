"""
LMCT006-4: STACY run 558 with U(5)O2 rods immersed in 63.99cm of U(6) uranyl nitrate and Gd solution with water reflection
...
mat1.add_nuclide("U234", 4.244300e-07)
mat1.add_nuclide("U235", 5.071500e-05)
mat1.add_nuclide("U236", 8.416600e-08)
mat1.add_nuclide("U238", 7.839900e-04)
mat1.add_nuclide("O16", 3.807700e-02)
mat1.add_nuclide("H1", 5.679400e-02)
mat1.add_element("N", 2.869700e-03)
mat1.add_element("Gd", 2.902900e-07)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=63.99)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 31.995))
