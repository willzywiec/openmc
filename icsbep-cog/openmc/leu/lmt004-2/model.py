"""
LMT004-2: 50 U(4.948) Metal Rods in Water; Pitch=4.27cm; Hf=30cm; Hw=36.5cm
...
surf17 = openmc.YPlane(surface_id=17, y0=12.9427)
# Water reflector
surf90 = openmc.ZCylinder(surface_id=90, x0=-16.51, y0=36.5, r=58.3, boundary_type="vacuum")
# Arbitrary
