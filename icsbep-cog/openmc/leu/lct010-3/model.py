"""
LEU-COMP-THERM-010-3: (13x8)-17.915cm-(13x8)-17.915cm-(13x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; Pb walls; 1.321 gap
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-67.445, 67.445, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-112.5, 112.5, -40.66, 40.66, -20.0625, 109.4975, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-34.425)
surf4 = openmc.XPlane(surface_id=4, x0=-16.51)
surf5 = openmc.XPlane(surface_id=5, x0=16.51)
surf6 = openmc.XPlane(surface_id=6, x0=34.425)
# Rubber
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-82.0, 82.0, -21.680999999999997, -11.481, -20.0625, 103.3375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-82.0, 82.0, 11.481, 21.680999999999997, -20.0625, 103.3375)
...
cell1.translation = (-50.935, 0.0, 0.0)
...
cell5.translation = (50.935, 0.0, 0.0)
...
source.space = openmc.stats.Box((-51.935, -2.27, 45.0375), (51.935, 2.27, 47.0375))
