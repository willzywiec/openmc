...
u1_cell6.region = -surf1 & +surf2 & +surf9
u1_cell7 = openmc.Cell(fill=mat3)
u1_cell7.region = +surf1 & +surf11 & +surf14 & -surf16
...
u2_cell0.region = -surf1 & -surf11 & -surf16
u2_cell1 = openmc.Cell(fill=mat3)
u2_cell1.region = -surf1 & -surf14 & -surf16
u2_cell2 = openmc.Cell(fill=mat4)
u2_cell2.region = +surf1 & -surf11 & -surf16
u2_cell3 = openmc.Cell(fill=mat4)
u2_cell3.region = +surf1 & -surf14 & -surf16
u2_cell4 = openmc.Cell(fill=mat3)
u2_cell4.region = +surf11 & +surf14 & -surf16
...
cell21.region = +surf11 & +surf14 & -surf16

# H2O
cell26 = openmc.Cell(cell_id=26, fill=mat3)
cell26.region = +surf22 & +surf24 & -surf16

# Al6061
cell30 = openmc.Cell(cell_id=30, fill=mat4)
cell30.region = -surf14 & -surf16
