"""
LCT041-3: CRISTO II Configuration C
...
mat5.add_element("Fe", 5.561100e-02)
mat5.add_element("Cr", 1.664300e-02)
mat5.add_element("Ni", 1.035500e-02)
mat5.add_element("Mn", 5.300000e-04)
mat5.add_element("Mo", 8.800000e-05)
mat5.add_element("C", 1.370000e-04)
mat5.add_element("Si", 9.190000e-04)
mat5.add_nuclide("B10", 9.301000e-04)
mat5.add_nuclide("B11", 3.720400e-03)
...
# Absorber plate
surf7 = openmc.model.RectangularParallelepiped(-95.67, 95.67, -95.67, 95.67, -499.95, 499.95)
# Reflector
surf8 = openmc.model.RectangularParallelepiped(-110.6, 110.6, -110.6, 110.6, -110.6, 110.6, boundary_type="reflecting")
...
cell1.region = -surf5 & -surf8

# H2O
cell2 = openmc.Cell(cell_id=2, fill=mat4)
cell2.region = +surf5 & -surf6 & -surf8

# BSS
cell3 = openmc.Cell(cell_id=3, fill=mat5)
cell3.region = +surf6 & -surf7 & -surf8

# H2O
cell4 = openmc.Cell(cell_id=4, fill=mat4)
cell4.region = +surf7 & -surf8

# H2O
cell8 = openmc.Cell(cell_id=8, fill=mat4)
cell8.region = +surf2 & -surf5

# H2O
cell12 = openmc.Cell(cell_id=12, fill=mat4)
cell12.region = +surf4 & -surf5

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell8, cell12])
