"""
LEU-COMP-THERM-010-1: (13x8)-19.495cm-(13x8)-19.495cm-(13x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; Pb walls; 0.0 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-82.0, 82.0, -20.36, -10.16, -20.0625, 103.3375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-82.0, 82.0, 10.16, 20.36, -20.0625, 103.3375)
...
cell1.translation = (-52.515, 0.0, 0.0)
...
cell5.translation = (52.515, 0.0, 0.0)
...
source.space = openmc.stats.Box((-53.515, -2.27, 45.0375), (53.515, 2.27, 47.0375))
