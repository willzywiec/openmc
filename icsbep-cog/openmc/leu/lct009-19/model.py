"""
LEU-COMP-THERM-009-19: (15x8)-3.6795cm-(0.061cm Cd)-3.6795cm-(15x8)-3.6795cm-(0.061cm Cd)-3.6795cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
surf21 = openmc.model.RectangularParallelepiped(-22.7905, -22.7295, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(22.7295, 22.7905, -17.8, 17.8, 0.0, 91.5)
