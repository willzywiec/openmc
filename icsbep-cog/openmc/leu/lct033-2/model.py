"""
LCT033-2: U(2)F4-1, Paraffin reflected on top and sides; Plexiglas on bottom
...
surf1 = openmc.model.RectangularParallelepiped(-30.665, 30.665, -30.665, 30.665, -39.73, 39.73)
surf2 = openmc.model.RectangularParallelepiped(-45.865, 45.865, -45.865, 45.865, -54.93, 54.93, boundary_type="vacuum")
surf3 = openmc.ZPlane(surface_id=3, z0=-39.73)
