"""
LCT006-13: Tank-Type Critical Assembly (TCA) 20x20 rods with 2.15 cm pitch; Hc=40.44 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=40.44)
# DX=DY=20*2.15        =  43.00 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-21.5, 21.5, -21.5, 21.5, -30.0, 144.15)
# DX=DY=20*2.15 + 2*30 = 103.00 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-51.5, 51.5, -51.5, 51.5, -30.0, 144.15, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-2.1, -2.1, 19.22), (2.1, 2.1, 21.22))
