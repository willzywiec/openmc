"""
LCT030-6: 823 U(3.5)O2 rods, 1.27 cm trianglur pitch, Hc=67.23cm
...
surf1 = openmc.ZPlane(surface_id=1, z0=67.23)
...
surf31_0 = openmc.Plane(a=0.8660248948, b=0.5000008815, c=0, d=17.0477000551)
surf31_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=17.0476700000)
surf31_2 = openmc.Plane(a=-0.8660248948, b=0.5000008815, c=0, d=17.0477000551)
surf31_3 = openmc.Plane(a=-0.8660248948, b=-0.5000008815, c=0, d=17.0477000551)
surf31_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=17.0476700000)
surf31_5 = openmc.Plane(a=0.8660248948, b=-0.5000008815, c=0, d=17.0477000551)
# 2nd prism with all fuel rods
# Prism 32: 6-sided polygon
surf32_0 = openmc.Plane(a=0.8660248987, b=0.5000008748, c=0, d=18.1475517522)
surf32_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=18.1475200000)
surf32_2 = openmc.Plane(a=-0.8660248987, b=0.5000008748, c=0, d=18.1475517522)
surf32_3 = openmc.Plane(a=-0.8660248987, b=-0.5000008748, c=0, d=18.1475517522)
surf32_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=18.1475200000)
surf32_5 = openmc.Plane(a=0.8660248987, b=-0.5000008748, c=0, d=18.1475517522)
# 3rd prism with all fuel rods
# Prism 33: 6-sided polygon
surf33_0 = openmc.Plane(a=0.8660249021, b=0.5000008689, c=0, d=19.2474034493)
surf33_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=19.2473700000)
surf33_2 = openmc.Plane(a=-0.8660249021, b=0.5000008689, c=0, d=19.2474034493)
surf33_3 = openmc.Plane(a=-0.8660249021, b=-0.5000008689, c=0, d=19.2474034493)
surf33_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=19.2473700000)
surf33_5 = openmc.Plane(a=0.8660249021, b=-0.5000008689, c=0, d=19.2474034493)
# 4th prism with 3 more rows of holes
# Prism 34: 6-sided polygon
surf34_0 = openmc.Plane(a=0.8660249103, b=0.5000008547, c=0, d=22.5469585406)
surf34_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=22.5469200000)
surf34_2 = openmc.Plane(a=-0.8660249103, b=0.5000008547, c=0, d=22.5469585406)
surf34_3 = openmc.Plane(a=-0.8660249103, b=-0.5000008547, c=0, d=22.5469585406)
surf34_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=22.5469200000)
surf34_5 = openmc.Plane(a=0.8660249103, b=-0.5000008547, c=0, d=22.5469585406)
surf321 = openmc.model.RectangularParallelepiped(-6.985, 6.985, -499.5, 499.5, -499.5, 499.5)
# (11 on each short side)
surf322 = openmc.model.RectangularParallelepiped(-6.985, 6.985, -499.5, 499.5, -499.5, 499.5)
surf323 = openmc.model.RectangularParallelepiped(-6.985, 6.985, -499.5, 499.5, -499.5, 499.5)
surf331 = openmc.model.RectangularParallelepiped(-3.81, 3.81, -499.5, 499.5, -499.5, 499.5)
# (6 on each short side)
surf332 = openmc.model.RectangularParallelepiped(-3.81, 3.81, -499.5, 499.5, -499.5, 499.5)
surf333 = openmc.model.RectangularParallelepiped(-3.81, 3.81, -499.5, 499.5, -499.5, 499.5)

# Z-plane surfaces for bounded cylinders
surf2_zmin = openmc.ZPlane(surface_id=1333, z0=-3.8)
surf2_zmax = openmc.ZPlane(surface_id=1334, z0=-2.3)
surf3_zmin = openmc.ZPlane(surface_id=1335, z0=126.9)
surf3_zmax = openmc.ZPlane(surface_id=1336, z0=127.9)
surf4_zmin = openmc.ZPlane(surface_id=1337, z0=-33.8, boundary_type="vacuum")
surf4_zmax = openmc.ZPlane(surface_id=1338, z0=131.8, boundary_type="vacuum")
surf10_zmin = openmc.ZPlane(surface_id=1339, z0=0.0)
surf10_zmax = openmc.ZPlane(surface_id=1340, z0=125.0)
surf12_zmin = openmc.ZPlane(surface_id=1341, z0=125.0)
surf12_zmax = openmc.ZPlane(surface_id=1342, z0=125.7)
surf14_zmin = openmc.ZPlane(surface_id=1343, z0=125.7)
surf14_zmax = openmc.ZPlane(surface_id=1344, z0=128.0)
surf15_zmin = openmc.ZPlane(surface_id=1345, z0=0.0)
surf15_zmax = openmc.ZPlane(surface_id=1346, z0=128.0)
surf16_zmin = openmc.ZPlane(surface_id=1347, z0=-2.3)
surf16_zmax = openmc.ZPlane(surface_id=1348, z0=130.3)
surf17_zmin = openmc.ZPlane(surface_id=1349, z0=-3.8)
surf17_zmax = openmc.ZPlane(surface_id=1350, z0=131.8)
...
source.space = openmc.stats.Point((0.0, 0.0, 33.615))
