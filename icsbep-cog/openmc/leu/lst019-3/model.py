"""
LST019-3: Concrete reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=726 (Run 150)
...
mat1.add_nuclide("U234", 6.511000e-07)
mat1.add_nuclide("U235", 8.079700e-05)
mat1.add_nuclide("U236", 8.069600e-08)
mat1.add_nuclide("U238", 7.196700e-04)
mat1.add_nuclide("H1", 5.869700e-02)
mat1.add_element("N", 2.177500e-03)
mat1.add_nuclide("O16", 3.719600e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=78.08)
# P50          [ dX=C-B; Xo=-(B+C)/2 ]
surf10 = openmc.model.RectangularParallelepiped(-22.55, -17.52, -35.5, 35.5, 0.0, 150.5)
# Gap          [ dX=C-B; Xo=-(B+C)/2 ]
surf11 = openmc.model.RectangularParallelepiped(-22.55, -17.52, -35.7, 35.7, 0.0, 150.5)
# Steel Frame  [ dX=C-B; Xo=-(B+C)/2 ]
surf12 = openmc.model.RectangularParallelepiped(-22.55, -17.52, -38.7, 38.7, -3.0, 153.5)
# Aluminum     [ dX=D-A; Xo=-(D+A)/2 ]
surf13 = openmc.model.RectangularParallelepiped(-23.36, -16.71, -38.7, 38.7, -3.0, 153.5)
# P50          [ dx=C-B; Xo=+(B+C)/2 ]
surf20 = openmc.model.RectangularParallelepiped(17.52, 22.55, -35.5, 35.5, 0.0, 150.5)
# Gap          [ dX=C-B; Xo=+(B+C)/2 ]
surf21 = openmc.model.RectangularParallelepiped(17.52, 22.55, -35.7, 35.7, 0.0, 150.5)
# Steel Frame  [ dx=C-B; Xo=+(B+C)/2 ]
surf22 = openmc.model.RectangularParallelepiped(17.52, 22.55, -38.7, 38.7, -3.0, 153.5)
# Aluminum     [ dx=D-A; Xo=+(D+A)/2 ]
surf23 = openmc.model.RectangularParallelepiped(16.71, 23.36, -38.7, 38.7, -3.0, 153.5)
# BCD
surf99 = openmc.model.RectangularParallelepiped(-23.5, 23.5, -39.0, 39.0, -4.0, 156.0, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 39.04))
