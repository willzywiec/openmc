"""
LMCT002-5: STACY run 397 with U(5)O2 rods immersed in 57.78cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 1.309700e-07)
mat1.add_nuclide("U235", 1.570200e-05)
mat1.add_nuclide("U236", 2.597200e-08)
mat1.add_nuclide("U238", 2.418700e-04)
mat1.add_nuclide("O16", 3.636100e-02)
mat1.add_nuclide("H1", 6.095000e-02)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=57.78)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 28.89))
