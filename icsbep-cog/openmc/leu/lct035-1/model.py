"""
LCT035-1: 21x21 array of U(2.6)O2 rods on 1.956cm pitch in soluble boron (TCA Core B1)
...
# Water with soluble boron (B1)
mat4 = openmc.Material(material_id=4)
mat4.set_density("sum")
mat4.add_nuclide("H1", 6.665200e-02)
mat4.add_nuclide("O16", 3.333200e-02)
mat4.add_nuclide("B10", 7.737600e-07)
mat4.add_nuclide("B11", 3.114500e-06)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=52.14)
# Array boundary
...
source.space = openmc.stats.Point((0.0, 0.0, 26.17))
