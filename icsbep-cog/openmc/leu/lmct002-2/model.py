"""
LMCT002-2: STACY run 376 with U(5)O2 rods immersed in 44.35m of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 3.660200e-07)
mat1.add_nuclide("U235", 4.388100e-05)
mat1.add_nuclide("U236", 7.258300e-08)
mat1.add_nuclide("U238", 6.759600e-04)
mat1.add_nuclide("O16", 3.803400e-02)
mat1.add_nuclide("H1", 5.695500e-02)
mat1.add_element("N", 2.958100e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=44.35)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 22.175))
