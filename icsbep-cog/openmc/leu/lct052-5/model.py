"""
LCT052-5: Pseudocylindrical array of 1285 U(4.738)O2 fuel rods with 1.72 cm triangular pitch in gadolinium nitrate solution
...
mat4.add_element("Gd", 1.685040e-06)
mat4.add_element("N", 9.451250e-06)
mat4.add_nuclide("H1", 6.670970e-02)
...
# Lower grid plate
surf3 = openmc.model.RectangularParallelepiped(-36.0, 36.0, -36.0, 36.0, -0.3, -0.04999999999999999)
# Upper grid plate
surf4 = openmc.model.RectangularParallelepiped(-36.0, 36.0, -36.0, 36.0, 96.45, 96.7)
# Solution critica height
surf5 = openmc.ZPlane(surface_id=5, z0=89.4)
# UO2
...
surf99_1 = openmc.Plane(a=0.8660253953, b=-0.5000000146, c=0, d=32.0256100285)
surf99_2 = openmc.Plane(a=1.0000000000, b=0.0000000000, c=0, d=32.6800000000)
surf99_3 = openmc.Plane(a=0.8660253953, b=0.5000000146, c=0, d=32.0256100285)
surf99_4 = openmc.Plane(a=0.5115817809, b=0.8592345904, c=0, d=32.3570669474)
surf99_5 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=32.0256000000)
surf99_6 = openmc.Plane(a=-0.5115817809, b=0.8592345904, c=0, d=32.3570669474)
surf99_7 = openmc.Plane(a=-0.8660253953, b=0.5000000146, c=0, d=32.0256100285)
surf99_8 = openmc.Plane(a=-1.0000000000, b=0.0000000000, c=0, d=32.6800000000)
surf99_9 = openmc.Plane(a=-0.8660253953, b=-0.5000000146, c=0, d=32.0256100285)
surf99_10 = openmc.Plane(a=-0.5115817809, b=-0.8592345904, c=0, d=32.3570669474)
surf99_11 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=32.0256000000)
...
lattice3.lower_left = [-36.12, -34.2599651]
lattice3.pitch = [3.440000, 2.979127]
lattice3.universes = [
...
cell26.region = +surf11 & +surf12 & -surf20

# Soln
cell27 = openmc.Cell(cell_id=27, fill=mat4)
cell27.region = -surf5 & -surf20
...
source.space = openmc.stats.Point((0.0, 0.0, 44.7))
