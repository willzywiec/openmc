"""
LMCT003-7: STACY run 438 with U(5)O2 rods immersed in 53.16cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 1.296800e-07)
mat1.add_nuclide("U235", 1.547000e-05)
mat1.add_nuclide("U236", 2.571700e-08)
mat1.add_nuclide("U238", 2.395700e-04)
mat1.add_nuclide("O16", 3.598800e-02)
mat1.add_nuclide("H1", 6.166100e-02)
mat1.add_element("N", 1.757000e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=53.16)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 26.58))
