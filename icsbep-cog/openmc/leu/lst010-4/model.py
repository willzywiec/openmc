"""
LST010-4: Polyethylene (P200) reflected 60-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=942 (Run 88)
...
mat1.add_nuclide("U234", 5.008300e-07)
mat1.add_nuclide("U235", 6.214900e-05)
mat1.add_nuclide("U236", 6.207200e-08)
mat1.add_nuclide("U238", 5.535700e-04)
mat1.add_nuclide("H1", 5.852400e-02)
mat1.add_element("N", 2.491200e-03)
mat1.add_nuclide("O16", 3.733900e-02)
...
mat6.add_nuclide("H1", 8.183100e-02)
mat6.add_element("C", 4.105700e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=76.42)
# Steel support/inner
surf11 = openmc.ZCylinder(surface_id=11, r=31.7)
# Steel support/outer
surf12 = openmc.ZCylinder(surface_id=12, r=68.5)
# =A
surf13 = openmc.ZCylinder(surface_id=13, r=31.87)
# =B
surf14 = openmc.ZCylinder(surface_id=14, r=32.17)
# =C
surf15 = openmc.ZCylinder(surface_id=15, r=52.4)
# =D
surf16 = openmc.ZCylinder(surface_id=16, r=53.21)
...
source.space = openmc.stats.Point((0.0, 0.0, 38.21))
