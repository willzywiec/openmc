"""
LEU-COMP-THERM-074-20: MIRTE-1 Experiment 4A-Ti-010; 11x10; Hc=89.483cm
...
lattice3.lower_left = [0.5016, 0.5016]
...
lattice4.lower_left = [-24.5016, 0.5016]
...
lattice5.lower_left = [-24.5016, -24.5016]
...
lattice6.lower_left = [0.5016, -24.5016]
...
source.space = openmc.stats.Box((-8.7, -8.7, 43.7415), (8.7, 8.7, 45.7415))
