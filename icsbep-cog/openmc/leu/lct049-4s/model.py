"""
LCT049-4S: Simplified model of R3-3R(6,6) with H/U=2 and d=16.27cm
...
cell1.region = +surf11 & -surf20 & +surf21 & -surf29 & +surf31 & -surf39
...
source.space = openmc.stats.Box((-19.395, -11.26, -11.0), (19.395, 11.26, 11.0))
