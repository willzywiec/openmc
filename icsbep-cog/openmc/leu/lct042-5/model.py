"""
LCT042-5: (20x18)-3.446cm-PlexCd(25x18)CdPlex-3.446cm-(20x18) array of U(2.35)O2 fuel rods with 1.684 cm pitch
...
mat7.add_element("Cd", 4.620100e-02)
mat7.add_element("Zn", 2.389900e-04)
...
surf20 = openmc.XPlane(surface_id=20, x0=-21.111)
surf21 = openmc.model.RectangularParallelepiped(-21.407, -21.05, -15.1, 15.1, 0.0, 91.5)
surf22 = openmc.XPlane(surface_id=22, x0=21.111)
surf23 = openmc.model.RectangularParallelepiped(21.05, 21.407, -15.1, 15.1, 0.0, 91.5)
...
cell1.translation = (-40.494, 0.0, 0.0)
...
cell5.translation = (40.494, 0.0, 0.0)
...
source.space = openmc.stats.Box((-41.494, -1.842, 44.72), (41.494, 1.842, 46.72))
