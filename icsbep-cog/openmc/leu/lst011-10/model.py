"""
LST011-10: Air reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=890 (Run 463)
...
mat1.add_nuclide("U234", 5.305700e-07)
mat1.add_nuclide("U235", 6.350300e-05)
mat1.add_nuclide("U236", 1.052100e-07)
mat1.add_nuclide("U238", 9.799400e-04)
mat1.add_nuclide("H1", 5.652500e-02)
mat1.add_element("N", 2.696400e-03)
mat1.add_nuclide("O16", 3.813600e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=62.48)
...
source.space = openmc.stats.Point((0.0, 0.0, 31.24))
