"""
LCT001-3: Three 20x16 arrays of U(2.35)O2 fuel rods with 2.032 cm pitch separated by 8.41 cm (SSC-2.35-000-005, etc.)
...
surf1 = openmc.model.RectangularParallelepiped(-69.37, 69.37, -16.256, 16.256, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-99.37, 99.37, -46.256, 46.256, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-28.73)
surf4 = openmc.XPlane(surface_id=4, x0=-20.32)
surf5 = openmc.XPlane(surface_id=5, x0=20.32)
surf6 = openmc.XPlane(surface_id=6, x0=28.73)
# Al-5052 lower plug
...
# Lattice 3: 20x16 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-20.32, -16.256]
...
cell1.translation = (-49.05, 0.0, 0.0)
...
cell5.translation = (49.05, 0.0, 0.0)
