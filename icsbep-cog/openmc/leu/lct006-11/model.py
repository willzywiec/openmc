"""
LCT006-11: Tank-Type Critical Assembly (TCA) 18x18 rods with 2.15 cm pitch; Hc=50.52 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=50.52)
# DX=DY=18*2.15        = 38.70 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-19.35, 19.35, -19.35, 19.35, -30.0, 144.15)
# DX=DY=18*2.15 + 2*30 = 98.70 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-49.35, 49.35, -49.35, 49.35, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-19.35, -19.35]
...
source.space = openmc.stats.Box((-2.1, -2.1, 24.26), (2.1, 2.1, 26.26))
