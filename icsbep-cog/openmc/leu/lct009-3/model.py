"""
LEU-COMP-THERM-009-3: (15x8)-4.459cm-(0.302cm STL)-4.459cm-(15x8)-4.459cm-(0.302cm STL)-4.459cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-66.37, 66.37, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-96.37, 96.37, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-28.27)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=28.27)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-23.811, -23.509, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(23.509, 23.811, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-47.32, 0.0, 0.0)
...
cell5.translation = (47.32, 0.0, 0.0)
...
source.space = openmc.stats.Box((-48.32, -2.27, 45.0375), (48.32, 2.27, 47.0375))
