"""
LCT050-3: Exp. No. 2764; 23x25-25=550 array of U(4.738)O2 rods on 1.3cm pitch; boron solution no. 1
...
mat8.add_nuclide("H1", 6.589300e-02)
mat8.add_nuclide("O16", 3.337960e-02)
mat8.add_element("N", 1.457960e-04)
mat8.add_nuclide("B10", 9.111850e-06)
mat8.add_nuclide("B11", 3.667635e-05)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=66.77)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 32.385), (5.55, 5.55, 34.385))
