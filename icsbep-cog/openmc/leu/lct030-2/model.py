"""
LCT030-2: 1495 U(3.5)O2 rods, 1.27 cm trianglur pitch, Hc=35.31cm
...
surf1 = openmc.ZPlane(surface_id=1, z0=35.31)
...
surf31_0 = openmc.Plane(a=0.8660250064, b=0.5000006884, c=0, d=22.5469610406)
surf31_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=22.5469300000)
surf31_2 = openmc.Plane(a=-0.8660250064, b=0.5000006884, c=0, d=22.5469610406)
surf31_3 = openmc.Plane(a=-0.8660250064, b=-0.5000006884, c=0, d=22.5469610406)
surf31_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=22.5469300000)
surf31_5 = openmc.Plane(a=0.8660250064, b=-0.5000006884, c=0, d=22.5469610406)
# 2nd prism with all fuel rods
# Prism 32: 6-sided polygon
surf32_0 = openmc.Plane(a=0.8660250041, b=0.5000006922, c=0, d=23.6468127377)
surf32_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=23.6467800000)
surf32_2 = openmc.Plane(a=-0.8660250041, b=0.5000006922, c=0, d=23.6468127377)
surf32_3 = openmc.Plane(a=-0.8660250041, b=-0.5000006922, c=0, d=23.6468127377)
surf32_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=23.6467800000)
surf32_5 = openmc.Plane(a=0.8660250041, b=-0.5000006922, c=0, d=23.6468127377)
# 3rd prism with all fuel rods
# Prism 33: 6-sided polygon
surf33_0 = openmc.Plane(a=0.8660250021, b=0.5000006957, c=0, d=24.7466644348)
surf33_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=24.7466300000)
surf33_2 = openmc.Plane(a=-0.8660250021, b=0.5000006957, c=0, d=24.7466644348)
surf33_3 = openmc.Plane(a=-0.8660250021, b=-0.5000006957, c=0, d=24.7466644348)
surf33_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=24.7466300000)
surf33_5 = openmc.Plane(a=0.8660250021, b=-0.5000006957, c=0, d=24.7466644348)
# 4th prism with all fuel rods
# Prism 34: 6-sided polygon
surf34_0 = openmc.Plane(a=0.8660250002, b=0.5000006990, c=0, d=25.8465161319)
surf34_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=25.8464800000)
surf34_2 = openmc.Plane(a=-0.8660250002, b=0.5000006990, c=0, d=25.8465161319)
surf34_3 = openmc.Plane(a=-0.8660250002, b=-0.5000006990, c=0, d=25.8465161319)
surf34_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=25.8464800000)
surf34_5 = openmc.Plane(a=0.8660250002, b=-0.5000006990, c=0, d=25.8465161319)
# 5th prism with 3 more rows of holes
# Prism 35: 6-sided polygon
surf35_0 = openmc.Plane(a=0.8660249955, b=0.5000007072, c=0, d=29.1460712232)
surf35_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=29.1460300000)
surf35_2 = openmc.Plane(a=-0.8660249955, b=0.5000007072, c=0, d=29.1460712232)
surf35_3 = openmc.Plane(a=-0.8660249955, b=-0.5000007072, c=0, d=29.1460712232)
surf35_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=29.1460300000)
surf35_5 = openmc.Plane(a=0.8660249955, b=-0.5000007072, c=0, d=29.1460712232)
surf321 = openmc.model.RectangularParallelepiped(-12.7, 12.7, -499.5, 499.5, -499.5, 499.5)
# (20 on each short side)
surf322 = openmc.model.RectangularParallelepiped(-12.7, 12.7, -499.5, 499.5, -499.5, 499.5)
surf323 = openmc.model.RectangularParallelepiped(-12.7, 12.7, -499.5, 499.5, -499.5, 499.5)
surf331 = openmc.model.RectangularParallelepiped(-8.255, 8.255, -499.5, 499.5, -499.5, 499.5)
# (13 on each short side)
surf332 = openmc.model.RectangularParallelepiped(-8.255, 8.255, -499.5, 499.5, -499.5, 499.5)
surf333 = openmc.model.RectangularParallelepiped(-8.255, 8.255, -499.5, 499.5, -499.5, 499.5)
surf341 = openmc.model.RectangularParallelepiped(-3.81, 3.81, -499.5, 499.5, -499.5, 499.5)
# (6 on each short side)
surf342 = openmc.model.RectangularParallelepiped(-3.81, 3.81, -499.5, 499.5, -499.5, 499.5)
surf343 = openmc.model.RectangularParallelepiped(-3.81, 3.81, -499.5, 499.5, -499.5, 499.5)
...
source.space = openmc.stats.Point((0.0, 0.0, 17.655))
