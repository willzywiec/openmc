"""
LCT041-4: CRISTO II Configuration D
...
mat5.add_element("Fe", 5.458100e-02)
mat5.add_element("Cr", 1.636700e-02)
mat5.add_element("Ni", 1.104400e-02)
mat5.add_element("Mn", 6.880000e-04)
mat5.add_element("Mo", 3.160000e-05)
mat5.add_element("C", 1.480000e-04)
mat5.add_element("Si", 7.640000e-04)
mat5.add_nuclide("B10", 9.717000e-04)
mat5.add_nuclide("B11", 3.886800e-03)
...
# Absorber plate
surf7 = openmc.model.RectangularParallelepiped(-99.6, 99.6, -99.6, 99.6, -499.95, 499.95)
# Reflector
