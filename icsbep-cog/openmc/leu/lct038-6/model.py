"""
LCT038-6: Two pairs of (18x13-2) arrays of U(4.738)O2 rods, 1.60 cm pitch, between 2.5cm concrete isolator, Hc=38.3cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=38.3)
# Lower grid plate
...
# Basket
surf10 = openmc.model.RectangularParallelepiped(-30.1, -1.299999999999999, 0.0, 28.8, -2.6000000000000014, 104.19999999999999)
# Basket
surf11 = openmc.model.RectangularParallelepiped(-30.1, -1.299999999999999, -28.8, 0.0, -2.6000000000000014, 104.19999999999999)
# Basket
surf12 = openmc.model.RectangularParallelepiped(1.299999999999999, 30.1, 0.0, 28.8, -2.6000000000000014, 104.19999999999999)
# Basket
surf13 = openmc.model.RectangularParallelepiped(1.299999999999999, 30.1, -28.8, 0.0, -2.6000000000000014, 104.19999999999999)
...
# Xo = (2.6/2) + 0.8 = 2.1
surf21 = openmc.ZCylinder(surface_id=21, x0=-2.1, y0=28.0, r=0.5)
# Xo = 17.5(1.6) + (2.6/2) = 29.3
surf22 = openmc.ZCylinder(surface_id=22, x0=-29.3, y0=0.8, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-29.3, y0=-0.8, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-2.1, y0=-28.0, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=2.1, y0=28.0, r=0.5)
surf26 = openmc.ZCylinder(surface_id=26, x0=29.3, y0=0.8, r=0.5)
surf27 = openmc.ZCylinder(surface_id=27, x0=29.3, y0=-0.8, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=2.1, y0=-28.0, r=0.5)
# Inner
surf31 = openmc.ZCylinder(surface_id=31, x0=-29.1675, y0=27.8675, r=0.7975)
# Outer
surf32 = openmc.ZCylinder(surface_id=32, x0=-29.1675, y0=27.8675, r=0.9325)
# Inner
surf33 = openmc.ZCylinder(surface_id=33, x0=-29.1675, y0=-27.8675, r=0.7975)
# Outer
surf34 = openmc.ZCylinder(surface_id=34, x0=-29.1675, y0=-27.8675, r=0.9325)
# Inner
surf35 = openmc.ZCylinder(surface_id=35, x0=29.1675, y0=27.8675, r=0.7975)
# Outer
surf36 = openmc.ZCylinder(surface_id=36, x0=29.1675, y0=27.8675, r=0.9325)
# Inner
surf37 = openmc.ZCylinder(surface_id=37, x0=29.1675, y0=-27.8675, r=0.7975)
# Outer
surf38 = openmc.ZCylinder(surface_id=38, x0=29.1675, y0=-27.8675, r=0.9325)
# Concrete
surf40 = openmc.model.RectangularParallelepiped(-1.05, 1.05, -34.8, 34.8, -2.3499999999999943, 97.25)
# Concrete
surf41 = openmc.model.RectangularParallelepiped(-1.25, 1.25, -34.8, 34.8, -1.0499999999999972, 95.95)
# Frame
surf42 = openmc.model.RectangularParallelepiped(-1.25, 1.25, -35.0, 35.0, -2.549999999999997, 97.45)
# PVC & paint
surf43 = openmc.model.RectangularParallelepiped(-1.3, 1.3, -35.05, 35.05, -2.5999999999999943, 97.5)
...
cell1.translation = (-15.7, 14.4, 0.0)
cell1.region = -surf10 & +surf21 & +surf22 & +surf32

# Assy
cell2 = openmc.Cell(cell_id=2, fill=universe3)
cell2.translation = (-15.7, -14.4, 0.0)
cell2.region = +surf10 & -surf11 & +surf23 & +surf24 & +surf34

# Assy
cell3 = openmc.Cell(cell_id=3, fill=universe4)
cell3.translation = (15.7, 14.4, 0.0)
cell3.region = -surf12 & +surf25 & +surf26 & +surf36

# Assy
cell4 = openmc.Cell(cell_id=4, fill=universe4)
cell4.translation = (15.7, -14.4, 0.0)
cell4.region = +surf12 & -surf13 & +surf27 & +surf28 & +surf38
...
cell24.region = +surf40 & +surf41 & +surf42 & -surf43 & +surf10 & +surf11 & +surf12 & +surf13
...
cell38.region = (+surf4 | -surf4_zmin | +surf4_zmax) & -surf5 & +surf6 & +surf7 & -surf8 & -surf9

# Water
cell46 = openmc.Cell(cell_id=46, fill=mat5)
cell46.region = (+surf4 | -surf4_zmin | +surf4_zmax) & -surf5 & +surf6 & +surf7 & -surf8 & -surf9
...
source.space = openmc.stats.Box((-7.9, -1.8, 18.15), (7.9, 1.8, 20.15))
