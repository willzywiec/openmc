"""
LCT003-12: 17x17 (two) + 17x15+1 + 17x15+2 arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water and 5.95 cm separation (SSC-2.35-000-071)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-31.603, 31.603, -30.761, 30.761, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-61.603, 61.603, -60.761, 60.761, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-2.975)
surf4 = openmc.XPlane(surface_id=4, x0=2.975)
surf5 = openmc.YPlane(surface_id=5, y0=-2.133)
surf6 = openmc.YPlane(surface_id=6, y0=3.817)
surf7 = openmc.YPlane(surface_id=7, y0=29.077)
surf8 = openmc.XPlane(surface_id=8, x0=-29.919)
surf9 = openmc.XPlane(surface_id=9, x0=28.235)
# Al-5052 lower plug
...
surf11_zmin = openmc.ZPlane(z0=-1.27)
surf11_zmax = openmc.ZPlane(z0=0.0)
surf12_zmin = openmc.ZPlane(z0=0.0)
surf12_zmax = openmc.ZPlane(z0=91.44)
surf13_zmin = openmc.ZPlane(z0=91.44)
surf13_zmax = openmc.ZPlane(z0=91.92)
surf14_zmin = openmc.ZPlane(z0=-1.27)
surf14_zmax = openmc.ZPlane(z0=91.92)
surf15_zmin = openmc.ZPlane(z0=91.92)
...
# Lattice 3: 17x17 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-14.314, -14.314]
...
cell1.translation = (-17.289, -16.447, 0.0)
cell1.region = -surf1 & -surf2 & -surf3 & -surf5
...
cell3.translation = (17.289, -16.447, 0.0)
...
cell5.translation = (-17.289, 16.447, 0.0)
cell5.region = -surf1 & -surf2 & -surf3 & +surf6 & -surf7

# CORE
cell6 = openmc.Cell(cell_id=6, fill=universe3)
cell6.translation = (-17.289, 16.447, 0.0)
cell6.region = -surf1 & -surf2 & -surf3 & +surf7 & -surf8

# EMPTY
cell7 = openmc.Cell(cell_id=7, fill=universe2)
cell7.region = -surf1 & -surf2 & -surf3 & +surf7 & +surf8

# EMPTY
cell8 = openmc.Cell(cell_id=8, fill=universe2)
cell8.region = -surf1 & -surf2 & +surf3 & -surf4 & +surf6

# CORE
cell9 = openmc.Cell(cell_id=9, fill=universe3)
cell9.translation = (17.289, 16.447, 0.0)
cell9.region = -surf1 & -surf2 & +surf4 & +surf6 & -surf7

# CORE
cell10 = openmc.Cell(cell_id=10, fill=universe3)
cell10.translation = (17.289, 16.447, 0.0)
cell10.region = -surf1 & -surf2 & +surf4 & +surf7 & +surf9

# EMPTY
cell11 = openmc.Cell(cell_id=11, fill=universe2)
cell11.region = -surf1 & -surf2 & +surf4 & +surf7 & -surf9
...
cell21.region = -surf2 & +surf17 & (+surf14 | -surf14_zmin | +surf14_zmax) & (+surf15 | -surf15_zmin | +surf15_zmax)
...
source.space = openmc.stats.Box((-18.289, -17.447, 44.72), (18.289, 17.447, 46.72))
