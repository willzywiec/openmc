"""
LEU-COMP-THERM-009-26: (15x8)-5.134cm-(0.652cm Zr-4)-5.134cm-(15x8)-5.134cm-(0.652cm Zr-4)-5.134cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
mat6.add_element("Zr", 4.095300e-02)
mat6.add_element("Fe", 1.431100e-04)
mat6.add_element("Sn", 4.809200e-04)
mat6.add_element("Cr", 9.515600e-05)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-68.07, 68.07, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-98.07, 98.07, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-29.97)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=29.97)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-24.836000000000002, -24.184, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(24.184, 24.836000000000002, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-49.02, 0.0, 0.0)
...
cell5.translation = (49.02, 0.0, 0.0)
...
source.space = openmc.stats.Box((-50.02, -2.27, 45.0375), (50.02, 2.27, 47.0375))
