"""
LEU-COMP-THERM-074-19: MIRTE-1 Experiment 4A-Ti-005; 10x10; Hc=69.898cm
...
mat8.add_element("Fe", 6.800800e-05)
mat8.add_element("Cr", 1.252200e-05)
mat8.add_element("Ti", 5.644300e-02)
mat8.add_element("Sn", 7.770100e-07)
mat8.add_element("C", 2.936300e-05)
mat8.add_element("N", 3.292700e-06)
mat8.add_nuclide("O16", 2.713000e-04)
mat8.add_element("Al", 5.127900e-06)
mat8.add_element("Si", 1.255700e-05)
mat8.add_element("P", 1.664200e-06)
mat8.add_element("Mn", 2.469100e-06)
mat8.add_element("Ni", 4.622400e-06)
...
lattice3.lower_left = [0.25125, 0.25125]
...
lattice4.lower_left = [-24.25125, 0.25125]
lattice4.pitch = [1.600000, 1.600000]
lattice4.universes = [
    [universe2, universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe2, universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe2, universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe2, universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe2, universe2, universe2, universe2, universe2, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
...
lattice5.lower_left = [-24.25125, -24.25125]
...
lattice6.lower_left = [0.25125, -24.25125]
...
# Air
cell28 = openmc.Cell(cell_id=28, fill=mat7)
...
source.space = openmc.stats.Box((-8.45, -8.45, 33.949), (8.45, 8.45, 35.949))
