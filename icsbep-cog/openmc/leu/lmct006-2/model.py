"""
LMCT006-2: STACY run 552 with U(5)O2 rods immersed in 49.76cm of U(6) uranyl nitrate and Gd solution with water reflection
...
mat1.add_nuclide("O16", 3.810400e-02)
mat1.add_nuclide("H1", 5.685600e-02)
mat1.add_element("N", 2.866300e-03)
mat1.add_element("Gd", 1.443800e-07)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=49.76)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 24.88))
