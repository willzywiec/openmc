"""
LEU-COMP-THERM-074-4: MIRTE-1 Experiment 1A-Glass-200; 18x18; Hc=77.937cm
...
mat8.add_element("Ba", 1.143800e-04)
mat8.add_nuclide("B11", 3.576900e-03)
mat8.add_nuclide("B10", 9.770600e-04)
mat8.add_element("Ce", 2.175200e-04)
mat8.add_element("K", 2.483500e-03)
mat8.add_element("Na", 4.281300e-03)
mat8.add_element("Cl", 4.731600e-06)
mat8.add_element("Sr", 2.001500e-06)
mat8.add_element("Mg", 1.513500e-06)
mat8.add_element("Zn", 2.810600e-07)
mat8.add_element("Pt", 3.908700e-09)
mat8.add_element("Pb", 3.128000e-07)
mat8.add_element("Cu", 9.599400e-08)
mat8.add_element("Fe", 3.413400e-07)
mat8.add_element("Li", 3.185800e-06)
mat8.add_element("Sb", 2.505100e-08)
mat8.add_element("Sn", 8.093300e-07)
mat8.add_element("Ti", 2.707300e-07)
mat8.add_nuclide("O16", 4.596000e-02)
mat8.add_element("F", 1.605400e-04)
mat8.add_element("S", 1.426600e-06)
mat8.add_element("Al", 2.373900e-05)
mat8.add_element("As", 2.035500e-08)
mat8.add_element("Ca", 1.065400e-06)
mat8.add_element("Zr", 1.588100e-07)
mat8.add_element("Si", 1.760300e-02)
...
cell3.region = -surf8 & +surf10 & +surf4 & -surf11

# Glass
cell4 = openmc.Cell(cell_id=4, fill=mat8)
cell4.region = -surf8 & +surf10 & +surf4 & +surf11 & -surf12

# Glass
cell5 = openmc.Cell(cell_id=5, fill=mat8)
cell5.region = -surf8 & +surf10 & +surf4 & +surf11 & +surf12 & -surf13

# Glass
cell6 = openmc.Cell(cell_id=6, fill=mat8)
cell6.region = -surf8 & +surf10 & +surf4 & +surf11 & +surf12 & +surf13 & -surf14

# Air
cell7 = openmc.Cell(cell_id=7, fill=mat7)
cell7.region = -surf8 & +surf10 & +surf4 & +surf11 & +surf12 & +surf13 & +surf14 & +surf9

# H2O
cell8 = openmc.Cell(cell_id=8, fill=mat6)
cell8.region = -surf8 & +surf10 & +surf4 & +surf11 & +surf12 & +surf13 & +surf14 & -surf9

# Air
cell19 = openmc.Cell(cell_id=19, fill=mat7)
cell19.region = +surf3 & +surf4 & +surf6 & +surf7 & -surf8 & +surf9

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell19])
...
source.space = openmc.stats.Box((-2.6, -2.6, 37.9685), (2.6, 2.6, 39.9685))
