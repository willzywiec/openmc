"""
LMT006-27: Bugey case 31; 41 type 1 tubes; 1 type 2 tube; 10.7cm pitch; Hw=59.25cm
...
# fuel tube and disk
surf107 = openmc.ZCylinder(surface_id=107, x0=-40.0, y0=24.2, r=4.85)
# Second row
...
# ditto/type2
surf154 = openmc.ZCylinder(surface_id=154, x0=13.5, y0=-7.9, r=4.75)
# ditto
...
# ditto
surf157 = openmc.ZCylinder(surface_id=157, x0=13.5, y0=24.2, r=4.85)
# Arbitrary
...
surf904 = openmc.ZPlane(surface_id=904, z0=59.25)
# Boundary condition
...
cell45.region = -surf900 & +surf903 & +surf904 & -surf999 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107
