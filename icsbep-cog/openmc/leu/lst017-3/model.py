"""
LST017-3: Unreflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=611 (Run 123)
...
mat1.add_nuclide("U234", 7.610200e-07)
mat1.add_nuclide("U235", 9.443700e-05)
mat1.add_nuclide("U236", 9.432000e-08)
mat1.add_nuclide("U238", 8.411600e-04)
mat1.add_nuclide("H1", 5.769600e-02)
mat1.add_element("N", 2.354700e-03)
mat1.add_nuclide("O16", 3.754400e-02)
...
# Hc
surf10 = openmc.ZPlane(surface_id=10, z0=60.25)
...
source.space = openmc.stats.Point((0.0, 0.0, 30.125))
