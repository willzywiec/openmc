"""
LEU-COMP-THERM-074-3: MIRTE-1 Experiment R1A-Water-200; 17x17; Hc=60.287cm
...
cell3.region = -surf8 & +surf10 & +surf4 & +surf9

# H2O
cell4 = openmc.Cell(cell_id=4, fill=mat6)
cell4.region = -surf8 & +surf10 & +surf4 & -surf9

# Air
cell15 = openmc.Cell(cell_id=15, fill=mat7)
cell15.region = +surf3 & +surf4 & +surf6 & +surf7 & -surf8 & +surf9

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell15])
...
source.space = openmc.stats.Point((0.0, 0.0, 30.1435))
