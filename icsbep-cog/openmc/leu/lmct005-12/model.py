"""
LMCT005-12: STACY run 526 with U(5)O2 rods immersed in 57.65cm of U(6) uranyl nitrate, Sm, Cs, Rh, and Eu solution with water reflection
...
mat1.add_nuclide("U234", 4.164600e-07)
mat1.add_nuclide("U235", 4.976100e-05)
mat1.add_nuclide("U236", 8.258400e-08)
mat1.add_nuclide("U238", 7.692600e-04)
mat1.add_nuclide("O16", 3.805100e-02)
mat1.add_nuclide("H1", 5.675700e-02)
mat1.add_element("N", 2.878700e-03)
mat1.add_element("Sm", 4.645900e-07)
mat1.add_element("Cs", 1.255100e-05)
mat1.add_element("Rh", 7.022500e-06)
mat1.add_element("Eu", 8.877000e-08)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=57.65)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 28.825))
