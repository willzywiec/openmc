"""
LMCT001-2: STACY run 380 with U(5)O2 rods immersed in 44.90cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 2.758400e-07)
mat1.add_nuclide("U235", 3.306900e-05)
mat1.add_nuclide("U236", 5.469900e-08)
mat1.add_nuclide("U238", 5.094000e-04)
mat1.add_nuclide("O16", 3.744600e-02)
mat1.add_nuclide("H1", 5.856000e-02)
mat1.add_element("N", 2.615200e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=44.90)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 22.45))
