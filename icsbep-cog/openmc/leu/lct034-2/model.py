"""
LCT034-2: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.155cm borated steel, 1.0cm water gap, Hc=36.54cm
...
# Basket
surf10 = openmc.model.RectangularParallelepiped(-29.455, -0.6549999999999994, 0.6549999999999994, 29.455, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf11 = openmc.model.RectangularParallelepiped(-29.61, -0.5, 0.5, 29.61, -2.200000000000003, 97.8)
# Basket
surf12 = openmc.model.RectangularParallelepiped(0.6549999999999994, 29.455, 0.6549999999999994, 29.455, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf13 = openmc.model.RectangularParallelepiped(0.5, 29.61, 0.5, 29.61, -2.200000000000003, 97.8)
# Basket
surf14 = openmc.model.RectangularParallelepiped(-29.455, -0.6549999999999994, -29.455, -0.6549999999999994, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf15 = openmc.model.RectangularParallelepiped(-29.61, -0.5, -29.61, -0.5, -2.200000000000003, 97.8)
# Basket
surf16 = openmc.model.RectangularParallelepiped(0.6549999999999994, 29.455, -29.455, -0.6549999999999994, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf17 = openmc.model.RectangularParallelepiped(0.5, 29.61, -29.61, -0.5, -2.200000000000003, 97.8)
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-28.5225, y0=28.5225, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-28.5225, y0=28.5225, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-1.455, y0=28.655, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-28.655, y0=1.455, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-1.455, y0=1.455, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=28.5225, y0=28.5225, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=28.5225, y0=28.5225, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=1.455, y0=28.655, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=28.655, y0=1.455, r=0.5)
...
cell1.translation = (-15.055, 15.055, 0.0)
...
cell4.translation = (15.055, 15.055, 0.0)
...
cell7.translation = (-15.055, -15.055, 0.0)
...
cell10.translation = (15.055, -15.055, 0.0)
...
source.space = openmc.stats.Box((-31.255, -31.255, 17.27), (31.255, 31.255, 19.27))
