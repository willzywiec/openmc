"""
LST004-6: Water-reflected 60-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=983 (Run 51)
...
mat1.add_nuclide("U234", 4.800400e-07)
mat1.add_nuclide("U235", 5.956900e-05)
mat1.add_nuclide("U236", 5.949500e-08)
mat1.add_nuclide("U238", 5.305900e-04)
mat1.add_nuclide("H1", 5.852800e-02)
mat1.add_element("N", 2.554400e-03)
mat1.add_nuclide("O16", 3.742200e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=95.50)
...
source.space = openmc.stats.Point((0.0, 0.0, 47.75))
