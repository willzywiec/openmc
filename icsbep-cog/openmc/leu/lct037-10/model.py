"""
LCT037-10: 12x36 array of 432 U(4.738)O2 fuel rods with 1.60 cm square pitch with 20.0/10.0/5.0 cm concrete screens
...
# Water
surf7 = openmc.ZPlane(surface_id=7, z0=47.98)
# Dummy
...
# Concrete
surf40 = openmc.model.RectangularParallelepiped(30.55, 34.95, -34.7, 34.7, -2.6500000000000057, 96.75)
# Concrete
surf41 = openmc.model.RectangularParallelepiped(30.25, 35.25, -34.7, 34.7, -0.45000000000000284, 94.55)
# Frame
surf42 = openmc.model.RectangularParallelepiped(30.25, 35.25, -35.0, 35.0, -2.950000000000003, 97.05)
# PVC & paint
surf43 = openmc.model.RectangularParallelepiped(30.2, 35.3, -35.05, 35.05, -3.0, 97.1)
# Tank wall
surf44 = openmc.model.RectangularParallelepiped(35.300000000000004, 35.6, -65.0, 65.0, -24.0, 116.0)
# AG3M pedestal plate
surf51 = openmc.model.RectangularParallelepiped(-150.4, 35.6, -93.0, 93.0, -4.0, -3.0)
# SST  pedestal plate
surf52 = openmc.model.RectangularParallelepiped(-150.4, 35.6, -93.0, 93.0, -6.5, -4.0)
# Entire problem
surf99 = openmc.model.RectangularParallelepiped(-49.199999999999996, 35.6, -65.05, 65.05, -24.0, 116.1, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-19.4, -1.8, 22.99), (0.19999999999999996, 1.8, 24.99))
