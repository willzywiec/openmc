"""
LCT061-10: 1309 U(4.5)O2 rods, 342 holes, 1.27 cm trianglur pitch, Hc=80.88m, 0.510 g(H3BO3)/L
...
# 0.510 g(H3BO3)/L solution
mat4 = openmc.Material(material_id=4)
mat4.set_density("sum")
mat4.add_nuclide("H1", 6.675900e-02)
mat4.add_nuclide("O16", 3.338700e-02)
mat4.add_nuclide("B10", 9.884400e-07)
mat4.add_nuclide("B11", 3.978600e-06)
...
surf4_zmax = openmc.ZPlane(z0=133.5, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-2.27, -2.09985, 39.44), (2.27, 2.09985, 41.44))
