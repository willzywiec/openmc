"""
LMCT007-9: STACY run 606 with U(5)O2 rods immersed in 56.09cm of U(6) uranyl nitrate, unreflected
...
mat1.add_nuclide("U235", 3.083800e-05)
mat1.add_nuclide("U236", 5.117800e-08)
mat1.add_nuclide("U238", 4.767200e-04)
mat1.add_nuclide("O16", 3.656200e-02)
mat1.add_nuclide("H1", 6.042100e-02)
mat1.add_element("N", 1.931100e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=56.09)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 28.045))
