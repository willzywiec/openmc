"""
LCT037-9: 12x36 array of 432 U(4.738)O2 fuel rods with 1.60 cm square pitch with 20.0/10.0/2.5 cm concrete screens
...
mat6.add_nuclide("H1", 6.674300e-02)
mat6.add_nuclide("O16", 3.337100e-02)
...
# Water
surf7 = openmc.ZPlane(surface_id=7, z0=48.07)
# Dummy
...
# Concrete
surf40 = openmc.model.RectangularParallelepiped(30.45, 32.55, -34.8, 34.8, -2.75, 96.85)
# Concrete
surf41 = openmc.model.RectangularParallelepiped(30.25, 32.75, -34.8, 34.8, -1.4500000000000028, 95.55)
# Frame
surf42 = openmc.model.RectangularParallelepiped(30.25, 32.75, -35.0, 35.0, -2.950000000000003, 97.05)
# PVC & paint
surf43 = openmc.model.RectangularParallelepiped(30.2, 32.8, -35.05, 35.05, -3.0, 97.1)
# Tank wall
surf44 = openmc.model.RectangularParallelepiped(32.800000000000004, 33.1, -65.0, 65.0, -24.0, 116.0)
# AG3M pedestal plate
surf51 = openmc.model.RectangularParallelepiped(-152.9, 33.1, -93.0, 93.0, -4.0, -3.0)
# SST  pedestal plate
surf52 = openmc.model.RectangularParallelepiped(-152.9, 33.1, -93.0, 93.0, -6.5, -4.0)
# Entire problem
surf99 = openmc.model.RectangularParallelepiped(-49.2, 33.099999999999994, -65.05, 65.05, -24.0, 116.1, boundary_type="vacuum")

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1099, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1100, z0=90.0)
surf2_zmin = openmc.ZPlane(surface_id=1101, z0=0.0)
surf2_zmax = openmc.ZPlane(surface_id=1102, z0=96.9)
surf3_zmin = openmc.ZPlane(surface_id=1103, z0=-1.27)
surf3_zmax = openmc.ZPlane(surface_id=1104, z0=98.2)
surf4_zmin = openmc.ZPlane(surface_id=1105, z0=-1.27)
surf4_zmax = openmc.ZPlane(surface_id=1106, z0=98.2)
...
cell19.region = -surf40

# Cncrt
cell20 = openmc.Cell(cell_id=20, fill=mat7)
cell20.region = +surf40 & -surf41

# XC10F
cell21 = openmc.Cell(cell_id=21, fill=mat9)
cell21.region = +surf40 & +surf41 & -surf42

# PVC
cell22 = openmc.Cell(cell_id=22, fill=mat8)
cell22.region = +surf40 & +surf41 & +surf42 & -surf43 & +surf33

# Tank
cell23 = openmc.Cell(cell_id=23, fill=mat4)
cell23.region = +surf33 & +surf43 & -surf44 & -surf99

# Pdstl
cell24 = openmc.Cell(cell_id=24, fill=mat3)
cell24.region = +surf44 & -surf51 & -surf99

# Pdstl
cell25 = openmc.Cell(cell_id=25, fill=mat4)
cell25.region = +surf44 & +surf51 & -surf52 & -surf99

# Air
cell26 = openmc.Cell(cell_id=26, fill=mat5)
cell26.region = +surf7 & +surf11 & +surf23 & +surf33 & +surf43 & +surf44 & +surf51 & +surf52 & -surf99

# Water
cell27 = openmc.Cell(cell_id=27, fill=mat6)
cell27.region = -surf7 & +surf11 & +surf23 & +surf33 & +surf43 & +surf44 & +surf51 & +surf52 & -surf99

# Water
cell37 = openmc.Cell(cell_id=37, fill=mat6)
cell37.region = (+surf4 | -surf4_zmin | +surf4_zmax) & +surf5 & +surf6 & -surf7 & -surf9

# Water
cell44 = openmc.Cell(cell_id=44, fill=mat6)
cell44.region = (+surf4 | -surf4_zmin | +surf4_zmax) & +surf5 & +surf6 & -surf7 & -surf9

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell15, cell16, cell17, cell18, cell19, cell20, cell21, cell22, cell23, cell24, cell25, cell26, cell27, cell37, cell44])
...
source.space = openmc.stats.Box((-19.4, -1.8, 23.035), (0.19999999999999996, 1.8, 25.035))
