"""
LST024-4: STACY two slabs of 10% 235U uranyl nitrate with polyethylene (P100) isolator
...
mat1.add_nuclide("U234", 6.099300e-07)
mat1.add_nuclide("U235", 7.568800e-05)
mat1.add_nuclide("U236", 7.559300e-08)
mat1.add_nuclide("U238", 6.741600e-04)
mat1.add_nuclide("H1", 5.935500e-02)
mat1.add_element("N", 2.006900e-03)
...
# Critical height
surf5 = openmc.ZPlane(surface_id=5, z0=67.84)
# Polyethylene
surf6 = openmc.model.RectangularParallelepiped(-5.025, 5.025, -35.7, 35.7, 0.0, 150.6)
# SST frame
surf7 = openmc.model.RectangularParallelepiped(-5.025, 5.025, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover
surf8 = openmc.model.RectangularParallelepiped(-5.835, 5.835, -38.7, 38.7, -3.0, 153.6)
# BCD
surf10 = openmc.model.RectangularParallelepiped(-44.542, 44.542, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
# LHS SST tank
surf11 = openmc.model.RectangularParallelepiped(-44.542, -5.920999999999999, -36.6005, 36.6005, -2.060999999999993, 152.183)
# RHS SST tank
surf12 = openmc.model.RectangularParallelepiped(5.920999999999999, 44.542, -36.6005, 36.6005, -2.060999999999993, 152.183)
...
cell1.translation = (-25.2315, 0.0, 0.0)
...
cell3.translation = (25.2315, 0.0, 0.0)
...
source.space = openmc.stats.Box((-26.2315, -1.0, 32.92), (26.2315, 1.0, 34.92))
