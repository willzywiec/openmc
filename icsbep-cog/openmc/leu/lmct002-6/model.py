...
surf1 = openmc.ZCylinder(surface_id=1, x0=145.4, y0=146.0, r=29.5)
# Zircaloy middle grid plate
surf2 = openmc.ZCylinder(surface_id=2, x0=105.0, y0=105.6, r=29.5)
# Zircaloy lower  grid plate
surf3 = openmc.ZCylinder(surface_id=3, x0=5.0, y0=5.6, r=29.5)
# SS304L tank, inner
...
cell2.region = -surf7 & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7) & +surf21 & +surf22

# Alles
cell3 = openmc.Cell(cell_id=3, fill=universe1)
cell3.region = -surf7 & (+surf20_0 | +surf20_1 | +surf20_2 | +surf20_3 | +surf20_4 | +surf20_5 | +surf20_6 | +surf20_7)
...
cell26.region = +surf15 & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7)

# Alles
cell30 = openmc.Cell(cell_id=30, fill=universe1)
cell30.region = +surf32 & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7)

# Soln
cell37 = openmc.Cell(cell_id=37, fill=mat1)
cell37.region = -surf10 & +surf13 & +surf14 & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7)
...
cell44.region = -surf10 & +surf31 & (-surf20_0 & -surf20_1 & -surf20_2 & -surf20_3 & -surf20_4 & -surf20_5 & -surf20_6 & -surf20_7)
