"""
LMCT002-6: STACY run 400 with U(5)O2 rods immersed in 66.39cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 6.587100e-08)
mat1.add_nuclide("U235", 7.897100e-06)
mat1.add_nuclide("U236", 1.306200e-08)
mat1.add_nuclide("U238", 1.216500e-04)
mat1.add_nuclide("O16", 3.587000e-02)
mat1.add_nuclide("H1", 6.204800e-02)
mat1.add_element("N", 1.782800e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=66.39)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 33.195))
