"""
LST011-11: Air reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=955 (Run 469)
...
mat1.add_nuclide("U234", 4.999500e-07)
mat1.add_nuclide("U235", 5.983800e-05)
mat1.add_nuclide("U236", 9.914100e-08)
mat1.add_nuclide("U238", 9.233900e-04)
mat1.add_nuclide("H1", 5.711800e-02)
mat1.add_element("N", 2.581900e-03)
mat1.add_nuclide("O16", 3.796500e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=74.92)
...
source.space = openmc.stats.Point((0.0, 0.0, 37.46))
