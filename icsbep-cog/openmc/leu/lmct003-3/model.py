"""
LMCT003-3: STACY run 417 with U(5)O2 rods immersed in 44.84cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 3.740000e-07)
mat1.add_nuclide("U235", 4.461400e-05)
mat1.add_nuclide("U236", 7.416500e-08)
mat1.add_nuclide("U238", 6.909100e-04)
mat1.add_nuclide("O16", 3.776400e-02)
mat1.add_nuclide("H1", 5.776100e-02)
mat1.add_element("N", 2.670300e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=44.84)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 22.42))
