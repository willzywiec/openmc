"""
LMCT003-5: STACY run 423 with U(5)O2 rods immersed in 47.56cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 2.580800e-07)
mat1.add_nuclide("U235", 3.078600e-05)
mat1.add_nuclide("U236", 5.117800e-08)
mat1.add_nuclide("U238", 4.767700e-04)
mat1.add_nuclide("O16", 3.692500e-02)
mat1.add_nuclide("H1", 5.973300e-02)
mat1.add_element("N", 2.214100e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=47.56)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 23.78))
