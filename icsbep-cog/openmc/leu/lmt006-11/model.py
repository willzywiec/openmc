"""
LMT006-11: Case 11; Bugey 4; detailed; 42 type 1 tubes; 11.2cm pitch; Hw=48.41cm; no additional plate
...
# Critical water height, Hw=48.41-0.4=48.01 (absolute)
surf904 = openmc.ZPlane(surface_id=904, z0=48.01)
# Critical water height (relative to tube)
surf905 = openmc.ZPlane(surface_id=905, z0=48.41)
# Arbitrary
...
cell48.region = -surf901 & -surf999

# Air
cell56 = openmc.Cell(cell_id=56, fill=mat5)
cell56.region = +surf4 & (+surf5 | -surf5_zmin | +surf5_zmax) & (+surf6 | -surf6_zmin | +surf6_zmax) & +surf905

# Water
cell64 = openmc.Cell(cell_id=64, fill=mat2)
cell64.region = -surf904 & -surf999

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell15, cell16, cell17, cell18, cell19, cell20, cell21, cell22, cell23, cell24, cell25, cell26, cell27, cell28, cell29, cell30, cell31, cell32, cell33, cell34, cell35, cell36, cell37, cell38, cell39, cell40, cell41, cell42, cell43, cell44, cell45, cell46, cell47, cell48, cell56, cell64])
...
source.space = openmc.stats.Box((-11.9, -9.0, 23.2), (-9.9, -3.8, 25.2))
