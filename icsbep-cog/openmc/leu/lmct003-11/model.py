"""
LMCT003-11: STACY run 420 with U(5)O2 rods immersed in 43.05cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 3.244700e-07)
mat1.add_nuclide("U235", 3.870500e-05)
mat1.add_nuclide("U236", 6.434200e-08)
mat1.add_nuclide("U238", 5.994000e-04)
mat1.add_nuclide("O16", 3.740500e-02)
mat1.add_nuclide("H1", 5.854200e-02)
mat1.add_element("N", 2.487400e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=43.05)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 21.525))
