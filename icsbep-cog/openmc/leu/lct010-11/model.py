"""
LEU-COMP-THERM-010-11: (13x8)-12.995cm-(13x8)-12.995cm-(13x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; Steel walls; 1.321 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -29.331, -11.480999999999998, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 11.480999999999998, 29.331, -20.0625, 101.8375)
...
cell1.translation = (-46.015, 0.0, 0.0)
...
cell5.translation = (46.015, 0.0, 0.0)
...
source.space = openmc.stats.Box((-47.015, -2.27, 45.0375), (47.015, 2.27, 47.0375))
