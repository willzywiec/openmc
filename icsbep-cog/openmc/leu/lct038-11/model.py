"""
LCT038-11: Two pairs of (18x12-2) arrays of U(4.738)O2 rods, 1.60 cm pitch, between 15.0cm concrete isolator, Hc=75.0cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=75.0)
# Lower grid plate
...
source.space = openmc.stats.Box((-26.95, -1.8, 36.5), (25.35, 1.8, 38.5))
