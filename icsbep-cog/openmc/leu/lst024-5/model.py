"""
LST024-5: STACY two slabs of 10% 235U uranyl nitrate with polyethylene (P150) isolator
...
mat1.add_nuclide("U234", 6.111600e-07)
mat1.add_nuclide("U235", 7.584100e-05)
mat1.add_nuclide("U236", 7.574600e-08)
mat1.add_nuclide("U238", 6.755200e-04)
mat1.add_nuclide("H1", 5.934200e-02)
mat1.add_element("N", 2.010000e-03)
...
# Critical height
surf5 = openmc.ZPlane(surface_id=5, z0=68.94)
# Polyethylene
...
# BCD
surf10 = openmc.model.RectangularParallelepiped(-47.15, 47.15, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
# LHS SST tank
surf11 = openmc.model.RectangularParallelepiped(-47.150000000000006, -8.529, -36.6005, 36.6005, -2.060999999999993, 152.183)
# RHS SST tank
surf12 = openmc.model.RectangularParallelepiped(8.529, 47.150000000000006, -36.6005, 36.6005, -2.060999999999993, 152.183)
...
cell1.translation = (-27.8395, 0.0, 0.0)
...
cell3.translation = (27.8395, 0.0, 0.0)
...
source.space = openmc.stats.Box((-28.8395, -1.0, 33.47), (28.8395, 1.0, 35.47))
