"""
LCT029-5: 22x22 array of 484 U(4.738)O2 fuel rods with 1.60 cm square pitch with two, 0.4890cm thick, Hf plates
...
surf5 = openmc.ZPlane(surface_id=5, z0=37.94)
# Lattice core boundary
surf6 = openmc.model.RectangularParallelepiped(-17.6, 17.6, -17.6, 17.6, -499.95, 499.95)
# Hafnium plate
surf7 = openmc.model.RectangularParallelepiped(-24.75, 24.75, 17.6, 18.089, 0.0, 50.0)
# Hafnium plate
surf8 = openmc.model.RectangularParallelepiped(-24.75, 24.75, -18.089, -17.6, 0.0, 50.0)
# UO2
...
source.space = openmc.stats.Box((-1.8, -1.8, 17.97), (1.8, 1.8, 19.97))
