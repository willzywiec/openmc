"""
LEU-COMP-THERM-010-6: (12x8)-14.195cm-(12x8)-14.195cm-(12x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; U walls; 1.956 gap
...
mat6.add_nuclide("U235", 9.522000e-05)
mat6.add_nuclide("U238", 4.715100e-02)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-59.915, 59.915, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-106.65, 106.65, -40.66, 40.66, -20.0625, 109.4975, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-29.435)
surf4 = openmc.XPlane(surface_id=4, x0=-15.24)
surf5 = openmc.XPlane(surface_id=5, x0=15.24)
surf6 = openmc.XPlane(surface_id=6, x0=29.435)
# Rubber
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-76.15, 76.15, -19.766000000000002, -12.116, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-76.15, 76.15, 12.116, 19.766000000000002, -20.0625, 101.8375)
...
# Lattice 3: 12x8 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-15.24, -10.16]
...
cell1.translation = (-44.675, 0.0, 0.0)
...
cell5.translation = (44.675, 0.0, 0.0)
...
source.space = openmc.stats.Box((-44.405, -2.27, 45.0375), (44.405, 2.27, 47.0375))
