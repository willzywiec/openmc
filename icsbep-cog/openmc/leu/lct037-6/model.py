"""
LCT037-6: 12x36 array of 432 U(4.738)O2 fuel rods with 1.60 cm square pitch with 20.0/2.5 cm concrete screens
...
# Water
surf7 = openmc.ZPlane(surface_id=7, z0=48.57)
# Dummy
...
# Concrete
surf30 = openmc.model.RectangularParallelepiped(20.349999999999998, 22.45, -34.8, 34.8, -2.75, 96.85)
# Concrete
surf31 = openmc.model.RectangularParallelepiped(20.15, 22.65, -34.8, 34.8, -1.4500000000000028, 95.55)
# Frame
surf32 = openmc.model.RectangularParallelepiped(20.15, 22.65, -35.0, 35.0, -2.950000000000003, 97.05)
# PVC & paint
surf33 = openmc.model.RectangularParallelepiped(20.099999999999998, 22.7, -35.05, 35.05, -3.0, 97.1)
# Tank wall
surf34 = openmc.model.RectangularParallelepiped(22.700000000000003, 23.0, -65.0, 65.0, -24.0, 116.0)
# AG3M pedestal plate
surf41 = openmc.model.RectangularParallelepiped(-163.0, 23.0, -93.0, 93.0, -4.0, -3.0)
# SST  pedestal plate
surf42 = openmc.model.RectangularParallelepiped(-163.0, 23.0, -93.0, 93.0, -6.5, -4.0)
# Entire problem
surf99 = openmc.model.RectangularParallelepiped(-49.2, 23.0, -65.05, 65.05, -24.0, 116.1, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-19.4, -1.8, 23.285), (0.19999999999999996, 1.8, 25.285))
