"""
LCT062-2: 18x18 array of U(2.6)O2 rods on 1.9558cm pitch with 0.2910cm SST plate, no gap (TCA)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=89.78)
# Array boundary
...
surf31 = openmc.model.RectangularParallelepiped(17.6022, 17.893199999999997, -22.5, 22.5, 0.37000000000000455, 150.37)
...
source.space = openmc.stats.Box((-1.98, -1.98, 43.89), (1.98, 1.98, 45.89))
