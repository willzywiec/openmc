"""
LMCT007-10: STACY run 610 with U(5)O2 rods immersed in 66.90cm of U(6) uranyl nitrate, unreflected
...
mat1.add_nuclide("U235", 2.332000e-05)
mat1.add_nuclide("U236", 3.870200e-08)
mat1.add_nuclide("U238", 3.605100e-04)
mat1.add_nuclide("O16", 3.608900e-02)
mat1.add_nuclide("H1", 6.142600e-02)
mat1.add_element("N", 1.689500e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=66.90)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 33.45))
