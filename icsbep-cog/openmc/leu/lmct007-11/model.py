"""
LMCT007-11: STACY run 620 with U(5)O2 rods immersed in 80.35cm of U(6) uranyl nitrate, unreflected
...
mat1.add_nuclide("U234", 1.542600e-07)
mat1.add_nuclide("U235", 1.843200e-05)
mat1.add_nuclide("U236", 3.058900e-08)
mat1.add_nuclide("U238", 2.849400e-04)
mat1.add_nuclide("O16", 3.579500e-02)
mat1.add_nuclide("H1", 6.209500e-02)
mat1.add_element("N", 1.534500e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=80.35)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 40.175))
