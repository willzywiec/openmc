"""
LCT049-5S: Simplified model of R2-2R(4,5) with H/U=2.5 and d=4.23cm
...
cell1.region = +surf11 & -surf18 & +surf21 & -surf27 & +surf31 & -surf38
...
source.space = openmc.stats.Box((-13.375, -11.26, -1.0), (13.375, 11.26, 1.0))
