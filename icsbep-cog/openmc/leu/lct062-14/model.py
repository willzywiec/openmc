"""
LCT062-14: 18x18 array of U(2.6)O2 rods on 1.9558cm pitch with 0.6194cm SST-0.98B plate, 0.9779cm gap (TCA)
...
mat6.add_element("C", 3.918300e-05)
mat6.add_element("Si", 7.289300e-04)
mat6.add_element("Mn", 1.428500e-03)
mat6.add_element("P", 1.709400e-05)
mat6.add_element("S", 5.503100e-06)
mat6.add_element("Cr", 1.751200e-02)
mat6.add_element("Ni", 8.149200e-03)
mat6.add_element("Mo", 2.943300e-04)
mat6.add_nuclide("B10", 8.511300e-04)
mat6.add_nuclide("B11", 3.425900e-03)
mat6.add_element("Fe", 5.627600e-02)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=104.77)
# Array boundary
...
surf31 = openmc.model.RectangularParallelepiped(18.5801, 19.1995, -22.5, 22.5, 0.37000000000000455, 150.37)

# Z-plane surfaces for bounded cylinders
surf11_zmin = openmc.ZPlane(z0=0.0)
surf11_zmax = openmc.ZPlane(z0=144.15)
surf12_zmin = openmc.ZPlane(z0=0.0)
surf12_zmax = openmc.ZPlane(z0=146.69)
surf13_zmin = openmc.ZPlane(z0=-16.83)
surf13_zmax = openmc.ZPlane(z0=170.73)
surf14_zmin = openmc.ZPlane(z0=-16.84)
surf14_zmax = openmc.ZPlane(z0=170.73)
surf21_zmin = openmc.ZPlane(z0=0.0)
surf21_zmax = openmc.ZPlane(z0=145.415)
surf22_zmin = openmc.ZPlane(z0=-16.83)
surf22_zmax = openmc.ZPlane(z0=170.73)
...
source.space = openmc.stats.Box((-1.98, -1.98, 51.385), (1.98, 1.98, 53.385))
