"""
LCT040-2: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.155cm borated steel, 2.0cm water gap, Hc=33.04cm, 0.1 cm gap between lead reflector
...
surf5 = openmc.ZPlane(surface_id=5, z0=33.04)
# Lower grid plate
...
# Inner: 2(0.1)+4(0.155)+18(2)(1.6)+2.0 = 60.42
surf41 = openmc.model.RectangularParallelepiped(-30.21, 30.21, -30.21, 30.21, -2.200000000000003, 92.8)
# Outer: 2(10.0) + 60.42 = 80.42
surf42 = openmc.model.RectangularParallelepiped(-40.21, 40.21, -40.21, 40.21, -2.200000000000003, 92.8)
...
source.space = openmc.stats.Box((-30.155, -30.155, 15.52), (30.155, 30.155, 17.52))
