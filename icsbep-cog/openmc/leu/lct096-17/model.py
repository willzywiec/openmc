"""
LEU-COMP-THERM-096-17: 45x45 array of 1600 fuel rods with 0.8001 cm square pitch; Hc = 35.31 cm
...
surf11 = openmc.ZCylinder(surface_id=11, r=46.8)
# Critical water height, Hc
surf13 = openmc.ZPlane(surface_id=13, z0=35.31)
...
source.space = openmc.stats.Box((-3.4, -3.4, 16.655), (4.2, 4.2, 18.655))
