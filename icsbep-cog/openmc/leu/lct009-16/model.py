"""
LEU-COMP-THERM-009-16: (15x8)-2.95045cm-(0.0291cm Cd)-2.95045cm-(15x8)-2.95045cm-(0.0291cm Cd)-2.95045cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-63.08, 63.08, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-93.08, 93.08, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-24.98)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=24.98)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-22.02955, -22.00045, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(22.00045, 22.02955, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-44.03, 0.0, 0.0)
...
cell5.translation = (44.03, 0.0, 0.0)
...
source.space = openmc.stats.Box((-45.03, -2.27, 45.0375), (45.03, 2.27, 47.0375))
