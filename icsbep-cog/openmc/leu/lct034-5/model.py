"""
LCT034-5: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.155cm borated steel, 4.0cm water gap, Hc=53.87cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=53.87)
# Lower grid plate
...
# Basket
surf10 = openmc.model.RectangularParallelepiped(-30.955, -2.1549999999999994, 2.1549999999999994, 30.955, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf11 = openmc.model.RectangularParallelepiped(-31.11, -2.0, 2.0, 31.11, -2.200000000000003, 97.8)
# Basket
surf12 = openmc.model.RectangularParallelepiped(2.1549999999999994, 30.955, 2.1549999999999994, 30.955, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf13 = openmc.model.RectangularParallelepiped(2.0, 31.11, 2.0, 31.11, -2.200000000000003, 97.8)
# Basket
surf14 = openmc.model.RectangularParallelepiped(-30.955, -2.1549999999999994, -30.955, -2.1549999999999994, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf15 = openmc.model.RectangularParallelepiped(-31.11, -2.0, -31.11, -2.0, -2.200000000000003, 97.8)
# Basket
surf16 = openmc.model.RectangularParallelepiped(2.1549999999999994, 30.955, -30.955, -2.1549999999999994, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf17 = openmc.model.RectangularParallelepiped(2.0, 31.11, -31.11, -2.0, -2.200000000000003, 97.8)
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-30.0225, y0=30.0225, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-30.0225, y0=30.0225, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-2.955, y0=30.155, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-30.155, y0=2.955, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-2.955, y0=2.955, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=30.0225, y0=30.0225, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=30.0225, y0=30.0225, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=2.955, y0=30.155, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=30.155, y0=2.955, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=2.955, y0=2.955, r=0.5)
...
cell1.translation = (-16.555, 16.555, 0.0)
...
cell4.translation = (16.555, 16.555, 0.0)
...
cell7.translation = (-16.555, -16.555, 0.0)
...
cell10.translation = (16.555, -16.555, 0.0)
...
source.space = openmc.stats.Box((-31.155, -31.155, 25.935), (31.155, 31.155, 27.935))
