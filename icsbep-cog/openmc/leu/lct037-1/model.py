"""
LCT037-1: 12x36 array of 432 U(4.738)O2 fuel rods with 1.60 cm square pitch with 2.5 cm concrete screen
...
# Water
surf7 = openmc.ZPlane(surface_id=7, z0=83.47)
# Dummy
...
# Concrete
surf20 = openmc.model.RectangularParallelepiped(0.25, 2.35, -34.8, 34.8, -2.75, 96.85)
# Concrete
surf21 = openmc.model.RectangularParallelepiped(0.050000000000000044, 2.55, -34.8, 34.8, -1.4500000000000028, 95.55)
# Frame
surf22 = openmc.model.RectangularParallelepiped(0.050000000000000044, 2.55, -35.0, 35.0, -2.950000000000003, 97.05)
# PVC & paint
surf23 = openmc.model.RectangularParallelepiped(0.0, 2.6, -35.05, 35.05, -3.0, 97.1)
# Tank wall
surf24 = openmc.model.RectangularParallelepiped(2.6, 2.9, -65.0, 65.0, -24.0, 116.0)
# AG3M pedestal plate
surf31 = openmc.model.RectangularParallelepiped(-183.4, 2.5999999999999943, -93.0, 93.0, -4.0, -3.0)
# SST  pedestal plate
surf32 = openmc.model.RectangularParallelepiped(-183.4, 2.5999999999999943, -93.0, 93.0, -6.5, -4.0)
# Entire problem
surf99 = openmc.model.RectangularParallelepiped(-49.2, 2.900000000000002, -65.05, 65.05, -24.0, 116.1, boundary_type="vacuum")
...
cell29.region = (+surf4 | -surf4_zmin | +surf4_zmax) & +surf5 & +surf6 & -surf7 & -surf9

# Water
cell36 = openmc.Cell(cell_id=36, fill=mat6)
cell36.region = (+surf4 | -surf4_zmin | +surf4_zmax) & +surf5 & +surf6 & -surf7 & -surf9
...
source.space = openmc.stats.Box((-19.4, -1.8, 40.735), (0.19999999999999996, 1.8, 42.735))
