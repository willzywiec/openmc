"""
LMT006-5: Case 5; Bugey 9; detailed; 42 type 1 tubes; 10.7cm pitch; Hw=53.18cm
...
# Second row
surf111 = openmc.ZCylinder(surface_id=111, x0=-30.73353, y0=-34.65, r=4.85)
# ditto
surf112 = openmc.ZCylinder(surface_id=112, x0=-30.73353, y0=-23.95, r=4.85)
# ditto
surf113 = openmc.ZCylinder(surface_id=113, x0=-30.73353, y0=-13.25, r=4.85)
# ditto
surf114 = openmc.ZCylinder(surface_id=114, x0=-30.73353, y0=-2.55, r=4.85)
# ditto
surf115 = openmc.ZCylinder(surface_id=115, x0=-30.73353, y0=8.15, r=4.85)
# ditto
surf116 = openmc.ZCylinder(surface_id=116, x0=-30.73353, y0=18.85, r=4.85)
# Third row
surf121 = openmc.ZCylinder(surface_id=121, x0=-21.46706, y0=-40.0, r=4.85)
# ditto
surf122 = openmc.ZCylinder(surface_id=122, x0=-21.46706, y0=-29.3, r=4.85)
# ditto
surf123 = openmc.ZCylinder(surface_id=123, x0=-21.46706, y0=-18.6, r=4.85)
# ditto
surf124 = openmc.ZCylinder(surface_id=124, x0=-21.46706, y0=-7.9, r=4.85)
# ditto
surf125 = openmc.ZCylinder(surface_id=125, x0=-21.46706, y0=2.8, r=4.85)
# ditto
surf126 = openmc.ZCylinder(surface_id=126, x0=-21.46706, y0=13.5, r=4.85)
# Fourth row
surf131 = openmc.ZCylinder(surface_id=131, x0=-12.20058, y0=-34.65, r=4.85)
# ditto
surf132 = openmc.ZCylinder(surface_id=132, x0=-12.20058, y0=-23.95, r=4.85)
# ditto
surf133 = openmc.ZCylinder(surface_id=133, x0=-12.20058, y0=-13.25, r=4.85)
# ditto
surf134 = openmc.ZCylinder(surface_id=134, x0=-12.20058, y0=-2.55, r=4.85)
# ditto
surf135 = openmc.ZCylinder(surface_id=135, x0=-12.20058, y0=8.15, r=4.85)
# ditto
surf136 = openmc.ZCylinder(surface_id=136, x0=-12.20058, y0=18.85, r=4.85)
# Fifth row
surf141 = openmc.ZCylinder(surface_id=141, x0=-2.93411, y0=-40.0, r=4.85)
# ditto
surf142 = openmc.ZCylinder(surface_id=142, x0=-2.93411, y0=-29.3, r=4.85)
# ditto
surf143 = openmc.ZCylinder(surface_id=143, x0=-2.93411, y0=-18.6, r=4.85)
# ditto
surf144 = openmc.ZCylinder(surface_id=144, x0=-2.93411, y0=-7.9, r=4.85)
# ditto
surf145 = openmc.ZCylinder(surface_id=145, x0=-2.93411, y0=2.8, r=4.85)
# ditto
surf146 = openmc.ZCylinder(surface_id=146, x0=-2.93411, y0=13.5, r=4.85)
# Sixth row
surf151 = openmc.ZCylinder(surface_id=151, x0=6.33236, y0=-34.65, r=4.85)
# ditto
surf152 = openmc.ZCylinder(surface_id=152, x0=6.33236, y0=-23.95, r=4.85)
# ditto
surf153 = openmc.ZCylinder(surface_id=153, x0=6.33236, y0=-13.25, r=4.85)
# ditto
surf154 = openmc.ZCylinder(surface_id=154, x0=6.33236, y0=-2.55, r=4.85)
# ditto
surf155 = openmc.ZCylinder(surface_id=155, x0=6.33236, y0=8.15, r=4.85)
# ditto
surf156 = openmc.ZCylinder(surface_id=156, x0=6.33236, y0=18.85, r=4.85)
# Seventh row
surf161 = openmc.ZCylinder(surface_id=161, x0=15.59883, y0=-40.0, r=4.85)
# ditto
surf162 = openmc.ZCylinder(surface_id=162, x0=15.59883, y0=-29.3, r=4.85)
# ditto
surf163 = openmc.ZCylinder(surface_id=163, x0=15.59883, y0=-18.6, r=4.85)
# ditto
surf164 = openmc.ZCylinder(surface_id=164, x0=15.59883, y0=-7.9, r=4.85)
# ditto
surf165 = openmc.ZCylinder(surface_id=165, x0=15.59883, y0=2.8, r=4.85)
# ditto
surf166 = openmc.ZCylinder(surface_id=166, x0=15.59883, y0=13.5, r=4.85)
...
surf904 = openmc.ZPlane(surface_id=904, z0=53.18)
...
source.space = openmc.stats.Box((-13.2, -18.25, 25.59), (-11.2, 3.55, 27.59))
