"""
LEU-COMP-THERM-074-22: MIRTE-1 Experiment 4A-Fe-020; 12x10; Hc=84.246cm
...
mat8.add_element("C", 5.074200e-04)
mat8.add_element("S", 1.608000e-05)
mat8.add_element("P", 2.421800e-05)
mat8.add_element("Si", 8.346300e-06)
mat8.add_element("Mn", 8.448300e-04)
mat8.add_element("Al", 4.170200e-05)
mat8.add_element("Cu", 3.688800e-06)
mat8.add_element("Ni", 3.195200e-06)
mat8.add_element("Cr", 2.704900e-06)
mat8.add_nuclide("O16", 4.395400e-05)
mat8.add_element("H", 9.302900e-06)
mat8.add_element("Fe", 8.293700e-02)
...
lattice3.lower_left = [1.00195, 1.00195]
...
lattice4.lower_left = [-25.00195, 1.00195]
...
lattice5.lower_left = [-25.00195, -25.00195]
...
lattice6.lower_left = [1.00195, -25.00195]
...
source.space = openmc.stats.Box((-9.2, -9.2, 41.123), (9.2, 9.2, 43.123))
