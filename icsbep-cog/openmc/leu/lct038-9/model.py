"""
LCT038-9: Two pairs of (18x12-2) arrays of U(4.738)O2 rods, 1.60 cm pitch, between 10.0cm concrete isolator, Hc=64.2cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=64.2)
# Lower grid plate
...
# Xo = (10.1/2) + 0.8 = 5.85
surf21 = openmc.ZCylinder(surface_id=21, x0=-5.85, y0=28.0, r=0.5)
# Xo = 17.5(1.6) + (10.1/2) = 33.05
surf22 = openmc.ZCylinder(surface_id=22, x0=-33.05, y0=0.8, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-33.05, y0=-0.8, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-5.85, y0=-28.0, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=5.85, y0=28.0, r=0.5)
surf26 = openmc.ZCylinder(surface_id=26, x0=33.05, y0=0.8, r=0.5)
surf27 = openmc.ZCylinder(surface_id=27, x0=33.05, y0=-0.8, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=5.85, y0=-28.0, r=0.5)
# Inner
surf31 = openmc.ZCylinder(surface_id=31, x0=-32.9175, y0=27.8675, r=0.7975)
# Outer
surf32 = openmc.ZCylinder(surface_id=32, x0=-32.9175, y0=27.8675, r=0.9325)
# Inner
surf33 = openmc.ZCylinder(surface_id=33, x0=-32.9175, y0=-27.8675, r=0.7975)
# Outer
surf34 = openmc.ZCylinder(surface_id=34, x0=-32.9175, y0=-27.8675, r=0.9325)
# Inner
surf35 = openmc.ZCylinder(surface_id=35, x0=32.9175, y0=27.8675, r=0.7975)
# Outer
surf36 = openmc.ZCylinder(surface_id=36, x0=32.9175, y0=27.8675, r=0.9325)
# Inner
surf37 = openmc.ZCylinder(surface_id=37, x0=32.9175, y0=-27.8675, r=0.7975)
# Outer
surf38 = openmc.ZCylinder(surface_id=38, x0=32.9175, y0=-27.8675, r=0.9325)
# Concrete
...
source.space = openmc.stats.Box((-24.45, -1.8, 31.1), (22.85, 1.8, 33.1))
