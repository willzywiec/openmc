"""
LMCT003-10: STACY run 418 with U(5)O2 rods immersed in 41.83cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 3.743900e-07)
mat1.add_nuclide("U235", 4.466000e-05)
mat1.add_nuclide("U236", 7.424100e-08)
mat1.add_nuclide("U238", 6.916200e-04)
mat1.add_nuclide("O16", 3.776400e-02)
mat1.add_nuclide("H1", 5.771900e-02)
mat1.add_element("N", 2.677900e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=41.83)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 20.915))
