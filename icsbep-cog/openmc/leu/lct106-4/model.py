"""
LEU-COMP-THERM-101-4: MIRTE-2.2 Experiment 4A-Mo-010; 10x11; Hc=64.215cm
...
mat7.add_element("Mo", 6.404700e-02)
mat7.add_element("Ag", 1.139500e-06)
mat7.add_element("Al", 8.883200e-08)
mat7.add_nuclide("O16", 5.761800e-05)
mat7.add_element("Si", 2.625900e-07)
...
lattice3.lower_left = [0.50445, 0.50445]
lattice3.pitch = [1.599480, 1.599480]
lattice3.universes = [
...
lattice4.lower_left = [-24.50445, 0.50445]
...
lattice5.lower_left = [-24.50445, -24.50445]
...
lattice6.lower_left = [0.50445, -24.50445]
...
source.space = openmc.stats.Box((-8.7, -8.7, 31.1075), (8.7, 8.7, 33.1075))
