"""
LEU-COMP-THERM-074-21: MIRTE-1 Experiment 4A-Fe-003; 9x9; Hc=79.456cm
...
mat8.add_element("Al", 4.172800e-05)
mat8.add_element("C", 2.070000e-04)
mat8.add_element("H", 9.308900e-06)
mat8.add_element("In", 1.225700e-06)
mat8.add_element("Mn", 3.415600e-04)
mat8.add_element("Ni", 2.398000e-06)
mat8.add_nuclide("O16", 1.084900e-04)
mat8.add_element("P", 2.120400e-05)
mat8.add_element("Pb", 2.264100e-07)
mat8.add_element("S", 1.462800e-05)
mat8.add_element("Ti", 1.959600e-06)
mat8.add_element("Fe", 8.354200e-02)
...
lattice3.lower_left = [0.1492, 0.1492]
...
lattice4.lower_left = [-24.1492, 0.1492]
...
lattice5.lower_left = [-24.1492, -24.1492]
...
lattice6.lower_left = [0.1492, -24.1492]
...
source.space = openmc.stats.Box((-8.35, -8.35, 38.728), (8.35, 8.35, 40.728))
