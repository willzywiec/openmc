"""
LST021-2: Unreflected 80-cm diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=1,053 (Run 218)
...
mat1.add_nuclide("U234", 4.646000e-07)
mat1.add_nuclide("U235", 5.765400e-05)
mat1.add_nuclide("U236", 5.758200e-08)
mat1.add_nuclide("U238", 5.135300e-04)
mat1.add_nuclide("H1", 6.069200e-02)
mat1.add_element("N", 1.727500e-03)
mat1.add_nuclide("O16", 3.638000e-02)
...
source.space = openmc.stats.Point((0.0, 0.0, 25.665))
