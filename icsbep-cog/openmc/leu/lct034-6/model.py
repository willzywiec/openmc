"""
LCT034-6: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.155cm borated steel, 5.0cm water gap, Hc=62.86cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=62.86)
# Lower grid plate
...
# Basket
surf10 = openmc.model.RectangularParallelepiped(-31.455, -2.6549999999999994, 2.6549999999999994, 31.455, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf11 = openmc.model.RectangularParallelepiped(-31.61, -2.5, 2.5, 31.61, -2.200000000000003, 97.8)
# Basket
surf12 = openmc.model.RectangularParallelepiped(2.6549999999999994, 31.455, 2.6549999999999994, 31.455, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf13 = openmc.model.RectangularParallelepiped(2.5, 31.61, 2.5, 31.61, -2.200000000000003, 97.8)
# Basket
surf14 = openmc.model.RectangularParallelepiped(-31.455, -2.6549999999999994, -31.455, -2.6549999999999994, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf15 = openmc.model.RectangularParallelepiped(-31.61, -2.5, -31.61, -2.5, -2.200000000000003, 97.8)
# Basket
surf16 = openmc.model.RectangularParallelepiped(2.6549999999999994, 31.455, -31.455, -2.6549999999999994, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf17 = openmc.model.RectangularParallelepiped(2.5, 31.61, -31.61, -2.5, -2.200000000000003, 97.8)
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-30.5225, y0=30.5225, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-30.5225, y0=30.5225, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-3.455, y0=30.655, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-30.655, y0=3.455, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-3.455, y0=3.455, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=30.5225, y0=30.5225, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=30.5225, y0=30.5225, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=3.455, y0=30.655, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=30.655, y0=3.455, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=3.455, y0=3.455, r=0.5)
...
cell1.translation = (-17.055, 17.055, 0.0)
...
cell4.translation = (17.055, 17.055, 0.0)
...
cell7.translation = (-17.055, -17.055, 0.0)
...
cell10.translation = (17.055, -17.055, 0.0)
...
source.space = openmc.stats.Box((-31.655, -31.655, 30.43), (31.655, 31.655, 32.43))
