"""
LEU-COMP-THERM-010-17: (12x16)-15.363cm-(12x16)-15.363cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; Steel walls; 1.956 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -34.942, -17.092, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 17.092, 34.942, -20.0625, 101.8375)
...
cell1.translation = (-38.067, 0.0, 0.0)
...
cell5.translation = (38.067, 0.0, 0.0)
...
source.space = openmc.stats.Box((-38.121, -2.27, 45.0375), (38.121, 2.27, 47.0375))
