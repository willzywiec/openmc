"""
LEU-COMP-THERM-010-5: (13x8)-14.255cm-(13x8)-14.255cm-(13x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; U walls; 0.0 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-76.15, 76.15, -17.81, -10.16, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-76.15, 76.15, 10.16, 17.81, -20.0625, 101.8375)
...
cell1.translation = (-47.275, 0.0, 0.0)
...
cell5.translation = (47.275, 0.0, 0.0)
...
source.space = openmc.stats.Box((-48.275, -2.27, 45.0375), (48.275, 2.27, 47.0375))
