...
# surf93: Error converting surface type "c": could not convert string to float: 'tr'
...
# surf199: Error converting surface type "c": could not convert string to float: 'tr'
