"""
LST020-4: Water reflected 80-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=1,239 (Run 226)
...
mat1.add_nuclide("H1", 6.131800e-02)
mat1.add_element("N", 1.571500e-03)
mat1.add_nuclide("O16", 3.606000e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=81.09)
...
source.space = openmc.stats.Point((0.0, 0.0, 40.545))
