"""
LMT006-16: Case 16; Bugey 18; detailed; 42 type 1 tubes; 12.2cm pitch; Hw=56.47cm
...
surf904 = openmc.ZPlane(surface_id=904, z0=56.47)
...
u3_cell1.region = +surf4 & (-surf5 & +surf5_zmin & -surf5_zmax)
u3_cell2 = openmc.Cell(fill=mat2)
u3_cell2.region = +surf4 & (+surf5 | -surf5_zmin | +surf5_zmax) & -surf904
...
source.space = openmc.stats.Box((-9.3, -6.5, 27.2), (-7.300000000000001, -0.30000000000000004, 29.2))
