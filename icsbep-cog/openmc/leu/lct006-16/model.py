"""
LCT006-16: Tank-Type Critical Assembly (TCA) 17x17 rods with 2.293 cm pitch; Hc=52.87 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=52.87)
# DX=DY=17*2.293        = 38.981 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-19.4905, 19.4905, -19.4905, 19.4905, -30.0, 144.15)
# DX=DY=17*2.293 + 2*30 = 98.981 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-49.4905, 49.4905, -49.4905, 49.4905, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-19.4905, -19.4905]
...
source.space = openmc.stats.Point((0.0, 0.0, 26.435))
