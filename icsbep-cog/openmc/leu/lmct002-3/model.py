"""
LMCT002-3: STACY run 376 with U(5)O2 rods immersed in 47.43cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 2.755800e-07)
mat1.add_nuclide("U235", 3.303800e-05)
mat1.add_nuclide("U236", 5.464800e-08)
mat1.add_nuclide("U238", 5.089300e-04)
mat1.add_nuclide("O16", 3.744300e-02)
mat1.add_nuclide("H1", 5.856200e-02)
mat1.add_element("N", 2.614200e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=47.43)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 23.715))
