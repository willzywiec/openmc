"""
LST017-2: Unreflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=511 (Run 122)
...
mat1.add_nuclide("U234", 8.900900e-07)
mat1.add_nuclide("U235", 1.104500e-04)
mat1.add_nuclide("U236", 1.103200e-07)
mat1.add_nuclide("U238", 9.838200e-04)
mat1.add_nuclide("H1", 5.642300e-02)
mat1.add_element("N", 2.672300e-03)
mat1.add_nuclide("O16", 3.817800e-02)
...
# Hc
surf10 = openmc.ZPlane(surface_id=10, z0=47.88)
...
source.space = openmc.stats.Point((0.0, 0.0, 23.94))
