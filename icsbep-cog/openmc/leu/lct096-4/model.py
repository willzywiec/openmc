"""
LEU-COMP-THERM-096-4: 45x45 array of 1977 fuel rods with 0.8001 cm square pitch; Hc = 37.12 cm
...
surf13 = openmc.ZPlane(surface_id=13, z0=37.12)
...
source.space = openmc.stats.Point((0.0, 0.0, 18.56))
