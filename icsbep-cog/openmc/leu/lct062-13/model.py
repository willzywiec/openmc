"""
LCT062-13: 18x18 array of U(2.6)O2 rods on 1.9558cm pitch with 0.6194cm SST-0.98B plate, no gap (TCA)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=116.40)
# Array boundary
...
surf31 = openmc.model.RectangularParallelepiped(17.6022, 18.2216, -22.5, 22.5, 0.37000000000000455, 150.37)
...
source.space = openmc.stats.Box((-1.98, -1.98, 57.2), (1.98, 1.98, 59.2))
