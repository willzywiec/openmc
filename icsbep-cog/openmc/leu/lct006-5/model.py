"""
LCT006-5: Tank-Type Critical Assembly (TCA) 18x18 rods with 1.956 cm pitch; Hc=75.32 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=75.32)
# DX=DY=18*1.956        = 35.208 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-17.604, 17.604, -17.604, 17.604, -30.0, 144.15)
# DX=DY=18*1.956 + 2*30 = 95.208 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-47.604, 47.604, -47.604, 47.604, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-17.604, -17.604]
...
source.space = openmc.stats.Box((-2.0, -2.0, 36.66), (2.0, 2.0, 38.66))
