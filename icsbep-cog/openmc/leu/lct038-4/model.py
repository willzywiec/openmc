"""
LCT038-4: Two (18x13-2) arrays of U(4.738)O2 rods, 1.60 cm pitch, 10.0cm concrete reflector, Hc=63.0cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=63.0)
# Lower grid plate
...
surf12 = openmc.model.RectangularParallelepiped(-84.9, 10.100000000000001, -47.5, 47.5, -3.4, -2.6)
# Water & tank & BCD
surf13 = openmc.model.RectangularParallelepiped(-109.9, 10.399999999999999, -60.0, 60.0, -22.599999999999994, 117.5, boundary_type="vacuum")
surf14 = openmc.XPlane(surface_id=14, x0=0.0)
surf15 = openmc.XPlane(surface_id=15, x0=10.1)
...
# Concrete
surf40 = openmc.model.RectangularParallelepiped(0.4500000000000002, 9.649999999999999, -34.5, 34.5, -2.049999999999997, 96.95)
# Concrete
surf41 = openmc.model.RectangularParallelepiped(0.04999999999999982, 10.05, -34.5, 34.5, 2.450000000000003, 92.45)
# Frame
surf42 = openmc.model.RectangularParallelepiped(0.04999999999999982, 10.05, -35.0, 35.0, -2.549999999999997, 97.45)
# PVC & paint
surf43 = openmc.model.RectangularParallelepiped(0.0, 10.1, -35.05, 35.05, -2.5999999999999943, 97.5)
...
cell29.region = +surf4 & -surf5 & +surf6 & +surf7 & -surf8 & -surf9

# Water
cell37 = openmc.Cell(cell_id=37, fill=mat5)
cell37.region = +surf4 & -surf5 & +surf6 & +surf7 & -surf8 & -surf9
...
source.space = openmc.stats.Box((-21.0, -1.8, 30.5), (0.19999999999999996, 1.8, 32.5))
