"""
LCT061-2: 762 U(4.5)O2 rods, 7 B4C rods, 1.27 cm trianglur pitch, Hc=96.27cm, water
...
surf1 = openmc.ZPlane(surface_id=1, z0=96.27)
...
surf4_zmax = openmc.ZPlane(z0=133.27, boundary_type="vacuum")
...
surf91_zmin = openmc.ZPlane(z0=0.0)
surf91_zmax = openmc.ZPlane(z0=128.0)
surf92_zmin = openmc.ZPlane(z0=-2.3)
surf92_zmax = openmc.ZPlane(z0=130.3)
surf93_zmin = openmc.ZPlane(z0=-3.8)
surf93_zmax = openmc.ZPlane(z0=131.8)
...
source.space = openmc.stats.Box((-2.27, -2.09985, 47.135), (2.27, 2.09985, 49.135))
