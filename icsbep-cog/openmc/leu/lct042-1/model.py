"""
LCT042-1: (20x18)-7.866cm-SS304L(25x18)SS304L-7.866cm-(20x18) array of U(2.35)O2 fuel rods with 1.684 cm pitch
...
mat7.add_element("Cr", 1.704600e-02)
mat7.add_element("Cu", 2.029100e-04)
mat7.add_element("Fe", 5.835300e-02)
mat7.add_element("Mn", 1.373400e-03)
mat7.add_element("Mo", 1.294200e-04)
mat7.add_element("Ni", 9.023800e-03)
...
surf21 = openmc.model.RectangularParallelepiped(-21.352, -21.05, -15.1, 15.1, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(21.05, 21.352, -15.1, 15.1, 0.0, 91.5)
...
cell1.translation = (-44.914, 0.0, 0.0)
...
cell5.translation = (44.914, 0.0, 0.0)
...
source.space = openmc.stats.Box((-45.914, -1.842, 44.72), (45.914, 1.842, 46.72))
