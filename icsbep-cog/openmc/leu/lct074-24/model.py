"""
LEU-COMP-THERM-074-24: MIRTE-1 Experiment 4A-Ni-003; 10x9; Hc=73.897cm
...
mat8.add_element("Ca", 2.665300e-06)
mat8.add_element("Cr", 2.054400e-06)
mat8.add_element("Fe", 9.276700e-05)
mat8.add_element("Mg", 3.516000e-05)
mat8.add_element("Mn", 1.361100e-04)
mat8.add_element("Si", 7.036300e-05)
mat8.add_element("Ti", 6.246800e-05)
mat8.add_element("Zn", 1.470200e-05)
mat8.add_element("C", 5.336100e-05)
mat8.add_nuclide("O16", 2.003000e-05)
mat8.add_element("Ni", 9.065200e-02)
...
lattice3.lower_left = [0.1482, 0.1482]
...
lattice4.lower_left = [-24.1482, 0.1482]
...
lattice5.lower_left = [-24.1482, -24.1482]
...
lattice6.lower_left = [0.1482, -24.1482]
...
source.space = openmc.stats.Box((-8.35, -8.35, 35.9485), (8.35, 8.35, 37.9485))
