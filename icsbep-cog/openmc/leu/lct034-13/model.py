"""
LCT034-13: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.65cm Boral, 1.5cm water gap, Hc=66.15cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=66.15)
# Lower grid plate
...
# Basket
surf10 = openmc.model.RectangularParallelepiped(-30.200000000000003, -1.4000000000000004, 1.4000000000000004, 30.200000000000003, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf11 = openmc.model.RectangularParallelepiped(-30.85, -0.75, 0.75, 30.85, -2.200000000000003, 97.8)
# Basket
surf12 = openmc.model.RectangularParallelepiped(1.4000000000000004, 30.200000000000003, 1.4000000000000004, 30.200000000000003, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf13 = openmc.model.RectangularParallelepiped(0.75, 30.85, 0.75, 30.85, -2.200000000000003, 97.8)
# Basket
surf14 = openmc.model.RectangularParallelepiped(-30.200000000000003, -1.4000000000000004, -30.200000000000003, -1.4000000000000004, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf15 = openmc.model.RectangularParallelepiped(-30.85, -0.75, -30.85, -0.75, -2.200000000000003, 97.8)
# Basket
surf16 = openmc.model.RectangularParallelepiped(1.4000000000000004, 30.200000000000003, -30.200000000000003, -1.4000000000000004, -2.200000000000003, 103.8)
# Boral, 0.65cm x 100 cm
surf17 = openmc.model.RectangularParallelepiped(0.75, 30.85, -30.85, -0.75, -2.200000000000003, 97.8)
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-29.2675, y0=29.2675, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-29.2675, y0=29.2675, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-2.2, y0=29.4, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-29.4, y0=2.2, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-2.2, y0=2.2, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=29.2675, y0=29.2675, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=29.2675, y0=29.2675, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=2.2, y0=29.4, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=29.4, y0=2.2, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=2.2, y0=2.2, r=0.5)
# Aluminum cover
...
cell1.translation = (-15.8, 15.8, 0.0)
...
cell12.translation = (15.8, -15.8, 0.0)
...
source.space = openmc.stats.Box((-30.4, -30.4, 32.075), (30.4, 30.4, 34.075))
