"""
LCT028-14: 342 U(4.31)O2 rods with 2.794 cm triangular pitch in water with 0.1169 gGd/l
...
# Water with Gd (Case 14)
mat5 = openmc.Material(material_id=5)
mat5.set_density("sum")
mat5.add_nuclide("H1", 6.672300e-02)
mat5.add_element("N", 2.607700e-06)
mat5.add_nuclide("O16", 3.336900e-02)
mat5.add_element("Gd", 4.476800e-07)
...
# Lexan  lattice plate
surf1 = openmc.ZCylinder(surface_id=1, r=34.0)
# SS304L lattice plate
surf2 = openmc.ZCylinder(surface_id=2, r=34.0)
# Al6061 lattice plate
surf3 = openmc.ZCylinder(surface_id=3, r=34.0)
# Water and boundary condition
surf4 = openmc.ZCylinder(surface_id=4, r=50.8, boundary_type="vacuum")
# Al6061 tie rod
surf5 = openmc.ZCylinder(surface_id=5, x0=0.0, y0=32.0, r=1.27)
# Al6061 tie rod
surf6 = openmc.ZCylinder(surface_id=6, x0=-27.7128, y0=-16.0, r=1.27)
# Al6061 tie rod
surf7 = openmc.ZCylinder(surface_id=7, x0=27.7128, y0=-16.0, r=1.27)
# U(4.31)O2 fuel
...
surf21_0 = openmc.Plane(a=0.8660246601, b=0.5000012881, c=0, d=29.0360748035)
surf21_1 = openmc.Plane(a=0.0000000000, b=1.0000000000, c=0, d=29.0360000000)
surf21_2 = openmc.Plane(a=-0.8660246601, b=0.5000012881, c=0, d=29.0360748035)
surf21_3 = openmc.Plane(a=-0.8660246601, b=-0.5000012881, c=0, d=29.0360748035)
surf21_4 = openmc.Plane(a=0.0000000000, b=-1.0000000000, c=0, d=29.0360000000)
surf21_5 = openmc.Plane(a=0.8660246601, b=-0.5000012881, c=0, d=29.0360748035)
