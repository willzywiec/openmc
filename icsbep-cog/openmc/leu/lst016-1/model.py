"""
LST016-1: Water reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=469 (Run 105)
...
mat1.add_nuclide("U234", 9.555500e-07)
mat1.add_nuclide("U235", 1.185800e-04)
mat1.add_nuclide("U236", 1.184300e-07)
mat1.add_nuclide("U238", 1.056200e-03)
mat1.add_nuclide("H1", 5.558200e-02)
mat1.add_element("N", 2.864700e-03)
mat1.add_nuclide("O16", 3.848100e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=40.09)
...
source.space = openmc.stats.Point((0.0, 0.0, 20.045))
