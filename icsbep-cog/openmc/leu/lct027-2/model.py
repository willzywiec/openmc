"""
LCT027-2: 14x14 array reflected by lead with no 0.5 cm water gap
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=71.87)
# Array boundary
...
# Lead #1 Xo=-18.8+0.5=-18.3; Yo=-26.2-0.5=-26.7
surf25 = openmc.model.RectangularParallelepiped(-48.3, 11.7, -41.7, -11.7, -3.200000000000003, 91.8)
# Lead #2
surf26 = openmc.model.RectangularParallelepiped(-11.7, 48.3, 11.7, 41.7, -3.200000000000003, 91.8)
# Lead #3 Xo=-26.2-0.5=-26.7; Yo=18.8-0.5=18.3
surf27 = openmc.model.RectangularParallelepiped(-41.7, -11.7, -11.7, 48.3, -3.200000000000003, 91.8)
# Lead #4
surf28 = openmc.model.RectangularParallelepiped(11.7, 41.7, -48.3, 11.7, -3.200000000000003, 91.8)
# BCD
...
source.space = openmc.stats.Box((-1.8, -1.8, 34.935), (1.8, 1.8, 36.935))
