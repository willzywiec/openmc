"""
LEU-COMP-THERM-010-25: (12x16)-16.233cm-(12x16)-16.233cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; U walls; 0.660 gap
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-50.289, 50.289, -15.136, 15.136, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-106.65, 106.65, -45.636, 45.636, -20.0625, 109.4975, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-27.585)
surf4 = openmc.XPlane(surface_id=4, x0=-11.352)
surf5 = openmc.XPlane(surface_id=5, x0=11.352)
surf6 = openmc.XPlane(surface_id=6, x0=27.585)
# Rubber
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-76.15, 76.15, -23.445999999999998, -15.796, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-76.15, 76.15, 15.796, 23.445999999999998, -20.0625, 101.8375)
...
cell1.translation = (-38.937, 0.0, 0.0)
...
cell5.translation = (38.937, 0.0, 0.0)
...
source.space = openmc.stats.Box((-38.991, -2.27, 45.0375), (38.991, 2.27, 47.0375))
