"""
LEU-COMP-THERM-074-15: MIRTE-1 Experiment R2A-Air-200(fe); 8x55; Hc=77.050cm
...
mat8.add_element("Pb", 3.878600e-07)
mat8.add_element("Be", 2.318500e-06)
mat8.add_element("Si", 3.147600e-05)
mat8.add_element("Ti", 4.699700e-06)
mat8.add_element("Zn", 2.703800e-06)
mat8.add_element("Zr", 3.876200e-07)
mat8.add_element("Cr", 5.564200e-06)
mat8.add_element("Cu", 3.288200e-06)
mat8.add_element("Fe", 6.619500e-05)
mat8.add_element("Mg", 1.964100e-03)
mat8.add_element("Mn", 8.191800e-05)
mat8.add_element("Ni", 2.464800e-06)
mat8.add_element("C", 5.352800e-06)
mat8.add_nuclide("O16", 2.009200e-06)
mat8.add_element("Al", 5.741700e-02)
...
lattice4.lower_left = [-49.6, -26.0037]
...
cell2.region = -surf8 & -surf11

# SST
cell3 = openmc.Cell(cell_id=3, fill=mat4)
cell3.region = -surf8 & +surf10 & +surf11 & -surf4

# Al
cell4 = openmc.Cell(cell_id=4, fill=mat8)
cell4.region = -surf8 & +surf10 & +surf11 & +surf4 & +surf12 & -surf13

# Air
cell5 = openmc.Cell(cell_id=5, fill=mat7)
cell5.region = -surf8 & +surf10 & +surf11 & +surf4 & -surf12 & -surf13

# Air
cell6 = openmc.Cell(cell_id=6, fill=mat7)
cell6.region = -surf8 & +surf10 & +surf11 & +surf4 & +surf13 & +surf9

# H2O
cell7 = openmc.Cell(cell_id=7, fill=mat6)
cell7.region = -surf8 & +surf10 & +surf11 & +surf4 & +surf13 & -surf9
...
cell26.region = +surf4 & +surf6 & +surf7 & -surf8 & +surf9
...
source.space = openmc.stats.Box((-1.8, -23.0, 37.525), (1.8, 23.0, 39.525))
