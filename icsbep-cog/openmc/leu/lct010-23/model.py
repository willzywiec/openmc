"""
LEU-COMP-THERM-010-23: (12x16)-13.873cm-(12x16)-13.873cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; Lead walls; 5.001 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-82.0, 82.0, -30.336999999999996, -20.137, -20.0625, 103.3375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-82.0, 82.0, 20.137, 30.336999999999996, -20.0625, 103.3375)
...
cell1.translation = (-36.577, 0.0, 0.0)
...
cell5.translation = (36.577, 0.0, 0.0)
...
source.space = openmc.stats.Box((-36.631, -2.27, 45.0375), (36.631, 2.27, 47.0375))
