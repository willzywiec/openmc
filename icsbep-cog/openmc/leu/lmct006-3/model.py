"""
LMCT006-3: STACY run 554 with U(5)O2 rods immersed in 55.82cm of U(6) uranyl nitrate and Gd solution with water reflection
...
mat1.add_nuclide("U234", 4.259800e-07)
mat1.add_nuclide("U235", 5.089900e-05)
mat1.add_nuclide("U236", 8.447200e-08)
mat1.add_nuclide("U238", 7.868400e-04)
mat1.add_nuclide("O16", 3.809300e-02)
mat1.add_nuclide("H1", 5.677700e-02)
mat1.add_element("N", 2.875600e-03)
mat1.add_element("Gd", 2.190600e-07)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=55.82)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 27.91))
