"""
LEU-COMP-THERM-009-18: (15x8)-2.9495cm-(0.061cm Cd)-2.9495cm-(15x8)-2.9495cm-(0.061cm Cd)-2.9495cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-93.11, 93.11, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-25.01)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=25.01)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-22.0605, -21.9995, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-44.06, 0.0, 0.0)
...
cell5.translation = (44.06, 0.0, 0.0)
...
source.space = openmc.stats.Box((-45.06, -2.27, 45.0375), (45.06, 2.27, 47.0375))
