"""
LMCT006-1: STACY run 546 with U(5)O2 rods immersed in 44.87cm of U(6) uranyl nitrate and Gd solution with water reflection
...
mat1.add_nuclide("U234", 4.254600e-07)
mat1.add_nuclide("U235", 5.083800e-05)
mat1.add_nuclide("U236", 8.437000e-08)
mat1.add_nuclide("U238", 7.858900e-04)
mat1.add_nuclide("O16", 3.800700e-02)
mat1.add_nuclide("H1", 5.671500e-02)
mat1.add_element("N", 2.855000e-03)
mat1.add_element("Gd", 7.238000e-08)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=44.87)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 22.435))
