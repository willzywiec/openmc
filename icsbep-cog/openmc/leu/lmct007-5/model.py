"""
LMCT007-5: STACY run 621 with U(5)O2 rods immersed in 75.50cm of U(6) uranyl nitrate with water reflection
...
mat1.add_nuclide("U234", 1.543900e-07)
mat1.add_nuclide("U235", 1.844700e-05)
mat1.add_nuclide("U236", 3.061500e-08)
mat1.add_nuclide("U238", 2.851700e-04)
mat1.add_nuclide("O16", 3.579100e-02)
mat1.add_nuclide("H1", 6.208400e-02)
mat1.add_element("N", 1.535000e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=75.50)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 37.75))
