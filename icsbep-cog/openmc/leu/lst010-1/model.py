"""
LST010-1: Polyethylene (P30) reflected 60-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=946 (Run 83)
...
mat1.add_nuclide("U234", 4.983600e-07)
mat1.add_nuclide("U235", 6.184300e-05)
mat1.add_nuclide("U236", 6.176600e-08)
mat1.add_nuclide("U238", 5.508400e-04)
mat1.add_nuclide("H1", 5.851600e-02)
mat1.add_element("N", 2.485100e-03)
mat1.add_nuclide("O16", 3.731100e-02)
...
mat6.add_nuclide("H1", 7.836000e-02)
mat6.add_element("C", 3.931600e-02)
...
# =B
surf14 = openmc.ZCylinder(surface_id=14, r=32.25)
# =C
surf15 = openmc.ZCylinder(surface_id=15, r=35.4)
# =D
surf16 = openmc.ZCylinder(surface_id=16, r=36.21)
...
source.space = openmc.stats.Point((0.0, 0.0, 40.63))
