"""
LMCT007-3: STACY run 607 with U(5)O2 rods immersed in 52.53cm of U(6) uranyl nitrate with water reflection
...
mat1.add_nuclide("H1", 6.042700e-02)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=52.53)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 26.265))
