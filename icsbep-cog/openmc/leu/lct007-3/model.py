"""
LCT007-3: 15x15 array of 225 U(4.738)O2 fuel rods with 2.10 cm square pitch in water
...
# Lattice boundary
surf2 = openmc.model.RectangularParallelepiped(-15.75, 15.75, -15.75, 15.75, -499.95, 499.95)
# Hc
surf10 = openmc.ZPlane(surface_id=10, z0=77.98)
# UO2
...
lattice2.lower_left = [-15.75, -15.75]
lattice2.pitch = [2.100000, 2.100000]
lattice2.universes = [
...
source.space = openmc.stats.Point((0.0, 0.0, 38.99))
