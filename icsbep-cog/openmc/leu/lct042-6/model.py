"""
LCT042-6: (20x18)-7.376cm-Cu(25x18)Cu-7.376cm-(20x18) array of U(2.35)O2 fuel rods with 1.684 cm pitch
...
mat7.add_element("C", 1.519400e-03)
mat7.add_element("Cu", 8.412800e-02)
mat7.add_element("Fe", 3.844400e-06)
mat7.add_element("Mg", 4.416800e-06)
mat7.add_element("Na", 4.669500e-06)
mat7.add_nuclide("O16", 1.006400e-04)
mat7.add_element("Si", 3.822300e-05)
mat7.add_element("S", 3.347400e-06)
...
surf21 = openmc.model.RectangularParallelepiped(-21.387, -21.049999999999997, -15.1, 15.1, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(21.049999999999997, 21.387, -15.1, 15.1, 0.0, 91.5)
...
cell1.translation = (-44.424, 0.0, 0.0)
...
cell5.translation = (44.424, 0.0, 0.0)
...
source.space = openmc.stats.Box((-45.424, -1.842, 44.72), (45.424, 1.842, 46.72))
