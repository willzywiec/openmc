"""
LEU-COMP-THERM-074-17: MIRTE-1 Experiment 2A-Cu-050; 8x45; Hc=59.554cm
...
mat8.add_element("Al", 2.113900e-05)
mat8.add_element("Be", 5.753300e-06)
mat8.add_element("Fe", 9.284300e-07)
mat8.add_element("P", 6.696000e-06)
mat8.add_element("Si", 7.384600e-06)
mat8.add_element("Ti", 2.165800e-06)
mat8.add_element("Zn", 1.348000e-05)
mat8.add_element("C", 1.122400e-05)
mat8.add_nuclide("O16", 3.240800e-05)
mat8.add_element("Cu", 8.155000e-02)
mat8.add_element("Sb", 4.258700e-07)
mat8.add_element("As", 6.920600e-07)
...
lattice4.lower_left = [-49.6, -18.4963]
...
cell9.region = -surf8 & +surf10 & +surf11 & +surf4 & +surf12 & +surf13 & +surf14 & +surf9

# H2O
cell10 = openmc.Cell(cell_id=10, fill=mat6)
cell10.region = -surf8 & +surf10 & +surf11 & +surf4 & +surf12 & +surf13 & +surf14 & -surf9

# Air
cell21 = openmc.Cell(cell_id=21, fill=mat7)
cell21.region = +surf3 & +surf4 & +surf6 & +surf7 & -surf8 & +surf9

# Air
cell29 = openmc.Cell(cell_id=29, fill=mat7)
cell29.region = +surf4 & +surf6 & +surf7 & -surf8 & +surf9

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell21, cell29])
...
source.space = openmc.stats.Box((-1.8, -15.5, 28.777), (1.8, 15.5, 30.777))
