"""
LEU-COMP-THERM-010-27: (12x16)-18.763cm-(12x16)-18.763cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; U walls; 1.956 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-76.15, 76.15, -24.742, -17.092000000000002, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-76.15, 76.15, 17.092000000000002, 24.742, -20.0625, 101.8375)
...
cell1.translation = (-41.467, 0.0, 0.0)
...
cell5.translation = (41.467, 0.0, 0.0)
...
source.space = openmc.stats.Box((-41.521, -2.27, 45.0375), (41.521, 2.27, 47.0375))
