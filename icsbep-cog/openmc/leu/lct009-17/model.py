"""
LEU-COMP-THERM-009-17: (15x8)-3.69545cm-(0.0291cm Cd)-3.69545cm-(15x8)-3.69545cm-(0.0291cm Cd)-3.69545cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-64.57, 64.57, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-94.57, 94.57, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-26.47)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=26.47)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-22.77455, -22.74545, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(22.74545, 22.77455, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-45.52, 0.0, 0.0)
...
cell5.translation = (45.52, 0.0, 0.0)
...
source.space = openmc.stats.Box((-46.52, -2.27, 45.0375), (46.52, 2.27, 47.0375))
