"""
LMCT003-14: STACY run 439 with U(5)O2 rods immersed in 51.39cm of U(6) uranyl nitrate solution with water reflection
...
mat1.add_nuclide("U234", 1.299400e-07)
mat1.add_nuclide("U235", 1.550100e-05)
mat1.add_nuclide("U236", 2.576800e-08)
mat1.add_nuclide("U238", 2.400500e-04)
mat1.add_nuclide("O16", 3.598800e-02)
mat1.add_nuclide("H1", 6.165200e-02)
mat1.add_element("N", 1.758000e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=51.39)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 25.695))
