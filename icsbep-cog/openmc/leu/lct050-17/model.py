"""
LCT050-17: Exp. No. 2778; 25x25-49=576 array of U(4.738)O2 rods on 1.3cm pitch; samarium solution no. C3
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=86.30)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 42.15), (5.55, 5.55, 44.15))
