"""
LEU-COMP-THERM-002-3: 8x16.37 = 8x16 + 3 array of U(4.31)O2 rods in water; 2.54 cm pitch
...
surf1 = openmc.model.RectangularParallelepiped(-10.16, 10.16, -21.59, 21.59, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-40.16, 40.16, -51.59, 51.59, -20.0625, 107.075, boundary_type="vacuum")
# Rubber
...
# Lattice 3: 8x17 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-10.16, -21.59]
...
lattice3.universes = [
    ...
    [universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe1, universe1, universe1, universe1, universe1, universe1, universe1, universe1],
    [universe1, universe1, universe1, universe2, universe2, universe2, universe2, universe2],
]
...
source.space = openmc.stats.Box((-2.27, -1.0, 45.0375), (2.27, 1.0, 47.0375))
