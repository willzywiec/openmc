"""
LST009-3: STACY 60cm diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=933 reflected with (B155) borated concrete (Run 94)
...
mat1.add_nuclide("U234", 5.047400e-07)
mat1.add_nuclide("U235", 6.263500e-05)
mat1.add_nuclide("U236", 6.255700e-08)
mat1.add_nuclide("U238", 5.578900e-04)
mat1.add_nuclide("H1", 5.846900e-02)
mat1.add_element("N", 2.512900e-03)
mat1.add_nuclide("O16", 3.738000e-02)
...
mat6.add_nuclide("H1", 1.897400e-02)
mat6.add_nuclide("O16", 9.486800e-03)
mat6.add_nuclide("O16", 3.146000e-02)
mat6.add_nuclide("B10", 1.617300e-03)
mat6.add_nuclide("B11", 6.509800e-03)
mat6.add_element("C", 2.035600e-03)
mat6.add_element("Na", 2.215300e-04)
mat6.add_element("Mg", 2.495200e-04)
mat6.add_element("Al", 5.504600e-04)
mat6.add_element("Si", 1.245200e-02)
mat6.add_element("S", 2.075900e-04)
mat6.add_element("Cl", 9.512200e-07)
mat6.add_element("K", 1.457600e-04)
mat6.add_element("Ca", 4.438400e-03)
mat6.add_element("Fe", 1.568800e-04)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=78.88)
# Steel support/inner
surf11 = openmc.ZCylinder(surface_id=11, r=31.7)
# Steel support/outer
surf12 = openmc.ZCylinder(surface_id=12, r=68.5)
# Aluminum reflector bottom plate
surf13 = openmc.ZCylinder(surface_id=13, r=51.51)
# Steel reflector top plate
surf14 = openmc.ZCylinder(surface_id=14, r=51.51)
# = 29.82 +  0.53 (Inner Gap)
surf15 = openmc.ZCylinder(surface_id=15, r=30.35)
# = 30.35 +  0.31 (Inner Wall)
surf16 = openmc.ZCylinder(surface_id=16, r=30.66)
# = 30.66 + 20.04 (Concrete)
surf17 = openmc.ZCylinder(surface_id=17, r=50.7)
# = 50.70 +  0.81 (Outer Wall)
surf18 = openmc.ZCylinder(surface_id=18, r=51.51)
# BCD
...
source.space = openmc.stats.Point((0.0, 0.0, 39.44))
