"""
LCT029-6: 21x21 array of 441 U(4.738)O2 fuel rods with 1.60 cm square pitch with four, 0.0978cm thick, Hf plates
...
surf5 = openmc.ZPlane(surface_id=5, z0=49.99)
...
cell15.region = -surf1 & (+surf14 | -surf14_zmin | +surf14_zmax)

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell15])
...
source.space = openmc.stats.Point((0.0, 0.0, 24.995))
