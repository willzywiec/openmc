"""
LST012-1: TRACY R203-Hc1 (critical)
...
# critical
surf5 = openmc.ZPlane(surface_id=5, z0=50.962, boundary_type="vacuum")

# Z-plane surfaces for bounded cylinders
surf3_zmin = openmc.ZPlane(z0=0.0)
surf3_zmax = openmc.ZPlane(z0=200.0)
surf4_zmin = openmc.ZPlane(z0=-8.06)
surf4_zmax = openmc.ZPlane(z0=202.6)
...
source.space = openmc.stats.Point((0.0, 0.0, 25.481))
