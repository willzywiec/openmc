"""
LEU-COMP-THERM-009-15: (15x8)-3.9965cm-(0.357cm Cu-1Cd)-3.9965cm-(15x8)-3.9965cm-(0.357cm Cu-1Cd)-3.9965cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-65.5, 65.5, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-95.5, 95.5, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-27.40)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=27.40)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-23.4035, -23.0465, -15.3, 15.3, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(23.0465, 23.4035, -15.3, 15.3, 0.0, 91.5)
...
cell1.translation = (-46.45, 0.0, 0.0)
...
cell5.translation = (46.45, 0.0, 0.0)
...
source.space = openmc.stats.Box((-47.45, -2.27, 45.0375), (47.45, 2.27, 47.0375))
