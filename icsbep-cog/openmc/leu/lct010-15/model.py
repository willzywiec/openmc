"""
LEU-COMP-THERM-010-15: (12x16)-15.263cm-(12x16)-15.263cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; Steel walls; 0.660 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -33.646, -15.796, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 15.796, 33.646, -20.0625, 101.8375)
...
cell1.translation = (-37.967, 0.0, 0.0)
...
cell5.translation = (37.967, 0.0, 0.0)
...
source.space = openmc.stats.Box((-38.021, -2.27, 45.0375), (38.021, 2.27, 47.0375))
