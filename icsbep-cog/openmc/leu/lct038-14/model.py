"""
LCT038-14: Two pairs of (18x13-2) arrays of U(4.738)O2 rods, 1.60 cm pitch, between 20.0cm and 10.0cm concrete isolators, Hc=59.0cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=59.0)
# Lower grid plate
...
# Basket  Note: Xo = (20.1+10.1)/2 + 14.4 = 29.5
surf10 = openmc.model.RectangularParallelepiped(-43.9, -15.1, 0.0, 28.8, -2.6000000000000014, 104.19999999999999)
# Basket
surf11 = openmc.model.RectangularParallelepiped(-43.9, -15.1, -28.8, 0.0, -2.6000000000000014, 104.19999999999999)
# Basket
surf12 = openmc.model.RectangularParallelepiped(15.1, 43.9, 0.0, 28.8, -2.6000000000000014, 104.19999999999999)
# Basket
surf13 = openmc.model.RectangularParallelepiped(15.1, 43.9, -28.8, 0.0, -2.6000000000000014, 104.19999999999999)
...
# Xo = (20.1+10.1)/2 + 0.8 = 15.9
surf21 = openmc.ZCylinder(surface_id=21, x0=-15.9, y0=28.0, r=0.5)
# Xo = 17.5(1.6) + (20.1+10.1)/2 = 43.1
surf22 = openmc.ZCylinder(surface_id=22, x0=-43.1, y0=0.8, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-43.1, y0=-0.8, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-15.9, y0=-28.0, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=15.9, y0=28.0, r=0.5)
surf26 = openmc.ZCylinder(surface_id=26, x0=43.1, y0=0.8, r=0.5)
surf27 = openmc.ZCylinder(surface_id=27, x0=43.1, y0=-0.8, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=15.9, y0=-28.0, r=0.5)
# Inner
surf31 = openmc.ZCylinder(surface_id=31, x0=-42.9675, y0=27.8675, r=0.7975)
# Outer
surf32 = openmc.ZCylinder(surface_id=32, x0=-42.9675, y0=27.8675, r=0.9325)
# Inner
surf33 = openmc.ZCylinder(surface_id=33, x0=-42.9675, y0=-27.8675, r=0.7975)
# Outer
surf34 = openmc.ZCylinder(surface_id=34, x0=-42.9675, y0=-27.8675, r=0.9325)
# Inner
surf35 = openmc.ZCylinder(surface_id=35, x0=42.9675, y0=27.8675, r=0.7975)
# Outer
surf36 = openmc.ZCylinder(surface_id=36, x0=42.9675, y0=27.8675, r=0.9325)
# Inner
surf37 = openmc.ZCylinder(surface_id=37, x0=42.9675, y0=-27.8675, r=0.7975)
# Outer
surf38 = openmc.ZCylinder(surface_id=38, x0=42.9675, y0=-27.8675, r=0.9325)
# Concrete
surf40 = openmc.model.RectangularParallelepiped(-14.65, -5.450000000000001, -34.5, 34.5, -2.049999999999997, 96.95)
# Concrete
surf41 = openmc.model.RectangularParallelepiped(-15.05, -5.050000000000001, -34.5, 34.5, 2.450000000000003, 92.45)
# Frame
surf42 = openmc.model.RectangularParallelepiped(-15.05, -5.050000000000001, -35.0, 35.0, -2.549999999999997, 97.45)
# PVC & paint
surf43 = openmc.model.RectangularParallelepiped(-15.100000000000001, -5.000000000000001, -35.05, 35.05, -2.5999999999999943, 97.5)
# Concrete
surf50 = openmc.model.RectangularParallelepiped(-4.95, 15.05, -35.0, 35.0, -2.549999999999997, 97.45)
# PVC & paint
...
cell40.region = +surf4 & -surf5 & +surf6 & +surf7 & -surf8 & -surf9

# Water
cell48 = openmc.Cell(cell_id=48, fill=mat5)
cell48.region = +surf4 & -surf5 & +surf6 & +surf7 & -surf8 & -surf9
...
source.space = openmc.stats.Box((-36.1, -1.8, 28.5), (36.1, 1.8, 30.5))
