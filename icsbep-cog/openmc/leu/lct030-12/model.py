"""
LCT030-12: 691 U(3.5)O2 rods, 1.27 cm trianglur pitch, Hc=117.89cm
...
# 3rd prism with 3 more rows of holes
...
cell6.region = (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf32_0 | +surf32_1 | +surf32_2 | +surf32_3 | +surf32_4 | +surf32_5) & (-surf33_0 & -surf33_1 & -surf33_2 & -surf33_3 & -surf33_4 & -surf33_5)

# Alles
cell7 = openmc.Cell(cell_id=7, fill=universe1)
cell7.region = (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf33_0 | +surf33_1 | +surf33_2 | +surf33_3 | +surf33_4 | +surf33_5)

# Mod
cell11 = openmc.Cell(cell_id=11, fill=mat4)
cell11.region = -surf1 & (+surf2 | -surf2_zmin | +surf2_zmax) & (+surf3 | -surf3_zmin | +surf3_zmax) & (-surf4 & +surf4_zmin & -surf4_zmax)

# Mod
cell18 = openmc.Cell(cell_id=18, fill=mat4)
cell18.region = -surf1 & (-surf4 & +surf4_zmin & -surf4_zmax) & (+surf16 | -surf16_zmin | +surf16_zmax) & (+surf17 | -surf17_zmin | +surf17_zmax)

# Alles
cell19 = openmc.Cell(cell_id=19, fill=universe1)
cell19.region = (-surf4 & +surf4_zmin & -surf4_zmax) & +surf20 & +surf21 & +surf22 & +surf23 & +surf24 & +surf25 & +surf26
...
root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell11, cell18, cell19, cell27])
...
source.space = openmc.stats.Point((0.0, 0.0, 58.945))
