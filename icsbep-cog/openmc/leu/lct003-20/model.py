"""
LCT003-20: (17x20)-9.88cm-(25x20)-9.88cm-(17x20) arrays of U(2.35)O2 fuel rods with 1.684cm square pitch in water (SSC-2.35-000-112)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-59.558, 59.558, -16.84, 16.84, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-89.558, 89.558, -46.84, 46.84, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-30.930)
surf4 = openmc.XPlane(surface_id=4, x0=-21.050)
surf5 = openmc.XPlane(surface_id=5, x0=21.050)
surf6 = openmc.XPlane(surface_id=6, x0=30.930)
# Al-5052 lower plug
...
# Lattice 3: 25x20 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-21.05, -16.84]
...
cell1.translation = (-45.244, 0.0, 0.0)
...
cell5.translation = (45.244, 0.0, 0.0)
...
source.space = openmc.stats.Box((-46.244, -1.842, 44.72), (46.244, 1.842, 46.72))
