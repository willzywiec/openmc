"""
LST020-3: Water reflected 80-cm-diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=1,168 (Run 220)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=62.56)
...
source.space = openmc.stats.Point((0.0, 0.0, 31.28))
