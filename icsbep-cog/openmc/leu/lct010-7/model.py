"""
LEU-COMP-THERM-010-7: (13x8)-16.925cm-(13x8)-16.925cm-(13x8) array of U(4.306)O2 rods in water; 2.54 cm pitch; U walls; 3.912 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-76.15, 76.15, -21.721999999999998, -14.072, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-76.15, 76.15, 14.072, 21.721999999999998, -20.0625, 101.8375)
...
cell1.translation = (-49.945, 0.0, 0.0)
...
cell5.translation = (49.945, 0.0, 0.0)
...
source.space = openmc.stats.Box((-50.945, -2.27, 45.0375), (50.945, 2.27, 47.0375))
