"""
LCT006-2: Tank-Type Critical Assembly (TCA) 20x20 rods with 1.849 cm pitch; Hc=73.73 cm
...
surf3 = openmc.ZPlane(surface_id=3, z0=73.73)
# DX=DY=20*1.849        = 36.98 (core planar bdy)
surf4 = openmc.model.RectangularParallelepiped(-18.49, 18.49, -18.49, 18.49, -30.0, 144.15)
# DX=DY=20*1.849 + 2*30 = 96.98 (refl planar bdy)
surf5 = openmc.model.RectangularParallelepiped(-48.49, 48.49, -48.49, 48.49, -30.0, 144.15, boundary_type="vacuum")
...
lattice2.lower_left = [-18.49, -18.49]
...
source.space = openmc.stats.Box((-1.9, -1.9, 35.865), (1.9, 1.9, 37.865))
