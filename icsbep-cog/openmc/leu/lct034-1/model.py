"""
LCT034-1: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.155cm borated steel, 0.6cm water gap; Hc=34.33cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=36.54)
# Lower grid plate
...
# Basket
surf10 = openmc.model.RectangularParallelepiped(-29.255000000000003, -0.45500000000000007, 0.45500000000000007, 29.255000000000003, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf11 = openmc.model.RectangularParallelepiped(-29.41, -0.3000000000000007, 0.3000000000000007, 29.41, -2.200000000000003, 97.8)
# Basket
surf12 = openmc.model.RectangularParallelepiped(0.45500000000000007, 29.255000000000003, 0.45500000000000007, 29.255000000000003, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf13 = openmc.model.RectangularParallelepiped(0.3000000000000007, 29.41, 0.3000000000000007, 29.41, -2.200000000000003, 97.8)
# Basket
surf14 = openmc.model.RectangularParallelepiped(-29.255000000000003, -0.45500000000000007, -29.255000000000003, -0.45500000000000007, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf15 = openmc.model.RectangularParallelepiped(-29.41, -0.3000000000000007, -29.41, -0.3000000000000007, -2.200000000000003, 97.8)
# Basket
surf16 = openmc.model.RectangularParallelepiped(0.45500000000000007, 29.255000000000003, -29.255000000000003, -0.45500000000000007, -2.200000000000003, 103.8)
# Borated steel, 0.155cm x 100 cm
surf17 = openmc.model.RectangularParallelepiped(0.3000000000000007, 29.41, -29.41, -0.3000000000000007, -2.200000000000003, 97.8)
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-28.3225, y0=28.3225, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-28.3225, y0=28.3225, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-1.255, y0=28.455, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-28.455, y0=1.255, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-1.255, y0=1.255, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=28.3225, y0=28.3225, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=28.3225, y0=28.3225, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=1.255, y0=28.455, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=28.455, y0=1.255, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=1.255, y0=1.255, r=0.5)
...
source.space = openmc.stats.Box((-31.055, -31.055, 16.165), (31.055, 31.055, 18.165))
