"""
LCT049-10S: Simplified model of R1-3R(4,3) with H/U=3 and d=4.47cm
...
cell1.region = +surf11 & -surf18 & +surf21 & -surf27 & +surf31 & -surf36
...
source.space = openmc.stats.Box((-34.015, -11.26, -1.0), (-7.025, 11.26, 1.0))
