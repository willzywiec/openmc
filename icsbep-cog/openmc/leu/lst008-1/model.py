"""
LST008-1: STACY 60cm diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=955 reflected with (C50) concrete (Run 74)
...
mat1.add_nuclide("U234", 4.944500e-07)
mat1.add_nuclide("U235", 6.135700e-05)
mat1.add_nuclide("U236", 6.128100e-08)
mat1.add_nuclide("U238", 5.465200e-04)
mat1.add_nuclide("H1", 5.858500e-02)
mat1.add_element("N", 2.463400e-03)
mat1.add_nuclide("O16", 3.727600e-02)
...
# = 30.63 + 4.94 (Concrete)
surf17 = openmc.ZCylinder(surface_id=17, r=35.57)
# = 35.57 + 0.80 (Outer Wall)
surf18 = openmc.ZCylinder(surface_id=18, r=36.37)
# BCD
...
source.space = openmc.stats.Point((0.0, 0.0, 39.995))
