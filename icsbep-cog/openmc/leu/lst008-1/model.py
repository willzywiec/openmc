...
surf13 = openmc.ZCylinder(surface_id=13, x0=-1.5, y0=0.0, r=36.37)
# Steel reflector top plate
surf14 = openmc.ZCylinder(surface_id=14, x0=142.0, y0=142.6, r=36.37)
...
# = 30.63 + 4.94 (Concrete)
surf17 = openmc.ZCylinder(surface_id=17, x0=0.0, y0=142.0, r=35.57)
# = 35.57 + 0.80 (Outer Wall)
surf18 = openmc.ZCylinder(surface_id=18, x0=0.0, y0=142.0, r=36.37)
# BCD
