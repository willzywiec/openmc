"""
LST018-5: Concrete reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=733 (Run 145)
...
mat1.add_nuclide("U234", 6.459500e-07)
mat1.add_nuclide("U235", 8.015800e-05)
mat1.add_nuclide("U236", 8.005800e-08)
mat1.add_nuclide("U238", 7.139800e-04)
mat1.add_nuclide("H1", 5.874700e-02)
mat1.add_element("N", 2.164800e-03)
mat1.add_nuclide("O16", 3.717000e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=65.56)
# C50
surf11 = openmc.model.RectangularParallelepiped(-22.61, -17.6, -35.7, 35.7, 0.0, 150.6)
# Steel Frame
surf12 = openmc.model.RectangularParallelepiped(-22.61, -17.6, -38.7, 38.7, -3.0, 153.6)
# Aluminum
surf13 = openmc.model.RectangularParallelepiped(-23.42, -16.79, -38.7, 38.7, -3.0, 153.6)
# C50
surf21 = openmc.model.RectangularParallelepiped(17.6, 22.61, -35.7, 35.7, 0.0, 150.6)
# Steel Frame
surf22 = openmc.model.RectangularParallelepiped(17.6, 22.61, -38.7, 38.7, -3.0, 153.6)
# Aluminum
surf23 = openmc.model.RectangularParallelepiped(16.79, 23.42, -38.7, 38.7, -3.0, 153.6)
# C150
surf31 = openmc.model.RectangularParallelepiped(-39.31, -24.31, -35.7, 35.7, 0.0, 150.6)
# Steel Frame
surf32 = openmc.model.RectangularParallelepiped(-39.31, -24.31, -38.7, 38.7, -3.0, 153.6)
# Aluminum
surf33 = openmc.model.RectangularParallelepiped(-40.12, -23.5, -38.7, 38.7, -3.0, 153.6)
# C150
surf41 = openmc.model.RectangularParallelepiped(24.31, 39.31, -35.7, 35.7, 0.0, 150.6)
# Steel Frame
surf42 = openmc.model.RectangularParallelepiped(24.31, 39.31, -38.7, 38.7, -3.0, 153.6)
# Aluminum
surf43 = openmc.model.RectangularParallelepiped(23.5, 40.12, -38.7, 38.7, -3.0, 153.6)
# BCD
...
source.space = openmc.stats.Point((0.0, 0.0, 32.78))
