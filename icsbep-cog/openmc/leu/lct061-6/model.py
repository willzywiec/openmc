"""
LCT061-6: 762 U(4.5)O2 rods, 7 Hf tubes, 1.27 cm trianglur pitch, Hc=77.66cm, water
...
surf1 = openmc.ZPlane(surface_id=1, z0=77.66)
...
source.space = openmc.stats.Box((-2.27, -2.09985, 37.83), (2.27, 2.09985, 39.83))
