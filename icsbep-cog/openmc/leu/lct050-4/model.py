"""
LCT050-4: Exp. No. 2765; 23x23-25=504 array of U(4.738)O2 rods on 1.3cm pitch; boron solution no. 1
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=87.88)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 42.94), (5.55, 5.55, 44.94))
