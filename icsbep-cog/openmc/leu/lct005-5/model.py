...
surf101 = openmc.ZCylinder(surface_id=101, x0=-6.3035, y0=17.156832, r=0.714)
surf102 = openmc.ZCylinder(surface_id=102, x0=-4.5025, y0=17.156832, r=0.714)
surf103 = openmc.ZCylinder(surface_id=103, x0=-2.7015, y0=17.156832, r=0.714)
surf104 = openmc.ZCylinder(surface_id=104, x0=-0.9005, y0=17.156832, r=0.714)
surf105 = openmc.ZCylinder(surface_id=105, x0=0.9005, y0=17.156832, r=0.714)
surf106 = openmc.ZCylinder(surface_id=106, x0=2.7015, y0=17.156832, r=0.714)
surf107 = openmc.ZCylinder(surface_id=107, x0=4.5025, y0=17.156832, r=0.714)
surf108 = openmc.ZCylinder(surface_id=108, x0=6.3035, y0=17.156832, r=0.714)
surf109 = openmc.ZCylinder(surface_id=109, x0=-9.005, y0=15.59712, r=0.714)
surf110 = openmc.ZCylinder(surface_id=110, x0=9.005, y0=15.59712, r=0.714)
surf111 = openmc.ZCylinder(surface_id=111, x0=-11.7065, y0=14.037408, r=0.714)
surf112 = openmc.ZCylinder(surface_id=112, x0=11.7065, y0=14.037408, r=0.714)
surf113 = openmc.ZCylinder(surface_id=113, x0=-12.607, y0=12.477696, r=0.714)
surf114 = openmc.ZCylinder(surface_id=114, x0=12.607, y0=12.477696, r=0.714)
surf115 = openmc.ZCylinder(surface_id=115, x0=-13.5075, y0=10.917984, r=0.714)
surf116 = openmc.ZCylinder(surface_id=116, x0=13.5075, y0=10.917984, r=0.714)
surf117 = openmc.ZCylinder(surface_id=117, x0=-14.408, y0=9.358272, r=0.714)
surf118 = openmc.ZCylinder(surface_id=118, x0=14.408, y0=9.358272, r=0.714)
surf119 = openmc.ZCylinder(surface_id=119, x0=-15.3085, y0=7.79856, r=0.714)
surf120 = openmc.ZCylinder(surface_id=120, x0=15.3085, y0=7.79856, r=0.714)
surf121 = openmc.ZCylinder(surface_id=121, x0=-16.209, y0=6.238848, r=0.714)
surf122 = openmc.ZCylinder(surface_id=122, x0=16.209, y0=6.238848, r=0.714)
surf123 = openmc.ZCylinder(surface_id=123, x0=-17.1095, y0=4.679136, r=0.714)
surf124 = openmc.ZCylinder(surface_id=124, x0=17.1095, y0=4.679136, r=0.714)
surf125 = openmc.ZCylinder(surface_id=125, x0=-18.01, y0=3.119424, r=0.714)
surf126 = openmc.ZCylinder(surface_id=126, x0=18.01, y0=3.119424, r=0.714)
surf127 = openmc.ZCylinder(surface_id=127, x0=-18.01, y0=0.0, r=0.714)
surf128 = openmc.ZCylinder(surface_id=128, x0=18.01, y0=0.0, r=0.714)
surf129 = openmc.ZCylinder(surface_id=129, x0=-18.01, y0=-3.119424, r=0.714)
surf130 = openmc.ZCylinder(surface_id=130, x0=18.01, y0=-3.119424, r=0.714)
surf131 = openmc.ZCylinder(surface_id=131, x0=-17.1095, y0=-4.679136, r=0.714)
surf132 = openmc.ZCylinder(surface_id=132, x0=17.1095, y0=-4.679136, r=0.714)
surf133 = openmc.ZCylinder(surface_id=133, x0=-16.209, y0=-6.238848, r=0.714)
surf134 = openmc.ZCylinder(surface_id=134, x0=16.209, y0=-6.238848, r=0.714)
surf135 = openmc.ZCylinder(surface_id=135, x0=-15.3085, y0=-7.79856, r=0.714)
surf136 = openmc.ZCylinder(surface_id=136, x0=15.3085, y0=-7.79856, r=0.714)
surf137 = openmc.ZCylinder(surface_id=137, x0=-14.408, y0=-9.358272, r=0.714)
surf138 = openmc.ZCylinder(surface_id=138, x0=14.408, y0=-9.358272, r=0.714)
surf139 = openmc.ZCylinder(surface_id=139, x0=-13.5075, y0=-10.917984, r=0.714)
surf140 = openmc.ZCylinder(surface_id=140, x0=13.5075, y0=-10.917984, r=0.714)
surf141 = openmc.ZCylinder(surface_id=141, x0=-12.607, y0=-12.477696, r=0.714)
surf142 = openmc.ZCylinder(surface_id=142, x0=12.607, y0=-12.477696, r=0.714)
surf143 = openmc.ZCylinder(surface_id=143, x0=-11.7065, y0=-14.037408, r=0.714)
surf144 = openmc.ZCylinder(surface_id=144, x0=11.7065, y0=-14.037408, r=0.714)
surf145 = openmc.ZCylinder(surface_id=145, x0=-9.005, y0=-15.59712, r=0.714)
surf146 = openmc.ZCylinder(surface_id=146, x0=9.005, y0=-15.59712, r=0.714)
surf147 = openmc.ZCylinder(surface_id=147, x0=-6.3035, y0=-17.156832, r=0.714)
surf148 = openmc.ZCylinder(surface_id=148, x0=-4.5025, y0=-17.156832, r=0.714)
surf149 = openmc.ZCylinder(surface_id=149, x0=-2.7015, y0=-17.156832, r=0.714)
surf150 = openmc.ZCylinder(surface_id=150, x0=-0.9005, y0=-17.156832, r=0.714)
surf151 = openmc.ZCylinder(surface_id=151, x0=0.9005, y0=-17.156832, r=0.714)
surf152 = openmc.ZCylinder(surface_id=152, x0=2.7015, y0=-17.156832, r=0.714)
surf153 = openmc.ZCylinder(surface_id=153, x0=4.5025, y0=-17.156832, r=0.714)
surf154 = openmc.ZCylinder(surface_id=154, x0=6.3035, y0=-17.156832, r=0.714)
...
cell1.region = (-surf1 & +surf1_zmin & -surf1_zmax) & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5 & -surf21_6 & -surf21_7 & -surf21_8 & -surf21_9 & -surf21_10 & -surf21_11) & +surf129

# water
cell2 = openmc.Cell(cell_id=2, fill=mat6)
cell2.region = (-surf1 & +surf1_zmin & -surf1_zmax) & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5 & -surf21_6 & -surf21_7 & -surf21_8 & -surf21_9 & -surf21_10 & -surf21_11) & -surf129
