...
surf20 = openmc.ZCylinder(surface_id=20, x0=-28.1975, y0=28.1975, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-28.1975, y0=28.1975, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-1.13, y0=28.33, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-28.33, y0=1.13, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=28.1975, y0=28.1975, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=28.1975, y0=28.1975, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=1.13, y0=28.33, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=28.33, y0=1.13, r=0.5)
