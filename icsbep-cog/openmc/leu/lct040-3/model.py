"""
LCT040-3: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.155cm borated steel, 2.0cm water gap, Hc=36.13cm, 2.5 cm gap between lead reflector
...
surf5 = openmc.ZPlane(surface_id=5, z0=36.13)
# Lower grid plate
...
surf20 = openmc.ZCylinder(surface_id=20, x0=-29.0225, y0=29.0225, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-29.0225, y0=29.0225, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-1.955, y0=28.655, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-28.655, y0=1.955, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-1.955, y0=1.955, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=29.0225, y0=29.0225, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=29.0225, y0=29.0225, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=1.955, y0=29.155, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=29.155, y0=1.955, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=1.955, y0=1.955, r=0.5)
# Inner: 2(2.5)+4(0.155)+18(2)(1.6)+2.0 = 65.22
surf41 = openmc.model.RectangularParallelepiped(-32.61, 32.61, -32.61, 32.61, -2.200000000000003, 92.8)
# Outer: 2(10.0) + 65.22 = 85.22
surf42 = openmc.model.RectangularParallelepiped(-42.61, 42.61, -42.61, 42.61, -2.200000000000003, 92.8)

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1042, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1043, z0=90.0)
surf2_zmin = openmc.ZPlane(surface_id=1044, z0=0.0)
surf2_zmax = openmc.ZPlane(surface_id=1045, z0=96.9)
surf3_zmin = openmc.ZPlane(surface_id=1046, z0=-1.27)
surf3_zmax = openmc.ZPlane(surface_id=1047, z0=98.2)
surf4_zmin = openmc.ZPlane(surface_id=1048, z0=-1.27)
surf4_zmax = openmc.ZPlane(surface_id=1049, z0=98.2)
...
cell13.region = +surf18 & +surf41 & -surf42
...
source.space = openmc.stats.Box((-30.155, -30.155, 17.065), (30.155, 30.155, 19.065))
