"""
LEU-COMP-THERM-009-23: (15x8)-3.5397cm-(0.2006cm Cd)-3.5397cm-(15x8)-3.5397cm-(0.2006cm Cd)-3.5397cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
mat6.add_element("Cd", 4.620100e-02)
mat6.add_element("Zn", 2.389900e-04)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-64.43, 64.43, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-94.43, 94.43, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-26.33)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=26.33)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-22.790300000000002, -22.5897, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(22.5897, 22.790300000000002, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-45.38, 0.0, 0.0)
...
cell5.translation = (45.38, 0.0, 0.0)
...
source.space = openmc.stats.Box((-46.38, -2.27, 45.0375), (46.38, 2.27, 47.0375))
