"""
LST011-5: Water reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=954 (Run 471)
...
mat1.add_nuclide("U234", 4.816800e-07)
mat1.add_nuclide("U235", 5.765100e-05)
mat1.add_nuclide("U236", 9.551900e-08)
mat1.add_nuclide("U238", 8.896500e-04)
mat1.add_nuclide("H1", 5.742100e-02)
mat1.add_element("N", 2.522100e-03)
mat1.add_nuclide("O16", 3.785900e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=76.21)
...
source.space = openmc.stats.Point((0.0, 0.0, 38.105))
