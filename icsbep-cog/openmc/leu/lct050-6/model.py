"""
LCT050-6: Exp. No. 2767; 25x25-25=600 array of U(4.738)O2 rods on 1.3cm pitch; boron solution no. 2
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=80.57)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 39.285), (5.55, 5.55, 41.285))
