"""
LST024-2: STACY two slabs of 10% 235U uranyl nitrate with polyethylene (P25) isolator
...
mat1.add_nuclide("U234", 6.078700e-07)
mat1.add_nuclide("U235", 7.543200e-05)
mat1.add_nuclide("U236", 7.533800e-08)
mat1.add_nuclide("U238", 6.718800e-04)
mat1.add_nuclide("H1", 5.935200e-02)
mat1.add_element("N", 2.001900e-03)
...
# Critical height
surf5 = openmc.ZPlane(surface_id=5, z0=58.58)
# Polyethylene
surf6 = openmc.model.RectangularParallelepiped(-1.27, 1.27, -35.7, 35.7, 0.0, 150.6)
# SST frame
surf7 = openmc.model.RectangularParallelepiped(-1.27, 1.27, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover
surf8 = openmc.model.RectangularParallelepiped(-2.08, 2.08, -38.7, 38.7, -3.0, 153.6)
# BCD
...
source.space = openmc.stats.Box((-22.4815, -1.0, 28.29), (22.4815, 1.0, 30.29))
