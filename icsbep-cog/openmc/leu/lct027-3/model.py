"""
LCT027-3: 14x14 array reflected by lead with no 1.0 cm water gap
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=72.99)
# Array boundary
...
# Hole
surf14 = openmc.ZCylinder(surface_id=14, x0=-1.8, y0=98.2, r=0.5)
# Basket bottom plate
...
# Source support rod
surf20 = openmc.ZCylinder(surface_id=20, x0=46.8, y0=103.4, r=0.3)
...
# Lead #1 Xo=-18.8+1.0=-17.8; Yo=-26.2-1.0=-27.2
surf25 = openmc.model.RectangularParallelepiped(-47.8, 12.2, -42.2, -12.2, -3.200000000000003, 91.8)
# Lead #2
surf26 = openmc.model.RectangularParallelepiped(-12.2, 47.8, 12.2, 42.2, -3.200000000000003, 91.8)
# Lead #3 Xo=-26.2-1.0=-27.2; Yo=18.8-1.0=17.8
surf27 = openmc.model.RectangularParallelepiped(-42.2, -12.2, -12.2, 47.8, -3.200000000000003, 91.8)
# Lead #4
surf28 = openmc.model.RectangularParallelepiped(12.2, 42.2, -47.8, 12.2, -3.200000000000003, 91.8)
# BCD
...
cell1.region = -surf2 & +surf3 & +surf4 & +surf5 & +surf6 & +surf7 & +surf8 & +surf9 & +surf10 & +surf20 & +surf22 & -surf99
...
cell9.region = +surf2 & +surf22 & -surf25 & -surf26 & -surf27 & -surf28
...
cell24.region = +surf1 & +surf15 & +surf16 & +surf17 & +surf18
...
source.space = openmc.stats.Box((-1.8, -1.8, 35.495), (1.8, 1.8, 37.495))
