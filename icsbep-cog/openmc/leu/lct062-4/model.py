"""
LCT062-4: 18x18 array of U(2.6)O2 rods on 1.9558cm pitch with 0.5820cm SST plate, 0.9779cm gap (TCA)
...
mat6.add_element("C", 2.386200e-04)
mat6.add_element("Si", 7.653400e-04)
mat6.add_element("Mn", 7.216500e-04)
mat6.add_element("P", 4.009600e-05)
mat6.add_element("S", 1.191600e-05)
mat6.add_element("Cr", 1.674700e-02)
mat6.add_element("Ni", 7.080700e-03)
mat6.add_element("Fe", 6.132200e-02)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=89.85)
# Array boundary
...
surf31 = openmc.model.RectangularParallelepiped(18.580099999999998, 19.1621, -22.5, 22.5, 0.37000000000000455, 150.37)
...
source.space = openmc.stats.Box((-1.98, -1.98, 43.925), (1.98, 1.98, 45.925))
