"""
LMT006-23: Bugey case 45; 40 type 1 tubes; 10.2cm pitch; Hw=59.60cm
...
surf904 = openmc.ZPlane(surface_id=904, z0=59.60)
# Boundary condition
...
cell8.translation = (-40.0, 21.2, 0.0)
cell8.region = -surf107 & +surf903 & -surf904 & -surf999

# Ftube
cell9 = openmc.Cell(cell_id=9, fill=universe3)
cell9.translation = (-29.8, -40.0, 0.0)
cell9.region = -surf111 & +surf903 & -surf904 & -surf999

# Ftube
cell10 = openmc.Cell(cell_id=10, fill=universe3)
cell10.translation = (-29.8, -29.8, 0.0)
cell10.region = -surf112 & +surf903 & -surf904 & -surf999

# Ftube
cell11 = openmc.Cell(cell_id=11, fill=universe3)
cell11.translation = (-29.8, -19.6, 0.0)
cell11.region = -surf113 & +surf903 & -surf904 & -surf999

# Ftube
cell12 = openmc.Cell(cell_id=12, fill=universe3)
cell12.translation = (-29.8, -9.4, 0.0)
cell12.region = -surf114 & +surf903 & -surf904 & -surf999

# Ftube
cell13 = openmc.Cell(cell_id=13, fill=universe3)
cell13.translation = (-29.8, 0.8, 0.0)
cell13.region = -surf115 & +surf903 & -surf904 & -surf999

# Ftube
cell14 = openmc.Cell(cell_id=14, fill=universe3)
cell14.translation = (-29.8, 11.0, 0.0)
cell14.region = -surf116 & +surf903 & -surf904 & -surf999

# Ftube
cell15 = openmc.Cell(cell_id=15, fill=universe3)
cell15.translation = (-29.8, 21.2, 0.0)
cell15.region = -surf117 & +surf903 & -surf904 & -surf999

# Ftube
cell16 = openmc.Cell(cell_id=16, fill=universe3)
cell16.translation = (-19.6, -40.0, 0.0)
cell16.region = -surf121 & +surf903 & -surf904 & -surf999

# Ftube
cell17 = openmc.Cell(cell_id=17, fill=universe3)
cell17.translation = (-19.6, -29.8, 0.0)
cell17.region = -surf122 & +surf903 & -surf904 & -surf999

# Ftube
cell18 = openmc.Cell(cell_id=18, fill=universe3)
cell18.translation = (-19.6, -19.6, 0.0)
cell18.region = -surf123 & +surf903 & -surf904 & -surf999

# Ftube
cell19 = openmc.Cell(cell_id=19, fill=universe3)
cell19.translation = (-19.6, -9.4, 0.0)
cell19.region = -surf124 & +surf903 & -surf904 & -surf999

# Ftube
cell20 = openmc.Cell(cell_id=20, fill=universe3)
cell20.translation = (-19.6, 0.8, 0.0)
cell20.region = -surf125 & +surf903 & -surf904 & -surf999

# Ftube
cell21 = openmc.Cell(cell_id=21, fill=universe3)
cell21.translation = (-19.6, 11.0, 0.0)
cell21.region = -surf126 & +surf903 & -surf904 & -surf999

# Ftube
cell22 = openmc.Cell(cell_id=22, fill=universe3)
cell22.translation = (-19.6, 21.2, 0.0)
cell22.region = -surf127 & +surf903 & -surf904 & -surf999

# Ftube
cell23 = openmc.Cell(cell_id=23, fill=universe3)
cell23.translation = (-9.4, -40.0, 0.0)
cell23.region = -surf131 & +surf903 & -surf904 & -surf999

# Ftube
cell24 = openmc.Cell(cell_id=24, fill=universe3)
cell24.translation = (-9.4, -29.8, 0.0)
cell24.region = -surf132 & +surf903 & -surf904 & -surf999

# Ftube
cell25 = openmc.Cell(cell_id=25, fill=universe3)
cell25.translation = (-9.4, -19.6, 0.0)
cell25.region = -surf133 & +surf903 & -surf904 & -surf999

# Ftube
cell26 = openmc.Cell(cell_id=26, fill=universe3)
cell26.translation = (-9.4, -9.4, 0.0)
cell26.region = -surf134 & +surf903 & -surf904 & -surf999

# Ftube
cell27 = openmc.Cell(cell_id=27, fill=universe3)
cell27.translation = (-9.4, 0.8, 0.0)
cell27.region = -surf135 & +surf903 & -surf904 & -surf999

# Ftube
cell28 = openmc.Cell(cell_id=28, fill=universe3)
cell28.translation = (-9.4, 11.0, 0.0)
cell28.region = -surf136 & +surf903 & -surf904 & -surf999

# Ftube
cell29 = openmc.Cell(cell_id=29, fill=universe3)
cell29.translation = (-9.4, 21.2, 0.0)
cell29.region = -surf137 & +surf903 & -surf904 & -surf999

# Ftube
cell30 = openmc.Cell(cell_id=30, fill=universe3)
cell30.translation = (0.8, -40.0, 0.0)
cell30.region = -surf141 & +surf903 & -surf904 & -surf999

# Ftube
cell31 = openmc.Cell(cell_id=31, fill=universe3)
cell31.translation = (0.8, -29.8, 0.0)
cell31.region = -surf142 & +surf903 & -surf904 & -surf999

# Ftube
cell32 = openmc.Cell(cell_id=32, fill=universe3)
cell32.translation = (0.8, -19.6, 0.0)
cell32.region = -surf143 & +surf903 & -surf904 & -surf999

# Ftube
cell33 = openmc.Cell(cell_id=33, fill=universe3)
cell33.translation = (0.8, -9.4, 0.0)
cell33.region = -surf144 & +surf903 & -surf904 & -surf999

# Ftube
cell34 = openmc.Cell(cell_id=34, fill=universe3)
cell34.translation = (0.8, 0.8, 0.0)
cell34.region = -surf145 & +surf903 & -surf904 & -surf999

# Ftube
cell35 = openmc.Cell(cell_id=35, fill=universe3)
cell35.translation = (0.8, 11.0, 0.0)
cell35.region = -surf146 & +surf903 & -surf904 & -surf999

# Ftube
cell36 = openmc.Cell(cell_id=36, fill=universe3)
cell36.translation = (0.8, 21.2, 0.0)
cell36.region = -surf147 & +surf903 & -surf904 & -surf999

# Ftube
cell37 = openmc.Cell(cell_id=37, fill=universe3)
cell37.translation = (11.0, -29.8, 0.0)
cell37.region = -surf151 & +surf903 & -surf904 & -surf999

# Ftube
cell38 = openmc.Cell(cell_id=38, fill=universe3)
cell38.translation = (11.0, -19.6, 0.0)
cell38.region = -surf152 & +surf903 & -surf904 & -surf999

# Ftube
cell39 = openmc.Cell(cell_id=39, fill=universe3)
cell39.translation = (11.0, -9.4, 0.0)
cell39.region = -surf153 & +surf903 & -surf904 & -surf999

# Ftube
cell40 = openmc.Cell(cell_id=40, fill=universe3)
cell40.translation = (11.0, 0.8, 0.0)
cell40.region = -surf154 & +surf903 & -surf904 & -surf999

# Ftube
cell41 = openmc.Cell(cell_id=41, fill=universe3)
cell41.translation = (11.0, 11.0, 0.0)
cell41.region = -surf155 & +surf903 & -surf904 & -surf999

# Water
cell42 = openmc.Cell(cell_id=42, fill=mat2)
cell42.region = +surf903 & -surf904 & -surf999 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107
