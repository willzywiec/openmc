"""
LEU-COMP-THERM-010-16: (12x16)-15.393cm-(12x16)-15.393cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; Steel walls; 1.321 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -34.307, -16.457, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 16.457, 34.307, -20.0625, 101.8375)
...
cell1.translation = (-38.097, 0.0, 0.0)
...
cell5.translation = (38.097, 0.0, 0.0)
...
source.space = openmc.stats.Box((-38.151, -2.27, 45.0375), (38.151, 2.27, 47.0375))
