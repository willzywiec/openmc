"""
LMT006-29: Bugey case 42; 46 type 1 tubes; 11.2cm pitch; Hw=65.65cm
...
# ditto
surf162 = openmc.ZCylinder(surface_id=162, x0=27.2, y0=-6.4, r=4.85)
# ditto
surf163 = openmc.ZCylinder(surface_id=163, x0=27.2, y0=4.8, r=4.85)
# ditto
surf164 = openmc.ZCylinder(surface_id=164, x0=27.2, y0=27.2, r=4.85)
# Arbitrary
...
surf904 = openmc.ZPlane(surface_id=904, z0=65.65)
# Boundary condition
...
cell45.translation = (27.2, -6.4, 0.0)
cell45.region = -surf162 & +surf903 & -surf900 & -surf999

# Ftube
cell46 = openmc.Cell(cell_id=46, fill=universe3)
cell46.translation = (27.2, 4.8, 0.0)
cell46.region = -surf163 & +surf903 & -surf900 & -surf999

# Ftube
cell47 = openmc.Cell(cell_id=47, fill=universe3)
cell47.translation = (27.2, 27.2, 0.0)
cell47.region = -surf164 & +surf903 & -surf900 & -surf999

# Water
cell48 = openmc.Cell(cell_id=48, fill=mat2)
cell48.region = +surf903 & -surf900 & -surf999 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107

# Plate
cell49 = openmc.Cell(cell_id=49, fill=mat4)
cell49.region = -surf3 & +surf902 & -surf903 & -surf999
...
cell51.region = +surf901 & -surf902 & -surf999
