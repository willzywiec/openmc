"""
LCT712-4: 35x35=1225 U(4.738)O2 Zr-4 clad rods with 1.075cm pitch; Hc=87.286cm
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=87.286)
# Array boundary
surf2 = openmc.model.RectangularParallelepiped(-19.35, 19.35, -19.35, 19.35, -499.995, 499.995)
# AGM3 top plate
...
# AGM3 bottom grid (case 4)
surf5 = openmc.model.RectangularParallelepiped(-21.3125, 21.3125, -21.3125, 21.3125, -0.4, 0.0)
# AGM3 bottom plate
...
lattice4.lower_left = [-19.35, -19.35]
lattice4.pitch = [1.075000, 1.075000]
lattice4.universes = [
...
source.space = openmc.stats.Box((-1.5375, -2.075, 42.643), (2.075, 1.5375, 44.643))
