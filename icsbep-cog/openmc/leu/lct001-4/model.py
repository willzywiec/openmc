"""
LCT001-4: (22x16)-10.05cm-(20x16)-10.05cm-(22x16) array of U(2.35)O2 fuel rods with 2.032 cm pitch (SSC-2.35-000-018)
...
surf1 = openmc.model.RectangularParallelepiped(-74.741, 74.741, -16.256, 16.256, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-104.741, 104.741, -46.256, 46.256, -19.11, 106.44, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-30.037)
surf4 = openmc.XPlane(surface_id=4, x0=-20.32)
surf5 = openmc.XPlane(surface_id=5, x0=20.32)
surf6 = openmc.XPlane(surface_id=6, x0=30.037)
# Al-5052 lower plug
...
# Lattice 3: 22x16 array
lattice3 = openmc.RectLattice(lattice_id=3)
lattice3.lower_left = [-22.352, -16.256]
...
cell1.translation = (-52.389, 0.0, 0.0)
...
cell5.translation = (52.389, 0.0, 0.0)
...
source.space = openmc.stats.Box((-2.016, -2.016, 44.72), (2.016, 2.016, 46.72))
