"""
LST025-4: STACY two slabs of 10% 235U uranyl nitrate with concrete (C150,C50) isolators
...
mat1.add_nuclide("U234", 6.010800e-07)
mat1.add_nuclide("U235", 7.458900e-05)
mat1.add_nuclide("U236", 7.449600e-08)
mat1.add_nuclide("U238", 6.643800e-04)
mat1.add_nuclide("H1", 5.946300e-02)
mat1.add_element("N", 1.985100e-03)
mat1.add_nuclide("O16", 3.691300e-02)
...
# Critical height
surf5 = openmc.ZPlane(surface_id=5, z0=64.22)
# Concrete
...
# BCD
surf20 = openmc.model.RectangularParallelepiped(-50.3255, 50.3255, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
# LHS SST tank
surf21 = openmc.model.RectangularParallelepiped(-50.325500000000005, -11.7045, -36.6005, 36.6005, -2.060999999999993, 152.183)
# C150 isolator
surf22 = openmc.model.RectangularParallelepiped(-11.6515, 4.968500000000001, -38.7, 38.7, -3.0, 153.6)
# C50 isolator
surf23 = openmc.model.RectangularParallelepiped(5.0215, 11.651499999999999, -38.7, 38.7, -3.0, 153.6)
# RHS SST tank
surf24 = openmc.model.RectangularParallelepiped(11.7045, 50.325500000000005, -36.6005, 36.6005, -2.060999999999993, 152.183)
...
source.space = openmc.stats.Box((-32.015, -1.0, 31.11), (32.015, 1.0, 33.11))
