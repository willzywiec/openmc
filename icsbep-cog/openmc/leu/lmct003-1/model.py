"""
LMCT003-1: STACY run 411 with U(5)O2 rods immersed in 43.49cm of U(6) uranyl nitrate solution, unreflected
...
mat1.add_nuclide("U234", 4.912000e-07)
mat1.add_nuclide("U235", 5.859500e-05)
mat1.add_nuclide("U236", 9.740700e-08)
mat1.add_nuclide("U238", 9.074300e-04)
mat1.add_nuclide("O16", 3.853800e-02)
mat1.add_nuclide("H1", 5.561900e-02)
mat1.add_element("N", 3.131600e-03)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=43.49)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 21.745))
