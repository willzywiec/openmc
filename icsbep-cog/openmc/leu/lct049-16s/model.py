"""
LCT049-16S: Simplified model of R1-2R(5,5) with H/U=2 & 3 (checkerboard) and d=1.35cm
...
cell1.region = +surf11 & -surf17 & +surf21 & -surf28 & +surf31 & -surf38
...
source.space = openmc.stats.Box((-22.195, -1.0, -1.0), (22.195, 1.0, 1.0))
