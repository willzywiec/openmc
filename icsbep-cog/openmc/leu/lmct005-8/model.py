"""
LMCT005-8: STACY run 515 with U(5)O2 rods immersed in 57.08cm of U(6) uranyl nitrate, Sm, Cs, and Rh solution with water reflection
...
mat1.add_nuclide("U234", 4.083500e-07)
mat1.add_nuclide("U235", 4.879300e-05)
mat1.add_nuclide("U236", 8.097600e-08)
mat1.add_nuclide("U238", 7.542900e-04)
mat1.add_nuclide("O16", 3.800100e-02)
mat1.add_nuclide("H1", 5.705500e-02)
mat1.add_element("N", 2.818700e-03)
mat1.add_element("Sm", 5.246700e-07)
mat1.add_element("Cs", 1.422800e-05)
mat1.add_element("Rh", 5.149800e-06)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=57.08)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 28.54))
