"""
LT003-3: ZED-2 with 21.59 cm triangular pitch and Hc = 166.720 cm
...
mat2.add_nuclide("H1", 5.212300e-04)
mat2.add_nuclide("H2", 6.594200e-02)
...
# D2O (Hc)
surf8 = openmc.ZPlane(surface_id=8, z0=166.720)
# Sheath, inner
...
# Lattice boundary
surf23 = openmc.model.RectangularParallelepiped(-113.3475, 113.3475, -102.836195, 102.836195, -499.95, 499.95)
# Dump line inner - 1st
...
surf51 = openmc.model.RectangularParallelepiped(-200.422, 200.422, 124.34243, 129.42243, 366.42499999999995, 395.0)
surf52 = openmc.model.RectangularParallelepiped(-200.422, 200.422, 105.64493999999999, 110.72494, 366.42499999999995, 395.0)
surf53 = openmc.model.RectangularParallelepiped(-200.422, 200.422, 86.94744999999999, 92.02745, 366.42499999999995, 395.0)
surf54 = openmc.model.RectangularParallelepiped(-200.422, 200.422, 68.24995999999999, 73.32996, 366.42499999999995, 395.0)
surf55 = openmc.model.RectangularParallelepiped(-200.422, 200.422, 49.55247, 54.63247, 366.42499999999995, 395.0)
surf56 = openmc.model.RectangularParallelepiped(-200.422, 200.422, 30.854979999999998, 35.934979999999996, 366.42499999999995, 395.0)
surf57 = openmc.model.RectangularParallelepiped(-200.422, 200.422, 12.15749, 17.23749, 366.42499999999995, 395.0)
surf58 = openmc.model.RectangularParallelepiped(-200.422, 200.422, -25.237489999999998, -20.15749, 366.42499999999995, 395.0)
surf59 = openmc.model.RectangularParallelepiped(-200.422, 200.422, -43.934979999999996, -38.85498, 366.42499999999995, 395.0)
surf60 = openmc.model.RectangularParallelepiped(-200.422, 200.422, -62.63247, -57.55247, 366.42499999999995, 395.0)
surf61 = openmc.model.RectangularParallelepiped(-200.422, 200.422, -81.32996, -76.24995999999999, 366.42499999999995, 395.0)
surf62 = openmc.model.RectangularParallelepiped(-200.422, 200.422, -100.02745, -94.94744999999999, 366.42499999999995, 395.0)
surf63 = openmc.model.RectangularParallelepiped(-200.422, 200.422, -118.72494, -113.64493999999999, 366.42499999999995, 395.0)
...
surf1_zmin = openmc.ZPlane(z0=15.0)
surf1_zmax = openmc.ZPlane(z0=304.741)
surf2_zmin = openmc.ZPlane(z0=15.0)
surf2_zmax = openmc.ZPlane(z0=306.053)
surf3_zmin = openmc.ZPlane(z0=14.53)
surf3_zmax = openmc.ZPlane(z0=306.053)
surf4_zmin = openmc.ZPlane(z0=305.953)
surf4_zmax = openmc.ZPlane(z0=306.053)
surf5_zmin = openmc.ZPlane(z0=14.53)
surf5_zmax = openmc.ZPlane(z0=14.85)
surf6_zmin = openmc.ZPlane(z0=14.53)
surf6_zmax = openmc.ZPlane(z0=307.958)
surf14_zmin = openmc.ZPlane(z0=279.14)
surf14_zmax = openmc.ZPlane(z0=324.86)
surf17_zmin = openmc.ZPlane(z0=355.63)
surf17_zmax = openmc.ZPlane(z0=402.38)
surf21_zmin = openmc.ZPlane(z0=0.0)
surf21_zmax = openmc.ZPlane(z0=333.0)
surf22_zmin = openmc.ZPlane(z0=-2.69)
surf22_zmax = openmc.ZPlane(z0=333.0)
surf33_zmin = openmc.ZPlane(z0=308.6)
surf33_zmax = openmc.ZPlane(z0=320.6)
surf34_zmin = openmc.ZPlane(z0=307.6)
surf34_zmax = openmc.ZPlane(z0=321.6)
surf40_zmin = openmc.ZPlane(z0=-2.69)
surf40_zmax = openmc.ZPlane(z0=315.45)
surf41_zmin = openmc.ZPlane(z0=-92.69)
surf41_zmax = openmc.ZPlane(z0=315.45)
...
lattice4.lower_left = [-113.3475, -102.836195]
lattice4.pitch = [10.795000, 18.697490]
lattice4.universes = [
...
source.space = openmc.stats.Point((0.0, 0.0, 90.86))
