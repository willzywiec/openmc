...
surf20 = openmc.ZCylinder(surface_id=20, x0=-28.6675, y0=28.6675, r=0.7975)
surf21 = openmc.ZCylinder(surface_id=21, x0=-28.6675, y0=28.6675, r=0.9325)
surf22 = openmc.ZCylinder(surface_id=22, x0=-1.6, y0=28.8, r=0.5)
surf23 = openmc.ZCylinder(surface_id=23, x0=-28.8, y0=1.6, r=0.5)
surf24 = openmc.ZCylinder(surface_id=24, x0=-1.6, y0=1.6, r=0.5)
surf25 = openmc.ZCylinder(surface_id=25, x0=28.6675, y0=28.6675, r=0.7975)
surf26 = openmc.ZCylinder(surface_id=26, x0=28.6675, y0=28.6675, r=0.9325)
surf27 = openmc.ZCylinder(surface_id=27, x0=1.6, y0=28.8, r=0.5)
surf28 = openmc.ZCylinder(surface_id=28, x0=28.8, y0=1.6, r=0.5)
surf29 = openmc.ZCylinder(surface_id=29, x0=1.6, y0=1.6, r=0.5)
# Aluminum cover
