"""
LST011-1: Water reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=787 (Run 460)
...
mat1.add_nuclide("U234", 5.888500e-07)
mat1.add_nuclide("U235", 7.047800e-05)
mat1.add_nuclide("U236", 1.167700e-07)
mat1.add_nuclide("U238", 1.087600e-03)
mat1.add_nuclide("H1", 5.547300e-02)
mat1.add_element("N", 2.913700e-03)
mat1.add_nuclide("O16", 3.849700e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=46.85)
...
source.space = openmc.stats.Point((0.0, 0.0, 23.425))
