"""
LMCT006-9: STACY run 557 with U(5)O2 rods immersed in 69.79cm of U(6) uranyl nitrate and Gd solution, unreflected
...
mat1.add_nuclide("U234", 4.240500e-07)
mat1.add_nuclide("U235", 5.066800e-05)
mat1.add_nuclide("U236", 8.408900e-08)
mat1.add_nuclide("U238", 7.832800e-04)
mat1.add_nuclide("O16", 3.807800e-02)
mat1.add_nuclide("H1", 5.680700e-02)
mat1.add_element("N", 2.868200e-03)
mat1.add_element("Gd", 2.910500e-07)
...
# Solution height
surf10 = openmc.ZPlane(surface_id=10, z0=69.79)
# UO2
...
source.space = openmc.stats.Point((0.0, 0.0, 34.895))
