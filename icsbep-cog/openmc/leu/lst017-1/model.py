"""
LST017-1: Unreflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=469 (Run 104)
...
# Hc
surf10 = openmc.ZPlane(surface_id=10, z0=44.92)
...
source.space = openmc.stats.Point((0.0, 0.0, 22.46))
