...
# Void
surf90 = openmc.ZCylinder(surface_id=90, x0=-0.2, y0=128.2, r=0.31)
# Hf tube
surf91 = openmc.ZCylinder(surface_id=91, x0=-2.3, y0=130.3, r=0.41)
# Hf ends
surf92 = openmc.ZCylinder(surface_id=92, x0=-3.8, y0=131.8, r=0.3)
