"""
LCT061-5: 762 U(4.5)O2 rods, 7 Hf tubes, 1.27 cm trianglur pitch, Hc=80.30cm, water
...
surf1 = openmc.ZPlane(surface_id=1, z0=80.30)
...
# Void
surf90 = openmc.ZCylinder(surface_id=90, r=0.31)
# Hf tube
surf91 = openmc.ZCylinder(surface_id=91, r=0.41)
# Hf ends
surf92 = openmc.ZCylinder(surface_id=92, r=0.3)
...
surf90_zmin = openmc.ZPlane(surface_id=1125, z0=-0.2)
surf90_zmax = openmc.ZPlane(surface_id=1126, z0=128.2)
surf91_zmin = openmc.ZPlane(surface_id=1127, z0=-2.3)
surf91_zmax = openmc.ZPlane(surface_id=1128, z0=130.3)
surf92_zmin = openmc.ZPlane(surface_id=1129, z0=-3.8)
surf92_zmax = openmc.ZPlane(surface_id=1130, z0=131.8)
...
u7_cell0.region = (+surf90 | -surf90_zmin | +surf90_zmax) & (-surf91 & +surf91_zmin & -surf91_zmax)
...
source.space = openmc.stats.Box((-2.27, -2.09985, 39.15), (2.207, 2.09985, 41.15))
