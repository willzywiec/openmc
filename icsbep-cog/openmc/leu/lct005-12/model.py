...
surf101 = openmc.ZCylinder(surface_id=101, x0=-9.588, y0=27.67818, r=0.714)
surf102 = openmc.ZCylinder(surface_id=102, x0=-7.99, y0=27.67818, r=0.714)
surf103 = openmc.ZCylinder(surface_id=103, x0=-6.392, y0=27.67818, r=0.714)
surf104 = openmc.ZCylinder(surface_id=104, x0=-4.794, y0=27.67818, r=0.714)
surf105 = openmc.ZCylinder(surface_id=105, x0=-3.196, y0=27.67818, r=0.714)
surf106 = openmc.ZCylinder(surface_id=106, x0=-1.598, y0=27.67818, r=0.714)
surf107 = openmc.ZCylinder(surface_id=107, x0=0.0, y0=27.67818, r=0.714)
surf108 = openmc.ZCylinder(surface_id=108, x0=1.598, y0=27.67818, r=0.714)
surf109 = openmc.ZCylinder(surface_id=109, x0=3.196, y0=27.67818, r=0.714)
surf110 = openmc.ZCylinder(surface_id=110, x0=4.794, y0=27.67818, r=0.714)
surf111 = openmc.ZCylinder(surface_id=111, x0=6.392, y0=27.67818, r=0.714)
surf112 = openmc.ZCylinder(surface_id=112, x0=7.99, y0=27.67818, r=0.714)
surf113 = openmc.ZCylinder(surface_id=113, x0=9.588, y0=27.67818, r=0.714)
surf114 = openmc.ZCylinder(surface_id=114, x0=-11.985, y0=26.294271, r=0.714)
surf115 = openmc.ZCylinder(surface_id=115, x0=11.985, y0=26.294271, r=0.714)
surf116 = openmc.ZCylinder(surface_id=116, x0=-14.382, y0=24.910362, r=0.714)
surf117 = openmc.ZCylinder(surface_id=117, x0=14.382, y0=24.910362, r=0.714)
surf118 = openmc.ZCylinder(surface_id=118, x0=-16.779, y0=23.526453, r=0.714)
surf119 = openmc.ZCylinder(surface_id=119, x0=16.779, y0=23.526453, r=0.714)
surf120 = openmc.ZCylinder(surface_id=120, x0=-19.176, y0=22.142544, r=0.714)
surf121 = openmc.ZCylinder(surface_id=121, x0=19.176, y0=22.142544, r=0.714)
surf122 = openmc.ZCylinder(surface_id=122, x0=-19.975, y0=20.758635, r=0.714)
surf123 = openmc.ZCylinder(surface_id=123, x0=19.975, y0=20.758635, r=0.714)
surf124 = openmc.ZCylinder(surface_id=124, x0=-20.774, y0=19.374726, r=0.714)
surf125 = openmc.ZCylinder(surface_id=125, x0=20.774, y0=19.374726, r=0.714)
surf126 = openmc.ZCylinder(surface_id=126, x0=-21.573, y0=17.990817, r=0.714)
surf127 = openmc.ZCylinder(surface_id=127, x0=21.573, y0=17.990817, r=0.714)
surf128 = openmc.ZCylinder(surface_id=128, x0=-22.372, y0=16.606908, r=0.714)
surf129 = openmc.ZCylinder(surface_id=129, x0=22.372, y0=16.606908, r=0.714)
surf130 = openmc.ZCylinder(surface_id=130, x0=-23.171, y0=15.222999, r=0.714)
surf131 = openmc.ZCylinder(surface_id=131, x0=23.171, y0=15.222999, r=0.714)
surf132 = openmc.ZCylinder(surface_id=132, x0=-23.97, y0=13.83909, r=0.714)
surf133 = openmc.ZCylinder(surface_id=133, x0=23.97, y0=13.83909, r=0.714)
surf134 = openmc.ZCylinder(surface_id=134, x0=-24.769, y0=12.455181, r=0.714)
surf135 = openmc.ZCylinder(surface_id=135, x0=24.769, y0=12.455181, r=0.714)
surf136 = openmc.ZCylinder(surface_id=136, x0=-25.568, y0=11.071272, r=0.714)
surf137 = openmc.ZCylinder(surface_id=137, x0=25.568, y0=11.071272, r=0.714)
surf138 = openmc.ZCylinder(surface_id=138, x0=-26.367, y0=9.687363, r=0.714)
surf139 = openmc.ZCylinder(surface_id=139, x0=26.367, y0=9.687363, r=0.714)
surf140 = openmc.ZCylinder(surface_id=140, x0=-27.166, y0=8.303454, r=0.714)
surf141 = openmc.ZCylinder(surface_id=141, x0=27.166, y0=8.303454, r=0.714)
surf142 = openmc.ZCylinder(surface_id=142, x0=-27.965, y0=6.919545, r=0.714)
surf143 = openmc.ZCylinder(surface_id=143, x0=27.965, y0=6.919545, r=0.714)
surf144 = openmc.ZCylinder(surface_id=144, x0=-28.764, y0=5.535636, r=0.714)
surf145 = openmc.ZCylinder(surface_id=145, x0=28.764, y0=5.535636, r=0.714)
surf146 = openmc.ZCylinder(surface_id=146, x0=-28.764, y0=2.767818, r=0.714)
surf147 = openmc.ZCylinder(surface_id=147, x0=28.764, y0=2.767818, r=0.714)
surf148 = openmc.ZCylinder(surface_id=148, x0=-28.764, y0=0.0, r=0.714)
surf149 = openmc.ZCylinder(surface_id=149, x0=28.764, y0=0.0, r=0.714)
surf150 = openmc.ZCylinder(surface_id=150, x0=-28.764, y0=-2.767818, r=0.714)
surf151 = openmc.ZCylinder(surface_id=151, x0=28.764, y0=-2.767818, r=0.714)
surf152 = openmc.ZCylinder(surface_id=152, x0=-28.764, y0=-5.535636, r=0.714)
surf153 = openmc.ZCylinder(surface_id=153, x0=28.764, y0=-5.535636, r=0.714)
surf154 = openmc.ZCylinder(surface_id=154, x0=-27.965, y0=-6.919545, r=0.714)
surf155 = openmc.ZCylinder(surface_id=155, x0=27.965, y0=-6.919545, r=0.714)
surf156 = openmc.ZCylinder(surface_id=156, x0=-27.166, y0=-8.303454, r=0.714)
surf157 = openmc.ZCylinder(surface_id=157, x0=27.166, y0=-8.303454, r=0.714)
surf158 = openmc.ZCylinder(surface_id=158, x0=-26.367, y0=-9.687363, r=0.714)
surf159 = openmc.ZCylinder(surface_id=159, x0=26.367, y0=-9.687363, r=0.714)
surf160 = openmc.ZCylinder(surface_id=160, x0=-25.568, y0=-11.071272, r=0.714)
surf161 = openmc.ZCylinder(surface_id=161, x0=25.568, y0=-11.071272, r=0.714)
surf162 = openmc.ZCylinder(surface_id=162, x0=-24.769, y0=-12.455181, r=0.714)
surf163 = openmc.ZCylinder(surface_id=163, x0=24.769, y0=-12.455181, r=0.714)
surf164 = openmc.ZCylinder(surface_id=164, x0=-23.97, y0=-13.83909, r=0.714)
surf165 = openmc.ZCylinder(surface_id=165, x0=23.97, y0=-13.83909, r=0.714)
surf166 = openmc.ZCylinder(surface_id=166, x0=-23.171, y0=-15.222999, r=0.714)
surf167 = openmc.ZCylinder(surface_id=167, x0=23.171, y0=-15.222999, r=0.714)
surf168 = openmc.ZCylinder(surface_id=168, x0=-22.372, y0=-16.606908, r=0.714)
surf169 = openmc.ZCylinder(surface_id=169, x0=22.372, y0=-16.606908, r=0.714)
surf170 = openmc.ZCylinder(surface_id=170, x0=-21.573, y0=-17.990817, r=0.714)
surf171 = openmc.ZCylinder(surface_id=171, x0=21.573, y0=-17.990817, r=0.714)
surf172 = openmc.ZCylinder(surface_id=172, x0=-20.774, y0=-19.374726, r=0.714)
surf173 = openmc.ZCylinder(surface_id=173, x0=20.774, y0=-19.374726, r=0.714)
surf174 = openmc.ZCylinder(surface_id=174, x0=-19.975, y0=-20.758635, r=0.714)
surf175 = openmc.ZCylinder(surface_id=175, x0=19.975, y0=-20.758635, r=0.714)
surf176 = openmc.ZCylinder(surface_id=176, x0=-19.176, y0=-22.142544, r=0.714)
surf177 = openmc.ZCylinder(surface_id=177, x0=19.176, y0=-22.142544, r=0.714)
surf178 = openmc.ZCylinder(surface_id=178, x0=-16.779, y0=-23.526453, r=0.714)
surf179 = openmc.ZCylinder(surface_id=179, x0=16.779, y0=-23.526453, r=0.714)
surf180 = openmc.ZCylinder(surface_id=180, x0=-14.382, y0=-24.910362, r=0.714)
surf181 = openmc.ZCylinder(surface_id=181, x0=14.382, y0=-24.910362, r=0.714)
surf182 = openmc.ZCylinder(surface_id=182, x0=-11.985, y0=-26.294271, r=0.714)
surf183 = openmc.ZCylinder(surface_id=183, x0=11.985, y0=-26.294271, r=0.714)
surf184 = openmc.ZCylinder(surface_id=184, x0=-9.588, y0=-27.67818, r=0.714)
surf185 = openmc.ZCylinder(surface_id=185, x0=-7.99, y0=-27.67818, r=0.714)
surf186 = openmc.ZCylinder(surface_id=186, x0=-6.392, y0=-27.67818, r=0.714)
surf187 = openmc.ZCylinder(surface_id=187, x0=-4.794, y0=-27.67818, r=0.714)
surf188 = openmc.ZCylinder(surface_id=188, x0=-3.196, y0=-27.67818, r=0.714)
surf189 = openmc.ZCylinder(surface_id=189, x0=-1.598, y0=-27.67818, r=0.714)
surf190 = openmc.ZCylinder(surface_id=190, x0=0.0, y0=-27.67818, r=0.714)
surf191 = openmc.ZCylinder(surface_id=191, x0=1.598, y0=-27.67818, r=0.714)
surf192 = openmc.ZCylinder(surface_id=192, x0=3.196, y0=-27.67818, r=0.714)
surf193 = openmc.ZCylinder(surface_id=193, x0=4.794, y0=-27.67818, r=0.714)
surf194 = openmc.ZCylinder(surface_id=194, x0=6.392, y0=-27.67818, r=0.714)
surf195 = openmc.ZCylinder(surface_id=195, x0=7.99, y0=-27.67818, r=0.714)
surf196 = openmc.ZCylinder(surface_id=196, x0=9.588, y0=-27.67818, r=0.714)
surf197 = openmc.ZCylinder(surface_id=197, x0=24.769, y0=15.222999, r=0.714)
surf198 = openmc.ZCylinder(surface_id=198, x0=-25.568, y0=13.83909, r=0.714)
...
cell1.region = -surf1 & (-surf21_0 & -surf21_1 & -surf21_2 & -surf21_3 & -surf21_4 & -surf21_5 & -surf21_6 & -surf21_7 & -surf21_8 & -surf21_9 & -surf21_10 & -surf21_11) & +surf101 & +surf112 & +surf113 & +surf120 & +surf121 & +surf122 & +surf143 & +surf144 & +surf145 & +surf152
...
cell119.region = -surf1 & (+surf22_0 | +surf22_1 | +surf22_2 | +surf22_3 | +surf22_4 | +surf22_5 | +surf22_6 | +surf22_7 | +surf22_8 | +surf22_9 | +surf22_10 | +surf22_11 | +surf22_12 | +surf22_13 | +surf22_14 | +surf22_15 | +surf22_16 | +surf22_17) & +surf201 & +surf202 & +surf203 & +surf204 & +surf205 & +surf206 & +surf207 & +surf208 & +surf209 & +surf210
...
cell136.region = -surf1 & +surf16 & +surf17 & +surf18 & +surf19 & +surf20
