"""
LMT004-3: 32 U(4.948) Metal Rods in Water; Pitch=4.72cm; Hf=60cm; Hw=59.0cm
...
surf2 = openmc.ZCylinder(surface_id=2, x0=4.72, y0=0.0, r=1.2475)
surf3 = openmc.ZCylinder(surface_id=3, x0=9.44, y0=0.0, r=1.2475)
surf4 = openmc.ZCylinder(surface_id=4, x0=14.16, y0=0.0, r=1.2475)
surf5 = openmc.ZCylinder(surface_id=5, x0=18.88, y0=0.0, r=1.2475)
surf6 = openmc.ZCylinder(surface_id=6, x0=23.6, y0=0.0, r=1.2475)
surf7 = openmc.ZCylinder(surface_id=7, x0=28.32, y0=0.0, r=1.2475)
...
# Water height
surf91 = openmc.ZPlane(surface_id=91, z0=59.0)
# Arbitrary
...
u1_cell6.region = +surf91 & -surf99 & (+surf1 | -surf1_zmin | +surf1_zmax) & +surf2 & +surf3 & +surf4 & +surf5 & +surf6
u1_cell7 = openmc.Cell(fill=mat2)
u1_cell7.region = -surf91 & -surf99 & (+surf1 | -surf1_zmin | +surf1_zmax) & +surf2 & +surf3 & +surf4 & +surf5 & +surf6
...
source.space = openmc.stats.Point((0.0, 0.0, 29.5))
