"""
LST008-2: STACY 60cm diameter cylindrical tank with 10% enriched uranyl nitrate solution @ H/X=952 reflected with (C100) concrete (Run 76)
...
mat1.add_nuclide("U234", 4.954800e-07)
mat1.add_nuclide("U235", 6.148500e-05)
mat1.add_nuclide("U236", 6.140800e-08)
mat1.add_nuclide("U238", 5.476600e-04)
mat1.add_nuclide("H1", 5.854700e-02)
mat1.add_element("N", 2.472000e-03)
mat1.add_nuclide("O16", 3.728300e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=73.50)
# Steel support/inner
surf11 = openmc.ZCylinder(surface_id=11, r=31.7)
# Steel support/outer
surf12 = openmc.ZCylinder(surface_id=12, r=68.5)
# Aluminum reflector bottom plate
surf13 = openmc.ZCylinder(surface_id=13, r=41.51)
# Steel reflector top plate
surf14 = openmc.ZCylinder(surface_id=14, r=41.51)
# = 29.82 + 0.68 (Inner Gap)
surf15 = openmc.ZCylinder(surface_id=15, r=30.5)
# = 30.50 + 0.31 (Inner Wall)
surf16 = openmc.ZCylinder(surface_id=16, r=30.81)
# = 30.81 + 9.89 (Concrete)
surf17 = openmc.ZCylinder(surface_id=17, r=40.7)
# = 40.70 + 0.81 (Outer Wall)
surf18 = openmc.ZCylinder(surface_id=18, r=41.51)
# BCD
...
source.space = openmc.stats.Point((0.0, 0.0, 36.75))
