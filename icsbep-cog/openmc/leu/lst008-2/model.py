...
surf13 = openmc.ZCylinder(surface_id=13, x0=-1.5, y0=0.0, r=41.51)
# Steel reflector top plate
surf14 = openmc.ZCylinder(surface_id=14, x0=142.0, y0=142.6, r=41.51)
# = 29.82 + 0.68 (Inner Gap)
surf15 = openmc.ZCylinder(surface_id=15, r=30.5)
# = 30.50 + 0.31 (Inner Wall)
surf16 = openmc.ZCylinder(surface_id=16, x0=0.0, y0=142.0, r=30.81)
# = 30.81 + 9.89 (Concrete)
surf17 = openmc.ZCylinder(surface_id=17, x0=0.0, y0=142.0, r=40.7)
# = 40.70 + 0.81 (Outer Wall)
surf18 = openmc.ZCylinder(surface_id=18, x0=0.0, y0=142.0, r=41.51)
# BCD
