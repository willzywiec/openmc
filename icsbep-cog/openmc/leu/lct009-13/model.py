"""
LEU-COMP-THERM-009-13: (15x8)-4.6515cm-(0.337cm Cu)-4.6515cm-(15x8)-4.6515cm-(0.337cm Cu)-4.6515cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
mat6.add_element("C", 1.519400e-03)
mat6.add_element("Cu", 8.412800e-02)
mat6.add_element("Fe", 3.844400e-06)
mat6.add_element("Mg", 4.416800e-06)
mat6.add_element("Na", 4.669500e-06)
mat6.add_nuclide("O16", 1.006400e-04)
mat6.add_element("Si", 3.822300e-05)
mat6.add_element("S", 3.347400e-06)
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-66.79, 66.79, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-96.79, 96.79, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-28.69)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=28.69)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-24.038500000000003, -23.7015, -15.3, 15.3, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(23.7015, 24.038500000000003, -15.3, 15.3, 0.0, 91.5)
...
cell1.translation = (-47.74, 0.0, 0.0)
...
cell5.translation = (47.74, 0.0, 0.0)
...
source.space = openmc.stats.Box((-48.74, -2.27, 45.0375), (48.74, 2.27, 47.0375))
