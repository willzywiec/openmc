"""
LCT062-7: 18x18 array of U(2.6)O2 rods on 1.9558cm pitch with 0.6228cm SST-0.67B plate, no gap (TCA)
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=112.71)
# Array boundary
...
surf31 = openmc.model.RectangularParallelepiped(17.6022, 18.224999999999998, -22.5, 22.5, 0.37000000000000455, 150.37)
...
source.space = openmc.stats.Box((-1.98, -1.98, 55.355), (1.98, 1.98, 57.355))
