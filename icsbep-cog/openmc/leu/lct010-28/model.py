"""
LEU-COMP-THERM-010-28: (12x16)-18.893cm-(12x16)-18.893cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; U walls; 2.616 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-76.15, 76.15, -25.402, -17.752000000000002, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-76.15, 76.15, 17.752000000000002, 25.402, -20.0625, 101.8375)
...
cell1.translation = (-41.597, 0.0, 0.0)
...
cell5.translation = (41.597, 0.0, 0.0)
...
source.space = openmc.stats.Box((-41.651, -2.27, 45.0375), (41.651, 2.27, 47.0375))
