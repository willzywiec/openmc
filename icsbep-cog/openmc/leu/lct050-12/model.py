"""
LCT050-12: Exp. No. 2773; 25x23-35=540 array of U(4.738)O2 rods on 1.3cm pitch; samarium solution no. C2
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=80.78)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 39.39), (5.55, 5.55, 41.39))
