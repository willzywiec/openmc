"""
U233-SOL-THERM-016-12: 2.698 kg 233U @ H/X=120.8 and N/U=2.15 (Exp't No. 105)
...
# Solution/Hc
surf10 = openmc.ZPlane(surface_id=10, z0=24.9425)
...
surf7_zmin = openmc.ZPlane(surface_id=1014, z0=0.3175)
surf7_zmax = openmc.ZPlane(surface_id=1015, z0=181.9275)
surf8_zmin = openmc.ZPlane(surface_id=1016, z0=-1.27)
surf8_zmax = openmc.ZPlane(surface_id=1017, z0=181.9275)
surf9_zmin = openmc.ZPlane(surface_id=1018, z0=181.9275)
surf9_zmax = openmc.ZPlane(surface_id=1019, z0=182.0545)
