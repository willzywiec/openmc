"""
PU-SOL-THERM-005 (Case 7) 0.964 kg Pu(95.95) @ H/X = 581 in a water reflected 14" SS-347 sphere
...
mat1.add_nuclide("Pu239", 9.888500e-05)
mat1.add_nuclide("Pu240", 4.156500e-06)
mat1.add_element("N", 3.738300e-03)
mat1.add_nuclide("H1", 5.741200e-02)
mat1.add_nuclide("O16", 3.825800e-02)
