"""
ICT016-23: 22.86 x 22.86 x 19.9644 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 20.32 cm Perspex on top - batch 80C
...
surf1 = openmc.model.RectangularParallelepiped(-11.43, 11.43, -11.43, 11.43, -9.9822, 9.9822)
surf2 = openmc.model.RectangularParallelepiped(-31.75, 31.75, -31.75, 31.75, -30.3022, 30.3022, boundary_type="vacuum")
surf3 = openmc.ZPlane(surface_id=3, z0=9.9822)
