"""
LST003-4: Partially full sphere of 10% enriched uranyl nitrate solution at H/X=913
...
mat1.add_nuclide("U234", 5.813400e-07)
mat1.add_nuclide("U235", 6.582000e-05)
mat1.add_nuclide("U238", 5.795300e-04)
mat1.add_element("N", 1.978300e-03)
mat1.add_nuclide("O16", 3.693900e-02)
mat1.add_nuclide("H1", 6.011000e-02)
...
surf3 = openmc.ZPlane(surface_id=3, z0=3.9656)
