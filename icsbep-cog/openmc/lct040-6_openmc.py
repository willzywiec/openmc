"""
LCT040-6: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.65cm Boral, 2.0cm water gap, Hc=53.98cm, 0.1cm gap between lead reflector
...
surf5 = openmc.ZPlane(surface_id=5, z0=53.98)
# Lower grid plate
...
# Outer: 2(10.0) + 62.40 = 82.40
surf52 = openmc.model.RectangularParallelepiped(-41.2, 41.2, -41.2, 41.2, -2.200000000000003, 92.8)
...
source.space = openmc.stats.Box((-30.65, -30.65, 25.99), (30.65, 30.65, 27.99))
