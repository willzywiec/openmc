"""
LCT038-1: Two (18x13-2) arrays of U(4.738)O2 rods, 1.60 cm pitch, no concrete reflector, Hc=71.2cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=71.2)
# Lower grid plate
...
surf12 = openmc.model.RectangularParallelepiped(-95.0, 0.0, -47.5, 47.5, -3.4, -2.6)
# Water & tank & BCD
surf13 = openmc.model.RectangularParallelepiped(-120.0, 0.29999999999999716, -60.0, 60.0, -22.599999999999994, 117.5, boundary_type="vacuum")
...
surf1_zmin = openmc.ZPlane(surface_id=1034, z0=0.0)
surf1_zmax = openmc.ZPlane(surface_id=1035, z0=90.0)
surf2_zmin = openmc.ZPlane(surface_id=1036, z0=0.0)
surf2_zmax = openmc.ZPlane(surface_id=1037, z0=96.9)
surf4_zmin = openmc.ZPlane(surface_id=1038, z0=-1.8)
surf4_zmax = openmc.ZPlane(surface_id=1039, z0=98.2)
...
cell11.region = +surf10 & +surf11 & -surf12 & -surf13 & -surf14

# SST
cell12 = openmc.Cell(cell_id=12, fill=mat3)
cell12.region = -surf13 & +surf14

# Air
cell13 = openmc.Cell(cell_id=13, fill=mat4)
cell13.region = +surf5 & +surf10 & +surf11 & +surf12 & -surf13 & -surf14

# Water
cell14 = openmc.Cell(cell_id=14, fill=mat5)
cell14.region = -surf5 & +surf10 & +surf11 & +surf12 & -surf13 & -surf14

# Water
cell25 = openmc.Cell(cell_id=25, fill=mat5)
cell25.region = (+surf4 | -surf4_zmin | +surf4_zmax) & -surf5 & +surf6 & +surf7 & -surf8 & -surf9

# Water
cell33 = openmc.Cell(cell_id=33, fill=mat5)
cell33.region = (+surf4 | -surf4_zmin | +surf4_zmax) & -surf5 & +surf6 & +surf7 & -surf8 & -surf9

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell25, cell33])
...
source.space = openmc.stats.Box((-21.0, -1.8, 34.6), (0.19999999999999996, 1.8, 36.6))
