"""
IEU-MET-FAST-022-3: FR0 6A-S; simplified homogeous cylindrical benchmark; C/X=11.2; H/X=1.7
...
mat1.add_nuclide("U234", 3.547400e-05)
mat1.add_nuclide("U235", 3.541100e-03)
mat1.add_nuclide("U238", 1.390700e-02)
mat1.add_element("C", 2.083300e-05)
mat1.add_element("F", 4.166700e-05)
mat1.add_element("C", 3.671100e-02)
...
# (U20)
surf1 = openmc.ZCylinder(surface_id=1, r=20.508)
# Copper (CU)
...
surf1_zmin = openmc.ZPlane(surface_id=1005, z0=-23.6555)
surf1_zmax = openmc.ZPlane(surface_id=1006, z0=23.6555)
