"""
U233-SOL-THERM-013: Case No. 6 (Experment No. 125)
...
mat1.add_nuclide("U232", 2.250200e-09)
mat1.add_nuclide("U233", 3.377700e-04)
mat1.add_nuclide("U234", 3.610200e-06)
mat1.add_nuclide("U235", 8.926900e-08)
mat1.add_nuclide("U236", 3.418800e-09)
mat1.add_nuclide("U238", 4.698600e-06)
mat1.add_element("Th", 4.343000e-06)
mat1.add_nuclide("H1", 6.339500e-02)
mat1.add_element("N", 8.008600e-04)
mat1.add_nuclide("O16", 3.474700e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=27.394)
