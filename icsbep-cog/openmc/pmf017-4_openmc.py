"""
PMF017-4: LLNL Pu Array Phase II - MHE - 4x4x4 - 3kg - case 204
...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -25.6285, -16.9415, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-28.38, 28.38, -26.365000000000002, -16.205, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -11.4385, -2.7515, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-28.38, 28.38, -12.175, -2.0149999999999997, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 2.7515, 11.4385, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-28.38, 28.38, 2.0149999999999997, 12.175, 216.35500000000002, 221.435)
# 4th, inner
surf26 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 16.9415, 25.6285, 217.0915, 220.69850000000002)
# 4th, outer
surf27 = openmc.model.RectangularParallelepiped(-28.38, 28.38, 16.205, 26.365000000000002, 216.35500000000002, 221.435)
# Hole
...
# MHE, ring 1
surf81 = openmc.ZCylinder(surface_id=81, r=5.0848)
# MHE, ring 2
surf82 = openmc.ZCylinder(surface_id=82, r=5.0848)
# MHE, ring 3
surf83 = openmc.ZCylinder(surface_id=83, r=5.0848)
# MHE, ring 4
surf84 = openmc.ZCylinder(surface_id=84, r=5.0848)
surf101 = openmc.ZCylinder(surface_id=101, x0=-21.285, y0=-21.285, r=5.0848)
surf102 = openmc.ZCylinder(surface_id=102, x0=-21.285, y0=-7.095, r=5.0848)
surf103 = openmc.ZCylinder(surface_id=103, x0=-21.285, y0=7.095, r=5.0848)
surf104 = openmc.ZCylinder(surface_id=104, x0=-21.285, y0=21.285, r=5.0848)
surf105 = openmc.ZCylinder(surface_id=105, x0=-7.095, y0=-21.285, r=5.0848)
surf106 = openmc.ZCylinder(surface_id=106, x0=-7.095, y0=-7.095, r=5.0848)
surf107 = openmc.ZCylinder(surface_id=107, x0=-7.095, y0=7.095, r=5.0848)
surf108 = openmc.ZCylinder(surface_id=108, x0=-7.095, y0=21.285, r=5.0848)
surf109 = openmc.ZCylinder(surface_id=109, x0=7.095, y0=-21.285, r=5.0848)
surf110 = openmc.ZCylinder(surface_id=110, x0=7.095, y0=-7.095, r=5.0848)
surf111 = openmc.ZCylinder(surface_id=111, x0=7.095, y0=7.095, r=5.0848)
surf112 = openmc.ZCylinder(surface_id=112, x0=7.095, y0=21.285, r=5.0848)
surf113 = openmc.ZCylinder(surface_id=113, x0=21.285, y0=-21.285, r=5.0848)
surf114 = openmc.ZCylinder(surface_id=114, x0=21.285, y0=-7.095, r=5.0848)
surf115 = openmc.ZCylinder(surface_id=115, x0=21.285, y0=7.095, r=5.0848)
surf116 = openmc.ZCylinder(surface_id=116, x0=21.285, y0=21.285, r=5.0848)
...
surf50_zmin = openmc.ZPlane(surface_id=1128, z0=0.0)
surf50_zmax = openmc.ZPlane(surface_id=1129, z0=208.417)
surf61_zmin = openmc.ZPlane(surface_id=1130, z0=25.083)
surf61_zmax = openmc.ZPlane(surface_id=1131, z0=99.3568)
surf62_zmin = openmc.ZPlane(surface_id=1132, z0=99.3568)
surf62_zmax = openmc.ZPlane(surface_id=1133, z0=100.6275)
surf63_zmin = openmc.ZPlane(surface_id=1134, z0=100.6275)
surf63_zmax = openmc.ZPlane(surface_id=1135, z0=106.4825)
surf64_zmin = openmc.ZPlane(surface_id=1136, z0=106.4825)
surf64_zmax = openmc.ZPlane(surface_id=1137, z0=107.7532)
surf65_zmin = openmc.ZPlane(surface_id=1138, z0=107.7532)
surf65_zmax = openmc.ZPlane(surface_id=1139, z0=108.9868)
surf66_zmin = openmc.ZPlane(surface_id=1140, z0=108.9868)
surf66_zmax = openmc.ZPlane(surface_id=1141, z0=110.2575)
surf67_zmin = openmc.ZPlane(surface_id=1142, z0=110.2575)
surf67_zmax = openmc.ZPlane(surface_id=1143, z0=116.1125)
surf68_zmin = openmc.ZPlane(surface_id=1144, z0=116.1125)
surf68_zmax = openmc.ZPlane(surface_id=1145, z0=117.3832)
surf69_zmin = openmc.ZPlane(surface_id=1146, z0=117.3832)
surf69_zmax = openmc.ZPlane(surface_id=1147, z0=118.6168)
surf70_zmin = openmc.ZPlane(surface_id=1148, z0=118.6168)
surf70_zmax = openmc.ZPlane(surface_id=1149, z0=119.8875)
surf71_zmin = openmc.ZPlane(surface_id=1150, z0=119.8875)
surf71_zmax = openmc.ZPlane(surface_id=1151, z0=125.7425)
surf72_zmin = openmc.ZPlane(surface_id=1152, z0=125.7425)
surf72_zmax = openmc.ZPlane(surface_id=1153, z0=127.0132)
surf73_zmin = openmc.ZPlane(surface_id=1154, z0=127.0132)
surf73_zmax = openmc.ZPlane(surface_id=1155, z0=128.2468)
surf74_zmin = openmc.ZPlane(surface_id=1156, z0=128.2468)
surf74_zmax = openmc.ZPlane(surface_id=1157, z0=129.5175)
surf75_zmin = openmc.ZPlane(surface_id=1158, z0=129.5175)
surf75_zmax = openmc.ZPlane(surface_id=1159, z0=135.3725)
surf76_zmin = openmc.ZPlane(surface_id=1160, z0=135.3725)
surf76_zmax = openmc.ZPlane(surface_id=1161, z0=136.6432)
surf81_zmin = openmc.ZPlane(surface_id=1162, z0=99.3568)
surf81_zmax = openmc.ZPlane(surface_id=1163, z0=107.7532)
surf82_zmin = openmc.ZPlane(surface_id=1164, z0=108.9868)
surf82_zmax = openmc.ZPlane(surface_id=1165, z0=117.3832)
surf83_zmin = openmc.ZPlane(surface_id=1166, z0=118.6168)
surf83_zmax = openmc.ZPlane(surface_id=1167, z0=127.0132)
surf84_zmin = openmc.ZPlane(surface_id=1168, z0=128.2468)
surf84_zmax = openmc.ZPlane(surface_id=1169, z0=136.6432)
...
# MHE
cell54 = openmc.Cell(cell_id=54, fill=mat13)
cell54.region = +surf80 & (-surf84 & +surf84_zmin & -surf84_zmax)

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell15, cell16, cell17, cell18, cell19, cell20, cell21, cell22, cell23, cell24, cell25, cell26, cell27, cell34, cell54])
...
source.space = openmc.stats.Box((-22.285, -22.285, 102.6), (22.285, 22.285, 133.49))
