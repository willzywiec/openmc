"""
MIX-COMP-THERM-004-11: 21x21 MOX pins with 2.474 cm pitch; Hc=64.53
...
mat1.add_nuclide("Pu241", 2.661700e-05)
mat1.add_nuclide("Pu242", 8.123400e-06)
mat1.add_nuclide("Am241", 2.665600e-06)
...
# Water height
surf11 = openmc.ZPlane(surface_id=11, z0=64.53)
# Al lower grid, top
...
source.space = openmc.stats.Point((0.0, 0.0, 32.265))
