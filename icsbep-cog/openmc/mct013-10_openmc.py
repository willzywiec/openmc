"""
MCT013-10: MOX/Polystyrene with H/X=226 with 1.32 SST-1.1B absorber and 15.24cm Lucite reflector
...
mat2.add_nuclide("B10", 8.304700e-04)
mat2.add_nuclide("B11", 3.342700e-03)
mat2.add_element("Fe", 5.633500e-02)
mat2.add_element("Cr", 1.471800e-02)
mat2.add_element("Ni", 5.798400e-03)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 1.32 + 20.6525 = 36.6439 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.671400000000002, 21.9725)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.00)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=1.32)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.911400000000004, 37.212500000000006, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 12.65))
