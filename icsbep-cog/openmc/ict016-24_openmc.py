"""
ICT016-24: 20.32 x 20.32 x 17.8308 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 20.32 cm Paraffin Wax on top - batch 40
...
mat3.add_nuclide("H1", 7.509800e-02)
mat3.add_element("C", 3.681300e-02)
...
surf1 = openmc.model.RectangularParallelepiped(-10.16, 10.16, -10.16, 10.16, -8.9154, 8.9154)
surf2 = openmc.model.RectangularParallelepiped(-30.48, 30.48, -30.48, 30.48, -29.2354, 29.2354, boundary_type="vacuum")
surf3 = openmc.ZPlane(surface_id=3, z0=8.9154)
