"""
PU-SOL-THERM-032-9: H/X=1007 with AIR in the central cavity
...
mat1.add_nuclide("Pu238", 3.516400e-08)
mat1.add_nuclide("Pu239", 6.206300e-05)
mat1.add_nuclide("Pu240", 6.946100e-06)
mat1.add_nuclide("Pu241", 8.889600e-07)
mat1.add_nuclide("Pu242", 6.224700e-08)
mat1.add_nuclide("H1", 6.339700e-02)
mat1.add_nuclide("O16", 3.546400e-02)
mat1.add_element("N", 1.450100e-03)
mat1.add_element("Fe", 6.038600e-07)
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=53.13)
# Cavity, bottom
...
source.space = openmc.stats.Point((0.0, 0.0, 26.565))
