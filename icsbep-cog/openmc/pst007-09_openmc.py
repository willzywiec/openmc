"""
PU-SOL-THERM-007 (Case 9) 1.243 kg Pu(95.43) @ H/X = 259 in a water reflected 11.5" SS-304L sphere
...
mat1.add_element("N", 1.385000e-03)
mat1.add_nuclide("H1", 6.315200e-02)
mat1.add_nuclide("O16", 3.555000e-02)
...
surf1 = openmc.ZPlane(surface_id=1, z0=10.4503)
