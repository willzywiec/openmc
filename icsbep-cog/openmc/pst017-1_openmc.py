"""
PU-SOL-THERM-017 (Case 1) 300 and 256 mm cylinders with 115.1 gPu/L at 30 cm s-to-s
...
surf4 = openmc.ZPlane(surface_id=4, z0=40.334)
# 300-mm Tank/Inner per Figure 5
surf5 = openmc.ZCylinder(surface_id=5, x0=57.79, y0=0.0, r=14.7)
# 300-mm Tank/Outer per Figure 5
surf6 = openmc.ZCylinder(surface_id=6, x0=57.79, y0=0.0, r=15.0)
...
source.space = openmc.stats.Point((57.79, 0.0, 20.1))
