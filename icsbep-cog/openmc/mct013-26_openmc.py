"""
MCT013-26: MOX/Polystyrene with H/X=226 with 0.23 Cadmium absorber and 15.24cm Lucite reflector
...
mat2.add_element("Cd", 3.971400e-02)
...
# Height of lower fuel + absorber + upper fuel = 14.6714 + 0.23 + 17.6302 = 32.5316 cm
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -20.38, 20.38, -14.671399999999998, 17.8602)
# Absorber, lower
surf2 = openmc.ZPlane(surface_id=2, z0=0.0)
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=0.23)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.9114, 33.1002, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 10.05))
