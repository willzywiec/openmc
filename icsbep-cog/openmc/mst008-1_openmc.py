"""
MIX-SOL-THERM-008-1: Raschig rings in 92.3 gPu/l with 147 gU/l and 4.2M solution (Model 3)
...
mat1.add_nuclide("Am241", 4.970300e-08)
mat1.add_nuclide("Pu238", 4.436500e-08)
mat1.add_nuclide("Pu239", 2.184500e-04)
mat1.add_nuclide("Pu240", 1.301500e-05)
mat1.add_nuclide("Pu241", 8.024300e-07)
mat1.add_nuclide("Pu242", 1.400700e-07)
mat1.add_nuclide("U234", 2.269500e-08)
mat1.add_nuclide("U235", 2.504600e-06)
mat1.add_nuclide("U236", 4.500400e-08)
mat1.add_nuclide("U238", 3.693300e-04)
mat1.add_element("Gd", 8.483400e-08)
mat1.add_element("Fe", 1.652200e-05)
mat1.add_element("N", 4.252800e-03)
mat1.add_nuclide("H1", 5.376400e-02)
mat1.add_nuclide("O16", 3.912000e-02)
...
# Critical height (case 1)
surf6 = openmc.ZPlane(surface_id=6, z0=57.56)
...
source.space = openmc.stats.Point((0.0, 0.0, 28.78))
