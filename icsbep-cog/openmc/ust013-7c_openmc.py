"""
U233-SOL-THERM-013: Case No. 7 (Experment No. 126)
...
mat1.add_nuclide("U232", 2.249900e-09)
mat1.add_nuclide("U233", 3.377200e-04)
mat1.add_nuclide("U234", 3.609600e-06)
mat1.add_nuclide("U235", 8.925500e-08)
mat1.add_nuclide("U236", 3.418300e-09)
mat1.add_nuclide("U238", 4.697900e-06)
mat1.add_element("Th", 4.342300e-06)
mat1.add_nuclide("H1", 6.338600e-02)
mat1.add_element("N", 8.007400e-04)
mat1.add_nuclide("O16", 3.474100e-02)
...
surf4 = openmc.ZPlane(surface_id=4, z0=27.432)
