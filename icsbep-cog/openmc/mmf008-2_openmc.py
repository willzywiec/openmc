"""
MIX-MET-FAST-008-2: ZEBRA-8B (in IRPhE: ZEBRA-FUND-RESR-001)
...
surf1 = openmc.model.RectangularParallelepiped(-2.3355, 2.3355, -2.3355, 2.3355, 2.2687, 2.4846000000000004)
...
surf6 = openmc.ZPlane(surface_id=6, z0=0.6304)
surf7 = openmc.ZPlane(surface_id=7, z0=2.2179)
surf8 = openmc.ZPlane(surface_id=8, z0=2.5354)
surf9 = openmc.ZPlane(surface_id=9, z0=4.1229)
surf10 = openmc.ZPlane(surface_id=10, z0=4.4381, boundary_type="periodic")
...
source.space = openmc.stats.Point((0.0, 0.0, 2.37665))
