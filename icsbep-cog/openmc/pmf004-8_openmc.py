"""
PMF004-8: LLNL Pu Array Phase II - bare - 3x3x3 - 6kg - case 214
...
# 1st, inner
surf20 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -18.8535, -10.1665, 217.0915, 220.69850000000002)
# 1st, outer
surf21 = openmc.model.RectangularParallelepiped(-21.765, 21.765, -19.59, -9.43, 216.35500000000002, 221.435)
# 2nd, inner
surf22 = openmc.model.RectangularParallelepiped(-49.95, 49.95, -4.3435, 4.3435, 217.0915, 220.69850000000002)
# 2nd, outer
surf23 = openmc.model.RectangularParallelepiped(-21.765, 21.765, -5.08, 5.08, 216.35500000000002, 221.435)
# 3rd, inner
surf24 = openmc.model.RectangularParallelepiped(-49.95, 49.95, 10.1665, 18.8535, 217.0915, 220.69850000000002)
# 3rd, outer
surf25 = openmc.model.RectangularParallelepiped(-21.765, 21.765, 9.43, 19.59, 216.35500000000002, 221.435)
# Hole
...
surf101 = openmc.ZCylinder(surface_id=101, x0=-14.51, y0=-14.51, r=3.607)
surf102 = openmc.ZCylinder(surface_id=102, x0=-14.51, y0=0.0, r=3.607)
surf103 = openmc.ZCylinder(surface_id=103, x0=-14.51, y0=14.51, r=3.607)
surf104 = openmc.ZCylinder(surface_id=104, x0=0.0, y0=-14.51, r=3.607)
surf105 = openmc.ZCylinder(surface_id=105, x0=0.0, y0=0.0, r=3.607)
surf106 = openmc.ZCylinder(surface_id=106, x0=0.0, y0=14.51, r=3.607)
surf107 = openmc.ZCylinder(surface_id=107, x0=14.51, y0=-14.51, r=3.607)
surf108 = openmc.ZCylinder(surface_id=108, x0=14.51, y0=0.0, r=3.607)
surf109 = openmc.ZCylinder(surface_id=109, x0=14.51, y0=14.51, r=3.607)

# Z-plane surfaces for bounded cylinders
surf31_zmin = openmc.ZPlane(surface_id=1109, z0=0.33092)
surf31_zmax = openmc.ZPlane(surface_id=1110, z0=0.635)
surf32_zmin = openmc.ZPlane(surface_id=1111, z0=0.635)
surf32_zmax = openmc.ZPlane(surface_id=1112, z0=0.656)
surf33_zmin = openmc.ZPlane(surface_id=1113, z0=0.656)
surf33_zmax = openmc.ZPlane(surface_id=1114, z0=5.289)
surf34_zmin = openmc.ZPlane(surface_id=1115, z0=0.656)
surf34_zmax = openmc.ZPlane(surface_id=1116, z0=5.289)
surf35_zmin = openmc.ZPlane(surface_id=1117, z0=5.289)
surf35_zmax = openmc.ZPlane(surface_id=1118, z0=5.376)
surf36_zmin = openmc.ZPlane(surface_id=1119, z0=5.376)
surf36_zmax = openmc.ZPlane(surface_id=1120, z0=5.7316)
surf37_zmin = openmc.ZPlane(surface_id=1121, z0=5.7316)
surf37_zmax = openmc.ZPlane(surface_id=1122, z0=5.7526)
surf38_zmin = openmc.ZPlane(surface_id=1123, z0=5.7526)
surf38_zmax = openmc.ZPlane(surface_id=1124, z0=10.3856)
surf39_zmin = openmc.ZPlane(surface_id=1125, z0=5.7526)
surf39_zmax = openmc.ZPlane(surface_id=1126, z0=10.3856)
surf40_zmin = openmc.ZPlane(surface_id=1127, z0=10.3856)
surf40_zmax = openmc.ZPlane(surface_id=1128, z0=10.4726)
surf41_zmin = openmc.ZPlane(surface_id=1129, z0=10.4726)
surf41_zmax = openmc.ZPlane(surface_id=1130, z0=10.9516)
surf50_zmin = openmc.ZPlane(surface_id=1131, z0=0.0)
surf50_zmax = openmc.ZPlane(surface_id=1132, z0=208.417)
surf61_zmin = openmc.ZPlane(surface_id=1133, z0=25.083)
surf61_zmax = openmc.ZPlane(surface_id=1134, z0=98.8442)
surf62_zmin = openmc.ZPlane(surface_id=1135, z0=98.8442)
surf62_zmax = openmc.ZPlane(surface_id=1136, z0=109.7958)
surf63_zmin = openmc.ZPlane(surface_id=1137, z0=109.7958)
surf63_zmax = openmc.ZPlane(surface_id=1138, z0=112.5242)
surf64_zmin = openmc.ZPlane(surface_id=1139, z0=112.5242)
surf64_zmax = openmc.ZPlane(surface_id=1140, z0=123.4758)
surf65_zmin = openmc.ZPlane(surface_id=1141, z0=123.4758)
surf65_zmax = openmc.ZPlane(surface_id=1142, z0=126.2042)
surf66_zmin = openmc.ZPlane(surface_id=1143, z0=126.2042)
surf66_zmax = openmc.ZPlane(surface_id=1144, z0=137.1558)
...
cell12.region = -surf15 & +surf16

# I-beam
cell13 = openmc.Cell(cell_id=13, fill=mat8)
cell13.region = -surf15 & -surf16 & +surf17 & -surf18

# O-beam
cell14 = openmc.Cell(cell_id=14, fill=mat8)
cell14.region = +surf20 & -surf21

# O-beam
cell15 = openmc.Cell(cell_id=15, fill=mat8)
cell15.region = +surf22 & -surf23
...
# Frame
cell18 = openmc.Cell(cell_id=18, fill=mat9)
cell18.region = +surf1 & -surf2

# Cncrt
cell19 = openmc.Cell(cell_id=19, fill=mat12)
cell19.region = +surf3 & -surf4

# THS
cell31 = openmc.Cell(cell_id=31, fill=mat7)
cell31.region = +surf30 & (+surf40 | -surf40_zmin | +surf40_zmax) & (-surf41 & +surf41_zmin & -surf41_zmax)

# Part
cell38 = openmc.Cell(cell_id=38, fill=universe1)
cell38.translation = (0.0, 0.0, 126.2042)
cell38.region = (+surf65 | -surf65_zmin | +surf65_zmax) & (-surf66 & +surf66_zmin & -surf66_zmax)

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell7, cell8, cell9, cell10, cell11, cell12, cell13, cell14, cell15, cell16, cell17, cell18, cell19, cell31, cell38])
...
source.space = openmc.stats.Box((-15.51, -15.51, 100.8167), (15.51, 15.51, 135.2733))
