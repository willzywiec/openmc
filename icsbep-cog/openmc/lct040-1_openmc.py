"""
LCT040-1: Four 18x18 arrays of U(4.738)O2 rods, 1.60 cm pitch, 0.155cm borated steel, 2.0cm water gap, Hc=40.01cm
...
surf5 = openmc.ZPlane(surface_id=5, z0=40.01)
# Lower grid plate
...
source.space = openmc.stats.Box((-30.155, -30.155, 19.005), (30.155, 30.155, 21.005))
