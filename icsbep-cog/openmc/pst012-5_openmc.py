"""
PU-SOL-THERM-012 (Case 5) Hc = 66.15 @ H/X=2394; 18.91 wt-% Pu-240; 6 sides water reflection
...
mat1.add_nuclide("Pu239", 2.471320e-05)
mat1.add_nuclide("Pu240", 6.261950e-06)
mat1.add_nuclide("Pu241", 1.856240e-06)
mat1.add_nuclide("Pu242", 3.749650e-07)
mat1.add_nuclide("Am241", 2.011560e-07)
mat1.add_element("N", 1.371650e-03)
mat1.add_nuclide("O16", 3.530110e-02)
mat1.add_nuclide("H1", 6.359480e-02)
mat1.add_element("Fe", 3.558460e-06)
mat1.add_element("Cr", 1.144310e-06)
mat1.add_element("Ni", 8.110380e-07)
...
# = Hc per Table 1b
surf1 = openmc.ZPlane(surface_id=1, z0=66.15)
# Lucoflex/Inner; Zo = Hc + 10
surf2 = openmc.model.RectangularParallelepiped(-64.0, 64.0, -64.0, 64.0, 67.15, 85.15)
# Lucoflex/Outer; Zo = Hc + 10
surf3 = openmc.model.RectangularParallelepiped(-65.0, 65.0, -65.0, 65.0, 66.15, 86.15)
# Tank/Inner
...
surf10 = openmc.ZPlane(surface_id=10, z0=86.15)
...
source.space = openmc.stats.Point((0.0, 0.0, 33.1))
