"""
LST011-8: Air reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=787 (Run 459)
...
mat1.add_nuclide("U234", 5.887200e-07)
mat1.add_nuclide("U235", 7.046300e-05)
mat1.add_nuclide("U236", 1.167400e-07)
mat1.add_nuclide("U238", 1.087300e-03)
mat1.add_nuclide("H1", 5.547800e-02)
mat1.add_element("N", 2.913200e-03)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=50.37)
...
source.space = openmc.stats.Point((0.0, 0.0, 25.185))
