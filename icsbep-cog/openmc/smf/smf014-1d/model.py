...
cell5.region = +surf602 & +surf5 & +surf6 & +surf7 & -surf8
...
cell26.region = -surf10 & +surf200 & +surf371 & -surf372

# HEU
cell27 = openmc.Cell(cell_id=27, fill=mat11)
cell27.region = -surf10 & +surf200 & +surf391 & -surf392

# Fe
cell28 = openmc.Cell(cell_id=28, fill=mat9)
cell28.region = +surf32 & -surf10 & +surf601 & -surf602 & +surf603
...
cell38.region = +surf10 & +surf200 & +surf401 & -surf402

# Fe
cell39 = openmc.Cell(cell_id=39, fill=mat10)
cell39.region = +surf19 & +surf611 & -surf612 & +surf603
