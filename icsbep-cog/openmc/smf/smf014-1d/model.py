...
surf371 = openmc.Sphere(surface_id=371, x0=7.682, y0=372, z0=s, r=8.003)
# Top HEU shell no. 38
surf381 = openmc.Sphere(surface_id=381, x0=7.671, y0=382, z0=s, r=8.003)
# Bottom  HEU shell no. 39
surf391 = openmc.Sphere(surface_id=391, x0=8.013, y0=392, z0=s, r=8.336)
# Top HEU shell no. 40
surf401 = openmc.Sphere(surface_id=401, x0=8.007, y0=402, z0=s, r=8.329)
# Bottom Fe reflector
surf601 = openmc.Sphere(surface_id=601, x0=8.34644, y0=602, z0=s, r=20.066)
# Top Fe reflector
surf611 = openmc.Sphere(surface_id=611, x0=8.34644, y0=tr, z0=0, r=0)
