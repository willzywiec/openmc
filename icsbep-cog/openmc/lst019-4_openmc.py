"""
LST019-4: Concrete reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=724 (Run 151)
...
mat1.add_nuclide("H1", 5.868200e-02)
mat1.add_element("N", 2.181600e-03)
mat1.add_nuclide("O16", 3.720500e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=77.56)
# P75          [ dX=C-B; Xo=-(B+C)/2 ]
surf10 = openmc.model.RectangularParallelepiped(-25.08, -17.560000000000002, -35.5, 35.5, 0.0, 150.5)
# Gap          [ dX=C-B; Xo=-(B+C)/2 ]
surf11 = openmc.model.RectangularParallelepiped(-25.08, -17.560000000000002, -35.7, 35.7, 0.0, 150.5)
# Steel Frame  [ dX=C-B; Xo=-(B+C)/2 ]
surf12 = openmc.model.RectangularParallelepiped(-25.08, -17.560000000000002, -38.7, 38.7, -3.0, 153.5)
# Aluminum     [ dX=D-A; Xo=-(D+A)/2 ]
surf13 = openmc.model.RectangularParallelepiped(-25.89, -16.75, -38.7, 38.7, -3.0, 153.5)
# P75          [ dx=C-B; Xo=+(B+C)/2 ]
surf20 = openmc.model.RectangularParallelepiped(17.560000000000002, 25.08, -35.5, 35.5, 0.0, 150.5)
# Gap          [ dX=C-B; Xo=+(B+C)/2 ]
surf21 = openmc.model.RectangularParallelepiped(17.560000000000002, 25.08, -35.7, 35.7, 0.0, 150.5)
# Steel Frame  [ dx=C-B; Xo=+(B+C)/2 ]
surf22 = openmc.model.RectangularParallelepiped(17.560000000000002, 25.08, -38.7, 38.7, -3.0, 153.5)
# Aluminum     [ dx=D-A; Xo=+(D+A)/2 ]
surf23 = openmc.model.RectangularParallelepiped(16.75, 25.89, -38.7, 38.7, -3.0, 153.5)
# BCD
...
source.space = openmc.stats.Point((0.0, 0.0, 38.78))
