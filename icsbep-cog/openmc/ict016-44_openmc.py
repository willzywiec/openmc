"""
ICT016-44: 22.86 x 22.86 x 19.7866 U(30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides extending up to 9.5250 cm from core bottom  - batch 80
...
surf1 = openmc.model.RectangularParallelepiped(-11.43, 11.43, -11.43, 11.43, -9.8933, 9.8933)
surf2 = openmc.model.RectangularParallelepiped(-31.75, 31.75, -31.75, 31.75, -30.2143, 30.2143, boundary_type="vacuum")
# Top of polythene
surf3 = openmc.ZPlane(surface_id=3, z0=-0.3693)
