"""
PU-COMP-MIXED-002 (Case 27) 15.073 kg Pu @ H/X = 61.9 with 18.50 wt-% Pu-240 and H/SQRT(A) = 0.511
...
surf1 = openmc.model.RectangularParallelepiped(-20.36, 20.36, -22.905, 22.905, -11.03, 11.03)
# 6" (15.24 cm) Plexiglas Reflector
surf2 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -38.145, 38.145, -26.27, 26.27, boundary_type="vacuum")
