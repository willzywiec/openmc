"""
LST019-2: Concrete reflected 28-cm-thick slab tank with 10% enriched uranyl nitrate solution @ H/X=728 (Run 149)
...
mat1.add_nuclide("U234", 6.500700e-07)
mat1.add_nuclide("U235", 8.066900e-05)
mat1.add_nuclide("U236", 8.056800e-08)
mat1.add_nuclide("U238", 7.185300e-04)
mat1.add_nuclide("H1", 5.871200e-02)
mat1.add_element("N", 2.175000e-03)
mat1.add_nuclide("O16", 3.719300e-02)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=80.27)
# P25          [ dX=C-B; Xo=-(B+C)/2 ]
surf10 = openmc.model.RectangularParallelepiped(-20.07, -17.53, -35.5, 35.5, 0.0, 150.5)
# Gap          [ dX=C-B; Xo=-(B+C)/2 ]
surf11 = openmc.model.RectangularParallelepiped(-20.07, -17.53, -35.7, 35.7, 0.0, 150.5)
# Steel Frame  [ dX=C-B; Xo=-(B+C)/2 ]
surf12 = openmc.model.RectangularParallelepiped(-20.07, -17.53, -38.7, 38.7, -3.0, 153.5)
# Aluminum     [ dX=D-A; Xo=-(D+A)/2 ]
surf13 = openmc.model.RectangularParallelepiped(-20.880000000000003, -16.72, -38.7, 38.7, -3.0, 153.5)
# P25          [ dx=C-B; Xo=+(B+C)/2 ]
surf20 = openmc.model.RectangularParallelepiped(17.53, 20.07, -35.5, 35.5, 0.0, 150.5)
# Gap          [ dX=C-B; Xo=+(B+C)/2 ]
surf21 = openmc.model.RectangularParallelepiped(17.53, 20.07, -35.7, 35.7, 0.0, 150.5)
# Steel Frame  [ dx=C-B; Xo=+(B+C)/2 ]
surf22 = openmc.model.RectangularParallelepiped(17.53, 20.07, -38.7, 38.7, -3.0, 153.5)
# Aluminum     [ dx=D-A; Xo=+(D+A)/2 ]
surf23 = openmc.model.RectangularParallelepiped(16.72, 20.880000000000003, -38.7, 38.7, -3.0, 153.5)
# BCD
surf99 = openmc.model.RectangularParallelepiped(-21.0, 21.0, -39.0, 39.0, -4.0, 156.0, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 40.135))
