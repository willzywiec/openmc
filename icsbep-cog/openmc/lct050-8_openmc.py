"""
LCT050-8: Exp. No. 2769; 23x25-25=550 array of U(4.738)O2 rods on 1.3cm pitch; samarium solution no. C1
...
# Critical height
surf1 = openmc.ZPlane(surface_id=1, z0=62.66)
# Array boundary
...
source.space = openmc.stats.Box((-4.25, -4.25, 30.33), (5.55, 5.55, 32.33))
