...
# Borated water for PNL-34
mat4 = openmc.Material(material_id=4)
mat4.set_density("sum")
mat4.add_nuclide("H1", 6.670600e-02)
mat4.add_nuclide("O16", 3.335300e-02)
mat4.add_nuclide("B10", 1.760600e-08)
mat4.add_nuclide("B11", 7.131300e-08)
...
surf94 = openmc.ZPlane(surface_id=94, z0=129.0600)
...
surf151 = openmc.YPlane(surface_id=151, y0=-61.604515)
surf152 = openmc.YPlane(surface_id=152, y0=-59.090045)
surf153 = openmc.YPlane(surface_id=153, y0=-56.575575)
surf154 = openmc.YPlane(surface_id=154, y0=-54.061105)
surf155 = openmc.YPlane(surface_id=155, y0=-51.546635)
surf156 = openmc.YPlane(surface_id=156, y0=-49.032165)
surf157 = openmc.YPlane(surface_id=157, y0=-46.517695)
surf158 = openmc.YPlane(surface_id=158, y0=-44.003225)
surf159 = openmc.YPlane(surface_id=159, y0=-41.488755)
surf160 = openmc.YPlane(surface_id=160, y0=-38.974285)
surf161 = openmc.YPlane(surface_id=161, y0=-36.459815)
surf162 = openmc.YPlane(surface_id=162, y0=-33.945345)
surf163 = openmc.YPlane(surface_id=163, y0=-31.430875)
surf164 = openmc.YPlane(surface_id=164, y0=-28.916405)
surf165 = openmc.YPlane(surface_id=165, y0=-26.401935)
surf166 = openmc.YPlane(surface_id=166, y0=-23.887465)
surf167 = openmc.YPlane(surface_id=167, y0=-21.372995)
surf168 = openmc.YPlane(surface_id=168, y0=-18.858525)
surf169 = openmc.YPlane(surface_id=169, y0=-16.344055)
surf170 = openmc.YPlane(surface_id=170, y0=-13.829585)
surf171 = openmc.YPlane(surface_id=171, y0=-11.315115)
surf172 = openmc.YPlane(surface_id=172, y0=-8.800645)
surf173 = openmc.YPlane(surface_id=173, y0=-6.286175)
surf174 = openmc.YPlane(surface_id=174, y0=-3.771705)
surf175 = openmc.YPlane(surface_id=175, y0=-1.257235)
surf176 = openmc.YPlane(surface_id=176, y0=1.257235)
...
cell15.translation = (60.34728, -60.34728, 0.0)
cell15.region = +surf125 & -surf126 & +surf151 & -surf152 & +surf191 & -surf192
