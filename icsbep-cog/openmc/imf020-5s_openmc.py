"""
IEU-MET-FAST-020-5s: Rev. 2: FR0 T4a-S; simplified homogeous cylindrical benchmark
...
# (U20)
surf1 = openmc.ZCylinder(surface_id=1, r=17.298)
# Copper (CU)
surf2 = openmc.ZCylinder(surface_id=2, r=27.412)
# Void Region (VR)
surf3 = openmc.ZCylinder(surface_id=3, r=27.412)
# Inside End Blocks (IEB)
surf4 = openmc.ZCylinder(surface_id=4, r=27.412)
# Outside End Blocks (OEB)
surf5 = openmc.ZCylinder(surface_id=5, r=27.412)
# Locking rails
surf6 = openmc.ZCylinder(surface_id=6, r=27.412)
# Iron reactor table and wall; inner
surf7 = openmc.ZCylinder(surface_id=7, r=68.4)
# Iron reactor table and wall; outer
surf8 = openmc.ZCylinder(surface_id=8, r=70.0, boundary_type="vacuum")

# Z-plane surfaces for bounded cylinders
surf1_zmin = openmc.ZPlane(surface_id=1008, z0=-15.0535)
surf1_zmax = openmc.ZPlane(surface_id=1009, z0=15.0535)
surf2_zmin = openmc.ZPlane(surface_id=1010, z0=-55.9035)
surf2_zmax = openmc.ZPlane(surface_id=1011, z0=55.9035)
surf3_zmin = openmc.ZPlane(surface_id=1012, z0=-57.4535)
surf3_zmax = openmc.ZPlane(surface_id=1013, z0=58.2465)
surf4_zmin = openmc.ZPlane(surface_id=1014, z0=-59.7535)
surf4_zmax = openmc.ZPlane(surface_id=1015, z0=60.2465)
surf5_zmin = openmc.ZPlane(surface_id=1016, z0=-61.5535)
surf5_zmax = openmc.ZPlane(surface_id=1017, z0=61.9465)
surf6_zmin = openmc.ZPlane(surface_id=1018, z0=61.9465)
surf6_zmax = openmc.ZPlane(surface_id=1019, z0=64.7465)
surf7_zmin = openmc.ZPlane(surface_id=1020, z0=-61.5535)
surf7_zmax = openmc.ZPlane(surface_id=1021, z0=64.7465)
surf8_zmin = openmc.ZPlane(surface_id=1022, z0=-77.5535, boundary_type="vacuum")
surf8_zmax = openmc.ZPlane(surface_id=1023, z0=64.7465, boundary_type="vacuum")
