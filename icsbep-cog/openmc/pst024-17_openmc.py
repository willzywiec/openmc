"""
PU-SOL-THERM-024 (Case 17) 26.434 kg Pu(75.78) at H/X = 153 with H/SQRT(A) = 0.216; 23.2 wt-% Pu-240
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=67.2084)
# Tank/Inner:  Width = Tc
surf2 = openmc.model.RectangularParallelepiped(-337.509, -230.82899999999998, 139.726, 158.014, -192.929, -86.249)
# Tank/Outer:  Width = Tc +  0.318
surf3 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 139.567, 158.173, -193.379, -85.799)
# Plex/Outer:  Width = Tc +  5.398
surf4 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 137.02700000000002, 160.713, -193.379, -85.799)
# Frame/Outer: Width = Tc + 23.178
surf5 = openmc.model.RectangularParallelepiped(-337.959, -230.379, 128.137, 169.603, -193.379, -85.799)
# U-Frame/Inner
...
source.space = openmc.stats.Point((-284.0, 149.0, -159.0))
