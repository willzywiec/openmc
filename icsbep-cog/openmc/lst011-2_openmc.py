"""
LST011-2: Water reflected 80-cm-diameter cylindrical tank with 6% enriched uranyl nitrate solution @ H/X=827 (Run 461)
...
mat1.add_nuclide("U234", 5.632500e-07)
mat1.add_nuclide("U235", 6.741400e-05)
mat1.add_nuclide("U236", 1.116900e-07)
mat1.add_nuclide("U238", 1.040300e-03)
mat1.add_nuclide("H1", 5.576300e-02)
mat1.add_element("N", 2.831000e-03)
mat1.add_nuclide("O16", 3.828400e-02)
...
# Hc
surf4 = openmc.ZPlane(surface_id=4, z0=50.77)
...
source.space = openmc.stats.Point((0.0, 0.0, 25.385))
