"""
PU-SOL-THERM-041-11: Experiment 288 with 48 gPu(3)/L at H/X=499; Hc=29.72
...
surf7 = openmc.ZPlane(surface_id=7, z0=29.72)
...
source.space = openmc.stats.Box((-18.5, -18.5, 14.61), (18.5, 18.5, 16.61))
