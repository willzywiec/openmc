"""
LEU-COMP-THERM-010-18: (12x16)-14.973cm-(12x16)-14.973cm-(12x16) array of U(4.306)O2 rods in water; 1.892 cm pitch; Steel walls; 2.616 gap
...
# Reflecting wall
surf21 = openmc.model.RectangularParallelepiped(-73.65, 73.65, -35.602000000000004, -17.752, -20.0625, 101.8375)
# Reflecting wall
surf22 = openmc.model.RectangularParallelepiped(-73.65, 73.65, 17.752, 35.602000000000004, -20.0625, 101.8375)
...
cell1.translation = (-37.677, 0.0, 0.0)
...
cell5.translation = (37.677, 0.0, 0.0)
...
source.space = openmc.stats.Box((-37.731, -2.27, 45.0375), (37.731, 2.27, 47.0375))
