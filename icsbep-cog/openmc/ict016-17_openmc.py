"""
ICT016-17: 17.78 x 17.78 x 20.2438 (30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 10.16 cm Polythene on top - batch 80
...
surf1 = openmc.model.RectangularParallelepiped(-8.89, 8.89, -8.89, 8.89, -10.1219, 10.1219)
surf2 = openmc.model.RectangularParallelepiped(-29.21, 29.21, -29.21, 29.21, -30.4419, 30.4419, boundary_type="vacuum")
# Zo=(20.2438/2)+10.16
surf3 = openmc.ZPlane(surface_id=3, z0=20.2819)
