"""
LCT075-5: 1,195 VVER U(6.5)O2 rods, 1.10 cm trianglur pitch, 4 water holes 12.1 from core center, Hc=69.98cm
...
surf1 = openmc.ZPlane(surface_id=1, z0=69.98)
...
source.space = openmc.stats.Point((0.0, 0.0, 34.99))
