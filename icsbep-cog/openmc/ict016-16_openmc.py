"""
ICT016-16: 17.78 x 17.78 x 20.7772 (30.14)O2/wax parallelepiped with 20.32 cm Polythene on bottom & sides - 5.08 cm Polythene on top - batch 80
...
surf1 = openmc.model.RectangularParallelepiped(-8.89, 8.89, -8.89, 8.89, -10.3886, 10.3886)
surf2 = openmc.model.RectangularParallelepiped(-29.21, 29.21, -29.21, 29.21, -30.7086, 30.7086, boundary_type="vacuum")
# Zo=(21.6662/2)+5.08
surf3 = openmc.ZPlane(surface_id=3, z0=15.4686)
