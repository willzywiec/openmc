"""
MCT013-8: MOX/Polystyrene with H/X=226 with 0.38 SST-1.1B absorber and 15.24cm Lucite reflector
...
mat2.add_nuclide("B10", 7.212000e-04)
mat2.add_nuclide("B11", 2.902900e-03)
mat2.add_element("Fe", 4.892200e-02)
mat2.add_element("Cr", 1.278100e-02)
mat2.add_element("Ni", 5.035400e-03)
...
# Absorber, upper
surf3 = openmc.ZPlane(surface_id=3, z0=0.38)
# Lucite reflector, 15.24 cm thick
surf4 = openmc.model.RectangularParallelepiped(-35.6, 35.6, -35.62, 35.62, -29.9114, 31.8662, boundary_type="vacuum")
...
source.space = openmc.stats.Box((-1.0, -1.0, -8.34), (1.0, 1.0, 9.5))
