"""
LST022-3: STACY 28cm thick slab tank with 10% enriched uranyl nitrate solution @ H/X=750 reflected with (B100) borated concrete (Run 134)
...
mat1.add_nuclide("U234", 6.352500e-07)
mat1.add_nuclide("U235", 7.883000e-05)
mat1.add_nuclide("U236", 7.873100e-08)
mat1.add_nuclide("U238", 7.021500e-04)
mat1.add_nuclide("H1", 5.910700e-02)
mat1.add_element("N", 2.045100e-03)
...
# Borated Concrete (B100)
mat5 = openmc.Material(material_id=5)
mat5.set_density("sum")
mat5.add_nuclide("H1", 1.704800e-02)
mat5.add_nuclide("O16", 8.524100e-03)
mat5.add_nuclide("O16", 3.302700e-02)
mat5.add_nuclide("B10", 1.057500e-03)
mat5.add_nuclide("B11", 4.256600e-03)
mat5.add_element("C", 1.328700e-03)
mat5.add_element("Na", 1.107700e-04)
mat5.add_element("Mg", 1.150500e-04)
mat5.add_element("Al", 7.040300e-04)
mat5.add_element("Si", 1.341700e-02)
mat5.add_element("S", 1.368900e-04)
mat5.add_element("Cl", 7.473900e-07)
mat5.add_element("K", 1.317000e-04)
mat5.add_element("Ca", 4.273000e-03)
mat5.add_element("Fe", 1.440500e-04)
...
# Hc
surf3 = openmc.ZPlane(surface_id=3, z0=74.78)
# Borated concrete
surf11 = openmc.model.RectangularParallelepiped(-32.53, -17.6, -35.7, 35.7, 0.0, 150.6)
# Steel frames
surf12 = openmc.model.RectangularParallelepiped(-32.53, -17.6, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover plates
surf13 = openmc.model.RectangularParallelepiped(-33.33, -16.79, -38.7, 38.7, -3.0, 153.6)
# Borated concrete
surf21 = openmc.model.RectangularParallelepiped(17.6, 32.53, -35.7, 35.7, 0.0, 150.6)
# Steel frames
surf22 = openmc.model.RectangularParallelepiped(17.6, 32.53, -38.7, 38.7, -3.0, 153.6)
# Aluminum cover plates
surf23 = openmc.model.RectangularParallelepiped(16.79, 33.33, -38.7, 38.7, -3.0, 153.6)
# BCD
surf99 = openmc.model.RectangularParallelepiped(-33.33, 33.33, -38.7, 38.7, -3.0, 153.6, boundary_type="vacuum")
...
source.space = openmc.stats.Point((0.0, 0.0, 37.39))
