"""
PMF031-13: 1.165cm cavityt; 7.8717 kg alpha-239Pu(88%); 3.69cm Polyethylene reflected; detailed model
...
mat1.add_nuclide("Pu241", 9.073600e-04)
mat1.add_element("Fe", 3.043900e-04)
mat1.add_element("C", 1.987400e-03)
mat1.add_element("H", 8.314800e-04)
mat1.add_element("N", 8.974800e-05)
mat1.add_nuclide("O16", 1.330500e-04)
...
mat5.add_element("C", 3.863400e-02)
mat5.add_nuclide("H1", 7.726700e-02)
...
surf6 = openmc.Sphere(surface_id=6, r=8.350, boundary_type="vacuum")
