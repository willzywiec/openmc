...
surf101 = openmc.ZCylinder(surface_id=101, x0=-9.65454, y0=-9.65454, r=0.32385)
surf102 = openmc.ZCylinder(surface_id=102, x0=-8.73506, y0=-9.65454, r=0.32385)
surf103 = openmc.ZCylinder(surface_id=103, x0=-7.81558, y0=-9.65454, r=0.32385)
surf104 = openmc.ZCylinder(surface_id=104, x0=-6.8961, y0=-9.65454, r=0.32385)
surf105 = openmc.ZCylinder(surface_id=105, x0=-5.97662, y0=-9.65454, r=0.32385)
surf106 = openmc.ZCylinder(surface_id=106, x0=-5.05714, y0=-9.65454, r=0.32385)
surf107 = openmc.ZCylinder(surface_id=107, x0=-4.13766, y0=-9.65454, r=0.32385)
surf108 = openmc.ZCylinder(surface_id=108, x0=-3.21818, y0=-9.65454, r=0.32385)
surf109 = openmc.ZCylinder(surface_id=109, x0=-2.2987, y0=-9.65454, r=0.32385)
surf110 = openmc.ZCylinder(surface_id=110, x0=-1.37922, y0=-9.65454, r=0.32385)
surf111 = openmc.ZCylinder(surface_id=111, x0=-0.45974, y0=-9.65454, r=0.32385)
surf112 = openmc.ZCylinder(surface_id=112, x0=0.45974, y0=-9.65454, r=0.32385)
surf113 = openmc.ZCylinder(surface_id=113, x0=1.37922, y0=-9.65454, r=0.32385)
surf114 = openmc.ZCylinder(surface_id=114, x0=2.2987, y0=-9.65454, r=0.32385)
surf115 = openmc.ZCylinder(surface_id=115, x0=3.21818, y0=-9.65454, r=0.32385)
surf116 = openmc.ZCylinder(surface_id=116, x0=4.13766, y0=-9.65454, r=0.32385)
surf117 = openmc.ZCylinder(surface_id=117, x0=5.05714, y0=-9.65454, r=0.32385)
surf118 = openmc.ZCylinder(surface_id=118, x0=5.97662, y0=-9.65454, r=0.32385)
surf119 = openmc.ZCylinder(surface_id=119, x0=6.8961, y0=-9.65454, r=0.32385)
surf120 = openmc.ZCylinder(surface_id=120, x0=7.81558, y0=-9.65454, r=0.32385)
surf121 = openmc.ZCylinder(surface_id=121, x0=8.73506, y0=-9.65454, r=0.32385)
surf122 = openmc.ZCylinder(surface_id=122, x0=9.65454, y0=-9.65454, r=0.32385)
...
surf201 = openmc.ZCylinder(surface_id=201, x0=-31.26232, y0=0.0, r=0.7239)
surf202 = openmc.ZCylinder(surface_id=202, x0=-29.42336, y0=0.0, r=0.7239)
surf203 = openmc.ZCylinder(surface_id=203, x0=-27.5844, y0=0.0, r=0.7239)
surf204 = openmc.ZCylinder(surface_id=204, x0=-25.74544, y0=0.0, r=0.7239)
surf205 = openmc.ZCylinder(surface_id=205, x0=-23.90648, y0=0.0, r=0.7239)
surf206 = openmc.ZCylinder(surface_id=206, x0=-22.06752, y0=0.0, r=0.7239)
surf207 = openmc.ZCylinder(surface_id=207, x0=-20.22856, y0=0.0, r=0.7239)
surf208 = openmc.ZCylinder(surface_id=208, x0=-18.3896, y0=0.0, r=0.7239)
surf209 = openmc.ZCylinder(surface_id=209, x0=-16.55064, y0=0.0, r=0.7239)
surf210 = openmc.ZCylinder(surface_id=210, x0=-14.71168, y0=0.0, r=0.7239)
surf211 = openmc.ZCylinder(surface_id=211, x0=-12.87272, y0=0.0, r=0.7239)
surf212 = openmc.ZCylinder(surface_id=212, x0=-11.03376, y0=0.0, r=0.7239)
surf213 = openmc.ZCylinder(surface_id=213, x0=-9.1948, y0=0.0, r=0.7239)
surf214 = openmc.ZCylinder(surface_id=214, x0=-7.35584, y0=0.0, r=0.7239)
surf215 = openmc.ZCylinder(surface_id=215, x0=-5.51688, y0=0.0, r=0.7239)
surf216 = openmc.ZCylinder(surface_id=216, x0=-3.67792, y0=0.0, r=0.7239)
surf217 = openmc.ZCylinder(surface_id=217, x0=-1.83896, y0=0.0, r=0.7239)
surf218 = openmc.ZCylinder(surface_id=218, x0=0.0, y0=0.0, r=0.7239)
surf219 = openmc.ZCylinder(surface_id=219, x0=1.83896, y0=0.0, r=0.7239)
surf220 = openmc.ZCylinder(surface_id=220, x0=3.67792, y0=0.0, r=0.7239)
surf221 = openmc.ZCylinder(surface_id=221, x0=5.51688, y0=0.0, r=0.7239)
surf222 = openmc.ZCylinder(surface_id=222, x0=7.35584, y0=0.0, r=0.7239)
surf223 = openmc.ZCylinder(surface_id=223, x0=9.1948, y0=0.0, r=0.7239)
surf224 = openmc.ZCylinder(surface_id=224, x0=11.03376, y0=0.0, r=0.7239)
surf225 = openmc.ZCylinder(surface_id=225, x0=12.87272, y0=0.0, r=0.7239)
surf226 = openmc.ZCylinder(surface_id=226, x0=14.71168, y0=0.0, r=0.7239)
surf227 = openmc.ZCylinder(surface_id=227, x0=16.55064, y0=0.0, r=0.7239)
surf228 = openmc.ZCylinder(surface_id=228, x0=18.3896, y0=0.0, r=0.7239)
surf229 = openmc.ZCylinder(surface_id=229, x0=20.22856, y0=0.0, r=0.7239)
surf230 = openmc.ZCylinder(surface_id=230, x0=22.06752, y0=0.0, r=0.7239)
surf231 = openmc.ZCylinder(surface_id=231, x0=23.90648, y0=0.0, r=0.7239)
surf232 = openmc.ZCylinder(surface_id=232, x0=25.74544, y0=0.0, r=0.7239)
surf233 = openmc.ZCylinder(surface_id=233, x0=27.5844, y0=0.0, r=0.7239)
surf234 = openmc.ZCylinder(surface_id=234, x0=29.42336, y0=0.0, r=0.7239)
surf235 = openmc.ZCylinder(surface_id=235, x0=31.26232, y0=0.0, r=0.7239)
...
u2_cell0.region = -surf100 & +surf101 & +surf102 & +surf103 & +surf104 & +surf105 & +surf106 & +surf107 & +surf108 & +surf109 & +surf110 & +surf111 & +surf112 & +surf113 & +surf114 & +surf115 & +surf116 & +surf117 & +surf118 & +surf119 & +surf120 & +surf121 & +surf122
