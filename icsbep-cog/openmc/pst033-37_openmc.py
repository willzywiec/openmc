"""
PU-SOL-THERM-033-37: 160.7 gPu(4.23)/L at H/X=153.2 with 73 (3x40) pyrex tubes at 3.23cm pitch
...
surf1 = openmc.ZPlane(surface_id=1, z0=57.98)
...
source.space = openmc.stats.Point((0.0, 0.0, 28.99))
