"""
IEU-MET-FAST-022-6: FR0 9-S; simplified homogeous cylindrical benchmark; C/X=0.005; D/X=2.8
...
mat1.add_nuclide("U234", 5.675800e-05)
mat1.add_nuclide("U235", 5.665700e-03)
mat1.add_nuclide("U238", 2.225100e-02)
mat1.add_element("C", 2.902200e-05)
mat1.add_element("F", 5.804400e-05)
mat1.add_nuclide("H2", 1.595800e-02)
mat1.add_nuclide("O16", 7.980600e-03)
mat1.add_element("Cu", 2.982000e-03)
...
# (U20)
surf1 = openmc.ZCylinder(surface_id=1, r=20.4245)
# Copper (CU)
...
surf1_zmin = openmc.ZPlane(surface_id=1005, z0=-17.204)
surf1_zmax = openmc.ZPlane(surface_id=1006, z0=17.204)
