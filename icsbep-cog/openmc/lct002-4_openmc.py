"""
LEU-COMP-THERM-002-4: (15x8)-10.62cm-(15x8)-10.62cm-(15x8) array of U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-67.77, 67.77, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-97.77, 97.77, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-29.67)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=29.67)
# Rubber
...
cell1.translation = (-48.72, 0.0, 0.0)
...
cell5.translation = (48.72, 0.0, 0.0)
...
cell13.region = -surf1 & (+surf15 | -surf15_zmin | +surf15_zmax) & +surf16

# H2O
cell16 = openmc.Cell(cell_id=16, fill=mat4)
cell16.region = -surf1 & +surf16

root_universe = openmc.Universe(cells=[cell1, cell2, cell3, cell4, cell5, cell6, cell13, cell16])
