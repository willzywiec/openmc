"""
PU-SOL-THERM-026 (Case 21) 36.241 kg Pu(81.6) at H/X = 109 with H/SQRT(A) = 0.277
...
# Hc
surf1 = openmc.ZPlane(surface_id=1, z0=62.408)
# Tank/Inner:  Width = Tc
...
source.space = openmc.stats.Point((-284.0, 149.0, -161.7))
