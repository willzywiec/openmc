"""
LEU-COMP-THERM-009-24: (15x8)-5.0475cm-(0.625cm Al)-5.0475cm-(15x8)-5.0475cm-(0.625cm Al)-5.0475cm-(15x8) arrays U(4.31)O2 rods in water; 2.54 cm pitch
...
# Array Boundary
surf1 = openmc.model.RectangularParallelepiped(-67.87, 67.87, -10.16, 10.16, -499.995, 499.995)
# Entire Problem (BCD)
surf2 = openmc.model.RectangularParallelepiped(-97.87, 97.87, -40.16, 40.16, -20.0625, 107.075, boundary_type="vacuum")
surf3 = openmc.XPlane(surface_id=3, x0=-29.77)
surf4 = openmc.XPlane(surface_id=4, x0=-19.05)
surf5 = openmc.XPlane(surface_id=5, x0=19.05)
surf6 = openmc.XPlane(surface_id=6, x0=29.77)
# Rubber
...
surf21 = openmc.model.RectangularParallelepiped(-24.7225, -24.0975, -17.8, 17.8, 0.0, 91.5)
surf22 = openmc.model.RectangularParallelepiped(24.0975, 24.7225, -17.8, 17.8, 0.0, 91.5)
...
cell1.translation = (-48.82, 0.0, 0.0)
...
cell5.translation = (48.82, 0.0, 0.0)
...
source.space = openmc.stats.Box((-49.82, -2.27, 45.0375), (49.82, 2.27, 47.0375))
